...
public final class Protocol {
  ...
  public static final String TASK_ASSIGNEE_HEADER_NAME = "io.camunda.zeebe:assignee";

  /** Task header key used for candidate groups */
  public static final String TASK_CANDIDATE_GROUPS_HEADER_NAME = "io.camunda.zeebe:candidateGroups";

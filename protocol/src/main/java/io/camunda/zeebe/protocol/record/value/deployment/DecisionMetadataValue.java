...
/**
 * The metadata of a deployed decision. A decision belongs to a decision requirements graph
 * (DRG/DRD) that represents the DMN resource. The metadata contains relevant properties of the
 * decision.
 */
public interface DecisionMetadataValue {

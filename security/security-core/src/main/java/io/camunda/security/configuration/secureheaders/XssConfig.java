...
/**
 * Sets the 'X-XSS-Protection' header. Can take the following modes: DISABLED ('0'), ENABLED ('1'),
 * ENABLED_WITH_BLOCK_MODE ('1; mode=block'). The header is ENABLED by default.
 */

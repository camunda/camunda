...
public record Authorization<T>(
    ...
    @JsonIgnore Function<T, List<String>> resourceIdsSupplier) {
  ...
  public static class Builder<T> {
    ...
    private Function<T, List<String>> resourceIdsSupplier;
    ...
    public Builder<T> resourceIds(final List<String> values) {
    ...
    public Builder<T> resourceIdsSupplier(final Function<T, List<String>> value) {
      resourceIdsSupplier = value;
      return this;
    }

    public Authorization<T> build() {
      return new Authorization(resourceType, permissionType, resourceIds, resourceIdsSupplier);
    }
  }
}

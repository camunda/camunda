...
import static io.camunda.security.api.model.authz.AuthorizationResourceType.BATCH;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.CLUSTER_VARIABLE;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.DECISION_DEFINITION;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.DECISION_REQUIREMENTS_DEFINITION;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.DOCUMENT;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.GLOBAL_LISTENER;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.GROUP;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.MAPPING_RULE;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.PROCESS_DEFINITION;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.RESOURCE;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.ROLE;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.SYSTEM;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.TENANT;
import static io.camunda.security.api.model.authz.AuthorizationResourceType.USER;
...
import static io.camunda.security.api.model.authz.PermissionType.CREATE_PROCESS_INSTANCE;
import static io.camunda.security.api.model.authz.PermissionType.DELETE_DECISION_INSTANCE;
import static io.camunda.security.api.model.authz.PermissionType.DELETE_PROCESS_INSTANCE;
import static io.camunda.security.api.model.authz.PermissionType.READ;
import static io.camunda.security.api.model.authz.PermissionType.READ_DECISION_DEFINITION;
import static io.camunda.security.api.model.authz.PermissionType.READ_DECISION_INSTANCE;
import static io.camunda.security.api.model.authz.PermissionType.READ_JOB_METRIC;
...
import static io.camunda.security.api.model.authz.PermissionType.READ_USAGE_METRIC;
import static io.camunda.security.api.model.authz.PermissionType.READ_USER_TASK;
import static io.camunda.security.api.model.authz.PermissionType.UPDATE_PROCESS_INSTANCE;

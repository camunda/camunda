...
public record Authorization<T>(
  ...
  public static <T> Authorization<T> with(final Authorization<T> authorization) {
    return of(
        b ->
            b.resourceType(authorization.resourceType())
                ...
                .resourceIdSupplier(authorization.resourceIdSupplier));
  }

  public static <T> Authorization<T> withResourceId(
      final Authorization<T> authorization, final long resourceId) {
    return withResourceId(authorization, String.valueOf(resourceId));
  }
  ...
  public static class Builder<T> {
    ...
    public Builder<T> unspecified() {
      return resourceType(AuthorizationResourceType.UNSPECIFIED);
    }

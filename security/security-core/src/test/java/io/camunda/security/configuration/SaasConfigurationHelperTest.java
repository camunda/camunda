...
class SaasConfigurationHelperTest {
  ...
  @Test
  void shouldReturnNullOrganizationIdWhenOrganizationIdIsNull() {
    // given
  ...
  @Test
  void shouldReturnNullClusterIdWhenClusterIdIsNull() {
    // given
    final var saas = new SaasConfiguration();
  ...
  @Test
  void shouldReturnNotSaasWhenClusterIdIsNull() {
    // given
    final var saas = new SaasConfiguration();

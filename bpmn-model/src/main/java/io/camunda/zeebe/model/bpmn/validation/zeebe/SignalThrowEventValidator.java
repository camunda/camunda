...
public class SignalThrowEventValidator implements ModelElementValidator<ThrowEvent> {
  ...
  public void validate(
    ...
    if (isSignalThrowEvent(element)) {
      // a signal throw event must have a task definition
      extensionElementsValidator.validate(element, validationResultCollector);
    }
  }

  private boolean isSignalThrowEvent(final ThrowEvent element) {

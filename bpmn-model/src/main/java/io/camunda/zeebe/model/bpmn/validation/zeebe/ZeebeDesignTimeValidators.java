  ...
  static {
    ...
    validators.add(
        ZeebeElementValidator.verifyThat(ZeebeFormDefinition.class)
            .hasOneOfNonEmptyAttribute(
                new HashMap<Function<ZeebeFormDefinition, String>, String>() {
                  {
                    put(ZeebeFormDefinition::getFormKey, ZeebeConstants.ATTRIBUTE_FORM_KEY);
                    put(ZeebeFormDefinition::getFormId, ZeebeConstants.ATTRIBUTE_FORM_ID);
                  }
                }));

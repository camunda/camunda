...
import static io.zeebe.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_OUTPUT_PARAMETER;
 ...
 */
public class CamundaOutputParameterImpl extends CamundaGenericValueElementImpl
    implements CamundaOutputParameter {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(CamundaOutputParameter.class, CAMUNDA_ELEMENT_OUTPUT_PARAMETER)
            .namespaceUri(CAMUNDA_NS)
            .instanceProvider(
                new ModelTypeInstanceProvider<CamundaOutputParameter>() {
                  @Override
                  public CamundaOutputParameter newInstance(

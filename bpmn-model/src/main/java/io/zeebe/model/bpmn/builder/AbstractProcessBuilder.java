...
public abstract class AbstractProcessBuilder<B extends AbstractProcessBuilder<B>>
  ...
  /**
   * Set the camunda task priority attribute. The priority is only used for service tasks which have
   * as type value <code>external</code>
   *
   ...
   *
   * @param historyTimeToLive value for history time to live, must be either null or non-negative
   *     integer.
   * @return the builder object
   */

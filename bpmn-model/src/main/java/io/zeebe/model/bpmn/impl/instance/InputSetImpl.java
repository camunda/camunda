...
import static io.zeebe.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_INPUT_SET;
...
public class InputSetImpl extends BaseElementImpl implements InputSet {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ...
    dataInputDataInputRefsCollection =
        sequenceBuilder
            .elementCollection(DataInputRefs.class)
            .idElementReferenceCollection(DataInput.class)
            .build();

    optionalInputRefsCollection =
        sequenceBuilder
            .elementCollection(OptionalInputRefs.class)
            .idElementReferenceCollection(DataInput.class)
            .build();

    whileExecutingInputRefsCollection =
        sequenceBuilder
            .elementCollection(WhileExecutingInputRefs.class)
            .idElementReferenceCollection(DataInput.class)
            .build();

    outputSetOutputSetRefsCollection =
        sequenceBuilder
            .elementCollection(OutputSetRefs.class)

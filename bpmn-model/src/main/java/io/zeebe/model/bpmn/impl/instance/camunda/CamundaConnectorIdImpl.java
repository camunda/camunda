...
import static io.zeebe.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_CONNECTOR_ID;
 ...
 */
public class CamundaConnectorIdImpl extends BpmnModelElementInstanceImpl
    implements CamundaConnectorId {

  public static void registerType(ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(CamundaConnectorId.class, CAMUNDA_ELEMENT_CONNECTOR_ID)
            .namespaceUri(CAMUNDA_NS)
            .instanceProvider(
                new ModelTypeInstanceProvider<CamundaConnectorId>() {
                  @Override

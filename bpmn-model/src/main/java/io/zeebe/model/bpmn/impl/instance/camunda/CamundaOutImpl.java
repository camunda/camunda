...
import static io.zeebe.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_OUT;
...
public class CamundaOutImpl extends BpmnModelElementInstanceImpl implements CamundaOut {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(CamundaOut.class, CAMUNDA_ELEMENT_OUT)
            .namespaceUri(CAMUNDA_NS)
            .instanceProvider(
                new ModelTypeInstanceProvider<CamundaOut>() {
                  @Override

...
class SchemaUpdateIT {
  ...
  @Disabled(
      "Seeds its previous-version schema from the camunda/camunda:8.10-SNAPSHOT image (built "
          + "from stable/8.10), which already has the jobLease rename from "
          + "https://github.com/camunda/camunda/issues/63222. "
          + "Re enable with https://github.com/camunda/camunda/issues/63447")
  @TestTemplate

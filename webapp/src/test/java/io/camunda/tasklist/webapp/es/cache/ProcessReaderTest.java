...
class ProcessReaderTest {
  ...
  @InjectMocks private ProcessReader processReader;
  ...
  public void shouldReturnAProcessEntityWhenGetProcessByBpmnIdIsCalled() throws IOException {
    ...
    // when
    final ProcessDTO result = processReader.getProcessByBpmnProcessId("bpmnProcessId");
  ...
  public void shouldReturnNotFoundWhenESReturnsZeroHits() throws IOException {
    ...
    assertThrows(
        ...
        () -> processReader.getProcessByBpmnProcessId("bpmnProcessId_not_exist"));
  }
  ...
  public void shouldReturnIOExceptionForGetProcessByBpmnId() throws IOException {
    ...
    final TasklistRuntimeException thrown =
        assertThrows(
            ...
            () -> processReader.getProcessByBpmnProcessId("bpmnProcessId"));
  ...
  public void shouldGetStartEventFormIdByBpmnProcessStartedByForm() {
    ...
    final ProcessDTO process = new ProcessDTO();
    ...
    when(formReader.getFormDTO(formId, processId)).thenReturn(formDTO);

    // given
    final String result = processReader.getStartEventFormIdByBpmnProcess(process);
  ...
  public void shouldGetStartEventFormIdByBpmnProcessByFormKeyNotContainsColon() {
    ...
    when(formReader.getFormDTO("", processId)).thenReturn(formDTO);
  ...
  public void shouldGetProcessReturnAProcessById() throws IOException {
    ...
    // given
    final ProcessEntity result = processReader.getProcess("1");
  ...
  public void shouldGetProcessReturnNotFound() throws IOException {
    ...
    // given and then
    assertThrows(TasklistRuntimeException.class, () -> processReader.getProcess("processId"));
  }
  ...
  public void shouldNotReturnProcessesWhenResourceAuthIsEnabledButNoAuthorization() {
    ...
    // given
    final List<ProcessDTO> processes = processReader.getProcesses();
    final List<ProcessDTO> processesWithCondition = processReader.getProcesses("*");

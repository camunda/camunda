...
public class IdentityController {
  ...
  public String login(final HttpServletRequest req) {
    final String authorizeUrl = identity
        .authentication()
   ...
   */
  @RequestMapping(value = IDENTITY_CALLBACK_URI, method = RequestMethod.GET)
  public void loggedInCallback(final HttpServletRequest req, final HttpServletResponse res, AuthCodeDto authCodeDto) throws IOException {
    logger.debug("Called back by identity with {} {}, SessionId: {} and AuthCode {}",
        ...
        authCodeDto.getCode());
    try {
      IdentityAuthentication authentication = beanFactory.getBean(IdentityAuthentication.class);
  ...
  public void logout(HttpServletRequest req, HttpServletResponse res) throws IOException {
    ...
    try {
      IdentityAuthentication authentication = (IdentityAuthentication) SecurityContextHolder
          .getContext()
          .getAuthentication();

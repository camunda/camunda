 ...
 * QueryDSL class without static calls, enabling unit tests to mock this out and reduce test complexity
 */
@Component
public class OpensearchQueryDSLWrapper {
    ...
    public <A> Query match(String field, A value, Operator operator, Function<A, FieldValue> toFieldValue) {

...
@Component
public class OpensearchProcessInstanceWriter implements io.camunda.operate.webapp.writer.ProcessInstanceWriter {
  ...
  private static void validateDeletion(final ProcessInstanceForListViewEntity processInstanceEntity) {

...
public class DecisionInstanceController extends ErrorController {
  ...
  @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Search examples", content = @Content(examples = {
      @ExampleObject(name = "All", value = "{}", description = "All decision instances (default size is 10)"),
      @ExampleObject(name = "Size of returned list", value = "{ \"size\": 5 }", description = "Search decision instances and return list of size 5"),
      @ExampleObject(name = "Sort", value = "{ \"sort\": [{\"field\":\"decisionName\",\"order\": \"ASC\"}] }", description = "Search decision instances and sort ascending by decisionName"),
      @ExampleObject(name = "Sort and size", value = "{ \"size\": 5, \"sort\": [{\"field\":\"decisionName\",\"order\": \"DESC\"}] }", description = "Search decision instances, sort descending by decisionName, and return list of size 5"),
      @ExampleObject(name = "Sort and page", value = "{   \"size\": 5," + "    \"sort\": [{\"field\":\"decisionName\",\"order\": \"ASC\"}]," + "    \"searchAfter\": ["
          + "      \"Invoice Classification\"," + "      \"2251799813686550\"" + "  ] }", description =
      ...
      @ExampleObject(name = "Filter and sort ", value = "{   \"filter\": {" + "      \"decisionVersion\": 1" + "    }," + "    \"size\": 50,"
          + "    \"sort\": [{\"field\":\"decisionId\",\"order\": \"ASC\"}]}", description = "Filter by decisionVersion and sort by decisionId"),}))
  @ResponseStatus(HttpStatus.OK)
  @PostMapping(
      value = SEARCH,

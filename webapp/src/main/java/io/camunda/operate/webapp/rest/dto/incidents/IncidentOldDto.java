...
@Deprecated
public class IncidentOldDto {

  public static final Comparator<IncidentOldDto> INCIDENT_DEFAULT_COMPARATOR = (o1, o2) -> {
  ...
  public static IncidentOldDto createFrom(IncidentEntity incidentEntity, List<OperationEntity> operations) {
    if (incidentEntity == null) {
      return null;
    }

    IncidentOldDto incident = new IncidentOldDto();
  ...
  public static List<IncidentOldDto> createFrom(List<IncidentEntity> incidentEntities, Map<Long, List<OperationEntity>> operations) {
    List<IncidentOldDto> result = new ArrayList<>();
  ...
  public static List<IncidentOldDto> sortDefault(List<IncidentOldDto> incidents) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentOldDto that = (IncidentOldDto) o;

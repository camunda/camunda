...
test('should have no accessibility violations on task history details', async ({
	network,
	taskDetailPage,
	makeAxeBuilder,
}) => {
...
test('should have no accessibility violations on empty task history', async ({
	network,
	taskDetailPage,
	makeAxeBuilder,
}) => {
...
test('should have no accessibility violations when task history cannot be loaded', async ({
	network,
	taskDetailPage,
	makeAxeBuilder,
}) => {
...
test('should have no accessibility violations when task history access is forbidden', async ({
	network,
	taskDetailPage,
	makeAxeBuilder,
}) => {

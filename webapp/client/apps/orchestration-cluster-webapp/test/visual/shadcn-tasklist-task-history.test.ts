...
test('should match the task history view', async ({network, shadcnTaskDetailPage: taskDetailPage, page}) => {
	network.use(
		mockQueryUserTaskAuditLogsEndpoint({
...
test('should match the task history details modal', async ({network, shadcnTaskDetailPage: taskDetailPage, page}) => {
...
test('should match the empty task history view', async ({network, shadcnTaskDetailPage: taskDetailPage, page}) => {
	network.use(
		mockQueryUserTaskAuditLogsEndpoint({
...
test('should match the task history loading error', async ({network, shadcnTaskDetailPage: taskDetailPage, page}) => {
	network.use(
		mockQueryUserTaskAuditLogsEndpoint({

...
test('should match snapshot with the filter select closed', async ({tasklistIndexPage, page}) => {
...
test('should match snapshot with the filter select open', async ({tasklistIndexPage, page}) => {

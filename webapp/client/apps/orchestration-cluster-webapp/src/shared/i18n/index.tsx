...
const languageItems: SelectionOption[] = Object.entries(localeDefinitions).map(([key, {language}]) => {
	return {
		id: key,
		label: language,
	};
...
const translationResources: Resource = Object.entries(localeDefinitions).reduce<Resource>(
...
const getCurrentDateLocale = () => localeDefinitions[i18n.language]?.dateLocale ?? dateLocaleEnUS;

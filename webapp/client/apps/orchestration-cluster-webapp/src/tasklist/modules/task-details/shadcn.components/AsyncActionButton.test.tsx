...
describe('<AsyncActionButton />', () => {
	...
	it('should render have a loading state', async () => {
		const screen = await render(
			<AsyncActionButton status="active" description="Loading...">
				Click me
			</AsyncActionButton>,
		);
	...
	it('should render a success state', async () => {
		const screen = await render(
			<AsyncActionButton status="finished" description="Done!">
				Click me
			</AsyncActionButton>,
		);
	...
	it('should call onSuccess callback after a delay', async () => {
		...
		await render(
			<AsyncActionButton status="finished" onSuccess={onSuccess}>
				Action
			</AsyncActionButton>,
		);
	...
	it('should allow button configuration', async () => {
		const screen = await render(
			<AsyncActionButton status="inactive" buttonProps={{variant: 'default', size: 'sm', disabled: true}}>
				Disabled button
			</AsyncActionButton>,
		);
	...
	it('should render error state', async () => {
		const screen = await render(
			<AsyncActionButton status="error" description="Failed">
				Action
			</AsyncActionButton>,
		);

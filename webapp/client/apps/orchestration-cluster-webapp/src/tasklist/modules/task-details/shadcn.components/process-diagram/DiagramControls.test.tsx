...
import {DiagramControls as ShadcnDiagramControls} from './DiagramControls';

const DiagramControls: React.FC<React.ComponentProps<typeof ShadcnDiagramControls>> = (props) => (
	<TooltipProvider>
		<ShadcnDiagramControls {...props} />
	</TooltipProvider>
);

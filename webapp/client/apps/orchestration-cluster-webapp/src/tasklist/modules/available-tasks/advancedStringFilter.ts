...
type AdvancedStringFilter = Extract<NonNullable<QueryUserTasksRequestBody['filter']>['businessId'], object>;
 ...
 */
const advancedStringFilterCodec = z.codec(z.string(), advancedStringFilterSchema, {

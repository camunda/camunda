...
import {CheckmarkOutline as BaseCheckmarkOutline, ErrorOutline as BaseErrorOutline} from '@carbon/react/icons';
...
const IconTextWithTopMargin = styled(IconText)`
	margin-top: var(--cds-spacing-03);
`;

const ResultCheckmarkOutline = styled(BaseCheckmarkOutline)`
	fill: var(--cds-support-success);
`;

const ResultErrorOutline = styled(BaseErrorOutline)`

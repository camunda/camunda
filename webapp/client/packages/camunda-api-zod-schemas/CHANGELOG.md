...
- Add `state` field (`ACTIVE`, `DRAINING`, `DELETED`) to the 8.10 process-definition schema, exposing and enabling filtering on the draining state ([#56988](https://github.com/camunda/camunda/issues/56988))

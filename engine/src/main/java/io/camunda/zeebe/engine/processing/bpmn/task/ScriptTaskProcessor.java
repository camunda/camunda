...
public final class ScriptTaskProcessor implements BpmnElementProcessor<ExecutableScriptTask> {
  ...
  public void onActivate(
    ...
    eventBehaviorOf(element, context).onActivate(element, context, sideEffects);
  }
  ...
  private static final class JobWorkerTaskBehavior implements ScriptTaskBehavior {
    ...
    public void onActivate(
        ...
        final SideEffects sideEffects) {
      delegate.onActivate(element, activating, sideEffects);
    }
  ...
  private interface ScriptTaskBehavior {
    void onActivate(
        ExecutableScriptTask element, BpmnElementContext activating, final SideEffects sideEffects);

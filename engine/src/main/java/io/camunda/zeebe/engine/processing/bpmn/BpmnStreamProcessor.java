    ...
    switch (intent) {
      case ACTIVATE_ELEMENT:
        ...
        stateTransitionBehavior
            ...
            .ifRightOrLeft(
                ok -> processor.onActivate(element, activatingContext, sideEffects),
      ...
      case COMPLETE_ELEMENT:
        ...
        processor.onComplete(element, completingContext, sideEffects);
        break;
      case TERMINATE_ELEMENT:
        final var terminatingContext = stateTransitionBehavior.transitionToTerminating(context);
        processor.onTerminate(element, terminatingContext, sideEffects);
        break;
      default:

...
public final class CreateProcessInstanceProcessor
  ...
  private void createProcessInstance(
    ...
    final var processInstance =
        initProcessInstanceRecord(process, processInstanceKey, record.getTenantIdBuffer());
  ...
  private Either<Rejection, DeployedProcess> getProcess(
    ...
    final DeployedProcess process = processState.getLatestProcessVersionByProcessId(tenantId, bpmnProcessId);
    if (process != null) {
  ...
  private Either<Rejection, DeployedProcess> getProcess(
    ...
    final DeployedProcess process =
        processState.getProcessByProcessIdAndVersion(tenantId, bpmnProcessId, version);
    if (process != null) {
      return Either.right(process);
    } else {
      return Either.left(
        ...
        instruction -> {
          ...
          final long flowScopeKey =
              activateFlowScopes(
                  ...
                  processInstanceKey,
                  elementId,
                  activatedFlowScopeIds,
                  processInstance.getTenantIdBuffer());
  ...
  private long activateFlowScopes(
    ...
    if (activatedFlowScopeIds.containsKey(flowScope.getId())) {
      ...
      final long flowScopeKey =
          activateFlowScopes(
              process, processInstanceKey, flowScope.getId(), activatedFlowScopeIds, tenantId);
      final ProcessInstanceRecord flowScopeRecord =
          createProcessInstanceRecord(
              process, processInstanceKey, flowScope.getId(), flowScopeKey, tenantId);

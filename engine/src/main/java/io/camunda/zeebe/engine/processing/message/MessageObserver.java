...
public final class MessageObserver implements StreamProcessorLifecycleAware {
  ...
  private final MutableTransientMessageSubscriptionState transientMessageSubscriptionState;

  public MessageObserver(
      final MessageState messageState,
      final MutableTransientMessageSubscriptionState transientMessageSubscriptionState,

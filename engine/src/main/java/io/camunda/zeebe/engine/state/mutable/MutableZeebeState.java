...
public interface MutableZeebeState extends ZeebeState {
  ...
  MutableTransientMessageSubscriptionState getTransientMessageSubscriptionState();

  MutableTransientProcessMessageSubscriptionState getTransientProcessMessageSubscriptionState();
}

...
public enum BpmnStep {
  ...
  MULTI_INSTANCE_ACTIVATING,
  MULTI_INSTANCE_ACTIVATED,
  MULTI_INSTANCE_COMPLETING,
  MULTI_INSTANCE_COMPLETED,
  MULTI_INSTANCE_TERMINATING,
  MULTI_INSTANCE_EVENT_OCCURRED,

  CALL_ACTIVITY_ACTIVATING,
  CALL_ACTIVITY_ACTIVATED
}

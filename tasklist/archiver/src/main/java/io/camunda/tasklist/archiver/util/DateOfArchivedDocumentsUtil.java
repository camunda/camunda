...
public final class DateOfArchivedDocumentsUtil {
   ...
   * "1h"}) the returned value collapses to the same day as the start, the bucket appears empty, and
  ...
  public static void validateRolloverConfiguration(
    ...
    try {
      ...
      throw new IllegalArgumentException(
          String.format(
              "Invalid archiver configuration: rollover date format '%s' is not a valid date format.",
              dateFormat),
          e);
    }

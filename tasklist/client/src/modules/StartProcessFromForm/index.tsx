...
import {StartProcessFromFormMessage} from 'modules/public-start-form/StartProcessFromFormMessage';
import styles from 'modules/public-start-form/startProcessFromForm.module.scss';

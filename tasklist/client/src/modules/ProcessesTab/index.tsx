...
import {newProcessInstance} from 'modules/processes/newProcessInstance';
import {FirstTimeModal} from 'modules/processes/FirstTimeModal';
import {notificationsStore} from 'modules/notifications/notifications.store';
import {logger} from 'modules/utils/logger';
import {NewProcessInstanceTasksPolling} from './NewProcessInstanceTasksPolling';
import {tracking} from 'modules/tracking';
import {useProcessDefinitions} from 'modules/api/useProcessDefinitions.query';
...
import {useCreateProcessInstance} from 'modules/api/useCreateProcessInstance.mutation';
import {C3EmptyState} from '@camunda/camunda-composite-components';
import EmptyMessageImage from 'modules/processes/empty-message-image.svg';
import {ProcessTile} from 'modules/processes/ProcessTile';
import {getProcessDisplayName} from 'modules/processes/getProcessDisplayName';
...
import {MultitenancyDropdown} from 'modules/multitenancy/MultitenancyDropdown';
import {getStateLocally, storeStateLocally} from 'modules/local-storage';
import {pages} from 'modules/routing';
import {FormModal} from 'modules/processes/FormModal';
import {useUploadDocuments} from 'modules/api/useUploadDocuments.mutation';
import {useProcessStartForm} from 'modules/api/useProcessStartForm.query';
import {useIsMultitenancyEnabled} from 'modules/multitenancy/useIsMultitenancyEnabled';
import {tryParseJSON} from 'modules/features/tasks/details/tryParseJSON';

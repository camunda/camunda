...
import styles from 'modules/tasks/variables-editor/styles.module.scss';
import cn from 'classnames';
import {useFetchFullVariable} from 'modules/api/useFetchFullVariable.mutation';
...
const JSONEditorModal = lazy(async () => {
  const [{loadMonaco}, {JSONEditorModal}] = await Promise.all([
    ...
    import('modules/tasks/variables-editor/JSONEditorModal'),
  ]);
                ...
                <JSONEditorModal
                  ...
                  title={t(
                    state === 'COMPLETED' || typeof assignee !== 'string'
                      ? 'jsonEditorViewVariableTitle'
                      : 'jsonEditorEditVariableTitle',
                  )}
                  readOnly={
                    state === 'COMPLETED' || typeof assignee !== 'string'
                  }

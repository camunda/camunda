...
import {AvailableTaskItem} from 'modules/tasks/available-tasks/AvailableTaskItem';
import {AvailableTasksSkeleton} from 'modules/tasks/available-tasks/AvailableTasksSkeleton';
import styles from 'modules/tasks/available-tasks/styles.module.scss';

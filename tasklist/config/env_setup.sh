...
./config/write_or_replace_var.sh "CAMUNDA_TASKLIST_${DATABASE_CAPS}_URL" "$DATABASE_URL" $MAVEN_CONTEXT
./config/write_or_replace_var.sh "CAMUNDA_TASKLIST_ZEEBE${DATABASE_CAPS}_URL" "$DATABASE_URL" $MAVEN_CONTEXT
./config/write_or_replace_var.sh "CAMUNDA_OPERATE_${DATABASE_CAPS}_URL" "$DATABASE_URL" $MAVEN_CONTEXT
./config/write_or_replace_var.sh "CAMUNDA_OPERATE_ZEEBE${DATABASE_CAPS}_URL" "$DATABASE_URL" $MAVEN_CONTEXT
...
./config/write_or_replace_var.sh "CAMUNDA_DATA_SECONDARYSTORAGE_${DATABASE_CAPS}_URL" "$DATABASE_URL" $MAVEN_CONTEXT

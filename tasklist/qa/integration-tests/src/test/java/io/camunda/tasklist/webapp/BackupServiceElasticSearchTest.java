...
// import static
// io.camunda.tasklist.webapp.es.backup.es.BackupManagerElasticSearch.SNAPSHOT_MISSING_EXCEPTION_TYPE;
...
//    assertTrue(actualMessage.contains(expectedMessage));
//
//    exception = assertThrows(TasklistRuntimeException.class, () ->
// backupService.deleteBackup(1L));
//    actualMessage = exception.getMessage();
//    assertTrue(actualMessage.contains(expectedMessage));
//
...
//    final String expectedMessage =
//        String.format(
//            "Encountered an error connecting to Elasticsearch while retrieving repository with
// name [%s].",
//            repoName);
//    final String actualMessage = exception.getMessage();
//    assertTrue(actualMessage.contains(expectedMessage));
...
//    final String expectedMessage =
//        String.format(
//            "Encountered an error connecting to Elasticsearch while searching for duplicate
// backup. Repository name: [%s].",
//            repoName);
//    final String actualMessage = exception.getMessage();
//    assertTrue(actualMessage.contains(expectedMessage));
//  }
...
//    final String expectedMessage =
//        String.format(
//            "Encountered an error connecting to Elasticsearch while searching for snapshots.
// Repository name: [%s].",
//            repoName);
//    final String actualMessage = exception.getMessage();
//    assertTrue(actualMessage.contains(expectedMessage));
...
//        createSnapshotInfoMock(
//            new
// Metadata().setBackupId(backupId1).setVersion("8.8.8").setPartNo(1).setPartCount(2),
//            UUID.randomUUID().toString(),
//            SnapshotState.SUCCESS);
//    final SnapshotInfo snapshotInfo12 =
//        createSnapshotInfoMock(
//            new
// Metadata().setBackupId(backupId1).setVersion("8.8.8").setPartNo(2).setPartCount(2),
//            UUID.randomUUID().toString(),
//            SnapshotState.SUCCESS);
...
//        createSnapshotInfoMock(
//            new
// Metadata().setBackupId(backupId2).setVersion("8.8.8").setPartNo(1).setPartCount(3),
//            UUID.randomUUID().toString(),
//            SnapshotState.SUCCESS);
//    final SnapshotInfo snapshotInfo22 =
//        createSnapshotInfoMock(
//            new
// Metadata().setBackupId(backupId2).setVersion("8.8.8").setPartNo(2).setPartCount(3),
//            UUID.randomUUID().toString(),
//            SnapshotState.SUCCESS);
//    // IN_PROGRESS
...
//        createSnapshotInfoMock(
//            new
// Metadata().setBackupId(backupId3).setVersion("8.8.8").setPartNo(1).setPartCount(3),
//            UUID.randomUUID().toString(),
//            SnapshotState.SUCCESS);
//    final SnapshotInfo snapshotInfo32 =
//        createSnapshotInfoMock(
//            new
// Metadata().setBackupId(backupId3).setVersion("8.8.8").setPartNo(2).setPartCount(3),
//            UUID.randomUUID().toString(),

...
public class IndexSchemaValidatorIT extends TasklistIntegrationTest {
  ...
  private static final String ORIGINAL_SCHEMA_PATH = "/schema/es/create/tasklist-test.json";
  ...
  public void shouldValidateDynamicIndexWithAddedProperty() throws Exception {
    // Define the IndexDescriptor
    final IndexDescriptor indexDescriptor = new IndexDescriptor() {
      @Override

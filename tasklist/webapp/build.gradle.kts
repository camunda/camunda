...
plugins.withId("java") {
  ...
  tasks.register<Test>("testCoreFeatures") {
    group = "verification"
    description = "Runs the Tasklist Core Features unit-test suite only."
    testClassesDirs = testSourceSet.get().output.classesDirs
    classpath = testSourceSet.get().runtimeClasspath
    include("**/TasklistCoreFeaturesTestSuite.class")
  }
  tasks.register<Test>("testDataLayer") {
    group = "verification"
    description = "Runs the Tasklist Data Layer unit-test suite only."
    testClassesDirs = testSourceSet.get().output.classesDirs
    classpath = testSourceSet.get().runtimeClasspath
    include("**/TasklistDataLayerTestSuite.class")
  }
}

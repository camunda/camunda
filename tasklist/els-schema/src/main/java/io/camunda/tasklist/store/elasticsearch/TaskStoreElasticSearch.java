...
public class TaskStoreElasticSearch implements TaskStore {
  ...
  @Override
  public Map<String, String> getTaskIdsWithIndexByProcessDefinitionId(final String processDefinitionId) {
    final SearchRequest searchRequest =
        ElasticsearchUtil.createSearchRequest(taskTemplate)
            .source(
                SearchSourceBuilder.searchSource()
  ...
  private List<String> getTasksContainsVarNameAndValue(final TaskByVariables[] taskVariablesFilter) {
  ...
  private BoolQueryBuilder returnUserGroupBoolQuery(final List<String> userGroups, final String userName) {

...
@Component
@Configuration
@ConfigurationProperties(LegacyTasklistProperties.PREFIX)
@PropertySource("classpath:tasklist-version.properties")
public class LegacyTasklistProperties {
  ...
  public boolean isAlphaVersion() {
    return getVersion().toLowerCase().contains(LegacyTasklistProperties.ALPHA_RELEASES_SUFIX);
  }
  ...
  public LegacyTasklistProperties setAuth0(final Auth0Properties auth0) {
    this.auth0 = auth0;
    return this;
  }
  ...
  public LegacyTasklistProperties setBackup(final BackupProperties backup) {
    this.backup = backup;
    return this;
  }
  ...
  public LegacyTasklistProperties setVersion(final String version) {
  ...
  public LegacyTasklistProperties setFeatureFlag(final FeatureFlagProperties featureFlag) {
  ...
  public LegacyTasklistProperties setOperatorUserId(final String operatorUserId) {
  ...
  public LegacyTasklistProperties setOperatorPassword(final String operatorPassword) {
  ...
  public LegacyTasklistProperties setOperatorDisplayName(final String operatorDisplayName) {
  ...
  public LegacyTasklistProperties setReaderUserId(final String readerUserId) {
  ...
  public LegacyTasklistProperties setReaderPassword(final String readerPassword) {
  ...
  public LegacyTasklistProperties setReaderDisplayName(final String readerDisplayName) {
  ...
  public LegacyTasklistProperties setOpenSearch(final TasklistOpenSearchProperties openSearch) {
  ...
  public LegacyTasklistProperties setDatabase(final String database) {

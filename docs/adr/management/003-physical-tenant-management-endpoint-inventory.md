...
|      Endpoint      |                                              Behavior                                              |
|--------------------|----------------------------------------------------------------------------------------------------|
| `GET /v2/status`   | Status of the default physical tenant. **Special case: no authentication, no PT-prefix supported** |
...
| `GET /cluster/v2/backups/history?pattern=`       | List history backups across all physical tenants.                                |
...
| `flowControl`                                     | Node, all physical tenants (response schema gains a PT dimension) | Node, filtered to specified physical tenant |
...
### D4. Cluster-wide backup contract

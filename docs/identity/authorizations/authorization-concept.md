...
Authorizations are granted to identity entities (users, roles, groups, mapping rules, clients). See [Identity documentation](../identity.md) for the full data model. The key relationships are:

...
> **Coordinate before deploying.** Each deploy creates a new version of every changed process. If two people deploy different branches, the latest deploy wins. Align in `#c8-release-train-development` before you deploy.

...
4. **Incident propagation:** Alerts are propagated into incident.io, which groups them by GHA workflow job name (unless it is a flood) and raises `C8 Monorepo CI` type incidents, severity L1.

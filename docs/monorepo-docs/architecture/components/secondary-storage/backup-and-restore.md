...
|---------------|------------------------------------------------------------------|
| `Prio1Backup` | State/progress tracking indices, and entity-hierarchy roots (process/decision definitions) whose dependents live in a later tier - must be snapshotted first |
...
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| 1    | **Prio 1 main**: `operate-metadata`, `camunda-history-deletion`, `operate-process`, `operate-decision`, `operate-decision-requirements`                                                                                                                                                                                                                                                                                                               | Import/post-import state, plus entity-hierarchy roots that must precede their dependents |

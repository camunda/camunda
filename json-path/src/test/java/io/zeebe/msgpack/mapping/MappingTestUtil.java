...
public class MappingTestUtil
{
    ...
    static
    {
        ...
        try
        {
            jsonDocumentPath = Paths.get(MsgPackDocumentTreeWriterTest.class.getResource("largeJsonDocument.json")
                                                                            .toURI());
        }
        catch (Exception e)
        {
    ...
    public static void assertThatIsArrayNode(MsgPackTree msgPackTree, String nodeId, String... childs)
    {

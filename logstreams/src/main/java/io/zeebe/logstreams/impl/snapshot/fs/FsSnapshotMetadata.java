...
public class FsSnapshotMetadata implements SnapshotMetadata
{
    ...
    public FsSnapshotMetadata(final String name, final long position, final long size, final boolean replicable, final byte[] checksum)
    {
        this.name = name;
    ...
    public FsSnapshotMetadata(final FsSnapshotStorageConfiguration config, final File snapshotFile, final File checksumFile)
    {
    ...
    private byte[] extractChecksum(final FsSnapshotStorageConfiguration config, final File checksumFile)
    {

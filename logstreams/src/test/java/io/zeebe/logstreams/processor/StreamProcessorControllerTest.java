...
public class StreamProcessorControllerTest
{
    ...
    public void shouldWriteEvent()
    {
        ...
        final UnsafeBuffer eventValue = new UnsafeBuffer(writtenEvent.getValueBuffer(), writtenEvent.getValueOffset(), writtenEvent.getValueLength());

...
public class Bytes2BytesZbMap extends ZbMap<ByteArrayKeyHandler, ByteArrayValueHandler>
    implements Iterable<Bytes2BytesZbMapEntry> {

  protected final ZbMapIterator<ByteArrayKeyHandler, ByteArrayValueHandler, Bytes2BytesZbMapEntry>
      iterator = new ZbMapIterator<>(this, new Bytes2BytesZbMapEntry());

  public Bytes2BytesZbMap(int keyMaxLength, int valueMaxLength) {
    super(keyMaxLength, valueMaxLength);
  }

  public Bytes2BytesZbMap(
      int tableSize, int blocksPerBucket, int keyMaxLength, int valueMaxLength) {

...
public class WorkflowInstanceFunctionalTest
{
    ...
    public void shouldStartWorkflowInstanceAtNoneStartEvent()
    {
        ...
        // then
        final SubscribedRecord workflowCreateCmd = testClient.receiveFirstWorkflowInstanceCommand(WorkflowInstanceIntent.CREATE);
        final SubscribedRecord startEvent = testClient.receiveFirstWorkflowInstanceEvent(WorkflowInstanceIntent.START_EVENT_OCCURRED);
    ...
    public void shouldTakeSequenceFlowFromStartEvent()
    {
        ...
        // then
        final SubscribedRecord startEvent = testClient.receiveFirstWorkflowInstanceEvent(WorkflowInstanceIntent.START_EVENT_OCCURRED);
        final SubscribedRecord sequenceFlow = testClient.receiveFirstWorkflowInstanceEvent(WorkflowInstanceIntent.SEQUENCE_FLOW_TAKEN);
    ...
    public void shouldCreateTaskWhenServiceTaskIsActivated()
    {
        ...
        final SubscribedRecord activityActivated =
            testClient.receiveFirstWorkflowInstanceEvent(WorkflowInstanceIntent.ACTIVITY_ACTIVATED);
        final SubscribedRecord createJobCmd =
            testClient.receiveFirstJobCommand(JobIntent.CREATE);
    ...
    public void shouldCompleteServiceTaskWhenTaskIsCompleted()
    {
        ...
        final SubscribedRecord activityActivatedEvent =
            testClient.receiveFirstWorkflowInstanceEvent(WorkflowInstanceIntent.ACTIVITY_ACTIVATED);
        final SubscribedRecord jobCompleted =
        ...
        assertThat(activityCompletedEvent.sourceRecordPosition()).isEqualTo(activityCompleting.position());
    ...
    public void shouldSpitOnExclusiveGateway()
    {
        ...
        SubscribedRecord endEvent = testClient.receiveFirstWorkflowInstanceEvent(workflowInstance1, WorkflowInstanceIntent.END_EVENT_OCCURRED);
        assertThat(endEvent.value()).containsEntry(PROP_WORKFLOW_ACTIVITY_ID, "a");

        endEvent = testClient.receiveFirstWorkflowInstanceEvent(workflowInstance2, WorkflowInstanceIntent.END_EVENT_OCCURRED);
        assertThat(endEvent.value()).containsEntry(PROP_WORKFLOW_ACTIVITY_ID, "b");

        endEvent = testClient.receiveFirstWorkflowInstanceEvent(workflowInstance3, WorkflowInstanceIntent.END_EVENT_OCCURRED);
    ...
    public void shouldJoinOnExclusiveGateway()
    {
        ...
        testClient.receiveFirstWorkflowInstanceEvent(workflowInstance1, WorkflowInstanceIntent.COMPLETED);
        testClient.receiveFirstWorkflowInstanceEvent(workflowInstance2, WorkflowInstanceIntent.COMPLETED);
    ...
    public void shouldSetSourceRecordPositionCorrectOnJoinXor()
    {
        ...
        List<SubscribedRecord> sequenceFlows = testClient.receiveEvents()
            .withIntent(WorkflowInstanceIntent.SEQUENCE_FLOW_TAKEN)
            .limit(3)
            .collect(Collectors.toList());

        List<SubscribedRecord> gateWays = testClient.receiveEvents()
        ...
        gateWays = testClient.receiveEvents()
            .withIntent(WorkflowInstanceIntent.GATEWAY_ACTIVATED)
            .filter(r -> (Long) r.value().get("workflowInstanceKey") == workflowInstance2)
            .limit(2)
            .collect(Collectors.toList());

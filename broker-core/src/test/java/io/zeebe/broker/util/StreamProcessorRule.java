...
public class StreamProcessorRule implements TestRule {
  ...
  public StreamProcessorControl runStreamProcessor(TestFactory factory) {
    final StreamProcessorControl control = initStreamProcessor(factory);
    control.start();
    return control;
  }
  ...
  public StreamProcessorControl initStreamProcessor(TestFactory factory) {
    ...
    return streams.initStreamProcessor(
        ...
        (db, dbContext) -> {
          ...
          return factory.apply(processorBuilder, db, dbContext);
        });
  }

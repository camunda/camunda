...
import static org.camunda.tngp.broker.configuration.ConfigurationScenario.*;
...
{
    private static final String GLOBAL_DIRECTORY = String.format("%stngp-testing%sglobal-data-path", File.separator, File.separator);
    ...
    public static Collection<ConfigurationScenario> configurations()
    {
        return Arrays.asList(
            ...
            scenario()
                .withConfiguration("tngp.test.global-directory.cfg.toml")
            ...
            scenario()
                .withConfiguration("tngp.test.global-default-directory.cfg.toml")
            ...
            scenario()
                .withConfiguration("tngp.test.global-temp-directory.cfg.toml")
            ...
            scenario()
                .withConfiguration("tngp.test.local-directories.cfg.toml")

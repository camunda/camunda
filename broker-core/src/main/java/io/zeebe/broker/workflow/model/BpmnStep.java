...
public enum BpmnStep {
  ...
  EVENT_BASED_GATEWAY_ELEMENT_READY,
  ...
  EXCLUSIVE_GATEWAY_ELEMENT_READY,

  FLOWOUT_ELEMENT_COMPLETED,

  INTERMEDIATE_CATCH_EVENT_ELEMENT_READY,
  ...
  RECEIVE_TASK_ELEMENT_ACTIVATED,

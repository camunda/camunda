...
public class RequestWorkflowControlRequest extends UnpackedObject
{
    ...
    public RequestWorkflowControlRequest()
    {
    ...
    public RequestWorkflowControlRequest setWorkflowKey(long key)
    {
    ...
    public RequestWorkflowControlRequest setTopicName(String topicName)
    {
    ...
    public RequestWorkflowControlRequest setBpmnProcessId(DirectBuffer directBuffer)
    {
    ...
    public RequestWorkflowControlRequest setVersion(int version)
    {

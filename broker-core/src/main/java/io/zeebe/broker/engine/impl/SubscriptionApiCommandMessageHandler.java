...
import io.zeebe.broker.subscription.command.CloseMessageSubscriptionCommand;
import io.zeebe.broker.subscription.command.CloseWorkflowInstanceSubscriptionCommand;
import io.zeebe.broker.subscription.command.CorrelateMessageSubscriptionCommand;
import io.zeebe.broker.subscription.command.CorrelateWorkflowInstanceSubscriptionCommand;
import io.zeebe.broker.subscription.command.OpenMessageSubscriptionCommand;
import io.zeebe.broker.subscription.command.OpenWorkflowInstanceSubscriptionCommand;
import io.zeebe.broker.subscription.command.RejectCorrelateMessageSubscriptionCommand;

...
public class ReplicationFactorService extends Actor implements Service<ReplicationFactorService>, KnownTopicsListener
{
    ...
    {
        final ActorFuture<NodeInfo> nextSocketAddressFuture = nodeSelector.getNextSocketAddress(partitionNodes.getPartitionInfo());

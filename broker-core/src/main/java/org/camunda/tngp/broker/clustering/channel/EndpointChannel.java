...
public class EndpointChannel
{
    ...
    protected Exception clientChannelException;
    ...
    public ClientChannel getClientChannel()
    {
        ...
        if (clientChannel != null)
        {
            ...
            {
                throw new RuntimeException("Channel with id " + clientChannel.getId() + " not open.");
            }
        }

        if (state == STATE_FAILED)
        {
            throw new RuntimeException(clientChannelException);
        }

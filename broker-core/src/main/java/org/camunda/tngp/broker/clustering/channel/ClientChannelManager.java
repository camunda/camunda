...
public class ClientChannelManager
{
    ...
    public EndpointChannel claim(final Endpoint endpoint)
    {
        ...
        if (idx < 0)
        {
            ...
            endpointChannel = createEndpointChannel(endpoint);
    ...
    protected EndpointChannel createEndpointChannel(final Endpoint endpoint)
    {
        final Endpoint copy = endpoint.copy();
        final EndpointChannel endpointChannel = new EndpointChannel(copy);

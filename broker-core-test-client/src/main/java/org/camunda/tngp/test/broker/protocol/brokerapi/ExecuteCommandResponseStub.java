...
public class ExecuteCommandResponseStub implements ResponseStub<ExecuteCommandRequest>
{
    ...
    protected Function<ExecuteCommandRequest, Boolean> activationFunction;
    ...
    public ExecuteCommandResponseStub(MsgPackHelper msgPackHelper, Function<ExecuteCommandRequest, Boolean> activationFunction)
    {

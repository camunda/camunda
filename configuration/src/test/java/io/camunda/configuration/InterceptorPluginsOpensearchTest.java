...
public class InterceptorPluginsOpensearchTest {
  ...
  @TestPropertySource(
      properties = {
        ...
        "camunda.data.secondary-storage.opensearch.interceptor-plugins.0.id=0Id",
        "camunda.data.secondary-storage.opensearch.interceptor-plugins.0.class-name=0ClassName",
        "camunda.data.secondary-storage.opensearch.interceptor-plugins.0.jar-path=0JarPath",
        "camunda.data.secondary-storage.opensearch.interceptor-plugins.1.id=1Id",
        "camunda.data.secondary-storage.opensearch.interceptor-plugins.1.class-name=1ClassName",
        "camunda.data.secondary-storage.opensearch.interceptor-plugins.1.jar-path=1JarPath"
      })
  ...
  @TestPropertySource(
      properties = {
        "camunda.data.secondary-storage.type=opensearch",
        // legacy operate
        "camunda.operate.opensearch.interceptorPlugins.0.id=0Id",
        "camunda.operate.opensearch.interceptorPlugins.0.className=0ClassName",
        "camunda.operate.opensearch.interceptorPlugins.0.jarPath=0JarPath",
  ...
  @TestPropertySource(
      properties = {
        ...
        "camunda.data.secondary-storage.opensearch.interceptor-plugins.1.jar-path=1JarPath",
        // legacy operate
        "camunda.operate.opensearch.interceptorPlugins.0.id=0IdOperate",
        "camunda.operate.opensearch.interceptorPlugins.0.className=0ClassNameOperate",
        "camunda.operate.opensearch.interceptorPlugins.0.jarPath=0JarPathOperate",

...
class AuditLogTest {
  ...
  @TestPropertySource(
      properties = {
        ...
        "camunda.data.audit-log.unknown.categories[1]=USER_TASKS",
        "camunda.data.audit-log.unknown.excludes[0]=BATCH"
      })
  class RDBMSExporterTest {
    ...
    void shouldPopulateWithAuditLog(@Autowired final BrokerBasedProperties brokerBasedProperties) {
      ...
      assertThat(config.getAuditLog().getUnknown().getExcludes())
          .containsExactlyInAnyOrder(AuditLogEntityType.BATCH);
    }
  }

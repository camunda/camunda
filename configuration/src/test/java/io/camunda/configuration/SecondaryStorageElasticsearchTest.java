...
public class SecondaryStorageElasticsearchTest {
  ...
  class WithConnectionPoolOnUnifiedConfig {
    final BrokerBasedProperties brokerBasedProperties;
    final SearchEngineConnectProperties searchEngineConnectProperties;

    WithConnectionPoolOnUnifiedConfig(
        @Autowired final BrokerBasedProperties brokerBasedProperties,
        @Autowired final SearchEngineConnectProperties searchEngineConnectProperties) {
      this.brokerBasedProperties = brokerBasedProperties;
      this.searchEngineConnectProperties = searchEngineConnectProperties;
    ...
    void shouldApplyConnectionPoolToCamundaExporter() {
      // given
      final Map<String, Object> args = camundaExporterArgs(brokerBasedProperties);
  ...
  class WithConnectionPoolOnlyOnTheExporter {
    final BrokerBasedProperties brokerBasedProperties;
    final SearchEngineConnectProperties searchEngineConnectProperties;

    WithConnectionPoolOnlyOnTheExporter(
        @Autowired final BrokerBasedProperties brokerBasedProperties,
        @Autowired final SearchEngineConnectProperties searchEngineConnectProperties) {
      this.brokerBasedProperties = brokerBasedProperties;
      this.searchEngineConnectProperties = searchEngineConnectProperties;

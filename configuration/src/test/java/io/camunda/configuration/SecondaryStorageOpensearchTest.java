...
public class SecondaryStorageOpensearchTest {
  ...
  @TestPropertySource(
      properties = {
        ...
        "camunda.provider-auth.aws.access-key=" + EXPECTED_AWS_ACCESS_KEY,
        "camunda.provider-auth.aws.secret-key=" + EXPECTED_AWS_SECRET_KEY,
        "camunda.data.secondary-storage.opensearch.aws-region=" + EXPECTED_AWS_REGION,

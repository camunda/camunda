...
public class ActorIdleStrategyConfiguration {
  private static final String PREFIX = "camunda.system.actor.idle.";
  private static final Set<String> LEGACY_MAX_SPINS_PROP = Set.of("zeebe.actor.idle.maxSpins");
  private static final Set<String> LEGACY_MAX_YIELDS_PROP = Set.of("zeebe.actor.idle.maxYields");
  private static final Set<String> LEGACY_MIN_PARK_PERIOD_PROP =
      Set.of("zeebe.actor.idle.minParkPeriod");
  private static final Set<String> LEGACY_MAX_PARK_PERIOD_PROP =

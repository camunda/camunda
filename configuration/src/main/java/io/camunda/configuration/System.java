...
public class System {
  ...
  private static final Set<String> LEGACY_CPU_THREAD_COUNT_PROP =
      Set.of("zeebe.broker.threads.cpuThreadCount");
  private static final Set<String> LEGACY_IO_THREAD_COUNT_PROP =
      Set.of("zeebe.broker.threads.ioThreadCount");
  private static final Set<String> LEGACY_CLOCK_CONTROLLED_PROP = Set.of("zeebe.clock.controlled");
   ...
   * cores for ioThreads and the operating system (it has to run somewhere). For example, when

...
public class S3 {
  ...
  private static final Set<String> LEGACY_ACCESSKEY_PROPERTIES =
      Set.of("zeebe.broker.data.backup.s3.accessKey");
  private static final Set<String> LEGACY_SECRETKEY_PROPERTIES =
      Set.of("zeebe.broker.data.backup.s3.secretKey");
  private static final Set<String> LEGACY_APICALLTIMEOUT_PROPERTIES =
      Set.of("zeebe.broker.data.backup.s3.apiCallTimeout");
  private static final Set<String> LEGACY_FORCEPATHATYLEACCESS_PROPERTIES =
  ...
  private static final Set<String> LEGACY_MAXCONCURRENTCONNECTIONS_PROPERTIES =
      Set.of("zeebe.broker.data.backup.s3.maxConcurrentConnections");
  private static final Set<String> LEGACY_CONNECTIONAQUISITIONTIMEOUT_PROPERTIES =
      Set.of("zeebe.broker.data.backup.s3.connectionAcquisitionTimeout");
  private static final Set<String> LEGACY_SUPPPORTLEGACYMD5_PROPERTIES =
  ...
  public Duration getApiCallTimeout() {
    return UnifiedConfigurationHelper.validateLegacyConfiguration(
        ...
        Duration.class,
        BackwardsCompatibilityMode.SUPPORTED,
        LEGACY_APICALLTIMEOUT_PROPERTIES);
  }
  ...
  public boolean isForcePathStyleAccess() {
    return UnifiedConfigurationHelper.validateLegacyConfiguration(
        ...
        Boolean.class,
        BackwardsCompatibilityMode.SUPPORTED,
        LEGACY_FORCEPATHATYLEACCESS_PROPERTIES);
  }
  ...
  public int getMaxConcurrentConnections() {
    return UnifiedConfigurationHelper.validateLegacyConfiguration(
        ...
        Integer.class,
        BackwardsCompatibilityMode.SUPPORTED,
        LEGACY_MAXCONCURRENTCONNECTIONS_PROPERTIES);
  }
  ...
  public Duration getConnectionAcquisitionTimeout() {
    return UnifiedConfigurationHelper.validateLegacyConfiguration(
        ...
        Duration.class,
        BackwardsCompatibilityMode.SUPPORTED,
        LEGACY_CONNECTIONAQUISITIONTIMEOUT_PROPERTIES);
  }
  ...
  public boolean isSupportLegacyMd5() {
    return UnifiedConfigurationHelper.validateLegacyConfiguration(
        ...
        Boolean.class,
        BackwardsCompatibilityMode.SUPPORTED,
        LEGACY_SUPPPORTLEGACYMD5_PROPERTIES);
  }

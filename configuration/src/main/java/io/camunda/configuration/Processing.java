...
public class Processing {
  ...
  /**
   * Changes the DueDateTimerCheckScheduler to give yield to other processing steps in situations where it
   * has many (i.e. millions of) timers to process. If set to false (default) the
   * DueDateTimerCheckScheduler will activate all due timers. In the worst case, this can lead to the node

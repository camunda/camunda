...
public final class JobStreamApiServer extends Actor implements ClusterMembershipEventListener {
  private final ClusterCommunicationService transport;
  private final StreamApiHandler<JobActivationProperties> requestHandler;

  public JobStreamApiServer(
      final ClusterCommunicationService transport,
      final StreamApiHandler<JobActivationProperties> requestHandler) {

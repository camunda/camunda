...
import static io.zeebe.legacy.tomlconfig.gateway.ConfigurationDefaults.DEFAULT_CLUSTER_HOST;
import static io.zeebe.legacy.tomlconfig.gateway.ConfigurationDefaults.DEFAULT_CLUSTER_MEMBER_ID;
import static io.zeebe.legacy.tomlconfig.gateway.ConfigurationDefaults.DEFAULT_CLUSTER_NAME;
import static io.zeebe.legacy.tomlconfig.gateway.ConfigurationDefaults.DEFAULT_CLUSTER_PORT;
import static io.zeebe.legacy.tomlconfig.gateway.ConfigurationDefaults.DEFAULT_CONTACT_POINT_HOST;
import static io.zeebe.legacy.tomlconfig.gateway.ConfigurationDefaults.DEFAULT_CONTACT_POINT_PORT;
import static io.zeebe.legacy.tomlconfig.gateway.ConfigurationDefaults.DEFAULT_REQUEST_TIMEOUT;
import static io.zeebe.legacy.tomlconfig.gateway.EnvironmentConstants.ENV_GATEWAY_CLUSTER_HOST;
import static io.zeebe.legacy.tomlconfig.gateway.EnvironmentConstants.ENV_GATEWAY_CLUSTER_MEMBER_ID;
import static io.zeebe.legacy.tomlconfig.gateway.EnvironmentConstants.ENV_GATEWAY_CLUSTER_NAME;
import static io.zeebe.legacy.tomlconfig.gateway.EnvironmentConstants.ENV_GATEWAY_CLUSTER_PORT;
import static io.zeebe.legacy.tomlconfig.gateway.EnvironmentConstants.ENV_GATEWAY_CONTACT_POINT;
import static io.zeebe.legacy.tomlconfig.gateway.EnvironmentConstants.ENV_GATEWAY_REQUEST_TIMEOUT;

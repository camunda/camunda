...
import static io.zeebe.legacy.tomlconfig.broker.EnvironmentConstants.ENV_ADVERTISED_HOST;
import static io.zeebe.legacy.tomlconfig.broker.EnvironmentConstants.ENV_HOST;
import static io.zeebe.legacy.tomlconfig.broker.EnvironmentConstants.ENV_PORT_OFFSET;

import io.zeebe.legacy.tomlconfig.broker.SocketBindingCfg.CommandApiCfg;
import io.zeebe.legacy.tomlconfig.broker.SocketBindingCfg.InternalApiCfg;
import io.zeebe.legacy.tomlconfig.broker.SocketBindingCfg.MonitoringApiCfg;
import io.zeebe.legacy.tomlconfig.util.ByteValueParser;

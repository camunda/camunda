...
public class DeleteHistoryTemplate extends AbstractTemplateDescriptor implements Prio2Backup {
  ...
  public DeleteHistoryTemplate(final String indexPrefix, final boolean isElasticsearch) {

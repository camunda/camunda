...
public class PersistentAuthorizedClientIndexDescriptor extends AbstractIndexDescriptor
    implements Prio5Backup {

  public static final String INDEX_NAME = "authorized-clients";
  public static final String INDEX_VERSION = "8.8.0";

  public PersistentAuthorizedClientIndexDescriptor(

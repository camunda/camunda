...
* [What is Camunda Platform 8?](https://docs.camunda.io/docs/next/components/)
* [Getting Started Tutorial](https://docs.camunda.io/docs/guides/)
* [Technical Concepts](https://docs.camunda.io/docs/next/components/zeebe/technical-concepts/technical-concepts-overview/)
...
* [Java Client](https://docs.camunda.io/docs/next/apis-tools/java-client/)

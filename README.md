...
* Moreover, every branch will be deployed at $branch_name.operate.camunda.cloud (e.s. `amazing-feature.operate.camunda.cloud`).

## Branch name flags

* Every branch that ends with `-nodeploy` (e.g. `amazing-feature-nodeploy`) will not be deployed.

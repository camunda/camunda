...
public interface ManagementSubscriptionBuilderStep1
{
    ...
    interface ManagementSubscriptionBuilderStep2
    {
         ...
         *
         * @param handler
         *            the handler to process all deployment events
         * @return the builder for this subscription
         */
         ...
         *
         * @param handler
         *            the handler to process all deployment commands
         * @return the builder for this subscription
         */
         ...
         *
         * @param handler
         *            the handler to process all topic events
         * @return the builder for this subscription
         */
         ...
         *
         * @param handler
         *            the handler to process all topic commands
         * @return the builder for this subscription
         */
    ...
    interface ManagementSubscriptionBuilderStep3 extends ManagementSubscriptionBuilderStep2
    {
         ...
         *
         * @param position
         *            the position at which to start publishing events from
         * @return the builder for this subscription
         */

...
/**
 * Represents an active job worker that perfors jobs of a certain type. While a registration is open,
 * the client continuously receives jobs from the broker and hands them to a registered
 * {@link JobHandler}.
 */

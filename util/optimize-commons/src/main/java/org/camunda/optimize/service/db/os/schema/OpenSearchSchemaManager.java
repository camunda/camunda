...
import static org.camunda.optimize.service.db.os.schema.OpenSearchIndexSettingsBuilder.buildDynamicSettings;
...
import org.camunda.optimize.service.db.os.schema.index.CollectionIndexOS;
import org.camunda.optimize.service.db.os.schema.index.DashboardIndexOS;
import org.camunda.optimize.service.db.os.schema.index.DashboardShareIndexOS;
...
import org.camunda.optimize.service.db.os.schema.index.InstantPreviewDashboardMetadataIndexOS;
import org.camunda.optimize.service.db.os.schema.index.LicenseIndexOS;
import org.camunda.optimize.service.db.os.schema.index.MetadataIndexOS;
import org.camunda.optimize.service.db.os.schema.index.OnboardingStateIndexOS;
import org.camunda.optimize.service.db.os.schema.index.ProcessDefinitionIndexOS;
import org.camunda.optimize.service.db.os.schema.index.ProcessOverviewIndexOS;
import org.camunda.optimize.service.db.os.schema.index.ReportShareIndexOS;
import org.camunda.optimize.service.db.os.schema.index.SettingsIndexOS;
import org.camunda.optimize.service.db.os.schema.index.TenantIndexOS;
import org.camunda.optimize.service.db.os.schema.index.TerminatedUserSessionIndexOS;
import org.camunda.optimize.service.db.os.schema.index.VariableLabelIndexOS;
...
import org.camunda.optimize.service.db.os.schema.index.events.EventProcessMappingIndexOS;
import org.camunda.optimize.service.db.os.schema.index.events.EventProcessPublishStateIndexOS;
import org.camunda.optimize.service.db.os.schema.index.index.ImportIndexIndexOS;
import org.camunda.optimize.service.db.os.schema.index.index.PositionBasedImportIndexOS;
import org.camunda.optimize.service.db.os.schema.index.index.TimestampBasedImportIndexOS;
...
public class OpenSearchSchemaManager
  ...
  private void createIndex(
    ...
    final boolean created =
        osClient.getRichOpenSearchClient().index().createIndexWithRetries(createIndexRequest);
    if (created) {

...
// TODO decide the future of this class with OPT-7352
public abstract class JavaCollectionOperationsUtil {
  ...
  public static Map<String, Object> asMap(Object... keyValuePairs) {
    if (keyValuePairs == null || keyValuePairs.length % 2 != 0) {
      throw new OptimizeRuntimeException("keyValuePairs should not be null and has a even length.");
    }

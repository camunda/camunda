...
public class AllocationUtil {
  ...
  static {
    final Object hack =
        AccessController.doPrivileged((PrivilegedAction<Object>) AllocationUtil::unmapHackImpl);
  ...
  private static Object unmapHackImpl() {
    ...
    try {
      ...
      return "Unmapping is not supported, because not all required permissions are given to file: "
          + se
          + " [Please grant at least the following permissions: RuntimePermission(\"accessClassInPackage.sun.misc\") "
          + " and ReflectPermission(\"suppressAccessChecks\")]";
    } catch (ReflectiveOperationException | RuntimeException e) {
      return "Unmapping is not supported on this platform, because internal Java APIs are not compatible: "
          + e;
    }
  }

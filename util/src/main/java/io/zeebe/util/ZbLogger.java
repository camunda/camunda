...
/**
 * Delegating Logger implementation which guards all invocations with static checks for the log level.
 * Allows the JVM to remove log statements which are not needed with the current log level. Removes the
 * possibility to dynamically change the log level.
 */

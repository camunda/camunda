...
/**
 * Maintains multiple levels of queues for each thread. Levels can be used for priorities
 * (each thread maintains a queue for each priority) or other things like IO-devices.
 */

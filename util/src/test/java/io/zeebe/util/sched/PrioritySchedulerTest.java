...
public class PrioritySchedulerTest
{
    ...
    public void testRequestsTasksAccordingToPriorityQuotas()
    {
        ...
        final PriorityScheduler scheduler = new PriorityScheduler(getTaskFn, new double[] {0.2, 0.3, 0.5});
    ...
    public void testRequestsTasksAccordingToPriorityQuotas2Runs()
    {
        ...
        final PriorityScheduler scheduler = new PriorityScheduler(getTaskFn, new double[] {0.3, 0.3, 0.4});

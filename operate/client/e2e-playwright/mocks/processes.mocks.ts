...
function mockResponses({
  ...
  processDefinitions?: QueryProcessDefinitionsResponseBody;
  ...
  return (route: Route) => {
    ...
    if (route.request().url().includes('/v2/process-definitions/search')) {
      return route.fulfill({
        status: processDefinitions === undefined ? 400 : 200,
...
const mockAhspProcessDefinitions: QueryProcessDefinitionsResponseBody = {
  items: [
    {

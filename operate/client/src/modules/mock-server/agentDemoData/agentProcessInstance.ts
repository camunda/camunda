...
import {
  ...
  MOCK_AGENT_INNER_INSTANCE_5_KEY,
  MOCK_AGENT_TASK_AGENT_INSTANCE_KEY,
...
export const MOCK_AGENT_ELEMENT_INSTANCES: MockElementInstance[] = [
  ...
  {
    elementInstanceKey: MOCK_AGENT_INNER_INSTANCE_1_KEY,
    processInstanceKey: MOCK_AGENT_INSTANCE_KEY,
    processDefinitionKey: MOCK_AGENT_DEFINITION_KEY,
    processDefinitionId: MOCK_AGENT_DEFINITION_ID,
    elementId: 'AI_Agent',
  ...
  },
  {
    ...
    state: 'COMPLETED',
    hasIncident: false,
    flowScopeKey: MOCK_AGENT_INNER_INSTANCE_1_KEY,
    rootProcessInstanceKey: null,
    tenantId: '<default>',
    startDate: '2026-03-26T14:30:01.200Z',
    endDate: '2026-03-26T14:30:02.800Z',
  ...
  {
    elementInstanceKey: MOCK_AGENT_INNER_INSTANCE_2_KEY,
    processInstanceKey: MOCK_AGENT_INSTANCE_KEY,
    processDefinitionKey: MOCK_AGENT_DEFINITION_KEY,
    processDefinitionId: MOCK_AGENT_DEFINITION_ID,
    elementId: 'AI_Agent',
  ...
  },
  {
    ...
    state: 'COMPLETED',
    hasIncident: false,
    flowScopeKey: MOCK_AGENT_INNER_INSTANCE_2_KEY,
    rootProcessInstanceKey: null,
    tenantId: '<default>',
    startDate: '2026-03-26T14:30:03.000Z',
    endDate: '2026-03-26T14:30:04.100Z',
  ...
  {
    elementInstanceKey: MOCK_AGENT_INNER_INSTANCE_3_KEY,
    processInstanceKey: MOCK_AGENT_INSTANCE_KEY,
    processDefinitionKey: MOCK_AGENT_DEFINITION_KEY,
    processDefinitionId: MOCK_AGENT_DEFINITION_ID,
    elementId: 'AI_Agent',
  ...
  },
  {
    ...
    state: 'COMPLETED',
    hasIncident: false,
    flowScopeKey: MOCK_AGENT_INNER_INSTANCE_3_KEY,
    rootProcessInstanceKey: null,
    tenantId: '<default>',
    startDate: '2026-03-26T14:30:03.050Z',
    endDate: '2026-03-26T14:30:04.150Z',
  ...
  {
    elementInstanceKey: MOCK_AGENT_INNER_INSTANCE_4_KEY,
    processInstanceKey: MOCK_AGENT_INSTANCE_KEY,
    processDefinitionKey: MOCK_AGENT_DEFINITION_KEY,
    processDefinitionId: MOCK_AGENT_DEFINITION_ID,
    elementId: 'AI_Agent',
  ...
  },
  {
    ...
    state: 'ACTIVE',
    hasIncident: false,
    flowScopeKey: MOCK_AGENT_INNER_INSTANCE_4_KEY,
    rootProcessInstanceKey: null,
    tenantId: '<default>',
    startDate: '2026-03-26T14:30:04.300Z',
    endDate: null,
  ...
  {
    elementInstanceKey: MOCK_AGENT_INNER_INSTANCE_5_KEY,
    processInstanceKey: MOCK_AGENT_INSTANCE_KEY,
    processDefinitionKey: MOCK_AGENT_DEFINITION_KEY,
    processDefinitionId: MOCK_AGENT_DEFINITION_ID,
    elementId: 'AI_Agent',
  ...
  {
    elementInstanceKey: MOCK_AGENT_TASK_AGENT_INSTANCE_KEY,
    processInstanceKey: MOCK_AGENT_INSTANCE_KEY,
    processDefinitionKey: MOCK_AGENT_DEFINITION_KEY,
    processDefinitionId: MOCK_AGENT_DEFINITION_ID,
    ...
    state: 'ACTIVE',
    hasIncident: false,
    flowScopeKey: MOCK_AGENT_INNER_INSTANCE_5_KEY,
    rootProcessInstanceKey: null,
    tenantId: '<default>',
    startDate: '2026-03-26T14:30:04.320Z',
    endDate: null,

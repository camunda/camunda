...
describe('useProcessInstance', () => {
  ...
  it('should fetch process instance successfully', async () => {
    ...
    const {result} = renderHook(() => useProcessInstance(), {
      wrapper: Wrapper,
    });
  ...
  it('should apply select function correctly', async () => {
    ...
    const select = (data: ProcessInstance) => data.state;

    const {result} = renderHook(() => useProcessInstance(select), {
      wrapper: Wrapper,
    });

...
const createDeletionBatchOperation = async (
  payload: CreateDeletionBatchOperationRequestBody,
) => {
  return requestWithThrow<CreateDeletionBatchOperationResponseBody>({
    url: endpoints.createDeletionBatchOperation.getUrl(),

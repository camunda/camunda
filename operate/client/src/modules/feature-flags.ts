...
const IS_FLOWNODE_INSTANCE_STATISTICS_V2_ENABLED = false;
const IS_PROCESS_INSTANCE_STATISTICS_V2_ENABLED = false;
const IS_PROCESS_SEQUENCE_FLOWS_V2_ENABLED = false;

...
export const mockBatchOperations: BatchOperation[] = [
  ...
  // Active - Cancel Process Instance
  {
    ...
    appliedBy: 'system-cleanup-client',
  ...
  // Completed - Migrate Process Instance (large batch with >1K items)
  {
    ...
    appliedBy: 'data-migrator-client',

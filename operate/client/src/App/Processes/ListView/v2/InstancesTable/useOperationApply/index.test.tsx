...
import useOperationApply from './index.ts';
import {renderHook, waitFor} from 'modules/testing-library.ts';
...
import {processesStore} from 'modules/stores/processes/processes.list.ts';
import {mockData} from './index.setup.ts';
import {
  mockProcessInstances,
  createBatchOperation,
  mockProcessDefinitions,
} from 'modules/testUtils.tsx';
import {mockFetchProcessInstances} from 'modules/mocks/api/processInstances/fetchProcessInstances.ts';
import {mockApplyBatchOperation} from 'modules/mocks/api/processInstances/operations.ts';
import * as operationsApi from 'modules/api/processInstances/operations.ts';
import {mockServer} from 'modules/mock-server/node.ts';
import {http, HttpResponse} from 'msw';
import {mockSearchProcessDefinitions} from 'modules/mocks/api/v2/processDefinitions/searchProcessDefinitions.ts';

              ...
              <DangerButton
                title={
                  (runningInstancesCount ?? 0) > 0
                    ? `Delete Process Definition "${processName} - Version ${processVersion}". It has running instances, so it will be scheduled for deletion and removed once they finish.`

...
import {
  hasEmbeddedForm,
  hasProcessEmbeddedForm,
} from 'modules/bpmn-js/utils/hasEmbeddedForm';
...
const BottomPanel: React.FC = observer(() => {
  ...
  const hasUserTaskEmbeddedFormMigration = () => {
    return hasProcessEmbeddedForm(sourceData);
  };
  ...
  return (
    <BottomSection>
                    ...
                    <LeftColumn>
                      {isEmbeddedFormMigration(
                        ...
                        <Tooltip
                          ...
                          align="right-bottom"
                          className={'MenuButton cds--icon-tooltip'}
                          leaveDelayMs={50}
                        >
                          <WarningFilled />
                        </Tooltip>
      ...
      {hasUserTaskEmbeddedFormMigration() && (

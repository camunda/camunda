...
export const mockOperationLog: MockAuditLogEntry[] = [
  ...
  },
  {
    ...
    operationType: 'COMPLETE_USER_TASK',
    operationState: 'success',
    startTimestamp: new Date(Date.now() - 95000).toISOString(),
    user: 'ml-inference-agent',
    agentElementId: 'UserTask_ApproveOrder',
    details: {
      userTask: {
        name: 'Approve order',
        elementId: 'UserTask_ApproveOrder',
        assignee: 'ml-inference-agent',
        action: 'complete',
      },
    },
  },
  {
    ...
    operationType: 'ASSIGN_USER_TASK',
    operationState: 'success',
    startTimestamp: new Date(Date.now() - 105000).toISOString(),
    user: 'process-ai-copilot',
    agentElementId: 'UserTask_ReviewClaim',
    details: {
      userTask: {
        name: 'Review claim',
        elementId: 'UserTask_ReviewClaim',
        assignee: 'claims-specialist',
        oldAssignee: 'process-ai-copilot',
        action: 'assign',
      },
    },
  },
  {
    ...
    operationType: 'RESOLVE_INCIDENT',
    operationState: 'success',
    startTimestamp: new Date(Date.now() - 115000).toISOString(),
    user: 'smart-recovery-bot',
    agentElementId: 'ServiceTask_ProcessPayment',

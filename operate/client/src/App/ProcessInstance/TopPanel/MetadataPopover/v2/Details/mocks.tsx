...
>>>>>>> 2fceaf075e4 (feat: migrate element instances data)
...
=======
const renderDetails = (
  metaData: V2MetaDataDto = baseMetaData,
  elementId = 'Task_1',
) => {
  return render(<Details metaData={metaData} elementId={elementId} />, {
    wrapper: TestWrapper,
  });
};

export {renderDetails, baseMetaData};
>>>>>>> 2fceaf075e4 (feat: migrate element instances data)

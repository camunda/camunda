...
describe('<ViewFullVariableButton />', () => {
  ...
  it('should not show edit toggle button in show mode when canEdit is false', async () => {
    const mockVariableName = 'foo-variable';
    const mockVariableKey = 'variable-key-123';
    const mockVariableValue = '{"foo": "bar", "test": 123}';
  ...
  it('should allow switching to edit mode in show mode when canEdit is true', async () => {
    const mockVariableName = 'foo-variable';
    const mockVariableKey = 'variable-key-123';
    const mockVariableValue = '{"foo": "bar", "test": 123}';

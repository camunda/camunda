...
public class IncidentStatisticsReader extends AbstractReader
  ...
  public Set<IncidentsByProcessGroupStatisticsDto> getProcessAndIncidentsStatistics() {
    final QueryBuilder pisWithReadPermissionQuery =
        createQueryForProcessesInstancesWithReadPermission();
  ...
  public Set<IncidentsByErrorMsgStatisticsDto> getIncidentStatisticsByError() {
    ...
    final var query =
        joinWithAnd(ACTIVE_INCIDENT_QUERY, createQueryForProcessesInstancesWithReadPermission());
   ...
   */
  private QueryBuilder createQueryForProcessesInstancesWithReadPermission() {

...
public class Auth0Service {
  ...
  public Authentication authenticate(final HttpServletRequest req, final HttpServletResponse res)
    ...
    try {
      final Tokens tokens = retrieveTokens(req);
  ...
  public String getAuthorizeUrl(final HttpServletRequest req, final HttpServletResponse res) {
    return authenticationController
        .buildAuthorizeUrl(req, getRedirectURI(req, SSO_CALLBACK_URI, true))
  ...
  public Tokens retrieveTokens(final HttpServletRequest req) throws Exception {
    return RetryOperation.<Tokens>newBuilder()
        ...
        .retryConsumer(() -> authenticationController.handle(req))

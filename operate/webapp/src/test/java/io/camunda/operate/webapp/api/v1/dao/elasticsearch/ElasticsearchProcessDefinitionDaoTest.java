...
class ElasticsearchProcessDefinitionDaoTest {
  ...
  @Spy private ElasticsearchProcessDefinitionDao underTest;

  @BeforeEach
  void setup() {
    underTest = new ElasticsearchProcessDefinitionDao();
  }

  @Test
  void testBuildFilteringWithValidFields() {
    // Given
    final SearchSourceBuilder mockSearchSourceBuilder = mock(SearchSourceBuilder.class);

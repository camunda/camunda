...
public class ElasticsearchPostImportActionIT extends AbstractElasticsearchConnectorProxyIT {
  ...
  public void setUp() throws IOException {
    ...
    ImportPositionEntity startPosition = new ImportPositionEntity();
  ...
  private void createProcessInstance(String key, Consumer<Map<String, Object>> propertiesCreator) {
    ...
    Map<String, Object> joinRelation = new HashMap<String, Object>();
  ...
  private void createFlowNodeInstance(
    ...
    Map<String, Object> listViewFlowNodeInstance = new HashMap<String, Object>();
    ...
    Map<String, Object> flowNodeInstance = new HashMap<String, Object>();
  ...
  public void shouldUseCorrectRoutingValueWhenUpdatingFlowNodeInstance()
    ...
    String callingProcessInstanceKey = "1";
    createProcessInstance(callingProcessInstanceKey, map -> {});

    String callingFlowNodeInstanceKey = "2";
    createFlowNodeInstance(
        callingFlowNodeInstanceKey, callingProcessInstanceKey, map -> {}, map -> {});

    String calledProcessInstanceKey = "3";
    TreePath calledProcessInstanceTreePath =
        new TreePath()
    ...
    String calledFlowNodeInstanceKey = "4";
    createFlowNodeInstance(
    ...
    Long incidentKey = 25_000_000_000L;
    String postImporterQueueKey = "1";
    Map<String, Object> postImporterQueueEntry = new HashMap<String, Object>();
    ...
    String incidentFlowNodeId = "incidentActivity";

    Map<String, Object> incidentEntry = new HashMap<String, Object>();
    ...
    // then
    List<LoggedRequest> requestsSent =
        WIRE_MOCK_SERVER
    ...
    LoggedRequest bulkRequest = requestsSent.get(0);
    List<JsonNode> bulkActions = parseActions(bulkRequest.getBodyAsString());

    // the update for the calling flow node instance was correctly routed to the calling process
    // instance
    List<JsonNode> updatesForCallingListViewFlowNodeInstance =
    ...
    String routingKeyForCallingListViewFlowNodeInstance =
    ...
    // instance
    List<JsonNode> updatesForCalledListViewFlowNodeInstance =
    ...
    String routingKeyForCalledListViewFlowNodeInstance =
  ...
  private List<JsonNode> parseActions(String bulkRequestBody) throws IOException {
    ...
    MappingIterator<JsonNode> iterator = reader.readValues(bulkRequestBody);
  ...
  @Test
  public void todo() {
    fail("Make sure this runs as part of the right CI build");
    fail("make sure the Opensearch build doesn't run this");
  }
}

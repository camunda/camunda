...
public class ProcessInstanceZeebeIT extends OperateZeebeAbstractIT {
  ...
  public void testProcessInstanceCreated() {
    ...
    searchTestRule.waitFor(flowNodeIsActiveCheck, processInstanceKey, "taskA");
  ...
  public void testVariablesAreLoaded() {
    ...
    searchTestRule.waitFor(processInstanceIsCreatedCheck, processInstanceKey);
    searchTestRule.waitFor(flowNodeIsActiveCheck, processInstanceKey, "taskA");
    searchTestRule.waitFor(variableExistsCheck, processInstanceKey, "a");
  ...
  public void testProcessInstanceEventBasedGatewayIsActive() {
    ...
    searchTestRule.waitFor(flowNodeIsActiveCheck, processInstanceKey, "gateway");
  ...
  public void testJobFailedWithRetriesLeft() {
    ...
    searchTestRule.waitFor(processInstanceIsCreatedCheck, processInstanceKey);
    searchTestRule.waitFor(processInstanceIsCreatedCheck, processInstanceKey2);
  ...
  public void testEventSubprocess() {
    ...
    // when
    searchTestRule.waitFor(flowNodeIsTerminatedCheck, processInstanceKey, "taskA");

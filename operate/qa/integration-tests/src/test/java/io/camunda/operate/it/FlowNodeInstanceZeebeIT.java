...
public class FlowNodeInstanceZeebeIT extends OperateZeebeAbstractIT {
  ...
  public void testFlowNodeInstanceTreeSeveralQueriesInOne() throws Exception {
    ...
    searchTestRule.waitFor(flowNodesAreCompletedCheck, processInstanceKey, flowNodeId1, 2);
    searchTestRule.waitFor(flowNodesAreCompletedCheck, processInstanceKey, subprocessFlowNodeId, 1);
  ...
  public void testFlowNodeInstanceTreeIsBuild() throws Exception {
    ...
    searchTestRule.waitFor(flowNodeIsActiveCheck, processInstanceKey, "taskC");
  ...
  public void testFlowNodeStateDtos() throws Exception {
    ...
    searchTestRule.waitFor(flowNodesAreCompletedCheck, processInstanceKey, "taskB", 9);

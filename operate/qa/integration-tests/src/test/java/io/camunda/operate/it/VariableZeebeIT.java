...
public class VariableZeebeIT extends OperateZeebeAbstractIT {
  ...
  public void testVariablesLoaded() throws Exception {
    ...
    searchTestRule.waitFor(variableExistsCheck, processInstanceKey, "otherVar");
    ...
    searchTestRule.waitFor(variableExistsCheck, processInstanceKey, "taskVarIn");
    ...
    searchTestRule.waitFor(flowNodeIsActiveCheck, processInstanceKey, "task3");
    searchTestRule.waitFor(variableExistsCheck, processInstanceKey, "otherTaskVar");
    ...
    searchTestRule.waitFor(variableExistsCheck, processInstanceKey, "task3Completed");

...
plugins.withId("java") {
  ...
  tasks.register<Test>("testCoreFeatures") {
    group = "verification"
    description = "Runs the Operate Core Features unit-test suite only."
    testClassesDirs = testSourceSet.get().output.classesDirs
    classpath = testSourceSet.get().runtimeClasspath
    include("**/OperateCoreFeaturesTestSuite.class")
  }
  tasks.register<Test>("testDataLayer") {
    group = "verification"
    description = "Runs the Operate Data Layer unit-test suite only."
    testClassesDirs = testSourceSet.get().output.classesDirs
    classpath = testSourceSet.get().runtimeClasspath
    include("**/OperateDataLayerTestSuite.class")
  }
}

...
@Component
@Configuration
@ConfigurationProperties(LegacyOperateProperties.PREFIX)
...
public class LegacyOperateProperties {
  ...
  public LegacyOperateProperties setAuth0(final Auth0Properties auth0) {
    this.auth0 = auth0;
    return this;
  }
  ...
  public LegacyOperateProperties setWebSecurity(final WebSecurityProperties webSecurity) {
  ...
  public LegacyOperateProperties setAlert(final AlertingProperties alert) {
    this.alert = alert;
    return this;
  }
  ...
  public LegacyOperateProperties setCloud(final CloudProperties cloud) {
    this.cloud = cloud;
    return this;
  }
  ...
  public LegacyOperateProperties setBackup(final BackupProperties backup) {
    this.backup = backup;
    return this;
  }
  ...
  public LegacyOperateProperties setVersion(final String version) {

...
public class ElasticsearchSchemaManager implements SchemaManager {
  ...
  protected final OperateElasticsearchProperties operateElasticsearchProperties;
  private final List<AbstractIndexDescriptor> indexDescriptors;
  ...
  public ElasticsearchSchemaManager(
    ...
    this.operateElasticsearchProperties = operateElasticsearchProperties;
  ...
  public void createDefaults() {
    ...
    LOGGER.info(
        ...
        settingsTemplate,
        operateElasticsearchProperties.getNumberOfShards(),
        operateElasticsearchProperties.getNumberOfReplicas());
  ...
  public String getIndexPrefix() {
    return operateElasticsearchProperties.getIndexPrefix();
  }
  ...
  private String settingsTemplateName() {
    return String.format("%s_template", operateElasticsearchProperties.getIndexPrefix());
  }

  private Settings getDefaultIndexSettings() {
    return Settings.builder()
        .put(NUMBER_OF_SHARDS, operateElasticsearchProperties.getNumberOfShards())
        .put(NUMBER_OF_REPLICAS, operateElasticsearchProperties.getNumberOfReplicas())
        .build();
  }
  ...
  private Settings getIndexSettings(final String indexName) {
    final var shards =
        operateElasticsearchProperties
            ...
            .getOrDefault(indexName, operateElasticsearchProperties.getNumberOfShards());
    final var replicas =
        operateElasticsearchProperties
            .getNumberOfReplicasForIndices()
            .getOrDefault(indexName, operateElasticsearchProperties.getNumberOfReplicas());
    return Settings.builder()

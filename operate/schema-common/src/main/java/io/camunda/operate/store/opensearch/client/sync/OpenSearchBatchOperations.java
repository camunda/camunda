...
public class OpenSearchBatchOperations extends OpenSearchSyncOperation {
  ...
  public OpenSearchBatchOperations(
      final Logger logger, final OpenSearchClient openSearchClient, final BeanFactory beanFactory) {
    super(logger, openSearchClient);
    this.beanFactory = beanFactory;
  }

  private void processBulkRequest(final OpenSearchClient osClient, final BulkRequest bulkRequest)
  ...
  public void bulk(final BulkRequest.Builder bulkRequestBuilder) {
    bulk(bulkRequestBuilder.build());
  }

  public void bulk(final BulkRequest bulkRequest) {

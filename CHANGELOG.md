# v8.4.0
## 🚀 New Features
* Stop consuming Monaco editor from a CDN ([#3986](https://github.com/camunda/tasklist/issues/3986))
* Deep merge object variables ([#3977](https://github.com/camunda/tasklist/issues/3977))
* Update docs link ([#3979](https://github.com/camunda/tasklist/issues/3979))
* Update warning message for the user doesn't have rights ([#3978](https://github.com/camunda/tasklist/issues/3978))
* Update docs link

## 💊 Bugfixes
* Enable complete button when form has no input ([#4207](https://github.com/camunda/tasklist/issues/4207))
* set privileges to true and use the correct user on zeebe container for migration tests ([#4210](https://github.com/camunda/tasklist/issues/4210))
* Regenerate login screenshots for playwright ([#4200](https://github.com/camunda/tasklist/issues/4200))
* disable renovate for stable branches on backend ([#4176](https://github.com/camunda/tasklist/issues/4176))
* revert updates by dependabot action ([#4173](https://github.com/camunda/tasklist/issues/4173))
* force refresh traditional ci workflow after commit ([#4172](https://github.com/camunda/tasklist/issues/4172))
* update dependabot_trigger.yml permissions on pull requests ([#4171](https://github.com/camunda/tasklist/issues/4171))
* remove wrong push command (dependabot trigger action) ([#4170](https://github.com/camunda/tasklist/issues/4170))
* add trigger job for dependabot  ([#4080](https://github.com/camunda/tasklist/issues/4080))
* add java distribution to dependabot job ([#4079](https://github.com/camunda/tasklist/issues/4079))
* ClearScroll request with AWS OS is not correctly signed ([#4008](https://github.com/camunda/tasklist/issues/4008))
* set user display name identity ([#3988](https://github.com/camunda/tasklist/issues/3988))
* update http-client to 5.2.3 ([#3974](https://github.com/camunda/tasklist/issues/3974))

## 🧹 Chore
* bump release deps to 8.4 ([#4217](https://github.com/camunda/tasklist/issues/4217))
* fix migration tests ([#4205](https://github.com/camunda/tasklist/issues/4205))
* **deps**: update dependency org.apache.commons:commons-lang3 to v3.14.0 (master) ([#4204](https://github.com/camunda/tasklist/issues/4204))
* **deps**: update all non-major dependencies (master) (patch) ([#4198](https://github.com/camunda/tasklist/issues/4198))
* refactor process saas it graphql ([#4188](https://github.com/camunda/tasklist/issues/4188))
* Update Browserlist DB
* **deps**: update dependency org.codehaus.mojo:build-helper-maven-plugin to v3.5.0 (master) ([#4190](https://github.com/camunda/tasklist/issues/4190))
* add the schedule for renovate for backend ([#4185](https://github.com/camunda/tasklist/issues/4185))
* **deps**: update version.jackson to v2.16.1 (master) (minor) ([#4186](https://github.com/camunda/tasklist/issues/4186))
* **deps**: update hashicorp/vault-action digest to 6853090 (master) ([#4187](https://github.com/camunda/tasklist/issues/4187))
* update branch prefix for backend ([#4183](https://github.com/camunda/tasklist/issues/4183))
* **deps**: update dependency com.graphql-java-kickstart:graphql-java-tools to v13.1.1 (master) ([#4177](https://github.com/camunda/tasklist/issues/4177))
* **deps**: bump org.keycloak:keycloak-admin-client
* **deps**: bump com.graphql-java:graphql-java from 21.2 to 21.3
* **deps**: update all non-major dependencies (master) (patch) ([#4153](https://github.com/camunda/tasklist/issues/4153))
* **deps**: bump org.apache.maven.plugins:maven-source-plugin from 3.2.1 to 3.3.0 ([#4159](https://github.com/camunda/tasklist/issues/4159))
* **deps**: bump org.apache.maven.plugins:maven-javadoc-plugin from 3.4.1 to 3.6.3 ([#4164](https://github.com/camunda/tasklist/issues/4164))
* **deps**: bump com.mycila:license-maven-plugin from 4.1 to 4.3 ([#4156](https://github.com/camunda/tasklist/issues/4156))
* replace dependabot to renovate ([#4175](https://github.com/camunda/tasklist/issues/4175))
* enable renovate for backend dependencies (backend) ([#4174](https://github.com/camunda/tasklist/issues/4174))
* update to push the commit ([#4169](https://github.com/camunda/tasklist/issues/4169))
* update dependabot_trigger.yml with push empty commit ([#4168](https://github.com/camunda/tasklist/issues/4168))
* create empty commit to update github actions in order to get correct credentials ([#4167](https://github.com/camunda/tasklist/issues/4167))
* update dependabot_trigger.yml job ([#4166](https://github.com/camunda/tasklist/issues/4166))
* create dependabot_trigger action ([#4165](https://github.com/camunda/tasklist/issues/4165))
* revert all package inclusons and reactivate dependabot ([#4154](https://github.com/camunda/tasklist/issues/4154))
* include all packages to renovate  ([#4152](https://github.com/camunda/tasklist/issues/4152))
* update renovate action ([#4150](https://github.com/camunda/tasklist/issues/4150))
* create a renovate github action ([#4149](https://github.com/camunda/tasklist/issues/4149))
* activate renovate for backend maven packages ([#4148](https://github.com/camunda/tasklist/issues/4148))
* move dependabot to github workflow ([#4145](https://github.com/camunda/tasklist/issues/4145))
* refactor taskit graphql ([#4144](https://github.com/camunda/tasklist/issues/4144))
* **deps**: bump org.apache.maven.plugins:maven-compiler-plugin from 3.11.0 to 3.12.1 ([#4138](https://github.com/camunda/tasklist/issues/4138))
* **deps**: bump version.aws-sdk from 2.21.38 to 2.22.5 ([#4140](https://github.com/camunda/tasklist/issues/4140))
* **deps**: bump org.testcontainers:testcontainers from 1.17.6 to 1.19.3 ([#4141](https://github.com/camunda/tasklist/issues/4141))
* **deps**: bump the patches group with 3 updates ([#4136](https://github.com/camunda/tasklist/issues/4136))
* reduce number of tests for graphQL TaskIT Mutation Test ([#4132](https://github.com/camunda/tasklist/issues/4132))
* refactor FormControllerIT - using nested classes and grouping initializers ([#4064](https://github.com/camunda/tasklist/issues/4064))
* Update Browserlist DB
* try to fix some random failures in IT tests ([#4130](https://github.com/camunda/tasklist/issues/4130))
* **deps**: update infra-preview-environments-ingress docker tag to v1.3.0 (master) ([#4122](https://github.com/camunda/tasklist/issues/4122))
* Refactor process internal integration tests ([#4120](https://github.com/camunda/tasklist/issues/4120))
* fixing a typo in the CI workflow ([#4110](https://github.com/camunda/tasklist/issues/4110))
* skip BE tests for renovate PRs ([#4106](https://github.com/camunda/tasklist/issues/4106))
* refactor task it, unit and service tests ([#4090](https://github.com/camunda/tasklist/issues/4090))
* skip renovate for client in stable branches ([#4095](https://github.com/camunda/tasklist/issues/4095))
* renovate is not updating stable branches for docker ([#4092](https://github.com/camunda/tasklist/issues/4092))
* use Zeebe container pool for integration tests ([#4081](https://github.com/camunda/tasklist/issues/4081))
* **deps**: bump org.springdoc:springdoc-openapi-starter-webmvc-ui from 2.1.0 to 2.3.0 ([#4077](https://github.com/camunda/tasklist/issues/4077))
* fix failing JaCoCo conflicting artifact upload ([#4084](https://github.com/camunda/tasklist/issues/4084))
* **deps**: bump the patches group with 3 updates ([#4072](https://github.com/camunda/tasklist/issues/4072))
* **deps**: bump version.graphql from 15.0.0 to 15.1.0 ([#4076](https://github.com/camunda/tasklist/issues/4076))
* migrate IT to junit5 ([#4061](https://github.com/camunda/tasklist/issues/4061))
* Update Browserlist DB
* **deps-dev**: bump com.github.docker-java:docker-java-core from 3.2.14 to 3.3.4 ([#3714](https://github.com/camunda/tasklist/issues/3714))
* **deps**: update actions/upload-artifact action to v4 ([#4050](https://github.com/camunda/tasklist/issues/4050))
* **deps**: update dependency vite to v5.0.9 ([#4046](https://github.com/camunda/tasklist/issues/4046))
* replace rnv8 with renovate in branch prefix ([#4053](https://github.com/camunda/tasklist/issues/4053))
* Bump to form-js@1.6.0 ([#4015](https://github.com/camunda/tasklist/issues/4015))
* **deps**: update actions/upload-artifact action to v4 ([#4049](https://github.com/camunda/tasklist/issues/4049))
* Remove iframe to fix a11y tests
* skip CI tests for renovate client deps update ([#4044](https://github.com/camunda/tasklist/issues/4044))
* **deps**: update alpine:3.18.5 docker digest to 34871e7 ([#4031](https://github.com/camunda/tasklist/issues/4031))
* **deps**: update dependency react-router-dom to v6.21.0 ([#4032](https://github.com/camunda/tasklist/issues/4032))
* create single docker image with multiple tags ([#4034](https://github.com/camunda/tasklist/issues/4034))
* **docker**: disable provenance for compatibility ([#4033](https://github.com/camunda/tasklist/issues/4033))
* **deps**: update dependency @camunda/camunda-composite-components to v0.3.0 ([#3776](https://github.com/camunda/tasklist/issues/3776))
* **deps**: update all non-major dependencies ([#4006](https://github.com/camunda/tasklist/issues/4006))
* **deps**: update dependency node to v20.10.0 ([#4019](https://github.com/camunda/tasklist/issues/4019))
* **deps**: update dependency @types/react to v18.2.45 ([#4012](https://github.com/camunda/tasklist/issues/4012))
* **deps**: update alpine:3.18.5 docker digest to d695c3d ([#4029](https://github.com/camunda/tasklist/issues/4029))
* avoid add -app suffix for stage and stable (#4024) ([#4028](https://github.com/camunda/tasklist/issues/4028))
* **deps**: update alpine:3.18.5 docker digest to d695c3d ([#4025](https://github.com/camunda/tasklist/issues/4025))
* **deps**: update alpine docker tag to v3.18.5 ([#4011](https://github.com/camunda/tasklist/issues/4011))
* replace maven-jib-plugin by Dockerfile and use Alpine as base … ([#3910](https://github.com/camunda/tasklist/issues/3910))
* **deps**: bump software.amazon.awssdk:auth from 2.20.10 to 2.21.38 ([#3944](https://github.com/camunda/tasklist/issues/3944))
* **deps**: update actions/setup-java action to v4 ([#4003](https://github.com/camunda/tasklist/issues/4003))
* **deps**: update actions/checkout action to v4 ([#4002](https://github.com/camunda/tasklist/issues/4002))
* **deps**: bump the patches group with 3 updates ([#4004](https://github.com/camunda/tasklist/issues/4004))
* **deps**: update stefanzweifel/git-auto-commit-action digest to 29183a2 ([#4007](https://github.com/camunda/tasklist/issues/4007))
* **deps**: bump org.apache.maven.plugins:maven-assembly-plugin from 3.5.0 to 3.6.0 ([#3947](https://github.com/camunda/tasklist/issues/3947))
* **deps**: bump @adobe/css-tools from 4.3.1 to 4.3.2 in /client ([#3923](https://github.com/camunda/tasklist/issues/3923))
* **deps**: bump commons-codec:commons-codec from 1.15 to 1.16.0 ([#3945](https://github.com/camunda/tasklist/issues/3945))
* **deps**: bump the patches group with 4 updates + fix dependabot authorization token ([#3991](https://github.com/camunda/tasklist/issues/3991))
* Remove Jenkins for Release Process ([#3995](https://github.com/camunda/tasklist/issues/3995))
* **deps**: update dependency vite to v5.0.8 ([#3989](https://github.com/camunda/tasklist/issues/3989))
* **deps**: update typescript-eslint monorepo to v6.14.0 ([#3987](https://github.com/camunda/tasklist/issues/3987))
* **deps**: update dependency eslint to v8.55.0 ([#3936](https://github.com/camunda/tasklist/issues/3936))
* **deps**: update dependency monaco-editor to v0.45.0 ([#3984](https://github.com/camunda/tasklist/issues/3984))
* **deps**: update dependency @carbon/react to v1.45.0 ([#3983](https://github.com/camunda/tasklist/issues/3983))
* **deps**: update actions/setup-python action to v5 ([#3985](https://github.com/camunda/tasklist/issues/3985))
* **deps**: update dependency @carbon/elements to v11.35.0 ([#3982](https://github.com/camunda/tasklist/issues/3982))
* **deps**: update dependency eslint-plugin-testing-library to v6.2.0 ([#3855](https://github.com/camunda/tasklist/issues/3855))
* **deps**: update all non-major dependencies ([#3981](https://github.com/camunda/tasklist/issues/3981))
* Simplify E2E tests
* **deps**: update dependency react-router-dom to v6.20.1 ([#3885](https://github.com/camunda/tasklist/issues/3885))
* **deps**: update dependency lint-staged to v15.2.0 ([#3959](https://github.com/camunda/tasklist/issues/3959))
* **deps**: update vitest monorepo to v1 (major) ([#3960](https://github.com/camunda/tasklist/issues/3960))
* Update Browserlist DB
* Revert wrong commit
* update CHANGELOG.md
# v8.4.0-alpha2

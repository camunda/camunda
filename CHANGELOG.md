# v8.5.0-alpha2
## 🚀 New Features
* align heights of filter and task detail headers ([#4632](https://github.com/camunda/tasklist/issues/4632))
* show a error message when an unexpected error occurs ([#4389](https://github.com/camunda/tasklist/issues/4389))
* Remove task redirection on process start ([#4597](https://github.com/camunda/tasklist/issues/4597))
* Zeebe user tasks - increment 1 ([#4440](https://github.com/camunda/tasklist/issues/4440))
* return Groups internal API ([#4560](https://github.com/camunda/tasklist/issues/4560))
* Implement custom filters modal ([#4583](https://github.com/camunda/tasklist/issues/4583))
* adding filters for candidateGroups, candidateUsers, assignees ([#4558](https://github.com/camunda/tasklist/issues/4558))
* processes can be filtered based on if they have a start form or not ([#4479](https://github.com/camunda/tasklist/issues/4479))
* Extend conditional to support SaaS on User Task Restrictions ([#4361](https://github.com/camunda/tasklist/issues/4361))
* tags show which processes have start forms ([#4381](https://github.com/camunda/tasklist/issues/4381))

## 💊 Bugfixes
* add flex wrap to task header ([#4630](https://github.com/camunda/tasklist/issues/4630))
* decode JWT for EntraID ([#4625](https://github.com/camunda/tasklist/issues/4625))
* **layout**: follow grid for process list search controls ([#4590](https://github.com/camunda/tasklist/issues/4590))
* Fix Failed STATE Job Tasks importer ([#4594](https://github.com/camunda/tasklist/issues/4594))
* draft variable show-up on all the tasks in ES ([#4602](https://github.com/camunda/tasklist/issues/4602))
* fixing idle sessions for Identity to logout Tasklist ([#4518](https://github.com/camunda/tasklist/issues/4518))
* template references for form check ([#4537](https://github.com/camunda/tasklist/issues/4537))
* fixing Uri for EntraId ([#4519](https://github.com/camunda/tasklist/issues/4519))
* Fix Osano CSS ([#4501](https://github.com/camunda/tasklist/issues/4501))

## 🧹 Chore
* bumping zeebe and identity versions ([#4641](https://github.com/camunda/tasklist/issues/4641))
* Bump to form-js 1.7.3 ([#4639](https://github.com/camunda/tasklist/issues/4639))
* **deps**: update typescript-eslint monorepo to v7.1.1 (master) ([#4638](https://github.com/camunda/tasklist/issues/4638))
* **deps**: update all non-major dependencies (master) ([#4637](https://github.com/camunda/tasklist/issues/4637))
* **deps**: update actions/checkout digest to 8eb1f6a (master) ([#4636](https://github.com/camunda/tasklist/issues/4636))
* **deps**: update dependency @carbon/elements to v11.41.0 (master) ([#4614](https://github.com/camunda/tasklist/issues/4614))
* **deps**: update dependency @camunda/camunda-composite-components to v0.6.0 (master) ([#4613](https://github.com/camunda/tasklist/issues/4613))
* Revert Carbon to 1.50.0
* Update form js ([#4628](https://github.com/camunda/tasklist/issues/4628))
* Fix formatting
* **deps**: update actions/checkout digest to b32f140 (master) ([#4609](https://github.com/camunda/tasklist/issues/4609))
* **deps**: update hashicorp/vault-action digest to a727ce2 (master) ([#4610](https://github.com/camunda/tasklist/issues/4610))
* **deps**: update dependency eslint to v8.57.0 (master) ([#4617](https://github.com/camunda/tasklist/issues/4617))
* **deps**: update dependency browserslist to v4.23.0 (master) ([#4616](https://github.com/camunda/tasklist/issues/4616))
* **doc**: add swagger annotations for OpenApi docs ([#4559](https://github.com/camunda/tasklist/issues/4559))
* **deps**: update helm release camunda-platform to v9.2.0 (master) ([#4619](https://github.com/camunda/tasklist/issues/4619))
* **deps**: update enricomi/publish-unit-test-result-action action to v2.15.1 (master) ([#4618](https://github.com/camunda/tasklist/issues/4618))
* **deps**: update stefanzweifel/git-auto-commit-action digest to e040c59 (master) ([#4611](https://github.com/camunda/tasklist/issues/4611))
* **deps**: update all non-major dependencies (master) ([#4612](https://github.com/camunda/tasklist/issues/4612))
* bump nimbus-jose-jwt to fix CVE-2023-52428 ([#4589](https://github.com/camunda/tasklist/issues/4589))
* Update Browserlist DB
* add organization check on get groups ([#4593](https://github.com/camunda/tasklist/issues/4593))
* **deps**: update dependency sass to v1.71.1 (master) ([#4532](https://github.com/camunda/tasklist/issues/4532))
* add identity baseURL env variable ([#4587](https://github.com/camunda/tasklist/issues/4587))
* add logs on identity auth service to debut (will be removed later)  ([#4585](https://github.com/camunda/tasklist/issues/4585))
* **deps**: update dependency @carbon/elements to v11.40.0 (master) ([#4530](https://github.com/camunda/tasklist/issues/4530))
* **deps**: update dependency @carbon/react to v1.51.1 (master) ([#4531](https://github.com/camunda/tasklist/issues/4531))
* remove log messages - identity auth service ([#4567](https://github.com/camunda/tasklist/issues/4567))
* set data on sprint start identity ([#4565](https://github.com/camunda/tasklist/issues/4565))
* Update IdentityAuthorizationService.java (will be reverted) ([#4564](https://github.com/camunda/tasklist/issues/4564))
* git issue template for bugs ([#4563](https://github.com/camunda/tasklist/issues/4563))
* extend jwt web auth setup for SaaS ([#4562](https://github.com/camunda/tasklist/issues/4562))
* Update Browserlist DB
* **deps**: update spring boot to v3.2.2 (master) (minor) ([#4194](https://github.com/camunda/tasklist/issues/4194))
* add token decode by org on User Task Restrictions ([#4555](https://github.com/camunda/tasklist/issues/4555))
* add log messages on IdentityAuthorizationService.java (PR will be reverted later) ([#4554](https://github.com/camunda/tasklist/issues/4554))
* bump to snapshot versions identity in order to test User Task Restrictions ([#4551](https://github.com/camunda/tasklist/issues/4551))
* Remove unnecessary call ([#4544](https://github.com/camunda/tasklist/issues/4544))
* Fix tests
* Bump to form-js@1.7.1
* **deps**: update all non-major dependencies (master) ([#4529](https://github.com/camunda/tasklist/issues/4529))
* **deps**: update vitest monorepo to v1.3.0 (master) ([#4533](https://github.com/camunda/tasklist/issues/4533))
* **deps**: update hashicorp/vault-action action to v3 (master) ([#4534](https://github.com/camunda/tasklist/issues/4534))
* **deps**: update hashicorp/vault-action digest to d1720f0 (master) ([#4528](https://github.com/camunda/tasklist/issues/4528))
* **deps**: update actions/add-to-project digest to 0609a27 (master) ([#4527](https://github.com/camunda/tasklist/issues/4527))
* Update Browserlist DB
* **deps**: update aws-java-sdk-v2 monorepo to v2.24.3 (master) (minor) ([#4492](https://github.com/camunda/tasklist/issues/4492))
* **deps**: update dependency com.squareup.okio:okio-jvm to v3.8.0 (master) ([#4494](https://github.com/camunda/tasklist/issues/4494))
* **deps**: update dependency com.squareup.okio:okio to v3.8.0 (master) ([#4493](https://github.com/camunda/tasklist/issues/4493))
* **deps**: update typescript-eslint monorepo to v7 (master) (major) ([#4497](https://github.com/camunda/tasklist/issues/4497))
* Fix typo ([#4498](https://github.com/camunda/tasklist/issues/4498))
* **deps**: update dependency @axe-core/playwright to v4.8.5 (master) ([#4496](https://github.com/camunda/tasklist/issues/4496))
* **deps**: update dependency msw to v2.2.0 (master) ([#4483](https://github.com/camunda/tasklist/issues/4483))
* **deps**: update dependency @types/mixpanel-browser to v2.49.0 (master) ([#4480](https://github.com/camunda/tasklist/issues/4480))
* **deps**: update dependency @carbon/react to v1.50.0 (master) ([#4477](https://github.com/camunda/tasklist/issues/4477))
* **deps**: update dependency @carbon/elements to v11.39.0 (master) ([#4475](https://github.com/camunda/tasklist/issues/4475))
* Update Browserlist DB
* support not public forms on starterByForm filter ([#4473](https://github.com/camunda/tasklist/issues/4473))
* **deps**: update dependency mixpanel-browser to v2.49.0 (master) ([#4472](https://github.com/camunda/tasklist/issues/4472))
* **deps**: update dependency @types/node to v20.11.17 (master) ([#4471](https://github.com/camunda/tasklist/issues/4471))
* **deps**: update dependency @carbon/react to v1.49.0 (master) ([#4460](https://github.com/camunda/tasklist/issues/4460))
* **deps**: update hashicorp/vault-action action to v2.8.0 (master) ([#4466](https://github.com/camunda/tasklist/issues/4466))
* **deps**: update dependency vite to v5.1.1 (master) ([#4464](https://github.com/camunda/tasklist/issues/4464))
* **deps**: update dependency react-router-dom to v6.22.0 (master) ([#4463](https://github.com/camunda/tasklist/issues/4463))
* **deps**: update slackapi/slack-github-action action to v1.25.0 (master) ([#4468](https://github.com/camunda/tasklist/issues/4468))
* **deps**: update typescript-eslint monorepo to v6.21.0 (master) ([#4469](https://github.com/camunda/tasklist/issues/4469))
* **deps**: update dependency @carbon/elements to v11.38.0 (master) ([#4459](https://github.com/camunda/tasklist/issues/4459))
* **deps**: update enricomi/publish-unit-test-result-action action to v2.14.0 (master) ([#4465](https://github.com/camunda/tasklist/issues/4465))
* **deps**: update dependency @testing-library/react to v14.2.1 (master) ([#4461](https://github.com/camunda/tasklist/issues/4461))
* **deps**: update dependency monaco-editor to v0.46.0 (master) ([#4462](https://github.com/camunda/tasklist/issues/4462))
* **deps**: update helm release camunda-platform to v9.1.0 (master) ([#4467](https://github.com/camunda/tasklist/issues/4467))
* **deps**: update dependency @testing-library/jest-dom to v6.4.2 (master) ([#4360](https://github.com/camunda/tasklist/issues/4360))
* **deps**: update all non-major dependencies (master) ([#4457](https://github.com/camunda/tasklist/issues/4457))
* **deps**: update stefanzweifel/git-auto-commit-action digest to 4d160c5 (master) ([#4439](https://github.com/camunda/tasklist/issues/4439))
* Wait for form to render ([#4444](https://github.com/camunda/tasklist/issues/4444))
* **e2e-tests**: make recreateData endpoint clear process cache ([#4442](https://github.com/camunda/tasklist/issues/4442))
* update CHANGELOG.md
# v8.5.0-alpha1
## 🚀 New Features

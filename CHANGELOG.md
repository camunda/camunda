...
* **tracking**: track what caused a task to be loaded ([#4309](https://github.com/camunda/tasklist/issues/4309))
* Deep link start forms on processes tab ([#4263](https://github.com/camunda/tasklist/issues/4263))
...
* add min condition match to OS query  ([#4419](https://github.com/camunda/tasklist/issues/4419))
* Prevent Mixpanel block starting UI ([#4400](https://github.com/camunda/tasklist/issues/4400))
* add scroll API for Draft Variables search ([#4365](https://github.com/camunda/tasklist/issues/4365))
* Fix bundling ([#4347](https://github.com/camunda/tasklist/issues/4347))
* Add useOnlyPositionCheck for tasklist ([#4358](https://github.com/camunda/tasklist/issues/4358))
* CVE-2023-3635 ([#4319](https://github.com/camunda/tasklist/issues/4319))
* do not automatically hide the offline notification ([#4268](https://github.com/camunda/tasklist/issues/4268))
...
* **deps**: update hashicorp/vault-action digest to 9f522b8 (master) ([#4431](https://github.com/camunda/tasklist/issues/4431))
* Improve Playwright test tracing
* **deps**: update dependencies release v85 alpha1 ([#4443](https://github.com/camunda/tasklist/issues/4443))
* **deps**: update actions/add-to-project digest to 0008229 (master) ([#4430](https://github.com/camunda/tasklist/issues/4430))
* **deps**: update all non-major dependencies (master) ([#4404](https://github.com/camunda/tasklist/issues/4404))
* process task instance migration ([#4417](https://github.com/camunda/tasklist/issues/4417))
* **deps**: update all non-major dependencies (master) (patch) ([#4405](https://github.com/camunda/tasklist/issues/4405))
* support filter processes by isStartedByForm  ([#4386](https://github.com/camunda/tasklist/issues/4386))
* process task migration ([#4394](https://github.com/camunda/tasklist/issues/4394))
* Update Browserlist DB
* update docker to alpine 3.19.1 ([#4409](https://github.com/camunda/tasklist/issues/4409))
* Revert changes on E2E runner ([#4402](https://github.com/camunda/tasklist/issues/4402))
* Bump to @bpmn-io/form-js@1.7.0 ([#4395](https://github.com/camunda/tasklist/issues/4395))
* Improve flaky test
* Improve flaky test
* **deps**: update hashicorp/vault-action digest to d523bb0 (master) ([#4403](https://github.com/camunda/tasklist/issues/4403))
* **deps**: update version.opensearch (master) (minor) ([#4240](https://github.com/camunda/tasklist/issues/4240))
* update httpclient5 version ([#4388](https://github.com/camunda/tasklist/issues/4388))
* CI build once ([#4399](https://github.com/camunda/tasklist/issues/4399))
* [OS] fix TaskControllerIT.CompleteTaskTests.completeTaskWithVariables ([#4392](https://github.com/camunda/tasklist/issues/4392))
* Update form-js integration screenshots
* Update form-js integration screenshots ([#4379](https://github.com/camunda/tasklist/issues/4379))
* Update Browserlist DB
* fix CVE-2024-22233 ([#4368](https://github.com/camunda/tasklist/issues/4368))
* **deps**: update dependency @types/node to v20.11.6 (master) ([#4355](https://github.com/camunda/tasklist/issues/4355))
* **ci**: move e2e-tests to cheaper self-hosted GHA runners ([#4342](https://github.com/camunda/tasklist/issues/4342))
* **deps**: update dependency date-fns to v3.3.1 (master) ([#4345](https://github.com/camunda/tasklist/issues/4345))
* Remove unnecessary useEffect ([#4346](https://github.com/camunda/tasklist/issues/4346))
* **ci**: prevent excessive costs by canceling in-progress builds on new commits ([#4344](https://github.com/camunda/tasklist/issues/4344))
* **ci**: move docker-tests to cheaper self-hosted GHA runners ([#4343](https://github.com/camunda/tasklist/issues/4343))
...
* Update Browserlist DB
* Add workflow to update visual regression screenshots ([#4315](https://github.com/camunda/tasklist/issues/4315))
* **deps**: update dependency react-router-dom to v6.21.3 (master) ([#4316](https://github.com/camunda/tasklist/issues/4316))
* **deps**: update dependency @camunda/camunda-composite-components to v0.4.0 (master) ([#4314](https://github.com/camunda/tasklist/issues/4314))
* **deps**: update dependency vite-tsconfig-paths to v4.3.1 (master) ([#4313](https://github.com/camunda/tasklist/issues/4313))
* **deps**: update dependency sass to v1.70.0 (master) ([#4312](https://github.com/camunda/tasklist/issues/4312))
* **deps**: update all non-major dependencies (master) ([#4307](https://github.com/camunda/tasklist/issues/4307))
* Fix MSW use
* **deps**: update dependency com.auth0:auth0 to v1.45.1 (master) ([#4288](https://github.com/camunda/tasklist/issues/4288))
* **deps**: update all non-major dependencies (master) (patch) ([#4284](https://github.com/camunda/tasklist/issues/4284))
* **deps**: update aws-java-sdk-v2 monorepo (master) (minor) ([#4285](https://github.com/camunda/tasklist/issues/4285))
* **deps**: update dependency com.auth0:mvc-auth-commons to v1.11.0 (master) ([#4289](https://github.com/camunda/tasklist/issues/4289))
* **deps**: update dependency msw to v2 (master) ([#4125](https://github.com/camunda/tasklist/issues/4125))
* **deps**: update dependency com.google.guava:guava to v33 (master) ([#4292](https://github.com/camunda/tasklist/issues/4292))
* **deps**: update dependency org.keycloak:keycloak-admin-client to v23 (master) ([#4294](https://github.com/camunda/tasklist/issues/4294))
* **deps**: update dependency org.assertj:assertj-core to v3.25.1 (master) ([#4290](https://github.com/camunda/tasklist/issues/4290))
* **deps**: update dependency @types/node to v20.11.4 (master) ([#4287](https://github.com/camunda/tasklist/issues/4287))
* Carbonisation screenshot
* **deps**: update typescript-eslint monorepo to v6.19.0 (master) ([#4283](https://github.com/camunda/tasklist/issues/4283))
* **deps**: update dependency @axe-core/playwright to v4.8.3 (master) ([#4280](https://github.com/camunda/tasklist/issues/4280))
* **deps**: update helm release camunda-platform to v9 (master) ([#4281](https://github.com/camunda/tasklist/issues/4281))
* **deps**: update vitest monorepo to v1.2.0 (master) ([#4279](https://github.com/camunda/tasklist/issues/4279))
* **deps**: update dependency @types/node to v20.11.2 (master) ([#4278](https://github.com/camunda/tasklist/issues/4278))
* **deps**: update all non-major dependencies (master) ([#4274](https://github.com/camunda/tasklist/issues/4274))
* **deps**: update dependency prettier to v3.2.2 (master) ([#4275](https://github.com/camunda/tasklist/issues/4275))
* **deps**: update dependency node to v20.11.0 (master) ([#4261](https://github.com/camunda/tasklist/issues/4261))
* Remove 403 from redirectable status codes ([#4269](https://github.com/camunda/tasklist/issues/4269))
* fix 8.5 zeebe importers packages ([#4267](https://github.com/camunda/tasklist/issues/4267))
* **deps**: update dependency browserslist-to-esbuild to v2 (master) ([#4230](https://github.com/camunda/tasklist/issues/4230))
* Remove unused dependency
* **deps**: update all non-major dependencies (master) ([#4260](https://github.com/camunda/tasklist/issues/4260))
* **deps**: update dependency date-fns to v3.2.0 (master) ([#4249](https://github.com/camunda/tasklist/issues/4249))
* **ingress-chart**: Update ingress chart version ([#4255](https://github.com/camunda/tasklist/issues/4255))
* Use fake timers to reduce test execution time ([#4236](https://github.com/camunda/tasklist/issues/4236))
* **deps**: update all non-major dependencies to v1.6.4 (master) ([#4243](https://github.com/camunda/tasklist/issues/4243))
* Update importers for 850 development ([#4235](https://github.com/camunda/tasklist/issues/4235))
* Add the camunda-identity repos ([#4244](https://github.com/camunda/tasklist/issues/4244))
* **deps**: update typescript-eslint monorepo to v6.18.1 (master) ([#4118](https://github.com/camunda/tasklist/issues/4118))
* **deps**: update all non-major dependencies (master) ([#4233](https://github.com/camunda/tasklist/issues/4233))
* **deps**: update enricomi/publish-unit-test-result-action action to v2.12.0 (master) ([#4239](https://github.com/camunda/tasklist/issues/4239))
* add paralellization over the github jobs it tests (matrix strategy test) ([#4242](https://github.com/camunda/tasklist/issues/4242))
* **deps**: update all non-major dependencies (master) (patch) ([#4237](https://github.com/camunda/tasklist/issues/4237))
* **deps**: update dependency org.testcontainers:postgresql to v1.19.3 (master) ([#4238](https://github.com/camunda/tasklist/issues/4238))
* **deps**: update dependency @testing-library/jest-dom to v6.2.0 (master) ([#4227](https://github.com/camunda/tasklist/issues/4227))
* extend user task restriction to other task operations ([#4202](https://github.com/camunda/tasklist/issues/4202))
* **deps**: update s4u/maven-settings-action action to v3 (master) ([#4231](https://github.com/camunda/tasklist/issues/4231))
* **deps**: update dependency @types/mixpanel-browser to v2.48.1 (master) ([#4228](https://github.com/camunda/tasklist/issues/4228))
* Fix version
* **deps**: update dependency @carbon/elements to v11.36.0 (master) ([#4108](https://github.com/camunda/tasklist/issues/4108))
* **deps**: update hashicorp/vault-action digest to 00bce0d (master) ([#4226](https://github.com/camunda/tasklist/issues/4226))
* **deps**: update dependency date-fns to v3 (master) ([#4124](https://github.com/camunda/tasklist/issues/4124))
* **deps**: update stefanzweifel/git-auto-commit-action digest to 12f6863 (master) ([#4225](https://github.com/camunda/tasklist/issues/4225))
* **deps**: update dependency eslint to v8.56.0 (master) ([#4112](https://github.com/camunda/tasklist/issues/4112))
* **deps**: update all non-major dependencies (master) ([#4107](https://github.com/camunda/tasklist/issues/4107))
* **deps**: update dependency eslint-plugin-prettier to v5.1.2 (master) ([#4117](https://github.com/camunda/tasklist/issues/4117))
* **deps**: update vitest monorepo to v1.1.3 (master) ([#4123](https://github.com/camunda/tasklist/issues/4123))
* **deps**: update dependency @carbon/react to v1.47.0 (master) ([#4111](https://github.com/camunda/tasklist/issues/4111))
* refactor ci ([#4089](https://github.com/camunda/tasklist/issues/4089))
* bump pom version to 8.5.0-SNAPSHOT
* Update Browserlist DB
* Update CHANGELOG.md
...
* Update error message when form fetch fails ([#3899](https://github.com/camunda/tasklist/issues/3899))
* use identity spring boot starter ([#3846](https://github.com/camunda/tasklist/issues/3846))
* Delete process definition in Tasklist ([#3738](https://github.com/camunda/tasklist/issues/3738))
* **form**: replace carbon-styles with SASS stylesheet ([#3749](https://github.com/camunda/tasklist/issues/3749))
...
* Fix Archiving for Opensearch ([#3940](https://github.com/camunda/tasklist/issues/3940))
* apply `rolloverBatchSize` when collecting instances to archive ([#3452](https://github.com/camunda/tasklist/issues/3452))
* return formId instead of null when has no form active ([#3896](https://github.com/camunda/tasklist/issues/3896))
* fixing AWS OpenSearch Connection ([#3887](https://github.com/camunda/tasklist/issues/3887))
* Prevent big forms from being cropped ([#3818](https://github.com/camunda/tasklist/issues/3818))
* Show error messages when variable fetch fails ([#3778](https://github.com/camunda/tasklist/issues/3778))
* extract the var retrieve from the loop + add log messages (#3817) ([#3852](https://github.com/camunda/tasklist/issues/3852))
* replace null string to object mapper node ([#3848](https://github.com/camunda/tasklist/issues/3848))
...
* **deps**: update all non-major dependencies ([#3958](https://github.com/camunda/tasklist/issues/3958))
* **deps**: update dependency eslint-config-prettier to v9.1.0 ([#3956](https://github.com/camunda/tasklist/issues/3956))
* **deps**: update all non-major dependencies ([#3912](https://github.com/camunda/tasklist/issues/3912))
* **deps**: update dependency @carbon/react to v1.44.0 ([#3928](https://github.com/camunda/tasklist/issues/3928))
* fix TaskControllerTest ([#3953](https://github.com/camunda/tasklist/issues/3953))
* fix lint ([#3952](https://github.com/camunda/tasklist/issues/3952))
* Integration tests for multi-tenancy with identity ([#3889](https://github.com/camunda/tasklist/issues/3889))
* Update Browserlist DB
* **deps**: update dependency @carbon/elements to v11.34.0 ([#3927](https://github.com/camunda/tasklist/issues/3927))
* update minor dependencies ([#3920](https://github.com/camunda/tasklist/issues/3920))
* Fix backport action PR title ([#3921](https://github.com/camunda/tasklist/issues/3921))
* **deps**: update dependency mobx to v6.12.0 ([#3897](https://github.com/camunda/tasklist/issues/3897))
* **deps**: update actions/setup-java action to v4 ([#3914](https://github.com/camunda/tasklist/issues/3914))
* dependabot major versions update ([#3915](https://github.com/camunda/tasklist/issues/3915))
* **deps**: update all non-major dependencies ([#3854](https://github.com/camunda/tasklist/issues/3854))
* **deps**: update typescript-eslint monorepo to v6.13.0 ([#3906](https://github.com/camunda/tasklist/issues/3906))
* **deps**: update dependency jsdom to v23 ([#3898](https://github.com/camunda/tasklist/issues/3898))
* **deps**: update dependency @types/node to v20.10.0 ([#3893](https://github.com/camunda/tasklist/issues/3893))
* **deps**: update typescript-eslint monorepo to v6.12.0 ([#3851](https://github.com/camunda/tasklist/issues/3851))
* Update Browserlist DB
* make dependabot create a single PR for patches ([#3862](https://github.com/camunda/tasklist/issues/3862))
* **deps**: bump com.auth0:java-jwt from 4.3.0 to 4.4.0 ([#3859](https://github.com/camunda/tasklist/issues/3859))
* **deps**: bump com.google.cloud.tools:jib-maven-plugin from 3.3.1 to 3.4.0 ([#3861](https://github.com/camunda/tasklist/issues/3861))
* **deps**: bump org.apache.maven.plugins:maven-checkstyle-plugin from 3.2.1 to 3.3.1 ([#3856](https://github.com/camunda/tasklist/issues/3856))
* **deps**: bump org.codehaus.mojo:exec-maven-plugin from 3.1.0 to 3.1.1 ([#3860](https://github.com/camunda/tasklist/issues/3860))
* **deps**: bump org.apache.maven.plugins:maven-surefire-plugin from 3.2.1 to 3.2.2 ([#3858](https://github.com/camunda/tasklist/issues/3858))
* **deps**: bump org.testcontainers:elasticsearch from 1.19.1 to 1.19.2 ([#3857](https://github.com/camunda/tasklist/issues/3857))
* **deps**: fix CVE-2023-44487 ([#3869](https://github.com/camunda/tasklist/issues/3869))
* **deps**: update dependency typescript to v5.3.2 ([#3853](https://github.com/camunda/tasklist/issues/3853))
* **preview**: remove PVCs from preview and stage env ([#3845](https://github.com/camunda/tasklist/issues/3845))
* **deps**: update mcr.microsoft.com/playwright docker tag to v1.40.0 ([#3830](https://github.com/camunda/tasklist/issues/3830))
* **deps**: update all non-major dependencies ([#3841](https://github.com/camunda/tasklist/issues/3841))
* **preview**: fixing preview actions ([#3828](https://github.com/camunda/tasklist/issues/3828))
* **deps**: update dependency vite-plugin-svgr to v4.2.0 ([#3838](https://github.com/camunda/tasklist/issues/3838))
* **deps**: update dependency eslint to v8.54.0 ([#3840](https://github.com/camunda/tasklist/issues/3840))
* Update Browserlist DB
* **deps**: update dependency @testing-library/react to v14.1.2 ([#3839](https://github.com/camunda/tasklist/issues/3839))
* **deps**: update dependency @testing-library/react to v14.1.1 ([#3837](https://github.com/camunda/tasklist/issues/3837))
* adding logging filter to HTTP Requests ([#3835](https://github.com/camunda/tasklist/issues/3835))
* **deps**: update all non-major dependencies ([#3827](https://github.com/camunda/tasklist/issues/3827))
* shorten branch name to avoid deploy-preview failures ([#3824](https://github.com/camunda/tasklist/issues/3824))
* **deps**: update dependency react-router-dom to v6.19.0 ([#3823](https://github.com/camunda/tasklist/issues/3823))
* **deps**: update dependency @vitejs/plugin-react to v4.2.0 ([#3821](https://github.com/camunda/tasklist/issues/3821))
* **deps**: update all non-major dependencies ([#3814](https://github.com/camunda/tasklist/issues/3814))
* **deps**: update dependency vite to v5.0.0-beta.20 ([#3813](https://github.com/camunda/tasklist/issues/3813))
* **deps**: update dependency mobx to v6.11.0 ([#3783](https://github.com/camunda/tasklist/issues/3783))
* **deps**: update all non-major dependencies ([#3807](https://github.com/camunda/tasklist/issues/3807))
* **deps**: dependabot updates - weekly ([#3805](https://github.com/camunda/tasklist/issues/3805))
* **deps**: update dependency mixpanel-browser to v2.48.0 ([#3793](https://github.com/camunda/tasklist/issues/3793))
* **deps**: update helm release camunda-platform to v8.3.2 ([#3790](https://github.com/camunda/tasklist/issues/3790))
* **deps**: update typescript-eslint monorepo to v6.11.0 ([#3789](https://github.com/camunda/tasklist/issues/3789))
* dependency updates - weekly dependabot ([#3788](https://github.com/camunda/tasklist/issues/3788))
* **deps**: update dependency @carbon/elements to v11.33.0 ([#3780](https://github.com/camunda/tasklist/issues/3780))
* **deps**: update dependency lint-staged to v15.1.0 ([#3782](https://github.com/camunda/tasklist/issues/3782))
* **deps**: update all non-major dependencies ([#3775](https://github.com/camunda/tasklist/issues/3775))
...
* **deps**: update all non-major dependencies ([#3105](https://github.com/camunda/tasklist/issues/3105))
* **deps**: update dependency react-router-dom to v6.14.0 ([#3120](https://github.com/camunda/tasklist/issues/3120))
* **e2e**: use proper path in form-js-integration spec ([#3115](https://github.com/camunda/tasklist/issues/3115))
* **deps**: update dependency @carbon/react to v1.31.3 ([#3081](https://github.com/camunda/tasklist/issues/3081))
* **deps**: update all non-major dependencies ([#3099](https://github.com/camunda/tasklist/issues/3099))
* **deps**: update dependency react-router-dom to v6.13.0 ([#3061](https://github.com/camunda/tasklist/issues/3061))
* **deps**: update all non-major dependencies ([#3091](https://github.com/camunda/tasklist/issues/3091))
* **deps**: update dependency @carbon/elements to v11.24.0 ([#3080](https://github.com/camunda/tasklist/issues/3080))
* **deps**: update dependency sass to v1.63.3 ([#3069](https://github.com/camunda/tasklist/issues/3069))
* linting rules ([#3085](https://github.com/camunda/tasklist/issues/3085))
* using forward ([#3084](https://github.com/camunda/tasklist/issues/3084))
* fixing public form using new Controller ([#3083](https://github.com/camunda/tasklist/issues/3083))
* SaaS public Forms ([#3082](https://github.com/camunda/tasklist/issues/3082))
* public forms without authentication ([#3079](https://github.com/camunda/tasklist/issues/3079))
* Fix scroll for big forms in public start page ([#3077](https://github.com/camunda/tasklist/issues/3077))
* 8.3.0-alpha2 release ([#3073](https://github.com/camunda/tasklist/issues/3073))
...
* **deps**: update tibdex/github-app-token action to v1.8.0 ([#3163](https://github.com/camunda/tasklist/issues/3163))
* **deps**: update hashicorp/vault-action digest to e926631 ([#3162](https://github.com/camunda/tasklist/issues/3162))
* **deps**: update all non-major dependencies ([#3161](https://github.com/camunda/tasklist/issues/3161))
* create `release` GHA workflows ([#3155](https://github.com/camunda/tasklist/issues/3155))
* **deps**: update all non-major dependencies ([#3132](https://github.com/camunda/tasklist/issues/3132))
* **security**: fix jackson vulnerability ([#3141](https://github.com/camunda/tasklist/issues/3141))
* **security**: bumping snakeyaml version ([#3140](https://github.com/camunda/tasklist/issues/3140))
* Enable processes for E2E tests ([#3129](https://github.com/camunda/tasklist/issues/3129))
* **deps**: update actions/setup-python action to v4 ([#3131](https://github.com/camunda/tasklist/issues/3131))
* TestRail Automatic Report Generation Upload Complete ([#3123](https://github.com/camunda/tasklist/issues/3123))
* **deps**: update enricomi/publish-unit-test-result-action action to v2.8.0 ([#3110](https://github.com/camunda/tasklist/issues/3110))
* **deps**: update dependency @types/mixpanel-browser to v2.47.0 ([#3117](https://github.com/camunda/tasklist/issues/3117))
* **deps**: update node.js to v19.9.0 ([#3121](https://github.com/camunda/tasklist/issues/3121))
* **backend**: bumping spring-boot version ([#3101](https://github.com/camunda/tasklist/issues/3101))
* **deps**: update hashicorp/vault-action digest to 357cb9c ([#3113](https://github.com/camunda/tasklist/issues/3113))
* **deps**: update hashicorp/vault-action action to v2.7.0 ([#3114](https://github.com/camunda/tasklist/issues/3114))
* **deps**: update actions/add-to-project digest to 0da8e46 ([#3111](https://github.com/camunda/tasklist/issues/3111))
* **deps**: update actions/add-to-project digest to 338542c ([#3109](https://github.com/camunda/tasklist/issues/3109))
* Add reset data fixture ([#3103](https://github.com/camunda/tasklist/issues/3103))
* Deduplicate lockfile
* Variables Tests migrated from TestCafe to Playwright ([#3087](https://github.com/camunda/tasklist/issues/3087))
* **deps**: update actions/add-to-project digest to 89ec196 ([#3100](https://github.com/camunda/tasklist/issues/3100))
* **deps**: update hashicorp/vault-action digest to 62aa8bb ([#3092](https://github.com/camunda/tasklist/issues/3092))
* **deps**: update hashicorp/vault-action digest to ec2980c ([#3067](https://github.com/camunda/tasklist/issues/3067))
* **deps**: update hashicorp/vault-action action to v2.6.0 ([#3068](https://github.com/camunda/tasklist/issues/3068))
* **deps**: update all non-major dependencies ([#3064](https://github.com/camunda/tasklist/issues/3064))
* **deps**: update actions/add-to-project digest to 6689247 ([#3078](https://github.com/camunda/tasklist/issues/3078))
* **deps**: update s4u/setup-maven-action action to v1.8.0 ([#3088](https://github.com/camunda/tasklist/issues/3088))
* **deps**: update mcr.microsoft.com/playwright docker tag to v1.35.0 ([#3075](https://github.com/camunda/tasklist/issues/3075))
* create `migrate elasticsearch data` GHA workflow ([#3076](https://github.com/camunda/tasklist/issues/3076))

pipelineJob('deploy-branch-to-k8s') {
  ...
  parameters {
    ...
    stringParam('BRANCH', 'master', 'Zeebe Tasklist docker image to use for deployment.')
    stringParam('ZEEBE_TASKLIST_BRANCH', 'master', 'Zeebe Tasklist branch to use for deployment.')

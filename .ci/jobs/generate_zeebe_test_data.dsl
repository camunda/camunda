pipelineJob('generate-zeebe-test-data') {
  ...
  parameters {
      ...
      stringParam('ZEEBE_PARTITION_COUNT', '6', 'Number of Zeebe partitions to configure.')
      ...
      stringParam('NUM_PROCESS_INSTANCES', '10000000', 'Number of process instances to generate, instances will be spread evenly among definitions.')
      stringParam('NUM_PROCESS_DEFINITIONS', '1000', 'Number of process definitions to deploy.')

pipelineJob('cleanup-k8s-branches') {

  displayName 'Cleanup branch deployments on K8s'
  description 'Cleanup branch deployments on Kubernetes and corresponding docker images.'

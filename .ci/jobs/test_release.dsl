pipelineJob('camunda-optimize-release-test') {
  ...
  parameters {
    stringParam('RELEASE_VERSION', '9.0.0', 'Version to release. Applied to pom.xml and Git tag.')
    stringParam('DEVELOPMENT_VERSION', '8.1.0-SNAPSHOT', 'Next development version.')

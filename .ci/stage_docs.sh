...
# upload
rsync -azv --delete-after "book/" jenkins_docs_zeebe_io@vm29.camunda.com:"/var/www/camunda/stage.docs.zeebe.io/" -e "ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no"

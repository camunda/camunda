...
describe('Filters', () => {
  ...
  it('should load the workflow and version fields', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByLabelText('Workflows')).toBeEnabled()
    );

    userEvent.selectOptions(screen.getByLabelText('Workflows'), [
  ...
  it('should set modified values to the URL', async () => {
    ...
    expect(screen.getByLabelText('Workflows')).toHaveValue('');
  ...
  it('should submit without delay', async () => {
    ...
    expect(MOCK_HISTORY.location.search).toBe(
      '?active=true&incidents=true&completed=true&canceled=true&workflow=complexProcess&workflowVersion=3'
    );
    ...
    expect(MOCK_HISTORY.location.search).toBe(
      '?active=true&incidents=true&completed=true&canceled=true&workflow=complexProcess&workflowVersion=1'
    );
    ...
    expect(MOCK_HISTORY.location.search).toBe(
      '?active=true&incidents=true&completed=true&canceled=true&workflow=complexProcess&workflowVersion=1&flowNodeId=ServiceTask_0kt6c5i'
    );
  });
});

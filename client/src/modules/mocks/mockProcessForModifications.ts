...
const mockProcessForModifications = `<?xml version="1.0" encoding="UTF-8"?>
<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:modeler="http://camunda.org/schema/modeler/1.0" xmlns:camunda="http://camunda.org/schema/1.0/bpmn" id="Definitions_1" targetNamespace="http://bpmn.io/schema/bpmn" exporter="Zeebe Modeler" exporterVersion="0.10.0" modeler:executionPlatform="Camunda Cloud" modeler:executionPlatformVersion="8.0.0" camunda:diagramRelationId="3f3ff7ed-2627-4879-8a42-3c97e9375d4c">
  <bpmn:process id="Process_aca2bbb8-dfb2-451e-80f2-f25e1965dfd0" isExecutable="true">
    ...
    <bpmn:userTask id="user-task-1">
      ...
      <bpmn:outgoing>Flow_0trcez0</bpmn:outgoing>
    </bpmn:userTask>
    <bpmn:endEvent id="end-event">
      <bpmn:incoming>Flow_1j8hu8u</bpmn:incoming>
    </bpmn:endEvent>
    ...
    <bpmn:sequenceFlow id="Flow_0trcez0" sourceRef="user-task-1" targetRef="multi-instance-service-task" />
    <bpmn:sequenceFlow id="Flow_1j8hu8u" sourceRef="multi-instance-service-task" targetRef="end-event" />
    <bpmn:serviceTask id="multi-instance-service-task">
      <bpmn:incoming>Flow_0trcez0</bpmn:incoming>
      <bpmn:outgoing>Flow_1j8hu8u</bpmn:outgoing>
      <bpmn:multiInstanceLoopCharacteristics />
    </bpmn:serviceTask>
  </bpmn:process>
  <bpmndi:BPMNDiagram id="BPMNDiagram_1">
    <bpmndi:BPMNPlane id="BPMNPlane_1" bpmnElement="Process_aca2bbb8-dfb2-451e-80f2-f25e1965dfd0">
      ...
      <bpmndi:BPMNEdge id="Flow_0trcez0_di" bpmnElement="Flow_0trcez0">
        <di:waypoint x="1780" y="280" />
        <di:waypoint x="1840" y="280" />
      </bpmndi:BPMNEdge>
      <bpmndi:BPMNEdge id="Flow_1j8hu8u_di" bpmnElement="Flow_1j8hu8u">
      ...
      <bpmndi:BPMNShape id="Activity_01u0yed_di" bpmnElement="smulti-instance-service-task">

...
describe('request', () => {
  ...
  afterEach(() => {
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'mockClear' does not exist on type '{ (in... Remove this comment to see the full error message
  ...
  describe('url', () => {
    it('should call fetch with url', () => {
      ...
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'mock' does not exist on type '{ (input: ... Remove this comment to see the full error message

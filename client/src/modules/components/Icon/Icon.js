...
export default function Icon(props) {
  ...
  /* For every icon added:
      ...
      Ideally, SVGs should be read from disk and rendered inline in the markup. afaik this is currently not possible without ejecting from create-react-app as it would require using a custom loader polugin for svg files.
  */

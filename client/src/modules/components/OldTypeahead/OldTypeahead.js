...
import './OldTypeahead.scss';
import {t} from 'translation';

export default class OldTypeahead extends React.Component {
  state = {
    query: '',
  ...
  render() {
    ...
    return (
      <div ref={this.containerRef} className={classnames('OldTypeahead', this.props.className)}>
        <Input

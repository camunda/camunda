      ...
      <div className="Alerts">
        <div className="Alerts__header">
          ...
          <div className="Alerts__tools">
            <Button color="green" className="Alerts__createButton" onClick={this.openCreationModal}>
              Create new Alert
            </Button>
          </div>
        </div>
        ...
        {this.state.reports && (
          <AlertModal
            ...
            onConfirm={this.saveAlert}
            onClose={this.cancelEdit}
            alert={this.state.alertToEdit}
          />
        )}
        {this.state.alertToDelete && (
          <Modal open={true} onClose={this.cancelDeleting} className="EntityList__delete-modal">
            ...
            <Modal.Content>
              <p>
                You are about to delete {this.state.alertToDelete.name}. Are you sure you want to
                proceed?
              </p>
            </Modal.Content>
            <Modal.Actions>
              <Button
                className="EntityList__close-delete-modal-button"
      ...
      return (
        <ul className="Alert__list">
          <li className="Alert__item Alert__no-entities">
            ...
            <a className="Alert__createLink" role="button" onClick={this.openCreationModal}>
              Create a new Alert…
            </a>
          </li>
        </ul>
            ...
            return (
              <li key={idx} className="Alert__item">
                ...
                <span className="Alert__data Alert__data--tool">
                  <Button
                    type="small"
                    className="Alert__deleteButton"
                    onClick={this.showDeleteModal(alert)}
                  >
                    Delete
                  </Button>
                </span>

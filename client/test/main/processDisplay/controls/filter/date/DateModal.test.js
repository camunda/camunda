...
import {createDateModal, __set__, __ResetDependency__} from 'main/processDisplay/controls/filter/date/DateModal';
...
describe('<DateModal>', () => {
  ...
  beforeEach(() => {
    ...
    DateModal = createDateModal(createCallback);

    ({node, update} = mountTemplate(<DateModal />));
  });

...
import {ProcessInstanceCountReact} from 'main/processDisplay/views/ProcessInstanceCount';
...
describe('<ProcessInstanceCount>', () => {
  it('should display the instance count', () => {
    const node = mount(<ProcessInstanceCountReact data="123" />);
  ...
  it('should have a thousands separator', () => {
    const node = mount(<ProcessInstanceCountReact data="12345" />);

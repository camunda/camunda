...
export const reportModalOptionsButton = reportModal.find('.optionsButton');
export const reportModalDropdownOption = reportModal.find('.DropdownOption');
export const addFilterButton = Selector('.Button').withText('Add a filter');
export const instanceStateFilter = Selector('.InstanceStateFilter .CarbonPopover .Button');
export const selectionFilter = Selector('.SelectionFilter .CarbonPopover .Button');

...
export async function setup() {
  await deploy([
    './tests/resources/Filters/processWithMultipleVersions_v_1.bpmn',
  ]);
  await deploy([
    './tests/resources/Filters/processWithMultipleVersions_v_2.bpmn',
  ]);
  await deploy(['./tests/resources/Filters/processWithAnError.bpmn']);

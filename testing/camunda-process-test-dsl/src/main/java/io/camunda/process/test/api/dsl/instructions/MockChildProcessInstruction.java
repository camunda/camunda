...
@Value.Immutable
@JsonDeserialize(builder = ImmutableMockChildProcessInstruction.Builder.class)
public interface MockChildProcessInstruction extends TestCaseInstruction {

  @Value.Default
  @Override
  default String getType() {
    return TestCaseInstructionType.MOCK_CHILD_PROCESS;
  }

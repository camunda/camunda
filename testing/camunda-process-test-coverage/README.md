...
A coverage module for [Camunda Process Test](../camunda-process-test-java/README.md) that combines backend report generation and frontend visualisation.

The frontend uses **camunda-bpmn-js** (Camunda-branded BPMN viewer), **Bootstrap 5**, and **Webpack 5** for bundling.

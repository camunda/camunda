...
/** A selector to identify an incident. */
@Value.Immutable
@JsonDeserialize(builder = ImmutableIncidentSelector.Builder.class)
public interface IncidentSelector {

  /**
   * The ID of the BPMN element where the incident occurred.
   *
  ...
  /**
   * The process definition ID of the incident.
   *

...
@Value.Immutable
@JsonDeserialize(builder = ImmutableBroadcastSignalInstruction.Builder.class)
public interface BroadcastSignalInstruction extends TestCaseInstruction {

  @Value.Default
  @Override
  default String getType() {
    return TestCaseInstructionType.BROADCAST_SIGNAL;
  }
  ...
  /**
   * The variables to broadcast with the signal. Optional.
   *

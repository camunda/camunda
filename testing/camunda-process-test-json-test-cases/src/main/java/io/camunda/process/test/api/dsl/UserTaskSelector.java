...
/** A selector to identify a user task. */
@Value.Immutable
@JsonDeserialize(builder = ImmutableUserTaskSelector.Builder.class)
public interface UserTaskSelector {
   ...
   *
   * @return the task name or empty if not set
   */
  Optional<String> getTaskName();

  /**
   * The process definition ID of the user task.
   *

...
via `frontend-maven-plugin` during `generate-resources`, and the resulting `coverage/index.html` +
...
```bash
./mvnw clean compile -Dskip.fe.build=false -pl testing/camunda-process-test-coverage
```

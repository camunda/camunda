...
public class BedrockEmbeddingModelAdapterProvider implements EmbeddingModelAdapterProvider {

  @Override
  public String getProviderName() {
    return BaseProviderConfig.PROVIDER_AMAZON_BEDROCK;
  }

  @Override
  public EmbeddingModelAdapter create(final ProviderConfig config) {
    final EmbeddingModel model =
        BedrockEmbeddingModelBuilder.build((BaseProviderConfig.AmazonBedrockConfig) config);

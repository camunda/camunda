...
public class OpenAiEmbeddingModelAdapterProvider implements EmbeddingModelAdapterProvider {

  @Override
  public String getProviderName() {
    return BaseProviderConfig.PROVIDER_OPENAI;
  }

  @Override
  public EmbeddingModelAdapter create(final ProviderConfig config) {
    final EmbeddingModel model =
        OpenAiEmbeddingModelBuilder.build((BaseProviderConfig.OpenAiConfig) config);

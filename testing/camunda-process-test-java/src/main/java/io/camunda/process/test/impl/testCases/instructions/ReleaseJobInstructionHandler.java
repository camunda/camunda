...
public class ReleaseJobInstructionHandler
    implements TestCaseInstructionHandler<ReleaseJobInstruction> {

  @Override
  public void execute(
      final ReleaseJobInstruction instruction,
    ...
    context.releaseJob(jobSelector);
  }

  @Override
  public Class<ReleaseJobInstruction> getInstructionType() {
    return ReleaseJobInstruction.class;
  }
}

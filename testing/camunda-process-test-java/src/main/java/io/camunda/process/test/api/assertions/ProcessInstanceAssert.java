...
public interface ProcessInstanceAssert {
   ...
   * @return the assertion object
   */
  ProcessInstanceAssert hasLocalVariableNames(String elementName, String... variableNames);
  ...
  ProcessInstanceAssert hasLocalVariable(
      String elementName, String variableName, Object variableValue);
   ...
   * @return the assertion object
   */
  ProcessInstanceAssert hasLocalVariables(String elementName, Map<String, Object> variables);

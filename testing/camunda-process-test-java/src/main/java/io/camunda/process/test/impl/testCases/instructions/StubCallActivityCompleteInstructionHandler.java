...
public class StubCallActivityCompleteInstructionHandler
    implements TestCaseInstructionHandler<StubCallActivityCompleteInstruction> {

  @Override
  public void execute(
      final StubCallActivityCompleteInstruction instruction,
  ...
  @Override
  public Class<StubCallActivityCompleteInstruction> getInstructionType() {
    return StubCallActivityCompleteInstruction.class;
  }
}

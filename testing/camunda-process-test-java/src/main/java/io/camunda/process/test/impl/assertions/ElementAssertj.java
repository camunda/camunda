              ...
              () -> {
                ...
                final List<FlowNodeInstance> flowNodeInstancesInState =
                    flowNodeInstances.stream()
                        .filter(
                            flowNodeInstance ->
                                flowNodeInstance.getFlowNodeInstanceState().equals(expectedState))
                          ...
                          .noneMatch(
                              element ->
                                  elementSelector.test(element)
                                      && element.getFlowNodeInstanceState().equals(expectedState)))
              .collect(Collectors.toList());
                  ...
                  elementSelector -> {
                    final FlowNodeInstanceState elementState =
                        reference.get().stream()
                            ...
                            .findFirst()
                            .map(FlowNodeInstanceDto::getFlowNodeInstanceState)
                            .orElse(null);
          ...
          .untilAsserted(
              () -> {
                ...
                assertThat(flowNodeInstances)
                    .extracting(FlowNodeInstanceDto::getFlowNodeInstanceState)

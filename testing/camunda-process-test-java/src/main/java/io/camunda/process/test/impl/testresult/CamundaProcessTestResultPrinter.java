...
public class CamundaProcessTestResultPrinter {
  ...
  private static String formatFlowNodeInstances(final List<FlowNodeInstanceDto> flowNodeInstances) {
  ...
  private static String formatFlowNodeInstance(final FlowNodeInstanceDto flowNodeInstance) {

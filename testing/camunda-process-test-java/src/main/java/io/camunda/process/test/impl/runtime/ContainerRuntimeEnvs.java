...
public class ContainerRuntimeEnvs {
  ...
  public static final String CONNECTORS_ENV_CAMUNDA_CLIENT_MODE = "CAMUNDA_CLIENT_MODE";
  public static final String CONNECTORS_ENV_OPERATE_CLIENT_BASE_URL =
      "CAMUNDA_CLIENT_OPERATE_BASE_URL";
  public static final String CONNECTORS_ENV_OPERATE_CLIENT_USERNAME =
      "CAMUNDA_CLIENT_AUTH_USERNAME";
  public static final String CONNECTORS_ENV_OPERATE_CLIENT_PASSWORD =

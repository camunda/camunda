...
public class ContainerRuntimeEnvs {
  ...
  public static final String CONNECTORS_ENV_OPERATE_CLIENT_BASE_URL = "OPERATE_CLIENT_BASE_URL";
  public static final String CONNECTORS_ENV_OPERATE_CLIENT_PROFILE = "OPERATE_CLIENT_PROFILE";
  public static final String CONNECTORS_ENV_OPERATE_CLIENT_USERNAME = "OPERATE_CLIENT_USERNAME";
  public static final String CONNECTORS_ENV_OPERATE_CLIENT_PASSWORD = "OPERATE_CLIENT_PASSWORD";
  public static final String CONNECTORS_ENV_LOG_APPENDER = "CONNECTORS_LOG_APPENDER";
  public static final String CONNECTORS_ENV_SECRET_FILTER_MODE =
      "CAMUNDA_CONNECTOR_SECRETRESOLVER_SECRETFILTER_MODE";
}

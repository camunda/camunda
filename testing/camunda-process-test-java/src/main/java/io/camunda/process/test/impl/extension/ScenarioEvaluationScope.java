...
/**
 * Wraps the entire scenario evaluation cycle (condition checks and action executions) with the
 ...
 */
@FunctionalInterface
public interface ScenarioEvaluationScope {

  /**
   * Executes the given evaluation within the appropriate context.
   *
   * @param evaluation the scenario evaluation to run (condition checks and action firings)
   */

...
public class StubCallActivityThrowErrorInstructionHandler
    implements TestCaseInstructionHandler<StubCallActivityThrowErrorInstruction> {

  @Override
  public void execute(
      final StubCallActivityThrowErrorInstruction instruction,
      final CamundaProcessTestContext context,
      final CamundaClient camundaClient,
      final AssertionFacade assertionFacade) {

    final JobSelector jobSelector =
        InstructionSelectorFactory.buildCallActivityStubJobSelector(
  ...
  @Override
  public Class<StubCallActivityThrowErrorInstruction> getInstructionType() {
    return StubCallActivityThrowErrorInstruction.class;
  }
}

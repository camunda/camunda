...
public class RunCalledProcessInstructionHandler
    implements TestCaseInstructionHandler<RunCalledProcessInstruction> {

  @Override
  public void execute(
      final RunCalledProcessInstruction instruction,
    ...
    context.runCalledProcess(jobSelector);
  }

  @Override
  public Class<RunCalledProcessInstruction> getInstructionType() {
    return RunCalledProcessInstruction.class;
  }
}

...
public class CamundaAssert {
   ...
   */
  public static ProcessInstanceAssert assertThatProcessInstance(final ProcessInstanceEvent processInstanceEvent) {
   ...
   * @return the assertion object
   */
  public static DecisionInstanceAssertj assertThatDecision(final EvaluateDecisionResponse response) {
   ...
   * @param processInstanceEvent the event of the process instance to verify
   * @return the assertion object
   * @deprecated, for removal, use {@link #assertThatProcessInstance} instead.
   * @since 8.8.0
   */
  @Deprecated
   ...
   * @return the assertion object
   * @see io.camunda.process.test.api.assertions.UserTaskSelectors
   * @deprecated, for removal, use {@link #assertThatUserTask} instead.
   * @since 8.8.0
   */
  @Deprecated
   ...
   * @return the assertion object
   * @see io.camunda.process.test.api.assertions.DecisionSelectors
   * @deprecated, for removal, use {@link #assertThatDecision} instead.
   * @since 8.8.0
   */
  @Deprecated

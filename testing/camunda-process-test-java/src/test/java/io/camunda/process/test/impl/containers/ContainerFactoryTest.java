...
class ContainerFactoryTest {
  ...
  @Test
  void shouldCreateCamundaContainerWithConfiguredImageAndTag() {
  ...
  @Test
  void shouldCreateConnectorsContainerWithConfiguredImageAndTag() {
    final ConnectorsContainer container =
        containerFactory.createConnectorsContainer("camunda/connectors-bundle", "latest");

  ...
  class HasCompletedElementsInOrder {
    ...
    void shouldFailIfOneElementIsNotCompleted() {
      ...
      Assertions.assertThatThrownBy(
          ...
          .hasMessage(
              "Process instance [key: %d] should have completed elements ['A', 'B', 'A'] in order, but only the following elements were encountered:\n"
                  + "\t- 'A': completed\n"
                  + "\t- 'B': completed\n"
                  + "\t- 'A': active",
              PROCESS_INSTANCE_KEY);
    ...
    void shouldFailIfElementsAreCompletedInADifferentOrder() {
      ...
      Assertions.assertThatThrownBy(
          ...
          .hasMessage(
              "Process instance [key: %d] should have completed elements ['B', 'A', 'A'] in order, but only the following elements were encountered:\n"
                  + "\t- 'A': completed\n"
                  + "\t- 'B': completed\n"
                  + "\t- 'A': completed",
              PROCESS_INSTANCE_KEY);

...
import net.long_running.dispatcher.impl.DispatcherConductor;
...
import net.long_running.dispatcher.impl.allocation.ExternallyAllocatedBuffer;
import net.long_running.dispatcher.impl.allocation.MappedFileAllocationDescriptor;
import net.long_running.dispatcher.impl.allocation.MappedFileAllocator;

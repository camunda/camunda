...
import static io.camunda.zeebe.engine.EngineConfiguration.DEFAULT_MESSAGE_START_DEDUP_TOMBSTONE_WINDOW;
...
public class ProcessInstanceCreationCfg implements ConfigurationEntry {
  ...
  public void setMessageStartDedupTombstoneWindow(final Duration messageStartDedupTombstoneWindow) {

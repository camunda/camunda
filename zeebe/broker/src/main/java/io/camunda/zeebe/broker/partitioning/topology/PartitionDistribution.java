...
public record PartitionDistribution(Set<PartitionMetadata> partitions) {
   ...
   * unchanged. Used by the physical-tenants feature to derive a partition distribution for a
   * non-default physical tenant from the default tenant's distribution.
   */

...
public class SnapshotAfterMigrationTransitionStep implements PartitionTransitionStep {
  ...
  static final class MigrationSnapshotDirector implements HealthMonitorable, CloseableSilently {
      ...
      if (!snapshotTaken && runningSnapshot == null) {
        ...
        runningSnapshot =
            control.schedule(
                ...
                () ->
                    forceSnapshot()
                        .onComplete((ignored, ex) -> forceSnapshotUntilSuccessful(ex), control));
      }
    }

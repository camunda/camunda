...
final class ExporterRepositoryTest {
  ...
  void shouldCacheDescriptorOnceLoaded() throws ExporterLoadException, ExternalJarLoadException {
    ...
    final var descriptor =
        repository.validateAndAddExporterDescriptor(id, exporterClass, null, null);
  ...
  void shouldFailToValidateAndConfigureIfExporterInvalid() {
    ...
    assertThatThrownBy(
            () ->
                repository.validateAndAddExporterDescriptor(id, InvalidExporter.class, null, null))
  ...
  void shouldLoadInternalExporterUsingExporterFactory()
    ...
    final List<ExporterFactory> factories = List.of(new TestExporterFactory());

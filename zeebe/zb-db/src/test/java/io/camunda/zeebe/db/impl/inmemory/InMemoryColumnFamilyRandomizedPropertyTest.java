...
/**
 * Randomized property test for the in-memory ZeebeDb implementation. Mirrors the existing {@code
 * ColumnFamilyRandomizedPropertyTest} but uses {@link InMemoryZeebeDb} instead of RocksDB.
 */
public class InMemoryColumnFamilyRandomizedPropertyTest {

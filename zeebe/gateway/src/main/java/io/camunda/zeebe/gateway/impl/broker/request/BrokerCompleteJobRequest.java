...
public final class BrokerCompleteJobRequest extends BrokerExecuteCommand<JobRecord> {
  ...
  public BrokerCompleteJobRequest setJobLeaseToken(final String jobLeaseToken) {
    requestDto.setJobLeaseToken(jobLeaseToken);
    return this;
  }

  public BrokerCompleteJobRequest setJobReservationToken(final String jobReservationToken) {

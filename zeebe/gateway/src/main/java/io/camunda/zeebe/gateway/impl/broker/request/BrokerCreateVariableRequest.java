...
public class BrokerCreateVariableRequest extends BrokerExecuteCommand<VariableRecord> {

  private final VariableRecord requestDto = new VariableRecord();

  public BrokerCreateVariableRequest() {
    super(ValueType.VARIABLE, VariableIntent.CREATE);
    super.request.setPartitionId(Protocol.START_PARTITION_ID);
  }

  public BrokerCreateVariableRequest clusterLevel() {
  ...
  public BrokerCreateVariableRequest setVariable(final String name, final DirectBuffer value) {

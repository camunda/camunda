...
public final class BrokerUpdateGlobalVariableRequest extends BrokerExecuteCommand<VariableRecord> {

  private final VariableRecord requestDto = new VariableRecord();

  public BrokerUpdateGlobalVariableRequest() {
  ...
  public BrokerUpdateGlobalVariableRequest setVariables(

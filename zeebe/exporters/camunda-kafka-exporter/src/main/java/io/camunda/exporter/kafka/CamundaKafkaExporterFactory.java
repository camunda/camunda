...
public final class CamundaKafkaExporterFactory implements ExporterFactory {

  @Override
  public String exporterId() {
    return "camunda-kafka";
  }

  @Override
  public Exporter newInstance() throws ExporterInstantiationException {
    return new CamundaKafkaExporter();
  }

  @Override
  public boolean isSameTypeAs(final ExporterFactory other) {
    return other instanceof CamundaKafkaExporterFactory;
  }
}

 ...
 */
public final class ExternalJarClassLoaderMaybeRemove extends URLClassLoader {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(ExternalJarClassLoaderMaybeRemove.class);

  private static final String JAVA_PACKAGE_PREFIX = "java.";
  private static final String JAR_URL_FORMAT = "jar:%s!/";

  private ExternalJarClassLoaderMaybeRemove(final URL[] urls) {
    super(urls);
  }

  static ExternalJarClassLoaderMaybeRemove ofPath(final Path jarPath)
    ...
    return new ExternalJarClassLoaderMaybeRemove(new URL[] {jarUrl});
  }

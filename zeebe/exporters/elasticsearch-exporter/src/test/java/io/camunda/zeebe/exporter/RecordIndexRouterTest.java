...
final class RecordIndexRouterTest {
  ...
  void shouldNotSetRoutingForRecordOfCurrentVersion() {
    ...
    // then - a null routing lets Elasticsearch hash the document id, spreading records over all
    // shards instead of piling the few partition ids onto a subset of them

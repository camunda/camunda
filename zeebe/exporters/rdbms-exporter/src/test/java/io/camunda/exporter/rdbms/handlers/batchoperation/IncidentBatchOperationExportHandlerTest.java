...
class IncidentBatchOperationExportHandlerTest {
  ...
  private IncidentBatchOperationExportHandler handler;

  @BeforeEach
  void setUp() {
    handler = new IncidentBatchOperationExportHandler(batchOperationWriter, batchOperationCache);
  ...
  private Record<IncidentRecordValue> createSuccessRecord() {
    return factory.generateRecord(
        ValueType.INCIDENT,
        b -> b.withIntent(IncidentIntent.RESOLVED).withBatchOperationReference(batchOperationKey));
  }

  private Record<IncidentRecordValue> createFailureRecord() {
    return factory.generateRecord(
        ValueType.INCIDENT,
        b ->

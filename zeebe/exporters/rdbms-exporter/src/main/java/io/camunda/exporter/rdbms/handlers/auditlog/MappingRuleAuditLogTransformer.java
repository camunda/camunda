...
public class MappingRuleAuditLogTransformer
    implements AuditLogTransformer<MappingRuleRecordValue, Builder> {
  ...
  @Override
  public void transform(final Record<MappingRuleRecordValue> record, final Builder entity) {
    final var value = record.getValue();
    entity.entityKey(value.getMappingRuleId());

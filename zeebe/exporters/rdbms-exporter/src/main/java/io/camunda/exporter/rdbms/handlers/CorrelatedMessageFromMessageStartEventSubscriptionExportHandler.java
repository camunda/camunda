...
public class CorrelatedMessageFromMessageStartEventSubscriptionExportHandler
    extends AbstractCorrelatedMessageExportHandler<MessageStartEventSubscriptionRecordValue> {

  private static final Set<Intent> SUPPORTED_INTENTS =
      Set.of(MessageStartEventSubscriptionIntent.CORRELATED);

  public CorrelatedMessageFromMessageStartEventSubscriptionExportHandler(

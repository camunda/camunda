...
public class CorrelatedMessageFromProcessMessageSubscriptionExportHandler
    extends AbstractCorrelatedMessageExportHandler<ProcessMessageSubscriptionRecordValue> {

  private static final Set<Intent> SUPPORTED_INTENTS =
      Set.of(ProcessMessageSubscriptionIntent.CORRELATED);

  public CorrelatedMessageFromProcessMessageSubscriptionExportHandler(
  ...
  protected void mapValue(
    ...
    builder
        ...
        .subscriptionType("PROCESS_MESSAGE")

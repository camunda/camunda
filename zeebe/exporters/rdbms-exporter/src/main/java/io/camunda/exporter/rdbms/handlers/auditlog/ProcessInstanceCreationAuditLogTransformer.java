...
public class ProcessInstanceCreationAuditLogTransformer
    implements AuditLogTransformer<ProcessInstanceCreationRecordValue, AuditLogDbModel.Builder> {
  ...
  public void transform(
      final Record<ProcessInstanceCreationRecordValue> record, final Builder entity) {

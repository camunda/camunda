...
public class EventFromProcessInstanceHandler
  ...
  private static final Set<String> PROCESS_INSTANCE_STATES =
      Set.of(
          EventType.ELEMENT_ACTIVATING.name(),
          EventType.ELEMENT_ACTIVATED.name(),
          EventType.ELEMENT_COMPLETING.name(),
          EventType.ELEMENT_COMPLETED.name(),
          EventType.ELEMENT_TERMINATED.name());

  private final EventTemplate eventTemplate;
  private final boolean concurrencyMode;

  public EventFromProcessInstanceHandler(EventTemplate eventTemplate, boolean concurrencyMode) {
  ...
  public boolean handlesRecord(Record<ProcessInstanceRecordValue> record) {
    ...
    return PROCESS_INSTANCE_STATES.contains(intentStr);
  }

...
import static io.camunda.zeebe.protocol.record.sbe.ValueType.AGENT_DEFINITION;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.AGENT_HISTORY;
...
import static io.camunda.zeebe.protocol.record.sbe.ValueType.BATCH_OPERATION_CHUNK;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.BATCH_OPERATION_CREATION;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.BATCH_OPERATION_EXECUTION;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.BATCH_OPERATION_INITIALIZATION;
...
import static io.camunda.zeebe.protocol.record.sbe.ValueType.FORM;
...
import static io.camunda.zeebe.protocol.record.sbe.ValueType.INCIDENT;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.JOB;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.JOB_METRICS_BATCH;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.MAPPING_RULE;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.MESSAGE_START_EVENT_SUBSCRIPTION;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.MESSAGE_SUBSCRIPTION;
...
import static io.camunda.zeebe.protocol.record.sbe.ValueType.PROCESS_INSTANCE_BUSINESS_ID;
...
import static io.camunda.zeebe.protocol.record.sbe.ValueType.PROCESS_MESSAGE_SUBSCRIPTION;
import static io.camunda.zeebe.protocol.record.sbe.ValueType.RESOURCE;

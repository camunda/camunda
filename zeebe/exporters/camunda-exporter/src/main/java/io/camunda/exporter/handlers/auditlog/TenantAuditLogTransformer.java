...
public class TenantAuditLogTransformer
    implements AuditLogTransformer<TenantRecordValue, AuditLogEntity> {
  ...
  @Override
  public void transform(final Record<TenantRecordValue> record, final AuditLogEntity entity) {

...
public class EventFromJobHandler implements ExportHandler<EventEntity, JobRecordValue> {
  ...
  public EventFromJobHandler(final String templateName, final boolean concurrencyMode) {
  ...
  private void loadEventGeneralData(
      final Record<JobRecordValue> record, final EventEntity eventEntity) {

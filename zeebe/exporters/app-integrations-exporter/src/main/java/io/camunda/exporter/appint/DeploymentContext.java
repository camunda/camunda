 ...
 * @param clusterId the cluster id provided by the broker context; empty/{@code null} when not set.
 * @param physicalTenantId the physical-tenant id this exporter instance serves.
 */
public record DeploymentContext(String orgId, String clusterId, String physicalTenantId) {

  public static final String ORGANIZATION_ID_ENV_VAR = "CAMUNDA_CLOUD_ORGANIZATION_ID";

  public static final DeploymentContext EMPTY = new DeploymentContext(null, null, null);
}

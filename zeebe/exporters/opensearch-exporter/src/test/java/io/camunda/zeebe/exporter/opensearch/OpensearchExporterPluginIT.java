...
import static io.camunda.zeebe.exporter.opensearch.utils.PluginTestUtils.getHttpClient;
...
final class OpensearchExporterPluginIT {
  ...
  private RestClient restClient = RestClientFactory.of(config, true);
  ...
  @Test
  void shouldAddStaticCustomHeader() throws Exception {
    // given

 ...
 */
final class IsmPolicyDeserializationTest {
  ...
  /**
   * The custom JSONP ObjectBuilderDeserializer avoids the overflow by skipping last_updated_time
   * and correctly deserializes every field in the response.
   */
  @Test

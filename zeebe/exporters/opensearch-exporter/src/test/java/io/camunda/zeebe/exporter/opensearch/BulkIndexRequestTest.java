...
final class BulkIndexRequestTest {
  ...
  final class SerializationTest {
    ...
    void shouldIndexRecordSerialized() throws IOException {
      ...
      assertThat(doc.get("requestChannelType")).isNull();
      assertThat(doc.get("requestToolName")).isNull();
    }

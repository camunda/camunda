...
public final class ClusterConfigurationManagerImpl implements ClusterConfigurationManager {
  ...
  private void logAndScheduleRetry(final ClusterConfigurationChangeOperation operation, final Throwable error) {
    shouldRetry = true;
  ...
  void registerTopologyChangeAppliers(final ConfigurationChangeAppliers configurationChangeAppliers) {
    executor.run(
        () -> {

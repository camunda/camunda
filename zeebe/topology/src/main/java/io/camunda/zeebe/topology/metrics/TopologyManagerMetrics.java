...
import static io.camunda.zeebe.topology.metrics.TopologyManagerMetricsDoc.*;
...
public class TopologyManagerMetrics {
  ...
  public OperationObserver observeOperation(final TopologyChangeOperation operation) {
    return startOperation(operation);
  }

  OperationObserver startOperation(final TopologyChangeOperation operation) {
    final var timer =
  ...
  public final class OperationObserver {
    ...
    private OperationObserver(
        final TopologyChangeOperation operation, final CloseableSilently timer) {

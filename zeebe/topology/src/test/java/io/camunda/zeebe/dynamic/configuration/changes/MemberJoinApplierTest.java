...
import static io.camunda.zeebe.dynamic.configuration.state.MemberState.State.ACTIVE;
import static io.camunda.zeebe.dynamic.configuration.state.MemberState.State.JOINING;

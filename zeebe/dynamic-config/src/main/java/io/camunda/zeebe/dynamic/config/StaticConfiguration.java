...
public record StaticConfiguration(
   ...
   * Partitions are split into groups by their {@link io.camunda.cluster.PartitionId#group()}; every
   * configured cluster member is visible in the result regardless of partition assignment. See
   * {@link ConfigurationUtil#getCurrentClusterConfigurationFrom} for details.
   */

...
import io.camunda.zeebe.dynamic.config.api.ConfigurationChangeCoordinator.ConfigurationChangeResult;
import io.camunda.zeebe.dynamic.config.state.ClusterConfiguration;
import io.camunda.zeebe.dynamic.config.state.PartitionGroupOperation.PartitionChangeOperation.PartitionJoinOperation;
import io.camunda.zeebe.dynamic.config.state.PartitionGroupOperation.PartitionChangeOperation.PartitionLeaveOperation;
import io.camunda.zeebe.dynamic.config.transformer.AddMembersTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ClusterPatchRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ClusterScaleRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ExporterDeleteRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ExporterDisableRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ExporterEnableRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ForceRemoveBrokersRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ForceScaleDownRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ModeChangeRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.PartitionReassignRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.PurgeRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.RemoveMembersTransformer;
import io.camunda.zeebe.dynamic.config.transformer.RestoreRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ScaleRequestTransformer;
import io.camunda.zeebe.dynamic.config.transformer.UpdatePartitionDistributionTransformer;
import io.camunda.zeebe.dynamic.config.transformer.UpdateRoutingStateTransformer;
import io.camunda.zeebe.dynamic.config.transformer.ZoneMigrationRequestTransformer;

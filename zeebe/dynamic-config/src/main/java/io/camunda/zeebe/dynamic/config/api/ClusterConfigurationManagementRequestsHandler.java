...
public final class ClusterConfigurationManagementRequestsHandler
  ...
  @Override
  public ActorFuture<ClusterConfigurationChangeResponse> changeExporterState(
      final ExportingStateChangeRequest request) {
    return handleRequest(
        request.dryRun(), new ExportingStateChangeRequestTransformer(request.state()));
  }

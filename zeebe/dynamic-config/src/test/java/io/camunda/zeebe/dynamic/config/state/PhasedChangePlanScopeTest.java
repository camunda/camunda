...
final class PhasedChangePlanScopeTest {
  ...
  void shouldConflictWithAnotherPlanOnTheSameGroup() {
    ...
    final var first =
        PhasedChangePlan.scopeOf(
            List.of(new PartitionGroupGraphPhase(Map.of("tenant-a", graphFor(MEMBER)))));
    final var second =
        PhasedChangePlan.scopeOf(
            List.of(
                new PartitionGroupGraphPhase(
    ...
    final var unrelated =
        PhasedChangePlan.scopeOf(
            List.of(new PartitionGroupGraphPhase(Map.of("tenant-c", graphFor(MEMBER)))));
  ...
  void shouldScopeAMixOfPhaseKindsToTheUnionOfTheirGroups() {
    ...
    final List<Phase> phases =
        List.of(
            ...
            new PartitionGroupGraphPhase(Map.of("tenant-b", graphFor(MEMBER))));
  ...
  void shouldScopeAPlanWithAnyGlobalPhaseAsClusterWide() {
    ...
    final List<Phase> phases =
        List.of(
            new PartitionGroupGraphPhase(Map.of("tenant-a", graphFor(MEMBER))),

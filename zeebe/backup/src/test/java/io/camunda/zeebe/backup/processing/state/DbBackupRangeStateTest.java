...
final class DbBackupRangeStateTest {
  ...
  @Test
  void shouldExtendRange() {
    // given
    state.startNewRange(1L);

    // when
    state.extendRange(1L, 5L);
  ...
  @Test
  void shouldExtendRangeMultipleTimes() {
    // given
    state.startNewRange(1L);

    // when
    state.extendRange(1L, 3L);
    state.extendRange(1L, 7L);
  ...
  @Test
  void shouldAdvanceRangeStart() {
    // given
    state.startNewRange(1L);
    state.extendRange(1L, 5L);

    // when
    state.advanceRangeStart(1L, 2L, 5L);
  ...
  void shouldNotAffectOtherRangesWhenAdvancing() {
    ...
    // when
    state.advanceRangeStart(1L, 3L, 5L);

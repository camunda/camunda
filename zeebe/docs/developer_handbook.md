...
The engine defines a [range of supported value types](https://github.com/camunda/camunda/blob/main/zeebe/engine/src/main/java/io/camunda/zeebe/engine/Engine.java#L48-L49) it processes,

...
public final class AgentDefinitionCreatedApplier
  ...
  public AgentDefinitionCreatedApplier(final MutableAgentDefinitionState agentDefinitionState) {
    this.agentDefinitionState = agentDefinitionState;
  }

  @Override
  public void applyState(final long key, final AgentDefinitionRecord value) {
    agentDefinitionState.insert(key, value);
  }
}

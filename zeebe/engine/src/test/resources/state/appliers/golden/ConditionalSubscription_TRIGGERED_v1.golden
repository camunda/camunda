...
public final class ConditionalSubscriptionTriggeredApplier
  ...
  public ConditionalSubscriptionTriggeredApplier(
  ...
  public void applyState(final long key, final ConditionalSubscriptionRecord value) {
    // only remove the subscription if it is interrupting
    // non-interrupting subscriptions remain to allow multiple triggers

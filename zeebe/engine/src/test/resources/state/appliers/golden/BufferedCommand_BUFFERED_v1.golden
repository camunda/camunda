...
/** Applier for {@link BufferedCommandIntent#BUFFERED}. */
final class BufferedCommandBufferedApplier
  ...
  BufferedCommandBufferedApplier(final MutableSuspensionState suspensionState) {

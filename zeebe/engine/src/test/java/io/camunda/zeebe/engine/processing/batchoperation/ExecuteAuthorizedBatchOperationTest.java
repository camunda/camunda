...
public final class ExecuteAuthorizedBatchOperationTest extends AbstractBatchOperationTest {

  @Test
  public void shouldExecuteBatchOperationForCancelProcessInstance() {
    // given
    final var auth =
        AuthorizationUtil.getAuthInfoWithClaim(Authorization.AUTHORIZED_USERNAME, "bud spencer");
    final var processInstanceKeys = Set.of(1L, 2L, 3L);
    final var batchOperationKey =
        createNewCancelProcessInstanceBatchOperation(processInstanceKeys, auth);

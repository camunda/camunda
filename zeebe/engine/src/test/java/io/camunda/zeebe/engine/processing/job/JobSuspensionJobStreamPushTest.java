 ...
 * that {@code ProcessInstanceResumeProcessor} makes after each {@code Job.RESUMED}. This needs its
 * own {@link EngineRule} with a {@link RecordingJobStreamer}, so it lives apart from {@code
 * JobSuspensionHandoutTest}.
 */
public final class JobSuspensionJobStreamPushTest {
  ...
  public void shouldNotPushSuspendedJobButPushItAfterResume() {
    ...
    // then - the job is pushed, via BpmnJobActivationBehavior#publishWork

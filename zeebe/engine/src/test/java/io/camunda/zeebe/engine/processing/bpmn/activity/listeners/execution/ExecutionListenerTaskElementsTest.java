  ...
  public static class ParametrizedTest {
    ...
    public void
      ...
      Assertions.assertThat(incident.getValue())
          ...
          .hasErrorMessage(
              """
                Assertion failure on evaluate the expression '{o_var_1:assert(some_var, some_var != null),_camunda_input_context:context put({},"o_var_1",o_var_1)}._camunda_input_context': \

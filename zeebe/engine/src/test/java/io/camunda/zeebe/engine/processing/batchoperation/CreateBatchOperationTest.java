...
public final class CreateBatchOperationTest {
  ...
  private final SecondaryDbQueryService secondaryDbQueryService =
      Mockito.mock(SecondaryDbQueryService.class);

  @Rule
  public final EngineRule engine =
      EngineRule.singlePartition().withSecondaryDbQueryService(secondaryDbQueryService);
  ...
  public void shouldCreateAndInitBatchOperation() {
    ...
    // given
    Mockito.when(
            secondaryDbQueryService.queryProcessInstanceKeys(
                Mockito.any(ProcessInstanceFilter.class), Mockito.any(SearchQueryPage.class)))

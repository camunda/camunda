...
public class CreateClusterVariableAuthorizationTest {
  ...
  @Test
  public void shouldBeAuthorizedToCreateGlobalScopedClusterVariable() {
    // when
    engine
        .clusterVariables()
  ...
  @Test
  public void shouldBeAuthorizedToCreateGlobalScopedClusterVariableWithSpecificPermissions() {
    // given
  ...
  @Test
  public void shouldBeAuthorizedToCreateTenantScopedClusterVariableWithSpecificPermissions() {
    // given
    final var user = createUser();
    addPermissionsToUser(
        user,
  ...
  @Test
  public void shouldBeUnauthorizedToCreateGlobalScopedClusterVariableIfNoPermissions() {
    // given
    final var user = createUser();
  ...
  @Test
  public void shouldBeUnauthorizedToCreateTenantScopedClusterVariableIfNoPermissions() {
    // given
    final var user = createUser();

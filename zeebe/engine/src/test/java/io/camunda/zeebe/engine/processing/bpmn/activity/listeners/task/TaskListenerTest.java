...
public class TaskListenerTest {
  ...
  public void shouldRejectUserTaskAssignmentWhenTaskListenerRejectsTheOperation() {
    // given
    final long processInstanceKey =
        createProcessInstance(createProcessWithAssignmentTaskListeners(listenerType));
  ...
  public void shouldClaimUserTaskAfterAllAssignmentTaskListenersAreExecuted() {
    ...
    final long processInstanceKey =
        createProcessInstance(
            createUserTaskWithTaskListeners(
                ZeebeTaskListenerEventType.assignment, listenerType, listenerType + "_2"));
    ...
    // then
    assertTaskListenerJobsCompletionSequence(
        processInstanceKey, JobListenerEventType.ASSIGNMENT, listenerType, listenerType + "_2");
            ...
            createProcessWithZeebeUserTask(
                task ->
                    task.zeebeAssignee(assignee)
                        ...
                        .zeebeTaskListener(l -> l.assignment().type(listenerType + "_2"))
  ...
  public void shouldRetryTaskListenerWhenListenerJobFailed() {
    ...
    final long processInstanceKey =
        createProcessInstance(
            createProcessWithCompleteTaskListeners(listenerType, listenerType + "_2"));
                ...
                p ->
                    p.userTask(
                            ...
                            t ->
                                t.zeebeUserTask()
                                    .zeebeAssignee("foo")
                                    .zeebeTaskListener(l -> l.complete().type(listenerType)))
                        .serviceTask(
  ...
  public void shouldProvideVariablesOfTaskCompletionToCompleteTaskListener() {
    ...
    final var processInstanceKey =
        createProcessInstanceWithVariables(
            createProcessWithCompleteTaskListeners(listenerType), Map.of("foo", "bar"));
  ...
  public void shouldProvideVariablesOfTaskCompletionFetchingOnlySpecifiedVariables() {
    ...
    final var processInstanceKey =
        createProcessInstanceWithVariables(
            createProcessWithCompleteTaskListeners(listenerType),
  ...
  public void shouldRejectCompleteTaskListenerJobCompletionWhenVariablesAreSet() {
    // given
    final long processInstanceKey =
        createProcessInstance(createProcessWithCompleteTaskListeners(listenerType));

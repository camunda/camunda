...
class BatchOperationPauseProcessorTest {

  private StateWriter stateWriter;
  private TypedCommandWriter commandWriter;
  private TypedRejectionWriter rejectionWriter;
  private TypedResponseWriter responseWriter;
  private BatchOperationPauseProcessor processor;
  ...
  void setUp() {
    ...
    processor =
        new BatchOperationPauseProcessor(writers, null, state, authCheckBehavior, keyGenerator);
  }
  ...
  void shouldRejectWhenInInvalidState() {
    ...
    when(batchOperation.canPause()).thenReturn(false);

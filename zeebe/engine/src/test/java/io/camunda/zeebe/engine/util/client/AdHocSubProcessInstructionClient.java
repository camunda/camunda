...
public class AdHocSubProcessInstructionClient {
  ...
  public AdHocSubProcessInstructionClient(final CommandWriter writer) {
    this.writer = writer;
  }
  ...
  public AdHocSubProcessInstructionClient expectRejection() {
    expectation = REJECTION_EXPECTATION;
    return this;
  }

  public AdHocSubProcessInstructionClient withAdHocSubProcessInstanceKey(
      final String adHocSubProcessInstanceKey) {
    adHocSubProcessInstructionRecord.setAdHocSubProcessInstanceKey(adHocSubProcessInstanceKey);
    return this;
  }

  public AdHocSubProcessInstructionClient withElementIds(final String... elementIds) {
  ...
  public AdHocSubProcessInstructionClient withAuthorizedTenantIds(final String... tenantIds) {

...
public class CommandDistributionIdempotencyTest {
  ...
  public record Scenario(ValueType valueType, Intent intent, CommandSender commandSender) {
  ...
  protected static class AcknowledgementInterceptor {
    ...
    private boolean matchesScenario(
      ...
      return getScenarioKey().map(scenarioKey -> recordKey.equals(scenarioKey)).orElse(false);
    }

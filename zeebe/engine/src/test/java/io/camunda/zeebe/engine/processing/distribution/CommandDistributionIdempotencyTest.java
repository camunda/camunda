...
import io.camunda.zeebe.engine.common.processing.batchoperation.BatchOperationCancelProcessor;
import io.camunda.zeebe.engine.common.processing.batchoperation.BatchOperationCreateProcessor;
import io.camunda.zeebe.engine.common.processing.batchoperation.BatchOperationLeadPartitionCompleteProcessor;
import io.camunda.zeebe.engine.common.processing.batchoperation.BatchOperationLeadPartitionFailProcessor;
import io.camunda.zeebe.engine.common.processing.batchoperation.BatchOperationResumeProcessor;
import io.camunda.zeebe.engine.common.processing.batchoperation.BatchOperationSuspendProcessor;
import io.camunda.zeebe.engine.common.processing.clock.ClockProcessor;
import io.camunda.zeebe.engine.common.processing.deployment.DeploymentCreateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.AuthorizationCreateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.AuthorizationDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.identity.AuthorizationUpdateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.GroupAddEntityProcessor;
import io.camunda.zeebe.engine.common.processing.identity.GroupCreateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.GroupDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.identity.GroupRemoveEntityProcessor;
import io.camunda.zeebe.engine.common.processing.identity.GroupUpdateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.MappingRuleCreateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.MappingRuleDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.identity.MappingRuleUpdateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.RoleAddEntityProcessor;
import io.camunda.zeebe.engine.common.processing.identity.RoleCreateProcessor;
import io.camunda.zeebe.engine.common.processing.identity.RoleDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.identity.RoleRemoveEntityProcessor;
import io.camunda.zeebe.engine.common.processing.identity.RoleUpdateProcessor;
import io.camunda.zeebe.engine.common.processing.message.MessageSubscriptionMigrateProcessor;
import io.camunda.zeebe.engine.common.processing.resource.ResourceDeletionDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.scaling.MarkPartitionBootstrappedProcessor;
import io.camunda.zeebe.engine.common.processing.scaling.ScaleUpProcessor;
import io.camunda.zeebe.engine.common.processing.signal.SignalBroadcastProcessor;
import io.camunda.zeebe.engine.common.processing.streamprocessor.DistributedTypedRecordProcessor;
import io.camunda.zeebe.engine.common.processing.tenant.TenantAddEntityProcessor;
import io.camunda.zeebe.engine.common.processing.tenant.TenantCreateProcessor;
import io.camunda.zeebe.engine.common.processing.tenant.TenantDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.tenant.TenantRemoveEntityProcessor;
import io.camunda.zeebe.engine.common.processing.tenant.TenantUpdateProcessor;
import io.camunda.zeebe.engine.common.processing.user.UserCreateProcessor;
import io.camunda.zeebe.engine.common.processing.user.UserDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.user.UserUpdateProcessor;

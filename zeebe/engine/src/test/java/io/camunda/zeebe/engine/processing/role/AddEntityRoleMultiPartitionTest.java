        ...
        .extracting(
            ...
            r ->
                ...
                r.getValue() instanceof CommandDistributionRecordValue
                    ...
                    : r.getPartitionId())
        .containsSubsequence(
            tuple(RoleIntent.ADD_ENTITY, RecordType.COMMAND, 1),
            tuple(RoleIntent.ENTITY_ADDED, RecordType.EVENT, 1),
    ...
    for (int partitionId = 2; partitionId < PARTITION_COUNT; partitionId++) {
      assertThat(
              RecordingExporter.roleRecords()
                  ...
                  .limit(record -> record.getIntent().equals(RoleIntent.ENTITY_ADDED))
                  .collect(Collectors.toList()))
          .extracting(Record::getIntent)
          .containsSubsequence(RoleIntent.ADD_ENTITY, RoleIntent.ENTITY_ADDED);
    }
  }

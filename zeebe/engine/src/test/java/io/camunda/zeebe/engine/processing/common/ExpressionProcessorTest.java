          ...
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateStringExpression(expression, -1L, "tenant"),
              "evaluateStringExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateStringExpressionAsDirectBuffer(expression, -1L, "tenant"),
              "evaluateStringExpressionAsDirectBuffer"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateLongExpression(expression, -1L, "tenant"),
              "evaluateLongExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateBooleanExpression(expression, -1L, "tenant"),
              "evaluateBooleanExpression(scopeKey, tenantId)"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) -> processor.evaluateBooleanExpression(expression, null),
              "evaluateBooleanExpression(context)"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateIntervalExpression(expression, -1L, "tenant"),
              "evaluateIntervalExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateDateTimeExpression(expression, -1L, "tenant"),
              "evaluateDateTimeExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateDateTimeExpression(expression, -1L, "tenant", false),
              "evaluateDateTimeExpression(nullableFlag)"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateAnyExpressionToBuffer(expression, -1L, "tenant"),
              "evaluateAnyExpressionToBuffer"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateAnyExpression(expression, -1L, "tenant"),
              "evaluateAnyExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateArrayExpression(expression, -1L, "tenant"),
              "evaluateArrayExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateArrayOfStringsExpression(expression, -1L, "tenant"),
              "evaluateArrayOfStringsExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateMessageCorrelationKeyExpression(expression, -1L, "tenant"),
              "evaluateMessageCorrelationKeyExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateIntegerExpression(expression, -1L, "tenant"),
              "evaluateIntegerExpression"),
          Arguments.of(
              (ProcessorMethod)
                  (processor, expression) ->
                      processor.evaluateVariableMappingExpression(expression, -1L, "tenant"),

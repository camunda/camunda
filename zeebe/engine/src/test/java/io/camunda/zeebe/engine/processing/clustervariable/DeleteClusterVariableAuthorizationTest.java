...
public class DeleteClusterVariableAuthorizationTest {
  ...
  public void shouldBeAuthorizedToDeleteGlobalScopedClusterVariable() {
    ...
    // when
    engine.clusterVariables().withName(VARIABLE_NAME).setGlobalScope().delete(user.getUsername());

    // then
    assertThat(
            RecordingExporter.clusterVariableRecords()
                .withIntent(ClusterVariableIntent.DELETED)
                .withName(VARIABLE_NAME)
                .exists())
        .isTrue();
  }
  ...
  @Test
  public void shouldBeAuthorizedToDeleteGlobalScopedClusterVariableWithSpecificPermissions() {
    // given
    engine
        .clusterVariables()
  ...
  @Test
  public void shouldBeUnauthorizedToDeleteGlobalScopedClusterVariableIfNoPermissions() {
    // given
    engine
        .clusterVariables()
        .withName(VARIABLE_NAME)
    ...
    Assertions.assertThat(rejection)
        ...
        .hasRejectionReason(
            "Insufficient permissions to perform operation 'DELETE' on resource 'CLUSTER_VARIABLE', required resource identifiers are one of '[*, myVariable]'");
  }

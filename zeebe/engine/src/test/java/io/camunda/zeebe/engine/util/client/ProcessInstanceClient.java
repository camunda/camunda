...
public final class ProcessInstanceClient {
  ...
  public static class ProcessInstanceCreationClient {
    ...
    public ProcessInstanceCreationClient withRuntimeSuspendInstruction(final String afterElementId) {
      final var instruction = new ProcessInstanceCreationRuntimeInstruction().setType(
          RuntimeInstructionType.SUSPEND_PROCESS_INSTANCE).setAfterElementId(afterElementId);

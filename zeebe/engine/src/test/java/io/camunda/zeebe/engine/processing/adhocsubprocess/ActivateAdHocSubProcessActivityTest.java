...
public class ActivateAdHocSubProcessActivityTest {
  ...
  @Test
  public void
      givenRunningAdhocSubProcessInstance_whenActivatingExistingFlowNode_thenTheFlowNodeIsActivated() {
  ...
  @Test
  public void
      givenRunningAdhocSubProcessInstance_whenSuccessfullyActivatingAFlowNode_thenSubsequentActivatedEventIsSent() {
    final var adHocSubProcessActivityActivationRecord =
        new AdHocSubProcessActivityActivationRecord()
            .setAdHocSubProcessInstanceKey(String.valueOf(adHocSubProcessInstanceKey));
    adHocSubProcessActivityActivationRecord.flowNodes().add().setFlowNodeId("A");
  ...
  @Test
  public void
      givenRunningAdhocSubProcessInstance_whenActivatingMoreThanOneFlowNode_thenAllGivenFlowNodesAreActivated() {
    final var adHocSubProcessActivityActivationRecord =
        new AdHocSubProcessActivityActivationRecord()
            .setAdHocSubProcessInstanceKey(String.valueOf(adHocSubProcessInstanceKey));
    adHocSubProcessActivityActivationRecord.flowNodes().add().setFlowNodeId("A");
  ...
  @Test
  public void
      givenRunningAdhocSubProcessInstance_whenActivatingFlowNodeThatDoesNotExist_thenTheActivationIsRejected() {
    final var adHocSubProcessActivityActivationRecord =
        new AdHocSubProcessActivityActivationRecord()
            .setAdHocSubProcessInstanceKey(String.valueOf(adHocSubProcessInstanceKey));
  ...
  @Test
  public void
      givenAdhocSubProcessInATerminalState_whenActivatingFlowNodes_thenTheActivationIsRejected() {
    final var adHocSubProcessActivityActivationRecord =
        new AdHocSubProcessActivityActivationRecord()
            .setAdHocSubProcessInstanceKey(String.valueOf(adHocSubProcessInstanceKey));
    adHocSubProcessActivityActivationRecord.flowNodes().add().setFlowNodeId("A");
  ...
  @Test
  public void
      givenRunningAdhocSubProcess_whenAttemptingToActivateDuplicateFlowNodes_thenTheActivationIsRejected() {
    final var adHocSubProcessActivityActivationRecord =
        new AdHocSubProcessActivityActivationRecord()
            .setAdHocSubProcessInstanceKey(String.valueOf(adHocSubProcessInstanceKey));
    adHocSubProcessActivityActivationRecord.flowNodes().add().setFlowNodeId("A");

...
public class JobCanceledV4ApplierTest {
  ...
  @Test
  public void shouldRemoveSecretReferencesOnJobCancellation() {
    // given
    ...
    // when
    appliersHelper.applyEventToState(jobKey, JobIntent.CANCELED, jobRecord);

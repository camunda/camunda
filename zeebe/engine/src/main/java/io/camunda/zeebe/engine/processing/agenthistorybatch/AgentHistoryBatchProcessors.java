...
public final class AgentHistoryBatchProcessors {

  private AgentHistoryBatchProcessors() {}

  public static void addAgentHistoryBatchProcessors(
    ...
    typedRecordProcessors.onCommand(
        ...
        new AgentHistoryBatchCleanUpProcessor(writers, processingState));
  }
}

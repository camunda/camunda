...
import io.camunda.zeebe.engine.common.state.deployment.VersionInfo;
...
import io.camunda.zeebe.engine.common.state.migration.to_8_3.DbDecisionMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.DbJobMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.DbMessageMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.DbMessageStartEventSubscriptionMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.DbMessageSubscriptionMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.DbProcessMessageSubscriptionMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.DbProcessMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_4.DbSignalSubscriptionMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_5.DbColumnFamilyCorrectionMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_6.DbDistributionMigrationState;
import io.camunda.zeebe.engine.common.state.migration.to_8_7.DbDistributionMigrationState8dot7;

...
public class ProcessInstanceDeleteCompleteProcessor
    implements TypedRecordProcessor<ProcessInstanceRecord> {
  private final StateWriter stateWriter;
  private final KeyGenerator keyGenerator;

  public ProcessInstanceDeleteCompleteProcessor(
  ...
  public void processRecord(final TypedRecord<ProcessInstanceRecord> record) {
    stateWriter.appendFollowUpEvent(
        keyGenerator.nextKey(), ProcessInstanceIntent.DELETED, record.getValue());
  }
}

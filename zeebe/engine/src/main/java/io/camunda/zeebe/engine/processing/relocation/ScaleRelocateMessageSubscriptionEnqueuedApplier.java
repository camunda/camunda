...
public class ScaleRelocateMessageSubscriptionEnqueuedApplier
    implements TypedEventApplier<ScaleIntent, ScaleRecord> {
  private final MutableRelocationState relocationState;

  public ScaleRelocateMessageSubscriptionEnqueuedApplier(
  ...
  public void applyState(final long key, final ScaleRecord value) {
    relocationState.enqueue(value.getMessageSubscriptionRecord());
  }
}

...
public class ConditionalBehavior {
  ...
  public void evaluateConditionals(
    ...
    for (final VariableEvent variableEvent : variableEvents) {
      ...
      while (!scopes.isEmpty()) {
        ...
        visitSubscriptions(
            variableEvent, currentScopeKey, triggeredSubscriptionKeys, interruptedScopes);
  ...
  private void visitSubscriptions(
    ...
    conditionSubscriptionState.visitByScopeKey(
        ...
        subscription -> {
          ...
          if (shouldTrigger(record, currentScopeKey)) {
  ...
  private boolean shouldTrigger(
      final ConditionalSubscriptionRecord record, final long currentScopeKey) {
  ...
  public record VariableEvent(long scopeKey, VariableIntent intent, VariableRecord record) {
    private static final Map<VariableIntent, String> intentToEventMap =
        Map.of(

...
import io.camunda.zeebe.engine.common.processing.bpmn.container.AdHocSubProcessInnerInstanceProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.container.AdHocSubProcessProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.container.CallActivityProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.container.EventSubProcessProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.container.MultiInstanceBodyProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.container.ProcessProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.container.SubProcessProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.event.BoundaryEventProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.event.EndEventProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.event.IntermediateCatchEventProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.event.IntermediateThrowEventProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.event.StartEventProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.gateway.EventBasedGatewayProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.gateway.ExclusiveGatewayProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.gateway.InclusiveGatewayProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.gateway.ParallelGatewayProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.BusinessRuleTaskProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.JobWorkerTaskProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.ManualTaskProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.ReceiveTaskProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.ScriptTaskProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.SendTaskProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.UndefinedTaskProcessor;
import io.camunda.zeebe.engine.common.processing.bpmn.task.UserTaskProcessor;

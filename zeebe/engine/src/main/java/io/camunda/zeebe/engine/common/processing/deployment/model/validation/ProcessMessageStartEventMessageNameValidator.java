 ...
 * a string
 */
public final class ProcessMessageStartEventMessageNameValidator
    implements ModelElementValidator<StartEvent> {

  private final ExpressionLanguage expressionLanguage;

  public ProcessMessageStartEventMessageNameValidator(final ExpressionLanguage expressionLanguage) {

...
import io.camunda.zeebe.engine.state.instance.RecordRequestMetadata;
...
public interface UserTaskState {
  ...
  <T extends RecordRequestMetadata> Optional<RecordRequestMetadata> findRecordRequestMetadata(

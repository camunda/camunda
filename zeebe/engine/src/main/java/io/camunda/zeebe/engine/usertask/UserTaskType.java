...
import io.camunda.zeebe.engine.usertask.applier.UserTaskAssignedV1Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskAssignedV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskAssignedV3Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskAssigningV1Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskAssigningV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskAssignmentDeniedApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCanceledApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCancelingV1Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCancelingV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskClaimingApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCompletedV1Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCompletedV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCompletingV1Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCompletingV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCompletionDeniedApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCorrectedApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCreatedApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCreatedV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCreatingApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskCreatingV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskMigratedApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskUpdateDeniedApplier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskUpdatedV1Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskUpdatedV2Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskUpdatingV1Applier;
import io.camunda.zeebe.engine.usertask.applier.UserTaskUpdatingV2Applier;

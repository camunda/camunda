...
public class SuspendProcessInstanceBatchOperationExecutor implements BatchOperationExecutor {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SuspendProcessInstanceBatchOperationExecutor.class);

  final TypedCommandWriter commandWriter;
  private final BrokerRequestAuthorizationConverter brokerRequestAuthorizationConverter;

  public SuspendProcessInstanceBatchOperationExecutor(
      final TypedCommandWriter commandWriter,
  ...
  public void execute(final long itemKey, final PersistedBatchOperation batchOperation) {
    LOGGER.trace("Suspending process instance with key '{}'", itemKey);

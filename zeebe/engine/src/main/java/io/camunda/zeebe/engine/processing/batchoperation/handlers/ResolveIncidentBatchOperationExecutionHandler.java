...
public class ResolveIncidentBatchOperationExecutionHandler
    implements BatchOperationExecutionHandler {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(ResolveIncidentBatchOperationExecutionHandler.class);

  final TypedCommandWriter commandWriter;
  final IncidentState incidentState;

  public ResolveIncidentBatchOperationExecutionHandler(
  ...
  @Override
  public void handleBatchOperationExecution(final long incidentKey, final long batchOperationKey) {

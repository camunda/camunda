...
import io.camunda.zeebe.engine.common.state.migration.VersionCompatibilityCheck.CheckResult;
...
import io.camunda.zeebe.engine.common.state.migration.to_8_2.DecisionRequirementsMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.MultiTenancyDecisionStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.MultiTenancyJobStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.MultiTenancyMessageStartEventSubscriptionStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.MultiTenancyMessageStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.MultiTenancyMessageSubscriptionStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.MultiTenancyProcessMessageSubscriptionStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.MultiTenancyProcessStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_3.ProcessInstanceByProcessDefinitionMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_4.MultiTenancySignalSubscriptionStateMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_5.ColumnFamilyPrefixCorrectionMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_6.OrderedCommandDistributionMigration;
import io.camunda.zeebe.engine.common.state.migration.to_8_7.IdempotentCommandDistributionMigration;

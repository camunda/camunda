...
class JobRetriesUpdatedApplierV2 implements TypedEventApplier<JobIntent, JobRecord> {

  private final MutableJobState jobState;
  private final MutableJobMetricsState jobMetricsState;

  JobRetriesUpdatedApplierV2(final MutableProcessingState state) {
  ...
  public void applyState(final long key, final JobRecord value) {
    ...
    jobMetricsState.incrementAllJobMetricsCounter(
        ...
        value.getTenantId(),
        value.getWorker(),
        JobMetricState.RETRIES_UPDATED,

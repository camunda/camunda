...
public class DeleteDecisionInstanceBatchOperationExecutor implements BatchOperationExecutor {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(DeleteDecisionInstanceBatchOperationExecutor.class);

  private final TypedCommandWriter commandWriter;
  private final BrokerRequestAuthorizationConverter brokerRequestAuthorizationConverter;

  public DeleteDecisionInstanceBatchOperationExecutor(
  ...
  public void execute(final long itemKey, final PersistedBatchOperation batchOperation) {
    ...
    command.setResourceType(HistoryDeletionType.DECISION_INSTANCE);

...
public interface TypedEventWriter {
   ...
   * EventApplier EventApplier}s, leading to differing state changes.
   ...
   * EventApplier}. If a specific version needs to be used, consider
   ...
   *
   * <p>Different versions of event records may be applied by different {@link
   * EventApplier}s, leading to differing state changes. This allows

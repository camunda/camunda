...
public final class EventAppliers implements EventApplier {
  ...
  private void registerJobIntentEventAppliers(final MutableProcessingState state) {
    ...
    register(JobIntent.RETRIES_UPDATED, 1, new JobRetriesUpdatedApplier(state));
    register(JobIntent.RETRIES_UPDATED, 2, new JobRetriesUpdatedApplierV2(state));
    ...
    register(JobIntent.MIGRATED, 1, new JobMigratedApplier(state));
    register(JobIntent.MIGRATED, 2, new JobMigratedApplierV2(state));
  }

...
public final class DbClockModification extends UnpackedObject implements DbValue {
  ...
  public DbClockModification pinAt(final long pinnedEpoch) {
    reset();
  ...
  public DbClockModification offsetBy(final long offsetMillis) {
    reset();

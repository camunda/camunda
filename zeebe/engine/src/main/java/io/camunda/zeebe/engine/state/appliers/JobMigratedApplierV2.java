...
public final class JobMigratedApplierV2 implements TypedEventApplier<JobIntent, JobRecord> {

  private final MutableJobState jobState;
  private final MutableJobMetricsState jobMetricsState;

  public JobMigratedApplierV2(final MutableProcessingState state) {
  ...
  public void applyState(final long key, final JobRecord value) {
    ...
    jobMetricsState.incrementAllJobMetricsCounter(
        value.getType(),
        value.getTenantId(),
        value.getWorker(),
        JobMetricState.MIGRATED,

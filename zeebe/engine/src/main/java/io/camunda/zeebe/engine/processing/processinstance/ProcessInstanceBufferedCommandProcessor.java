 ...
 * replayed verbatim once the process instance is drained during resume (see #57792). No client
 ...
 */
public final class ProcessInstanceBufferedCommandProcessor {

  private final KeyGenerator keyGenerator;
  private final Writers writers;

  public ProcessInstanceBufferedCommandProcessor(
  ...
  public void bufferCommand(final TypedRecord<?> command, final long processInstanceKey) {
    ...
    final var bufferedCommandRecord =
        new ProcessInstanceBufferedCommandRecord()
            ...
            .setElementInstanceKey(command.getKey())

...
public final class BatchOperationResumeProcessor
  ...
  public void processNewCommand(final TypedRecord<BatchOperationExecutionRecord> command) {
    ...
    responseWriter.writeEventOnCommand(
        batchKey, BatchOperationExecutionIntent.RESUMED, command.getValue(), command);
  ...
  private void resumeBatchOperation(
    ...
    commandWriter.appendFollowUpCommand(key, BatchOperationExecutionIntent.EXECUTE, batchExecute);
  }
}

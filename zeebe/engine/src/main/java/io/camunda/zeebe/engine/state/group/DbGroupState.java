...
public class DbGroupState implements MutableGroupState {
  ...
  private final DbCompositeKey<DbForeignKey<DbString>, DbString> fkGroupIdAndEntityKey;
  ...
  public DbGroupState(
    ...
    fkGroupIdAndEntityKey = new DbCompositeKey<>(fkGroupId, entityId);
    entityTypeByGroupColumnFamily =
        zeebeDb.createColumnFamily(
  ...
  @Override
  public void removeEntity(final long groupKey, final String entityId) {

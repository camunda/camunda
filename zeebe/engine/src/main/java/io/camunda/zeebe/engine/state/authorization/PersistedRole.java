...
public class PersistedRole extends ObjectDbValue {
	...
	public PersistedRole() {
		super(4);
		declareProperty(roleKeyProp).declareProperty(roleIdProp).declareProperty(nameProp)
	...
	/**
	 * Wraps the provided RoleRecord into this PersistedRole instance. Copies the
	 * properties from the RoleRecord to the corresponding properties of this
	 * persisted role, allowing the current instance to reflect the state of the
	 * provided record.
	 *

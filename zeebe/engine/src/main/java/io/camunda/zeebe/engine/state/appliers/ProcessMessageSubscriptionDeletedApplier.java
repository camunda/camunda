...
@HandlesIntent(intent = ProcessMessageSubscriptionIntent.class, type = "DELETED")
public final class ProcessMessageSubscriptionDeletedApplier
  ...
  public ProcessMessageSubscriptionDeletedApplier(

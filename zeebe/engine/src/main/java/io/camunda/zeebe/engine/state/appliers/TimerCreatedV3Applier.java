...
final class TimerCreatedV3Applier implements TypedEventApplier<TimerIntent, TimerRecord> {

  private final MutableTimerInstanceState timerInstanceState;
  private final TimerInstance timerInstance = new TimerInstance();

  TimerCreatedV3Applier(final MutableTimerInstanceState timerInstanceState) {
  ...
  public void applyState(final long key, final TimerRecord value) {
    ...
    timerInstance.setStorageOrdinal(value.getStorageOrdinal());

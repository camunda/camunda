...
public final class ClockProcessors {
  ...
  public static void addClockProcessors(
    ...
    final ClockProcessorHelper helper =
        new ClockProcessorHelper(
            writers, keyGenerator, clock, commandDistributionBehavior, authCheckBehavior);
    typedRecordProcessors.onCommand(
        ValueType.CLOCK, ClockIntent.PIN, new ClockPinProcessor(helper));
    typedRecordProcessors.onCommand(
        ValueType.CLOCK, ClockIntent.RESET, new ClockResetProcessor(helper));
  }
}

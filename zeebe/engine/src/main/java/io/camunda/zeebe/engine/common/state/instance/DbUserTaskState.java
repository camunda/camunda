...
import io.camunda.zeebe.engine.usertask.state.instance.UserTaskLifecycleStateValue;
import io.camunda.zeebe.engine.usertask.state.instance.UserTaskRecordValue;

...
import io.camunda.zeebe.engine.processing.batchoperation.handlers.CancelProcessInstanceBatchOperationExecutionHandler;
import io.camunda.zeebe.engine.processing.batchoperation.handlers.ResolveIncidentBatchOperationExecutionHandler;
  ...
  public static void addBatchOperationProcessors(
    ...
    final var batchExecutionHandlers =
        Map.of(
            ...
            new CancelProcessInstanceBatchOperationExecutionHandler(writers.command()),
            BatchOperationType.RESOLVE_INCIDENT,
            new ResolveIncidentBatchOperationExecutionHandler(

...
public class ScaleRelocateCorrelationKeyStartedApplier
    implements TypedEventApplier<ScaleIntent, ScaleRecord> {

  private final MutableRelocationState relocationState;

  public ScaleRelocateCorrelationKeyStartedApplier(final MutableRelocationState relocationState) {
    this.relocationState = relocationState;
  }

  @Override
  public void applyState(final long key, final ScaleRecord value) {
    relocationState.markAsRelocating(value.getCorrelationKey());
  }
}

...
public class PersistedUsageMetrics extends ObjectDbValue {
	...
	public PersistedUsageMetrics() {
		...
		declareProperty(fromTimeProp).declareProperty(toTimeProp).declareProperty(tenantRPIMapProp)
				.declareProperty(tenantEDIMapProp).declareProperty(tenantTUMapProp);
	}
	...
	public PersistedUsageMetrics setTenantRPIMap(final Map<String, Long> tenantRPIMap) {
		tenantRPIMapProp.setValue(BufferUtil.wrapArray(MsgPackConverter.convertToMsgPack(tenantRPIMap)));
		return this;
	}
	...
	public PersistedUsageMetrics setTenantEDIMap(final Map<String, Long> tenantEDIMap) {
		tenantEDIMapProp.setValue(BufferUtil.wrapArray(MsgPackConverter.convertToMsgPack(tenantEDIMap)));
		return this;
	}

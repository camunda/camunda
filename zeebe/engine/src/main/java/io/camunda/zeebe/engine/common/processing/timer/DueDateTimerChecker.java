...
public class DueDateTimerChecker implements StreamProcessorLifecycleAware {
  ...
  public static final class TriggerTimersSideEffect implements Function<TaskResultBuilder, Long> {
  ...
  public static final class YieldingDecorator implements TimerVisitor {

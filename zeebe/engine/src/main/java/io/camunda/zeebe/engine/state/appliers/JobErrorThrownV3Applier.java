...
public class JobErrorThrownV3Applier implements TypedEventApplier<JobIntent, JobRecord> {
  ...
  JobErrorThrownV3Applier(final MutableProcessingState state) {
  ...
  private void removeJobReference(
    ...
    secretReferenceState.removeAllSecretReferencesByJobKey(jobKey);
  }
}

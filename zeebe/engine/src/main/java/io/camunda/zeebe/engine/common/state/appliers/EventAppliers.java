...
import io.camunda.zeebe.engine.common.processing.scaling.ScaleUpStatusResponseApplier;
import io.camunda.zeebe.engine.common.processing.scaling.ScaledUpApplier;
import io.camunda.zeebe.engine.common.processing.scaling.ScalingUpApplier;
import io.camunda.zeebe.engine.common.state.EventApplier;
import io.camunda.zeebe.engine.common.state.EventApplier.NoSuchEventApplier.NoApplierForIntent;
import io.camunda.zeebe.engine.common.state.EventApplier.NoSuchEventApplier.NoApplierForVersion;
...
import io.camunda.zeebe.engine.job.applier.JobBatchActivatedApplier;
...
public final class EventAppliers implements EventApplier, EventApplierRegistry {
  ...
  public EventAppliers registerEventAppliers(final MutableProcessingState state) {
    ...
    JobType.registerEventAppliers(this, state);

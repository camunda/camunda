 ...
 */
package io.camunda.zeebe.engine.common.state.migration.to_8_3;
...
public final class MultiTenancyMessageStateMigration implements MigrationTask {
  ...
  public boolean needsToRun(final MigrationTaskContext context) {
    return hasPublishedMessagesInDeprecatedCF(context.processingState());
  }
  ...
  private static boolean hasPublishedMessagesInDeprecatedCF(final ProcessingState processingState) {
    return !processingState.isEmpty(ZbColumnFamilies.DEPRECATED_MESSAGES);
  }
}

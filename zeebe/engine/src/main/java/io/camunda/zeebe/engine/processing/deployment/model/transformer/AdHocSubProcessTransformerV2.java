...
/**
 * Version 2 of the {@code AD_HOC_SUB_PROCESS} handler (see {@link
 * io.camunda.zeebe.engine.processing.deployment.model.transformation.BpmnTransformer}). {@link
 * AdHocSubProcessTransformer} stays frozen at v1 forever.
 */
public final class AdHocSubProcessTransformerV2

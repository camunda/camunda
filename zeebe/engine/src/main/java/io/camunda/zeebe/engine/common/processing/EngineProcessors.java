...
import io.camunda.zeebe.engine.common.metrics.ProcessEngineMetrics;
import io.camunda.zeebe.engine.common.processing.batchoperation.BatchOperationSetupProcessors;
import io.camunda.zeebe.engine.common.processing.bpmn.behavior.BpmnBehaviors;
import io.camunda.zeebe.engine.common.processing.bpmn.behavior.BpmnBehaviorsImpl;
import io.camunda.zeebe.engine.common.processing.bpmn.behavior.BpmnJobActivationBehavior;
import io.camunda.zeebe.engine.common.processing.clock.ClockProcessors;
import io.camunda.zeebe.engine.common.processing.common.DecisionBehavior;
import io.camunda.zeebe.engine.common.processing.deployment.DeploymentCreateProcessor;
import io.camunda.zeebe.engine.common.processing.deployment.distribute.DeploymentDistributeProcessor;
import io.camunda.zeebe.engine.common.processing.deployment.distribute.DeploymentDistributionCommandSender;
import io.camunda.zeebe.engine.common.processing.deployment.distribute.DeploymentDistributionCompleteProcessor;
import io.camunda.zeebe.engine.common.processing.deployment.distribute.DeploymentRedistributor;
import io.camunda.zeebe.engine.common.processing.distribution.CommandDistributionAcknowledgeProcessor;
import io.camunda.zeebe.engine.common.processing.distribution.CommandDistributionBehavior;
import io.camunda.zeebe.engine.common.processing.distribution.CommandDistributionContinueProcessor;
import io.camunda.zeebe.engine.common.processing.distribution.CommandDistributionFinishProcessor;
import io.camunda.zeebe.engine.common.processing.distribution.CommandRedistributor;
import io.camunda.zeebe.engine.common.processing.dmn.DecisionEvaluationEvaluteProcessor;
import io.camunda.zeebe.engine.common.processing.identity.AuthorizationCheckBehavior;
import io.camunda.zeebe.engine.common.processing.identity.AuthorizationProcessors;
import io.camunda.zeebe.engine.common.processing.identity.GroupProcessors;
import io.camunda.zeebe.engine.common.processing.identity.IdentitySetupProcessors;
import io.camunda.zeebe.engine.common.processing.identity.MappingRuleProcessors;
import io.camunda.zeebe.engine.common.processing.identity.RoleProcessors;
import io.camunda.zeebe.engine.common.processing.incident.IncidentEventProcessors;
import io.camunda.zeebe.engine.common.processing.message.MessageEventProcessors;
import io.camunda.zeebe.engine.common.processing.message.command.SubscriptionCommandSender;
import io.camunda.zeebe.engine.common.processing.metrics.UsageMetricsProcessors;
import io.camunda.zeebe.engine.common.processing.resource.ResourceDeletionDeleteProcessor;
import io.camunda.zeebe.engine.common.processing.resource.ResourceFetchProcessor;
import io.camunda.zeebe.engine.common.processing.scaling.ScalingProcessors;
...
import io.camunda.zeebe.engine.common.processing.tenant.TenantProcessors;
import io.camunda.zeebe.engine.common.processing.timer.DueDateTimerChecker;
import io.camunda.zeebe.engine.common.processing.user.UserProcessors;
...
import io.camunda.zeebe.engine.job.JobType;
import io.camunda.zeebe.engine.usertask.processing.UserTaskProcessor;
...
public final class EngineProcessors {
  ...
  public static TypedRecordProcessors createEngineProcessors(
    ...
    JobType.registerCommandProcessors(
        typedRecordProcessors,
        processingState,
        scheduledTaskStateFactory,
        bpmnBehaviors,

...
public final class JobRecord extends UnifiedRecordValue implements JobRecordValue {
  ...
  private final EnumProperty<ListenerEventType> listenerEventTypeProp =
      new EnumProperty<>(
          "listenerEventType", ListenerEventType.class, ListenerEventType.UNSPECIFIED);
  ...
  public JobRecord() {
    ...
    declareProperty(deadlineProp)
        ...
        .declareProperty(listenerEventTypeProp)
  ...
  public void wrapWithoutVariables(final JobRecord record) {
    ...
    listenerEventTypeProp.setValue(record.getListenerEventType());
  ...
  public ListenerEventType getListenerEventType() {
    return listenerEventTypeProp.getValue();
  }

  public JobRecord setListenerEventType(final ListenerEventType listenerEventType) {
    listenerEventTypeProp.setValue(listenerEventType);
    return this;
  }

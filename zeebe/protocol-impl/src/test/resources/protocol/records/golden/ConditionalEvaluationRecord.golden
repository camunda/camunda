...
public final class ConditionalEvaluationRecord extends UnifiedRecordValue
  ...
  /**
   * Adds a started process instance to the record by copying the provided record.
   *
   * @param startedProcessInstance the started process instance record to add
   * @return this record for fluent chaining
   */
  public ConditionalEvaluationRecord addStartedProcessInstance(
      final StartedProcessInstanceRecord startedProcessInstance) {
    startedProcessInstancesProp.add().copy(startedProcessInstance);
    return this;
  }

  /**
   * Adds multiple started process instances to the record.
   *
   * @param startedProcessInstances the list of started process instances to add
   * @return this record for fluent chaining
   */
  public ConditionalEvaluationRecord addStartedProcessInstances(
      final List<StartedProcessInstanceRecord> startedProcessInstances) {
    startedProcessInstances.forEach(this::addStartedProcessInstance);
    return this;
  }
}

...
public class DataStoreTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<ChildElementAssumption> getChildElementAssumptions() {
    return Arrays.asList(new ChildElementAssumption(DataState.class, 0, 1));
  }
  ...
  public Collection<AttributeAssumption> getAttributesAssumptions() {
    return Arrays.asList(
        ...
        new AttributeAssumption("capacity"),
        new AttributeAssumption("isUnlimited", false, false, true),

...
public final class ExtensionElementsDuplicationValidator<
        T extends BaseElement, E extends ModelElementInstance>
  ...
  private ExtensionElementsDuplicationValidator(
  ...
  public void validate(final T element, final ValidationResultCollector validationResultCollector) {
    ...
    if (extensionElements != null
      ...
      validationResultCollector.addError(
          0,
          String.format(
              "Must have exactly one 'zeebe:%s' extension element when exists. "
  ...
  public static class Builder<T extends BaseElement> {
    ...
    public <E extends ModelElementInstance>
        ExtensionElementsDuplicationValidator<T, E> hasSingleExtensionElement(
            final Class<E> extensionElement, final String name) {

      return new ExtensionElementsDuplicationValidator<>(elementType, extensionElement, name);
    }
  }
}

...
public class ZeebeConditionVariableImpl extends BpmnModelElementInstanceImpl
    implements ZeebeConditionVariable {

  protected static Attribute<String> variableNamesAttribute;
  protected static Attribute<String> variableEventsAttribute;

  public ZeebeConditionVariableImpl(final ModelTypeInstanceContext instanceContext) {
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(ZeebeConditionVariable.class, ZeebeConstants.ELEMENT_CONDITION_VARIABLE)
            .namespaceUri(BpmnModelConstants.ZEEBE_NS)
            .instanceProvider(ZeebeConditionVariableImpl::new);

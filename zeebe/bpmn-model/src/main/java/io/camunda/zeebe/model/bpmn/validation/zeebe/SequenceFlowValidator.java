  ...
  public void validate(
    ...
    if (sourceRef == null || sourceRef.trim().isEmpty()) {
      ...
      validationResultCollector.addError(
          0, String.format("SequenceFlow has sourceRef '%s' which cannot be resolved", sourceRef));
    }
    ...
    if (targetRef == null || targetRef.trim().isEmpty()) {
      ...
      validationResultCollector.addError(
          0, String.format("SequenceFlow has targetRef '%s'  which cannot be resolved", targetRef));
    }

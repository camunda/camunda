...
import static io.camunda.zeebe.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_EXPRESSION;
        ...
        modelBuilder
            ...
            .instanceProvider(
                new ModelTypeInstanceProvider<Expression>() {
                  @Override
                  public Expression newInstance(final ModelTypeInstanceContext instanceContext) {

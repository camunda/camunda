...
public enum ZbColumnFamilies implements EnumValue, ScopedColumnFamily {
  ...
  USER_TASK_TRANSITION_TRIGGER_REQUEST_METADATA(110),

  GROUPS(111, ColumnFamilyScope.GLOBAL),

  REDISTRIBUTION(112),

  USERNAME_BY_USER_KEY(113, ColumnFamilyScope.GLOBAL),
  CLAIM_BY_ID(114, ColumnFamilyScope.GLOBAL),
  AUTHORIZATION_KEYS_BY_OWNER(115, ColumnFamilyScope.GLOBAL),

  BATCH_OPERATION(116),
  PENDING_BATCH_OPERATION(117),
  BATCH_OPERATION_CHUNKS(118),

  VARIABLE_DOCUMENT_STATE_BY_SCOPE_KEY(119),

  RELATIONS_BY_ENTITY(120, ColumnFamilyScope.GLOBAL),
  ENTITIES_BY_RELATION(121, ColumnFamilyScope.GLOBAL),

  USER_TASK_INITIAL_ASSIGNEE(122),

  RPI_USAGE_METRICS(123);

...
public enum ZbColumnFamilies implements EnumValue {
  ...
  TENANTS(107),
  ENTITY_BY_TENANT(108),

  USER_TASK_INTERMEDIATE_STATES(109),

  MAPPINGS(110),
  CLAIM_BY_KEY(111),

  USER_TASK_TRANSITION_TRIGGER_REQUEST_METADATA(112),
  ...
  USERNAME_BY_USER_KEY(117),
  CLAIM_BY_ID(118),
  AUTHORIZATION_KEYS_BY_OWNER(119),

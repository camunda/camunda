...
public enum JobListenerEventType {
   ...
   * logic before the task is completed, to correct user task data, or to deny the completion.
   */
  COMPLETING,
   ...
   * logic before the task is assigned, to correct user task data, or to deny the assignment.
   */
  ASSIGNING,
}

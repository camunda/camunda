...
public record StoredRestoreStatus(RestoreStatus restoreStatus, String etag) {
  public record RestoreStatus(long backupId, Status status, Set<Integer> restoredNodes) {
    ...
    public static RestoreStatus fromJson(final ObjectMapper objectMapper, final String json) {
      try {

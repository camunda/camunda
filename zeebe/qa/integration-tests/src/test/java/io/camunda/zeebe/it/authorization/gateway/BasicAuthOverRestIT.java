...
final class BasicAuthOverRestIT {
  ...
  private TestStandaloneGateway gateway =
  ...
  void beforeEach() {
    ...
    defaultUserClient = createClient(gateway, defaultUsername, "demo");
    authUtil = new AuthorizationsUtil(gateway, defaultUserClient, CONTAINER.getHttpHostAddress());

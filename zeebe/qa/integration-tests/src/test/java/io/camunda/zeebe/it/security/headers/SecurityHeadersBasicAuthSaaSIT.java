...
@ZeebeIntegration
public class SecurityHeadersBasicAuthSaaSIT extends SecurityHeadersBaseIT {
  ...
  private TestStandaloneBroker broker =
      new TestStandaloneBroker()
          ...
          .withSecurityConfig(
              sc -> {
                final var saas = new SaasConfiguration();
                saas.setClusterId("clusterId");
                saas.setOrganizationId("organizationId");
                sc.setSaas(saas);
              });

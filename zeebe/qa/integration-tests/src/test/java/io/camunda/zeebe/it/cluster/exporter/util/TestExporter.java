 ...
 */
package io.camunda.zeebe.it.cluster.exporter.util;
...
/**
 * A test exporter used by {@link
 * io.camunda.zeebe.it.cluster.exporter.ExporterConfigInstantiationIT}. It needs to be a top level
 * class since we'll be rebasing (i.e. merging) with a dynamically created implementation class
 * before packaging it as a JAR, along with its companion class {@link TestExporterConfig}.
 *

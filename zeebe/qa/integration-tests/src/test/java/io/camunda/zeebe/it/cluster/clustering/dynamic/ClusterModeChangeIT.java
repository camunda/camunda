...
@ZeebeIntegration
@Timeout(60)
final class ClusterModeChangeIT {

  private static final int BROKERS_COUNT = 3;
  private static final int PARTITIONS_COUNT = 3;

  // The automatic afterEach purge is disabled: this single-method test tears the static cluster
  // down at class end, and purging a cluster that has just cycled through recovery exercises an
  // unrelated Raft-leave path rather than the mode transition under test.

 ...
 */
package io.camunda.zeebe.it.authorization.gateway;
...
public class BasicAuthOverGrpcIT {
  ...
  void beforeEach() {
    ...
    defaultUserClient = createClientGrpc(gateway, defaultUsername, "demo");
    final var clientForPermissions = createClient(gateway, defaultUsername, "demo");
    authUtil =
        new AuthorizationsUtil(gateway, clientForPermissions, CONTAINER.getHttpHostAddress());

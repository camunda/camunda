...
import io.atomix.raft.storage.serializer.sbe.BooleanType;
import io.atomix.raft.storage.serializer.sbe.ConfigurationDecoder;
import io.atomix.raft.storage.serializer.sbe.ConfigurationEncoder;
...
import io.atomix.raft.storage.serializer.sbe.MetaDecoder;
import io.atomix.raft.storage.serializer.sbe.MetaEncoder;
...
public class MetaStoreSerializer {
  ...
  private final ByteBuffer metaByteBuffer = ByteBuffer.allocate(256).order(ENDIANESS);

 ...
 * accepted and carried through its phases from there, so every phase of a transfer is bounded by
 * the settings the transfer started with.
 *
 * @param replicationLagThreshold the most replication lag, in bytes, the desired leader may have

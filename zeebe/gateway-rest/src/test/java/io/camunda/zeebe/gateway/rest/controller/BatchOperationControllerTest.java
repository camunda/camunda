...
class BatchOperationControllerTest extends RestControllerTest {
  ...
  void shouldReturnBatchOperationItems() {
    ...
    final var batchOperationItem =
        new BatchOperationEntity.BatchOperationItemEntity(
            batchOperationKey, 1L, BatchOperationState.COMPLETED);
  ...
  void shouldCancelBatchOperation() {
    ...
    verify(batchOperationServices).cancel(batchOperationKey);
  }

  @Test
  void shouldPauseBatchOperation() throws Exception {
    final var batchOperationKey = 1L;
    ...
    verify(batchOperationServices).pause(batchOperationKey);
  }

  @Test
  void shouldResumeBatchOperation() throws Exception {
    final var batchOperationKey = 1L;
    ...
    verify(batchOperationServices).resume(batchOperationKey);
  }

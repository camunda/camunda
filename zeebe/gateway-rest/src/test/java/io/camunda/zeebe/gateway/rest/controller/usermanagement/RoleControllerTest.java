  ...
  class DefaultRoleControllerTest extends RestControllerTest {
    ...
    void createRoleShouldReturnCreated(final String roleId) {
      ...
      webClient
          ...
          .bodyValue(
              RoleCreateRequest.Builder.create()
                  .roleId(roleId)
                  .name(roleName)
    ...
    void createRoleWithoutIdShouldFail() {
      ...
      webClient
          ...
          .accept(MediaType.APPLICATION_JSON)
          .contentType(MediaType.APPLICATION_JSON)
          .bodyValue(RoleCreateRequest.Builder.create().roleId(roleId).name(roleName).build())
          .exchange()
          .expectStatus()
          .isBadRequest()
          .expectBody()
    ...
    void shouldFailOnCreateRoleWithTooLongGroupId() {
      ...
      webClient
          ...
          .accept(MediaType.APPLICATION_JSON)
          .contentType(MediaType.APPLICATION_JSON)
          .bodyValue(RoleCreateRequest.Builder.create().roleId(roleId).name("name").build())
          .exchange()
          .expectStatus()
          .isBadRequest()
          .expectBody()
    ...
    void shouldUpdateRoleAndReturnResponse() {
      ...
      webClient
          ...
          .contentType(MediaType.APPLICATION_JSON)
          .bodyValue(
              RoleUpdateRequest.Builder.create().name(roleName).description(description).build())
          .exchange()
          .expectStatus()
          .isOk()
          .expectBody()

...
class ProcessInstanceRequestValidatorTest {
  ...
  @Test
  @DisplayName("Should reject null processDefinitionKey")
  ...
  @Test
  @DisplayName("Should accept processDefinitionId")
  ...
  @Test
  @DisplayName("Should reject null processDefinitionId")
  void shouldRejectNullProcessDefinitionId() {
    final var request = new ProcessInstanceCreationInstructionById();

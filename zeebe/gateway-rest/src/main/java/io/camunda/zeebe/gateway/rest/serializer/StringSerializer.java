...
public class StringSerializer extends JsonSerializer<String> {
  ...
  private void writeDefault(final String value, final JsonGenerator gen) throws IOException {
    writeString(value, gen);
  }

  private void writeString(final String value, final JsonGenerator gen) throws IOException {
    gen.writeString(value);
  }

  private void writeNumber(final String value, final JsonGenerator gen) throws IOException {
  ...
  public void serialize(
      final String value, final JsonGenerator gen, final SerializerProvider serializers)
      throws IOException {

...
public class GeneratedTenantController {
  ...
  public ResponseEntity<Object> searchTenants(
      @RequestBody(required = false) final GeneratedTenantSearchQueryRequestStrictContract tenantSearchQueryRequest
  ) {
    final var authentication =
        authenticationProvider.getAnonymousIfUnavailable();
  ...
  public ResponseEntity<Object> searchUsersForTenant(
      @PathVariable("tenantId") final String tenantId,
      @RequestBody(required = false) final GeneratedTenantUserSearchQueryRequestStrictContract tenantUserSearchQueryRequest
  ) {
    final var authentication =
        authenticationProvider.getAnonymousIfUnavailable();
    return serviceAdapter.searchUsersForTenant(tenantId, tenantUserSearchQueryRequest, authentication);
  }
  ...
  public ResponseEntity<Object> searchClientsForTenant(
      @PathVariable("tenantId") final String tenantId,
      @RequestBody(required = false) final GeneratedTenantClientSearchQueryRequestStrictContract tenantClientSearchQueryRequest
  ) {
    final var authentication =
        authenticationProvider.getAnonymousIfUnavailable();
    return serviceAdapter.searchClientsForTenant(tenantId, tenantClientSearchQueryRequest, authentication);
  }
  ...
  public ResponseEntity<Object> searchGroupIdsForTenant(
      @PathVariable("tenantId") final String tenantId,
      @RequestBody(required = false) final GeneratedTenantGroupSearchQueryRequestStrictContract tenantGroupSearchQueryRequest
  ) {
    final var authentication =
        authenticationProvider.getAnonymousIfUnavailable();
    return serviceAdapter.searchGroupIdsForTenant(tenantId, tenantGroupSearchQueryRequest, authentication);
  }
  ...
  public ResponseEntity<Object> searchMappingRulesForTenant(
    ...
    final var authentication =
        authenticationProvider.getAnonymousIfUnavailable();
    return serviceAdapter.searchMappingRulesForTenant(tenantId, mappingRuleSearchQueryRequest, authentication);
  }
}

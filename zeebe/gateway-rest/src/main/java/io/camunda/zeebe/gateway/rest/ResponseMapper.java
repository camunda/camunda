...
public final class ResponseMapper {
  ...
  public static ResponseEntity<Object> toGlobalVariableCreateResponse(final VariableRecord $) {
    return new ResponseEntity<>(HttpStatus.CREATED);
  }

  public static ResponseEntity<Object> toGlobalVariableUpdateResponse(final VariableRecord $) {

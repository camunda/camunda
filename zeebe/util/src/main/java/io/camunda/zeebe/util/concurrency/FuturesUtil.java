...
public class FuturesUtil {
   ...
   */
  public static <A> CompletableFuture<@Nullable Void> traverseIgnoring(
      final Collection<A> collection,
      final Function<A, CompletableFuture<Void>> function,
      final Executor executor) {
    var future = CompletableFuture.<@Nullable Void>completedFuture(null);
  ...
  public static <A extends @Nullable Object, B extends @Nullable Object>
      CompletableFuture<List<B>> parTraverse(

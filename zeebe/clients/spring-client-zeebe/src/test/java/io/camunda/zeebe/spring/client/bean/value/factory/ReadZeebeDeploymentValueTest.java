...
public class ReadZeebeDeploymentValueTest {
  ...
  public void shouldReadSingleClassPathResourceTest() {
    ...
    // when
    final Optional<ZeebeDeploymentValue> valueForClass = annotationProcessor.readAnnotation(classInfo);
  ...
  public void shouldReadMultipleClassPathResourcesTest() {
    // given
    final ClassInfo classInfo = ClassInfo.builder().bean(new WithMultipleClassPathResource()).build();

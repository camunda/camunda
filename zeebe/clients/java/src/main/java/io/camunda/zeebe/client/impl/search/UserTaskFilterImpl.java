...
implements UserTaskFilter {
  ...
  @Override
  public UserTaskFilter userTaskTaskDefinitionIds(final String taskDefinitionId,
      final String... taskDefinitionIds) {
    return userTaskTaskDefinitionIds(UserTaskFilter.collectValues(taskDefinitionId, taskDefinitionIds));
  }

  @Override
  public UserTaskFilter userTaskTaskDefinitionIds(final List<String> taskDefinitionIds) {
    filter.setTaskDefinitionId(UserTaskFilter.addValuesToList(filter.getTaskDefinitionId(), taskDefinitionIds));
    return this;
  }

  @Override
  public UserTaskFilter userTaskCandidateGroups(final String candidateGroup,
  ...
  public UserTaskFilter userTaskCandidateGroups(final List<String> candidateGroups) {
    filter.setCandidateGroup(UserTaskFilter.addValuesToList(filter.getCandidateGroup(), candidateGroups));
    return this;
  }

  @Override
  public UserTaskFilter userTaskCandidateUsers(final String candidateUser,
  ...
  public UserTaskFilter userTaskCandidateUsers(final List<String> candidateUsers) {
    filter.setCandidateUser(UserTaskFilter.addValuesToList(filter.getCandidateUser(), candidateUsers));
    return this;
  }

  @Override
  public UserTaskFilter userTaskProcessDefinitionKeys(final Long processDefinitionKey,
      final Long... processDefinitionKeys) {
    return userTaskProcessDefinitionKeys(UserTaskFilter.collectValues(processDefinitionKey, processDefinitionKeys));
  }

  @Override
  public UserTaskFilter userTaskProcessDefinitionKeys(final List<Long> processDefinitionKeys) {
    filter.setProcessDefinitionKey(UserTaskFilter.addValuesToList(filter.getProcessDefinitionKey(), processDefinitionKeys));
    return this;
  }

  @Override
  public UserTaskFilter userTaskProcessInstanceKeys(final Long processInstanceKey,
      final Long... processInstanceKeys) {
    return userTaskProcessInstanceKeys(UserTaskFilter.collectValues(processInstanceKey, processInstanceKeys));
  }

  @Override
  public UserTaskFilter userTaskProcessInstanceKeys(final List<Long> processInstanceKeys) {
    filter.setProcessInstanceKey(UserTaskFilter.addValuesToList(filter.getProcessInstanceKey(), processInstanceKeys));
    return this;
  }

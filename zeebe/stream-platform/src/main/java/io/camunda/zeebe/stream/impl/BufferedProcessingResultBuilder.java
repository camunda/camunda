...
final class BufferedProcessingResultBuilder implements ProcessingResultBuilder {
  ...
  private boolean startANewBatch = false;
  ...
  @Override
  public ProcessingResultBuilder withStartANewBatch() {
    startANewBatch = true;
    return this;
  }
  ...
  public ProcessingResult build() {
    return new BufferedResult(
        mutableRecordBatch, processingResponse, postCommitTasks, !startANewBatch);
  }

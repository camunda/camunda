...
public class StartedHealthIndicatorTest {
  ...
  public void shouldReportUnknownWhenGatewayStateIsEmpty() {
    ...
    // then
    assertThat(actual.getStatus()).isSameAs(org.springframework.boot.health.contributor.Status.UNKNOWN);
  }
  ...
  public void shouldReportDownWhenGatewayStateIsInitial() {
    ...
    // then
    assertThat(actual.getStatus()).isSameAs(org.springframework.boot.health.contributor.Status.DOWN);
  }

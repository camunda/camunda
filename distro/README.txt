This is a distribution of Zeebe Tasklist ${project.version}
...
To run Zeebe Tasklist:
1. Adjust Zeebe Tasklist configuration file config/application.yml to point to your Zeebe and Elasticsearch instances

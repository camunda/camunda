...
2. Elasticsearch is running: it can be either the same instance configured for Zeebe export, or a separate one. See https://www.elastic.co/products/elasticsearch on how to install and run Elasticsearch

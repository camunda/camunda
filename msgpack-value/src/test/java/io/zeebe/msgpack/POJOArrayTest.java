...
public class POJOArrayTest
{
    ...
    public void shouldSerializePOJO()
    {
        ...
        assertThat(msgPackMap).containsOnly(entry("simpleArray", "[{longProp=123}, {longProp=456}, {longProp=789}]"));
    }
    ...
    public void shouldSerializeAfterPartiallyReadEntries()
    {
        ...
        assertThat(msgPackMap).containsOnly(entry("simpleArray", "[{longProp=123}, {longProp=456}, {longProp=789}, {longProp=555}, {longProp=777}]"));
    }
    ...
    public void shouldNotSerializeRemovedEntry()
    {
        ...
        final Map<String, Object> msgPackMap = MsgPackUtil.asMap(pojoBuffer, 0, pojoBuffer.capacity());
        assertThat(msgPackMap).containsOnly(entry("simpleArray", "[{longProp=123}, {longProp=456}, {longProp=555}, {longProp=777}]"));
    }
    ...
    public void shouldSerializeAppendedEntry()
    {
        ...
        final Map<String, Object> msgPackMap = MsgPackUtil.asMap(pojoBuffer, 0, pojoBuffer.capacity());
        assertThat(msgPackMap).containsOnly(entry("simpleArray", "[{longProp=123}, {longProp=456}, {longProp=789}, {longProp=555}, {longProp=777}, {longProp=999}]"));
    }
    ...
    public void shouldSerializeInbetweenAddedEntry()
    {
        ...
        final Map<String, Object> msgPackMap = MsgPackUtil.asMap(pojoBuffer, 0, pojoBuffer.capacity());
        assertThat(msgPackMap).containsOnly(entry("simpleArray", "[{longProp=123}, {longProp=456}, {longProp=789}, {longProp=999}, {longProp=555}, {longProp=777}]"));
    }

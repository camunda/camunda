...
public class DocumentPropertyTest
{
    ...
    public void shouldThrowExceptionIfInvalidDocumentIsSet()
    {
        ...
        assertThat(throwable).hasMessage("Document has invalid format. On root level an object is only allowed.");
    }
    ...
    public void shouldThrowExceptionOnDeserializeInvalidDocument()
    {
        ...
        assertThat(throwable).hasMessageContaining("Could not deserialize object. Deserialization stuck");
        ...
        assertThat(rootCause).hasMessage("Document has invalid format. On root level an object is only allowed.");
    }

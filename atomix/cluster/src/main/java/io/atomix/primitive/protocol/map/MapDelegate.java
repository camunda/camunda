...
public interface MapDelegate<K, V> extends Map<K, V> {
  ...
  /**
   * Adds the specified listener to the map which will be notified whenever the mappings in the map
   * are changed.
   *
  ...
  /**
   * Removes the specified listener from the map such that it will no longer receive change
   * notifications.
   *

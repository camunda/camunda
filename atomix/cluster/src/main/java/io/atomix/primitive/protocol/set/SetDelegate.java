...
public interface SetDelegate<E> extends Set<E> {
  ...
  /**
   * Adds the specified listener to the set which will be notified whenever the entries in the set
   * are changed.
   *
  ...
  /**
   * Removes the specified listener from the set such that it will no longer receive change
   * notifications.
   *

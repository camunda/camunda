...
public final class Namespaces {
  public static final Namespace BASIC = new FallbackNamespace(buildNamespace());
  ...
  private static Builder buildNamespace() {
    return new NamespaceImpl.Builder()
        ...
        .register(
            ArrayList.class, LinkedList.class, HashSet.class, LinkedHashSet.class, ArrayDeque.class)

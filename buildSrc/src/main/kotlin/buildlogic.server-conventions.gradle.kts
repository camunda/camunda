...
val commonsCodecVersion =
  versionCatalog.findVersion("commons-codec").get().requiredVersion
val commonsCollectionsVersion =
  versionCatalog.findVersion("org-apache-commons-commons-collections").get().requiredVersion
val commonsLoggingVersion =
  versionCatalog.findVersion("commons-logging").get().requiredVersion

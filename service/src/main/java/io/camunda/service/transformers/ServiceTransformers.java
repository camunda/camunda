...
public final class ServiceTransformers {
  ...
  public static void initializeTransformers(final ServiceTransformers mappers) {
    ...
    mappers.put(
        DecisionRequirementQuery.class,
        new TypedSearchQueryTransformer<DecisionRequirementFilter, DecisionRequirementSort>(
            mappers));
    ...
    mappers.put(DecisionRequirementFilter.class, new DecisionRequirementFilterTransformer());
  }
}

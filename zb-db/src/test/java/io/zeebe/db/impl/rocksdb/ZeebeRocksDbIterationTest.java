...
public class ZeebeRocksDbIterationTest {
  ...
  private ZeebeRocksDb<DefaultColumnFamily> zeebeDb;
  ...
  public void setup() throws Exception {
    ...
    zeebeDb = Mockito.spy(((ZeebeRocksDb<DefaultColumnFamily>) dbFactory.createDb(pathName)));
  ...
  public void shouldStopIteratingAfterPrefixExceeded() {
    ...
    Mockito.doAnswer(
        ...
        .when(zeebeDb)
        .newIterator(Mockito.anyLong(), Mockito.any(RocksDbReadOptions.class));

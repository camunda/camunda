...
import io.camunda.tasklist.zeebeimport.v100.record.RecordImpl;
import io.camunda.tasklist.zeebeimport.v100.record.value.JobRecordValueImpl;
import io.camunda.tasklist.zeebeimport.v100.record.value.ProcessInstanceRecordValueImpl;
import io.camunda.tasklist.zeebeimport.v100.record.value.VariableDocumentRecordImpl;
import io.camunda.tasklist.zeebeimport.v100.record.value.VariableRecordValueImpl;
import io.camunda.tasklist.zeebeimport.v100.record.value.deployment.DeployedProcessImpl;

...
public class TenantService {
  ...
  public TenantEntity fetchOrCreateTenant(final String tenantId, final String tenantName) {
    final var tenants =
  ...
  public void assignMemberToTenant(final Long tenantKey, final Long memberKey) {

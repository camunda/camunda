...
@SpringBootTest(
    classes = { TestApplicationWithNoBeans.class, ImportJob.class, ImportListenerIT.TestImportListener.class,
...
public class ImportListenerIT extends NoBeansIT {
  ...
  @MockBean
  private ImportBulkProcessor elasticsearchBulkProcessor;

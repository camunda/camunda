...
public class MappingMergeBenchmark
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        {
            final long startMerge = System.currentTimeMillis();
            final int resultLen = processor.merge(sourceDocument, sourceDocument, mappings);
            final long endMerge = System.currentTimeMillis();
            final long diff = endMerge - startMerge;
        ...
        System.out.println();
        System.out.println(String.format("Merge avg execution time: %d ms", avgDiff));
        System.out.println(String.format("Merge min execution time: %d ms", minDiff));
        System.out.println(String.format("Merge max execution time: %d ms", maxDiff));
    }

...
@EnableConfigurationProperties(
    LivenessGatewayPartitionLeaderAwarenessHealthIndicatorProperties.class)
@EnableScheduling
public class LivenessGatewayPartitionLeaderAwarenessHealthIndicatorAutoConfiguration {
  ...
  public HealthIndicator livenessGatewayPartitionLeaderAwarenessHealthIndicator(
      GatewayPartitionLeaderAwarenessHealthIndicator healthIndicator,
      LivenessGatewayPartitionLeaderAwarenessHealthIndicatorProperties properties) {

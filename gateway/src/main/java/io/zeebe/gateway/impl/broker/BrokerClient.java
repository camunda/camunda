...
public class BrokerClient implements AutoCloseable {
  ...
  static {
    final String version = BrokerClient.class.getPackage().getImplementationVersion();
  ...
  public BrokerClient(final ZeebeClientConfiguration configuration) {
    this(configuration, null);
  }

  public BrokerClient(final ZeebeClientConfiguration configuration, final ActorClock actorClock) {

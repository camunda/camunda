...
public class GatewayCfg {
  ...
  private Map<String, InterceptorCfg> interceptors = new HashMap<>();
  ...
  public Map<String, InterceptorCfg> getInterceptors() {
    return interceptors;
  }

  public void setInterceptors(final Map<String, InterceptorCfg> interceptors) {

...
public class GatewayResponsiveHealthIndicatorAutoConfigurationTest {
  ...
  public void shouldConfigureHealthIndicator() {
    ...
    final var properties = new GatewayResponsiveHealthIndicatorProperties();
    properties.setRequestTimeout(timeout);

    final var sutAutoConfig = new GatewayResponsiveHealthIndicatorAutoConfiguration();

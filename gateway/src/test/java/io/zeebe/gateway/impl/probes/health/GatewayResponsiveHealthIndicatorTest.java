...
public class GatewayResponsiveHealthIndicatorTest {
  ...
  private static final String CERTIFICATE_CHAIN_PATH =
      GatewayResponsiveHealthIndicatorTest.class
          .getClassLoader()
  ...
  public void shouldRejectNullConfigInConstructor() {
    assertThatThrownBy(() -> new GatewayResponsiveHealthIndicator(null, TEST_DURATION))
        .isExactlyInstanceOf(NullPointerException.class);
  }

  @Test
  public void shouldRejectNullDurationInConstructor() {
    assertThatThrownBy(() -> new GatewayResponsiveHealthIndicator(TEST_CFG, null))
        .isExactlyInstanceOf(NullPointerException.class);
  }

  @Test
  public void shouldRejectZeroDurationIn() {
    assertThatThrownBy(() -> new GatewayResponsiveHealthIndicator(TEST_CFG, Duration.ofSeconds(0)))
  ...
  public void shouldRejectNegativeDurationIn() {
    assertThatThrownBy(
            () -> new GatewayResponsiveHealthIndicator(TEST_CFG, Duration.ofSeconds(-10)))
        .isExactlyInstanceOf(IllegalArgumentException.class);
  }
  ...
  public void shouldReportUnknownIfNoZeebeClientCanBeSupplied() {
    // given
    final var healthIndicator = new GatewayResponsiveHealthIndicator(TEST_CFG, TEST_DURATION);
  ...
  public void shouldNotSupplyZeebeClientIfGatewayConfigIsNotInitialized() {
    ...
    final var healthIndicator = new GatewayResponsiveHealthIndicator(gatewayCfg, TEST_DURATION);
  ...
  public void testGetContactPoint() {
    // when
    final String actualContactPoint = GatewayResponsiveHealthIndicator.getContactPoint(TEST_CFG);
  ...
  public void testCreateZeebeClientShouldConfigureContactPoint() {
    ...
    final ZeebeClient actual =
        GatewayResponsiveHealthIndicator.createZeebeClient(TEST_CFG, TEST_DURATION);
  ...
  public void testCreateZeebeClientShouldPassCertificateChainPathIfSecurityIsEnabled() {
    ...
    final ZeebeClient actualZeebeClient =
        GatewayResponsiveHealthIndicator.createZeebeClient(
            securityEnabledGatewayCfg, TEST_DURATION);

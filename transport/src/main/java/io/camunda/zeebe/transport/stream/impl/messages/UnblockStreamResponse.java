...
public final class UnblockStreamResponse implements StreamResponse {
  private final MessageHeaderEncoder headerEncoder = new MessageHeaderEncoder();
  private final MessageHeaderDecoder headerDecoder = new MessageHeaderDecoder();

  private final UnblockStreamResponseEncoder messageEncoder = new UnblockStreamResponseEncoder();
  private final UnblockStreamResponseDecoder messageDecoder = new UnblockStreamResponseDecoder();

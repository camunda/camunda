...
public final class BlockStreamResponse implements StreamResponse {
  private final MessageHeaderEncoder headerEncoder = new MessageHeaderEncoder();
  private final MessageHeaderDecoder headerDecoder = new MessageHeaderDecoder();

  private final BlockStreamResponseEncoder messageEncoder = new BlockStreamResponseEncoder();
  private final BlockStreamResponseDecoder messageDecoder = new BlockStreamResponseDecoder();

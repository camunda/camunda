...
public final class BlockStreamRequest implements BufferReader, BufferWriter {
  private final MessageHeaderEncoder headerEncoder = new MessageHeaderEncoder();
  private final MessageHeaderDecoder headerDecoder = new MessageHeaderDecoder();

  private final BlockStreamRequestEncoder messageEncoder = new BlockStreamRequestEncoder();
  private final BlockStreamRequestDecoder messageDecoder = new BlockStreamRequestDecoder();
  ...
  public BlockStreamRequest streamId(final UUID streamId) {
  ...
  public boolean equals(final Object o) {
    ...
    final BlockStreamRequest that = (BlockStreamRequest) o;
    return Objects.equals(streamId, that.streamId);
  }

  @Override
  public String toString() {
    return "BlockStreamRequest{" + "streamId=" + streamId + '}';
  }
}

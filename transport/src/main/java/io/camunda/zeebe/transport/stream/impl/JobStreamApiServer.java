...
public final class JobStreamApiServer<M extends BufferReader, P extends BufferWriter> extends Actor
    implements ClusterMembershipEventListener {
  private final ClusterCommunicationService transport;
  private final StreamApiHandler<M> requestHandler;

  public JobStreamApiServer(
      final ClusterCommunicationService transport, final StreamApiHandler<M> requestHandler) {

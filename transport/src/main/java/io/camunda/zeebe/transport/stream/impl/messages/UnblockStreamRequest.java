...
public final class UnblockStreamRequest implements BufferReader, BufferWriter {
  private final MessageHeaderEncoder headerEncoder = new MessageHeaderEncoder();
  private final MessageHeaderDecoder headerDecoder = new MessageHeaderDecoder();

  private final UnblockStreamRequestEncoder messageEncoder = new UnblockStreamRequestEncoder();
  private final UnblockStreamRequestDecoder messageDecoder = new UnblockStreamRequestDecoder();
  ...
  public UnblockStreamRequest streamId(final UUID streamId) {
  ...
  public boolean equals(final Object o) {
    ...
    final UnblockStreamRequest that = (UnblockStreamRequest) o;
    return Objects.equals(streamId, that.streamId);
  }

  @Override
  public String toString() {
    return "UnblockStreamRequest{" + "streamId=" + streamId + '}';
  }
}

...
Artifact names: one per pod (each contains the cpu/wall/alloc reports for that pod), e.g. `flamegraph-<name>-<date>-camunda-0`, `flamegraph-<name>-<date>-camunda-1`, `flamegraph-<name>-<date>-camunda-2`

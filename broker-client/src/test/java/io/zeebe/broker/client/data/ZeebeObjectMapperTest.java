 ...
 */
package io.zeebe.broker.client.data;
...
import io.zeebe.broker.client.util.Events;
...
public class ZeebeObjectMapperTest {
  ...
  public void shouldThrowExceptionIfDeserializationFails() {
    assertThatThrownBy(() -> objectMapper.fromJson("invalid", JobEvent.class))
        ...
        .hasMessage(
            "Failed deserialize JSON 'invalid' to object of type 'io.zeebe.broker.client.api.events.JobEvent'");
  }
  ...
  public void shouldThrowExceptionIfDeserializeToWrongRecord() {
    ...
    assertThatThrownBy(() -> objectMapper.fromJson(json, WorkflowInstanceEvent.class))
        .isInstanceOf(ClientException.class)
        .hasMessage(
            "Cannot deserialize JSON to object of type 'io.zeebe.broker.client.api.events.WorkflowInstanceEvent'. Incompatible type for record 'EVENT - JOB'.");
  }
  ...
  public void shouldThrowExceptionIfDeserializeToImplClass() {
    ...
    assertThatThrownBy(() -> objectMapper.fromJson(json, JobEventImpl.class))
        .isInstanceOf(ClientException.class)
        .hasMessage(
            "Cannot deserialize JSON: unknown record class 'io.zeebe.broker.client.impl.event.JobEventImpl'");
  }
}

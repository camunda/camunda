 ...
 */
package io.zeebe.broker.client.event;
...
import io.zeebe.broker.client.api.subscription.DeploymentCommandHandler;
import io.zeebe.broker.client.api.subscription.RecordHandler;
import io.zeebe.broker.client.api.subscription.TopicCommandHandler;
...
public class ManagementSubscriptionTest {
  ...
  private void assertMetadata(
    ...
    final io.zeebe.broker.client.api.record.RecordType clientRecordType =
        io.zeebe.broker.client.api.record.RecordType.valueOf(expectedRecordType.name());
    final io.zeebe.broker.client.api.record.ValueType clientValueType =
        io.zeebe.broker.client.api.record.ValueType.valueOf(expectedValueType.name());

 ...
 */
package io.zeebe.broker.client.job;
...
import io.zeebe.broker.client.job.subscription.RecordingJobHandler;
...
public class JobPayloadTest {
  ...
  public void init() {
    ...
    clientRule.jobClient().newWorker().jobType("test").handler(jobHandler).open();

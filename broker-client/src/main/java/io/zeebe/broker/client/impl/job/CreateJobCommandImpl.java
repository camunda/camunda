 ...
 */
package io.zeebe.broker.client.impl.job;

import io.zeebe.broker.client.api.commands.CreateJobCommandStep1;
import io.zeebe.broker.client.api.commands.CreateJobCommandStep1.CreateJobCommandStep2;
...
import io.zeebe.broker.client.impl.command.JobCommandImpl;
...
public class CreateJobCommandImpl extends CommandImpl<JobEvent>
  ...
  @Override
  public CreateJobCommandStep2 payload(Object payload) {
    command.setPayload(payload);
    return this;
  }

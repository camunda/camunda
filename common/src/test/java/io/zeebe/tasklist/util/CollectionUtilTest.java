...
public class CollectionUtilTest {
  ...
  public void testAsMapException() {
    assertThatExceptionOfType(TasklistRuntimeException.class).isThrownBy(() -> CollectionUtil.asMap((Object[])null));
    assertThatExceptionOfType(TasklistRuntimeException.class).isThrownBy(() -> CollectionUtil.asMap("key1"));
    assertThatExceptionOfType(TasklistRuntimeException.class).isThrownBy(() -> CollectionUtil.asMap("key1","value1","key2"));
  }

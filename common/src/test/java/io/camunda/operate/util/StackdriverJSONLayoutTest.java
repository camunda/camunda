...
/**
 * This test ensures that StackdriverLayout defined in zeebe-util library is working as expected.
 * If the test is failing, then probably smth was changed on Zeebe side and we need to make adjustmets accordingly,
 * including /distro/config/log4j2.xml file and docs on logging.
 */
public class StackdriverJSONLayoutTest {
  ...
  @Rule
  public LoggerContextRule loggerRule = new LoggerContextRule("log4j2.xml");
  ...
  public void testLayout() throws Exception {
    ...
    final Map<String, Object> logMap = jsonReader.withValueToUpdate(new HashMap<String, String>())
        .readValue(messages.get(0));

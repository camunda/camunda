...
import io.camunda.operate.zeebeimport.v1_0.record.RecordValueWithPayloadImpl;
...
public class ProcessInstanceRecordValueImpl extends RecordValueWithPayloadImpl
  ...
  public boolean equals(Object o) {
    ...
    ProcessInstanceRecordValueImpl that = (ProcessInstanceRecordValueImpl) o;
  ...
  public String toString() {
    return "ProcessInstanceRecordValueImpl{" + "bpmnProcessId='" + bpmnProcessId + '\'' + ", elementId='" + elementId + '\'' + ", version=" + version
      + ", processDefinitionKey=" + processDefinitionKey + ", processInstanceKey=" + processInstanceKey + ", flowScopeKey=" + flowScopeKey + ", bpmnElementType="
      + bpmnElementType + ", parentProcessInstanceKey=" + parentProcessInstanceKey + ", parentElementInstanceKey=" + parentElementInstanceKey + "} " + super.toString();
  }
}

...
public class WebApplicationAuthorizationCheckFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    LOG.info("WebApplicationAuthorizationCheckFilter processing: {}", request.getRequestURI());
  ...
  private boolean hasClientCertificate(final HttpServletRequest request) {
    final Object certificates = request.getAttribute("javax.servlet.request.X509Certificate");

...
/**
 * Filter that checks whether the authenticated user has access to the requested web component
 * (identity, operate, tasklist). If not, redirects to the component's forbidden page.
 */

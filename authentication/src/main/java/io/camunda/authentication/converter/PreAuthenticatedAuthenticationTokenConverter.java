...
/**
 * Converter for PreAuthenticatedAuthenticationToken (mTLS authentication) to CamundaAuthentication.
 * Handles certificate-based authentication where the certificate is stored as credentials.
 */
public class PreAuthenticatedAuthenticationTokenConverter
  ...
  public PreAuthenticatedAuthenticationTokenConverter(
  ...
  public boolean supports(final Authentication authentication) {
    return Optional.ofNullable(authentication)
        ...
        .filter(token -> token.getCredentials() instanceof X509Certificate)
        .isPresent();
  }

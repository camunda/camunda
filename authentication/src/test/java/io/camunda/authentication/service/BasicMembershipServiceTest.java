...
public class BasicMembershipServiceTest {
  ...
  void setUp() throws Exception {
    ...
    membershipService = new BasicMembershipService(tenantServices, roleServices, groupServices);
  }

  @Test
  void shouldNotInvokeAnyServiceUntilProviderIsRead() {
    // given
    membershipService.createProviderForUser("demo");
  ...
  void shouldMemoizeMembershipLookups() {
    ...
    final var provider = membershipService.createProviderForUser("demo");

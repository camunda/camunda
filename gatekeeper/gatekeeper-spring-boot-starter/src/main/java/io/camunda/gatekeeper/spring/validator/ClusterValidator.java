...
/**
 * Validates the cluster ID claim of a JWT token. If the {@code https://camunda.com/clusterId} claim
 * is present, it must match the expected cluster ID.
 */
public final class ClusterValidator implements OAuth2TokenValidator<Jwt> {

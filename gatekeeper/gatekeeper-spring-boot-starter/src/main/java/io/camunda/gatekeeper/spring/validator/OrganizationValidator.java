...
/**
 * Validates the organization claim of a JWT token. If the {@code https://camunda.com/orgs} claim is
 * present, at least one organization entry must match the expected organization ID.
 */
public final class OrganizationValidator implements OAuth2TokenValidator<Jwt> {

 ...
 */
package io.camunda.gatekeeper.spring.util;

import jakarta.servlet.http.HttpServletRequest;
import org.springframework.security.web.util.UrlUtils;
import org.springframework.web.util.UriComponentsBuilder;

/** Utility methods for validating HTTP request redirects. */
public final class RequestValidationUtils {

  private RequestValidationUtils() {}

  /**
   * Returns {@code true} if the given URL is a valid redirect target pointing back to the same
   * application host.
   */

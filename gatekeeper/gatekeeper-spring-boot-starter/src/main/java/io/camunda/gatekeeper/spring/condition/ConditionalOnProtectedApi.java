...
import io.camunda.gatekeeper.spring.condition.ConditionalOnProtectedApi.OnProtectedApiCondition;
...
public @interface ConditionalOnProtectedApi {
  ...
  final class OnProtectedApiCondition implements Condition {
    @Override

 ...
 * attribute. This ensures that the same {@link CamundaAuthentication} is returned while processing
 * a request. However, Spring bounds the request attributes to the current thread. By default, the
 * request attributes are not inheritable for child threads.
 */
public final class RequestContextBasedAuthenticationHolder implements CamundaAuthenticationHolder {

  static final String CAMUNDA_AUTHENTICATION_REQUEST_HOLDER_KEY =
      "io.camunda.gatekeeper:CamundaAuthentication";

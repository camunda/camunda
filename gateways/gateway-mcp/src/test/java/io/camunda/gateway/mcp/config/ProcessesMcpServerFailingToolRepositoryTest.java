...
import io.camunda.gateway.mcp.config.ProcessesMcpServerFailingToolRepositoryTest.FailingToolsConfiguration;
...
@ContextConfiguration(classes = FailingToolsConfiguration.class)
class ProcessesMcpServerFailingToolRepositoryTest extends ToolsTest {

...
import io.camunda.gateway.mcp.tool.demo.DemoTools;
 ...
 * src/test/resources/schema/tool-schemas-snapshot.json
 */
...
class ToolSchemaRegressionTest extends ToolsTest {

  private static final String SNAPSHOT_PATH = "schema/tool-schemas-snapshot.json";
  ...
  void toolSchemasShouldMatchSnapshot() throws IOException, JSONException {
    ...
    JSONAssert.assertEquals(
        "Tool schemas should match snapshot. "

...
@Schema(
    name = "AdvancedIncidentStateFilter",
    description =
        "Advanced IncidentState filter with different filter operations (can be combined).")
public record AdvancedIncidentStateFilter(
    @Nullable
        @Schema(
            name = "eq",

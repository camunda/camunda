...
/**
 * MCP-specific date range filter with {@code from} (inclusive) and {@code to} (exclusive)
 * boundaries. Used in MCP tool filter records to represent date/time range constraints.
 */

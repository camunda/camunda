...
/**
 * MCP-specific user task search query facade. Wraps the MCP-owned filter with existing page/sort
 * types.
 */
@JsonInclude(JsonInclude.Include.ALWAYS)
public record McpUserTaskSearchQuery(
    @JsonProperty
        @JsonPropertyDescription("The user task search filters.")
        @Schema(requiredMode = RequiredMode.NOT_REQUIRED, defaultValue = "##default")
        McpUserTaskFilter filter,
    @JsonProperty
    ...
    @JsonProperty
        ...
        @Schema(requiredMode = RequiredMode.NOT_REQUIRED, defaultValue = "##default")
        List<GeneratedUserTaskSearchQuerySortRequestStrictContract> sort) {}

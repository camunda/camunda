...
/**
 * MCP-specific process instance search query facade. Wraps the MCP-owned filter with existing
 * page/sort types.
 */
@JsonInclude(JsonInclude.Include.ALWAYS)
public record McpProcessInstanceSearchQuery(
    @JsonProperty
        @JsonPropertyDescription("The process instance search filters.")
        @Schema(requiredMode = RequiredMode.NOT_REQUIRED, defaultValue = "##default")
        McpProcessInstanceFilter filter,
    @JsonProperty
    ...
    @JsonProperty
        ...
        @Schema(requiredMode = RequiredMode.NOT_REQUIRED, defaultValue = "##default")
        List<GeneratedProcessInstanceSearchQuerySortRequestStrictContract> sort) {}

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-definitions.yaml#/components/schemas/ProcessDefinitionSearchQueryResult
 */
...
public record GeneratedProcessDefinitionSearchQueryStrictContract(
  ...
  public static java.util.List<GeneratedProcessDefinitionStrictContract> coerceItems(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedProcessDefinitionStrictContract, but was " + value.getClass().getName());
    }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("ProcessDefinitionSearchQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("ProcessDefinitionSearchQueryResult", "items");

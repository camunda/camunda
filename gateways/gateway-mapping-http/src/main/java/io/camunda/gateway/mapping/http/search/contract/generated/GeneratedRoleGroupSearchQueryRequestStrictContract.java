...
public record GeneratedRoleGroupSearchQueryRequestStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep sort(
        final java.util.@Nullable List<GeneratedRoleGroupSearchQuerySortRequestStrictContract>
            sort) {
      this.sort = sort;
      return this;
    }
    ...
    public Builder sort(
        final java.util.@Nullable List<GeneratedRoleGroupSearchQuerySortRequestStrictContract> sort,

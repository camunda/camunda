...
public record GeneratedJobFailRequestStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep retryBackOff(final @Nullable Long retryBackOff, final ContractPolicy.FieldPolicy<Long> policy) {
  ...
  OptionalStep retryBackOff(final @Nullable Long retryBackOff, final ContractPolicy.FieldPolicy<Long> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef RETRIES = ContractPolicy.field("JobFailRequest", "retries");
    public static final ContractPolicy.FieldRef ERROR_MESSAGE = ContractPolicy.field("JobFailRequest", "errorMessage");
    public static final ContractPolicy.FieldRef RETRY_BACK_OFF = ContractPolicy.field("JobFailRequest", "retryBackOff");
    public static final ContractPolicy.FieldRef VARIABLES = ContractPolicy.field("JobFailRequest", "variables");

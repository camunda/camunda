...
public record GeneratedGroupSearchQueryRequestStrictContract(
    @Nullable java.util.List<GeneratedGroupSearchQuerySortRequestStrictContract> sort,
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep sort(
        final java.util.List<GeneratedGroupSearchQuerySortRequestStrictContract> sort) {
      this.sort = sort;
      return this;
    }
    ...
    @Override
    public OptionalStep filter(final GeneratedGroupFilterStrictContract filter) {
      this.filter = filter;
      return this;
    }
    ...
    public Builder filter(
        final GeneratedGroupFilterStrictContract filter,
  ...
  public interface OptionalStep {
    ...
    OptionalStep filter(final GeneratedGroupFilterStrictContract filter);

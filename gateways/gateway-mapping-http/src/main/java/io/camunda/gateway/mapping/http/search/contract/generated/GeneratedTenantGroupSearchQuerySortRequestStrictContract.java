...
public record GeneratedTenantGroupSearchQuerySortRequestStrictContract(
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    public GeneratedTenantGroupSearchQuerySortRequestStrictContract build() {
      return new GeneratedTenantGroupSearchQuerySortRequestStrictContract(this.field, this.order);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD =
        ContractPolicy.field("TenantGroupSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER =
        ContractPolicy.field("TenantGroupSearchQuerySortRequest", "order");

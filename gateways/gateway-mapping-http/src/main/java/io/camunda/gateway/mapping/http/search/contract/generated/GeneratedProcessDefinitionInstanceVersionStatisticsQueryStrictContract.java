...
public record GeneratedProcessDefinitionInstanceVersionStatisticsQueryStrictContract(
  ...
  public static java.util.List<GeneratedProcessDefinitionInstanceVersionStatisticsStrictContract> coerceItems(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedProcessDefinitionInstanceVersionStatisticsStrictContract, but was " + value.getClass().getName());
    }

    final var result = new ArrayList<GeneratedProcessDefinitionInstanceVersionStatisticsStrictContract>(listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
      } else if (item instanceof GeneratedProcessDefinitionInstanceVersionStatisticsStrictContract strictItem) {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsQueryResult", "items");

...
public record GeneratedAdvancedClusterVariableScopeFilterStrictContract(
    @Nullable io.camunda.gateway.protocol.model.ClusterVariableScopeEnum eq,
    @Nullable io.camunda.gateway.protocol.model.ClusterVariableScopeEnum neq,
    @Nullable Boolean exists,
    @Nullable java.util.List<io.camunda.gateway.protocol.model.ClusterVariableScopeEnum> in,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final io.camunda.gateway.protocol.model.ClusterVariableScopeEnum eq) {
      this.eq = eq;
      return this;
    }
    ...
    public OptionalStep eq(
        final io.camunda.gateway.protocol.model.ClusterVariableScopeEnum eq,
    ...
    @Override
    public OptionalStep neq(final io.camunda.gateway.protocol.model.ClusterVariableScopeEnum neq) {
      this.neq = neq;
      return this;
    }
    ...
    public OptionalStep neq(
        final io.camunda.gateway.protocol.model.ClusterVariableScopeEnum neq,
        final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.ClusterVariableScopeEnum>
            policy) {
    ...
    public OptionalStep in(
        final java.util.List<io.camunda.gateway.protocol.model.ClusterVariableScopeEnum> in) {
      this.in = in;
      return this;
    }
  ...
  public interface OptionalStep {
    OptionalStep eq(final io.camunda.gateway.protocol.model.ClusterVariableScopeEnum eq);
    ...
    OptionalStep neq(final io.camunda.gateway.protocol.model.ClusterVariableScopeEnum neq);

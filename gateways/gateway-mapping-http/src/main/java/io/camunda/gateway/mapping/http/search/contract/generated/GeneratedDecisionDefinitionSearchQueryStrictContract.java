...
public record GeneratedDecisionDefinitionSearchQueryStrictContract(
    ...
    @JsonProperty("items") java.util.List<GeneratedDecisionDefinitionStrictContract> items) {
  ...
  public static java.util.List<GeneratedDecisionDefinitionStrictContract> coerceItems(
      final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedDecisionDefinitionStrictContract, but was "
              + value.getClass().getName());
    }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("DecisionDefinitionSearchQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("DecisionDefinitionSearchQueryResult", "items");

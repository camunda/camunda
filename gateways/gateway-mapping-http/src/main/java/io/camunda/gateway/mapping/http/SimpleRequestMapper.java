...
public class SimpleRequestMapper {
  ...
  private static List<ProcessInstanceCreationRuntimeInstruction>
    ...
    return instructions.stream()
        .map(
            (io.camunda.gateway.protocol.model.simple.ProcessInstanceCreationTerminateInstruction
                    instruction) -> {
              final var mapped =
              ...
              return (ProcessInstanceCreationRuntimeInstruction) mapped;
            })
        .toList();
  }
}

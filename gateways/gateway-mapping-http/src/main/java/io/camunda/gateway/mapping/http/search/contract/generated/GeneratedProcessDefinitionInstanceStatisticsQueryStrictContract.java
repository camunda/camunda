...
public record GeneratedProcessDefinitionInstanceStatisticsQueryStrictContract(
  ...
  public static java.util.List<GeneratedProcessDefinitionInstanceStatisticsStrictContract>
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedProcessDefinitionInstanceStatisticsStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedProcessDefinitionInstanceStatisticsStrictContract>(listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
      } else if (item
          instanceof GeneratedProcessDefinitionInstanceStatisticsStrictContract strictItem) {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("ProcessDefinitionInstanceStatisticsQueryResult", "items");

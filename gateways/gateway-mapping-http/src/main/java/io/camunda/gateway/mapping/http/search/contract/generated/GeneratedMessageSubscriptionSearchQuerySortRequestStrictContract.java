 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/messages.yaml#/components/schemas/MessageSubscriptionSearchQuerySortRequest
 */
...
public record GeneratedMessageSubscriptionSearchQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedMessageSubscriptionSearchQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedMessageSubscriptionSearchQuerySortRequestStrictContract build() {
      return new GeneratedMessageSubscriptionSearchQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedMessageSubscriptionSearchQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("MessageSubscriptionSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("MessageSubscriptionSearchQuerySortRequest", "order");

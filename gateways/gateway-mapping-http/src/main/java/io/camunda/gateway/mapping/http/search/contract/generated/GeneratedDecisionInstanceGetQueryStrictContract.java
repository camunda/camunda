 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/decision-instances.yaml#/components/schemas/DecisionInstanceGetQueryResult
 */
...
public record GeneratedDecisionInstanceGetQueryStrictContract(
  ...
  public GeneratedDecisionInstanceGetQueryStrictContract {
  ...
  public static final class Builder
    ...
    @Override
    public EvaluatedInputsStep tenantId(final String tenantId) {
      this.tenantId = tenantId;
      return this;
    }

    @Override
    public MatchedRulesStep evaluatedInputs(final Object evaluatedInputs) {
      this.evaluatedInputs = evaluatedInputs;
      return this;
    }

    @Override
    public OptionalStep matchedRules(final Object matchedRules) {
    ...
    @Override
    public GeneratedDecisionInstanceGetQueryStrictContract build() {
  ...
  public interface TenantIdStep {
    EvaluatedInputsStep tenantId(final String tenantId);
  }

  public interface EvaluatedInputsStep {
    MatchedRulesStep evaluatedInputs(final Object evaluatedInputs);
  }

  public interface MatchedRulesStep {
    OptionalStep matchedRules(final Object matchedRules);
  }
  ...
  public interface OptionalStep {
    ...
    GeneratedDecisionInstanceGetQueryStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef DECISION_DEFINITION_ID =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "decisionDefinitionId");
    public static final ContractPolicy.FieldRef DECISION_DEFINITION_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "decisionDefinitionKey");
    public static final ContractPolicy.FieldRef DECISION_DEFINITION_NAME =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "decisionDefinitionName");
    public static final ContractPolicy.FieldRef DECISION_DEFINITION_TYPE =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "decisionDefinitionType");
    public static final ContractPolicy.FieldRef DECISION_DEFINITION_VERSION =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "decisionDefinitionVersion");
    public static final ContractPolicy.FieldRef DECISION_EVALUATION_INSTANCE_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "decisionEvaluationInstanceKey");
    public static final ContractPolicy.FieldRef DECISION_EVALUATION_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "decisionEvaluationKey");
    public static final ContractPolicy.FieldRef ELEMENT_INSTANCE_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "elementInstanceKey");
    public static final ContractPolicy.FieldRef EVALUATION_DATE =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "evaluationDate");
    public static final ContractPolicy.FieldRef EVALUATION_FAILURE =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "evaluationFailure");
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "processDefinitionKey");
    public static final ContractPolicy.FieldRef PROCESS_INSTANCE_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "processInstanceKey");
    public static final ContractPolicy.FieldRef RESULT =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "result");
    public static final ContractPolicy.FieldRef ROOT_DECISION_DEFINITION_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "rootDecisionDefinitionKey");
    public static final ContractPolicy.FieldRef ROOT_PROCESS_INSTANCE_KEY =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "rootProcessInstanceKey");
    public static final ContractPolicy.FieldRef STATE =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "state");
    public static final ContractPolicy.FieldRef TENANT_ID =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "tenantId");
    public static final ContractPolicy.FieldRef EVALUATED_INPUTS =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "evaluatedInputs");
    public static final ContractPolicy.FieldRef MATCHED_RULES =
        ContractPolicy.field("DecisionInstanceGetQueryResult", "matchedRules");

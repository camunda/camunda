...
public record GeneratedJobWorkerStatisticsQueryResultStrictContract(
    @JsonProperty("page") GeneratedSearchQueryPageResponseStrictContract page,
    @JsonProperty("items") java.util.List<GeneratedJobWorkerStatisticsItemStrictContract> items) {

  public GeneratedJobWorkerStatisticsQueryResultStrictContract {
  ...
  public static java.util.List<GeneratedJobWorkerStatisticsItemStrictContract> coerceItems(
      final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedJobWorkerStatisticsItemStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedJobWorkerStatisticsItemStrictContract>(listValue.size());
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    @Override
    public GeneratedJobWorkerStatisticsQueryResultStrictContract build() {
  ...
  public interface OptionalStep {
    GeneratedJobWorkerStatisticsQueryResultStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("JobWorkerStatisticsQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("JobWorkerStatisticsQueryResult", "items");

...
public final class DecisionInstanceContractAdapter {
  ...
  public static DecisionInstanceGetQueryResult toGetProjection(
    ...
    return new DecisionInstanceGetQueryResult()
        ...
        .elementInstanceKey(sc.getElementInstanceKey().orElse(null))
        .evaluationDate(sc.getEvaluationDate())
        .evaluationFailure(sc.getEvaluationFailure().orElse(null))
        .processDefinitionKey(sc.getProcessDefinitionKey().orElse(null))
        .processInstanceKey(sc.getProcessInstanceKey().orElse(null))
        .result(sc.getResult())
        .rootDecisionDefinitionKey(sc.getRootDecisionDefinitionKey())
        .rootProcessInstanceKey(sc.getRootProcessInstanceKey().orElse(null))
        .state(sc.getState())

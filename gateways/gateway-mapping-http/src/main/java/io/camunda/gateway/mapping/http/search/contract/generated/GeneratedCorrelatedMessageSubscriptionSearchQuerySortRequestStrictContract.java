 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/messages.yaml#/components/schemas/CorrelatedMessageSubscriptionSearchQuerySortRequest
 */
...
public record GeneratedCorrelatedMessageSubscriptionSearchQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedCorrelatedMessageSubscriptionSearchQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedCorrelatedMessageSubscriptionSearchQuerySortRequestStrictContract build() {
      return new GeneratedCorrelatedMessageSubscriptionSearchQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedCorrelatedMessageSubscriptionSearchQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("CorrelatedMessageSubscriptionSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("CorrelatedMessageSubscriptionSearchQuerySortRequest", "order");

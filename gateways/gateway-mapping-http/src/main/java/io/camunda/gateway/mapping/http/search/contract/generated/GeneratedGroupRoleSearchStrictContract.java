 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/groups.yaml#/components/schemas/GroupRoleSearchResult
 */
...
public record GeneratedGroupRoleSearchStrictContract(
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    @Override
    public GeneratedGroupRoleSearchStrictContract build() {
      return new GeneratedGroupRoleSearchStrictContract(
  ...
  public interface OptionalStep {
    GeneratedGroupRoleSearchStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("GroupRoleSearchResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("GroupRoleSearchResult", "items");

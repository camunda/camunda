 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-definitions.yaml#/components/schemas/ProcessDefinitionInstanceVersionStatisticsResult
 */
...
public record GeneratedProcessDefinitionInstanceVersionStatisticsStrictContract(
  ...
  public static final class Builder implements ProcessDefinitionIdStep, ProcessDefinitionKeyStep, TenantIdStep, ProcessDefinitionVersionStep, ActiveInstancesWithIncidentCountStep, ActiveInstancesWithoutIncidentCountStep, OptionalStep {
    ...
    @Override
    public ActiveInstancesWithIncidentCountStep processDefinitionVersion(final Integer processDefinitionVersion) {
      this.processDefinitionVersion = processDefinitionVersion;
      return this;
    }

    @Override
    public ActiveInstancesWithoutIncidentCountStep activeInstancesWithIncidentCount(final Long activeInstancesWithIncidentCount) {
      this.activeInstancesWithIncidentCount = activeInstancesWithIncidentCount;
      return this;
    }

    @Override
    public OptionalStep activeInstancesWithoutIncidentCount(final Long activeInstancesWithoutIncidentCount) {
  ...
  public interface ProcessDefinitionVersionStep {
    ActiveInstancesWithIncidentCountStep processDefinitionVersion(final Integer processDefinitionVersion);
  }

  public interface ActiveInstancesWithIncidentCountStep {
    ActiveInstancesWithoutIncidentCountStep activeInstancesWithIncidentCount(final Long activeInstancesWithIncidentCount);
  }

  public interface ActiveInstancesWithoutIncidentCountStep {
    OptionalStep activeInstancesWithoutIncidentCount(final Long activeInstancesWithoutIncidentCount);
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_ID = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsResult", "processDefinitionId");
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_KEY = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsResult", "processDefinitionKey");
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_NAME = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsResult", "processDefinitionName");
    public static final ContractPolicy.FieldRef TENANT_ID = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsResult", "tenantId");
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_VERSION = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsResult", "processDefinitionVersion");
    public static final ContractPolicy.FieldRef ACTIVE_INSTANCES_WITH_INCIDENT_COUNT = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsResult", "activeInstancesWithIncidentCount");
    public static final ContractPolicy.FieldRef ACTIVE_INSTANCES_WITHOUT_INCIDENT_COUNT = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsResult", "activeInstancesWithoutIncidentCount");

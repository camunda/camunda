 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/filters.yaml#/components/schemas/AdvancedStringFilter
 */
...
public record GeneratedAdvancedStringFilterStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public GeneratedAdvancedStringFilterStrictContract build() {
      return new GeneratedAdvancedStringFilterStrictContract(
  ...
  public interface OptionalStep {
    ...
    GeneratedAdvancedStringFilterStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedStringFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedStringFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedStringFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedStringFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedStringFilter", "$notIn");
    public static final ContractPolicy.FieldRef $LIKE =
        ContractPolicy.field("AdvancedStringFilter", "$like");

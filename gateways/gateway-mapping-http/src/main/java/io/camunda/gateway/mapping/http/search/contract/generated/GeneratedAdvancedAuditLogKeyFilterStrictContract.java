...
public record GeneratedAdvancedAuditLogKeyFilterStrictContract(
    ...
    implements GeneratedAuditLogKeyFilterPropertyStrictContract {

  public GeneratedAdvancedAuditLogKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedAuditLogKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedAuditLogKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedAuditLogKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedAuditLogKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedAuditLogKeyFilter", "$notIn");

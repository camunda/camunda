 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/jobs.yaml#/components/schemas/JobResultCorrections
 */
...
public record GeneratedJobResultCorrectionsStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef ASSIGNEE = ContractPolicy.field("JobResultCorrections", "assignee");
    public static final ContractPolicy.FieldRef DUE_DATE = ContractPolicy.field("JobResultCorrections", "dueDate");
    public static final ContractPolicy.FieldRef FOLLOW_UP_DATE = ContractPolicy.field("JobResultCorrections", "followUpDate");
    public static final ContractPolicy.FieldRef CANDIDATE_USERS = ContractPolicy.field("JobResultCorrections", "candidateUsers");
    public static final ContractPolicy.FieldRef CANDIDATE_GROUPS = ContractPolicy.field("JobResultCorrections", "candidateGroups");
    public static final ContractPolicy.FieldRef PRIORITY = ContractPolicy.field("JobResultCorrections", "priority");

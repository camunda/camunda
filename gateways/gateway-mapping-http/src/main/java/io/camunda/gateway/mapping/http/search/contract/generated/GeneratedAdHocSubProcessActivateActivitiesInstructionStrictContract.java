...
public record GeneratedAdHocSubProcessActivateActivitiesInstructionStrictContract(
  ...
  public static java.util.List<GeneratedAdHocSubProcessActivateActivityReferenceStrictContract> coerceElements(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "elements must be a List of GeneratedAdHocSubProcessActivateActivityReferenceStrictContract, but was " + value.getClass().getName());
    }

    final var result = new ArrayList<GeneratedAdHocSubProcessActivateActivityReferenceStrictContract>(listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
      } else if (item instanceof GeneratedAdHocSubProcessActivateActivityReferenceStrictContract strictItem) {
  ...
  public static final class Builder implements ElementsStep, OptionalStep {
    ...
    @Override
    public OptionalStep cancelRemainingInstances(final @Nullable Boolean cancelRemainingInstances, final ContractPolicy.FieldPolicy<Boolean> policy) {
      this.cancelRemainingInstances = policy.apply(cancelRemainingInstances, Fields.CANCEL_REMAINING_INSTANCES, null);
      return this;
    }
  ...
  OptionalStep cancelRemainingInstances(final @Nullable Boolean cancelRemainingInstances, final ContractPolicy.FieldPolicy<Boolean> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef ELEMENTS = ContractPolicy.field("AdHocSubProcessActivateActivitiesInstruction", "elements");
    public static final ContractPolicy.FieldRef CANCEL_REMAINING_INSTANCES = ContractPolicy.field("AdHocSubProcessActivateActivitiesInstruction", "cancelRemainingInstances");

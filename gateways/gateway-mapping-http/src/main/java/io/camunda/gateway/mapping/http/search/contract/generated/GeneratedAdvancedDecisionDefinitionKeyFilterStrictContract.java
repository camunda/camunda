...
public record GeneratedAdvancedDecisionDefinitionKeyFilterStrictContract(
    ...
    implements GeneratedDecisionDefinitionKeyFilterPropertyStrictContract {

  public GeneratedAdvancedDecisionDefinitionKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedDecisionDefinitionKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedDecisionDefinitionKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedDecisionDefinitionKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedDecisionDefinitionKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedDecisionDefinitionKeyFilter", "$notIn");

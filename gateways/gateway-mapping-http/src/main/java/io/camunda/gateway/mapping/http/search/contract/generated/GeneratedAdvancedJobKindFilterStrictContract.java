...
public record GeneratedAdvancedJobKindFilterStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final io.camunda.gateway.protocol.model.@Nullable JobKindEnum eq, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.JobKindEnum> policy) {
    ...
    @Override
    public OptionalStep neq(final io.camunda.gateway.protocol.model.@Nullable JobKindEnum neq, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.JobKindEnum> policy) {
    ...
    @Override
    public OptionalStep in(final java.util.@Nullable List<io.camunda.gateway.protocol.model.JobKindEnum> in) {
      this.in = in;
      return this;
    }

    @Override
    public OptionalStep in(final java.util.@Nullable List<io.camunda.gateway.protocol.model.JobKindEnum> in, final ContractPolicy.FieldPolicy<java.util.List<io.camunda.gateway.protocol.model.JobKindEnum>> policy) {
  ...
  OptionalStep eq(final io.camunda.gateway.protocol.model.@Nullable JobKindEnum eq, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.JobKindEnum> policy);


  OptionalStep neq(final io.camunda.gateway.protocol.model.@Nullable JobKindEnum neq);

  OptionalStep neq(final io.camunda.gateway.protocol.model.@Nullable JobKindEnum neq, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.JobKindEnum> policy);
  ...
  OptionalStep in(final java.util.@Nullable List<io.camunda.gateway.protocol.model.JobKindEnum> in);

  OptionalStep in(final java.util.@Nullable List<io.camunda.gateway.protocol.model.JobKindEnum> in, final ContractPolicy.FieldPolicy<java.util.List<io.camunda.gateway.protocol.model.JobKindEnum>> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedJobKindFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedJobKindFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedJobKindFilter", "$exists");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedJobKindFilter", "$in");
    public static final ContractPolicy.FieldRef LIKE = ContractPolicy.field("AdvancedJobKindFilter", "$like");

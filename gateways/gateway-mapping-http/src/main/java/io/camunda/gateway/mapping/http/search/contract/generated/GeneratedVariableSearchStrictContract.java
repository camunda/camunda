...
public record GeneratedVariableSearchStrictContract(
  ...
  public static final class Builder implements NameStep, TenantIdStep, VariableKeyStep, ScopeKeyStep, ProcessInstanceKeyStep, ValueStep, IsTruncatedStep, OptionalStep {
    private String name;
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef NAME = ContractPolicy.field("VariableSearchResult", "name");
    public static final ContractPolicy.FieldRef TENANT_ID = ContractPolicy.field("VariableSearchResult", "tenantId");
    public static final ContractPolicy.FieldRef VARIABLE_KEY = ContractPolicy.field("VariableSearchResult", "variableKey");
    public static final ContractPolicy.FieldRef SCOPE_KEY = ContractPolicy.field("VariableSearchResult", "scopeKey");
    public static final ContractPolicy.FieldRef PROCESS_INSTANCE_KEY = ContractPolicy.field("VariableSearchResult", "processInstanceKey");
    public static final ContractPolicy.FieldRef ROOT_PROCESS_INSTANCE_KEY = ContractPolicy.field("VariableSearchResult", "rootProcessInstanceKey");
    public static final ContractPolicy.FieldRef VALUE = ContractPolicy.field("VariableSearchResult", "value");
    public static final ContractPolicy.FieldRef IS_TRUNCATED = ContractPolicy.field("VariableSearchResult", "isTruncated");

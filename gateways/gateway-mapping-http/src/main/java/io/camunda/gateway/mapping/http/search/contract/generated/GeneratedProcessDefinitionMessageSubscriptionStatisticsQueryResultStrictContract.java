 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-definitions.yaml#/components/schemas/ProcessDefinitionMessageSubscriptionStatisticsQueryResult
 */
...
public record GeneratedProcessDefinitionMessageSubscriptionStatisticsQueryResultStrictContract(
    @JsonProperty("page") GeneratedSearchQueryPageResponseStrictContract page,
    @JsonProperty("items")
        java.util.List<GeneratedProcessDefinitionMessageSubscriptionStatisticsStrictContract>
            items) {

  public GeneratedProcessDefinitionMessageSubscriptionStatisticsQueryResultStrictContract {
  ...
  public interface OptionalStep {
    GeneratedProcessDefinitionMessageSubscriptionStatisticsQueryResultStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("ProcessDefinitionMessageSubscriptionStatisticsQueryResult", "page");

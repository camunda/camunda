 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/messages.yaml#/components/schemas/AdvancedMessageSubscriptionKeyFilter
 */
...
public record GeneratedAdvancedMessageSubscriptionKeyFilterStrictContract(
    @Nullable String eq,
    @Nullable String neq,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public GeneratedAdvancedMessageSubscriptionKeyFilterStrictContract build() {
      return new GeneratedAdvancedMessageSubscriptionKeyFilterStrictContract(
          coerceEq(this.eq),
          coerceNeq(this.neq),
          this.exists,
          this.in,
  ...
  OptionalStep notIn(final java.util.@Nullable List<String> notIn, final ContractPolicy.FieldPolicy<java.util.List<String>> policy);
    ...
    GeneratedAdvancedMessageSubscriptionKeyFilterStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$in");
    public static final ContractPolicy.FieldRef NOT_IN = ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$notIn");

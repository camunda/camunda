...
public record GeneratedAdvancedMessageSubscriptionKeyFilterStrictContract(
    ...
    implements GeneratedMessageSubscriptionKeyFilterPropertyStrictContract {

  public GeneratedAdvancedMessageSubscriptionKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedMessageSubscriptionKeyFilter", "$notIn");

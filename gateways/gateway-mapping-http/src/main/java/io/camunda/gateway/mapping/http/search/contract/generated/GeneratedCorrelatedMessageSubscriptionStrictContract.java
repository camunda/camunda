...
public record GeneratedCorrelatedMessageSubscriptionStrictContract(
    ...
    @JsonProperty("correlationTime") String correlationTime,
    ...
    @JsonProperty("subscriptionKey") String subscriptionKey,
    @JsonProperty("tenantId") String tenantId) {

  public GeneratedCorrelatedMessageSubscriptionStrictContract {
    Objects.requireNonNull(correlationTime, "No correlationTime provided.");
    ...
    Objects.requireNonNull(subscriptionKey, "No subscriptionKey provided.");

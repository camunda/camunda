...
public record GeneratedAuthorizationSearchQueryStrictContract(
    @JsonProperty("page") @Nullable Object page,
    @JsonProperty("sort")
        java.util.@Nullable List<GeneratedAuthorizationSearchQuerySortRequestStrictContract> sort,
    @JsonProperty("filter") @Nullable GeneratedAuthorizationFilterStrictContract filter) {
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep sort(
        final java.util.@Nullable List<GeneratedAuthorizationSearchQuerySortRequestStrictContract>
            sort) {
      this.sort = sort;
      return this;
    }
    ...
    public Builder filter(
        final @Nullable GeneratedAuthorizationFilterStrictContract filter,
    ...
    public GeneratedAuthorizationSearchQueryStrictContract build() {
      return new GeneratedAuthorizationSearchQueryStrictContract(
          this.page, coerceSort(this.sort), coerceFilter(this.filter));
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("AuthorizationSearchQuery", "page");

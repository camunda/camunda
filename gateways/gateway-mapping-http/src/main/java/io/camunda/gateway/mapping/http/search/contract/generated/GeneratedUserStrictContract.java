 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/users.yaml#/components/schemas/UserResult
 */
...
public record GeneratedUserStrictContract(
  ...
  public static final class Builder implements UsernameStep, OptionalStep {
    ...
    public GeneratedUserStrictContract build() {
      return new GeneratedUserStrictContract(
          this.username,
          this.name,
          this.email);
    }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef USERNAME = ContractPolicy.field("UserResult", "username");

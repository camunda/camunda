...
public record GeneratedMappingRuleSearchQuerySortRequestStrictContract(
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    public GeneratedMappingRuleSearchQuerySortRequestStrictContract build() {
      return new GeneratedMappingRuleSearchQuerySortRequestStrictContract(this.field, this.order);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD =
        ContractPolicy.field("MappingRuleSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER =
        ContractPolicy.field("MappingRuleSearchQuerySortRequest", "order");

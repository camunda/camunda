...
public record GeneratedVariableStrictContract(String value) {
  ...
  public static final class Builder implements ValueStep, OptionalStep {
    ...
    @Override
    public OptionalStep value(final String value, final ContractPolicy.FieldPolicy<String> policy) {
      this.value = value;
  ...
  public interface ValueStep {
    OptionalStep value(final String value, final ContractPolicy.FieldPolicy<String> policy);
  }

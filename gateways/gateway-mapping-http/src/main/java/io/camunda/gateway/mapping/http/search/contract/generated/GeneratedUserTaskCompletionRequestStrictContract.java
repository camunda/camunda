...
public record GeneratedUserTaskCompletionRequestStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    public GeneratedUserTaskCompletionRequestStrictContract build() {
      return new GeneratedUserTaskCompletionRequestStrictContract(
          this.variables,
          this.action);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef VARIABLES = ContractPolicy.field("UserTaskCompletionRequest", "variables");
    public static final ContractPolicy.FieldRef ACTION = ContractPolicy.field("UserTaskCompletionRequest", "action");

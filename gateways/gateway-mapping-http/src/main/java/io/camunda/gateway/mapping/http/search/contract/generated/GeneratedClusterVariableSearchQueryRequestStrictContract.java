...
public record GeneratedClusterVariableSearchQueryRequestStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep sort(
        final java.util.@Nullable List<GeneratedClusterVariableSearchQuerySortRequestStrictContract>
            sort) {
      this.sort = sort;
      return this;
    }
    ...
    public OptionalStep filter(
        final @Nullable GeneratedClusterVariableSearchQueryFilterRequestStrictContract filter) {
      this.filter = filter;
      return this;
    }

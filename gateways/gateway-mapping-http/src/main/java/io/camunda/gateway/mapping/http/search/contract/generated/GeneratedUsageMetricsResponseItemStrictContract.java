...
public record GeneratedUsageMetricsResponseItemStrictContract(
  ...
  public static final class Builder implements ProcessInstancesStep, DecisionInstancesStep, AssigneesStep, OptionalStep {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PROCESS_INSTANCES = ContractPolicy.field("UsageMetricsResponseItem", "processInstances");
    public static final ContractPolicy.FieldRef DECISION_INSTANCES = ContractPolicy.field("UsageMetricsResponseItem", "decisionInstances");
    public static final ContractPolicy.FieldRef ASSIGNEES = ContractPolicy.field("UsageMetricsResponseItem", "assignees");

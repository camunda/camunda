 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/mapping-rules.yaml#/components/schemas/MappingRuleCreateResult
 */
...
public record GeneratedMappingRuleCreateStrictContract(
  ...
  public GeneratedMappingRuleCreateStrictContract {
  ...
  public static final class Builder
    ...
    @Override
    public GeneratedMappingRuleCreateStrictContract build() {
  ...
  public interface OptionalStep {
    GeneratedMappingRuleCreateStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef CLAIM_NAME =
        ContractPolicy.field("MappingRuleCreateResult", "claimName");
    public static final ContractPolicy.FieldRef CLAIM_VALUE =
        ContractPolicy.field("MappingRuleCreateResult", "claimValue");
    public static final ContractPolicy.FieldRef NAME =
        ContractPolicy.field("MappingRuleCreateResult", "name");
    public static final ContractPolicy.FieldRef MAPPING_RULE_ID =
        ContractPolicy.field("MappingRuleCreateResult", "mappingRuleId");

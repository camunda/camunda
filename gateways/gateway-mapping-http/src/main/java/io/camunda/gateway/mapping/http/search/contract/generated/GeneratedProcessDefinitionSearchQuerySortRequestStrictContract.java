...
public record GeneratedProcessDefinitionSearchQuerySortRequestStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("ProcessDefinitionSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("ProcessDefinitionSearchQuerySortRequest", "order");

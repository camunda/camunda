...
public record GeneratedProcessInstanceModificationMoveInstructionStrictContract(
    @JsonProperty("sourceElementInstruction") Object sourceElementInstruction,
    @JsonProperty("targetElementId") String targetElementId,
    @JsonProperty("ancestorScopeInstruction") @Nullable Object ancestorScopeInstruction,
  ...
  public GeneratedProcessInstanceModificationMoveInstructionStrictContract {
    Objects.requireNonNull(sourceElementInstruction, "No sourceElementInstruction provided.");

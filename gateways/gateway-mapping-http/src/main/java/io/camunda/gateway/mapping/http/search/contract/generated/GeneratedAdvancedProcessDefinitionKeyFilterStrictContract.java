...
public record GeneratedAdvancedProcessDefinitionKeyFilterStrictContract(
    ...
    implements GeneratedProcessDefinitionKeyFilterPropertyStrictContract {

  public GeneratedAdvancedProcessDefinitionKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$notIn");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/keys.yaml#/components/schemas/AdvancedProcessDefinitionKeyFilter
 */
...
public record GeneratedAdvancedProcessDefinitionKeyFilterStrictContract(
    @Nullable String eq,
    @Nullable String neq,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public GeneratedAdvancedProcessDefinitionKeyFilterStrictContract build() {
      return new GeneratedAdvancedProcessDefinitionKeyFilterStrictContract(
          coerceEq(this.eq),
          coerceNeq(this.neq),
          this.exists,
          this.in,
  ...
  OptionalStep notIn(final java.util.@Nullable List<String> notIn, final ContractPolicy.FieldPolicy<java.util.List<String>> policy);
    ...
    GeneratedAdvancedProcessDefinitionKeyFilterStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$in");
    public static final ContractPolicy.FieldRef NOT_IN = ContractPolicy.field("AdvancedProcessDefinitionKeyFilter", "$notIn");

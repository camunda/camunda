 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/documents.yaml#/components/schemas/DocumentMetadata
 */
...
public record GeneratedDocumentMetadataStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep contentType(final @Nullable String contentType, final ContractPolicy.FieldPolicy<String> policy) {
    ...
    @Override
    public OptionalStep fileName(final @Nullable String fileName, final ContractPolicy.FieldPolicy<String> policy) {
    ...
    @Override
    public OptionalStep size(final @Nullable Long size, final ContractPolicy.FieldPolicy<Long> policy) {
    ...
    @Override
    public OptionalStep customProperties(final java.util.@Nullable Map<String, Object> customProperties) {
      this.customProperties = customProperties;
      return this;
    }

    @Override
    public OptionalStep customProperties(final java.util.@Nullable Map<String, Object> customProperties, final ContractPolicy.FieldPolicy<java.util.Map<String, Object>> policy) {
  ...
  OptionalStep contentType(final @Nullable String contentType, final ContractPolicy.FieldPolicy<String> policy);


  OptionalStep fileName(final @Nullable String fileName);

  OptionalStep fileName(final @Nullable String fileName, final ContractPolicy.FieldPolicy<String> policy);
  ...
  OptionalStep customProperties(final java.util.@Nullable Map<String, Object> customProperties, final ContractPolicy.FieldPolicy<java.util.Map<String, Object>> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef CONTENT_TYPE = ContractPolicy.field("DocumentMetadata", "contentType");
    public static final ContractPolicy.FieldRef FILE_NAME = ContractPolicy.field("DocumentMetadata", "fileName");
    public static final ContractPolicy.FieldRef EXPIRES_AT = ContractPolicy.field("DocumentMetadata", "expiresAt");
    public static final ContractPolicy.FieldRef SIZE = ContractPolicy.field("DocumentMetadata", "size");
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_ID = ContractPolicy.field("DocumentMetadata", "processDefinitionId");
    public static final ContractPolicy.FieldRef PROCESS_INSTANCE_KEY = ContractPolicy.field("DocumentMetadata", "processInstanceKey");
    public static final ContractPolicy.FieldRef CUSTOM_PROPERTIES = ContractPolicy.field("DocumentMetadata", "customProperties");

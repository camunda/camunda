 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-instances.yaml#/components/schemas/SourceElementInstanceKeyInstruction
 */
...
public record GeneratedSourceElementInstanceKeyInstructionStrictContract(
    String sourceType,
    String sourceElementInstanceKey
) {
  ...
  public GeneratedSourceElementInstanceKeyInstructionStrictContract {
    ...
    Objects.requireNonNull(sourceElementInstanceKey, "sourceElementInstanceKey is required and must not be null");
  }
  ...
  public static String coerceSourceElementInstanceKey(final Object value) {
    ...
    throw new IllegalArgumentException(
        "sourceElementInstanceKey must be a String or Number, but was " + value.getClass().getName());
  }
  ...
  public static final class Builder implements SourceTypeStep, SourceElementInstanceKeyStep, OptionalStep {
    ...
    public GeneratedSourceElementInstanceKeyInstructionStrictContract build() {
      return new GeneratedSourceElementInstanceKeyInstructionStrictContract(
          this.sourceType,
          coerceSourceElementInstanceKey(this.sourceElementInstanceKey));
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef SOURCE_TYPE = ContractPolicy.field("SourceElementInstanceKeyInstruction", "sourceType");
    public static final ContractPolicy.FieldRef SOURCE_ELEMENT_INSTANCE_KEY = ContractPolicy.field("SourceElementInstanceKeyInstruction", "sourceElementInstanceKey");

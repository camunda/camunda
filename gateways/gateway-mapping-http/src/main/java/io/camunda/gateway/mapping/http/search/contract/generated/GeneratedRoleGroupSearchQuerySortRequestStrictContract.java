...
public record GeneratedRoleGroupSearchQuerySortRequestStrictContract(
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    public GeneratedRoleGroupSearchQuerySortRequestStrictContract build() {
      return new GeneratedRoleGroupSearchQuerySortRequestStrictContract(this.field, this.order);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD =
        ContractPolicy.field("RoleGroupSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER =
        ContractPolicy.field("RoleGroupSearchQuerySortRequest", "order");

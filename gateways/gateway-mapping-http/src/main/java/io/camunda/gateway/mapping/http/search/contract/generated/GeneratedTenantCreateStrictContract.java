 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/tenants.yaml#/components/schemas/TenantCreateResult
 */
...
public record GeneratedTenantCreateStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef TENANT_ID = ContractPolicy.field("TenantCreateResult", "tenantId");
    public static final ContractPolicy.FieldRef NAME = ContractPolicy.field("TenantCreateResult", "name");
    public static final ContractPolicy.FieldRef DESCRIPTION = ContractPolicy.field("TenantCreateResult", "description");

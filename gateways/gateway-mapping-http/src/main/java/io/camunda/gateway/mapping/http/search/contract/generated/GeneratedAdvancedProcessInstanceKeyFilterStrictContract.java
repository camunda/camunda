...
public record GeneratedAdvancedProcessInstanceKeyFilterStrictContract(
    ...
    implements GeneratedProcessInstanceKeyFilterPropertyStrictContract {

  public GeneratedAdvancedProcessInstanceKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedProcessInstanceKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedProcessInstanceKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedProcessInstanceKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedProcessInstanceKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedProcessInstanceKeyFilter", "$notIn");

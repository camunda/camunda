...
public record GeneratedGroupClientSearchStrictContract(
    ...
    @JsonProperty("items") java.util.List<GeneratedGroupClientStrictContract> items) {
  ...
  public static java.util.List<GeneratedGroupClientStrictContract> coerceItems(final Object value) {
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedGroupClientStrictContract, but was "
              + value.getClass().getName());
    }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("GroupClientSearchResult", "page");
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("GroupClientSearchResult", "items");

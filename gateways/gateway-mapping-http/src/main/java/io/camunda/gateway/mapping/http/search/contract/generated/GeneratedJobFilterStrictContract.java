 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/jobs.yaml#/components/schemas/JobFilter
 */
...
public record GeneratedJobFilterStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep deadline(final @Nullable Object deadline, final ContractPolicy.FieldPolicy<Object> policy) {
    ...
    @Override
    public OptionalStep deniedReason(final @Nullable Object deniedReason, final ContractPolicy.FieldPolicy<Object> policy) {
    ...
    @Override
    public OptionalStep endTime(final @Nullable Object endTime, final ContractPolicy.FieldPolicy<Object> policy) {
    ...
    @Override
    public OptionalStep hasFailedWithRetriesLeft(final @Nullable Boolean hasFailedWithRetriesLeft, final ContractPolicy.FieldPolicy<Boolean> policy) {
      this.hasFailedWithRetriesLeft = policy.apply(hasFailedWithRetriesLeft, Fields.HAS_FAILED_WITH_RETRIES_LEFT, null);
      return this;
    }
    ...
    @Override
    public OptionalStep kind(final @Nullable Object kind, final ContractPolicy.FieldPolicy<Object> policy) {
    ...
    @Override
    public OptionalStep listenerEventType(final @Nullable Object listenerEventType, final ContractPolicy.FieldPolicy<Object> policy) {
    ...
    @Override
    public OptionalStep worker(final @Nullable Object worker, final ContractPolicy.FieldPolicy<Object> policy) {
    ...
    @Override
    public OptionalStep lastUpdateTime(final @Nullable Object lastUpdateTime, final ContractPolicy.FieldPolicy<Object> policy) {
  ...
  OptionalStep deadline(final @Nullable Object deadline, final ContractPolicy.FieldPolicy<Object> policy);


  OptionalStep deniedReason(final @Nullable Object deniedReason);

  OptionalStep deniedReason(final @Nullable Object deniedReason, final ContractPolicy.FieldPolicy<Object> policy);
  ...
  OptionalStep endTime(final @Nullable Object endTime, final ContractPolicy.FieldPolicy<Object> policy);
  ...
  OptionalStep hasFailedWithRetriesLeft(final @Nullable Boolean hasFailedWithRetriesLeft, final ContractPolicy.FieldPolicy<Boolean> policy);
  ...
  OptionalStep listenerEventType(final @Nullable Object listenerEventType, final ContractPolicy.FieldPolicy<Object> policy);
  ...
  OptionalStep worker(final @Nullable Object worker, final ContractPolicy.FieldPolicy<Object> policy);
  ...
  OptionalStep lastUpdateTime(final @Nullable Object lastUpdateTime, final ContractPolicy.FieldPolicy<Object> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef DEADLINE = ContractPolicy.field("JobFilter", "deadline");
    public static final ContractPolicy.FieldRef DENIED_REASON = ContractPolicy.field("JobFilter", "deniedReason");
    public static final ContractPolicy.FieldRef ELEMENT_ID = ContractPolicy.field("JobFilter", "elementId");
    public static final ContractPolicy.FieldRef ELEMENT_INSTANCE_KEY = ContractPolicy.field("JobFilter", "elementInstanceKey");
    public static final ContractPolicy.FieldRef END_TIME = ContractPolicy.field("JobFilter", "endTime");
    public static final ContractPolicy.FieldRef ERROR_CODE = ContractPolicy.field("JobFilter", "errorCode");
    public static final ContractPolicy.FieldRef ERROR_MESSAGE = ContractPolicy.field("JobFilter", "errorMessage");
    public static final ContractPolicy.FieldRef HAS_FAILED_WITH_RETRIES_LEFT = ContractPolicy.field("JobFilter", "hasFailedWithRetriesLeft");
    public static final ContractPolicy.FieldRef IS_DENIED = ContractPolicy.field("JobFilter", "isDenied");
    public static final ContractPolicy.FieldRef JOB_KEY = ContractPolicy.field("JobFilter", "jobKey");
    public static final ContractPolicy.FieldRef KIND = ContractPolicy.field("JobFilter", "kind");
    public static final ContractPolicy.FieldRef LISTENER_EVENT_TYPE = ContractPolicy.field("JobFilter", "listenerEventType");
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_ID = ContractPolicy.field("JobFilter", "processDefinitionId");
    public static final ContractPolicy.FieldRef PROCESS_DEFINITION_KEY = ContractPolicy.field("JobFilter", "processDefinitionKey");
    public static final ContractPolicy.FieldRef PROCESS_INSTANCE_KEY = ContractPolicy.field("JobFilter", "processInstanceKey");
    public static final ContractPolicy.FieldRef RETRIES = ContractPolicy.field("JobFilter", "retries");
    public static final ContractPolicy.FieldRef STATE = ContractPolicy.field("JobFilter", "state");
    public static final ContractPolicy.FieldRef TENANT_ID = ContractPolicy.field("JobFilter", "tenantId");
    public static final ContractPolicy.FieldRef TYPE = ContractPolicy.field("JobFilter", "type");
    public static final ContractPolicy.FieldRef WORKER = ContractPolicy.field("JobFilter", "worker");
    public static final ContractPolicy.FieldRef CREATION_TIME = ContractPolicy.field("JobFilter", "creationTime");
    public static final ContractPolicy.FieldRef LAST_UPDATE_TIME = ContractPolicy.field("JobFilter", "lastUpdateTime");

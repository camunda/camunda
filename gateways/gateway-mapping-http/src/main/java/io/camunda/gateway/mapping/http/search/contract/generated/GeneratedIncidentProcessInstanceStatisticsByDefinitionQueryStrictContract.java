...
public record GeneratedIncidentProcessInstanceStatisticsByDefinitionQueryStrictContract(
  ...
  public static java.util.List<GeneratedIncidentProcessInstanceStatisticsByDefinitionStrictContract>
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedIncidentProcessInstanceStatisticsByDefinitionStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedIncidentProcessInstanceStatisticsByDefinitionStrictContract>(
            listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
          ...
          instanceof
          GeneratedIncidentProcessInstanceStatisticsByDefinitionStrictContract strictItem) {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("IncidentProcessInstanceStatisticsByDefinitionQueryResult", "items");

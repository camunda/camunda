 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/tenants.yaml#/components/schemas/TenantSearchQueryRequest
 */
...
public record GeneratedTenantSearchQueryRequestStrictContract(
  ...
  public static java.util.List<GeneratedTenantSearchQuerySortRequestStrictContract> coerceSort(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "sort must be a List of GeneratedTenantSearchQuerySortRequestStrictContract, but was " + value.getClass().getName());
    }

    final var result = new ArrayList<GeneratedTenantSearchQuerySortRequestStrictContract>(listValue.size());
  ...
  public static GeneratedTenantFilterStrictContract coerceFilter(final Object value) {
    ...
    throw new IllegalArgumentException(
        "filter must be a GeneratedTenantFilterStrictContract, but was " + value.getClass().getName());
  }
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep sort(final java.util.@Nullable List<GeneratedTenantSearchQuerySortRequestStrictContract> sort) {
      this.sort = sort;
      return this;
    }
    ...
    public Builder sort(final java.util.@Nullable List<GeneratedTenantSearchQuerySortRequestStrictContract> sort, final ContractPolicy.FieldPolicy<java.util.List<GeneratedTenantSearchQuerySortRequestStrictContract>> policy) {
    ...
    public Builder filter(final @Nullable GeneratedTenantFilterStrictContract filter, final ContractPolicy.FieldPolicy<GeneratedTenantFilterStrictContract> policy) {
  ...
  OptionalStep sort(final java.util.@Nullable List<GeneratedTenantSearchQuerySortRequestStrictContract> sort);

  OptionalStep sort(final @Nullable Object sort);

  OptionalStep sort(final java.util.@Nullable List<GeneratedTenantSearchQuerySortRequestStrictContract> sort, final ContractPolicy.FieldPolicy<java.util.List<GeneratedTenantSearchQuerySortRequestStrictContract>> policy);
  ...
  OptionalStep filter(final @Nullable GeneratedTenantFilterStrictContract filter, final ContractPolicy.FieldPolicy<GeneratedTenantFilterStrictContract> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("TenantSearchQueryRequest", "page");
    public static final ContractPolicy.FieldRef SORT = ContractPolicy.field("TenantSearchQueryRequest", "sort");
    public static final ContractPolicy.FieldRef FILTER = ContractPolicy.field("TenantSearchQueryRequest", "filter");

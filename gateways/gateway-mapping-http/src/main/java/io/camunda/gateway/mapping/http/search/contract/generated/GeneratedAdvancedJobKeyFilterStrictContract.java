 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/keys.yaml#/components/schemas/AdvancedJobKeyFilter
 */
...
public record GeneratedAdvancedJobKeyFilterStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedJobKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedJobKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedJobKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedJobKeyFilter", "$in");
    public static final ContractPolicy.FieldRef NOT_IN = ContractPolicy.field("AdvancedJobKeyFilter", "$notIn");

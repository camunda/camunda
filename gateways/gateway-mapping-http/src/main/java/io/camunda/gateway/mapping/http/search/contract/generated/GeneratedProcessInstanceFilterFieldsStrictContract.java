...
public record GeneratedProcessInstanceFilterFieldsStrictContract(
  ...
  public GeneratedProcessInstanceFilterFieldsStrictContract {
    if (tags != null)
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef START_DATE =
        ContractPolicy.field("ProcessInstanceFilterFields", "startDate");
    public static final ContractPolicy.FieldRef END_DATE =
        ContractPolicy.field("ProcessInstanceFilterFields", "endDate");
    public static final ContractPolicy.FieldRef STATE =
        ContractPolicy.field("ProcessInstanceFilterFields", "state");
    public static final ContractPolicy.FieldRef HAS_INCIDENT =
        ContractPolicy.field("ProcessInstanceFilterFields", "hasIncident");
    public static final ContractPolicy.FieldRef TENANT_ID =
        ContractPolicy.field("ProcessInstanceFilterFields", "tenantId");
    public static final ContractPolicy.FieldRef VARIABLES =
        ContractPolicy.field("ProcessInstanceFilterFields", "variables");
    public static final ContractPolicy.FieldRef PROCESS_INSTANCE_KEY =
        ContractPolicy.field("ProcessInstanceFilterFields", "processInstanceKey");
    public static final ContractPolicy.FieldRef PARENT_PROCESS_INSTANCE_KEY =
        ContractPolicy.field("ProcessInstanceFilterFields", "parentProcessInstanceKey");
    public static final ContractPolicy.FieldRef PARENT_ELEMENT_INSTANCE_KEY =
        ContractPolicy.field("ProcessInstanceFilterFields", "parentElementInstanceKey");
    public static final ContractPolicy.FieldRef BATCH_OPERATION_ID =
        ContractPolicy.field("ProcessInstanceFilterFields", "batchOperationId");
    public static final ContractPolicy.FieldRef ERROR_MESSAGE =
        ContractPolicy.field("ProcessInstanceFilterFields", "errorMessage");
    public static final ContractPolicy.FieldRef HAS_RETRIES_LEFT =
        ContractPolicy.field("ProcessInstanceFilterFields", "hasRetriesLeft");
    public static final ContractPolicy.FieldRef ELEMENT_INSTANCE_STATE =
        ContractPolicy.field("ProcessInstanceFilterFields", "elementInstanceState");
    public static final ContractPolicy.FieldRef ELEMENT_ID =
        ContractPolicy.field("ProcessInstanceFilterFields", "elementId");
    public static final ContractPolicy.FieldRef HAS_ELEMENT_INSTANCE_INCIDENT =
        ContractPolicy.field("ProcessInstanceFilterFields", "hasElementInstanceIncident");
    public static final ContractPolicy.FieldRef INCIDENT_ERROR_HASH_CODE =
        ContractPolicy.field("ProcessInstanceFilterFields", "incidentErrorHashCode");
    public static final ContractPolicy.FieldRef TAGS =
        ContractPolicy.field("ProcessInstanceFilterFields", "tags");
    public static final ContractPolicy.FieldRef BUSINESS_ID =
        ContractPolicy.field("ProcessInstanceFilterFields", "businessId");

...
public record GeneratedAdvancedBatchOperationStateFilterStrictContract(
    @Nullable io.camunda.gateway.protocol.model.BatchOperationStateEnum eq,
    @Nullable io.camunda.gateway.protocol.model.BatchOperationStateEnum neq,
    @Nullable Boolean exists,
    @Nullable java.util.List<io.camunda.gateway.protocol.model.BatchOperationStateEnum> in,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final io.camunda.gateway.protocol.model.BatchOperationStateEnum eq) {
      this.eq = eq;
      return this;
    }
    ...
    public OptionalStep eq(
        final io.camunda.gateway.protocol.model.BatchOperationStateEnum eq,
    ...
    @Override
    public OptionalStep neq(final io.camunda.gateway.protocol.model.BatchOperationStateEnum neq) {
      this.neq = neq;
      return this;
    }
    ...
    public OptionalStep neq(
        final io.camunda.gateway.protocol.model.BatchOperationStateEnum neq,
        final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.BatchOperationStateEnum>
            policy) {
    ...
    public OptionalStep in(
        final java.util.List<io.camunda.gateway.protocol.model.BatchOperationStateEnum> in) {
      this.in = in;
      return this;
    }
  ...
  public interface OptionalStep {
    OptionalStep eq(final io.camunda.gateway.protocol.model.BatchOperationStateEnum eq);
    ...
    OptionalStep neq(final io.camunda.gateway.protocol.model.BatchOperationStateEnum neq);

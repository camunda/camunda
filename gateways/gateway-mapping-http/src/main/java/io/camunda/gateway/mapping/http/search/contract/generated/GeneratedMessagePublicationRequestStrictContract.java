...
public record GeneratedMessagePublicationRequestStrictContract(
  ...
  public static final class Builder implements NameStep, OptionalStep {
    ...
    @Override
    public OptionalStep messageId(final String messageId) {
    ...
    public OptionalStep messageId(
        final String messageId, final ContractPolicy.FieldPolicy<String> policy) {
  ...
  public interface OptionalStep {
    ...
    OptionalStep messageId(final String messageId);

    OptionalStep messageId(final String messageId, final ContractPolicy.FieldPolicy<String> policy);

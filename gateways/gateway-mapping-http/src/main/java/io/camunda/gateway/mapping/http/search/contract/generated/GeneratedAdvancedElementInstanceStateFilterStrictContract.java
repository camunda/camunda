...
public record GeneratedAdvancedElementInstanceStateFilterStrictContract(
    @Nullable io.camunda.gateway.protocol.model.ElementInstanceStateEnum eq,
    @Nullable io.camunda.gateway.protocol.model.ElementInstanceStateEnum neq,
    @Nullable Boolean exists,
    @Nullable java.util.List<io.camunda.gateway.protocol.model.ElementInstanceStateEnum> in,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final io.camunda.gateway.protocol.model.ElementInstanceStateEnum eq) {
      this.eq = eq;
      return this;
    }
    ...
    public OptionalStep eq(
        final io.camunda.gateway.protocol.model.ElementInstanceStateEnum eq,
    ...
    @Override
    public OptionalStep neq(final io.camunda.gateway.protocol.model.ElementInstanceStateEnum neq) {
      this.neq = neq;
      return this;
    }
    ...
    public OptionalStep neq(
        final io.camunda.gateway.protocol.model.ElementInstanceStateEnum neq,
        final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.ElementInstanceStateEnum>
            policy) {
    ...
    public OptionalStep in(
        final java.util.List<io.camunda.gateway.protocol.model.ElementInstanceStateEnum> in) {
      this.in = in;
      return this;
    }
  ...
  public interface OptionalStep {
    OptionalStep eq(final io.camunda.gateway.protocol.model.ElementInstanceStateEnum eq);
    ...
    OptionalStep neq(final io.camunda.gateway.protocol.model.ElementInstanceStateEnum neq);

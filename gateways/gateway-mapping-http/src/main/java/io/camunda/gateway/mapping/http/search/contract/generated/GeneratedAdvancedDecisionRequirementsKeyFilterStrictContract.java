...
public record GeneratedAdvancedDecisionRequirementsKeyFilterStrictContract(
    ...
    implements GeneratedDecisionRequirementsKeyFilterPropertyStrictContract {

  public GeneratedAdvancedDecisionRequirementsKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$notIn");

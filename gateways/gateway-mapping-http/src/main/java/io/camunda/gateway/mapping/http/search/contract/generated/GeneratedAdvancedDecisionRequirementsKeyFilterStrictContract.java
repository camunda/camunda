 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/keys.yaml#/components/schemas/AdvancedDecisionRequirementsKeyFilter
 */
...
public record GeneratedAdvancedDecisionRequirementsKeyFilterStrictContract(
    @Nullable String eq,
    @Nullable String neq,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final @Nullable Object eq, final ContractPolicy.FieldPolicy<Object> policy) {
      this.eq = policy.apply(eq, Fields.EQ, null);
      return this;
    }
    ...
    public Builder neq(final @Nullable String neq, final ContractPolicy.FieldPolicy<String> policy) {
      this.neq = policy.apply(neq, Fields.NEQ, null);
      return this;
    }

    @Override
    public OptionalStep neq(final @Nullable Object neq, final ContractPolicy.FieldPolicy<Object> policy) {
      this.neq = policy.apply(neq, Fields.NEQ, null);
      return this;
    }
    ...
    @Override
    public GeneratedAdvancedDecisionRequirementsKeyFilterStrictContract build() {
      return new GeneratedAdvancedDecisionRequirementsKeyFilterStrictContract(
          coerceEq(this.eq),
          coerceNeq(this.neq),
          this.exists,
          this.in,
  ...
  OptionalStep notIn(final java.util.@Nullable List<String> notIn, final ContractPolicy.FieldPolicy<java.util.List<String>> policy);
    ...
    GeneratedAdvancedDecisionRequirementsKeyFilterStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$in");
    public static final ContractPolicy.FieldRef NOT_IN = ContractPolicy.field("AdvancedDecisionRequirementsKeyFilter", "$notIn");

...
public record GeneratedIncidentProcessInstanceStatisticsByErrorQueryStrictContract(
  ...
  public static java.util.List<GeneratedIncidentProcessInstanceStatisticsByErrorStrictContract>
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedIncidentProcessInstanceStatisticsByErrorStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedIncidentProcessInstanceStatisticsByErrorStrictContract>(
            listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
      } else if (item
          instanceof GeneratedIncidentProcessInstanceStatisticsByErrorStrictContract strictItem) {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("IncidentProcessInstanceStatisticsByErrorQueryResult", "items");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/jobs.yaml#/components/schemas/JobChangeset
 */
...
public record GeneratedJobChangesetStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep timeout(final @Nullable Long timeout, final ContractPolicy.FieldPolicy<Long> policy) {
    ...
    public GeneratedJobChangesetStrictContract build() {
      return new GeneratedJobChangesetStrictContract(
          this.retries,
          this.timeout);
    }
  }
  ...
  OptionalStep timeout(final @Nullable Long timeout, final ContractPolicy.FieldPolicy<Long> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef RETRIES = ContractPolicy.field("JobChangeset", "retries");
    public static final ContractPolicy.FieldRef TIMEOUT = ContractPolicy.field("JobChangeset", "timeout");

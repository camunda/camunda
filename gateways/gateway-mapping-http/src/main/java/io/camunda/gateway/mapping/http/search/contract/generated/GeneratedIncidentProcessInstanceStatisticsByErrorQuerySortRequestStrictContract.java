 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/incidents.yaml#/components/schemas/IncidentProcessInstanceStatisticsByErrorQuerySortRequest
 */
...
public record GeneratedIncidentProcessInstanceStatisticsByErrorQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedIncidentProcessInstanceStatisticsByErrorQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedIncidentProcessInstanceStatisticsByErrorQuerySortRequestStrictContract build() {
      return new GeneratedIncidentProcessInstanceStatisticsByErrorQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedIncidentProcessInstanceStatisticsByErrorQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("IncidentProcessInstanceStatisticsByErrorQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("IncidentProcessInstanceStatisticsByErrorQuerySortRequest", "order");

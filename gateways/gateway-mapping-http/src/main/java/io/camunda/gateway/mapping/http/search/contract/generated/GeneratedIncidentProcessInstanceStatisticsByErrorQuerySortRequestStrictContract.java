...
public record GeneratedIncidentProcessInstanceStatisticsByErrorQuerySortRequestStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD =
        ContractPolicy.field("IncidentProcessInstanceStatisticsByErrorQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER =
        ContractPolicy.field("IncidentProcessInstanceStatisticsByErrorQuerySortRequest", "order");

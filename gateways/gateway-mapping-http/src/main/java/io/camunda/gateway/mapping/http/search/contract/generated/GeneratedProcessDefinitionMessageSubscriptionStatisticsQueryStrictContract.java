...
public record GeneratedProcessDefinitionMessageSubscriptionStatisticsQueryStrictContract(
  ...
  public static java.util.List<GeneratedProcessDefinitionMessageSubscriptionStatisticsStrictContract> coerceItems(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedProcessDefinitionMessageSubscriptionStatisticsStrictContract, but was " + value.getClass().getName());
    }

    final var result = new ArrayList<GeneratedProcessDefinitionMessageSubscriptionStatisticsStrictContract>(listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
      } else if (item instanceof GeneratedProcessDefinitionMessageSubscriptionStatisticsStrictContract strictItem) {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("ProcessDefinitionMessageSubscriptionStatisticsQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("ProcessDefinitionMessageSubscriptionStatisticsQueryResult", "items");

...
public record GeneratedAdvancedEntityTypeFilterStrictContract(
    @Nullable io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum eq,
    @Nullable io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum neq,
    @Nullable Boolean exists,
    @Nullable java.util.List<io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum> in,
  ...
  public static final class Builder implements OptionalStep {
    private io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum eq;
    private io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum neq;
    private Boolean exists;
    private java.util.List<io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum> in;
    private String like;

    private Builder() {}

    @Override
    public OptionalStep eq(final io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum eq) {
      this.eq = eq;
      return this;
    }
    ...
    public OptionalStep eq(
        final io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum eq,
    ...
    @Override
    public OptionalStep neq(final io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum neq) {
      this.neq = neq;
      return this;
    }
    ...
    public OptionalStep neq(
        final io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum neq,
        final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum>
            policy) {
    ...
    public OptionalStep in(
        final java.util.List<io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum> in) {
      this.in = in;
      return this;
    }
  ...
  public interface OptionalStep {
    OptionalStep eq(final io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum eq);
    ...
    OptionalStep neq(final io.camunda.gateway.protocol.model.AuditLogEntityTypeEnum neq);

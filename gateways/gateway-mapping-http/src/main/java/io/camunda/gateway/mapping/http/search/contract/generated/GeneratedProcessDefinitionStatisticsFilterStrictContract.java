 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-instances.yaml#/components/schemas/ProcessDefinitionStatisticsFilter
 */
...
public record GeneratedProcessDefinitionStatisticsFilterStrictContract(
    ...
    @JsonProperty("$or")
        java.util.@Nullable List<GeneratedBaseProcessInstanceFilterFieldsStrictContract> $or) {

  public GeneratedProcessDefinitionStatisticsFilterStrictContract {
    if (tags != null)
  ...
  public static java.util.List<GeneratedBaseProcessInstanceFilterFieldsStrictContract> coerce$or(
      final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "$or must be a List of GeneratedBaseProcessInstanceFilterFieldsStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedBaseProcessInstanceFilterFieldsStrictContract>(listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
      } else if (item
          instanceof GeneratedBaseProcessInstanceFilterFieldsStrictContract strictItem) {
        result.add(strictItem);

      } else {
        throw new IllegalArgumentException(
            "$or must contain only GeneratedBaseProcessInstanceFilterFieldsStrictContract items, but got "
                + item.getClass().getName());
      }
    }
    return java.util.List.copyOf(result);
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep $or(
        final java.util.@Nullable List<GeneratedBaseProcessInstanceFilterFieldsStrictContract>
            $or) {
      this.$or = $or;
      return this;
    }
    ...
    public Builder $or(
        final java.util.@Nullable List<GeneratedBaseProcessInstanceFilterFieldsStrictContract> $or,
        final ContractPolicy.FieldPolicy<
                java.util.List<GeneratedBaseProcessInstanceFilterFieldsStrictContract>>
            policy) {
    ...
    @Override
    public GeneratedProcessDefinitionStatisticsFilterStrictContract build() {
      return new GeneratedProcessDefinitionStatisticsFilterStrictContract(
          this.startDate,
          this.endDate,
          this.state,
          this.hasIncident,
  ...
  public interface OptionalStep {
    ...
    GeneratedProcessDefinitionStatisticsFilterStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef START_DATE =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "startDate");
    public static final ContractPolicy.FieldRef END_DATE =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "endDate");
    public static final ContractPolicy.FieldRef STATE =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "state");
    public static final ContractPolicy.FieldRef HAS_INCIDENT =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "hasIncident");
    public static final ContractPolicy.FieldRef TENANT_ID =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "tenantId");
    public static final ContractPolicy.FieldRef VARIABLES =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "variables");
    public static final ContractPolicy.FieldRef PROCESS_INSTANCE_KEY =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "processInstanceKey");
    public static final ContractPolicy.FieldRef PARENT_PROCESS_INSTANCE_KEY =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "parentProcessInstanceKey");
    public static final ContractPolicy.FieldRef PARENT_ELEMENT_INSTANCE_KEY =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "parentElementInstanceKey");
    public static final ContractPolicy.FieldRef BATCH_OPERATION_ID =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "batchOperationId");
    public static final ContractPolicy.FieldRef ERROR_MESSAGE =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "errorMessage");
    public static final ContractPolicy.FieldRef HAS_RETRIES_LEFT =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "hasRetriesLeft");
    public static final ContractPolicy.FieldRef ELEMENT_INSTANCE_STATE =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "elementInstanceState");
    public static final ContractPolicy.FieldRef ELEMENT_ID =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "elementId");
    public static final ContractPolicy.FieldRef HAS_ELEMENT_INSTANCE_INCIDENT =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "hasElementInstanceIncident");
    public static final ContractPolicy.FieldRef INCIDENT_ERROR_HASH_CODE =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "incidentErrorHashCode");
    public static final ContractPolicy.FieldRef TAGS =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "tags");
    public static final ContractPolicy.FieldRef BUSINESS_ID =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "businessId");
    public static final ContractPolicy.FieldRef $OR =
        ContractPolicy.field("ProcessDefinitionStatisticsFilter", "$or");

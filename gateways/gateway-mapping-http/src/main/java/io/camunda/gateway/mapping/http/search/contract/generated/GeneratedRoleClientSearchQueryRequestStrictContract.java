...
public record GeneratedRoleClientSearchQueryRequestStrictContract(
  ...
  public static java.util.List<GeneratedRoleClientSearchQuerySortRequestStrictContract> coerceSort(
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "sort must be a List of GeneratedRoleClientSearchQuerySortRequestStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedRoleClientSearchQuerySortRequestStrictContract>(listValue.size());
    for (final var item : listValue) {
      if (item == null) {
        result.add(null);
      } else if (item
          instanceof GeneratedRoleClientSearchQuerySortRequestStrictContract strictItem) {
  ...
  public static final class Builder implements OptionalStep {
    ...
    public GeneratedRoleClientSearchQueryRequestStrictContract build() {
      return new GeneratedRoleClientSearchQueryRequestStrictContract(coerceSort(this.sort));
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef SORT =
        ContractPolicy.field("RoleClientSearchQueryRequest", "sort");

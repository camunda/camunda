...
public record GeneratedProcessDefinitionInstanceStatisticsQueryResultStrictContract(
  ...
  public GeneratedProcessDefinitionInstanceStatisticsQueryResultStrictContract {
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    @Override
    public GeneratedProcessDefinitionInstanceStatisticsQueryResultStrictContract build() {
  ...
  public interface OptionalStep {
    GeneratedProcessDefinitionInstanceStatisticsQueryResultStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("ProcessDefinitionInstanceStatisticsQueryResult", "page");

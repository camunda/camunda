 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/problem-detail.yaml#/components/schemas/ProblemDetail
 */
...
public record GeneratedProblemDetailStrictContract(
  ...
  public static final class Builder implements TypeStep, TitleStep, StatusStep, DetailStep, InstanceStep, OptionalStep {
    private String type;
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef TYPE = ContractPolicy.field("ProblemDetail", "type");
    public static final ContractPolicy.FieldRef TITLE = ContractPolicy.field("ProblemDetail", "title");
    public static final ContractPolicy.FieldRef STATUS = ContractPolicy.field("ProblemDetail", "status");
    public static final ContractPolicy.FieldRef DETAIL = ContractPolicy.field("ProblemDetail", "detail");
    public static final ContractPolicy.FieldRef INSTANCE = ContractPolicy.field("ProblemDetail", "instance");

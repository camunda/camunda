 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/batch-operations.yaml#/components/schemas/BatchOperationSearchQuerySortRequest
 */
...
public record GeneratedBatchOperationSearchQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedBatchOperationSearchQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedBatchOperationSearchQuerySortRequestStrictContract build() {
      return new GeneratedBatchOperationSearchQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedBatchOperationSearchQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("BatchOperationSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("BatchOperationSearchQuerySortRequest", "order");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/variables.yaml#/components/schemas/VariableSearchQuerySortRequest
 */
...
public record GeneratedVariableSearchQuerySortRequestStrictContract(
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    public GeneratedVariableSearchQuerySortRequestStrictContract build() {
      return new GeneratedVariableSearchQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("VariableSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("VariableSearchQuerySortRequest", "order");

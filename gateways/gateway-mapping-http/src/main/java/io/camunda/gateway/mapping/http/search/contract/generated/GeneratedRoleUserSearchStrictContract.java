 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/roles.yaml#/components/schemas/RoleUserSearchResult
 */
...
public record GeneratedRoleUserSearchStrictContract(
  ...
  public static java.util.List<GeneratedRoleUserStrictContract> coerceItems(final Object value) {
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedRoleUserStrictContract, but was " + value.getClass().getName());
    }
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    public GeneratedRoleUserSearchStrictContract build() {
      return new GeneratedRoleUserSearchStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("RoleUserSearchResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("RoleUserSearchResult", "items");

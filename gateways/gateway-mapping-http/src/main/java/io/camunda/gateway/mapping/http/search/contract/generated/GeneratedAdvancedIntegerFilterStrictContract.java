 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/filters.yaml#/components/schemas/AdvancedIntegerFilter
 */
...
public record GeneratedAdvancedIntegerFilterStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final @Nullable Integer eq, final ContractPolicy.FieldPolicy<Integer> policy) {
    ...
    @Override
    public OptionalStep neq(final @Nullable Integer neq, final ContractPolicy.FieldPolicy<Integer> policy) {
    ...
    @Override
    public OptionalStep gt(final @Nullable Integer gt, final ContractPolicy.FieldPolicy<Integer> policy) {
    ...
    @Override
    public OptionalStep gte(final @Nullable Integer gte, final ContractPolicy.FieldPolicy<Integer> policy) {
    ...
    @Override
    public OptionalStep lt(final @Nullable Integer lt, final ContractPolicy.FieldPolicy<Integer> policy) {
    ...
    @Override
    public OptionalStep lte(final @Nullable Integer lte, final ContractPolicy.FieldPolicy<Integer> policy) {
    ...
    @Override
    public OptionalStep in(final java.util.@Nullable List<Integer> in, final ContractPolicy.FieldPolicy<java.util.List<Integer>> policy) {
  ...
  OptionalStep in(final java.util.@Nullable List<Integer> in, final ContractPolicy.FieldPolicy<java.util.List<Integer>> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedIntegerFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedIntegerFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedIntegerFilter", "$exists");
    public static final ContractPolicy.FieldRef GT = ContractPolicy.field("AdvancedIntegerFilter", "$gt");
    public static final ContractPolicy.FieldRef GTE = ContractPolicy.field("AdvancedIntegerFilter", "$gte");
    public static final ContractPolicy.FieldRef LT = ContractPolicy.field("AdvancedIntegerFilter", "$lt");
    public static final ContractPolicy.FieldRef LTE = ContractPolicy.field("AdvancedIntegerFilter", "$lte");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedIntegerFilter", "$in");

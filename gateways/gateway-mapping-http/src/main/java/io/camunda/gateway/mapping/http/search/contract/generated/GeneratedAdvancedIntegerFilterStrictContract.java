...
public record GeneratedAdvancedIntegerFilterStrictContract(
    @JsonProperty("$eq") @Nullable Integer $eq,
    @JsonProperty("$neq") @Nullable Integer $neq,
    @JsonProperty("$exists") @Nullable Boolean $exists,
    @JsonProperty("$gt") @Nullable Integer $gt,
    @JsonProperty("$gte") @Nullable Integer $gte,
    @JsonProperty("$lt") @Nullable Integer $lt,
    @JsonProperty("$lte") @Nullable Integer $lte,
    @JsonProperty("$in") java.util.@Nullable List<Integer> $in)
    implements GeneratedIntegerFilterPropertyStrictContract {

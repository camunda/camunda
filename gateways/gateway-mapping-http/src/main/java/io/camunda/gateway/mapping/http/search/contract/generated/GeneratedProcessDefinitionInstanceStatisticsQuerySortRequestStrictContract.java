 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-definitions.yaml#/components/schemas/ProcessDefinitionInstanceStatisticsQuerySortRequest
 */
...
public record GeneratedProcessDefinitionInstanceStatisticsQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedProcessDefinitionInstanceStatisticsQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedProcessDefinitionInstanceStatisticsQuerySortRequestStrictContract build() {
      return new GeneratedProcessDefinitionInstanceStatisticsQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedProcessDefinitionInstanceStatisticsQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("ProcessDefinitionInstanceStatisticsQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("ProcessDefinitionInstanceStatisticsQuerySortRequest", "order");

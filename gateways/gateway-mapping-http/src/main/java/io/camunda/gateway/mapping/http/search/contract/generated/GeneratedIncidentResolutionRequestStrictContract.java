 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/incidents.yaml#/components/schemas/IncidentResolutionRequest
 */
...
public record GeneratedIncidentResolutionRequestStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    public GeneratedIncidentResolutionRequestStrictContract build() {
      return new GeneratedIncidentResolutionRequestStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef OPERATION_REFERENCE = ContractPolicy.field("IncidentResolutionRequest", "operationReference");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/incidents.yaml#/components/schemas/IncidentErrorTypeEnum
 */
...
public enum GeneratedIncidentErrorTypeEnum {
  ...
  GeneratedIncidentErrorTypeEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static GeneratedIncidentErrorTypeEnum fromValue(String value) {
    for (GeneratedIncidentErrorTypeEnum b : GeneratedIncidentErrorTypeEnum.values()) {

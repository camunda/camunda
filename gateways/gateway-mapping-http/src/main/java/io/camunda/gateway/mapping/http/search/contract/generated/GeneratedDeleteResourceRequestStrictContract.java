...
public record GeneratedDeleteResourceRequestStrictContract(
    ...
    @Nullable Boolean deleteHistory
) {
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep deleteHistory(final @Nullable Boolean deleteHistory, final ContractPolicy.FieldPolicy<Boolean> policy) {
  ...
  OptionalStep deleteHistory(final @Nullable Boolean deleteHistory, final ContractPolicy.FieldPolicy<Boolean> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef OPERATION_REFERENCE = ContractPolicy.field("DeleteResourceRequest", "operationReference");
    public static final ContractPolicy.FieldRef DELETE_HISTORY = ContractPolicy.field("DeleteResourceRequest", "deleteHistory");

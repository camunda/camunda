...
public record GeneratedAdvancedJobStateFilterStrictContract(
    @Nullable io.camunda.gateway.protocol.model.JobStateEnum eq,
    @Nullable io.camunda.gateway.protocol.model.JobStateEnum neq,
    @Nullable Boolean exists,
    @Nullable java.util.List<io.camunda.gateway.protocol.model.JobStateEnum> in,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final io.camunda.gateway.protocol.model.JobStateEnum eq) {
      this.eq = eq;
      return this;
    }
    ...
    public OptionalStep eq(
        final io.camunda.gateway.protocol.model.JobStateEnum eq,
    ...
    @Override
    public OptionalStep neq(final io.camunda.gateway.protocol.model.JobStateEnum neq) {
      this.neq = neq;
      return this;
    }
    ...
    public OptionalStep neq(
        final io.camunda.gateway.protocol.model.JobStateEnum neq,
        final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.JobStateEnum> policy) {
    ...
    public OptionalStep in(
        final java.util.List<io.camunda.gateway.protocol.model.JobStateEnum> in) {
      this.in = in;
      return this;
    }
  ...
  public interface OptionalStep {
    OptionalStep eq(final io.camunda.gateway.protocol.model.JobStateEnum eq);

    OptionalStep eq(
        final io.camunda.gateway.protocol.model.JobStateEnum eq,
        final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.JobStateEnum> policy);

    OptionalStep neq(final io.camunda.gateway.protocol.model.JobStateEnum neq);
    ...
    OptionalStep in(final java.util.List<io.camunda.gateway.protocol.model.JobStateEnum> in);

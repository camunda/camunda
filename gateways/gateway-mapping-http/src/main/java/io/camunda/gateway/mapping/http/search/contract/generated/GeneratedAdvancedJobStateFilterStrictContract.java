...
public record GeneratedAdvancedJobStateFilterStrictContract(
    @JsonProperty("$eq")
        io.camunda.gateway.mapping.http.search.contract.generated.@Nullable GeneratedJobStateEnum
            $eq,
    @JsonProperty("$neq")
        io.camunda.gateway.mapping.http.search.contract.generated.@Nullable GeneratedJobStateEnum
            $neq,
    ...
    @JsonProperty("$in")
        java.util.@Nullable List<
                io.camunda.gateway.mapping.http.search.contract.generated.GeneratedJobStateEnum>
            $in,
    @JsonProperty("$like") @Nullable String $like)
    implements GeneratedJobStateFilterPropertyStrictContract {
  ...
  public static final class Builder implements OptionalStep {
    private io.camunda.gateway.mapping.http.search.contract.generated.GeneratedJobStateEnum $eq;
    private io.camunda.gateway.mapping.http.search.contract.generated.GeneratedJobStateEnum $neq;

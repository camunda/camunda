...
public record GeneratedAdvancedBatchOperationTypeFilterStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep eq(
        final io.camunda.gateway.protocol.model.@Nullable BatchOperationTypeEnum eq) {
      this.eq = eq;
      return this;
    }
    ...
    public OptionalStep neq(
        final io.camunda.gateway.protocol.model.@Nullable BatchOperationTypeEnum neq) {
      this.neq = neq;
      return this;
    }
    ...
    public OptionalStep in(
        final java.util.@Nullable List<io.camunda.gateway.protocol.model.BatchOperationTypeEnum>
            in) {
      this.in = in;
      return this;
    }
    ...
    @Override
    public OptionalStep in(
        final java.util.@Nullable List<io.camunda.gateway.protocol.model.BatchOperationTypeEnum> in,

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/element-instances.yaml#/components/schemas/ElementInstanceSearchQueryResult
 */
...
public record GeneratedElementInstanceSearchQueryStrictContract(
  ...
  public static java.util.List<GeneratedElementInstanceStrictContract> coerceItems(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedElementInstanceStrictContract, but was " + value.getClass().getName());
    }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("ElementInstanceSearchQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("ElementInstanceSearchQueryResult", "items");

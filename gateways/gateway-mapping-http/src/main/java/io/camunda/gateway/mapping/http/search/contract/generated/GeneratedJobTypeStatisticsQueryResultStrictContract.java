...
public record GeneratedJobTypeStatisticsQueryResultStrictContract(
    @JsonProperty("page") GeneratedSearchQueryPageResponseStrictContract page,
    @JsonProperty("items") java.util.List<GeneratedJobTypeStatisticsItemStrictContract> items) {

  public GeneratedJobTypeStatisticsQueryResultStrictContract {
  ...
  public static java.util.List<GeneratedJobTypeStatisticsItemStrictContract> coerceItems(
      final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedJobTypeStatisticsItemStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedJobTypeStatisticsItemStrictContract>(listValue.size());
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    @Override
    public GeneratedJobTypeStatisticsQueryResultStrictContract build() {
  ...
  public interface OptionalStep {
    GeneratedJobTypeStatisticsQueryResultStrictContract build();
  }

  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("JobTypeStatisticsQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("JobTypeStatisticsQueryResult", "items");

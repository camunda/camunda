 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/keys.yaml#/components/schemas/AdvancedScopeKeyFilter
 */
...
public record GeneratedAdvancedScopeKeyFilterStrictContract(
    @Nullable String eq,
    @Nullable String neq,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public GeneratedAdvancedScopeKeyFilterStrictContract build() {
      return new GeneratedAdvancedScopeKeyFilterStrictContract(
          coerceEq(this.eq),
          coerceNeq(this.neq),
          this.exists,
          this.in,
  ...
  OptionalStep notIn(final java.util.@Nullable List<String> notIn, final ContractPolicy.FieldPolicy<java.util.List<String>> policy);
    ...
    GeneratedAdvancedScopeKeyFilterStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedScopeKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedScopeKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedScopeKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedScopeKeyFilter", "$in");
    public static final ContractPolicy.FieldRef NOT_IN = ContractPolicy.field("AdvancedScopeKeyFilter", "$notIn");

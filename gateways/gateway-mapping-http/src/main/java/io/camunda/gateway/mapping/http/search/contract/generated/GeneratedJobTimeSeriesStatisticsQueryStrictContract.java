...
public record GeneratedJobTimeSeriesStatisticsQueryStrictContract(
  ...
  public static java.util.List<GeneratedJobTimeSeriesStatisticsItemStrictContract> coerceItems(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedJobTimeSeriesStatisticsItemStrictContract, but was " + value.getClass().getName());
    }

    final var result = new ArrayList<GeneratedJobTimeSeriesStatisticsItemStrictContract>(listValue.size());
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("JobTimeSeriesStatisticsQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("JobTimeSeriesStatisticsQueryResult", "items");

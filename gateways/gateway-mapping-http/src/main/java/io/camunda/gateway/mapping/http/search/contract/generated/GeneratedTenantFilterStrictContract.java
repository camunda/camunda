 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/tenants.yaml#/components/schemas/TenantFilter
 */
...
public record GeneratedTenantFilterStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    public GeneratedTenantFilterStrictContract build() {
      return new GeneratedTenantFilterStrictContract(
          this.tenantId,
          this.name);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef TENANT_ID = ContractPolicy.field("TenantFilter", "tenantId");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/authorizations.yaml#/components/schemas/AuthorizationSearchResult
 */
...
public record GeneratedAuthorizationSearchStrictContract(
  ...
  public static java.util.List<GeneratedAuthorizationStrictContract> coerceItems(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedAuthorizationStrictContract, but was " + value.getClass().getName());
    }
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    public GeneratedAuthorizationSearchStrictContract build() {
      return new GeneratedAuthorizationSearchStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("AuthorizationSearchResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("AuthorizationSearchResult", "items");

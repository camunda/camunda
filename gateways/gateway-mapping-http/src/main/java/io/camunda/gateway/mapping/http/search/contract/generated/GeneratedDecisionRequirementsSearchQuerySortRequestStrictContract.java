 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/decision-requirements.yaml#/components/schemas/DecisionRequirementsSearchQuerySortRequest
 */
...
public record GeneratedDecisionRequirementsSearchQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedDecisionRequirementsSearchQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedDecisionRequirementsSearchQuerySortRequestStrictContract build() {
      return new GeneratedDecisionRequirementsSearchQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedDecisionRequirementsSearchQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("DecisionRequirementsSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("DecisionRequirementsSearchQuerySortRequest", "order");

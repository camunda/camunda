...
public record GeneratedRoleUserSearchQueryRequestStrictContract(
    @Nullable java.util.List<GeneratedRoleUserSearchQuerySortRequestStrictContract> sort) {
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep sort(
        final java.util.List<GeneratedRoleUserSearchQuerySortRequestStrictContract> sort) {
      this.sort = sort;
      return this;
    }

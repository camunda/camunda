...
public record GeneratedRoleUserSearchQueryRequestStrictContract(
  ...
  public static java.util.List<GeneratedRoleUserSearchQuerySortRequestStrictContract> coerceSort(
      final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "sort must be a List of GeneratedRoleUserSearchQuerySortRequestStrictContract, but was "
              + value.getClass().getName());
    }

    final var result =
        new ArrayList<GeneratedRoleUserSearchQuerySortRequestStrictContract>(listValue.size());
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep sort(
        final java.util.@Nullable List<GeneratedRoleUserSearchQuerySortRequestStrictContract>
            sort) {
      this.sort = sort;
      return this;
    }
    ...
    public Builder sort(
        final java.util.@Nullable List<GeneratedRoleUserSearchQuerySortRequestStrictContract> sort,
        final ContractPolicy.FieldPolicy<
                java.util.List<GeneratedRoleUserSearchQuerySortRequestStrictContract>>
            policy) {
    ...
    public GeneratedRoleUserSearchQueryRequestStrictContract build() {
      return new GeneratedRoleUserSearchQueryRequestStrictContract(coerceSort(this.sort));
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef SORT =
        ContractPolicy.field("RoleUserSearchQueryRequest", "sort");

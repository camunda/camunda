...
public record GeneratedTenantSearchQueryStrictContract(
    ...
    @JsonProperty("items") java.util.List<GeneratedTenantStrictContract> items) {
  ...
  public static java.util.List<GeneratedTenantStrictContract> coerceItems(final Object value) {
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedTenantStrictContract, but was "
              + value.getClass().getName());
    }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("TenantSearchQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("TenantSearchQueryResult", "items");

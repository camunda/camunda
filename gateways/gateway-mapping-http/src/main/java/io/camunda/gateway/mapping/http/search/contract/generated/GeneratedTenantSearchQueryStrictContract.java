 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/tenants.yaml#/components/schemas/TenantSearchQueryResult
 */
...
public record GeneratedTenantSearchQueryStrictContract(
    GeneratedSearchQueryPageResponseStrictContract page,
    java.util.List<GeneratedTenantStrictContract> items
) {

  public GeneratedTenantSearchQueryStrictContract {
  ...
  public static java.util.List<GeneratedTenantStrictContract> coerceItems(final Object value) {
    if (value == null) {
      return null;
    }
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedTenantStrictContract, but was " + value.getClass().getName());
    }
    ...
    for (final var item : listValue) {
      if (item == null) {
        ...
        throw new IllegalArgumentException(
            "items must contain only GeneratedTenantStrictContract items, but got "
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    @Override
    public GeneratedTenantSearchQueryStrictContract build() {
      return new GeneratedTenantSearchQueryStrictContract(
  ...
  public interface OptionalStep {
    GeneratedTenantSearchQueryStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("TenantSearchQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("TenantSearchQueryResult", "items");

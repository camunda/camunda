...
public record GeneratedUserTaskAuditLogSearchQueryRequestStrictContract(
  ...
  public static GeneratedUserTaskAuditLogFilterStrictContract coerceFilter(final Object value) {
    ...
    throw new IllegalArgumentException(
        "filter must be a GeneratedUserTaskAuditLogFilterStrictContract, but was "
            + value.getClass().getName());
  }
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep filter(final GeneratedUserTaskAuditLogFilterStrictContract filter) {
      this.filter = filter;
      return this;
    }
    ...
    public Builder filter(
        ...
        final ContractPolicy.FieldPolicy<GeneratedUserTaskAuditLogFilterStrictContract> policy) {
  ...
  public interface OptionalStep {
    ...
    OptionalStep filter(final GeneratedUserTaskAuditLogFilterStrictContract filter);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef SORT =
        ContractPolicy.field("UserTaskAuditLogSearchQueryRequest", "sort");
    public static final ContractPolicy.FieldRef FILTER =
        ContractPolicy.field("UserTaskAuditLogSearchQueryRequest", "filter");

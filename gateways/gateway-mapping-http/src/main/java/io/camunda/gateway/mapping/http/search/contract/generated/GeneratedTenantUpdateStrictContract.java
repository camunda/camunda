 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/tenants.yaml#/components/schemas/TenantUpdateResult
 */
...
public record GeneratedTenantUpdateStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef TENANT_ID = ContractPolicy.field("TenantUpdateResult", "tenantId");
    public static final ContractPolicy.FieldRef NAME = ContractPolicy.field("TenantUpdateResult", "name");
    public static final ContractPolicy.FieldRef DESCRIPTION = ContractPolicy.field("TenantUpdateResult", "description");

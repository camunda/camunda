...
public record GeneratedGroupClientSearchQueryRequestStrictContract(
    @Nullable java.util.List<GeneratedGroupClientSearchQuerySortRequestStrictContract> sort) {
  ...
  public static final class Builder implements OptionalStep {
    ...
    public OptionalStep sort(
        final java.util.List<GeneratedGroupClientSearchQuerySortRequestStrictContract> sort) {
      this.sort = sort;
      return this;
    }

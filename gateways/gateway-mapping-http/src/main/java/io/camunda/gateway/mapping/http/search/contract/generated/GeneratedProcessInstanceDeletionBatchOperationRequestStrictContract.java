...
public record GeneratedProcessInstanceDeletionBatchOperationRequestStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FILTER =
        ContractPolicy.field("ProcessInstanceDeletionBatchOperationRequest", "filter");
    public static final ContractPolicy.FieldRef OPERATION_REFERENCE =
        ContractPolicy.field("ProcessInstanceDeletionBatchOperationRequest", "operationReference");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/batch-operations.yaml#/components/schemas/ProcessInstanceDeletionBatchOperationRequest
 */
...
public record GeneratedProcessInstanceDeletionBatchOperationRequestStrictContract(
    GeneratedProcessInstanceFilterFieldsStrictContract filter,
    @Nullable Long operationReference
) {

  public GeneratedProcessInstanceDeletionBatchOperationRequestStrictContract {
  ...
  public static final class Builder implements FilterStep, OptionalStep {
    ...
    @Override
    public GeneratedProcessInstanceDeletionBatchOperationRequestStrictContract build() {
      return new GeneratedProcessInstanceDeletionBatchOperationRequestStrictContract(
  ...
  OptionalStep operationReference(final @Nullable Long operationReference, final ContractPolicy.FieldPolicy<Long> policy);
    ...
    GeneratedProcessInstanceDeletionBatchOperationRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FILTER = ContractPolicy.field("ProcessInstanceDeletionBatchOperationRequest", "filter");
    public static final ContractPolicy.FieldRef OPERATION_REFERENCE = ContractPolicy.field("ProcessInstanceDeletionBatchOperationRequest", "operationReference");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-definitions.yaml#/components/schemas/ProcessDefinitionInstanceVersionStatisticsQuerySortRequest
 */
...
public record GeneratedProcessDefinitionInstanceVersionStatisticsQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedProcessDefinitionInstanceVersionStatisticsQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedProcessDefinitionInstanceVersionStatisticsQuerySortRequestStrictContract build() {
      return new GeneratedProcessDefinitionInstanceVersionStatisticsQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedProcessDefinitionInstanceVersionStatisticsQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsQuerySortRequest", "order");

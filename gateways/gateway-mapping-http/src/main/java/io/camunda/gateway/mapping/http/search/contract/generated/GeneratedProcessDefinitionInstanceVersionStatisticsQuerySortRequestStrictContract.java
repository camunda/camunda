...
public record GeneratedProcessDefinitionInstanceVersionStatisticsQuerySortRequestStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD =
        ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER =
        ContractPolicy.field("ProcessDefinitionInstanceVersionStatisticsQuerySortRequest", "order");

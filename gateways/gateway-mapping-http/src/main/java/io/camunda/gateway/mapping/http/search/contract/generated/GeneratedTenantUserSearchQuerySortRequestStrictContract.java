...
public record GeneratedTenantUserSearchQuerySortRequestStrictContract(
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    public GeneratedTenantUserSearchQuerySortRequestStrictContract build() {
      return new GeneratedTenantUserSearchQuerySortRequestStrictContract(this.field, this.order);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD =
        ContractPolicy.field("TenantUserSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER =
        ContractPolicy.field("TenantUserSearchQuerySortRequest", "order");

...
public record GeneratedMappingRuleFilterStrictContract(
    @JsonProperty("claimName") @Nullable String claimName,
    @JsonProperty("claimValue") @Nullable String claimValue,
    @JsonProperty("name") @Nullable String name,
    @JsonProperty("mappingRuleId") @Nullable String mappingRuleId) {

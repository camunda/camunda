 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/tenants.yaml#/components/schemas/TenantSearchQuerySortRequest
 */
...
public record GeneratedTenantSearchQuerySortRequestStrictContract(
    String field,
    io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order
) {

  public GeneratedTenantSearchQuerySortRequestStrictContract {
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    @Override
    public GeneratedTenantSearchQuerySortRequestStrictContract build() {
      return new GeneratedTenantSearchQuerySortRequestStrictContract(
          this.field,
          this.order);
    }
  }
  ...
  OptionalStep order(final io.camunda.gateway.protocol.model.@Nullable SortOrderEnum order, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.SortOrderEnum> policy);
    ...
    GeneratedTenantSearchQuerySortRequestStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD = ContractPolicy.field("TenantSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER = ContractPolicy.field("TenantSearchQuerySortRequest", "order");

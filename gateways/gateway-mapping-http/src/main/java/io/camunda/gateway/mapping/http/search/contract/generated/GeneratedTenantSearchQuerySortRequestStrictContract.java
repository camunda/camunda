...
public record GeneratedTenantSearchQuerySortRequestStrictContract(
  ...
  public static final class Builder implements FieldStep, OptionalStep {
    ...
    public GeneratedTenantSearchQuerySortRequestStrictContract build() {
      return new GeneratedTenantSearchQuerySortRequestStrictContract(this.field, this.order);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef FIELD =
        ContractPolicy.field("TenantSearchQuerySortRequest", "field");
    public static final ContractPolicy.FieldRef ORDER =
        ContractPolicy.field("TenantSearchQuerySortRequest", "order");

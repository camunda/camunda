 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/jobs.yaml#/components/schemas/JobActivationRequest
 */
...
public record GeneratedJobActivationRequestStrictContract(
  ...
  public static final class Builder implements TypeStep, TimeoutStep, MaxJobsToActivateStep, OptionalStep {
    private String type;
    ...
    @Override
    public OptionalStep worker(final @Nullable String worker, final ContractPolicy.FieldPolicy<String> policy) {
    ...
    @Override
    public OptionalStep fetchVariable(final java.util.@Nullable List<String> fetchVariable, final ContractPolicy.FieldPolicy<java.util.List<String>> policy) {
    ...
    @Override
    public OptionalStep tenantIds(final java.util.@Nullable List<String> tenantIds, final ContractPolicy.FieldPolicy<java.util.List<String>> policy) {
    ...
    @Override
    public OptionalStep tenantFilter(final io.camunda.gateway.protocol.model.@Nullable TenantFilterEnum tenantFilter) {
      this.tenantFilter = tenantFilter;
      return this;
    }

    @Override
    public OptionalStep tenantFilter(final io.camunda.gateway.protocol.model.@Nullable TenantFilterEnum tenantFilter, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.TenantFilterEnum> policy) {
  ...
  OptionalStep worker(final @Nullable String worker, final ContractPolicy.FieldPolicy<String> policy);


  OptionalStep fetchVariable(final java.util.@Nullable List<String> fetchVariable);

  OptionalStep fetchVariable(final java.util.@Nullable List<String> fetchVariable, final ContractPolicy.FieldPolicy<java.util.List<String>> policy);
  ...
  OptionalStep tenantIds(final java.util.@Nullable List<String> tenantIds, final ContractPolicy.FieldPolicy<java.util.List<String>> policy);


  OptionalStep tenantFilter(final io.camunda.gateway.protocol.model.@Nullable TenantFilterEnum tenantFilter);

  OptionalStep tenantFilter(final io.camunda.gateway.protocol.model.@Nullable TenantFilterEnum tenantFilter, final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.TenantFilterEnum> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef TYPE = ContractPolicy.field("JobActivationRequest", "type");
    public static final ContractPolicy.FieldRef WORKER = ContractPolicy.field("JobActivationRequest", "worker");
    public static final ContractPolicy.FieldRef TIMEOUT = ContractPolicy.field("JobActivationRequest", "timeout");
    public static final ContractPolicy.FieldRef MAX_JOBS_TO_ACTIVATE = ContractPolicy.field("JobActivationRequest", "maxJobsToActivate");
    public static final ContractPolicy.FieldRef FETCH_VARIABLE = ContractPolicy.field("JobActivationRequest", "fetchVariable");
    public static final ContractPolicy.FieldRef REQUEST_TIMEOUT = ContractPolicy.field("JobActivationRequest", "requestTimeout");
    public static final ContractPolicy.FieldRef TENANT_IDS = ContractPolicy.field("JobActivationRequest", "tenantIds");
    public static final ContractPolicy.FieldRef TENANT_FILTER = ContractPolicy.field("JobActivationRequest", "tenantFilter");

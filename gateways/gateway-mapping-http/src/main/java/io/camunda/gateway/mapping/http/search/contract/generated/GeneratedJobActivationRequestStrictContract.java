...
public record GeneratedJobActivationRequestStrictContract(
    ...
    @JsonProperty("worker") @Nullable String worker,
    @JsonProperty("timeout") Long timeout,
    @JsonProperty("maxJobsToActivate") Integer maxJobsToActivate,
    @JsonProperty("fetchVariable") java.util.@Nullable List<String> fetchVariable,
    @JsonProperty("requestTimeout") @Nullable Long requestTimeout,
    @JsonProperty("tenantIds") java.util.@Nullable List<String> tenantIds,
    @JsonProperty("tenantFilter")
        io.camunda.gateway.mapping.http.search.contract.generated.@Nullable
            GeneratedTenantFilterEnum
            tenantFilter) {

  public GeneratedJobActivationRequestStrictContract {
    Objects.requireNonNull(type, "No type provided.");
    Objects.requireNonNull(timeout, "No timeout provided.");
    Objects.requireNonNull(maxJobsToActivate, "No maxJobsToActivate provided.");
  }
  ...
  public static final class Builder
    ...
    private io.camunda.gateway.mapping.http.search.contract.generated.GeneratedTenantFilterEnum
        tenantFilter;
    ...
    public OptionalStep tenantFilter(
        ...
        final ContractPolicy.FieldPolicy<
                io.camunda.gateway.mapping.http.search.contract.generated.GeneratedTenantFilterEnum>
            policy) {

...
public record GeneratedJobResultActivateElementStrictContract(
  ...
  public static final class Builder implements OptionalStep {
    ...
    public GeneratedJobResultActivateElementStrictContract build() {
      return new GeneratedJobResultActivateElementStrictContract(
          this.elementId,
          this.variables);
    }
  }
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef ELEMENT_ID = ContractPolicy.field("JobResultActivateElement", "elementId");
    public static final ContractPolicy.FieldRef VARIABLES = ContractPolicy.field("JobResultActivateElement", "variables");

...
public record GeneratedRoleSearchQueryStrictContract(
    ...
    @JsonProperty("items") java.util.List<GeneratedRoleStrictContract> items) {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE =
        ContractPolicy.field("RoleSearchQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS =
        ContractPolicy.field("RoleSearchQueryResult", "items");

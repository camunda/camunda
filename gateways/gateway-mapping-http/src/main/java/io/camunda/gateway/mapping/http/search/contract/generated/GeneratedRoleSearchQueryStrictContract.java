 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/roles.yaml#/components/schemas/RoleSearchQueryResult
 */
...
public record GeneratedRoleSearchQueryStrictContract(
  ...
  public static java.util.List<GeneratedRoleStrictContract> coerceItems(final Object value) {
    ...
    if (!(value instanceof java.util.List<?> listValue)) {
      throw new IllegalArgumentException(
          "items must be a List of GeneratedRoleStrictContract, but was " + value.getClass().getName());
    }
  ...
  public static final class Builder implements PageStep, ItemsStep, OptionalStep {
    ...
    @Override
    public GeneratedRoleSearchQueryStrictContract build() {
      return new GeneratedRoleSearchQueryStrictContract(
  ...
  public interface OptionalStep {
    GeneratedRoleSearchQueryStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef PAGE = ContractPolicy.field("RoleSearchQueryResult", "page");
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("RoleSearchQueryResult", "items");

...
public final class GeneratedProcessInstanceSequenceFlowResultMapper {

  private GeneratedProcessInstanceSequenceFlowResultMapper() {}

  public static ProcessInstanceSequenceFlowResult toProtocol(
      final GeneratedProcessInstanceSequenceFlowStrictContract source) {
    return new ProcessInstanceSequenceFlowResult()
        .sequenceFlowId(source.sequenceFlowId())

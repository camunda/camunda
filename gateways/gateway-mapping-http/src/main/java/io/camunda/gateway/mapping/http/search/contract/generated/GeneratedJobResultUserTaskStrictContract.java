 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/jobs.yaml#/components/schemas/JobResultUserTask
 */
...
public record GeneratedJobResultUserTaskStrictContract(
  ...
  public static GeneratedJobResultCorrectionsStrictContract coerceCorrections(final Object value) {
    ...
    throw new IllegalArgumentException(
        "corrections must be a GeneratedJobResultCorrectionsStrictContract, but was " + value.getClass().getName());
  }
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep denied(final @Nullable Boolean denied, final ContractPolicy.FieldPolicy<Boolean> policy) {
    ...
    @Override
    public OptionalStep corrections(final @Nullable GeneratedJobResultCorrectionsStrictContract corrections) {
    ...
    public Builder corrections(final @Nullable GeneratedJobResultCorrectionsStrictContract corrections, final ContractPolicy.FieldPolicy<GeneratedJobResultCorrectionsStrictContract> policy) {
      this.corrections = policy.apply(corrections, Fields.CORRECTIONS, null);
      return this;
    }

    @Override
    public OptionalStep corrections(final @Nullable Object corrections, final ContractPolicy.FieldPolicy<Object> policy) {
      this.corrections = policy.apply(corrections, Fields.CORRECTIONS, null);
      return this;
    }
    ...
    public GeneratedJobResultUserTaskStrictContract build() {
      return new GeneratedJobResultUserTaskStrictContract(
          this.denied,
          this.deniedReason,
          coerceCorrections(this.corrections),
          this.type);
    }
  }
  ...
  OptionalStep denied(final @Nullable Boolean denied, final ContractPolicy.FieldPolicy<Boolean> policy);
  ...
  OptionalStep corrections(final @Nullable GeneratedJobResultCorrectionsStrictContract corrections);

  OptionalStep corrections(final @Nullable Object corrections);

  OptionalStep corrections(final @Nullable GeneratedJobResultCorrectionsStrictContract corrections, final ContractPolicy.FieldPolicy<GeneratedJobResultCorrectionsStrictContract> policy);

  OptionalStep corrections(final @Nullable Object corrections, final ContractPolicy.FieldPolicy<Object> policy);
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef DENIED = ContractPolicy.field("JobResultUserTask", "denied");
    public static final ContractPolicy.FieldRef DENIED_REASON = ContractPolicy.field("JobResultUserTask", "deniedReason");
    public static final ContractPolicy.FieldRef CORRECTIONS = ContractPolicy.field("JobResultUserTask", "corrections");
    public static final ContractPolicy.FieldRef TYPE = ContractPolicy.field("JobResultUserTask", "type");

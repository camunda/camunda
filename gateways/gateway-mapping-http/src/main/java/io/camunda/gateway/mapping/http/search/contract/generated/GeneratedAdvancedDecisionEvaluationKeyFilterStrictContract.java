...
public record GeneratedAdvancedDecisionEvaluationKeyFilterStrictContract(
    ...
    implements GeneratedDecisionEvaluationKeyFilterPropertyStrictContract {

  public GeneratedAdvancedDecisionEvaluationKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedDecisionEvaluationKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedDecisionEvaluationKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedDecisionEvaluationKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedDecisionEvaluationKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedDecisionEvaluationKeyFilter", "$notIn");

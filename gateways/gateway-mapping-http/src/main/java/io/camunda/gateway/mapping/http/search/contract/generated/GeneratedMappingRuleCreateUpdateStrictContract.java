 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/mapping-rules.yaml#/components/schemas/MappingRuleCreateUpdateResult
 */
...
public record GeneratedMappingRuleCreateUpdateStrictContract(
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef CLAIM_NAME = ContractPolicy.field("MappingRuleCreateUpdateResult", "claimName");
    public static final ContractPolicy.FieldRef CLAIM_VALUE = ContractPolicy.field("MappingRuleCreateUpdateResult", "claimValue");
    public static final ContractPolicy.FieldRef NAME = ContractPolicy.field("MappingRuleCreateUpdateResult", "name");
    public static final ContractPolicy.FieldRef MAPPING_RULE_ID = ContractPolicy.field("MappingRuleCreateUpdateResult", "mappingRuleId");

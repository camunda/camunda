 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/process-instances.yaml#/components/schemas/ProcessInstanceElementStatisticsQueryResult
 */
...
public record GeneratedProcessInstanceElementStatisticsQueryStrictContract(
    java.util.List<GeneratedProcessElementStatisticsStrictContract> items
) {

  public GeneratedProcessInstanceElementStatisticsQueryStrictContract {
  ...
  public static final class Builder implements ItemsStep, OptionalStep {
    ...
    @Override
    public GeneratedProcessInstanceElementStatisticsQueryStrictContract build() {
  ...
  public interface OptionalStep {
    GeneratedProcessInstanceElementStatisticsQueryStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef ITEMS = ContractPolicy.field("ProcessInstanceElementStatisticsQueryResult", "items");

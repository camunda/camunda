...
public record GeneratedAdvancedUserTaskStateFilterStrictContract(
    @Nullable io.camunda.gateway.protocol.model.UserTaskStateEnum eq,
    @Nullable io.camunda.gateway.protocol.model.UserTaskStateEnum neq,
    @Nullable Boolean exists,
    @Nullable java.util.List<io.camunda.gateway.protocol.model.UserTaskStateEnum> in,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public OptionalStep eq(final io.camunda.gateway.protocol.model.UserTaskStateEnum eq) {
      this.eq = eq;
      return this;
    }
    ...
    public OptionalStep eq(
        final io.camunda.gateway.protocol.model.UserTaskStateEnum eq,
    ...
    @Override
    public OptionalStep neq(final io.camunda.gateway.protocol.model.UserTaskStateEnum neq) {
      this.neq = neq;
      return this;
    }
    ...
    public OptionalStep neq(
        final io.camunda.gateway.protocol.model.UserTaskStateEnum neq,
        final ContractPolicy.FieldPolicy<io.camunda.gateway.protocol.model.UserTaskStateEnum>
            policy) {
    ...
    public OptionalStep in(
        final java.util.List<io.camunda.gateway.protocol.model.UserTaskStateEnum> in) {
      this.in = in;
      return this;
    }
  ...
  public interface OptionalStep {
    OptionalStep eq(final io.camunda.gateway.protocol.model.UserTaskStateEnum eq);
    ...
    OptionalStep neq(final io.camunda.gateway.protocol.model.UserTaskStateEnum neq);
    ...
    OptionalStep in(final java.util.List<io.camunda.gateway.protocol.model.UserTaskStateEnum> in);

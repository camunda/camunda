...
public record GeneratedGroupCreateStrictContract(
  ...
  public static final class Builder implements GroupIdStep, NameStep, OptionalStep {
    ...
    @Override
    public NameStep groupId(final String groupId, final ContractPolicy.FieldPolicy<String> policy) {
  ...
  public interface GroupIdStep {
    NameStep groupId(final String groupId, final ContractPolicy.FieldPolicy<String> policy);
  }

...
public record GeneratedAdvancedDecisionEvaluationInstanceKeyFilterStrictContract(
    ...
    implements GeneratedDecisionEvaluationInstanceKeyFilterPropertyStrictContract {

  public GeneratedAdvancedDecisionEvaluationInstanceKeyFilterStrictContract {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef $EQ =
        ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef $NEQ =
        ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef $EXISTS =
        ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef $IN =
        ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$in");
    public static final ContractPolicy.FieldRef $NOT_IN =
        ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$notIn");

 ...
 * Source: zeebe/gateway-protocol/src/main/proto/v2/keys.yaml#/components/schemas/AdvancedDecisionEvaluationInstanceKeyFilter
 */
...
public record GeneratedAdvancedDecisionEvaluationInstanceKeyFilterStrictContract(
    @Nullable String eq,
    @Nullable String neq,
  ...
  public static final class Builder implements OptionalStep {
    ...
    @Override
    public GeneratedAdvancedDecisionEvaluationInstanceKeyFilterStrictContract build() {
      return new GeneratedAdvancedDecisionEvaluationInstanceKeyFilterStrictContract(
          coerceEq(this.eq),
          coerceNeq(this.neq),
          this.exists,
          this.in,
  ...
  OptionalStep notIn(final java.util.@Nullable List<String> notIn, final ContractPolicy.FieldPolicy<java.util.List<String>> policy);
    ...
    GeneratedAdvancedDecisionEvaluationInstanceKeyFilterStrictContract build();
  }


  public static final class Fields {
    public static final ContractPolicy.FieldRef EQ = ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$eq");
    public static final ContractPolicy.FieldRef NEQ = ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$neq");
    public static final ContractPolicy.FieldRef EXISTS = ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$exists");
    public static final ContractPolicy.FieldRef IN = ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$in");
    public static final ContractPolicy.FieldRef NOT_IN = ContractPolicy.field("AdvancedDecisionEvaluationInstanceKeyFilter", "$notIn");

...
public record GeneratedUserTaskPropertiesStrictContract(
  ...
  public static final class Builder implements ActionStep, CandidateGroupsStep, CandidateUsersStep, ChangedAttributesStep, OptionalStep {
  ...
  public static final class Fields {
    public static final ContractPolicy.FieldRef ACTION = ContractPolicy.field("UserTaskProperties", "action");
    public static final ContractPolicy.FieldRef ASSIGNEE = ContractPolicy.field("UserTaskProperties", "assignee");
    public static final ContractPolicy.FieldRef CANDIDATE_GROUPS = ContractPolicy.field("UserTaskProperties", "candidateGroups");
    public static final ContractPolicy.FieldRef CANDIDATE_USERS = ContractPolicy.field("UserTaskProperties", "candidateUsers");
    public static final ContractPolicy.FieldRef CHANGED_ATTRIBUTES = ContractPolicy.field("UserTaskProperties", "changedAttributes");
    public static final ContractPolicy.FieldRef DUE_DATE = ContractPolicy.field("UserTaskProperties", "dueDate");
    public static final ContractPolicy.FieldRef FOLLOW_UP_DATE = ContractPolicy.field("UserTaskProperties", "followUpDate");
    public static final ContractPolicy.FieldRef FORM_KEY = ContractPolicy.field("UserTaskProperties", "formKey");
    public static final ContractPolicy.FieldRef PRIORITY = ContractPolicy.field("UserTaskProperties", "priority");
    public static final ContractPolicy.FieldRef USER_TASK_KEY = ContractPolicy.field("UserTaskProperties", "userTaskKey");

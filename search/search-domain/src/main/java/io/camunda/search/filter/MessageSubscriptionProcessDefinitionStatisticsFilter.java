...
public record MessageSubscriptionProcessDefinitionStatisticsFilter(
  ...
  public static final class Builder
      implements ObjectBuilder<MessageSubscriptionProcessDefinitionStatisticsFilter> {
    ...
    @Override
    public MessageSubscriptionProcessDefinitionStatisticsFilter build() {
      return new MessageSubscriptionProcessDefinitionStatisticsFilter(

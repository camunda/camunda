...
public class ResourceAccessForbiddenException extends CamundaSearchException {

  private final MissingAuthorization missingAuthorization;

  public ResourceAccessForbiddenException(final MissingAuthorization missingAuthorization) {
    super(
  ...
  public ResourceAccessForbiddenException(final Authorization authorization) {

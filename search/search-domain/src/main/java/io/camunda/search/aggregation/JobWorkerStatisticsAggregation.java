...
public record JobWorkerStatisticsAggregation(SearchQueryPage page)
    implements AggregationBase, AggregationPaginated {

  // Composite aggregation name
  public static final String AGGREGATION_BY_WORKER = "byWorker";

  // Composite aggregation source name
  public static final String AGGREGATION_SOURCE_NAME_WORKER = "worker";

  // Default size for composite aggregation
  public static final int AGGREGATION_COMPOSITE_SIZE = 10000;

  // Filter bucket names (within each worker bucket)

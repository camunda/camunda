...
public record UsageMetricsFilter(
    List<String> events, OffsetDateTime startTime, OffsetDateTime endTime, boolean tenants)
  ...
  public static final class Builder implements ObjectBuilder<UsageMetricsFilter> {
    ...
    public Builder tenants(final boolean value) {
      tenants = value;
      return this;
    }
    ...
    public UsageMetricsFilter build() {
      return new UsageMetricsFilter(events, startTime, endTime, tenants);
    }
  }
}

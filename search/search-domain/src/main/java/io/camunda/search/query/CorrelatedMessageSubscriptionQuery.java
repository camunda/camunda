...
public record CorrelatedMessageSubscriptionQuery(
    CorrelatedMessageSubscriptionFilter filter, CorrelatedMessageSubscriptionSort sort, SearchQueryPage page)
    implements TypedSearchQuery<CorrelatedMessageSubscriptionFilter, CorrelatedMessageSubscriptionSort> {

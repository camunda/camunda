...
public class OpensearchWildcardQuery extends OpensearchQueryVariant<WildcardQuery>
    implements DataStoreWildcardQuery {

  public OpensearchWildcardQuery(final WildcardQuery query) {
    super(query);
  }
  ...
  public static final class Builder implements DataStoreWildcardQuery.Builder {
    ...
    public DataStoreWildcardQuery build() {
      ...
      return new OpensearchWildcardQuery(query);
    }
  }
}

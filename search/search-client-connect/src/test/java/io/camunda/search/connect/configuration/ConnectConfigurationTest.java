...
public class ConnectConfigurationTest {
  ...
  class WhenMaxConnectionsIsNotPositive {
    ...
    @Test
    void shouldThrowExceptionWhenMaxConnectionsPerRouteIsZero() {
      // given
      final var configuration = new ConnectConfiguration();
      configuration.setMaxConnectionsPerRoute(0);
    ...
    @Test
    void shouldThrowExceptionWhenMaxConnectionsPerRouteIsNegative() {
      // given
      final var configuration = new ConnectConfiguration();
      configuration.setMaxConnectionsPerRoute(-10);

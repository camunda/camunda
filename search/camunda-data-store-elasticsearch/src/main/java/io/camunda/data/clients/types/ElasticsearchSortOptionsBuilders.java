...
public class ElasticsearchSortOptionsBuilders implements DataStoreSortOptionsBuildersDelegate {

  @Override
  public DataStoreSortOptions.Builder sort() {
    return new ElasticsearchSortOptions.Builder();
  }
  ...
  public DataStoreFieldSort.Builder field() {
    return new ElasticsearchFieldSort.Builder();
  }

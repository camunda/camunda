...
public final class ElasticsearchTermsQuery extends ElasticsearchQueryVariant<TermsQuery>
    implements DataStoreTermsQuery {

  public ElasticsearchTermsQuery(final TermsQuery termsQuery) {
    super(termsQuery);
  }
  ...
  public static final class Builder implements DataStoreTermsQuery.Builder {
    ...
    public DataStoreTermsQuery build() {
      ...
      return new ElasticsearchTermsQuery(termsQuery);
    }
  }
}

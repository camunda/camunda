...
public class ElasticsearchExistsQuery extends ElasticsearchQueryVariant<ExistsQuery>
    implements DataStoreExistsQuery {

  public ElasticsearchExistsQuery(final ExistsQuery query) {
    super(query);
  }
  ...
  public static final class Builder implements DataStoreExistsQuery.Builder {
    ...
    public DataStoreExistsQuery build() {
      ...
      return new ElasticsearchExistsQuery(query);
    }
  }
}

...
public class ElasticsearchMatchNoneQuery extends ElasticsearchQueryVariant<MatchNoneQuery>
    implements DataStoreMatchNoneQuery {

  public ElasticsearchMatchNoneQuery(final MatchNoneQuery query) {
    super(query);
  }
  ...
  public static final class Builder implements DataStoreMatchNoneQuery.Builder {
    ...
    public DataStoreMatchNoneQuery build() {
      ...
      return new ElasticsearchMatchNoneQuery(query);
    }
  }
}

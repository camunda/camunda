...
public class ElasticsearchMatchAllQuery extends ElasticsearchQueryVariant<MatchAllQuery>
    implements DataStoreMatchAllQuery {

  public ElasticsearchMatchAllQuery(final MatchAllQuery query) {
    super(query);
  }
  ...
  public static final class Builder implements DataStoreMatchAllQuery.Builder {
    ...
    public DataStoreMatchAllQuery build() {
      ...
      return new ElasticsearchMatchAllQuery(query);
    }
  }
}

...
public class MessageSubscriptionProcessDefinitionStatisticsFieldSortingTransformer
  ...
  public String apply(final String domainField) {
    return switch (domainField) {
      ...
      default -> throw new IllegalArgumentException("Unknown fields: " + domainField);
    };
  }
}

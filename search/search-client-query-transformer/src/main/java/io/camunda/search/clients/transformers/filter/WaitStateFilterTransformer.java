...
public class WaitStateFilterTransformer extends IndexFilterTransformer<WaitingStateFilter> {
  ...
  @Override
  public SearchQuery toSearchQuery(final WaitingStateFilter filter) {
    return and(longOperations(PROCESS_INSTANCE_KEY, filter.processInstanceKeyOperations()));
  }
}

...
public record SearchQueryRequest(
  ...
  public static final class Builder implements ObjectBuilder<SearchQueryRequest> {
    ...
    public Builder aggregations(final List<SearchAggregation> values) {
      aggregations = addValuesToList(aggregations, values);
      return this;
    }

    public Builder aggregations(final SearchAggregation value, final SearchAggregation... values) {

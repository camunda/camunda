...
import static io.camunda.webapps.schema.descriptors.index.TenantIndex.MEMBER_TYPE;

public class TenantMemberFieldSortingTransformer implements FieldSortingTransformer {

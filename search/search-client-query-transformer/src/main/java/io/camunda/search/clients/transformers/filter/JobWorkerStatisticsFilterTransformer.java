...
public class JobWorkerStatisticsFilterTransformer
    extends IndexFilterTransformer<JobWorkerStatisticsFilter> {

  public JobWorkerStatisticsFilterTransformer(final IndexDescriptor indexDescriptor) {
    super(indexDescriptor);
  }

  @Override
  public SearchQuery toSearchQuery(final JobWorkerStatisticsFilter filter) {
    ...
    // jobType is required for worker statistics

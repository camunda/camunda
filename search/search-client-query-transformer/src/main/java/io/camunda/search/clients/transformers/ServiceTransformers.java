...
public final class ServiceTransformers {
    ...
    public <F extends FilterBase, S extends SortOption> TypedSearchQueryTransformer<F, S> getTypedSearchQueryTransformer(
            final Class<?> cls) {
        final ServiceTransformer<TypedSearchQuery<F, S>, SearchQueryRequest> transformer = getTransformer(cls);
    ...
    public <A extends AggregationResultBase> AggregationResultTransformer<A> getSearchAggregationResultTransformer(
            final Class<A> cls) {
    ...
    public <A extends AggregationBase> AggregationTransformer<A> getAggregationTransformer(
            final Class<?> cls) {
        final ServiceTransformer<Tuple<A, ServiceTransformers>, List<SearchAggregator>> transformer = getTransformer(
                cls);
    ...
    public static void initializeTransformers(
        ...
        final TypedSearchQueryTransformer<?, ?> searchQueryTransformer = new TypedSearchQueryTransformer<>(mappers);
        // query -> request
        Stream.of(

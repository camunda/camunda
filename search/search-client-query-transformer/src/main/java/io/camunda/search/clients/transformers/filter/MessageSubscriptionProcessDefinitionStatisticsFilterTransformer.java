...
public class MessageSubscriptionProcessDefinitionStatisticsFilterTransformer
    extends IndexFilterTransformer<MessageSubscriptionProcessDefinitionStatisticsFilter> {

  public MessageSubscriptionProcessDefinitionStatisticsFilterTransformer(
  ...
  public SearchQuery toSearchQuery(
      final MessageSubscriptionProcessDefinitionStatisticsFilter filter) {
    final var eventSourceTypeTerm =
        stringTerms(EVENT_SOURCE_TYPE, List.of("PROCESS_MESSAGE_SUBSCRIPTION"));
    return and(
        List.of(eventSourceTypeTerm),

...
import static io.camunda.webapps.schema.descriptors.index.GroupIndex.MEMBER_TYPE;

public class GroupMemberFieldSortingTransformer implements FieldSortingTransformer {

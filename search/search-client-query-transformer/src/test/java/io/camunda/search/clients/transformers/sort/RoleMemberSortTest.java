...
public class RoleMemberSortTest extends AbstractSortTransformerTest {
  ...
  public void shouldSortByField(
    ...
    // when
    final var request = SearchQueryBuilders.roleMemberSearchQuery(q -> q.sort(fn));
  ...
  private record TestArguments(
      String field,
      SortOrder sortOrder,
      Function<RoleMemberSort.Builder, ObjectBuilder<RoleMemberSort>> fn)

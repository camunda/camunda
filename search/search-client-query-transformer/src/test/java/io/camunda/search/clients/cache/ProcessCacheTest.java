...
class ProcessCacheTest {
  ...
  void setUp() {
    entity =
        new ProcessDefinitionEntity(1L, "name1", "d1", null, null, 1, null, "tenant1", null, false);
        ...
        .thenReturn(
            SearchQueryResult.of(
                new ProcessDefinitionEntity(
                    missingKey, "later", "laterId", null, null, 1, null, "tenant", null, false)));
            ...
            invocation -> {
              ...
              return switch (key) {
                ...
                case 2 ->
                    SearchQueryResult.of(
                        new ProcessDefinitionEntity(
                            2L, "n2", "d2", null, null, 1, null, "t", null, false));
                case 3 ->
                    SearchQueryResult.of(
                        new ProcessDefinitionEntity(
                            3L, "n3", "d3", null, null, 1, null, "t", null, false));
  ...
  void shouldNotPersistEmptyResultsForBulkLoad() {
    ...
    when(searchExecutor.search(any(), eq(ProcessEntity.class), eq(ResourceAccessChecks.disabled())))
        .thenReturn(
            SearchQueryResult.of(
                new ProcessDefinitionEntity(
                    presentKey, "name1", "d1", null, null, 1, null, "tenant", null, false)))
        .thenReturn(
            SearchQueryResult.of(
                new ProcessDefinitionEntity(
                    presentKey, "name1", "d1", null, null, 1, null, "tenant", null, false),
                new ProcessDefinitionEntity(
                    missingKey, "name2", "d2", null, null, 1, null, "tenant", null, false)));

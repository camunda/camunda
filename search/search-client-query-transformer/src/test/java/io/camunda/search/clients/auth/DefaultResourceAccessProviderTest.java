...
class DefaultResourceAccessProviderTest {
  ...
  void shouldAllowAccessToResourceByIdBasedAuthorization() {
    ...
    when(authorizationChecker.isAuthorized(eq(authScopeInvoice), any(), any(Authorization.class)))
        .thenReturn(true);
  ...
  void shouldAllowAccessToResourceByResourceIdSupplier() {
    ...
    when(authorizationChecker.isAuthorized(eq(authScopeOrder), any(), any(Authorization.class)))
        .thenReturn(true);

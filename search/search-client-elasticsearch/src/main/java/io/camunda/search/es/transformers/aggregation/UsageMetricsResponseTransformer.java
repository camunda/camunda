...
public class UsageMetricsResponseTransformer
    implements SearchTransfomer<SearchResponse<?>, UsageMetricsAggregation> {
  public UsageMetricsResponseTransformer() {}

  @Override
  public UsageMetricsAggregation apply(final SearchResponse<?> value) {
    ...
    return new UsageMetricsAggregation(assignees, processInstances, decisionInstances);
  }
}

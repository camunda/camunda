...
These tests can also enforce certain coding standards that prevent bugs like [RequireKebabCaseInConditionalOnPropertyArchTest](./src/test/java/io/camunda/RequireKebabCaseInConditionalOnPropertyArchTest.java) and [RequireKebabCaseInValueArchTest](./src/test/java/io/camunda/RequireKebabCaseInValueArchTest.java).

...
public class Generator23 {

  private static final Logger logger = LoggerFactory.getLogger(Generator23.class);
  ...
  private static String readFileToString() throws IOException, URISyntaxException {
    return IOUtils.toString(Generator23.class.getResourceAsStream("/ValidTestLicense.txt"), Charset.forName("UTF-8"));
  }
  ...
  private static String readClasspathFileAsString(String filePath) {
    InputStream inputStream = Generator23.class.getClassLoader().getResourceAsStream(filePath);
    String data = null;
    try {

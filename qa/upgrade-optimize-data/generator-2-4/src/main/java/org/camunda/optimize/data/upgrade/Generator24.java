...
public class Generator24 {
  ...
  private static final Logger logger = LoggerFactory.getLogger(Generator24.class);
  ...
  private static String readFileToString() throws IOException, URISyntaxException {
    return new String(Files.readAllBytes(Paths.get(Generator24.class.getResource("/ValidTestLicense.txt")

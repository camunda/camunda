...
public class ListViewQueryIT extends OperateIntegrationTest {
  ...
  public void testQueryByWorkflowKeys() throws Exception {
    ...
    ListViewRequestDto query = TestUtil.createGetAllWorkflowInstancesQuery(q -> q.setWorkflowIds(Arrays.asList(wfKey1.toString(), wfKey3.toString())));
...
//  }
  ...
  public void testParamsAreEmptyStringsInsteadOfNull() throws Exception {
    ...
    ListViewRequestDto queryRequest = TestUtil.createGetAllRunningQuery()

...
import org.camunda.operate.webapp.rest.dto.operation.BatchOperationDto;
...
import static org.camunda.operate.util.TestUtil.createBatchOperationEntity;
...
public class BatchOperationReaderIT extends OperateIntegrationTest {
  ...
  public void testUser2Operations() throws Exception {
    when(userService.getCurrentUsername()).thenReturn(USER_2);

...
// TODO(menski): rename after old client was removed
public class GrpcRecordingJobHandler implements JobHandler {
  ...
  public GrpcRecordingJobHandler() {
    this(
        (controller, job) -> {
          // do nothing
        });
  ...
  public GrpcRecordingJobHandler(JobHandler... jobHandlers) {

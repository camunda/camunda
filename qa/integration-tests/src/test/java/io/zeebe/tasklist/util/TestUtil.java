...
public abstract class TestUtil {
  ...
  //
  //  public static WorkflowInstanceForListViewEntity createWorkflowInstance(WorkflowInstanceState
  // state) {
  //    return createWorkflowInstance(state, null);
  //  }
  //
  //  public static WorkflowInstanceForListViewEntity createWorkflowInstance(WorkflowInstanceState
  // state, Long workflowId) {
  ...
  //    if (state.equals(WorkflowInstanceState.COMPLETED) ||
  // state.equals(WorkflowInstanceState.CANCELED)) {
  ...
  //  }
  //
  //  public static WorkflowInstanceForListViewEntity createWorkflowInstance(OffsetDateTime
  // startDate, OffsetDateTime endDate) {
  //    WorkflowInstanceForListViewEntity workflowInstance = createWorkflowInstanceEntityWithIds();
  //    final int i = random.nextInt(10);
  //    workflowInstance.setBpmnProcessId("testProcess" + i);
  ...
  //  }
  //
  //  public static ActivityInstanceForListViewEntity createActivityInstanceWithIncident(Long
  // workflowInstanceKey, ActivityState state, String errorMsg, Long incidentKey) {
  //    ActivityInstanceForListViewEntity activityInstanceForListViewEntity =
  // createActivityInstance(workflowInstanceKey, state);
  //    createIncident(activityInstanceForListViewEntity, errorMsg, incidentKey);
  //    return activityInstanceForListViewEntity;
  //  }
  //
  //  public static void createIncident(ActivityInstanceForListViewEntity
  // activityInstanceForListViewEntity, String errorMsg, Long incidentKey) {
  //    if (incidentKey != null) {
  ...
  //  }
  //
  //  public static ActivityInstanceForListViewEntity createActivityInstance(Long
  // workflowInstanceKey, ActivityState state) {
  //    return createActivityInstance(workflowInstanceKey, state, "start", null);
  //  }
  //
  //  public static ActivityInstanceForListViewEntity createActivityInstance(Long
  // workflowInstanceKey, ActivityState state, String activityId, ActivityType activityType) {
  //    ActivityInstanceForListViewEntity activityInstanceEntity = new
  // ActivityInstanceForListViewEntity();
  ...
  //
  //  public static ActivityInstanceForListViewEntity createActivityInstance(Long
  // workflowInstanceKey, ActivityState state, String activityId) {
  //    return createActivityInstance(workflowInstanceKey, state, activityId,
  // ActivityType.SERVICE_TASK);
  //  }
  //
  //
  //  public static WorkflowInstanceForListViewEntity
  // createWorkflowInstanceEntity(WorkflowInstanceState state) {
  //    return createWorkflowInstanceEntity(state, null);
  //  }
  //
  //  public static WorkflowInstanceForListViewEntity
  // createWorkflowInstanceEntity(WorkflowInstanceState state, Long workflowKey) {
  //    WorkflowInstanceForListViewEntity workflowInstance = createWorkflowInstanceEntityWithIds();
  //    final int i = random.nextInt(10);
  //    workflowInstance.setBpmnProcessId("testProcess" + i);
  //    workflowInstance.setWorkflowName("Test process" + i);
  ...
  //    WorkflowInstanceForListViewEntity workflowInstance = new
  // WorkflowInstanceForListViewEntity();
  ...
  //  }
  //
  //  public static WorkflowInstanceForListViewEntity createWorkflowInstanceEntity(OffsetDateTime
  // startDate, OffsetDateTime endDate) {
  //    WorkflowInstanceForListViewEntity workflowInstance = createWorkflowInstanceEntityWithIds();
  //    final int i = random.nextInt(10);
  //    workflowInstance.setBpmnProcessId("testProcess" + i);
  ...
  //  }
  //
  //  public static IncidentEntity createIncident(IncidentState state, Long incidentKey, Long
  // workflowInstanceKey) {
  //    return createIncident(state, "start", random.nextLong(), null, incidentKey,
  // workflowInstanceKey);
  //  }
  //
  ...
  //  }
  //
  //  public static IncidentEntity createIncident(IncidentState state, String activityId, Long
  // activityInstanceId) {
  //    return createIncident(state, activityId, activityInstanceId, null);
  //  }
  //
  //  public static IncidentEntity createIncident(IncidentState state, String activityId, Long
  // activityInstanceId, String errorMsg) {
  //    return createIncident(state, activityId, activityInstanceId, errorMsg, null);
  //  }
  //
  //  public static IncidentEntity createIncident(IncidentState state, String activityId, Long
  // activityInstanceId, String errorMsg, Long incidentKey) {
  //    return createIncident(state, activityId, activityInstanceId, errorMsg, incidentKey, null);
  //  }
  //
  //  public static IncidentEntity createIncident(IncidentState state, String activityId, Long
  // activityInstanceId, String errorMsg, Long incidentKey, Long workflowInstanceKey) {
  ...
  //  }
  //
  //  public static List<WorkflowEntity> createWorkflowVersions(String bpmnProcessId, String name,
  // int versionsCount) {
  ...
  //  }
  //
  //  public static ListViewRequestDto createWorkflowInstanceQuery(Consumer<ListViewRequestDto>
  // filtersSupplier) {
  ...
  //  }
  //
  //  public static ListViewRequestDto
  // createGetAllWorkflowInstancesQuery(Consumer<ListViewRequestDto> filtersSupplier) {
  ...
  //  }
  //
  //  public static ListViewRequestDto createGetAllFinishedQuery(Consumer<ListViewRequestDto>
  // filtersSupplier) {
  ...
  //  }
  //
  //  public static VariableForListViewEntity createVariableForListView(Long workflowInstanceKey,
  // Long scopeKey, String name, String value) {
  ...
  //  }
  //
  //  public static VariableEntity createVariable(Long workflowInstanceKey, Long scopeKey, String
  // name, String value) {
  ...
  //
  //  public static OperationEntity createOperationEntity(Long workflowInstanceKey, Long
  // incidentKey, String varName, String username) {
  //    return createOperationEntity(workflowInstanceKey, incidentKey, varName,
  // OperationState.SCHEDULED, username, false);
  //  }
  //
  //  public static OperationEntity createOperationEntity(Long workflowInstanceKey, Long
  // incidentKey, String varName, OperationState state, String username, boolean lockExpired) {
  ...
  //      } else {
  //        oe.setLockExpirationTime(OffsetDateTime.now().plus(LOCK_TIMEOUT_DEFAULT,
  // ChronoUnit.MILLIS));
  //      }
  ...
  //  }
  //
  //  public static OperationEntity createOperationEntity(Long workflowInstanceKey, OperationState
  // state, boolean lockExpired) {
  ...
  //  }
  //
  //  public static BatchOperationEntity createBatchOperationEntity(OffsetDateTime startDate,
  // OffsetDateTime endDate, String username) {

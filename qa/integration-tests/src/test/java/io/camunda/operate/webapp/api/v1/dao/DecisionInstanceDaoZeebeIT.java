...
public class DecisionInstanceDaoZeebeIT extends OperateZeebeAbstractIT {

  protected static final Logger logger = LoggerFactory.getLogger(DecisionInstanceDaoZeebeIT.class);

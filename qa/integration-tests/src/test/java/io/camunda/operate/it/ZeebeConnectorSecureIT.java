...
public class ZeebeConnectorSecureIT {
  ...
  public ZeebeContainer zeebeContainer = new ZeebeContainer()
      ...
      .withEnv(Map.of(
          "ZEEBE_BROKER_GATEWAY_SECURITY_CERTIFICATECHAINPATH", "/usr/local/zeebe/certs/" + CERTIFICATE_FILE,
          "ZEEBE_BROKER_GATEWAY_SECURITY_PRIVATEKEYPATH",      "/usr/local/zeebe/certs/" + PRIVATE_KEY_FILE,

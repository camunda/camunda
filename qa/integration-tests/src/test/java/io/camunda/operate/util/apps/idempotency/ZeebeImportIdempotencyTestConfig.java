...
import io.camunda.operate.zeebeimport.v1_3.processors.ElasticsearchBulkProcessor;
...
public class ZeebeImportIdempotencyTestConfig {
  ...
  @Bean("io.camunda.operate.zeebeimport.v1_3.processors.ElasticsearchBulkProcessor")
  @Primary

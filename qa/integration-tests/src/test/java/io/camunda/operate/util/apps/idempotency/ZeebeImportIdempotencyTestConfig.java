...
import io.camunda.operate.zeebeimport.v8_0.processors.ElasticsearchBulkProcessor;
...
public class ZeebeImportIdempotencyTestConfig {
  ...
  @Bean("io.camunda.operate.zeebeimport.v8_0.processors.ElasticsearchBulkProcessor")
  @Primary

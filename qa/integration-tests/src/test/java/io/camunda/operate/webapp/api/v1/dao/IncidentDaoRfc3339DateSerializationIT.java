...
public class IncidentDaoRfc3339DateSerializationIT extends OperateSearchAbstractIT {
  ...
  public void shouldFilterByCreationDate() {
    ...
    assertThat(incidentResults.getItems().get(0).getCreationTime()).isEqualTo(firstIncidentRfc3339CreationTime);
  ...
  public void shouldFilterByCreationDateWithDateMath() {
    Results<Incident> incidentResults = dao.search(new Query<Incident>()
        .setFilter(new Incident().setCreationTime(firstIncidentRfc3339CreationTime + "||/d")));

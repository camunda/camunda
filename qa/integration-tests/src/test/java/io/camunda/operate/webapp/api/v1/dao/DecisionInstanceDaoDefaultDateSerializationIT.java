...
public class DecisionInstanceDaoDefaultDateSerializationIT extends OperateSearchAbstractIT {
  ...
  public void shouldFilterByEvaluationDate() {
    ...
    assertThat(decisionInstanceResults.getItems().get(0).getEvaluationDate()).isEqualTo(firstDecisionEvaluationDate);
  ...
  public void shouldFilterByEvaluationDateWithDateMath() {
    Results<DecisionInstance> decisionInstanceResults = dao.search(new Query<DecisionInstance>()
        .setFilter(new DecisionInstance().setEvaluationDate(firstDecisionEvaluationDate + "||/d")));

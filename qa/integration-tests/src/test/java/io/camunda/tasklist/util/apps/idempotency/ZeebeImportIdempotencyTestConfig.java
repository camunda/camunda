...
import io.camunda.tasklist.zeebeimport.v800.processors.ElasticsearchBulkProcessor;
...
public class ZeebeImportIdempotencyTestConfig {
  ...
  @Bean("io.camunda.tasklist.zeebeimport.v800.processors.ElasticsearchBulkProcessor")
  @Primary

...
public class SearchDecisionRequirementsTest {
  ...
  public static void setup() {
    ...
    deployProcessModel("decision_model.dmn");
    deployProcessModel("decision_model_1.dmn");
    deployProcessModel("decision_model_1_v2.dmn");
  ...
  @Test
  void shouldRetrieveByDecisionRequirementKey() {
    // when
    final var result =
        zeebeClient
  ...
  @Test
  void shouldRetrieveByDecisionRequirementId() {
    // when
    final var result =
        zeebeClient
            .newDecisionRequirementsQuery()
  ...
  @Test
  void shouldRetrieveByDecisionRequirementName() {
    // when
    final var result =
        zeebeClient
            .newDecisionRequirementsQuery()

...
public class CamundaDatabaseTestApplicationParameterResolver implements ParameterResolver {
  ...
  private final CamundaDatabaseTestApplication testApplication;

  public CamundaDatabaseTestApplicationParameterResolver(
      final String standaloneCamundaKey, final CamundaDatabaseTestApplication testApplication) {
  ...
  public boolean supportsParameter(
    ...
    return parameterCtx.getParameter().getType().equals(CamundaDatabaseTestApplication.class);
  }
  ...
  public Object resolveParameter(
    ...
    final String key = CamundaDatabaseTestApplication.class.getName() + "_" + standaloneCamundaKey;
    ...
    return store.getOrComputeIfAbsent(
        key, __ -> testApplication, CamundaDatabaseTestApplication.class);
  }
}

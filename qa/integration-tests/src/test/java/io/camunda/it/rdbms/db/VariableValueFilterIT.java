...
public class VariableValueFilterIT {
  ...
  public void shouldFindVariableWithNameFilter(final CamundaRdbmsTestApplication testApplication) {
    ...
    // AND a name filter
    final VariableValueFilter variableValueFilter = new Builder()
  ...
  @TestTemplate
  public void shouldFindVariableWithNameAndEqValue(final CamundaRdbmsTestApplication testApplication) {
    // GIVEN 21 variables
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final var randomizedVariable = prepareRandomVariablesAndReturnOne(testApplication);
  ...
  @TestTemplate
  public void shouldFindVariableWithNameAndNeqValue(final CamundaRdbmsTestApplication testApplication) {
    // GIVEN 21 variables
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final var randomizedVariable = prepareRandomVariablesAndReturnOne(testApplication);
  ...
  @TestTemplate
  public void shouldFindVariableWithNameAndGtValue(final CamundaRdbmsTestApplication testApplication) {
    // GIVEN 21 variables
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
  ...
  @TestTemplate
  public void shouldFindVariableWithNameAndGteValue(final CamundaRdbmsTestApplication testApplication) {
    // GIVEN 21 variables
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final var randomizedVariable = prepareRandomVariablesAndReturnOne(testApplication, "6");
  ...
  @TestTemplate
  public void shouldFindVariableWithNameAndLtValue(final CamundaRdbmsTestApplication testApplication) {
    // GIVEN 21 variables
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final var randomizedVariable = prepareRandomVariablesAndReturnOne(testApplication, "6");
  ...
  @TestTemplate
  public void shouldFindVariableWithNameAndLteValue(final CamundaRdbmsTestApplication testApplication) {
    // GIVEN 21 variables
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final var randomizedVariable = prepareRandomVariablesAndReturnOne(testApplication, "6");
  ...
  public void shouldFindVariableWithMultipleNamesFilter(final CamundaRdbmsTestApplication testApplication) {
    ...
    // WHEN we search for it, we should find one
    searchAndAssertVariableValueFilter(rdbmsService, randomizedVariable, List.of(variableValueFilter, otherVariableValueFilter));
  }
  ...
  public void shouldFindVariableWithMultipleNamesAndValuesFilter(final CamundaRdbmsTestApplication testApplication) {
    ...
    final VariableValueFilter variableValueFilter = new Builder()
        ...
        .eq(randomizedVariable.value())
        .build();
    final VariableValueFilter otherVariableValueFilter = new Builder()
        .name("not there")
        .eq("no")
        .build();
  ...
  private VariableDbModel prepareRandomVariablesAndReturnOne(final CamundaRdbmsTestApplication testApplication, final String value) {
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    ...
    if(value != null) {
      randomizedVariable = VariableFixtures.createRandomized(b -> b.scopeKey(scopeKey).value(value));
    } else {
  ...
  private void searchAndAssertVariableValueFilter(final RdbmsService rdbmsService, final VariableDbModel variableDbModel, final VariableValueFilter variableValueFilter) {
    searchAndAssertVariableValueFilter(rdbmsService, variableDbModel, List.of(variableValueFilter));
  }

  private void searchAndAssertVariableValueFilter(final RdbmsService rdbmsService, final VariableDbModel variableDbModel, final List<VariableValueFilter> variableValueFilter) {
    final var searchResult =
        rdbmsService.getVariableReader().search(
            new VariableDbQuery(

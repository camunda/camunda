...
import io.camunda.qa.util.cluster.TestAuthorizationClient;
import io.camunda.qa.util.cluster.TestAuthorizationClient.Permissions;
...
public class TasklistCreateProcessInstanceAuthorizationIT {
  ...
  @AutoCloseResource private static TestAuthorizationClient adminAuthClient;
  ...
  public void beforeAll() {
    ...
    try (final var intermediateCamundaClient =
            TestAuthorizationClient.createClient(broker, defaultUser, defaultUser);
    ...
    adminCamundaClient =
        TestAuthorizationClient.createClient(broker, ADMIN_USER_NAME, ADMIN_USER_PASSWORD);

...
public class FlowNodeInstanceSortIT {
  ...
  public void shouldSortByFlowNodeInstanceKeyAsc(
    ...
    testSorting(testApplication.getRdbmsService(),
  ...
  @TestTemplate
  public void shouldSortByFlowNodeIdAsc(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
        b -> b.flowNodeId().asc(),
  ...
  @TestTemplate
  public void shouldSortByFlowNodeIdDesc(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
        b -> b.flowNodeId().desc(),
  ...
  @TestTemplate
  public void shouldSortByProcessInstanceKey(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
  ...
  @TestTemplate
  public void shouldSortByProcessDefinitionKey(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
  ...
  @TestTemplate
  public void shouldSortByStartDateAsc(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
        b -> b.startDate().asc(),
  ...
  @TestTemplate
  public void shouldSortByEndDate(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
        b -> b.endDate().asc(),
  ...
  @TestTemplate
  public void shouldSortByTenantId(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
        b -> b.tenantId().asc(),
  ...
  @TestTemplate
  public void shouldSortByIncidentKeyAsc(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
        b -> b.incidentKey().asc(),
        Comparator.nullsLast(Comparator.comparing(FlowNodeInstanceEntity::incidentKey,
            Comparator.nullsLast(Comparator.naturalOrder()))));
  }

  @TestTemplate
  public void shouldSortByIncidentKeyDesc(
      final CamundaRdbmsTestApplication testApplication) {
    testSorting(testApplication.getRdbmsService(),
  ...
  private void testSorting(final RdbmsService rdbmsService,
    ...
    createAndSaveRandomFlowNodeInstances(rdbmsWriter,
        b -> b.processDefinitionKey(processDefinitionKey));

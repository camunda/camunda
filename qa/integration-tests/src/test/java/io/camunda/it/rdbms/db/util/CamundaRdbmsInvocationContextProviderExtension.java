...
public class CamundaRdbmsInvocationContextProviderExtension
  ...
  private final Map<String, CamundaDatabaseTestApplication> testApplications;

  public CamundaRdbmsInvocationContextProviderExtension() {
    testApplications = new HashMap<>();
    testApplications.put(
        "postgreSQL",
        CamundaDatabaseTestApplication.builder()
            .withConfiguration(RdbmsTestConfiguration.class)
            .build()
  ...
  public void beforeAll(final ExtensionContext context) {
    if (!started) {
      LOGGER.info("Starting up '{}' CamundaDatabaseTestApplication ...", testApplications.size());

...
/** TBD */
public class CamundaTestDBExtension
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(CamundaTestDBExtension.class);
  private final DatabaseType databaseType;
  private final List<AutoCloseable> closeables = new ArrayList<>();
  private final NewCamundaTestApplication testApplication;
  private String testPrefix;

  public CamundaTestDBExtension() {
  ...
  public CamundaTestDBExtension(final NewCamundaTestApplication testApplication) {

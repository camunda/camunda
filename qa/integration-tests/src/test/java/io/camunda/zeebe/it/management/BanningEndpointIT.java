...
public class BanningEndpointIT {
  ...
  @TestCluster
  private static final TestStandaloneCluster CLUSTER =
  ...
  void shouldBanInstance() {
    ...
    final var actuator = BanningActuator.ofAddress(monitoringAddress());
  ...
  private String monitoringAddress() {
    return CLUSTER.brokers().get(MemberId.from("0")).monitoringAddress();
  }
}

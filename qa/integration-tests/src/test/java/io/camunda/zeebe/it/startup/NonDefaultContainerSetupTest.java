                ...
                (Consumer<CreateContainerCmd>)
                    cmd ->
                        Objects.requireNonNull(cmd.getHostConfig())
                            ...
                            /* Tmpfs needs to be mounted as some data is written to it,
                             * e.g. by RocksDb or tomcat. It also needs the executable flag as Rocksdb
                             * requires that for some lib modfules it generates to tmp,
                             * otherwise a java.lang.UnsatisfiedLinkError error occurs:
                             * librocksdbjni-linux64.so: failed to map segment from shared object
                             */
                            .withTmpFs(Map.of("/tmp", "exec")))));
  }

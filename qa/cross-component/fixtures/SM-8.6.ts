...
import {LoginPage} from '@pages/SM-8.6/LoginPage';
import {HomePage} from '@pages/SM-8.6/HomePage';
import {NavigationPage} from '@pages/SM-8.6/NavigationPage';
import {ModelerHomePage} from '@pages/SM-8.6/ModelerHomePage';
import {ModelerCreatePage} from '@pages/SM-8.6/ModelerCreatePage';
import {PlayPage} from '@pages/SM-8.6/PlayPage';
import {TaskPanelPage} from '@pages/SM-8.6/TaskPanelPage';
import {TaskDetailsPage} from '@pages/SM-8.6/TaskDetailsPage';
import {OperateHomePage} from '@pages/SM-8.6/OperateHomePage';
import {OperateProcessesPage} from '@pages/SM-8.6/OperateProcessesPage';
import {OperateProcessInstancePage} from '@pages/SM-8.6/OperateProcessInstancePage';
import {OptimizeCollectionsPage} from '@pages/SM-8.6/OptimizeCollectionsPage';
import {OptimizeHomePage} from '@pages/SM-8.6/OptimizeHomePage';
import {FormJsPage} from '@pages/SM-8.6/FormJsPage';
import {OptimizeReportPage} from '@pages/SM-8.6/OptimizeReportPage';
import {ConsoleOrganizationPage} from '@pages/SM-8.6/ConsoleOrganizationPage';
import {SettingsPage} from '@pages/SM-8.6/SettingsPage';
import {ConnectorSettingsPage} from '@pages/SM-8.6/ConnectorSettingsPage';
import {ConnectorMarketplacePage} from '@pages/SM-8.6/ConnectorMarketplacePage';
import {IdentityPage} from '@pages/SM-8.6/IdentityPage';
import {ConsoleHomePage} from '@pages/SM-8.6/ConsoleHomePage';
import {OptimizeDashboardPage} from '@pages/SM-8.6/OptimizeDashboardPage';

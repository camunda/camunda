...
import {ClusterPage} from '@pages/8.5/ClusterPage';
...
import {ClusterDetailsPage} from '@pages/8.5/ClusterDetailsPage';
import {OperateProcessInstancePage} from '@pages/8.5/OperateProcessInstancePage';
import {OptimizeCollectionsPage} from '@pages/8.5/OptimizeCollectionsPage';
import {OptimizeHomePage} from '@pages/8.5/OptimizeHomePage';
import {FormJsPage} from '@pages/8.5/FormJsPage';
import {OptimizeReportPage} from '@pages/8.5/OptimizeReportPage';
import {ConsoleOrganizationPage} from '@pages/8.5/ConsoleOrganizationPage';
import {SettingsPage} from '@pages/8.5/SettingsPage';
import {ConnectorSettingsPage} from '@pages/8.5/ConnectorSettingsPage';
import {ClusterSecretsPage} from '@pages/8.5/ClusterSecretsPage';
import {TaskProcessesPage} from '@pages/8.5/TaskProcessesPage';
import {ConnectorMarketplacePage} from '@pages/8.5/ConnectorMarketplacePage';
import {ModelerUserInvitePage} from '@pages/8.5/ModelerUserInvitePage';
import {SignUpPage} from '@pages/8.5/SignUpPage';

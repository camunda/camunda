...
import {OperateLoginPage} from '@pages/c8Run-8.6/OperateLoginPage';
import {OperateHomePage} from '@pages/c8Run-8.6/OperateHomePage';
import {TaskPanelPage} from '@pages/c8Run-8.6/TaskPanelPage';
import {TaskListLoginPage} from '@pages/c8Run-8.6/TaskListLoginPage';
import {OperateProcessesPage} from '@pages/c8Run-8.6/OperateProcessesPage';
import {OperateProcessInstancePage} from '@pages/c8Run-8.6/OperateProcessInstancePage';
import {TaskDetailsPage} from '@pages/c8Run-8.6/TaskDetailsPage';

...
import {ClusterPage} from '@pages/8.7/ClusterPage';
...
import {ClusterDetailsPage} from '@pages/8.7/ClusterDetailsPage';
...
import {FormJsPage} from '@pages/8.7/FormJsPage';
...
import {ConnectorSettingsPage} from '@pages/8.7/ConnectorSettingsPage';
import {ClusterSecretsPage} from '@pages/8.7/ClusterSecretsPage';
import {TaskProcessesPage} from '@pages/8.7/TaskProcessesPage';
import {OptimizeDashboardPage} from '@pages/8.7/OptimizeDashboardPage';
import {ConnectorMarketplacePage} from '@pages/8.7/ConnectorMarketplacePage';
import {ModelerUserInvitePage} from '@pages/8.7/ModelerUserInvitePage';
import {SignUpPage} from '@pages/8.7/SignUpPage';

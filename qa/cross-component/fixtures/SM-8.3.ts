...
import {LoginPage} from '@pages/SM-8.3/LoginPage';
import {HomePage} from '@pages/SM-8.3/HomePage';
import {NavigationPage} from '@pages/SM-8.3/NavigationPage';
import {ModelerHomePage} from '@pages/SM-8.3/ModelerHomePage';
import {ModelerCreatePage} from '@pages/SM-8.3/ModelerCreatePage';
import {TaskPanelPage} from '@pages/SM-8.3/TaskPanelPage';
import {TaskDetailsPage} from '@pages/SM-8.3/TaskDetailsPage';
import {OperateHomePage} from '@pages/SM-8.3/OperateHomePage';
import {OperateProcessesPage} from '@pages/SM-8.3/OperateProcessesPage';
import {OperateProcessInstancePage} from '@pages/SM-8.3/OperateProcessInstancePage';
import {OptimizeCollectionsPage} from '@pages/SM-8.3/OptimizeCollectionsPage';
import {OptimizeHomePage} from '@pages/SM-8.3/OptimizeHomePage';
import {FormJsPage} from '@pages/SM-8.3/FormJsPage';
import {OptimizeReportPage} from '@pages/SM-8.3/OptimizeReportPage';
import {ConsoleOrganizationPage} from '@pages/SM-8.3/ConsoleOrganizationPage';
import {SettingsPage} from '@pages/SM-8.3/SettingsPage';
import {ConnectorSettingsPage} from '@pages/SM-8.3/ConnectorSettingsPage';
import {ConnectorMarketplacePage} from '@pages/SM-8.3/ConnectorMarketplacePage';
import {IdentityPage} from '@pages/SM-8.3/IdentityPage';
import {ConsoleHomePage} from '@pages/SM-8.3/ConsoleHomePage';
import {OptimizeDashboardPage} from '@pages/SM-8.3/OptimizeDashboardPage';

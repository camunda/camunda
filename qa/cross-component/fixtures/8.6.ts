...
import {ClusterPage} from '@pages/8.6/ClusterPage';
import {AppsPage} from '@pages/8.6/AppsPage';
import {ModelerHomePage} from '@pages/8.6/ModelerHomePage';
import {ModelerCreatePage} from '@pages/8.6/ModelerCreatePage';
...
import {ClusterDetailsPage} from '@pages/8.6/ClusterDetailsPage';
...
import {FormJsPage} from '@pages/8.6/FormJsPage';
import {OptimizeReportPage} from '@pages/8.6/OptimizeReportPage';
import {ConsoleOrganizationPage} from '@pages/8.6/ConsoleOrganizationPage';
import {SettingsPage} from '@pages/8.6/SettingsPage';
import {ConnectorSettingsPage} from '@pages/8.6/ConnectorSettingsPage';
import {ClusterSecretsPage} from '@pages/8.6/ClusterSecretsPage';
import {TaskProcessesPage} from '@pages/8.6/TaskProcessesPage';
import {OptimizeDashboardPage} from '@pages/8.6/OptimizeDashboardPage';
import {ConnectorMarketplacePage} from '@pages/8.6/ConnectorMarketplacePage';
import {ModelerUserInvitePage} from '@pages/8.6/ModelerUserInvitePage';

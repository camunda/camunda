...
import {LoginPage} from '@pages/SM-8.7/LoginPage';
import {HomePage} from '@pages/SM-8.7/HomePage';
import {NavigationPage} from '@pages/SM-8.7/NavigationPage';
import {ModelerHomePage} from '@pages/SM-8.7/ModelerHomePage';
import {ModelerCreatePage} from '@pages/SM-8.7/ModelerCreatePage';
import {PlayPage} from '@pages/SM-8.7/PlayPage';
import {TaskPanelPage} from '@pages/SM-8.7/TaskPanelPage';
import {TaskDetailsPage} from '@pages/SM-8.7/TaskDetailsPage';
import {OperateHomePage} from '@pages/SM-8.7/OperateHomePage';
import {OperateProcessesPage} from '@pages/SM-8.7/OperateProcessesPage';
import {OperateProcessInstancePage} from '@pages/SM-8.7/OperateProcessInstancePage';
import {OptimizeCollectionsPage} from '@pages/SM-8.7/OptimizeCollectionsPage';
import {OptimizeHomePage} from '@pages/SM-8.7/OptimizeHomePage';
import {FormJsPage} from '@pages/SM-8.7/FormJsPage';
import {OptimizeReportPage} from '@pages/SM-8.7/OptimizeReportPage';
import {ConsoleOrganizationPage} from '@pages/SM-8.7/ConsoleOrganizationPage';
import {SettingsPage} from '@pages/SM-8.7/SettingsPage';
import {ConnectorSettingsPage} from '@pages/SM-8.7/ConnectorSettingsPage';
import {ConnectorMarketplacePage} from '@pages/SM-8.7/ConnectorMarketplacePage';
import {IdentityPage} from '@pages/SM-8.7/IdentityPage';
import {ConsoleHomePage} from '@pages/SM-8.7/ConsoleHomePage';
import {OptimizeDashboardPage} from '@pages/SM-8.7/OptimizeDashboardPage';

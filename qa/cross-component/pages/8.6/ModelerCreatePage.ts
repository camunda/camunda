...
class ModelerCreatePage {
  ...
  async clickIdInput(): Promise<void> {
    await this.idInput.click({timeout: 60000});
  }
  ...
  async clickFirstPlacedElement(): Promise<void> {
    await this.firstPlacedElement.click({timeout: 90000});
  }

  async clickSecondPlacedElement(): Promise<void> {
    await this.secondPlacedElement.click({timeout: 12000});
  }

  async clickSecondElement(): Promise<void> {
    await this.secondElement.click({timeout: 12000});
  }

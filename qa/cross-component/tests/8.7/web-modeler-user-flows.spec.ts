...
import {ConsoleOrganizationPage} from '@pages/8.7/ConsoleOrganizationPage';
import {HomePage} from '@pages/8.7/HomePage';
import {SettingsPage} from '@pages/8.7/SettingsPage';
import {ModelerCreatePage} from '@pages/8.7/ModelerCreatePage';
import {captureScreenshot, captureFailureVideo} from '@setup';
import {MailSlurp} from 'mailslurp-client';
import {clickInvitationLinkInEmail} from '@pages/8.7/UtilitiesPage';
...
test.describe('Web Modeler User Flow Tests', () => {
  ...
  test('Form.js Integration with User Task and AI Generated Form', async ({
    ...
    await test.step('Create BPMN Diagram with a User Task with an embedded AI Generated Form and Start Process Instance', async () => {
      ...
      await modelerCreatePage.fillIdInput('User_Task_Process_With_AI_Form');
      await modelerCreatePage.clickStartEventElement();

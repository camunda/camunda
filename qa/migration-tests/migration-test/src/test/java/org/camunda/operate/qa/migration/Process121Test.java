...
import org.camunda.operate.qa.migration.v121.Process121DataGenerator;
...
public class Process121Test extends AbstractMigrationTest {


  private String bpmnProcessId = Process121DataGenerator.PROCESS_BPMN_PROCESS_ID;
  ...
  public void findProcessInstanceIds() {
    ...
    if (processInstanceIds == null) {
      ...
      assertThat(processInstanceIds).hasSize(Process121DataGenerator.PROCESS_INSTANCE_COUNT);
    }
  }
  ...
  public void testIncidents() {
    ...
    assertThat(incidents.size()).isEqualTo(Process121DataGenerator.INCIDENT_COUNT);

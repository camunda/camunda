...
import org.camunda.operate.qa.migration.v0230.Process0230DataGenerator;
...
public class Process0230Test extends AbstractMigrationTest {

  private String bpmnProcessId = Process0230DataGenerator.PROCESS_BPMN_PROCESS_ID;
  ...
  public void findProcessInstanceIds() {
    ...
    if (processInstanceIds == null) {
      ...
      assertThat(processInstanceIds).hasSize(Process0230DataGenerator.PROCESS_INSTANCE_COUNT);
    }
  }
  ...
  public void testSequenceFlows() {
    ...
    assertThat(sequenceFlows.size()).isEqualTo(Process0230DataGenerator.PROCESS_INSTANCE_COUNT * 2);
  }
  ...
  public void testFlowNodeInstances() {
    ...
    assertThat(activityInstances.size()).isEqualTo(Process0230DataGenerator.PROCESS_INSTANCE_COUNT * 3);
  ...
  public void testVariables() {
    ...
    assertThat(variableEntities.size()).isEqualTo(Process0230DataGenerator.PROCESS_INSTANCE_COUNT * 4);
  }
  ...
  public void testListViews() {
    SearchRequest searchRequest = new SearchRequest(listViewTemplate.getAlias());
    int processInstancesCount = Process0230DataGenerator.PROCESS_INSTANCE_COUNT;
  ...
  public void testIncidents() {
    ...
    assertThat(incidents.size()).isBetween(
        Process0230DataGenerator.INCIDENT_COUNT - (Process0230DataGenerator.COUNT_OF_CANCEL_OPERATION + Process0230DataGenerator.COUNT_OF_RESOLVE_OPERATION),
        Process0230DataGenerator.INCIDENT_COUNT
    );

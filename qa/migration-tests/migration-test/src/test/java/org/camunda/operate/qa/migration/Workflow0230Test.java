...
import org.camunda.operate.qa.migration.v0230.Workflow0230DataGenerator;
...
public class Workflow0230Test extends AbstractMigrationTest {

  private String bpmnProcessId = Workflow0230DataGenerator.WORKFLOW_BPMN_PROCESS_ID;
  ...
  public void findWorkflowInstanceIds() {
    ...
    if (workflowInstanceIds == null) {
      ...
      assertThat(workflowInstanceIds).hasSize(Workflow0230DataGenerator.WORKFLOW_INSTANCE_COUNT);
    }
  }
  ...
  public void testFlowNodeInstances() {
    ...
    assertThat(activityInstances.size()).isEqualTo(Workflow0230DataGenerator.WORKFLOW_INSTANCE_COUNT * 3);
  ...
  public void testVariables() {
    ...
    assertThat(variableEntities.size()).isEqualTo(Workflow0230DataGenerator.WORKFLOW_INSTANCE_COUNT * 4);
  }
  ...
  public void testListViews() {
    SearchRequest searchRequest = new SearchRequest(listViewTemplate.getAlias());
    int workflowInstancesCount = Workflow0230DataGenerator.WORKFLOW_INSTANCE_COUNT;
  ...
  public void testIncidents() {
    ...
    assertThat(incidents.size()).isBetween(
        Workflow0230DataGenerator.INCIDENT_COUNT - (Workflow0230DataGenerator.COUNT_OF_CANCEL_OPERATION + Workflow0230DataGenerator.COUNT_OF_RESOLVE_OPERATION),
        Workflow0230DataGenerator.INCIDENT_COUNT
    );

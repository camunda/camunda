 ...
 */
@Component
public class Process0230DataGenerator {

  private static final Logger logger = LoggerFactory.getLogger(Process0230DataGenerator.class);
  public static final String PROCESS_BPMN_PROCESS_ID = "process0230";
  ...
  public void createData(TestContext testContext) throws Exception {
    ...
    try {
      ...
      completeTasks("task0230_1", PROCESS_INSTANCE_COUNT);
  ...
  public boolean createOperation(Long processInstanceKey, OperationType operationType) {

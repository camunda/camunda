...
public class InheritedSimpleMappingAuthorizationIT {
  ...
  private static Stream<Named<TestClient>> provideAuthorizedMappingRules() {
    return Stream.of(
        Named.of("#userThroughGroup", CLIENT_THROUGH_AUTHORIZED_GROUP),
        Named.of("#userThroughRole", CLIENT_THROUGH_AUTHORIZED_ROLE),
        Named.of("#userThroughGroupThroughRole", CLIENT_THROUGH_GROUP_THROUGH_AUTHORIZED_ROLE));
  }

  private static Stream<Named<TestClient>> provideUnauthorizedMappingRules() {
    return Stream.of(
        Named.of("#userThroughGroup", CLIENT_THROUGH_UNAUTHORIZED_GROUP),
        Named.of("#userThroughRole", CLIENT_THROUGH_UNAUTHORIZED_ROLE),
        Named.of("#userThroughGroupThroughRole", CLIENT_THROUGH_GROUP_THROUGH_UNAUTHORIZED_ROLE));
  }

...
public class DecisionInstanceSpecificFilterIT {
  ...
  static List<DecisionInstanceFilter> shouldFindDecisionInstanceWithSpecificFilterParameters() {
    return List.of(
        ...
        DecisionInstanceFilter.of(b -> b.stateOperations(Operation.eq(DecisionInstanceState.EVALUATED))),
        DecisionInstanceFilter.of(b -> b.stateOperations(Operation.in(DecisionInstanceState.EVALUATED, DecisionInstanceState.FAILED))),

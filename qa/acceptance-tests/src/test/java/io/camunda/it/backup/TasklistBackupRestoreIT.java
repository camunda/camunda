...
@Testcontainers
@ZeebeIntegration
public class TasklistBackupRestoreIT {
  private static final Logger LOGGER = LoggerFactory.getLogger(TasklistBackupRestoreIT.class);
  ...
  private List<String> takeHistoryBackup() {
    ...
    Awaitility.await("Tasklist backup completed")

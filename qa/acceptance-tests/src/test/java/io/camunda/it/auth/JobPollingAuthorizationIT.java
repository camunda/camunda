...
public class JobPollingAuthorizationIT {
  ...
  public void shouldReceiveOnlyAuthorizedJobs(
    ...
    // given
    // three process instances with jobs are created
    ...
    assertThat(activatedJobs.iterator().next().getTenantId()).isEqualTo(TENANT_B);
  }

...
class UserTaskSearchTest {
  ...
  void shouldReturnUserTaskByCreationDateGt() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getCreationDate())
                  .isAfter(userTaskCreationDateExample.minusSeconds(1));
            });
  }
  ...
  void shouldReturnUserTaskByCreationDateLt() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getCreationDate())
                  .isBefore(userTaskCreationDateExample.plusSeconds(1));
            });
  }
  ...
  void shouldReturnUserTaskByCreationDateEq() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getCreationDate()).isEqualTo(userTaskCreationDateExample);
            });
  }
  ...
  void shouldReturnUserTaskByCompletionDateGte() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getCompletionDate())
  ...
  void shouldReturnUserTaskByCompletionDateEq() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getCompletionDate()).isEqualTo(userTaskCompletionDateExample);
            });
  }
  ...
  void shouldReturnUserTaskByCompletionDateGt() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getCompletionDate())
                  .isAfter(userTaskCompletionDateExample.minusSeconds(1));
            });
  }
  ...
  void shouldReturnUserTaskByCompletionDateLt() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getCompletionDate())
                  .isBefore(userTaskCompletionDateExample.plusSeconds(1));
            });
  }
  ...
  void shouldRetrieveTaskByDueDateEquals() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getDueDate()).isEqualTo(dueDateExample);
            });
  }
  ...
  void shouldRetrieveTaskByFollowUpDateEquals() {
    ...
    result
        ...
        .forEach(
            item -> {
              assertThat(item.getFollowUpDate()).isEqualTo(followUpDateExample);
            });
  }

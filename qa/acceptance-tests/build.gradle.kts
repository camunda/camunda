...
// groups are owned by dedicated CI shards (rdbms, multi-db, compatibility, nightly) and must not
// run in the root acceptance suite. Mutating the existing JUnitPlatformOptions (rather than calling
// useJUnitPlatform again) preserves the performance/strace exclusions set by server-conventions.
tasks.named<Test>("it") {

...
fun Test.configureAcceptanceProfile(
...
tasks.register<Test>("itHistory") {
  description = "Runs the Maven history acceptance-test profile."
  configureAcceptanceProfile(
    includePatterns = allItPatterns,
...
tasks.register<Test>("itIdentity") {
  description = "Runs the Maven identity-tests acceptance-test profile."
  configureAcceptanceProfile(
...
tasks.register<Test>("itRdbms") {
  description = "Runs the Maven rdbms acceptance-test profile."
  configureAcceptanceProfile(
    includePatterns = allItPatterns,

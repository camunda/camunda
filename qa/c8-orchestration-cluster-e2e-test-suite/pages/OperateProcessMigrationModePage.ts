...
export class OperateProcessMigrationModePage {
  ...
  constructor(page: Page) {
    this.page = page;
    this.targetVersionCombo = page.getByRole('combobox', { name: 'Target Version' });
    this.nextButton = this.page.getByRole('button', {name: 'Next'});
    this.confirmButton = this.page.getByRole('button', {name: 'Confirm'});
    this.migrationConfirmationInput = page.locator('#modification-confirmation');
    this.migrationConfirmationButton = page.getByLabel('Migration confirmation').getByRole('button', { name: 'Confirm' });
  }

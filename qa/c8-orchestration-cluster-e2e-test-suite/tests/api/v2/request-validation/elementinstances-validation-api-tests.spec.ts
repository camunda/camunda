...
test.describe('Elementinstances Validation API Tests', () => {
  ...
  test('activateAdHocSubProcessActivities - Param elements.0.elementId wrong type (#1)', async ({
    request,
  }) => {
    const requestBody = {
      elements: [
  ...
  test('activateAdHocSubProcessActivities - Param elements.0.elementId wrong type (#2)', async ({
    request,
  }) => {
    const requestBody = {
      elements: [
  ...
  test('createElementInstanceVariables - Additional prop __extraField', async ({
    request,
  }) => {
    const requestBody = {
      variables: {},
  ...
  test('searchElementInstances - Additional prop __extraField', async ({
    request,
  }) => {
    const requestBody = {
      __extraField: 'unexpected',
  ...
  test('searchElementInstances - Missing body', async ({ request }) => {
    const res = await request.post(
      buildUrl('/element-instances/search', undefined),
      {
        headers: jsonHeaders(),

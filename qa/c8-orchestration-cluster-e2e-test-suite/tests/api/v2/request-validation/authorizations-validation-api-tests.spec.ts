...
test.describe('Authorizations Validation API Tests', () => {
  ...
  test('createAuthorization - Body wrong top-level type', async ({
    request,
  }) => {
    const requestBody = [];
    const res = await request.post(buildUrl('/authorizations', undefined), {
  ...
  test('createAuthorization - Missing resourceType (#1)', async ({
    request,
  }) => {
    const requestBody = {
      ownerId: 'x',
  ...
  test('createAuthorization - Missing resourceType (#2)', async ({
    request,
  }) => {
    const requestBody = {
      ownerId: 'x',
  ...
  test('updateAuthorization - Body wrong top-level type', async ({
    request,
  }) => {
    const requestBody = [];
    const res = await request.put(
  ...
  test('updateAuthorization - Missing resourceType (#1)', async ({
    request,
  }) => {
    const requestBody = {
      ownerId: 'x',
  ...
  test('updateAuthorization - Missing resourceType (#2)', async ({
    request,
  }) => {
    const requestBody = {
      ownerId: 'x',

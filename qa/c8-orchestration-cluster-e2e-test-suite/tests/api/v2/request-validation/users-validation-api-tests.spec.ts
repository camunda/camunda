...
test.describe('Users Validation API Tests', () => {
  ...
  test('createUser - Param email wrong type (#1)', async ({request}) => {
    const requestBody = {
      password: 'x',
      username: 'x',
      email: 123,
  ...
  test('createUser - Param email wrong type (#2)', async ({request}) => {
    const requestBody = {
      password: 'x',
      username: 'x',
      email: true,
  ...
  test('createUser - Missing email', async ({request}) => {
    const requestBody = {
      password: 'x',
      username: 'x',
    };
  ...
  test('createUser - Missing combo password,email', async ({request}) => {
    const requestBody = {
      username: 'x',
    };
    const res = await request.post(buildUrl('/users', undefined), {
  ...
  test('createUser - Missing combo password,username', async ({request}) => {
    const requestBody = {
      email: 'x',
    };
    const res = await request.post(buildUrl('/users', undefined), {
  ...
  test('createUser - Missing combo password,username,email', async ({
    request,
  }) => {
    const requestBody = {};
    const res = await request.post(buildUrl('/users', undefined), {
  ...
  test('createUser - Missing combo username,email', async ({request}) => {
    const requestBody = {
      password: 'x',
    };
    const res = await request.post(buildUrl('/users', undefined), {

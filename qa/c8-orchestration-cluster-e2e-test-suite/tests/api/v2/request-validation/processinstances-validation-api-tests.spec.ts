...
test.describe('Processinstances Validation API Tests', () => {
  ...
  test('migrateProcessInstance - Param mappingInstructions.0.sourceElementId wrong type (#1)', async ({
    request,
  }) => {
    const requestBody = {
      targetProcessDefinitionKey: null,
  ...
  test('migrateProcessInstance - Param mappingInstructions.0.sourceElementId wrong type (#2)', async ({
    request,
  }) => {
    const requestBody = {
      targetProcessDefinitionKey: null,
  ...
  test('migrateProcessInstance - Param mappingInstructions.0.targetElementId wrong type (#1)', async ({
    request,
  }) => {
    const requestBody = {
      targetProcessDefinitionKey: null,
  ...
  test('migrateProcessInstance - Param mappingInstructions.0.targetElementId wrong type (#2)', async ({
    request,
  }) => {
    const requestBody = {
      targetProcessDefinitionKey: null,
  ...
  test('migrateProcessInstancesBatchOperation - Param migrationPlan.mappingInstructions.0.sourceElementId wrong type (#1)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {
  ...
  test('migrateProcessInstancesBatchOperation - Param migrationPlan.mappingInstructions.0.sourceElementId wrong type (#2)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {
  ...
  test('migrateProcessInstancesBatchOperation - Param migrationPlan.mappingInstructions.0.targetElementId wrong type (#1)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {
  ...
  test('migrateProcessInstancesBatchOperation - Param migrationPlan.mappingInstructions.0.targetElementId wrong type (#2)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {
  ...
  test('modifyProcessInstancesBatchOperation - Param moveInstructions.0.sourceElementId wrong type (#1)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {
  ...
  test('modifyProcessInstancesBatchOperation - Param moveInstructions.0.sourceElementId wrong type (#2)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {
  ...
  test('modifyProcessInstancesBatchOperation - Param moveInstructions.0.targetElementId wrong type (#1)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {
  ...
  test('modifyProcessInstancesBatchOperation - Param moveInstructions.0.targetElementId wrong type (#2)', async ({
    request,
  }) => {
    const requestBody = {
      filter: {

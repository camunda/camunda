...
interface Opts { onlyOperations?: Set<string>; capPerOperation?: number; maxComboSize?: number; }

export function generateMissingRequiredCombos(ops: OperationModel[], opts: Opts): ValidationScenario[] {

...
test.describe('Groups Validation API Tests', () => {
  ...
  test('searchGroups - Additional prop __unexpectedField', async ({
    request,
  }) => {
    const requestBody = {
      __unexpectedField: 'x',
  ...
  test('searchGroups - Enum violation sort.0.field (#1)', async ({request}) => {
    const requestBody = {
      sort: {
        '0': {
          field: {
  ...
  test('searchGroups - Enum violation sort.0.field (#2)', async ({request}) => {
    const requestBody = {
      sort: {
        '0': {
          field: {
  ...
  test('searchGroups - Enum violation sort.0.order (#1)', async ({request}) => {
    const requestBody = {
      sort: {
        '0': {
          order: {
  ...
  test('searchGroups - Enum violation sort.0.order (#2)', async ({request}) => {
    const requestBody = {
      sort: {
        '0': {
          order: {
  ...
  test('searchMappingRulesForGroup - Additional prop __unexpectedField', async ({
    request,
  }) => {
    const requestBody = {
      __unexpectedField: 'x',
  ...
  test('searchRolesForGroup - Body wrong top-level type', async ({request}) => {
    const requestBody: string[] = [];
    const res = await request.post(
      buildUrl('/groups/{groupId}/roles/search', {groupId: 'x'}),
      {
  ...
  test('searchUsersForGroup - Body wrong top-level type', async ({request}) => {
    const requestBody: string[] = [];
    const res = await request.post(
      buildUrl('/groups/{groupId}/users/search', {groupId: 'x'}),
      {

...
import {assertEqualsForKeys, assertRequiredFields, assertStatusCode, buildUrl, jsonHeaders} from '../http';
import {expect} from '@playwright/test';
import {authorizationRequiredFieldsWithoutPermissionTypes, authorizedComponentRequiredFields} from '../beans/requestBeans';
...
export async function verifyAuthorizationFields(
    obj: {  
      ownerId: string;
      ownerType: string;
      resourceId: string;
    ...
    assertEqualsForKeys(obj, expected, authorizationRequiredFieldsWithoutPermissionTypes);

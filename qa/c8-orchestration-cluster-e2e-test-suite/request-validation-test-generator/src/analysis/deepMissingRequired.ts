...
interface Opts { onlyOperations?: Set<string>; capPerOperation?: number; includeNested?: boolean; }

export function generateDeepMissingRequired(ops: OperationModel[], opts: Opts): ValidationScenario[] {

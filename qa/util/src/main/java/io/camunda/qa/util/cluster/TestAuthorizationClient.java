...
public class TestAuthorizationClient implements AutoCloseable {
  ...
  public TestAuthorizationClient(final ZeebeClient client, final String elasticsearchUrl) {
    this.client = client;
  ...
  public static ZeebeClient createClient(
      final TestStandaloneCamunda broker, final String username, final String password) {
    return broker
        .newClientBuilder()

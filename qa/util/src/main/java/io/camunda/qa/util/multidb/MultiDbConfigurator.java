...
public class MultiDbConfigurator {
  ...
  public void configureElasticsearchSupport(
    ...
    // db type
    // set UC environment variable so that ConditionalOnSecondaryStorageType works
  ...
  public void configureOpenSearchSupport(
    ...
    testApplication.withUnifiedConfig(
        cfg -> {
          cfg.getData().getSecondaryStorage().setType(SecondaryStorageType.opensearch);
          cfg.getData().getSecondaryStorage().getRetention().setEnabled(retentionEnabled);
          cfg.getData().getSecondaryStorage().getRetention().setMinimumAge("0s");
  ...
  public void configureRDBMSSupport(final boolean retentionEnabled) {
    ...
    testApplication.withUnifiedConfig(
        cfg -> cfg.getData().getSecondaryStorage().setType(SecondaryStorageType.rdbms));

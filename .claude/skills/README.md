...
|             Skill             |                                             Description                                             |
|--------------------------------|------------------------------------------------------------------------------------------------------|
| `act-testing`                  | Prepare act-testable GitHub Actions workflow scenarios; validate workflow logic locally               |
...
| `ci-incident`                   | Drive CI incident response in camunda/camunda by incident ID                                          |
...
| `ci-security-compliance`        | Enforce GitHub Actions security and compliance conventions for this monorepo                          |
| `ci-validation`                 | Validate GitHub Actions workflow changes using actionlint, conftest, spotless, and act testability    |
...
| `zeebe-flamegraph-diff`         | Parse and compare async-profiler CPU flamegraphs from Camunda/Zeebe brokers; diff a run against a baseline |

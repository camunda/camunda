...
import io.camunda.tasklist.zeebeimport.v120.record.RecordImpl;
import io.camunda.tasklist.zeebeimport.v120.record.value.JobRecordValueImpl;
import io.camunda.tasklist.zeebeimport.v120.record.value.ProcessInstanceRecordValueImpl;
import io.camunda.tasklist.zeebeimport.v120.record.value.VariableDocumentRecordImpl;
import io.camunda.tasklist.zeebeimport.v120.record.value.VariableRecordValueImpl;
import io.camunda.tasklist.zeebeimport.v120.record.value.deployment.DeployedProcessImpl;

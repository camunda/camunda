...
import io.camunda.operate.zeebeimport.v1_2.record.value.JobRecordValueImpl;
import io.camunda.operate.zeebeimport.v1_2.record.value.ProcessInstanceRecordValueImpl;
import io.camunda.operate.zeebeimport.v1_2.record.value.VariableDocumentRecordImpl;

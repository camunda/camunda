...
public class GatewayModeDockerIT extends AbstractCamundaDockerIT {
  ...
  void testGatewayModeExposesCorrectPortsAndHealthEndpoint() throws Exception {
    ...
    /* create Camunda container with GATEWAY mode configuration */

    final GenericContainer camundaContainer =
        createContainer(this::createCamundaContainer)
            .withEnv("CAMUNDA_MODE", "gateway")
            .waitingFor(
                Wait.forHttp("/actuator/health/gatewayStarted")
                    .forPort(9600)
                    .forStatusCode(200)

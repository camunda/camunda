...
public class BackupPriorityConfiguration {
  ...
  public BackupPriorityConfiguration(final UnifiedConfiguration unifiedConfiguration) {
    secondaryStorage = unifiedConfiguration.getCamunda().getData().getSecondaryStorage();
  }

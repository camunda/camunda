...
@ConditionalOnDatabase(DatabaseConfig.RDBMS)
...
public class RdbmsConfiguration {
  ...
  @Bean
  public RoleMemberDbReader roleMemberDbReader() {
  ...
  @Bean
  public MappingDbReader mappingReader(final MappingMapper mappingMapper) {
  ...
  public RdbmsService rdbmsService(
      ...
      final MappingDbReader mappingReader,
      final BatchOperationDbReader batchOperationReader,

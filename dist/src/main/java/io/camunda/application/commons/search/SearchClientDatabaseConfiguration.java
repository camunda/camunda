...
import io.camunda.application.commons.condition.ConditionalOnDatabase;
import io.camunda.application.commons.condition.ConditionalOnDatabaseDisabled;
import io.camunda.application.commons.condition.ConditionalOnDatabaseEnabled;
...
public class SearchClientDatabaseConfiguration {
  ...
  @Bean
  @ConditionalOnDatabase(DatabaseConfig.ELASTICSEARCH)
  ...
  @Bean
  @ConditionalOnDatabase(DatabaseConfig.OPENSEARCH)
  ...
  public CamundaSearchClients searchClients(
    ...
    return new CamundaSearchClients(
        searchClientReaders,
        new CompositeResourceAccessController(resourceAccessControllers),
        null);
  }

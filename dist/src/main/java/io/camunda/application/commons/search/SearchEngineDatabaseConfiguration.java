...
public class SearchEngineDatabaseConfiguration {
  ...
  @Bean
  public SearchSchemaManagerConfiguration searchSchemaManagerConfiguration(
    ...
    return new SearchSchemaManagerConfiguration(searchEngineConfiguration, createSchema);
  }

  /** workaround to make the broker wait for the schema to be created before starting */
  @Bean
  @DependsOn("searchSchemaManagerConfiguration")

...
> [!IMPORTANT]
> The Grafanda dashboards in the [`grafana/`](grafana) folder are not maintained anymore.
> Please use the [camunda-observability repository](https://github.com/camunda/camunda-observability) instead.

This repository contains old Grafana dashbaords that are not maintained anymore, do not update them.

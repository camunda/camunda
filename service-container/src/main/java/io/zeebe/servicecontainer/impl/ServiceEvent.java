...
public class ServiceEvent
{
    public enum ServiceEventType
    {
        ...
        /** Fired by the container when all of a service's dependencies are available. If the service
         * has at least one dependency, it means that this dependency has started. If the service has no dependencies,
         * the event is fired immediately, after the service is installed.
         */

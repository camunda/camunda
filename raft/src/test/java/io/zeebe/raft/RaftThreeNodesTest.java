...
public class RaftThreeNodesTest {
  ...
  public RaftRule raft2 = new RaftRule(serviceContainer, "default", 0, raft1);
  public RaftRule raft3 = new RaftRule(serviceContainer, "default", 0, raft1);

  @Rule
  public RaftClusterRule cluster =
      new RaftClusterRule(actorScheduler, serviceContainer, raft1, raft2, raft3);
  ...
  public void shouldElectNewLeader() {
    ...
    assertThat(newLeader).isNotNull().isNotEqualTo(oldLeader);

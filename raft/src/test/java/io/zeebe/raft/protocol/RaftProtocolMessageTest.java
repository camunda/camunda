...
public class RaftProtocolMessageTest {
  ...
  public static RaftRule raft1 = new RaftRule(serviceContainer, 1, 123);
  public static RaftRule raft2 = new RaftRule(serviceContainer, 2, 123, raft1);
  ...
  public void shouldReadWriteJoinResponse() {
    ...
    ConfigurationResponse configurationResponse =
        new ConfigurationResponse().setRaft(raft).setSucceeded(true);
  ...
  public void shouldReadWritePollRequest() {
    ...
    PollRequest pollRequest =
        new PollRequest().setRaft(raft).setLastEventPosition(111).setLastEventTerm(222);
  ...
  public void shouldReadWritePollResponse() {
    // given
    PollResponse pollResponse = new PollResponse().setTerm(111).setGranted(true);
  ...
  public void shouldReadWriteVoteRequest() {
    ...
    VoteRequest voteRequest =
        new VoteRequest().setRaft(raft).setLastEventPosition(111).setLastEventTerm(222);
  ...
  public void shouldReadWriteVoteResponse() {
    // given
    VoteResponse voteResponse = new VoteResponse().setTerm(111).setGranted(true);
  ...
  public void shouldReadAndWriteAppendRequestWithoutEvent() {
    ...
    AppendRequest appendRequest =
        new AppendRequest().setRaft(raft).setPreviousEventPosition(111).setPreviousEventTerm(222);
  ...
  public void shouldReadAndWriteAppendRequestWithEvent() {
    ...
    final MutableDirectBuffer data =
        new UnsafeBuffer(new byte[DataFrameDescriptor.alignedFramedLength(msgLength)]);
  ...
  public void shouldReadWriteAppendResponse() {
    ...
    AppendResponse appendResponse =
        new AppendResponse().setRaft(raft).setPreviousEventPosition(111).setSucceeded(true);

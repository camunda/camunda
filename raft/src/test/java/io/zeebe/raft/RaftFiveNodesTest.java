...
public class RaftFiveNodesTest {
  ...
  public RaftClusterRule cluster =
      new RaftClusterRule(actorScheduler, serviceContainerRule, raft1, raft2, raft3, raft4, raft5);
  ...
  public void shouldElectNewLeader() {
    ...
    assertThat(newLeader).isNotNull().isNotEqualTo(raft1);
  ...
  public void shouldTruncateLog() {
    ...
    // then the new events are also committed on the returning nodes discarding there uncommitted
    // events

...
import static io.zeebe.raft.PollResponseEncoder.termNullValue;

import io.zeebe.raft.BooleanType;
import io.zeebe.raft.PollResponseDecoder;
import io.zeebe.raft.PollResponseEncoder;
import org.agrona.DirectBuffer;
import org.agrona.MutableDirectBuffer;

public class PollResponse extends AbstractRaftMessage implements HasTerm
{
    ...
    public PollResponse setTerm(final int term)
    {
        this.term = term;
        return this;
    }
    ...
    public PollResponse setGranted(final boolean granted)
    {

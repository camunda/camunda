...
public class ElasticsearchArchiverRepository implements ArchiverRepository {
  ...
  public CompletableFuture<ArchiveBatch> getBatchOperationNextBatch() {
    ...
    Function<Throwable, String> errorMessage = t -> format("Exception occurred, while obtaining finished batch operations: %s", t.getMessage());
  ...
  private Either<Throwable, ArchiveBatch> handleSearchResponse(final SearchResponse searchResponse, final Throwable error, Function<Throwable, String> errorMessage) {
    if (error != null) {

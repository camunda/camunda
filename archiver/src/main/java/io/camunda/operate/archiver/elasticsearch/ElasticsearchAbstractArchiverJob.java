...
public abstract class ElasticsearchAbstractArchiverJob implements io.camunda.operate.archiver.ArchiverJob {

  private static final Logger logger = LoggerFactory.getLogger(ElasticsearchAbstractArchiverJob.class);
  ...
  public ElasticsearchAbstractArchiverJob() {

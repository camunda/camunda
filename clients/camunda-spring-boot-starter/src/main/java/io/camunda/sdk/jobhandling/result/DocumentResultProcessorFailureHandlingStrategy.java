 ...
 */
package io.camunda.sdk.jobhandling.result;
...
import io.camunda.sdk.exception.JobError;
import io.camunda.sdk.jobhandling.DocumentContext;
import io.camunda.sdk.jobhandling.JobExceptionHandlingStrategy;
import java.util.Map;
import java.util.function.Function;

/**
 * This handler will be invoked as soon as a job worker result contains a {@link DocumentContext}
 * that fails to upload all documents in a batch.
 */

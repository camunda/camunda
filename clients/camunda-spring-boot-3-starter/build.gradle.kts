...
val springBoot3Version = extra["springBoot3Version"] as String
val spring6Version = extra["spring6Version"] as String

val shadowBaseStarter =
  configurations.create("shadowBaseStarter") {
...
val generateJobWorkerPermutations =
  tasks.register<JavaExec>("generateJobWorkerPermutations") {
    ...
    inputs
      .dir(baseStarterProjectDir.resolve("src/test/test-source-generator"))
...
tasks.named<JavaCompile>("compileTestJava") {
  exclude(
    ...
    "io/camunda/client/spring/actuator/CamundaClientHealthIndicatorTest.java",
  )
}
...
dependencies {
  constraints {
    ...
    api("org.springframework.boot:spring-boot-actuator-autoconfigure:$springBoot3Version")
    ...
    testImplementation("org.springframework.boot:spring-boot-test:$springBoot3Version")
    testImplementation("org.springframework:spring-web:$spring6Version")
...
tasks.named<com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar>("shadowJar") {
  ...
  configurations = listOf(project.configurations.runtimeClasspath.get(), shadowBaseStarter)

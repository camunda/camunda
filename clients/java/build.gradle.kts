...
val compileDiscriminatorTool =
  tasks.register<JavaCompile>("compileDiscriminatorTool") {
...
openApiGenerate {
  ...
  outputDir.set(rawGeneratedOpenApiDir)
  ...
  typeMappings.set(
    mapOf(
      ...
      "ClusterVariableResultBaseMetadataValue" to "Object",
      // OpenAPI Generator 7.21 keeps oneOf wrapper models for these filters; Maven's newer
      // generator collapses them through the metadata value mapping above.
      "AdvancedMetadataValueFilterEq" to "Object",
      "AdvancedMetadataValueFilterNeq" to "Object",
      "ResourceKey" to "String",
      "ScopeKey" to "String",
      "ElementInstanceKey" to "String",
      // map specific filter properties to basic filter types
      "AgentDefinitionKeyFilterProperty" to "BasicStringFilterProperty",

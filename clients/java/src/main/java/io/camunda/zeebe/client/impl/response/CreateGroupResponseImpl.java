...
/** Implementation of the CreateGroupResponse interface. */
public class CreateGroupResponseImpl implements CreateGroupResponse {
  ...
  /**
   * Sets the response for group creation.
   *
   * @param response the response object from the REST API.
   * @return the updated CreateGroupResponseImpl instance.
   */

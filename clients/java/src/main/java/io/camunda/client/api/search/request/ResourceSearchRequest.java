...
public interface ResourceSearchRequest
    extends TypedSearchRequest<ResourceFilter, ResourceSort, AnyPage, ResourceSearchRequest>,
        FinalSearchRequestStep<Resource> {}

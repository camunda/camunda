 ...
 */
@JsonPropertyOrder({
  AdvancedJobStateFilter.JSON_PROPERTY_$_EQ,
  AdvancedJobStateFilter.JSON_PROPERTY_$_NEQ,
  AdvancedJobStateFilter.JSON_PROPERTY_$_EXISTS,
  AdvancedJobStateFilter.JSON_PROPERTY_$_IN,
  AdvancedJobStateFilter.JSON_PROPERTY_$_LIKE
})
...
public class AdvancedJobStateFilter {
  ...
  @javax.annotation.Nullable
  private List<JobStateEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public AdvancedJobStateFilter() {
  }

  public AdvancedJobStateFilter $eq(@javax.annotation.Nullable JobStateEnum $eq) {
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable JobStateEnum $eq) {
    this.$eq = $eq;
  }

  public AdvancedJobStateFilter $neq(@javax.annotation.Nullable JobStateEnum $neq) {
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable JobStateEnum $neq) {
    this.$neq = $neq;
  }

  public AdvancedJobStateFilter $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public AdvancedJobStateFilter $in(@javax.annotation.Nullable List<JobStateEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public AdvancedJobStateFilter add$InItem(JobStateEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<JobStateEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<JobStateEnum> $in) {
    this.$in = $in;
  }

  public AdvancedJobStateFilter $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    AdvancedJobStateFilter advancedJobStateFilter = (AdvancedJobStateFilter) o;
    return Objects.equals(this.$eq, advancedJobStateFilter.$eq) &&
        Objects.equals(this.$neq, advancedJobStateFilter.$neq) &&
        Objects.equals(this.$exists, advancedJobStateFilter.$exists) &&
        Objects.equals(this.$in, advancedJobStateFilter.$in) &&
        Objects.equals(this.$like, advancedJobStateFilter.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdvancedJobStateFilter {\n");

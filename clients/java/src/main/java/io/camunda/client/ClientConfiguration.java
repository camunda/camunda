...
public interface ClientConfiguration<CREDENTIALS_PROVIDER extends CredentialsProvider> {

  /**
   * @deprecated since 8.5 for removal with 8.8, replaced by {@link
   *     ClientConfiguration#getGrpcAddress()}
   ...
   */
  CREDENTIALS_PROVIDER getCredentialsProvider();

...
import static io.camunda.client.api.search.SearchRequestBuilders.variableValueFilter;
import static io.camunda.client.impl.util.CollectionUtil.addValuesToList;
import static io.camunda.client.impl.util.CollectionUtil.toList;

import io.camunda.client.api.search.ProcessInstanceFilter;
import io.camunda.client.api.search.VariableValueFilter;

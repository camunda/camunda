...
public class TenantScopedCreateClusterVariableImpl
  ...
  public TenantScopedCreateClusterVariableImpl(
  ...
  @Override
  public TenantScopedClusterVariableCreationCommandStep1 create(
  ...
  public CamundaFuture<CreateClusterVariableResponse> send() {
    ...
    final String path = "/cluster-variables/tenants/" + tenantId;
    httpClient.post(
        path,

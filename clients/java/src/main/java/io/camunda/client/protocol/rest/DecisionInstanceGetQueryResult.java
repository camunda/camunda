 ...
 */
@JsonPropertyOrder({
  DecisionInstanceGetQueryResult.JSON_PROPERTY_DECISION_INSTANCE_ID,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_STATE,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_EVALUATION_DATE,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_EVALUATION_FAILURE,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_DECISION_DEFINITION_ID,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_DECISION_DEFINITION_NAME,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_DECISION_DEFINITION_VERSION,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_DECISION_DEFINITION_TYPE,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_RESULT,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_TENANT_ID,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_DECISION_INSTANCE_KEY,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_PROCESS_DEFINITION_KEY,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_PROCESS_INSTANCE_KEY,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_DECISION_DEFINITION_KEY,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_ELEMENT_INSTANCE_KEY,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_EVALUATED_INPUTS,
  DecisionInstanceGetQueryResult.JSON_PROPERTY_MATCHED_RULES
})
...
public class DecisionInstanceGetQueryResult {
  ...
  public DecisionInstanceGetQueryResult() {
  }

  public DecisionInstanceGetQueryResult decisionInstanceId(@javax.annotation.Nullable String decisionInstanceId) {
  ...
  public DecisionInstanceGetQueryResult state(@javax.annotation.Nullable DecisionInstanceStateEnum state) {
  ...
  public DecisionInstanceGetQueryResult evaluationDate(@javax.annotation.Nullable OffsetDateTime evaluationDate) {
  ...
  public DecisionInstanceGetQueryResult evaluationFailure(@javax.annotation.Nullable String evaluationFailure) {
  ...
  public DecisionInstanceGetQueryResult decisionDefinitionId(@javax.annotation.Nullable String decisionDefinitionId) {
  ...
  public DecisionInstanceGetQueryResult decisionDefinitionName(@javax.annotation.Nullable String decisionDefinitionName) {
  ...
  public DecisionInstanceGetQueryResult decisionDefinitionVersion(@javax.annotation.Nullable Integer decisionDefinitionVersion) {
  ...
  public DecisionInstanceGetQueryResult decisionDefinitionType(@javax.annotation.Nullable DecisionDefinitionTypeEnum decisionDefinitionType) {
  ...
  public DecisionInstanceGetQueryResult result(@javax.annotation.Nullable String result) {
  ...
  public DecisionInstanceGetQueryResult tenantId(@javax.annotation.Nullable String tenantId) {
  ...
  public DecisionInstanceGetQueryResult decisionInstanceKey(@javax.annotation.Nullable String decisionInstanceKey) {
  ...
  public DecisionInstanceGetQueryResult processDefinitionKey(@javax.annotation.Nullable String processDefinitionKey) {
  ...
  public DecisionInstanceGetQueryResult processInstanceKey(@javax.annotation.Nullable String processInstanceKey) {
  ...
  public DecisionInstanceGetQueryResult decisionDefinitionKey(@javax.annotation.Nullable String decisionDefinitionKey) {
  ...
  public DecisionInstanceGetQueryResult elementInstanceKey(@javax.annotation.Nullable String elementInstanceKey) {
  ...
  public DecisionInstanceGetQueryResult evaluatedInputs(@javax.annotation.Nullable List<EvaluatedDecisionInputItem> evaluatedInputs) {
    
    this.evaluatedInputs = evaluatedInputs;
    return this;
  }

  public DecisionInstanceGetQueryResult addEvaluatedInputsItem(EvaluatedDecisionInputItem evaluatedInputsItem) {
  ...
  public DecisionInstanceGetQueryResult matchedRules(@javax.annotation.Nullable List<MatchedDecisionRuleItem> matchedRules) {
    
    this.matchedRules = matchedRules;
    return this;
  }

  public DecisionInstanceGetQueryResult addMatchedRulesItem(MatchedDecisionRuleItem matchedRulesItem) {
  ...
  public boolean equals(Object o) {
    ...
    DecisionInstanceGetQueryResult decisionInstanceGetQueryResult = (DecisionInstanceGetQueryResult) o;
    return Objects.equals(this.decisionInstanceId, decisionInstanceGetQueryResult.decisionInstanceId) &&
        Objects.equals(this.state, decisionInstanceGetQueryResult.state) &&
        Objects.equals(this.evaluationDate, decisionInstanceGetQueryResult.evaluationDate) &&
        Objects.equals(this.evaluationFailure, decisionInstanceGetQueryResult.evaluationFailure) &&
        Objects.equals(this.decisionDefinitionId, decisionInstanceGetQueryResult.decisionDefinitionId) &&
        Objects.equals(this.decisionDefinitionName, decisionInstanceGetQueryResult.decisionDefinitionName) &&
        Objects.equals(this.decisionDefinitionVersion, decisionInstanceGetQueryResult.decisionDefinitionVersion) &&
        Objects.equals(this.decisionDefinitionType, decisionInstanceGetQueryResult.decisionDefinitionType) &&
        Objects.equals(this.result, decisionInstanceGetQueryResult.result) &&
        Objects.equals(this.tenantId, decisionInstanceGetQueryResult.tenantId) &&
        Objects.equals(this.decisionInstanceKey, decisionInstanceGetQueryResult.decisionInstanceKey) &&
        Objects.equals(this.processDefinitionKey, decisionInstanceGetQueryResult.processDefinitionKey) &&
        Objects.equals(this.processInstanceKey, decisionInstanceGetQueryResult.processInstanceKey) &&
        Objects.equals(this.decisionDefinitionKey, decisionInstanceGetQueryResult.decisionDefinitionKey) &&
        Objects.equals(this.elementInstanceKey, decisionInstanceGetQueryResult.elementInstanceKey) &&
        Objects.equals(this.evaluatedInputs, decisionInstanceGetQueryResult.evaluatedInputs) &&
        Objects.equals(this.matchedRules, decisionInstanceGetQueryResult.matchedRules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(decisionInstanceId, state, evaluationDate, evaluationFailure, decisionDefinitionId, decisionDefinitionName, decisionDefinitionVersion, decisionDefinitionType, result, tenantId, decisionInstanceKey, processDefinitionKey, processInstanceKey, decisionDefinitionKey, elementInstanceKey, evaluatedInputs, matchedRules);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DecisionInstanceGetQueryResult {\n");

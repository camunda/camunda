 ...
 */
@JsonPropertyOrder({
  AdvancedElementInstanceStateFilter.JSON_PROPERTY_$_EQ,
  AdvancedElementInstanceStateFilter.JSON_PROPERTY_$_NEQ,
  AdvancedElementInstanceStateFilter.JSON_PROPERTY_$_EXISTS,
  AdvancedElementInstanceStateFilter.JSON_PROPERTY_$_IN,
  AdvancedElementInstanceStateFilter.JSON_PROPERTY_$_LIKE
})
...
public class AdvancedElementInstanceStateFilter {
  public static final String JSON_PROPERTY_$_EQ = "$eq";
  @javax.annotation.Nullable
  private ElementInstanceStateEnum $eq;

  public static final String JSON_PROPERTY_$_NEQ = "$neq";
  @javax.annotation.Nullable
  private ElementInstanceStateEnum $neq;
  ...
  @javax.annotation.Nullable
  private List<ElementInstanceStateEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public AdvancedElementInstanceStateFilter() {
  }

  public AdvancedElementInstanceStateFilter $eq(@javax.annotation.Nullable ElementInstanceStateEnum $eq) {
  ...
  public ElementInstanceStateEnum get$Eq() {
    return $eq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable ElementInstanceStateEnum $eq) {
    this.$eq = $eq;
  }

  public AdvancedElementInstanceStateFilter $neq(@javax.annotation.Nullable ElementInstanceStateEnum $neq) {
  ...
  public ElementInstanceStateEnum get$Neq() {
    return $neq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable ElementInstanceStateEnum $neq) {
    this.$neq = $neq;
  }

  public AdvancedElementInstanceStateFilter $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public AdvancedElementInstanceStateFilter $in(@javax.annotation.Nullable List<ElementInstanceStateEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public AdvancedElementInstanceStateFilter add$InItem(ElementInstanceStateEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<ElementInstanceStateEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<ElementInstanceStateEnum> $in) {
    this.$in = $in;
  }

  public AdvancedElementInstanceStateFilter $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    AdvancedElementInstanceStateFilter advancedElementInstanceStateFilter = (AdvancedElementInstanceStateFilter) o;
    return Objects.equals(this.$eq, advancedElementInstanceStateFilter.$eq) &&
        Objects.equals(this.$neq, advancedElementInstanceStateFilter.$neq) &&
        Objects.equals(this.$exists, advancedElementInstanceStateFilter.$exists) &&
        Objects.equals(this.$in, advancedElementInstanceStateFilter.$in) &&
        Objects.equals(this.$like, advancedElementInstanceStateFilter.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdvancedElementInstanceStateFilter {\n");

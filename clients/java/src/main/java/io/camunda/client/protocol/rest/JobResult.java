...
public class JobResult {
  ...
  public enum TypeEnum {
    USER_TASK(String.valueOf("userTask")),
    
    AD_HOC_SUB_PROCESS(String.valueOf("adHocSubProcess")),
  ...
  protected TypeEnum type = TypeEnum.USER_TASK;

  public JobResult() {
  }

  public JobResult type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, jobResult.type);
  }

...
public class JobSearchRequestImpl extends TypedSearchRequestPropertyProvider<JobSearchQueryRequest>
    implements JobSearchRequest {

  private final JobSearchQueryRequest request;
  private final JsonMapper jsonMapper;
  private final HttpClient httpClient;
  private final RequestConfig.Builder httpRequestConfig;

  public JobSearchRequestImpl(final HttpClient httpClient, final JsonMapper jsonMapper) {
    request = new JobSearchQueryRequest();
  ...
  @Override
  protected JobSearchQueryRequest getSearchRequestProperty() {
    return request;
  }
}

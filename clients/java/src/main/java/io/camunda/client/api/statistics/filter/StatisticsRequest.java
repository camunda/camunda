...
import io.camunda.client.api.statistics.filter.StatisticsRequest.StatisticsRequestFilter;
import java.util.function.Consumer;

public interface StatisticsRequest<
    F extends StatisticsRequestFilter, SELF extends StatisticsRequest<F, SELF>> {

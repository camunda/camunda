...
public interface CreateGlobalExecutionListenerCommandStep1 {
   ...
   */
  CreateGlobalExecutionListenerCommandStep2 type(String type);

  interface CreateGlobalExecutionListenerCommandStep2 {
     ...
     * @return the next step
     */
    CreateGlobalExecutionListenerCommandStep3 eventTypes(
     ...
     * @return the next step
     */
    CreateGlobalExecutionListenerCommandStep3 eventType(GlobalExecutionListenerEventType eventType);
  }

  interface CreateGlobalExecutionListenerCommandStep3
     ...
     */
    CreateGlobalExecutionListenerCommandStep3 retries(int retries);
     ...
     * @return the builder for chaining
     */
    CreateGlobalExecutionListenerCommandStep3 afterNonGlobal(boolean afterNonGlobal);
     ...
     * @return the builder for chaining
     */
    CreateGlobalExecutionListenerCommandStep3 priority(int priority);
     ...
     * @return the builder for chaining
     */
    CreateGlobalExecutionListenerCommandStep3 elementTypes(
     ...
     * @return the builder for chaining
     */
    CreateGlobalExecutionListenerCommandStep3 categories(

...
public class GlobalExecutionListenerImpl implements GlobalExecutionListener {

  private final String id;
  private final String type;
  private final int retries;
  private final List<GlobalExecutionListenerEventType> eventTypes;
  private final List<GlobalExecutionListenerElementType> elementTypes;
  private final List<GlobalExecutionListenerCategory> categories;
  private final boolean afterNonGlobal;
  private final int priority;
  private final GlobalListenerSource source;

  public GlobalExecutionListenerImpl(final GlobalExecutionListenerResult result) {
    id = result.getId();
    type = result.getType();

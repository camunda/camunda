...
public class UpdateVariableImpl implements VariableUpdateRequestStep1 {
  ...
  public UpdateVariableImpl(final HttpClient httpClient, final JsonMapper jsonMapper) {
  ...
  @Override
  public FinalCommandStep<UpdateVariableResponse> requestTimeout(final Duration requestTimeout) {

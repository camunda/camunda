...
public class IncidentByProcessInstanceKeySearchRequestImpl
  ...
  @Override
  public IncidentByProcessInstanceKeySearchRequest filter(final IncidentFilter value) {
    throw new UnsupportedOperationException(
        "Cannot apply filters for incident search by process instance key");
  }

  @Override
  public IncidentByProcessInstanceKeySearchRequest filter(final Consumer<IncidentFilter> fn) {
    throw new UnsupportedOperationException(
        "Cannot apply filters for incident search by process instance key");
  }

...
public enum BatchOperationTypeEnum {
  ...
  BatchOperationTypeEnum(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static BatchOperationTypeEnum fromValue(String value) {
    for (BatchOperationTypeEnum b : BatchOperationTypeEnum.values()) {

 ...
 */
@JsonPropertyOrder({
  CancelProcessInstanceRequest.JSON_PROPERTY_OPERATION_REFERENCE
})
...
public class CancelProcessInstanceRequest {
  ...
  public CancelProcessInstanceRequest operationReference(@javax.annotation.Nullable Long operationReference) {

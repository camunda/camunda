...
public class ProcessDefinitionInstanceStatisticsRequestImpl
  ...
  @Override
  public ProcessDefinitionInstanceStatisticsRequest page(final OffsetPage value) {
    request.setPage(provideSearchRequestProperty(value));
    return this;
  }

  @Override
  public ProcessDefinitionInstanceStatisticsRequest page(final Consumer<OffsetPage> fn) {

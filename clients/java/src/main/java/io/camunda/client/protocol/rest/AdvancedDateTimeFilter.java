 ...
 */
@JsonPropertyOrder({
  AdvancedDateTimeFilter.JSON_PROPERTY_$_EQ,
  AdvancedDateTimeFilter.JSON_PROPERTY_$_NEQ,
  AdvancedDateTimeFilter.JSON_PROPERTY_$_EXISTS,
  AdvancedDateTimeFilter.JSON_PROPERTY_$_GT,
  AdvancedDateTimeFilter.JSON_PROPERTY_$_GTE,
  AdvancedDateTimeFilter.JSON_PROPERTY_$_LT,
  AdvancedDateTimeFilter.JSON_PROPERTY_$_LTE,
  AdvancedDateTimeFilter.JSON_PROPERTY_$_IN
})
...
public class AdvancedDateTimeFilter {
  ...
  public AdvancedDateTimeFilter $eq(@javax.annotation.Nullable OffsetDateTime $eq) {
  ...
  public AdvancedDateTimeFilter $neq(@javax.annotation.Nullable OffsetDateTime $neq) {
  ...
  public AdvancedDateTimeFilter $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public AdvancedDateTimeFilter $gt(@javax.annotation.Nullable OffsetDateTime $gt) {
  ...
  public AdvancedDateTimeFilter $gte(@javax.annotation.Nullable OffsetDateTime $gte) {
  ...
  public AdvancedDateTimeFilter $lt(@javax.annotation.Nullable OffsetDateTime $lt) {
  ...
  public AdvancedDateTimeFilter $lte(@javax.annotation.Nullable OffsetDateTime $lte) {
  ...
  public AdvancedDateTimeFilter $in(@javax.annotation.Nullable List<OffsetDateTime> $in) {
    
    this.$in = $in;
    return this;
  }

  public AdvancedDateTimeFilter add$InItem(OffsetDateTime $inItem) {
    if (this.$in == null) {
  ...
  public boolean equals(Object o) {
    ...
    AdvancedDateTimeFilter advancedDateTimeFilter = (AdvancedDateTimeFilter) o;
    return Objects.equals(this.$eq, advancedDateTimeFilter.$eq) &&
        Objects.equals(this.$neq, advancedDateTimeFilter.$neq) &&
        Objects.equals(this.$exists, advancedDateTimeFilter.$exists) &&
        Objects.equals(this.$gt, advancedDateTimeFilter.$gt) &&
        Objects.equals(this.$gte, advancedDateTimeFilter.$gte) &&
        Objects.equals(this.$lt, advancedDateTimeFilter.$lt) &&
        Objects.equals(this.$lte, advancedDateTimeFilter.$lte) &&
        Objects.equals(this.$in, advancedDateTimeFilter.$in);
  }

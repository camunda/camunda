...
import io.camunda.client.impl.search.filter.GlobalExecutionListenerFilterImpl;
...
import io.camunda.client.impl.search.sort.GlobalExecutionListenerSortImpl;
...
public final class SearchRequestBuilders {
  ...
  public static GlobalExecutionListenerFilter globalExecutionListenerFilter(
      final Consumer<GlobalExecutionListenerFilter> fn) {
    final GlobalExecutionListenerFilter filter = new GlobalExecutionListenerFilterImpl();
    fn.accept(filter);
    return filter;
  }

  public static GlobalExecutionListenerSort globalExecutionListenerSort(
      final Consumer<GlobalExecutionListenerSort> fn) {
    final GlobalExecutionListenerSort sort = new GlobalExecutionListenerSortImpl();
    fn.accept(sort);
    return sort;
  }
}

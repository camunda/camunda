 ...
 */
@JsonPropertyOrder({
  AdvancedBatchOperationTypeFilter.JSON_PROPERTY_$_EQ,
  AdvancedBatchOperationTypeFilter.JSON_PROPERTY_$_NEQ,
  AdvancedBatchOperationTypeFilter.JSON_PROPERTY_$_EXISTS,
  AdvancedBatchOperationTypeFilter.JSON_PROPERTY_$_IN,
  AdvancedBatchOperationTypeFilter.JSON_PROPERTY_$_LIKE
})
...
public class AdvancedBatchOperationTypeFilter {
  public static final String JSON_PROPERTY_$_EQ = "$eq";
  @javax.annotation.Nullable
  private BatchOperationTypeEnum $eq;

  public static final String JSON_PROPERTY_$_NEQ = "$neq";
  @javax.annotation.Nullable
  private BatchOperationTypeEnum $neq;
  ...
  @javax.annotation.Nullable
  private List<BatchOperationTypeEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public AdvancedBatchOperationTypeFilter() {
  }

  public AdvancedBatchOperationTypeFilter $eq(@javax.annotation.Nullable BatchOperationTypeEnum $eq) {
  ...
  public BatchOperationTypeEnum get$Eq() {
    return $eq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable BatchOperationTypeEnum $eq) {
    this.$eq = $eq;
  }

  public AdvancedBatchOperationTypeFilter $neq(@javax.annotation.Nullable BatchOperationTypeEnum $neq) {
  ...
  public BatchOperationTypeEnum get$Neq() {
    return $neq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable BatchOperationTypeEnum $neq) {
    this.$neq = $neq;
  }

  public AdvancedBatchOperationTypeFilter $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public AdvancedBatchOperationTypeFilter $in(@javax.annotation.Nullable List<BatchOperationTypeEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public AdvancedBatchOperationTypeFilter add$InItem(BatchOperationTypeEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<BatchOperationTypeEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<BatchOperationTypeEnum> $in) {
    this.$in = $in;
  }

  public AdvancedBatchOperationTypeFilter $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    AdvancedBatchOperationTypeFilter advancedBatchOperationTypeFilter = (AdvancedBatchOperationTypeFilter) o;
    return Objects.equals(this.$eq, advancedBatchOperationTypeFilter.$eq) &&
        Objects.equals(this.$neq, advancedBatchOperationTypeFilter.$neq) &&
        Objects.equals(this.$exists, advancedBatchOperationTypeFilter.$exists) &&
        Objects.equals(this.$in, advancedBatchOperationTypeFilter.$in) &&
        Objects.equals(this.$like, advancedBatchOperationTypeFilter.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdvancedBatchOperationTypeFilter {\n");

 ...
 */
@JsonPropertyOrder({
  DeleteResourceRequest.JSON_PROPERTY_OPERATION_REFERENCE
})
...
public class DeleteResourceRequest {
  ...
  public DeleteResourceRequest operationReference(@javax.annotation.Nullable Long operationReference) {

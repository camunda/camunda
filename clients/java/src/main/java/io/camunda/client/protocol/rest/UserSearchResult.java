 ...
 */
@JsonPropertyOrder({
  UserSearchResult.JSON_PROPERTY_ITEMS,
  UserSearchResult.JSON_PROPERTY_PAGE
})
...
public class UserSearchResult {
  ...
  private List<UserResult> items = new ArrayList<>();
  ...
  public UserSearchResult items(@javax.annotation.Nullable List<UserResult> items) {
    
    this.items = items;
    return this;
  }

  public UserSearchResult addItemsItem(UserResult itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@javax.annotation.Nullable List<UserResult> items) {
    this.items = items;
  }

  public UserSearchResult page(@javax.annotation.Nullable SearchQueryPageResponse page) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, userSearchResult.items) &&
        Objects.equals(this.page, userSearchResult.page);
  }

 ...
 */
@JsonPropertyOrder({
  JobSearchQuerySortRequest.JSON_PROPERTY_FIELD,
  JobSearchQuerySortRequest.JSON_PROPERTY_ORDER
})
...
public class JobSearchQuerySortRequest {
  /**
  ...
  public enum FieldEnum {
    ...
    DENIED_REASON(String.valueOf("deniedReason")),
    
    ELEMENT_ID(String.valueOf("elementId")),
    
    ELEMENT_INSTANCE_KEY(String.valueOf("elementInstanceKey")),
    
    END_TIME(String.valueOf("endTime")),
    
    ERROR_CODE(String.valueOf("errorCode")),
    
    ERROR_MESSAGE(String.valueOf("errorMessage")),
    
    HAS_FAILED_WITH_RETRIES_LEFT(String.valueOf("hasFailedWithRetriesLeft")),
    
    IS_DENIED(String.valueOf("isDenied")),
    
    JOB_KEY(String.valueOf("jobKey")),
    
    KIND(String.valueOf("kind")),
    
    LISTENER_EVENT_TYPE(String.valueOf("listenerEventType")),
  ...
  public JobSearchQuerySortRequest() {
  }

  public JobSearchQuerySortRequest field(@javax.annotation.Nonnull FieldEnum field) {
  ...
  public JobSearchQuerySortRequest order(@javax.annotation.Nullable SortOrderEnum order) {
  ...
  public boolean equals(Object o) {
    ...
    JobSearchQuerySortRequest jobSearchQuerySortRequest = (JobSearchQuerySortRequest) o;
    return Objects.equals(this.field, jobSearchQuerySortRequest.field) &&
        Objects.equals(this.order, jobSearchQuerySortRequest.order);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobSearchQuerySortRequest {\n");

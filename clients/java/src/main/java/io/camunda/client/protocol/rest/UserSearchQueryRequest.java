 ...
 */
@JsonPropertyOrder({
  UserSearchQueryRequest.JSON_PROPERTY_SORT,
  UserSearchQueryRequest.JSON_PROPERTY_FILTER,
  UserSearchQueryRequest.JSON_PROPERTY_PAGE
})
...
public class UserSearchQueryRequest {
  ...
  private List<UserSearchQuerySortRequest> sort = new ArrayList<>();
  ...
  public UserSearchQueryRequest sort(@javax.annotation.Nullable List<UserSearchQuerySortRequest> sort) {
  ...
  @JsonProperty(JSON_PROPERTY_SORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSort(@javax.annotation.Nullable List<UserSearchQuerySortRequest> sort) {
    this.sort = sort;
  }

  public UserSearchQueryRequest filter(@javax.annotation.Nullable UserFilter filter) {
  ...
  @JsonProperty(JSON_PROPERTY_FILTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilter(@javax.annotation.Nullable UserFilter filter) {
    this.filter = filter;
  }

  public UserSearchQueryRequest page(@javax.annotation.Nullable SearchQueryPageRequest page) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sort, userSearchQueryRequest.sort) &&
        Objects.equals(this.filter, userSearchQueryRequest.filter) &&
        Objects.equals(this.page, userSearchQueryRequest.page);
  }

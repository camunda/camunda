...
public class ProcessFlowNodeStatisticsImpl implements ProcessElementStatistics {
  ...
  public ProcessFlowNodeStatisticsImpl(final ProcessElementStatisticsResult statistics) {

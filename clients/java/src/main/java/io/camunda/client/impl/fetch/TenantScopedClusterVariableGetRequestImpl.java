...
public class TenantScopedClusterVariableGetRequestImpl
  ...
  public TenantScopedClusterVariableGetRequestImpl(
      final HttpClient httpClient, final String tenantId) {
  ...
  @Override
  public TenantScopedClusterVariableGetRequest requestTimeout(final Duration requestTimeout) {
  ...
  @Override
  public TenantScopedClusterVariableGetRequest withName(final String name) {

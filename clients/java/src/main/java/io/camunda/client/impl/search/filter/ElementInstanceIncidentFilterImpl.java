...
public class ElementInstanceIncidentFilterImpl
  ...
  @Override
  public ElementInstanceIncidentFilter processInstanceKey(final Long value) {
    processDefinitionKey(b -> b.eq(value));
    return this;
  }

  @Override
  public ElementInstanceIncidentFilter processInstanceKey(final Consumer<BasicLongProperty> fn) {
    final BasicLongProperty property = new BasicLongPropertyImpl();
    fn.accept(property);
    filter.processInstanceKey(provideSearchRequestProperty(property));
    return this;
  }

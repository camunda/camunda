...
public class ProcessDefinitionStatisticsFilterImpl
  ...
  @Override
  public ProcessDefinitionStatisticsFilter parentFlowNodeInstanceKey(
  ...
  @Override
  public ProcessDefinitionStatisticsFilter flowNodeId(final String flowNodeId) {
    flowNodeId(b -> b.eq(flowNodeId));
    return this;
  }

  @Override
  public ProcessDefinitionStatisticsFilter flowNodeId(final Consumer<StringProperty> fn) {
    final StringProperty property = new StringPropertyImpl();
    fn.accept(property);
  ...
  @Override
  public ProcessDefinitionStatisticsFilter flowNodeInstanceState(
  ...
  @Override
  public ProcessDefinitionStatisticsFilter hasFlowNodeInstanceIncident(

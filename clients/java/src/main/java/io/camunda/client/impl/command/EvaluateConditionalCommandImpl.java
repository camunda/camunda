...
public final class EvaluateConditionalCommandImpl
    extends CommandWithVariables<EvaluateConditionalCommandImpl>
    implements EvaluateConditionalCommandStep1, EvaluateConditionalCommandStep2 {

  private final GatewayStub asyncStub;
  private final Predicate<StatusCode> retryPredicate;
  private final GatewayOuterClass.ConditionalEvaluationInstruction.Builder grpcRequestObjectBuilder;
  ...
  public EvaluateConditionalCommandImpl(
    ...
    grpcRequestObjectBuilder = GatewayOuterClass.ConditionalEvaluationInstruction.newBuilder();
  ...
  @Override
  protected EvaluateConditionalCommandImpl setVariablesInternal(final String variables) {
  ...
  @Override
  public EvaluateConditionalCommandStep2 withoutProcessDefinitionKey() {
    return this;
  }
  ...
  private CamundaFuture<EvaluateConditionalResponse> sendGrpcRequest() {
    final GatewayOuterClass.ConditionalEvaluationInstruction request =
        grpcRequestObjectBuilder.build();
    final RetriableClientFutureImpl<
            EvaluateConditionalResponse, GatewayOuterClass.EvaluateConditionalResult>
        future =
  ...
  private void sendGrpcRequest(
      final GatewayOuterClass.ConditionalEvaluationInstruction request,
      final StreamObserver<GatewayOuterClass.EvaluateConditionalResult> streamObserver) {
    asyncStub

...
public final class CamundaClientEnvironmentVariables {
  ...
  public static final String OAUTH_ENV_TOKEN_FETCH_MAX_RETRIES =
      "CAMUNDA_AUTH_TOKEN_FETCH_MAX_RETRIES";
  public static final String OAUTH_ENV_TOKEN_FETCH_INITIAL_BACKOFF =
      "CAMUNDA_AUTH_TOKEN_FETCH_INITIAL_BACKOFF_MS";
  public static final String OAUTH_ENV_TOKEN_FETCH_BACKOFF_MULTIPLIER =
      "CAMUNDA_AUTH_TOKEN_FETCH_BACKOFF_MULTIPLIER";
  public static final String OAUTH_ENV_TOKEN_FETCH_RETRYABLE_STATUS_CODES =
      "CAMUNDA_AUTH_TOKEN_FETCH_RETRYABLE_STATUS_CODES";
  public static final String OAUTH_ENV_TOKEN_FETCH_NON_RETRYABLE_COOLDOWN =
      "CAMUNDA_AUTH_TOKEN_FETCH_NON_RETRYABLE_COOLDOWN_MS";

 ...
 */
@JsonPropertyOrder({
  AdvancedJobKindFilter.JSON_PROPERTY_$_EQ,
  AdvancedJobKindFilter.JSON_PROPERTY_$_NEQ,
  AdvancedJobKindFilter.JSON_PROPERTY_$_EXISTS,
  AdvancedJobKindFilter.JSON_PROPERTY_$_IN,
  AdvancedJobKindFilter.JSON_PROPERTY_$_LIKE
})
...
public class AdvancedJobKindFilter {
  ...
  @javax.annotation.Nullable
  private List<JobKindEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public AdvancedJobKindFilter() {
  }

  public AdvancedJobKindFilter $eq(@javax.annotation.Nullable JobKindEnum $eq) {
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable JobKindEnum $eq) {
    this.$eq = $eq;
  }

  public AdvancedJobKindFilter $neq(@javax.annotation.Nullable JobKindEnum $neq) {
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable JobKindEnum $neq) {
    this.$neq = $neq;
  }

  public AdvancedJobKindFilter $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public AdvancedJobKindFilter $in(@javax.annotation.Nullable List<JobKindEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public AdvancedJobKindFilter add$InItem(JobKindEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<JobKindEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<JobKindEnum> $in) {
    this.$in = $in;
  }

  public AdvancedJobKindFilter $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    AdvancedJobKindFilter advancedJobKindFilter = (AdvancedJobKindFilter) o;
    return Objects.equals(this.$eq, advancedJobKindFilter.$eq) &&
        Objects.equals(this.$neq, advancedJobKindFilter.$neq) &&
        Objects.equals(this.$exists, advancedJobKindFilter.$exists) &&
        Objects.equals(this.$in, advancedJobKindFilter.$in) &&
        Objects.equals(this.$like, advancedJobKindFilter.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdvancedJobKindFilter {\n");

...
public final class BatchOperationCreatedResponseImpl implements BatchOperationCreatedResponse {

  private final long batchOperationKey;
  private final BatchOperationType batchOperationType;

  public BatchOperationCreatedResponseImpl(final BatchOperationCreatedResult response) {

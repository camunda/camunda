...
public interface UserTaskFilterBase extends SearchRequestFilter {
   ...
   */
  UserTaskFilterBase userTaskKey(final Long value);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase state(final UserTaskState state);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase state(final Consumer<UserTaskStateProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase assignee(final String assignee);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase assignee(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase businessId(final String businessId);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase businessId(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase priority(final Integer priority);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase priority(final Consumer<IntegerProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase elementId(final String taskDefinitionId);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase name(final String name);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase name(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase tags(final Set<String> tags);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase tags(final String... tags);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase candidateGroup(final String candidateGroup);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase candidateGroup(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase candidateUser(final String candidateUser);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase candidateUser(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase processDefinitionKey(final Long processDefinitionKey);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase processDefinitionKey(final Consumer<BasicLongProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase processInstanceKey(final Long processInstanceKey);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase processInstanceKey(final Consumer<BasicLongProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase tenantId(final String tenantId);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase tenantId(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase bpmnProcessId(final String bpmnProcessId);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase bpmnProcessId(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase processInstanceVariables(
   ...
   * @return the updated filter
   */
  UserTaskFilterBase processInstanceVariables(final Map<String, Object> variableValueFilters);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase localVariables(final List<Consumer<VariableValueFilter>> variableValueFilters);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase localVariables(final Map<String, Object> variableValueFilters);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase elementInstanceKey(final Long elementInstanceKey);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase creationDate(final OffsetDateTime creationDate);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase creationDate(final Consumer<DateTimeProperty> creationDate);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase completionDate(final OffsetDateTime completionDate);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase completionDate(final Consumer<DateTimeProperty> completionDate);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase followUpDate(final OffsetDateTime followUpDate);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase followUpDate(final Consumer<DateTimeProperty> followUpDate);
   ...
   * @return the updated filter
   */
  UserTaskFilterBase dueDate(final OffsetDateTime dueDate);

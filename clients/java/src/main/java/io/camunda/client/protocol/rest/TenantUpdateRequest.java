...
public class TenantUpdateRequest {
  ...
  public TenantUpdateRequest name(@javax.annotation.Nonnull String name) {
  ...
  public TenantUpdateRequest description(@javax.annotation.Nonnull String description) {

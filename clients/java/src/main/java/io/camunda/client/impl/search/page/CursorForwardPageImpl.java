...
/** Implementation of {@link CursorForwardPage} supporting cursor-forward pagination. */
public class CursorForwardPageImpl
    extends TypedSearchRequestPropertyProvider<SearchQueryPageRequest>
    implements CursorForwardPage {

  private final SearchQueryPageRequest page;

  public CursorForwardPageImpl() {

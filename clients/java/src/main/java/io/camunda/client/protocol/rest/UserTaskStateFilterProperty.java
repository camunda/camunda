 ...
 */
@JsonPropertyOrder({
  UserTaskStateFilterProperty.JSON_PROPERTY_$_EQ,
  UserTaskStateFilterProperty.JSON_PROPERTY_$_NEQ,
  UserTaskStateFilterProperty.JSON_PROPERTY_$_EXISTS,
  UserTaskStateFilterProperty.JSON_PROPERTY_$_IN,
  UserTaskStateFilterProperty.JSON_PROPERTY_$_LIKE
})
...
public class UserTaskStateFilterProperty {
  ...
  @javax.annotation.Nullable
  private List<UserTaskStateEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public UserTaskStateFilterProperty() {
  }

  public UserTaskStateFilterProperty $eq(@javax.annotation.Nullable UserTaskStateEnum $eq) {
  ...
  public UserTaskStateEnum get$Eq() {
    return $eq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable UserTaskStateEnum $eq) {
    this.$eq = $eq;
  }

  public UserTaskStateFilterProperty $neq(@javax.annotation.Nullable UserTaskStateEnum $neq) {
  ...
  public UserTaskStateEnum get$Neq() {
    return $neq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable UserTaskStateEnum $neq) {
    this.$neq = $neq;
  }

  public UserTaskStateFilterProperty $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public UserTaskStateFilterProperty $in(@javax.annotation.Nullable List<UserTaskStateEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public UserTaskStateFilterProperty add$InItem(UserTaskStateEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<UserTaskStateEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<UserTaskStateEnum> $in) {
    this.$in = $in;
  }

  public UserTaskStateFilterProperty $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    UserTaskStateFilterProperty userTaskStateFilterProperty = (UserTaskStateFilterProperty) o;
    return Objects.equals(this.$eq, userTaskStateFilterProperty.$eq) &&
        Objects.equals(this.$neq, userTaskStateFilterProperty.$neq) &&
        Objects.equals(this.$exists, userTaskStateFilterProperty.$exists) &&
        Objects.equals(this.$in, userTaskStateFilterProperty.$in) &&
        Objects.equals(this.$like, userTaskStateFilterProperty.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserTaskStateFilterProperty {\n");

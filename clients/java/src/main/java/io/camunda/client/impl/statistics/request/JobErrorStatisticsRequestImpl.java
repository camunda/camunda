...
import io.camunda.client.protocol.rest.JobErrorStatisticsFilter;
...
public class JobErrorStatisticsRequestImpl
  ...
  @Override
  public JobErrorStatisticsRequest page(final java.util.function.Consumer<SearchRequestPage> fn) {

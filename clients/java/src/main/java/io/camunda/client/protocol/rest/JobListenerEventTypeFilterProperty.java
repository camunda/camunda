 ...
 */
@JsonPropertyOrder({
  JobListenerEventTypeFilterProperty.JSON_PROPERTY_$_EQ,
  JobListenerEventTypeFilterProperty.JSON_PROPERTY_$_NEQ,
  JobListenerEventTypeFilterProperty.JSON_PROPERTY_$_EXISTS,
  JobListenerEventTypeFilterProperty.JSON_PROPERTY_$_IN,
  JobListenerEventTypeFilterProperty.JSON_PROPERTY_$_LIKE
})
...
public class JobListenerEventTypeFilterProperty {
  public static final String JSON_PROPERTY_$_EQ = "$eq";
  @javax.annotation.Nullable
  private JobListenerEventTypeEnum $eq;

  public static final String JSON_PROPERTY_$_NEQ = "$neq";
  @javax.annotation.Nullable
  private JobListenerEventTypeEnum $neq;
  ...
  @javax.annotation.Nullable
  private List<JobListenerEventTypeEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public JobListenerEventTypeFilterProperty() {
  }

  public JobListenerEventTypeFilterProperty $eq(@javax.annotation.Nullable JobListenerEventTypeEnum $eq) {
  ...
  public JobListenerEventTypeEnum get$Eq() {
    return $eq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable JobListenerEventTypeEnum $eq) {
    this.$eq = $eq;
  }

  public JobListenerEventTypeFilterProperty $neq(@javax.annotation.Nullable JobListenerEventTypeEnum $neq) {
  ...
  public JobListenerEventTypeEnum get$Neq() {
    return $neq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable JobListenerEventTypeEnum $neq) {
    this.$neq = $neq;
  }

  public JobListenerEventTypeFilterProperty $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public JobListenerEventTypeFilterProperty $in(@javax.annotation.Nullable List<JobListenerEventTypeEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public JobListenerEventTypeFilterProperty add$InItem(JobListenerEventTypeEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<JobListenerEventTypeEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<JobListenerEventTypeEnum> $in) {
    this.$in = $in;
  }

  public JobListenerEventTypeFilterProperty $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    JobListenerEventTypeFilterProperty jobListenerEventTypeFilterProperty = (JobListenerEventTypeFilterProperty) o;
    return Objects.equals(this.$eq, jobListenerEventTypeFilterProperty.$eq) &&
        Objects.equals(this.$neq, jobListenerEventTypeFilterProperty.$neq) &&
        Objects.equals(this.$exists, jobListenerEventTypeFilterProperty.$exists) &&
        Objects.equals(this.$in, jobListenerEventTypeFilterProperty.$in) &&
        Objects.equals(this.$like, jobListenerEventTypeFilterProperty.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobListenerEventTypeFilterProperty {\n");

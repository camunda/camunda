 ...
 */
@JsonPropertyOrder({
  BatchOperationItemStateFilterProperty.JSON_PROPERTY_$_EQ,
  BatchOperationItemStateFilterProperty.JSON_PROPERTY_$_NEQ,
  BatchOperationItemStateFilterProperty.JSON_PROPERTY_$_EXISTS,
  BatchOperationItemStateFilterProperty.JSON_PROPERTY_$_IN,
  BatchOperationItemStateFilterProperty.JSON_PROPERTY_$_LIKE
})
...
public class BatchOperationItemStateFilterProperty {
  public static final String JSON_PROPERTY_$_EQ = "$eq";
  @javax.annotation.Nullable
  private BatchOperationItemStateEnum $eq;

  public static final String JSON_PROPERTY_$_NEQ = "$neq";
  @javax.annotation.Nullable
  private BatchOperationItemStateEnum $neq;
  ...
  @javax.annotation.Nullable
  private List<BatchOperationItemStateEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public BatchOperationItemStateFilterProperty() {
  }

  public BatchOperationItemStateFilterProperty $eq(@javax.annotation.Nullable BatchOperationItemStateEnum $eq) {
  ...
  public BatchOperationItemStateEnum get$Eq() {
    return $eq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable BatchOperationItemStateEnum $eq) {
    this.$eq = $eq;
  }

  public BatchOperationItemStateFilterProperty $neq(@javax.annotation.Nullable BatchOperationItemStateEnum $neq) {
  ...
  public BatchOperationItemStateEnum get$Neq() {
    return $neq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable BatchOperationItemStateEnum $neq) {
    this.$neq = $neq;
  }

  public BatchOperationItemStateFilterProperty $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public BatchOperationItemStateFilterProperty $in(@javax.annotation.Nullable List<BatchOperationItemStateEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public BatchOperationItemStateFilterProperty add$InItem(BatchOperationItemStateEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<BatchOperationItemStateEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<BatchOperationItemStateEnum> $in) {
    this.$in = $in;
  }

  public BatchOperationItemStateFilterProperty $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    BatchOperationItemStateFilterProperty batchOperationItemStateFilterProperty = (BatchOperationItemStateFilterProperty) o;
    return Objects.equals(this.$eq, batchOperationItemStateFilterProperty.$eq) &&
        Objects.equals(this.$neq, batchOperationItemStateFilterProperty.$neq) &&
        Objects.equals(this.$exists, batchOperationItemStateFilterProperty.$exists) &&
        Objects.equals(this.$in, batchOperationItemStateFilterProperty.$in) &&
        Objects.equals(this.$like, batchOperationItemStateFilterProperty.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchOperationItemStateFilterProperty {\n");

...
public class ProcessDefinitionElementStatisticsRequestImpl
  ...
  @Override
  public FinalCommandStep<List<ProcessDefinitionElementStatistics>> requestTimeout(
  ...
  @Override
  public CamundaFuture<List<ProcessDefinitionElementStatistics>> send() {
    final HttpCamundaFuture<List<ProcessDefinitionElementStatistics>> result =

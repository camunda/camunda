...
public interface ProcessInstanceIncidentFilter extends SearchRequestFilter {

  /**
   * Filters incidents by the specified key.
   *
   * @param value the key of the incident
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter incidentKey(final Long value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter incidentKey(final Consumer<BasicLongProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter processDefinitionKey(final Long value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter processDefinitionKey(final Consumer<BasicLongProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter processDefinitionId(final String value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter processDefinitionId(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter errorType(final IncidentErrorType errorType);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter errorType(final Consumer<IncidentErrorTypeProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter errorMessage(final String errorMessage);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter errorMessage(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter elementId(final String value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter elementId(final Consumer<StringProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter elementInstanceKey(final Long value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter elementInstanceKey(final Consumer<BasicLongProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter creationTime(final OffsetDateTime creationTime);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter creationTime(final Consumer<DateTimeProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter state(final IncidentState value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter state(final Consumer<IncidentStateProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter jobKey(final Long value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter jobKey(final Consumer<BasicLongProperty> fn);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter tenantId(final String value);
   ...
   * @return the updated filter
   */
  ProcessInstanceIncidentFilter tenantId(final Consumer<StringProperty> fn);
}

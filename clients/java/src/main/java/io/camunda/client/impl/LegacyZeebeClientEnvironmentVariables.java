...
/**
 * @deprecated since 8.8 for removal in 8.10, replaced by {@link CamundaClientEnvironmentVariables}.
 *     Please see the <a
 ...
 */
@Deprecated
public final class LegacyZeebeClientEnvironmentVariables {
  ...
  public static final String USE_CLIENT_SIDE_LOAD_BALANCING_VAR =
      "ZEEBE_CLIENT_USE_CLIENT_SIDE_LOAD_BALANCING";
  ...
  private LegacyZeebeClientEnvironmentVariables() {}
}

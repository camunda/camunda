 ...
 */
@JsonPropertyOrder({
  BatchOperationStateFilterProperty.JSON_PROPERTY_$_EQ,
  BatchOperationStateFilterProperty.JSON_PROPERTY_$_NEQ,
  BatchOperationStateFilterProperty.JSON_PROPERTY_$_EXISTS,
  BatchOperationStateFilterProperty.JSON_PROPERTY_$_IN,
  BatchOperationStateFilterProperty.JSON_PROPERTY_$_LIKE
})
...
public class BatchOperationStateFilterProperty {
  public static final String JSON_PROPERTY_$_EQ = "$eq";
  @javax.annotation.Nullable
  private BatchOperationStateEnum $eq;

  public static final String JSON_PROPERTY_$_NEQ = "$neq";
  @javax.annotation.Nullable
  private BatchOperationStateEnum $neq;
  ...
  @javax.annotation.Nullable
  private List<BatchOperationStateEnum> $in = new ArrayList<>();

  public static final String JSON_PROPERTY_$_LIKE = "$like";
  @javax.annotation.Nullable
  private String $like;

  public BatchOperationStateFilterProperty() {
  }

  public BatchOperationStateFilterProperty $eq(@javax.annotation.Nullable BatchOperationStateEnum $eq) {
  ...
  public BatchOperationStateEnum get$Eq() {
    return $eq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_EQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Eq(@javax.annotation.Nullable BatchOperationStateEnum $eq) {
    this.$eq = $eq;
  }

  public BatchOperationStateFilterProperty $neq(@javax.annotation.Nullable BatchOperationStateEnum $neq) {
  ...
  public BatchOperationStateEnum get$Neq() {
    return $neq;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_NEQ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$Neq(@javax.annotation.Nullable BatchOperationStateEnum $neq) {
    this.$neq = $neq;
  }

  public BatchOperationStateFilterProperty $exists(@javax.annotation.Nullable Boolean $exists) {
  ...
  public BatchOperationStateFilterProperty $in(@javax.annotation.Nullable List<BatchOperationStateEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public BatchOperationStateFilterProperty add$InItem(BatchOperationStateEnum $inItem) {
    if (this.$in == null) {
  ...
  public List<BatchOperationStateEnum> get$In() {
    return $in;
  }
  ...
  @JsonProperty(JSON_PROPERTY_$_IN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void set$In(@javax.annotation.Nullable List<BatchOperationStateEnum> $in) {
    this.$in = $in;
  }

  public BatchOperationStateFilterProperty $like(@javax.annotation.Nullable String $like) {
  ...
  public boolean equals(Object o) {
    ...
    BatchOperationStateFilterProperty batchOperationStateFilterProperty = (BatchOperationStateFilterProperty) o;
    return Objects.equals(this.$eq, batchOperationStateFilterProperty.$eq) &&
        Objects.equals(this.$neq, batchOperationStateFilterProperty.$neq) &&
        Objects.equals(this.$exists, batchOperationStateFilterProperty.$exists) &&
        Objects.equals(this.$in, batchOperationStateFilterProperty.$in) &&
        Objects.equals(this.$like, batchOperationStateFilterProperty.$like);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchOperationStateFilterProperty {\n");

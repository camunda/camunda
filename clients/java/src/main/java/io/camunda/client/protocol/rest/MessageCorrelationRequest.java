 ...
 */
@JsonPropertyOrder({
  MessageCorrelationRequest.JSON_PROPERTY_NAME,
  MessageCorrelationRequest.JSON_PROPERTY_CORRELATION_KEY,
  MessageCorrelationRequest.JSON_PROPERTY_VARIABLES,
  MessageCorrelationRequest.JSON_PROPERTY_TENANT_ID
})
...
public class MessageCorrelationRequest {
  ...
  public MessageCorrelationRequest name(@javax.annotation.Nullable String name) {
  ...
  public MessageCorrelationRequest correlationKey(@javax.annotation.Nullable String correlationKey) {
  ...
  public MessageCorrelationRequest variables(@javax.annotation.Nullable Map<String, Object> variables) {
  ...
  public MessageCorrelationRequest tenantId(@javax.annotation.Nullable String tenantId) {

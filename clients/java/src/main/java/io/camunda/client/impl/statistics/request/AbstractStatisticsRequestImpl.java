...
import io.camunda.client.impl.fetch.FetchRequestConsistencyPolicy;
...
public abstract class AbstractStatisticsRequestImpl<S, T>
    extends TypedSearchRequestPropertyProvider<S>
  ...
  protected AbstractStatisticsRequestImpl(final RequestConfig.Builder httpRequestConfig) {

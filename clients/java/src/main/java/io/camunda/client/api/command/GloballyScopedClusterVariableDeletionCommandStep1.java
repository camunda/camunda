 ...
 * </pre>
 */
public interface GloballyScopedClusterVariableDeletionCommandStep1
    extends FinalCommandStep<DeleteClusterVariableResponse> {

  /**
   * Specifies the name of the cluster variable to delete.
   *
   * <p>The variable will be deleted only if it exists with the specified name and global scope. If
   ...
   */
  GloballyScopedClusterVariableDeletionCommandStep1 delete(String name);
}

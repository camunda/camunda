...
public final class FlowNodeInstanceImpl implements FlowNodeInstance {
  ...
  private final io.camunda.client.api.search.enums.FlowNodeInstanceResultState state;
  private final String tenantId;
  private final io.camunda.client.api.search.enums.FlowNodeInstanceResultType type;
  ...
  public FlowNodeInstanceImpl(final FlowNodeInstanceResult item) {
    ...
    state =
        EnumUtil.convert(
            item.getState(), io.camunda.client.api.search.enums.FlowNodeInstanceResultState.class);
    tenantId = item.getTenantId();
    type =
        EnumUtil.convert(
            item.getType(), io.camunda.client.api.search.enums.FlowNodeInstanceResultType.class);
  }
  ...
  @Override
  public io.camunda.client.api.search.enums.FlowNodeInstanceResultState getState() {
    return state;
  }
  ...
  @Override
  public io.camunda.client.api.search.enums.FlowNodeInstanceResultType getType() {
    return type;
  }

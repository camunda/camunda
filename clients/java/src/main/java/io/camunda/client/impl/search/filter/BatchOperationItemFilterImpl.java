...
public class BatchOperationItemFilterImpl
  ...
  @Override
  public io.camunda.client.api.search.filter.BatchOperationItemFilter batchOperationId(final Consumer<StringProperty> fn) {
  ...
  @Override
  public io.camunda.client.api.search.filter.BatchOperationItemFilter itemKey(final Consumer<StringProperty> fn) {
    final StringProperty property = new StringPropertyImpl();
    fn.accept(property);
  ...
  @Override
  public io.camunda.client.api.search.filter.BatchOperationItemFilter processInstanceKey(final Consumer<StringProperty> fn) {
    final StringProperty property = new StringPropertyImpl();
    fn.accept(property);

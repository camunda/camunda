...
public class AssignMappingRuleToTenantTest extends ClientRestTest {

  private static final String TENANT_ID = "tenantId";
  private static final String MAPPING_RULE_ID = "mappingRuleId";

  @Test
  void shouldAssignMappingRuleToTenant() {
    // when
    client
  ...
  void shouldRaiseExceptionOnNotFoundTenant() {
    ...
    gatewayService.errorOnRequest(
        REST_API_PATH + "/tenants/" + TENANT_ID + "/mapping-rules/" + MAPPING_RULE_ID,

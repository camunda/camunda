  ...
  public void shouldReceiveAccessTokenFromIdP() throws IOException {
    ...
    final OAuthCredentialsProvider credentialsProvider =
        new OAuthCredentialsProviderBuilder()
            ...
            // WARNING some providers like Keycloak will ignore the key password as input and use
            // only the store password to protect both the key and store itself. If two different
            // passwords are needed, the private key and store will likely need to be generated
            // manually. This *may* cause issues with different keystore PKCS12 implementations, and
            // is why the generators sometimes use only one password.

...
public final class EvaluateConditionalTest extends ClientTest {
  ...
  public void shouldEvaluateConditionalWithoutProcessDefinitionKey() {
    ...
    final EvaluateConditionalResponse response =
        client
            ...
            .withoutProcessDefinitionKey()
            .variables("{\"x\":100}")
            .send()
            .join();

    // then
    final ConditionalEvaluationInstruction request = gatewayService.getLastRequest();
  ...
  public void shouldRaiseExceptionOnError() {
    ...
    gatewayService.errorOnRequest(
        ConditionalEvaluationInstruction.class, () -> new ClientException("Invalid request"));

...
public class QueryProcessInstanceTest extends ClientRestTest {
  ...
  public void shouldSearchProcessInstanceWithFullFilters() {
    ...
    assertThat(filter.getProcessInstanceKey()).isNotNull();
    assertThat(filter.getProcessInstanceKey().get$Eq()).isEqualTo(123L);
    assertThat(filter.getProcessDefinitionId()).isNotNull();
    ...
    assertThat(filter.getProcessDefinitionVersion()).isNotNull();
    ...
    assertThat(filter.getProcessDefinitionKey()).isNotNull();

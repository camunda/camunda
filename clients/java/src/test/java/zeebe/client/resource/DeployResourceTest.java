 ...
 */
package zeebe.client.resource;

import static zeebe.client.util.RecordingGatewayService.deployedDecision;
import static zeebe.client.util.RecordingGatewayService.deployedDecisionRequirements;
import static zeebe.client.util.RecordingGatewayService.deployedForm;
import static zeebe.client.util.RecordingGatewayService.deployedProcess;
import static zeebe.client.util.RecordingGatewayService.deployment;

...
public class ReflectConfigGenerator {
  ...
  public static final String CONFIG_FILE =
      "clients/c8ctl/src/main/resources/META-INF/native-image/io.camunda/c8cli/reflect-config.json";
  ...
  private static ClassReflectionConfig generateClass(final Class<?> clazz) {
    ...
    final var methods =
        Arrays.stream(clazz.getDeclaredMethods())
            .map(ReflectConfigGenerator::generateMethods)
            .toList();

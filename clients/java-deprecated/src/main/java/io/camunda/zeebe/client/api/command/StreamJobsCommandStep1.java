 ...
 *     io.camunda.client.api.command.StreamJobsCommandStep1}. Please see the <a
...
public interface StreamJobsCommandStep1 {
  ...
  /**
   * @deprecated since 8.8 for removal in 8.10, replaced by {@link
   *     io.camunda.client.api.command.StreamJobsCommandStep1.StreamJobsCommandStep2}. Please see
   *     the <a
   *     href="https://docs.camunda.io/docs/8.8/apis-tools/migration-manuals/migrate-to-camunda-java-client/">Camunda
   *     Java Client migration guide</a>.
   */
  ...
  /**
   * @deprecated since 8.8 for removal in 8.10, replaced by {@link
   *     io.camunda.client.api.command.StreamJobsCommandStep1.StreamJobsCommandStep3}. Please see
   *     the <a
   *     href="https://docs.camunda.io/docs/8.8/apis-tools/migration-manuals/migrate-to-camunda-java-client/">Camunda
   *     Java Client migration guide</a>.
   */

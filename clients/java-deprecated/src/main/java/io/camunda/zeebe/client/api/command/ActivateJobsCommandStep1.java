 ...
 *     io.camunda.client.api.command.ActivateJobsCommandStep1}. Please see the <a
...
public interface ActivateJobsCommandStep1
  ...
  /**
   * @deprecated since 8.8 for removal in 8.10, replaced by {@link
   *     io.camunda.client.api.command.ActivateJobsCommandStep1.ActivateJobsCommandStep2}. Please
   *     see the <a
   *     href="https://docs.camunda.io/docs/8.8/apis-tools/migration-manuals/migrate-to-camunda-java-client/">Camunda
   *     Java Client migration guide</a>.
   */
  ...
  /**
   * @deprecated since 8.8 for removal in 8.10, replaced by {@link
   *     io.camunda.client.api.command.ActivateJobsCommandStep1.ActivateJobsCommandStep3}. Please
   *     see the <a
   *     href="https://docs.camunda.io/docs/8.8/apis-tools/migration-manuals/migrate-to-camunda-java-client/">Camunda
   *     Java Client migration guide</a>.
   */

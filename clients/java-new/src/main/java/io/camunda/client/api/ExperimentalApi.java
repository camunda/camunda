 ...
 * rationale, usecase, and so forth, so that the Camunda team may prioritize the process toward
 ...
 *   <li>After Camunda has gained API stability, this annotation can only be added to new API.
 *       Adding it to an existing API is considered API-breaking.
 *   <li>Removing this annotation from an API gives it stable status.
 * </ol>
 *
 * <p>Note: This annotation is intended only for Camunda library code. Users should not attach this

...
/**
 * Emitted when the ZeebeClient is about to close. Typically, during application shutdown, but
 * maybe more often in test case or never if the ZeebeClient is disabled, see {@link

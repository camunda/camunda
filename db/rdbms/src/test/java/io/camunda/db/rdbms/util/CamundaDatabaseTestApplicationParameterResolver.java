...
public class CamundaDatabaseTestApplicationParameterResolver implements ParameterResolver {
  ...
  public Object resolveParameter(final ParameterContext parameterCtx,
    ...
    final String key = CamundaDatabaseTestApplication.class.getName();
    ...
    return store.getOrComputeIfAbsent(key, __ -> testApplication, CamundaDatabaseTestApplication.class);
  }

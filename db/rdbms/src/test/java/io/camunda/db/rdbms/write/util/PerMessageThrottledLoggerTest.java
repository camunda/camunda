...
class PerMessageThrottledLoggerTest {
  ...
  void shouldThrottleRepeatedMessages() {
    ...
    verify(delegate, times(1)).warn("Test message {}", new Object[] {"param1"});
  }
  ...
  void shouldWorkWithInfoLevel() {
    ...
    // then - should only log once
    verify(delegate, times(1)).info("Info message {}", new Object[] {"param1"});
  }
  ...
  void shouldWorkWithErrorLevel() {
    ...
    // then - should only log once
    verify(delegate, times(1)).error("Error message {}", new Object[] {"param1"});
  }
  ...
  void shouldWorkWithDebugLevel() {
    ...
    // then - should only log once
    verify(delegate, times(1)).debug("Debug message {}", new Object[] {"param1"});
  }
  ...
  void shouldHandleMessagesWithNoParameters() {
    ...
    // then - should only log once
    verify(delegate, times(1)).warn("Simple message", new Object[] {});
  }
  ...
  void shouldHandleMessagesWithMultipleParameters() {
    ...
    verify(delegate, times(1)).warn("Message {} and {} and {}", new Object[] {"a", "b", "c"});
  }
}

...
public class CamundaDatabaseTestApplication implements ExtensionContext.Store.CloseableResource {
  ...
  private CamundaDatabaseTestApplication(final CamundaDatabaseTestApplicationBuilder applicationBuilder) {
  ...
  public CamundaDatabaseTestApplication withDatabaseContainer(final GenericContainer<?> databaseContainer) {
  ...
  public static class CamundaDatabaseTestApplicationBuilder {
    ...
    private final Map<String, Object> properties = new HashMap<>(
        Map.of("spring.liquibase.enabled", "false")
    );

    public CamundaDatabaseTestApplicationBuilder() {
      applicationBuilder = new SpringApplicationBuilder()
    ...
    public CamundaDatabaseTestApplicationBuilder withConfiguration(final Class<?>... configurations) {
      this.configurations = configurations;
      return this;
    }

    public CamundaDatabaseTestApplicationBuilder withProperty(final String propertyKey, final String value) {

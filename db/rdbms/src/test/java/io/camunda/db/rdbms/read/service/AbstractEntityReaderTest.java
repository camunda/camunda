...
class AbstractEntityReaderTest {
  ...
  void convertWithSearchAfter() {
    ...
    final SearchQueryPage page = new SearchQueryPage(0, 10, result.firstSortValues(), null);
  ...
  void convertWithSearchBefore() {
    ...
    final SearchQueryPage page = new SearchQueryPage(0, 10, null, result.firstSortValues());

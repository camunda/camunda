...
public record JobMetricsDbModel(
    String key,
  ...
  public static class Builder implements ObjectBuilder<JobMetricsDbModel> {
    ...
    public Builder key(final long batchRecordKey, final int incrementedInt) {
      key = batchRecordKey + "_" + incrementedInt;
      return this;
    }
    ...
    @Override
    public JobMetricsDbModel build() {
      return new JobMetricsDbModel(
          key,
          startTime,
          endTime,
          tenantId,

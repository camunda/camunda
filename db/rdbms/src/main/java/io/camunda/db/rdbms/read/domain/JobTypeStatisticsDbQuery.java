...
public record JobTypeStatisticsDbQuery(
  ...
  public static JobTypeStatisticsDbQuery of(
      final Function<JobTypeStatisticsDbQuery.Builder, ObjectBuilder<JobTypeStatisticsDbQuery>> fn) {
  ...
  public static final class Builder implements ObjectBuilder<JobTypeStatisticsDbQuery> {
    ...
    public Builder page(final SearchQueryPage value) {
      page = DbQueryPage.from(value);
      return this;
    }

    @Override
    public JobTypeStatisticsDbQuery build() {
      filter = Objects.requireNonNullElse(filter, FilterBuilders.jobTypeStatistics().build());
      authorizedTenantIds = Objects.requireNonNullElse(authorizedTenantIds, Collections.emptyList());
      page = Objects.requireNonNullElse(page, DbQueryPage.empty());

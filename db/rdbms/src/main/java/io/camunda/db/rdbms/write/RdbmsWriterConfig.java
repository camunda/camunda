...
public record RdbmsWriterConfig(
    ...
    boolean exportPendingBatchOperationItems) {
  ...
  public static final boolean DEFAULT_EXPORT_PENDING_BATCH_OPERATION_ITEMS = true;
  ...
  public static class Builder implements ObjectBuilder<RdbmsWriterConfig> {
    ...
    private boolean exportPendingBatchOperationItems = DEFAULT_EXPORT_PENDING_BATCH_OPERATION_ITEMS;
    ...
    public Builder exportPendingBatchOperationItems(
        final boolean exportPendingBatchOperationItems) {
      this.exportPendingBatchOperationItems = exportPendingBatchOperationItems;
      return this;
    }
    ...
    public RdbmsWriterConfig build() {
      return new RdbmsWriterConfig(
          ...
          exportPendingBatchOperationItems);
    }
  }
}

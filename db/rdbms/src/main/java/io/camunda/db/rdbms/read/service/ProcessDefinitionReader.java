...
public class ProcessDefinitionReader extends AbstractEntityReader<ProcessDefinitionEntity> {
  ...
  public List<ProcessDefinitionFlowNodeStatisticsEntity> statistics(
      final ProcessDefinitionStatisticsFilter filter) {
    LOG.trace("[RDBMS DB] Query process definition statistics with filter {}", filter);
    return processDefinitionMapper.statistics(filter);
  }
}

...
import io.camunda.db.rdbms.write.service.MetricsCleanupService;
...
public class RdbmsWriter {
  ...
  public RdbmsWriter(
    ...
    historyCleanupService =
        new HistoryCleanupService(
            ...
            sequenceFlowWriter,
            metrics);
    metricsCleanupService = new MetricsCleanupService(config, usageMetricWriter, metrics);
  }
  ...
  public MetricsCleanupService getMetricsCleanupService() {

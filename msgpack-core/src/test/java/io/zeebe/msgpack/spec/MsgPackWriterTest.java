...
public class MsgPackWriterTest
{
    ...
    public static Iterable<Object[]> data()
    {
        return Arrays.asList(new Object[][] {
            ...
            {
                "fixmap",
                actual((w) -> w.writeMapHeader(15)),
                expect((b) -> b.add(0x8f))
            },
            {
                "fixarray",
                actual((w) -> w.writeArrayHeader(15)),
                expect((b) -> b.add(0x9f))
            },
            {
                "fixstr",
            ...
            {
                "false",
                actual((w) -> w.writeBoolean(false)),
                expect((b) -> b.add(0xc2))
            },
            {
                "true",
                actual((w) -> w.writeBoolean(true)),
                expect((b) -> b.add(0xc3))
            },
            {
                "bin 8",
                actual((w) -> w.writeBinaryHeader(0xff)),
                expect((b) -> b.add(0xc4, 0xff))
            },
            {
                "bin 8 with data",
            ...
            {
                "str 8",
                actual((w) -> w.writeStringHeader(0xff)),
                expect((b) -> b.add(0xd9, 0xff))
            },
            {
                "str 8 with data",

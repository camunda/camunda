...
public class MsgPackSkippingTest
{
    ...
    public static Iterable<Object[]> data()
    {
        return Arrays.asList(new Object[][] {
            ...
            {
                "fixmap",
                given((b) -> b.add(0x81, 0xc0, 0xc0)) // map entry: nil => nil
            },
            {
                "fixarray",
                given((b) -> b.add(0x91, 0xc0)) // array entry: nil
            },
            {
                "fixstr",
                given((b) -> b.add(0xa3).add(utf8("foo")))
            },
            {
                "nil",
                given((b) -> b.add(0xc0))
            ...
            {
                "bin 8",
                given((b) -> b.add(0xc4, 0x01, 0xff)) // length 1
            },
            {
                "bin 16",
                given((b) -> b.add(0xc5, 0x00, 0x01, 0xff)) // length 1
            },
            {
                "bin 32",
                given((b) -> b.add(0xc6, 0x00, 0x00, 0x00, 0x01, 0xff)) // length 1
            },
            {
                "ext 8",
                given((b) -> b.add(0xc7, 0x01, 0x00, 0xff)) // length 1
            },
            {
                "ext 16",
                given((b) -> b.add(0xc8, 0x00, 0x01, 0x00, 0xff)) // length 1
            },
            {
                "ext 32",
                given((b) -> b.add(0xc9, 0x00, 0x00, 0x00, 0x01, 0x00, 0xff)) // length 1
            },
            {
                "float 32",
            ...
            {
                "fixext 1",
                given((b) -> b.add(0xd4, 0x00, 0xff))
            },
            {
                "fixext 2",
                given((b) -> b.add(0xd5, 0x00, 0xff, 0xff))
            },
            {
                "fixext 4",
                given((b) -> b.add(0xd6, 0x00, 0xff, 0xff, 0xff, 0xff))
            },
            {
                "fixext 8",
                given((b) -> b.add(0xd7, 0x00).add(new byte[8]))
            },
            {
                "fixext 16",
                given((b) -> b.add(0xd8, 0x00).add(new byte[16]))
            },
            {
                "str 8",
                given((b) -> b.add(0xd9, 0x01, 0xff)) // length 1
            },
            {
                "str 16",
                given((b) -> b.add(0xda, 0x00, 0x01, 0xff)) // length 1
            },
            {
                "str 32",
                given((b) -> b.add(0xdb, 0x00, 0x00, 0x00, 0x01, 0xff)) // length 1
            },
            {
                "array 16",
                given((b) -> b.add(0xdc, 0x00, 0x01, 0xc0)) // length 1, value nil
            },
            {
                "array 32",
            ...
            {
                "map 32",
                given((b) -> b.add(0xdf, 0x00, 0x00, 0x00, 0x01, 0xc0, 0xc0)) // length 1, value nil => nil
            },
            {
                "negative fixint",
                given((b) -> b.add(0xe0))

...
import org.camunda.optimize.upgrade.migrate34To35.dtos.FlowNodeInstanceDtoOld;
import org.camunda.optimize.upgrade.migrate34To35.dtos.ProcessInstanceDtoOld;
import org.camunda.optimize.upgrade.migrate34To35.dtos.UserTaskInstanceDtoOld;
...
public class ProcessInstanceIndexV6Old extends DefaultIndexMappingCreator implements DefinitionBasedType, InstanceType {

  public static final int VERSION = 6;

  public static final String START_DATE = ProcessInstanceDtoOld.Fields.startDate;
  public static final String END_DATE = ProcessInstanceDtoOld.Fields.endDate;
  public static final String DURATION = ProcessInstanceDtoOld.Fields.duration;
  public static final String PROCESS_DEFINITION_KEY = ProcessInstanceDtoOld.Fields.processDefinitionKey;
  public static final String PROCESS_DEFINITION_VERSION = ProcessInstanceDtoOld.Fields.processDefinitionVersion;
  public static final String PROCESS_DEFINITION_ID = ProcessInstanceDtoOld.Fields.processDefinitionId;
  public static final String PROCESS_INSTANCE_ID = ProcessInstanceDtoOld.Fields.processInstanceId;
  public static final String BUSINESS_KEY = ProcessInstanceDtoOld.Fields.businessKey;
  public static final String STATE = ProcessInstanceDtoOld.Fields.state;

  public static final String EVENTS = ProcessInstanceDtoOld.Fields.events;
  public static final String EVENT_ID = FlowNodeInstanceDtoOld.Fields.id;
  public static final String ACTIVITY_ID = FlowNodeInstanceDtoOld.Fields.activityId;
  public static final String ACTIVITY_TYPE = FlowNodeInstanceDtoOld.Fields.activityType;
  ...
  public static final String PROCESS_INSTANCE_ID_FOR_ACTIVITY = FlowNodeInstanceDtoOld.Fields.processInstanceId;
  public static final String ACTIVITY_DURATION = FlowNodeInstanceDtoOld.Fields.durationInMs;
  public static final String ACTIVITY_START_DATE = FlowNodeInstanceDtoOld.Fields.startDate;
  public static final String ACTIVITY_END_DATE = FlowNodeInstanceDtoOld.Fields.endDate;
  public static final String ACTIVITY_CANCELED = FlowNodeInstanceDtoOld.Fields.canceled;

  public static final String VARIABLES = ProcessInstanceDtoOld.Fields.variables;
  ...
  public static final String USER_TASKS = ProcessInstanceDtoOld.Fields.userTasks;
  public static final String USER_TASK_ID = UserTaskInstanceDtoOld.Fields.id;

  public static final String USER_TASK_ACTIVITY_ID = UserTaskInstanceDtoOld.Fields.activityId;
  public static final String USER_TASK_ACTIVITY_INSTANCE_ID = UserTaskInstanceDtoOld.Fields.activityInstanceId;

  public static final String USER_TASK_TOTAL_DURATION = UserTaskInstanceDtoOld.Fields.totalDurationInMs;
  public static final String USER_TASK_IDLE_DURATION = UserTaskInstanceDtoOld.Fields.idleDurationInMs;
  public static final String USER_TASK_WORK_DURATION = UserTaskInstanceDtoOld.Fields.workDurationInMs;

  public static final String USER_TASK_START_DATE = UserTaskInstanceDtoOld.Fields.startDate;
  public static final String USER_TASK_END_DATE = UserTaskInstanceDtoOld.Fields.endDate;
  public static final String USER_TASK_DUE_DATE = UserTaskInstanceDtoOld.Fields.dueDate;

  public static final String USER_TASK_ASSIGNEE = UserTaskInstanceDtoOld.Fields.assignee;
  public static final String USER_TASK_CANDIDATE_GROUPS = UserTaskInstanceDtoOld.Fields.candidateGroups;
  public static final String USER_TASK_ASSIGNEE_OPERATIONS = UserTaskInstanceDtoOld.Fields.assigneeOperations;
  public static final String USER_TASK_CANDIDATE_GROUP_OPERATIONS =
    UserTaskInstanceDtoOld.Fields.candidateGroupOperations;

  public static final String USER_TASK_DELETE_REASON = UserTaskInstanceDtoOld.Fields.deleteReason;
  public static final String USER_TASK_CANCELED = UserTaskInstanceDtoOld.Fields.canceled;

  public static final String ENGINE = ProcessInstanceDtoOld.Fields.engine;
  public static final String TENANT_ID = ProcessInstanceDtoOld.Fields.tenantId;
  ...
  public static final String INCIDENTS = ProcessInstanceDtoOld.Fields.incidents;
  ...
  public ProcessInstanceIndexV6Old(final String instanceIndexKey) {

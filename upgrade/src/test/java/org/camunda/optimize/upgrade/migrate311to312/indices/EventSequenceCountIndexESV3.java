 ...
 */
package org.camunda.optimize.upgrade.migrate311to312.indices;
...
public class EventSequenceCountIndexESV3 extends DefaultIndexMappingCreator<XContentBuilder> {
  ...
  public EventSequenceCountIndexESV3(final String indexKey) {
    this.indexName = constructIndexName(indexKey);
  }

  @Override
  public XContentBuilder addStaticSetting(final String key, final int value, final XContentBuilder contentBuilder) throws
                                                                                                                   IOException {

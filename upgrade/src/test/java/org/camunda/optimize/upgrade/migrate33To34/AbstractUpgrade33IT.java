...
public class AbstractUpgrade33IT extends AbstractUpgradeIT {
  ...
  protected static final String EVENT_PROCESS_INSTANCE_INDEX_ID_1 = "someId";
  protected static final String EVENT_PROCESS_INSTANCE_INDEX_ID_2 = "otherId";
  ...
  protected static final ProcessInstanceIndexV5Old PROCESS_INSTANCE_INDEX = new ProcessInstanceIndexV5Old();
  protected static final EventProcessInstanceIndexV5Old EVENT_PROCESS_INSTANCE_INDEX_1 =
    new EventProcessInstanceIndexV5Old(EVENT_PROCESS_INSTANCE_INDEX_ID_1);
  protected static final EventProcessInstanceIndexV5Old EVENT_PROCESS_INSTANCE_INDEX_2 =
    new EventProcessInstanceIndexV5Old(EVENT_PROCESS_INSTANCE_INDEX_ID_2);
  ...
  protected void setUp() throws Exception {
    ...
    initSchema(
      Arrays.asList(
        ...
        EVENT_PROCESS_INSTANCE_INDEX_1,
        EVENT_PROCESS_INSTANCE_INDEX_2
      )
    );

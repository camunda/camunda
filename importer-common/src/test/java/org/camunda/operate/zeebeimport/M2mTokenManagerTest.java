...
import static org.camunda.operate.zeebeimport.M2mTokenManager.FIELD_NAME_ACCESS_TOKEN;
import static org.camunda.operate.zeebeimport.M2mTokenManager.FIELD_NAME_AUDIENCE;
import static org.camunda.operate.zeebeimport.M2mTokenManager.FIELD_NAME_CLIENT_ID;
import static org.camunda.operate.zeebeimport.M2mTokenManager.FIELD_NAME_CLIENT_SECRET;
import static org.camunda.operate.zeebeimport.M2mTokenManager.FIELD_NAME_GRANT_TYPE;
import static org.camunda.operate.zeebeimport.M2mTokenManager.GRANT_TYPE_VALUE;
...
@SpringBootTest(
    ...
    properties = {
        "camunda.operate.auth0.domain=" + M2mTokenManagerTest.AUTH0_DOMAIN,
        "camunda.operate.auth0.m2mClientId=" + M2mTokenManagerTest.M2M_CLIENT_ID,
        "camunda.operate.auth0.m2mClientSecret=" + M2mTokenManagerTest.M2M_CLIENT_SECRET,
        "camunda.operate.auth0.m2mAudience=" + M2mTokenManagerTest.M2M_AUDIENCE,
    }
)
public class M2mTokenManagerTest {

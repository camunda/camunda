...
| `SessionStorePort`                      | `SessionStoreAdapter` and `PhysicalTenantScopedSessionStorePortProvider` (`authentication`)                                                                   |
| `SecurityPathPort`                      | `SecurityPathAdapter` (`authentication`)                                                                                                                      |
| `ResourceAccessProvider` (`core.authz`) | `DefaultResourceAccessProvider` (`search-client-query-transformer`) · `PhysicalTenantResourceAccessProvider` (`authentication`)                               |

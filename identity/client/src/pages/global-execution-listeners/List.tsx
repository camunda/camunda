...
import type { ExecutionListenerEventType } from "src/pages/global-execution-listeners/utility";
...
const List: FC = () => {
  ...
  const transformedData = globalExecutionListeners?.items.map((listener) => ({
    ...
    eventTypes: getEventTypeLabels(
      listener.eventTypes as ExecutionListenerEventType[],
      t,
    ),
    categories: getCategoryLabels(listener.categories ?? [], t),

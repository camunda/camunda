...
const ForbiddenComponent: FC = () => {
  ...
  return (
      <ErrorPage title={<Translate>403 - You do not have access to this component</Translate>}>
        <Translate>
          It looks like you don't have the necessary permissions to access this component. Please contact your cluster admin to get access.
        </Translate>
        <Link href="">

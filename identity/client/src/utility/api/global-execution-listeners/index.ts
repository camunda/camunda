...
import { globalExecutionListenerEventTypeSchema } from "@camunda/camunda-api-zod-schemas/8.9";
import {
  ApiDefinition,
  apiDelete,
  apiPost,
...
export const LISTENER_EXECUTION_EVENT_TYPES: GlobalExecutionListenerEventType[] =
  [...globalExecutionListenerEventTypeSchema.options];

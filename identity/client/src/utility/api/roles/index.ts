...
> = (params) => {
  ...
  return apiPost(`${ROLES_ENDPOINT}/${encodeURIComponent(roleId)}/mapping-rules/search`, body);
};
...
> = ({ roleId, mappingRuleId }) => {
  return apiPut(`${ROLES_ENDPOINT}/${encodeURIComponent(roleId)}/mapping-rules/${encodeURIComponent(mappingRuleId)}`);
};
...
export const unassignRoleMappingRule: ApiDefinition<
  ...
  Pick<Role, "roleId"> & Pick<MappingRule, "mappingRuleId">
> = ({ roleId, mappingRuleId }) =>
  apiDelete(`${ROLES_ENDPOINT}/${encodeURIComponent(roleId)}/mapping-rules/${encodeURIComponent(mappingRuleId)}`);
...
> = ({ roleId, ...body }) =>
  apiPost(`${ROLES_ENDPOINT}/${encodeURIComponent(roleId)}/groups/search`, body);
...
> = (args) => {
  ...
  return apiPost(`${ROLES_ENDPOINT}/${encodeURIComponent(roleId)}/clients/search`, body);
};
...
> = ({ roleId, clientId }) => {
  return apiPut(`${ROLES_ENDPOINT}/${encodeURIComponent(roleId)}/clients/${encodeURIComponent(clientId)}`);
};
...
export const unassignRoleClient: ApiDefinition<
  ...
  Pick<Role, "roleId"> & Pick<TenantClient, "clientId">
> = ({ roleId, clientId }) =>
  apiDelete(`${ROLES_ENDPOINT}/${encodeURIComponent(roleId)}/clients/${encodeURIComponent(clientId)}`);

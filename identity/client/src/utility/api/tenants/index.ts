...
> = ({ tenantId, name, description }) =>
  apiPatch(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}`, { name, description });

export const deleteTenant: ApiDefinition<
  undefined,
  Pick<Tenant, "tenantId">
> = ({ tenantId }) => apiDelete(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}`);
...
> = ({ tenantId, ...body }) =>
  apiPost(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/groups/search`, body);

export const assignTenantGroup: ApiDefinition<
  undefined,
  Pick<Tenant, "tenantId"> & Pick<Group, "groupId">
> = ({ tenantId, groupId }) => {
  return apiPut(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/groups/${encodeURIComponent(groupId)}`);
};
...
export const unassignTenantGroup: ApiDefinition<
  ...
  Pick<Tenant, "tenantId"> & Pick<Group, "groupId">
> = ({ tenantId, groupId }) =>
  apiDelete(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/groups/${encodeURIComponent(groupId)}`);
...
> = ({ tenantId, ...body }) =>
  apiPost(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/roles/search`, body);

export const assignTenantRole: ApiDefinition<
  undefined,
  Pick<Tenant, "tenantId"> & Pick<Role, "roleId">
> = ({ tenantId, roleId }) => {
  return apiPut(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/roles/${encodeURIComponent(roleId)}`);
};
...
export const unassignTenantRole: ApiDefinition<
  ...
  Pick<Tenant, "tenantId"> & Pick<Role, "roleId">
> = ({ tenantId, roleId }) =>
  apiDelete(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/roles/${encodeURIComponent(roleId)}`);
...
> = (params) => {
  ...
  return apiPost(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/mapping-rules/search`, body);
};
...
export const unassignTenantMappingRule: ApiDefinition<
  ...
  Pick<Tenant, "tenantId"> & Pick<MappingRule, "mappingRuleId">
> = ({ tenantId, mappingRuleId }) =>
  apiDelete(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/mapping-rules/${encodeURIComponent(mappingRuleId)}`);

export const getClientsByTenantId: ApiDefinition<
  QueryClientsByTenantResponseBody,
  QueryClientsByTenantRequestBody & Pick<Tenant, "tenantId">
> = ({ tenantId, ...body }) =>
  apiPost(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/clients/search`, body);

export const assignTenantClient: ApiDefinition<
  undefined,
  Pick<Tenant, "tenantId"> & { clientId: string }
> = ({ tenantId, clientId, ...body }) => {
  return apiPut(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/clients/${encodeURIComponent(clientId)}`, body);
};
...
export const unassignTenantClient: ApiDefinition<
  ...
  Pick<Tenant, "tenantId"> & { clientId: string }
> = ({ tenantId, clientId }) =>
  apiDelete(`${TENANTS_ENDPOINT}/${encodeURIComponent(tenantId)}/clients/${encodeURIComponent(clientId)}`);

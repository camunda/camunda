...
export class MappingRulesPage {
  ...
  constructor(page: Page) {
    ...
    this.editMappingRuleButton = (rowName) =>
      this.mappingRulesList.getByRole("row", { name: rowName }).getByLabel(/edit/i);
    this.deleteMappingRuleButton = (rowName) =>
      this.mappingRulesList
        .getByRole("row", { name: rowName })
        .getByLabel("Delete");

    // Create a mapping rule modal
    ...
    // Edit mapping rule modal
    this.editMappingRuleModal = page.getByRole("dialog", { name: /edit mapping rule/i });
    this.closeEditMappingModal = this.editMappingRuleModal.getByRole("button", {
      name: "Close",
    });
    ...
    this.editMappingRuleModalUpdateButton = this.editMappingRuleModal.getByRole(
      "button",
      {
        name: /update mapping rule/i,
      },
    );

    // Delete a mapping rule modal
    this.deleteMappingRuleModal = page.getByRole("dialog", {
      name: /delete mapping rule/i,
    });

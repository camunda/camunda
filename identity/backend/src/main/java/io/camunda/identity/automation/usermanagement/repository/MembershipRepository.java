...
import io.camunda.identity.automation.usermanagement.model.Membership;
...
public interface MembershipRepository extends JpaRepository<Membership, Long> {
  ...
  @Query(
      value =
          "select new io.camunda.identity.automation.usermanagement.CamundaGroup(gm.group.id, gm.group.name)"
              + " from Membership gm"

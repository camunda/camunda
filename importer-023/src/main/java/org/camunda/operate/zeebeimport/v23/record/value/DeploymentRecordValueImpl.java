 ...
 */
package org.camunda.operate.zeebeimport.v23.record.value;

import java.util.Arrays;
import java.util.List;
import java.util.Objects;
import org.camunda.operate.zeebeimport.v23.record.value.deployment.DeployedWorkflowImpl;
import org.camunda.operate.zeebeimport.v23.record.value.deployment.DeploymentResourceImpl;

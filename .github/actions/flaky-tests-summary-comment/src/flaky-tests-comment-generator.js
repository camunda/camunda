...
async function main(context, github, currentData, prNumber, branchName, runAttempt) {
  ...
  const mergedData = helpers.mergeFlakyData(currentData, historicalData, runAttempt);

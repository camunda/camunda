...
Optional:
  ...
  FLAMEGRAPH_LINKS    Pre-rendered Slack mrkdwn links to this run's flamegraph artifacts (e.g.
                      "<url|name> · <url|name>"), built by the `List flamegraph artifacts` step
                      in the calling job via actions/github-script + listWorkflowRunArtifacts.
                      Empty or unset omits the flamegraphs line.
"""
import json
import os
import socket

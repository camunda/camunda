...
class Tracking {
  ...
  #isTrackingSupported = () => {
    return (
      !import.meta.env.DEV &&
      ['prod', 'int', 'dev'].includes(getStage(window.location.host)) &&

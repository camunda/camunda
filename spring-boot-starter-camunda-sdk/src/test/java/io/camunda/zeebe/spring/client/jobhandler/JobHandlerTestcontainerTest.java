...
import io.camunda.zeebe.spring.test.testcontainer.ZeebeSpringTest;
...
@SpringBootTest(
    classes = {
      JobHandlerTestcontainerTest.class,
      JobHandlerTestcontainerTest.TestMetricsConfiguration.class,
      JobHandlerTestcontainerTest.ZeebeCustomizerDisableWorkerConfiguration.class
    },
    properties = {"zeebe.client.worker.default-type=DefaultType"})
@ZeebeSpringTest
public class JobHandlerTestcontainerTest {
  ...
  private static JobHandlerTestcontainerTest.ComplexTypeDTO test6ComplexTypeDTO = null;
    ...
    Assertions.assertTrue(
        jobWorkerManager
            .findJobWorkerConfigByName(
                "io.camunda.zeebe.spring.client.jobhandler.JobHandlerTestcontainerTest.ORIGINAL#handleTest2")
            .isPresent());
  }
  ...
  public void handleTest6(
      ...
      @Variable final JobHandlerTestcontainerTest.ComplexTypeDTO dto,
  ...
  void testShouldDeserializeComplexTypeZebeeVariable() {
    ...
    assertNotEquals(new JobHandlerTestcontainerTest.ComplexTypeDTO(), test6ComplexTypeDTO);

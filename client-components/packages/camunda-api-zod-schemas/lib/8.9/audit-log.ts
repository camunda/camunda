...
const auditLogSchema = z.object({
	...
	entityKey: z.string(),
	entityType: auditLogEntityTypeSchema.nullable(),
	...
	timestamp: z.string(),
	actorId: z.string(),
	actorType: auditLogActorTypeSchema.nullable(),
	tenantId: z.string().nullable(),
	result: auditLogResultSchema.nullable(),
	annotation: z.string().nullable(),
	category: auditLogCategorySchema.nullable(),

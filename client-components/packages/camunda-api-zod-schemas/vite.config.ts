  ...
  build: {
    lib: {
      entry: {
        ...
        "8.8/ad-hoc-sub-process": resolve(
          __dirname,
          "lib/8.8/ad-hoc-sub-process.ts",
        ),
        ...
        "8.8/decision-definition": resolve(
          __dirname,
          "lib/8.8/decision-definition.ts",
        ),
        "8.8/decision-instance": resolve(
          __dirname,
          "lib/8.8/decision-instance.ts",
        ),
        "8.8/decision-requirements": resolve(
          __dirname,
          "lib/8.8/decision-requirements.ts",
        ),
        "8.8/document": resolve(__dirname, "lib/8.8/document.ts"),
        "8.8/element-instance": resolve(
          __dirname,
          "lib/8.8/element-instance.ts",
        ),
        ...
        "8.8/process-definition": resolve(
          __dirname,
          "lib/8.8/process-definition.ts",
        ),
        "8.8/process-instance": resolve(
          __dirname,
          "lib/8.8/process-instance.ts",
        ),

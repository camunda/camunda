	...
	build: {
		lib: {
			entry: {
				...
				'8.9/conditional': resolve(__dirname, 'lib/8.9/conditional.ts'),
				...
				'8.9/expression': resolve(__dirname, 'lib/8.9/expression.ts'),
				...
				'8.9/setup': resolve(__dirname, 'lib/8.9/setup.ts'),

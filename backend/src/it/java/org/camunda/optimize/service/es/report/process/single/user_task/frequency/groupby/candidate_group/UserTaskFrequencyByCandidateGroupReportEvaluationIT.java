...
public class UserTaskFrequencyByCandidateGroupReportEvaluationIT extends AbstractProcessDefinitionIT {
  ...
  public void reportEvaluationForOneProcessWithUnassignedTasks() {
    ...
    assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), FIRST_CANDIDATE_GROUP_ID)).isPresent()
      ...
      .isEqualTo(1.);
    assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), DISTRIBUTE_BY_IDENTITY_MISSING_KEY)).isPresent()
      .get()
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(1.);
    assertThat(result.getInstanceCount()).isEqualTo(1L);
  ...
  public void otherProcessDefinitionsDoNotInfluenceResult() {
    ...
    assertThat(MapResultUtil.getEntryForKey(result2.getFirstMeasureData(), FIRST_CANDIDATE_GROUP_ID)).isPresent()
      ...
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(1.);
    assertThat(MapResultUtil.getEntryForKey(result2.getFirstMeasureData(), DISTRIBUTE_BY_IDENTITY_MISSING_KEY)).isPresent()
      .get()
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(1.);
  }

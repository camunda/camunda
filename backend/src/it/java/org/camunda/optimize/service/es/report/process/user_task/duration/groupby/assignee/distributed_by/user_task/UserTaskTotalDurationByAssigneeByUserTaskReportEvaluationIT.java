...
import static org.camunda.optimize.test.util.ProcessReportDataBuilderHelper.createUserTaskTotalDurationMapGroupByAssigneeByUserTaskReport;
...
public class UserTaskTotalDurationByAssigneeByUserTaskReportEvaluationIT
  ...
  protected ProcessReportDataDto createReport(final String processDefinitionKey, final String version) {
    return createUserTaskTotalDurationMapGroupByAssigneeByUserTaskReport(processDefinitionKey, version);
  }

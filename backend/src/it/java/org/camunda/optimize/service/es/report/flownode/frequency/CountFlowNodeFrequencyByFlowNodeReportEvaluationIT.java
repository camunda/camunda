package org.camunda.optimize.service.es.report.flownode.frequency;
...
public class CountFlowNodeFrequencyByFlowNodeReportEvaluationIT {
  ...
  public void evaluateReportForMultipleEventsWithMultipleProcesses() {
    ...
    MapProcessReportResultDto result1 = evaluateReport(reportData);
    ...
    MapProcessReportResultDto result2 = evaluateReport(reportData);

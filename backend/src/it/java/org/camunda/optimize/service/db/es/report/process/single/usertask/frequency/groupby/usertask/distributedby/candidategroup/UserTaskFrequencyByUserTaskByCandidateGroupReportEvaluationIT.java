 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.usertask.frequency.groupby.usertask.distributedby.candidategroup;
...
public class UserTaskFrequencyByUserTaskByCandidateGroupReportEvaluationIT
  ...
  public void
      instanceLevelFilterByCandidateGroupOnlyCountsUserTaskFromInstancesWithThatCandidateGroup(
          final MembershipFilterOperator filterOperator,
          final String[] filterValues,
          final Long expectedInstanceCount,
          final Map<String, List<Triple<String, Double, String>>> expectedResult) {
  ...
  private ProcessReportDataDto createReport(
    ...
    return TemplatedProcessReportDataBuilder.createReportData()
        ...
        .setReportDataType(
            ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_USER_TASK_BY_CANDIDATE_GROUP)
        .build();
  }
  ...
  private ProcessDefinitionEngineDto deployTwoUserTasksDefinition() {
    return engineIntegrationExtension.deployProcessAndGetProcessDefinition(
        getDoubleUserTaskDiagram(PROCESS_DEFINITION_KEY));
  }

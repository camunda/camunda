...
public class DecisionVariableAuthorizationIT extends AbstractPlatformIT {
  ...
  public void variableRequest_authorized() {
    ...
    // then
    responses.forEach(
        response -> assertThat(response.getStatus()).isEqualTo(Response.Status.OK.getStatusCode()));
  }
  ...
  public void variableNameRequestWithoutAuthorization() {
    ...
    // when
    Response inputVariableNameResponse =
        embeddedOptimizeExtension
            ...
            .buildDecisionInputVariableNamesRequest(
                ...
                false)
            .execute();
    Response outputVariableNameResponse =
        embeddedOptimizeExtension
            .getRequestExecutor()
            .withoutAuthentication()
  ...
  public void variableValuesRequestWithoutAuthorization() {
    ...
    // when
    Response inputVariableValueResponse =
        embeddedOptimizeExtension
            .getRequestExecutor()
            .withoutAuthentication()
            .buildDecisionInputVariableValuesRequest(
                createVariableValueRequest(
                    ...
                    Collections.emptyList()))
            .execute();
    Response outputVariableValueResponse =
        embeddedOptimizeExtension
            .getRequestExecutor()
            .withoutAuthentication()
  ...
  public void variableValuesRequest_unauthorizedTenant() {
    ...
    List<Response> responses =
        executeVariableValuesRequestsAsKermit(
            decisionDefinition, Collections.singletonList(tenantId));
  ...
  public void variableNamesRequest_unauthorizedTenantDoesNotFailRequest() {
    ...
    // when
    List<Response> responses =
        executeVariableValuesRequestsAsKermit(decisionDefinition, Collections.singletonList(null));
  ...
  public void variableNamesRequest_partiallyUnauthorizedTenantsNotForbidden() {
    ...
    final DecisionDefinitionEngineDto decisionDefinition1 =
        deploySimpleDecisionDefinition(tenantId1);
    final DecisionDefinitionEngineDto decisionDefinition2 =
        deploySimpleDecisionDefinition(tenantId2);
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.addGlobalAuthorizationForResource(RESOURCE_TYPE_DECISION_DEFINITION);
    authorizationClient.grantSingleResourceAuthorizationsForUser(
    ...
    List<Response> responses =
        executeVariableNamesRequestsAsKermit(
            decisionDefinition1, Lists.newArrayList(tenantId1, tenantId2));
  ...
  private List<Response> executeVariableRequestsAsKermit(
  ...
  private List<Response> executeVariableNamesRequestsAsKermit(
      final DecisionDefinitionEngineDto decisionDefinition, List<String> tenantIds) {
    Response inputVariableNameResponse =
        embeddedOptimizeExtension
            .getRequestExecutor()
            ...
            .buildDecisionInputVariableNamesRequest(
                createInputVariableNameRequest(
                    decisionDefinition.getKey(),
                    String.valueOf(decisionDefinition.getVersion()),
                    tenantIds),
                true)
            .execute();
    Response outputVariableNameResponse =
  ...
  private List<Response> executeVariableValuesRequestsAsKermit(
      final DecisionDefinitionEngineDto decisionDefinition, List<String> tenantIds) {
    Response inputVariableValueResponse =
        embeddedOptimizeExtension
            .getRequestExecutor()
  ...
  private DecisionVariableNameRequestDto createInputVariableNameRequest(
  ...
  private DecisionVariableValueRequestDto createVariableValueRequest(

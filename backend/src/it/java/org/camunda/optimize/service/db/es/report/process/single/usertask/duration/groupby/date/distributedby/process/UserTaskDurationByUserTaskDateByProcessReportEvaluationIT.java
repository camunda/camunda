 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.usertask.duration.groupby.date.distributedby.process;
...
public abstract class UserTaskDurationByUserTaskDateByProcessReportEvaluationIT extends AbstractPlatformIT {
  ...
  private void changeUserTaskDurationAndDatesForInstance(final ProcessInstanceEngineDto processInstanceDto,

...
public abstract class UserTaskFrequencyByUserTaskDateByProcessReportEvaluationIT extends AbstractPlatformIT {

  protected abstract ProcessReportDataType getReportDataType();

  protected abstract ProcessGroupByType getGroupByType();

  protected abstract void changeUserTaskInstanceDate(final ProcessInstanceEngineDto processInstanceDto,
  ...
  public void reportEvaluationWithSingleProcessDefinitionSource() {
    ...
    engineIntegrationExtension.finishAllRunningUserTasks();
    changeUserTaskInstanceDate(instance, USER_TASK_1, now.minusDays(1));
  ...
  public void reportEvaluationWithMultipleProcessDefinitionSources() {
    ...
    engineIntegrationExtension.finishAllRunningUserTasks();
    changeUserTaskInstanceDate(firstInstance, USER_TASK_1, now.minusDays(1));
    ...
    engineIntegrationExtension.finishAllRunningUserTasks();
    engineIntegrationExtension.finishAllRunningUserTasks();
    changeUserTaskInstanceDate(secondInstance, USER_TASK_1, now.minusDays(1));
    changeUserTaskInstanceDate(secondInstance, USER_TASK_2, now);
    importAllEngineEntitiesFromScratch();
  ...
  public void reportEvaluationWithMultipleProcessDefinitionSourcesAndOverlappingInstances() {
    ...
    engineIntegrationExtension.finishAllRunningUserTasks();
    changeUserTaskInstanceDate(v1Instance, USER_TASK_1, now.minusDays(1));
    ...
    engineIntegrationExtension.finishAllRunningUserTasks();
    engineIntegrationExtension.finishAllRunningUserTasks();
    changeUserTaskInstanceDate(v2Instance, USER_TASK_1, now.minusDays(1));
    changeUserTaskInstanceDate(v2Instance, USER_TASK_2, now);
    importAllEngineEntitiesFromScratch();

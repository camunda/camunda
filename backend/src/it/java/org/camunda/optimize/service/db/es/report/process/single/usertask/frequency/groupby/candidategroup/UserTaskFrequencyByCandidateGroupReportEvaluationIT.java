 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.usertask.frequency.groupby.candidategroup;
...
public class UserTaskFrequencyByCandidateGroupReportEvaluationIT extends AbstractProcessDefinitionIT {
  ...
  public void reportEvaluationForOneProcessInstance() {
    ...
    assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), SECOND_CANDIDATE_GROUP_ID))
      .isPresent().get()
      .extracting(MapResultEntryDto::getValue, MapResultEntryDto::getLabel)
  ...
  public void reportEvaluationForOneProcessInstanceWithUnassignedTasks() {
    ...
    assertThat(result.getFirstMeasureData()).hasSize(2);
    assertThat(getExecutedFlowNodeCount(result)).isEqualTo(2L);
    assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), FIRST_CANDIDATE_GROUP_ID)).isPresent()
      .get()
  ...
  public void reportEvaluationForMultipleCandidateGroups() {
    ...
    assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), FIRST_CANDIDATE_GROUP_ID)).isPresent()
      ...
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(2.);
    assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), SECOND_CANDIDATE_GROUP_ID)).isPresent()
      .get()
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(1.);
    assertThat(result.getInstanceCount()).isEqualTo(1L);
  ...
  public void otherProcessDefinitionsDoNotInfluenceResult() {
    ...
    assertThat(MapResultUtil.getEntryForKey(result1.getFirstMeasureData(), FIRST_CANDIDATE_GROUP_ID)).isPresent()
      .get()
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(2.);
    assertThat(MapResultUtil.getEntryForKey(result1.getFirstMeasureData(), SECOND_CANDIDATE_GROUP_ID)).isPresent()
      .get()
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(2.);
    ...
    assertThat(MapResultUtil.getEntryForKey(result2.getFirstMeasureData(), FIRST_CANDIDATE_GROUP_ID)).isPresent()
      .get()
      .extracting(MapResultEntryDto::getValue)
      .isEqualTo(1.);
    assertThat(MapResultUtil.getEntryForKey(
  ...
  public static Stream<Arguments> viewLevelAssigneeFilterScenarios() {
    return Stream.of(
      ...
      Arguments.of(
        ...
        Arrays.asList(Tuple.tuple(FIRST_CANDIDATE_GROUP_ID, 1.), Tuple.tuple(SECOND_CANDIDATE_GROUP_ID, 1.))
      ),
      Arguments.of(
  ...
  public void viewLevelFilterByAssigneeOnlyCountsCandidateGroupsFromThoseMatchingFilter(final MembershipFilterOperator filterOperator,
  ...
  public void viewLevelFilterByCandidateGroupOnlyCountsThoseCandidateGroups(final MembershipFilterOperator filterOperator,
                                                                            final String[] filterValues,
                                                                            final Long expectedInstanceCount,
                                                                            final List<Tuple> expectedResult) {
    // given
  ...
  public void instanceLevelFilterByCandidateGroupOnlyCountsThoseCandidateGroupsFromInstancesMatchingFilter(
    final MembershipFilterOperator filterOperator,
    final String[] filterValues,
    final Long expectedInstanceCount,
    final List<Tuple> expectedResult) {

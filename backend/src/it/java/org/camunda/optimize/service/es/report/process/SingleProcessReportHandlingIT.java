...
import org.camunda.optimize.dto.optimize.query.report.single.configuration.KPIType;
...
public class SingleProcessReportHandlingIT extends AbstractIT {
  ...
  public void updateProcessReport() {
    ...
    kpiConfigurationDto.setActive(true);
    kpiConfigurationDto.setType(KPIType.TIME);
    SingleReportTargetValueDto singleReportTargetValueDto = new SingleReportTargetValueDto();
    singleReportTargetValueDto.setKpi(kpiConfigurationDto);
    ...
    assertThat(newReport.getData().getConfiguration().getTargetValue().getKpi().getType()).isEqualTo(KPIType.TIME);
    assertThat(newReport.getData().getConfiguration().getTargetValue().getKpi().isActive()).isEqualTo(true);

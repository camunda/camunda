...
public class ProcessInstanceFrequencyByProcessInstanceStartDateReportByProcessEvaluationIT
  extends AbstractProcessInstanceFrequencyByProcessInstanceDateByProcessReportEvaluationIT {

  @Override
  protected ProcessReportDataType getReportDataType() {
    return ProcessReportDataType.PROC_INST_FREQ_GROUP_BY_START_DATE_BY_PROCESS;
  }
  ...
  protected void changeProcessInstanceDate(final ProcessInstanceEngineDto instanceEngineDto,
    ...
    engineDatabaseExtension.changeProcessInstanceStartDate(instanceEngineDto.getId(), newDate);
  }

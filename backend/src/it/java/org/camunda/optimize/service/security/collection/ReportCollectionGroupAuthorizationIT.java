...
public class ReportCollectionGroupAuthorizationIT extends AbstractCollectionRoleIT {
  ...
  protected static final List<ReportCollectionGroupAuthorizationIT.ReportScenario>
  ...
  public void superGroupIdentityIsGrantedAddReport(
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupIdentityIsGrantedCopyPrivateReportToCollection(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupIdentityIsGrantedToCopyPrivateReportOfOtherUser(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupIdentityIsGrantedAccessToCollectionReport(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupListReportsContainsOtherUsersPrivateReports(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupCanUpdateOtherPrivateReport(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupIdentityIsGrantedUpdateReport(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupCanDeleteOtherPrivateReport(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  @ParameterizedTest
  @MethodSource(REPORT_SCENARIOS)
  public void superGroupIdentityIsGrantedDeleteReport(
      final ReportCollectionGroupAuthorizationIT.ReportScenario reportScenario) {
    // given
    authorizationClient.addKermitUserAndGrantAccessToOptimize();
    authorizationClient.createKermitGroupAndAddKermitToThatGroup();
  ...
  private int getEngineResourceTypeForReportType(
      final ReportCollectionGroupAuthorizationIT.IdentityRoleAndReportScenario identityAndReport) {

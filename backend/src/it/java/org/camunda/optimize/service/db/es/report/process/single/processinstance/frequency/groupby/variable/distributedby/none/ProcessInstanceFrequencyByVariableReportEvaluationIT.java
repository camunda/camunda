 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.processinstance.frequency.groupby.variable.distributedby.none;
...
public class ProcessInstanceFrequencyByVariableReportEvaluationIT
  ...
  public void simpleReportEvaluation() {
    ...
    assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), "bar").get().getValue())
        .isEqualTo(1.);
  }
  ...
  public void multipleProcessInstances() {
    ...
    assertThat(
        ...
        .isEqualTo(1.);
    assertThat(
            MapResultUtil.getEntryForKey(resultDto.getFirstMeasureData(), "bar2").get().getValue())
        .isEqualTo(2.);
  }

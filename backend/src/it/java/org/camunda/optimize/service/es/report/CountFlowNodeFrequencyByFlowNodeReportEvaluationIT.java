...
public class CountFlowNodeFrequencyByFlowNodeReportEvaluationIT {
  ...
  public void reportEvaluationForOneProcess() throws Exception {
    ...
    CountFlowNodeFrequencyByFlowNodeReportResultDto result = evaluateReport(reportData);
  ...
  public void evaluateReportForMultipleEventsWithMultipleProcesses() throws Exception {
    ...
    CountFlowNodeFrequencyByFlowNodeReportResultDto result1 = evaluateReport(reportData);
    reportData.setProcessDefinitionId(processDefinitionId2);
    CountFlowNodeFrequencyByFlowNodeReportResultDto result2 = evaluateReport(reportData);
  ...
  private CountFlowNodeFrequencyByFlowNodeReportResultDto evaluateReport(ReportDataDto reportData) {
    Response response = evaluateReportAndReturnResponse(reportData);
    assertThat(response.getStatus(), is(200));

    return response.readEntity(CountFlowNodeFrequencyByFlowNodeReportResultDto.class);
  }

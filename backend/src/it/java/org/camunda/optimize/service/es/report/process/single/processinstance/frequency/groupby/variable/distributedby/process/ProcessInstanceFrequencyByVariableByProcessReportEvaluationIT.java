 ...
 */
package org.camunda.optimize.service.es.report.process.single.processinstance.frequency.groupby.variable.distributedby.process;
...
public class ProcessInstanceFrequencyByVariableByProcessReportEvaluationIT extends AbstractPlatformIT {
    ...
    assertThat(result.getMeasures()).hasSize(1)
      ...
      .containsExactly(
        Tuple.tuple(
          ...
          List.of(
            createHyperMapResult("aStringValue", new MapResultEntryDto(processIdentifier, 1.0, processDisplayName)))
        ));
  }

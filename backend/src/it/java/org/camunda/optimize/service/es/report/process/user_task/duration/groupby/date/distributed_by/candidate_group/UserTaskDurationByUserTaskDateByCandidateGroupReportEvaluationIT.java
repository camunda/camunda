...
public abstract class UserTaskDurationByUserTaskDateByCandidateGroupReportEvaluationIT extends AbstractProcessDefinitionIT {
  ...
  public void filterByAssigneeOnlyCountsUserTaskWithThatAssignee(final String filterOperator,
  ...
  public static Stream<Arguments> candidateGroupFilterScenarios() {
    return Stream.of(
      Arguments.of(
        IN, new String[]{SECOND_CANDIDATE_GROUP}, Lists.newArrayList(Tuple.tuple(SECOND_CANDIDATE_GROUP, 10L))
      ),
      Arguments.of(
        IN,
      ...
      Arguments.of(
        NOT_IN, new String[]{SECOND_CANDIDATE_GROUP}, Lists.newArrayList(Tuple.tuple(FIRST_CANDIDATE_GROUP, 10L))
      ),
  ...
  @SuppressWarnings("unchecked")
  public void filterByCandidateGroupOnlyCountsUserTaskWithThatCandidateGroup(final String filterOperator,
                                                                             final String[] filterValues,
                                                                             final List<Tuple> expectedResult) {
    // given
    final ProcessDefinitionEngineDto processDefinition = deployTwoUserTasksDefinition();

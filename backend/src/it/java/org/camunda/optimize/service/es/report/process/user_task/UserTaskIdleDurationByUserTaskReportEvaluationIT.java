...
public class UserTaskIdleDurationByUserTaskReportEvaluationIT
  ...
  public UserTaskIdleDurationByUserTaskReportEvaluationIT(final ProcessViewOperation viewOperation) {
    super(viewOperation);
  }
  ...
  protected ProcessReportDataDto createReport(final String processDefinitionKey, final String version) {
    return createUserTaskIdleDurationMapGroupByUserTaskReport(processDefinitionKey, version, viewOperation);
  }

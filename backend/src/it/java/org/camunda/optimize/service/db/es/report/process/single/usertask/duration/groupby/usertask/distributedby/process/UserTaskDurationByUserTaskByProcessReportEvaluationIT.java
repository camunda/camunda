 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.usertask.duration.groupby.usertask.distributedby.process;
...
public class UserTaskDurationByUserTaskByProcessReportEvaluationIT extends AbstractPlatformIT {
  ...
  public void reportEvaluationWithSingleProcessDefinitionSource() {
    ...
    assertThat(result.getMeasures()).hasSize(1)
      ...
      .containsExactly(List.of(
        ...
        createHyperMapResult(USER_TASK_2, new MapResultEntryDto(processIdentifier, 1000.0, processDisplayName))
      ));
  }
  ...
  @Test
  public void reportEvaluationWithMultipleProcessDefinitionSourcesAndOverlappingInstancesAcrossAggregationAndDurationTypes() {
    // given
    final ProcessInstanceEngineDto v1Instance =
      engineIntegrationExtension.deployAndStartProcess(getDoubleUserTaskDiagram("definition"));
    engineIntegrationExtension.finishAllRunningUserTasks();

...
import org.camunda.optimize.service.db.es.report.process.single.ModelElementDurationByModelElementDateReportEvaluationIT;
...
public abstract class FlowNodeDurationByFlowNodeDateReportEvaluationIT
  ...
  public void reportEvaluationForSeveralProcessesWithAllAggregationTypes() {
    ...
    assertThat(result.getMeasures())
        .extracting(MeasureResponseDto::getAggregationType)
        .containsExactly(getSupportedAggregationTypes());
    final Map<AggregationDto, Double> expectedResultsAsMap =
        databaseIntegrationTestExtension.calculateExpectedValueGivenDurations(10., 20.);
    result
        .getMeasures()
        .forEach(
            measureResult ->
  ...
  private static Stream<Arguments> viewLevelAssigneeFilterScenarios() {
    return Stream.of(
        Arguments.of(IN, new String[] {SECOND_USER}, new Double[] {3000.}),
        Arguments.of(
            IN,
            new String[] {DEFAULT_USERNAME, SECOND_USER, null},
            new Double[] {2000., 3000., 4000.}),
        Arguments.of(NOT_IN, new String[] {SECOND_USER}, new Double[] {2000., null, 4000.}),
        Arguments.of(NOT_IN, new String[] {DEFAULT_USERNAME, SECOND_USER}, new Double[] {4000.}));
  }
  ...
  private static Stream<Arguments> viewLevelCandidateGroupFilterScenarios() {
    return Stream.of(
        Arguments.of(IN, new String[] {SECOND_CANDIDATE_GROUP_ID}, new Double[] {3000.}),
        Arguments.of(
            IN,
            new String[] {FIRST_CANDIDATE_GROUP_ID, SECOND_CANDIDATE_GROUP_ID, null},
            new Double[] {2000., 3000., 4000.}),
        Arguments.of(
            NOT_IN, new String[] {SECOND_CANDIDATE_GROUP_ID}, new Double[] {2000., null, 4000.}),
        Arguments.of(
            NOT_IN,

...
public abstract class AbstractDecisionStringNotContainsVariableQueryFilterIT
  ...
  public void notContainsFilter_possibleMatchingScenarios() {
    ...
    // when
    final List<DecisionFilterDto<?>> notContainsFilter =
        createNotContainsFilterForValues("ketchup");
    ReportResultResponseDto<List<RawDataDecisionInstanceDto>> result =
        evaluateReportWithFilter(decisionDefinitionDto, notContainsFilter);
  ...
  public void notContainsFilter_otherVariableWithMatchingValue() {
    ...
    final DecisionDefinitionEngineDto decisionDefinitionDto =
        deployInputEqualsOutputDecisionDefinition();
    startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs("ketchup"));
  ...
  public void notContainsFilter_nullValue() {
    ...
    startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs(shouldNotMatch));
  ...
  public void notContainsFilter_combineSeveralValues() {
    ...
    final List<DecisionFilterDto<?>> filter =
        createNotContainsFilterForValues("ketchup", null, "must");
    ReportResultResponseDto<List<RawDataDecisionInstanceDto>> result =
        evaluateReportWithFilter(decisionDefinitionDto, filter);
        ...
        new HashMap<String, InputVariableEntry>() {
          {
            put(
                ...
                new InputVariableEntry(
                    STRING_INPUT_ID, "input", VariableType.STRING, shouldNotMatch));
            put(
                INTEGER_INPUT_ID,
  ...
  protected abstract void assertThatResultDoesNotContainVariables(
      final ReportResultResponseDto<List<RawDataDecisionInstanceDto>> result,
      final String... shouldMatch);

  protected abstract List<DecisionFilterDto<?>> createNotContainsFilterForValues(

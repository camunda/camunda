...
public abstract class ModelElementDurationByModelElementDateReportEvaluationIT
            ...
            i -> {
              final String expectedDateString =
                  groupedByDateAsString(
                      startDate.plus(i, groupByUnitAsChrono), groupByUnitAsChrono);
  ...
  public void automaticIntervalSelection_combinedReportsWithDistinctRanges() {
    ...
    startProcessInstancesWithModelElementDateInDayRange(
        processDefinition1, now.plusDays(1), now.plusDays(3));
    ProcessDefinitionEngineDto processDefinition2 = deploySimpleDefinition();
    startProcessInstancesWithModelElementDateInDayRange(
        processDefinition2, now.plusDays(4), now.plusDays(6));
    importAllEngineEntitiesFromScratch();
  ...
  public void automaticIntervalSelection_combinedReportsWithOneIncludingRange() {
    ...
    ProcessDefinitionEngineDto processDefinition1 = deploySimpleDefinition();
    startProcessInstancesWithModelElementDateInDayRange(
        processDefinition1, now.plusDays(1), now.plusDays(6));
    ProcessDefinitionEngineDto processDefinition2 = deploySimpleDefinition();
    startProcessInstancesWithModelElementDateInDayRange(
        processDefinition2, now.plusDays(3), now.plusDays(5));
    importAllEngineEntitiesFromScratch();
  ...
  public void automaticIntervalSelection_combinedReportsWithIntersectingRange() {
    ...
    ProcessDefinitionEngineDto processDefinition1 = deploySimpleDefinition();
    startProcessInstancesWithModelElementDateInDayRange(
        processDefinition1, now.plusDays(1), now.plusDays(4));
    ProcessDefinitionEngineDto processDefinition2 = deploySimpleDefinition();
    startProcessInstancesWithModelElementDateInDayRange(
        processDefinition2, now.plusDays(4), now.plusDays(6));
    importAllEngineEntitiesFromScratch();
  ...
  protected void updateUserTaskTime(
  ...
  protected String groupedByDateAsString(
  ...
  protected abstract void startProcessInstancesWithModelElementDateInDayRange(

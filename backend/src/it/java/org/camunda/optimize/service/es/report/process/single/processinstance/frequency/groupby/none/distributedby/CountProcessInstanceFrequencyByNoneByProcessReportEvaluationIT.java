...
import static org.camunda.optimize.test.util.ProcessReportDataType.COUNT_PROC_INST_FREQ_GROUP_BY_NONE_BY_PROCESS;
...
public class CountProcessInstanceFrequencyByNoneByProcessReportEvaluationIT extends AbstractIT {
  ...
  private ProcessReportDataDto createCountGroupedByNoneByProcessReport(final List<ReportDataDefinitionDto> definitionDtos) {
    final ProcessReportDataDto reportData = TemplatedProcessReportDataBuilder.createReportData()
      .setReportDataType(COUNT_PROC_INST_FREQ_GROUP_BY_NONE_BY_PROCESS)
      .build();

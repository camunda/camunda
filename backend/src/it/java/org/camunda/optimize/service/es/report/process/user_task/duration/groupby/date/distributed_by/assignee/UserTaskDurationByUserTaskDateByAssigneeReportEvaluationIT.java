...
public abstract class UserTaskDurationByUserTaskDateByAssigneeReportEvaluationIT extends AbstractProcessDefinitionIT {
  ...
  public void filterByAssigneeOnlyCountsThoseAssignees(final String filterOperator,
  ...
  public static Stream<Arguments> candidateGroupFilterScenarios() {
    return Stream.of(
      Arguments.of(
        IN, new String[]{SECOND_CANDIDATE_GROUP}, Lists.newArrayList(Tuple.tuple(SECOND_USER, 10L))
      ),
      Arguments.of(
        IN,
      ...
      Arguments.of(NOT_IN, new String[]{SECOND_CANDIDATE_GROUP}, Lists.newArrayList(Tuple.tuple(DEFAULT_USERNAME, 10L))),
  ...
  @SuppressWarnings("unchecked")
  public void filterByCandidateGroupOnlyCountsAssigneesFromThoseUserTasks(final String filterOperator,
                                                                          final String[] filterValues,
                                                                          final List<Tuple> expectedResult) {
    // given
    final ProcessDefinitionEngineDto processDefinition = deployTwoUserTasksDefinition();

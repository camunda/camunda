...
public abstract class AbstractUserTaskDurationByUserTaskByCandidateGroupReportEvaluationIT
  ...
  private static Stream<Arguments> flowNodeStatusProcessFilters() {
    return Stream.of(
        ...
        Arguments.of(
            ...
            1L),
        Arguments.of(
            ProcessFilterBuilder.filter().canceledFlowNodesOnly().add().buildList(), 2, 2L));
  }
  ...
  public void evaluateReportWithFlowNodeStatus(
    ...
    assertEvaluateReportWithFlowNodeStatusFilter(
        actualResult, processFilter, expectedInstanceCount);
  }
  ...
  public void
      instanceLevelFilterByCandidateGroupOnlyIncludesUserTaskFromInstancesWithThatCandidateGroup(
          final MembershipFilterOperator filterOperator,
          final String[] filterValues,
          final Long expectedInstanceCount,
          final Map<String, List<Triple<String, Double, String>>> expectedResult) {
  ...
  private ProcessDefinitionEngineDto deployFourUserTasksDefinition() {
    BpmnModelInstance modelInstance =
        Bpmn.createExecutableProcess(DEFAULT_PROCESS_ID)
            .startEvent()
            .parallelGateway()
            .userTask(USER_TASK_1)
            .userTask(USER_TASK_2)

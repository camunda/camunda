 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.flownode.duration.groupby.variable.distributedby.process;
            ...
            Tuple.tuple(
                ...
                List.of(
                    createHyperMapResult(
                        "aStringValue",
                        new MapResultEntryDto(
                            allVersionsIdentifier, 18000.0, allVersionsDisplayName),

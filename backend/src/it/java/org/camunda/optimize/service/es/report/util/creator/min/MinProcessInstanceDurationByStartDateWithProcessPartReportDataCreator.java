...
public class MinProcessInstanceDurationByStartDateWithProcessPartReportDataCreator implements ReportDataCreator {
  ...
  public SingleReportDataDto create(String processDefinitionKey, String processDefinitionVersion,
    ...
    if (additional.length == 2) {
      ...
      return createMinProcessInstanceDurationGroupByStartDateWithProcessPartReport(

...
public class InstantPreviewDashboardIT extends AbstractDashboardRestServiceIT {
  ...
  private void assertTileTranslation(Map<String, Object> textTileConfiguration, String locale) {
    ...
    expectedStrings.put("de", List.of(
      ...
      "Aggregiere und gruppiere Prozessausführung Daten in Tagen, Wochen und Monaten um Metriken und Key Performance Indicator (KPI) zu monitoren und zu melden.",
      "Abonniere eine wöchentliche Email-Zusammenfassung der Prozessmetriken und KPIs",
      "Analysiere Probleme und finde Verbesserungen",
      "Nutze alle gesammelten Prozessausführung Daten, um Probleme zu untersuchen oder neue Prozessverbesserungen einzuleiten.",
      "Nutze die Optimize Ausreißeranalyse, um Verbesserungspotenzial im Prozess zu finden",
      "Echtzeitnahe Überwache der Prozess Gesundheit",
      "Monitore Prozessausführung Daten der letzten Minuten, Stunden und Tage echtzeitnah, um korrektiv eingreifen zu können.",
      "Erstelle eine Kopie dieses Dashboards und passe es deinen Bedürfnissen an",
      "Aktuell laufend",
      "Dieser Bericht zeigt den fortschritt aller laufenden Prozesses an.",
    ...
    expectedStrings.put("en", List.of(
      ...
      "This dashboard provides a competitive overview of metrics and use cases that can be covered with Optimize. It is available for any process as soon as a process is deployed.",
      "Report business metrics",
      "Aggregate and group the process execution data into days, weeks, and months to monitor and report business metrics and key performance indicators (KPI).",

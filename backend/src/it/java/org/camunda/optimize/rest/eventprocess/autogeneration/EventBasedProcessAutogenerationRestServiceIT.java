...
public class EventBasedProcessAutogenerationRestServiceIT
  ...
  public void createAutogeneratedProcess_multipleCamundaEventSources_noTracingVariableProvided(
  ...
  private CamundaEventSourceEntryDto deployAndStartEngineInstanceAndCreateEventSource() {
    ...
    return createCamundaSourceEntry(
        processInstanceEngineDto.getProcessDefinitionKey(), EventScopeType.PROCESS_INSTANCE);
  }

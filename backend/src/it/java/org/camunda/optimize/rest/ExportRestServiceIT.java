...
public class ExportRestServiceIT extends AbstractPlatformIT {
  ...
  private static final String COLUMN_PROCESS_INSTANCE_ID =
  ...
  public void exportExistingRawDecisionReport() throws IOException {
    ...
    String reportId =
        createAndStoreDefaultValidRawDecisionReportDefinition(
  ...
  public void exportDynamicRawProcessReport_rejectInvalidRequests(
      final ProcessRawDataCsvExportRequestDto invalidRequest) {
    // given
  ...
  private static Stream<ProcessRawDataCsvExportRequestDto>
      getInvalidDynamicRawProcessExportRequests() {
    return Stream.of(
  ...
  public void exportDynamicRawProcessReport_withJustProcessInstanceId() {
    ...
    assertThat(csvString)
        .containsExactly(
            escapeString(COLUMN_PROCESS_INSTANCE_ID), escapeString(processInstance.getId()));
  }
  ...
  public void exportDynamicRawProcessReport_withJustProcessInstanceIdSpecificVersion() {
    ...
    final ProcessRawDataCsvExportRequestDto exportRequestDto =
        ProcessRawDataCsvExportRequestDto.builder()
            ...
            .processDefinitionVersions(
                Collections.singletonList(processInstanceVersion2.getProcessDefinitionVersion()))
            .includedColumns(Collections.singletonList(COLUMN_PROCESS_INSTANCE_ID))
            .build();
  ...
  public void exportDynamicRawProcessReport_withJustProcessInstanceIdSpecificTenant() {
    ...
    assertThat(csvString)
        .containsExactly(
            escapeString(COLUMN_PROCESS_INSTANCE_ID), escapeString(processInstanceTenant1.getId()));
  }
  ...
  public void exportDynamicRawProcessReport_withJustProcessInstanceIdWithFilter() {
    ...
    engineDatabaseExtension.changeProcessInstanceStartDate(
        processInstance1.getId(), modifiedStartDate);
    ...
    assertThat(csvString)
        .containsExactly(
            escapeString(COLUMN_PROCESS_INSTANCE_ID), escapeString(processInstance2.getId()));
  }
  ...
  private String createAndStoreDefaultValidRawDecisionReportDefinition(
      String decisionDefinitionKey, String decisionDefinitionVersion) {
  ...
  private String createSingleDecisionReport(
      SingleDecisionReportDefinitionRequestDto singleDecisionReportDefinitionDto) {
  ...
  private ProcessInstanceEngineDto deployAndStartSimpleProcessWithVariables(
    ...
    return engineIntegrationExtension.deployAndStartProcessWithVariables(
        getSimpleBpmnDiagram(), variables, tenantId);
  }
}

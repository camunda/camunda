...
@Component
public class UserTaskDurationGroupByUserTaskStartDateByTaskCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByUserTaskStartDateByTaskCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

...
public abstract class AbstractActivityInstanceWriterES
    extends AbstractProcessInstanceDataWriterES<FlowNodeEventDto>
    implements AbstractActivityInstanceWriter {

  private final ObjectMapper objectMapper;

  protected AbstractActivityInstanceWriterES(
  ...
  private ImportRequestDto createImportRequestForActivityInstance(
      Map.Entry<String, List<FlowNodeEventDto>> activitiesByProcessInstance,
    ...
    // see
    // https://discuss.elastic.co/t/how-to-update-nested-objects-in-elasticsearch-2-2-script-via-java-api/43135

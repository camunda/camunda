 ...
 */
package org.camunda.optimize.service.es.report.command.process.flownode.duration.groupby.date.distributedby.flownode;
...
@Component
public class FlowNodeDurationGroupByFlowNodeEndDateByFlowNodeCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeDurationGroupByFlowNodeEndDateByFlowNodeCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

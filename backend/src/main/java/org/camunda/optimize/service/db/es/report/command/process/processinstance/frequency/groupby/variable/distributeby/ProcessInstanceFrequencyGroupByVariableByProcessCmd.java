 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.processinstance.frequency.groupby.variable.distributeby;
...
@Component
public class ProcessInstanceFrequencyGroupByVariableByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceFrequencyGroupByVariableByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.flownode.frequency.groupby.date.distributedby.flownode;
...
@Component
public class FlowNodeFrequencyGroupByFlowNodeEndDateByFlowNodeCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeFrequencyGroupByFlowNodeEndDateByFlowNodeCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

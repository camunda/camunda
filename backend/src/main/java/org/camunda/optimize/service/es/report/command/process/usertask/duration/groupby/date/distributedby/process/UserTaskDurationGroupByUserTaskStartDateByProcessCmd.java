 ...
 */
package org.camunda.optimize.service.es.report.command.process.usertask.duration.groupby.date.distributedby.process;
...
public class UserTaskDurationGroupByUserTaskStartDateByProcessCmd
  ...
  public UserTaskDurationGroupByUserTaskStartDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.processinstance.duration.groupby.date.distributedby.process;
...
@Component
public class ProcessInstanceDurationGroupByStartDateByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceDurationGroupByStartDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

...
@Component
public class FlowNodeFrequencyGroupByFlowNodeStartDateByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeFrequencyGroupByFlowNodeStartDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

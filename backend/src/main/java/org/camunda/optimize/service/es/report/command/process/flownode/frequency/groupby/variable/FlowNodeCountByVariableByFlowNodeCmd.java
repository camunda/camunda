...
@Component
public class FlowNodeCountByVariableByFlowNodeCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeCountByVariableByFlowNodeCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

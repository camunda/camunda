...
@Component
public class DecisionInstanceFrequencyGroupByMatchedRuleCmd extends DecisionCmd<List<MapResultEntryDto>> {

  public DecisionInstanceFrequencyGroupByMatchedRuleCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

...
public class RunningUserTaskInstanceWriterES extends AbstractUserTaskWriterES implements RunningUserTaskInstanceWriter {

  @Autowired
  public RunningUserTaskInstanceWriterES(final OptimizeElasticsearchClient esClient,

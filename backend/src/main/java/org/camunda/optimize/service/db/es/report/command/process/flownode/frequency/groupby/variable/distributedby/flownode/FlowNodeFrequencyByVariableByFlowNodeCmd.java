 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.flownode.frequency.groupby.variable.distributedby.flownode;
...
@Component
public class FlowNodeFrequencyByVariableByFlowNodeCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

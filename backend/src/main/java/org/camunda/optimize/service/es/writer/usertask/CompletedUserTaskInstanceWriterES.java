...
public class CompletedUserTaskInstanceWriterES extends AbstractUserTaskWriterES implements CompletedUserTaskInstanceWriter {

  public CompletedUserTaskInstanceWriterES(final OptimizeElasticsearchClient esClient,

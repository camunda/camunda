...
@Component
public class CountDecisionInstanceFrequencyGroupByInputVariableCmd extends DecisionCmd<List<MapResultEntryDto>> {

  public CountDecisionInstanceFrequencyGroupByInputVariableCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

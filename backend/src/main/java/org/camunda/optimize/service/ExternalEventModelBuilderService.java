...
public class ExternalEventModelBuilderService {
  ...
  public AbstractFlowNodeBuilder<?, ?> createModelFromExternalEventSource(ProcessBuilder processBuilder,
    ...
    if (!canGenerateModelFromGraph(autogeneratedEventGraphDto)) {
      return processBuilder.startEvent();
    }
    ...
    for (EventTypeDto rootNode : autogeneratedEventGraphDto.getStartEvents()) {
      ...
      StartEventBuilder startEventBuilder = processBuilder.startEvent(nodeId)
  ...
  private AbstractFlowNodeBuilder<?, ?> depthTraverseGraph(EventTypeDto previouslyAddedNode,
  ...
  private AbstractFlowNodeBuilder<?, ?> addEndEvent(final AbstractFlowNodeBuilder<?, ?> currentNodeBuilder,
                                                    final EventTypeDto nodeToAdd, final String nodeId) {

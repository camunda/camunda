...
@Component
public class ProcessInstanceFrequencyGroupByRunningDateCmd extends ProcessCmd<List<MapResultEntryDto>> {

  public ProcessInstanceFrequencyGroupByRunningDateCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.frequency.groupby.date.distributedby.process;
...
@Component
public class UserTaskFrequencyGroupByUserTaskEndDateByProcessCmd
  extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskFrequencyGroupByUserTaskEndDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.candidategroup.distributedby.process;
...
@Component
public class UserTaskDurationGroupByCandidateGroupByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByCandidateGroupByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.processinstance.frequency.groupby.duration.distributeby;
...
import org.camunda.optimize.service.db.es.report.command.modules.group_by.process.ProcessGroupByDuration;
...
@Component
public class ProcessInstanceFrequencyGroupByDurationByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceFrequencyGroupByDurationByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

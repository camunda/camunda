...
import org.camunda.optimize.service.db.es.report.command.modules.group_by.decision.variable.DecisionGroupByOutputVariable;
...
@Component
public class DecisionInstanceFrequencyGroupByOutputVariableCmd extends DecisionCmd<List<MapResultEntryDto>> {

  public DecisionInstanceFrequencyGroupByOutputVariableCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }
  ...
  protected DecisionReportCmdExecutionPlan<List<MapResultEntryDto>> buildExecutionPlan(final ReportCmdExecutionPlanBuilder builder) {
    return builder.createExecutionPlan()
      ...
      .groupBy(DecisionGroupByOutputVariable.class)

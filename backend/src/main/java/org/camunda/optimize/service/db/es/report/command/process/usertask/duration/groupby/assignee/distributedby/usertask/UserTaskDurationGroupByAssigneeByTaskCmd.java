 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.assignee.distributedby.usertask;
...
@Component
public class UserTaskDurationGroupByAssigneeByTaskCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByAssigneeByTaskCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

...
public class CamundaActivityEventReaderES implements CamundaActivityEventReader {
  ...
  public List<CamundaActivityEventDto> getCamundaActivityEventsForDefinitionAt(
    ...
    return getPageOfEventsForDefinitionKeySortedByTimestamp(
        definitionKey, timestampQuery, MAX_RESPONSE_SIZE_LIMIT);
  }
  ...
  public List<CamundaActivityEventDto> getCamundaActivityEventsForDefinitionBetween(
    ...
    final RangeQueryBuilder eventsQuery =
        rangeQuery(CamundaActivityEventIndex.TIMESTAMP)
  ...
  private List<CamundaActivityEventDto> getPageOfEventsForDefinitionKeySortedByTimestamp(
      final String definitionKey, final QueryBuilder query, final int limit) {

...
@Component
public class CountProcessInstanceFrequencyGroupByEndDateCmd extends ProcessCmd<List<MapResultEntryDto>> {

  public CountProcessInstanceFrequencyGroupByEndDateCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

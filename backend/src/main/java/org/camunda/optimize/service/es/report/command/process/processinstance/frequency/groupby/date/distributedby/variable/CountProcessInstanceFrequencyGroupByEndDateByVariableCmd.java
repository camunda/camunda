...
@Component
public class CountProcessInstanceFrequencyGroupByEndDateByVariableCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public CountProcessInstanceFrequencyGroupByEndDateByVariableCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

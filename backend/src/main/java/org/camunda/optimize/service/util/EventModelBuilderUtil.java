...
public class EventModelBuilderUtil {
  ...
  public static AutogeneratedEventGraphDto generateExternalEventGraph(final List<EventSequenceCountDto> externalEventSequenceCounts) {
  ...
  private static List<EventTypeDto> identifyAndPromoteBestFitStartEvents(final Map<EventTypeDto, AdjacentEventTypesDto> adjacentEventTypesDtoMap) {
  ...
  private static List<EventTypeDto> identifyAndPromoteBestFitEndEvents(final Map<EventTypeDto, AdjacentEventTypesDto> adjacentEventTypesDtoMap,

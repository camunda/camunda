...
public class EventModelBuilderUtil {
  ...
  public static AutogenerationEventGraphDto generateExternalEventGraph(final List<EventSequenceCountDto> externalEventSequenceCounts) {
    Map<EventTypeDto, AutogenerationAdjacentEventTypesDto> adjacentEventTypesDtoMap = new HashMap<>();
      ...
      .forEach(eventSequenceCountDto -> {
        if (eventSequenceCountDto.getTargetEvent() == null) {
          ...
          if (adjacentEventTypesDtoMap.containsKey(eventSequenceCountDto.getSourceEvent())) {
            ...
            adjacentEventTypesDtoMap.put(
              eventSequenceCountDto.getSourceEvent(),
              AutogenerationAdjacentEventTypesDto.builder().succeedingEvents(targetEvents).build()
            );
          }
          if (adjacentEventTypesDtoMap.containsKey(eventSequenceCountDto.getTargetEvent())) {
            ...
            adjacentEventTypesDtoMap.put(
              ...
              AutogenerationAdjacentEventTypesDto.builder().precedingEvents(sourceEvents).build()
            );
          }
        }
      });

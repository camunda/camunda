 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.usertask.distributedby.process;
...
import org.camunda.optimize.service.db.es.report.command.modules.group_by.process.usertask.ProcessGroupByUserTask;
...
@Component
public class UserTaskDurationGroupByTaskGroupByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByTaskGroupByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

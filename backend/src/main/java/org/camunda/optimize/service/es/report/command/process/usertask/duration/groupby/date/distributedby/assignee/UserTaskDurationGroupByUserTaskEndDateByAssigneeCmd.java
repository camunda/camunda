 ...
 */
package org.camunda.optimize.service.es.report.command.process.usertask.duration.groupby.date.distributedby.assignee;
...
@Component
public class UserTaskDurationGroupByUserTaskEndDateByAssigneeCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

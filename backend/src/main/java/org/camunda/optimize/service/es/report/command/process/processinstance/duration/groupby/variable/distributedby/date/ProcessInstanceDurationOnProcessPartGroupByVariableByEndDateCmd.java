...
@Component
public class ProcessInstanceDurationOnProcessPartGroupByVariableByEndDateCmd
  extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceDurationOnProcessPartGroupByVariableByEndDateCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

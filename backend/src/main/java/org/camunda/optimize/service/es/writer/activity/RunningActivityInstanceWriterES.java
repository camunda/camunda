...
public class RunningActivityInstanceWriterES extends AbstractActivityInstanceWriterES implements RunningActivityInstanceWriter {

  public RunningActivityInstanceWriterES(final OptimizeElasticsearchClient esClient,

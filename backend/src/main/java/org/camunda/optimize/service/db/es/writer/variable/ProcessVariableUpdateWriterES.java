...
public class ProcessVariableUpdateWriterES
    extends AbstractProcessInstanceDataWriterES<ProcessVariableDto>
    implements ProcessVariableUpdateWriter {

  private static final Script VARIABLE_CLEAR_SCRIPT =
      new Script(MessageFormat.format("ctx._source.{0} = new ArrayList();\n", VARIABLES));

  private static final String VARIABLE_UPDATES_FROM_ENGINE = "variableUpdatesFromEngine";

  private final ObjectMapper objectMapper;

  public ProcessVariableUpdateWriterES(
  ...
  private Map<String, List<ProcessVariableDto>> groupVariablesByProcessInstanceIds(
      List<ProcessVariableDto> variableUpdates) {

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.flownode.duration.groupby.date.distributedby.process;
...
@Component
public class FlowNodeDurationGroupByFlowNodeEndDateByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeDurationGroupByFlowNodeEndDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

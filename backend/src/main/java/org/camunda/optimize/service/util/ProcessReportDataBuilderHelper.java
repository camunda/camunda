...
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessDistributedByCreator.createDistributedByFlowNode;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessDistributedByCreator.createDistributedByNone;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessDistributedByCreator.createDistributedByStartDateDto;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessDistributedByCreator.createDistributedByUserTasks;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessDistributedByCreator.createDistributedByVariable;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByAssignee;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByCandidateGroup;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByDuration;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByEndDateDto;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByFlowNode;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByNone;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByRunningDateDto;
import static org.camunda.optimize.service.db.es.report.command.process.util.ProcessGroupByDtoCreator.createGroupByStartDateDto;

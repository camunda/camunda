...
public abstract class AbstractZeebeRecordFetcher<T> {
    ...
    try {
      ...
      if (isZeebeInstanceIndexNotFoundException(e)) {
        ...
        final String errorMessage =
          String.format("Was not able to retrieve zeebe records of type %s from partition %s",
                        getBaseIndexName(),
                        partitionId);
  ...
  protected abstract List<T> fetchZeebeRecordsForPrefixAndPartitionFrom(final PositionBasedImportPage positionBasedImportPage) throws Exception;

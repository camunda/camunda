 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.flownode.frequency.groupby.variable.distributedby.process;
...
@Component
public class FlowNodeFrequencyGroupByVariableByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeFrequencyGroupByVariableByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

...
public class ExternalEventGraphService {
  ...
  public AutogeneratedEventGraphDto generateExternalEventGraph() {
    ...
    final List<EventTraceStateDto> traceSample = getTracedSample();
    return AutogeneratedEventGraphDto.builder()
      .startEvents(startEvents)
      .endEvents(endEvents)
      .adjacentEventTypesDtoMap(adjacentEventTypesDtoMap)
      .sampleAsTypeLists(getTracesAsTypeLists(traceSample))
      .build();
  }

  private List<EventTraceStateDto> getTracedSample() {
    return eventTraceStateService.getTracesWithMaxResultSize(MAX_SAMPLE_RESULTS);
  }

 ...
 */
package org.camunda.optimize.service.es.report.command.process.usertask.frequency.groupby.assignee.distributedby.process;
...
@Component
public class UserTaskFrequencyGroupByAssigneeDistributeByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskFrequencyGroupByAssigneeDistributeByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

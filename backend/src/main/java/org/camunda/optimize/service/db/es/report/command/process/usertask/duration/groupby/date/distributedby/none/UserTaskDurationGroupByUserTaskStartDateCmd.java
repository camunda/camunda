 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.date.distributedby.none;
...
@Component
public class UserTaskDurationGroupByUserTaskStartDateCmd extends ProcessCmd<List<MapResultEntryDto>> {

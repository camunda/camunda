...
public class IdentityLinkLogWriterES extends AbstractUserTaskWriterES
    implements IdentityLinkLogWriter {

  public IdentityLinkLogWriterES(
  ...
  protected String createInlineUpdateScript() {
    ...
    return substitutor.replace(
            ...
            "if (ctx._source.${flowNodesField} == null) ctx._source.${flowNodesField} = [];\n"
                ...
                + "} else {\n"
                +
                // 2.2 if it doesn't exist add it with id and assignee/candidate group operations
                // set

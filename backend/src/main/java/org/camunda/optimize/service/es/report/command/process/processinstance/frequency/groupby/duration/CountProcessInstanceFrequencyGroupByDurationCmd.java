...
@Component
public class CountProcessInstanceFrequencyGroupByDurationCmd extends ProcessCmd<List<MapResultEntryDto>> {

  public CountProcessInstanceFrequencyGroupByDurationCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

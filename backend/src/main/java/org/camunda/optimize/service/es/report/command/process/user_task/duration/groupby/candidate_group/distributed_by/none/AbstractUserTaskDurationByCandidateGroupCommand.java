...
public abstract class AbstractUserTaskDurationByCandidateGroupCommand
  ...
  protected SingleProcessMapDurationReportResult evaluate() {
    ...
    logger.debug(
      "Evaluating user task duration grouped by candidate group report for process definition key [{}] and versions [{}]",

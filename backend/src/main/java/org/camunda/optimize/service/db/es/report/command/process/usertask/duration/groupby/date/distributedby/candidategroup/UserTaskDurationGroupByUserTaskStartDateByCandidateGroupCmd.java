 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.date.distributedby.candidategroup;
...
@Component
public class UserTaskDurationGroupByUserTaskStartDateByCandidateGroupCmd
  extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByUserTaskStartDateByCandidateGroupCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.frequency.groupby.usertask.distributedby.assignee;
...
@Component
public class UserTaskFrequencyGroupByTaskByAssigneeCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

...
public class CompletedUserTaskInstanceWriterES extends AbstractUserTaskWriterES
    implements CompletedUserTaskInstanceWriter {

  public CompletedUserTaskInstanceWriterES(
  ...
  public List<ImportRequestDto> generateUserTaskImports(
    ...
    return super.generateUserTaskImports(
        "completed user task instances", esClient, userTaskInstances);
  }

...
public class UserTaskIdleDurationByCandidateGroupByUserTaskCommand
  extends AbstractUserTaskDurationByCandidateGroupByUserTaskCommand {


  public UserTaskIdleDurationByCandidateGroupByUserTaskCommand(final AggregationStrategy strategy) {
    super(strategy);
  }

...
public class ZeebeVariableFetcherOS
  extends AbstractZeebeRecordFetcherOS<ZeebeVariableRecordDto> implements ZeebeVariableFetcher {

  public ZeebeVariableFetcherOS(final int partitionId,

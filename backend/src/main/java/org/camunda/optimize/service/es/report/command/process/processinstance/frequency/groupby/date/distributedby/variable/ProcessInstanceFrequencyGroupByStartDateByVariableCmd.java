...
@Component
public class ProcessInstanceFrequencyGroupByStartDateByVariableCmd
  extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceFrequencyGroupByStartDateByVariableCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

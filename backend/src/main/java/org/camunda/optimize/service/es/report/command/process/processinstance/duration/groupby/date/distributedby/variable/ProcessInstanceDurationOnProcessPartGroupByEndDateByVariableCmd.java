...
@Component
public class ProcessInstanceDurationOnProcessPartGroupByEndDateByVariableCmd
  extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceDurationOnProcessPartGroupByEndDateByVariableCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

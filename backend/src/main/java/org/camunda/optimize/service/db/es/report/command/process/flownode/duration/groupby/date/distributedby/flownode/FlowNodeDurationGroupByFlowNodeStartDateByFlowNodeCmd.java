 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.flownode.duration.groupby.date.distributedby.flownode;
...
import org.camunda.optimize.service.db.es.report.command.modules.distributed_by.process.ProcessDistributedByFlowNode;
import org.camunda.optimize.service.db.es.report.command.modules.group_by.process.date.ProcessGroupByFlowNodeStartDate;
...
@Component
public class FlowNodeDurationGroupByFlowNodeStartDateByFlowNodeCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeDurationGroupByFlowNodeStartDateByFlowNodeCmd(

 ...
 */
package org.camunda.optimize.service.es.report.command.process.flownode.duration.groupby.variable.distributedby.process;
...
@Component
public class FlowNodeDurationByVariableByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeDurationByVariableByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

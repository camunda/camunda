...
@Component
public class ProcessInstanceDurationGroupByEndDateByVariableCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceDurationGroupByEndDateByVariableCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

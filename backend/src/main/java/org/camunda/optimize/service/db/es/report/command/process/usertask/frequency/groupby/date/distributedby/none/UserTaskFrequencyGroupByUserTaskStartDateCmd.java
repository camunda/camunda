 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.frequency.groupby.date.distributedby.none;
...
@Component
public class UserTaskFrequencyGroupByUserTaskStartDateCmd extends ProcessCmd<List<MapResultEntryDto>> {

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.flownode.frequency.groupby.flownode.distributedby.process;
...
import org.camunda.optimize.service.db.es.report.command.modules.group_by.process.flownode.ProcessGroupByFlowNode;
...
@Component
public class FlowNodeFrequencyGroupByFlowNodeByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeFrequencyGroupByFlowNodeByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

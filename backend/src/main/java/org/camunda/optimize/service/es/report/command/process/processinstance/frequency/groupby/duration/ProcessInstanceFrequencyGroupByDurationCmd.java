 ...
 */
package org.camunda.optimize.service.es.report.command.process.processinstance.frequency.groupby.duration;
...
@Component
public class ProcessInstanceFrequencyGroupByDurationCmd extends ProcessCmd<List<MapResultEntryDto>> {

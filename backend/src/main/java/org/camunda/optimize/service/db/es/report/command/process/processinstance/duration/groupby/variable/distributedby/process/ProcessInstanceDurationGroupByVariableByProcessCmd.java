 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.processinstance.duration.groupby.variable.distributedby.process;
...
@Component
public class ProcessInstanceDurationGroupByVariableByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceDurationGroupByVariableByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

 ...
 */
package org.camunda.optimize.service.es.report.command.process.flownode.frequency.groupby.date.distributedby.none;
...
@Component
public class FlowNodeFrequencyGroupByFlowNodeEndDateCmd extends ProcessCmd<List<MapResultEntryDto>> {

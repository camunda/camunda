...
public class AutogeneratedProcessModelService {
  ...
  public AutogeneratedProcessModelService(EventTraceStateServiceFactory eventTraceStateServiceFactory,
  ...
  public AutogeneratedProcessModelDto generateModelFromEventSources(List<EventSourceEntryDto> eventSources) {
    AutogeneratedEventGraphDto autogeneratedEventGraphDto = null;

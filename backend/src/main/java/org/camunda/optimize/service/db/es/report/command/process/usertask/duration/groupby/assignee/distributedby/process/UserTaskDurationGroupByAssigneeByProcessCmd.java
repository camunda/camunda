 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.assignee.distributedby.process;
...
@Component
public class UserTaskDurationGroupByAssigneeByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByAssigneeByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

...
//    final Map<OptimizeOpensearchClient, List<ImportRequestOsDto>> esClientToImportRequests = importRequestDtos.stream()
//
//      .collect(groupingBy(ImportRequestOsDto::getClient));

    //todo refactor it for opensearch
...
//        final Map<String, List<ImportRequestOsDto>> requestsByType = requestList.stream()
//          .collect(groupingBy(ImportRequestOsDto::getImportName));
...
//  }
//
//  public static boolean tryUpdateByQueryRequest(OptimizeOpensearchClient esClient,
...
//      throw new OptimizeRuntimeException(errorMessage, e);
  ...
  public static boolean tryDeleteByQueryRequest(OptimizeOpensearchClient osClient,
                                                Query queryBuilder,
                                                String deletedItemIdentifier,
                                                final boolean refresh,
                                                String... indices) {
...
//    });
    ...
    //todo handle here checking submiting delete task
//    final String taskId;
//    try {
//      taskId = osClient.submitDeleteTask(request).getTask();
//    } catch (IOException e) {
//
//    }
//

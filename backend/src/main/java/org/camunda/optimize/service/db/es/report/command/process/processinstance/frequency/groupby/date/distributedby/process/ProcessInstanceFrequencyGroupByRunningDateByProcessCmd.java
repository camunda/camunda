 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.processinstance.frequency.groupby.date.distributedby.process;
...
import org.camunda.optimize.service.db.es.report.command.modules.group_by.process.date.ProcessGroupByProcessInstanceRunningDate;
...
@Component
public class ProcessInstanceFrequencyGroupByRunningDateByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceFrequencyGroupByRunningDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

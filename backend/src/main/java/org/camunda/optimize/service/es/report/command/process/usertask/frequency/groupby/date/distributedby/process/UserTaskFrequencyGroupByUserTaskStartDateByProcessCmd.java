 ...
 */
package org.camunda.optimize.service.es.report.command.process.usertask.frequency.groupby.date.distributedby.process;
...
@Component
public class UserTaskFrequencyGroupByUserTaskStartDateByProcessCmd
  extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskFrequencyGroupByUserTaskStartDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

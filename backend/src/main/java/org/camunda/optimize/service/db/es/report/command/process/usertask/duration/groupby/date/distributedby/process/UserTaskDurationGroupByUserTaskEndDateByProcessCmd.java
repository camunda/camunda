 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.date.distributedby.process;
...
@Component
public class UserTaskDurationGroupByUserTaskEndDateByProcessCmd
  extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByUserTaskEndDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

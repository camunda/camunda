...
public class ProcessDefinitionManager {
  ...
  protected List<DefinitionImportInformation> availableProcessDefinitions = new ArrayList<>();
  protected OffsetDateTime timeToLoad = OffsetDateTime.now();
  ...
  protected boolean haveToReload() {
    return true;
  }
  ...
  public void reset() {
    this.timeToLoad = OffsetDateTime.now();
  }
}

package org.camunda.optimize.service.es.report.command.median;
...
public class MedianFlowNodeDurationByFlowNodeCommand extends FlowNodeGroupingCommand {
  ...
  protected MapReportResultDto evaluate() {
    ...
    logger.debug("Evaluating median flow node duration grouped by flow node report " +
        ...
        .subAggregation(
          filter(
            ...
            .subAggregation(AggregationBuilders
              ...
              .subAggregation(
                percentiles(MAX_DURATION_AGGREGATION)
                  .percentiles(50)
  ...
  private Map<String, Long> processAggregations(Aggregations aggregations) {
    ...
    for (Terms.Bucket b : terms.getBuckets()) {
      InternalTDigestPercentiles percentiles = b.getAggregations().get(MAX_DURATION_AGGREGATION);
      long roundedDuration = Math.round(percentiles.percentile(50));

...
public class CollectionWriterOS implements CollectionWriter {
  ...
  public void deleteScopeEntryFromAllCollections(final String scopeEntryId) {
    ...
    Script removeScopeEntryFromCollectionsScript = OpenSearchWriterUtil.createDefaultScriptWithPrimitiveParams(
    ...
    Query query = new NestedQuery.Builder()
      .path(DATA)
      .query(new NestedQuery.Builder()
               .path(String.join(".", DATA, SCOPE))
               .query(QueryDSL.term(String.join(".", DATA, SCOPE, CollectionScopeEntryDto.Fields.id.name()), scopeEntryId))
  ...
  public void removeScopeEntry(String collectionId, String scopeEntryId, String userId) throws NotFoundException {
    ...
    final Script updateEntityScript = OpenSearchWriterUtil.createDefaultScriptWithPrimitiveParams(
  ...
  private UpdateResponse executeUpdateRequest(final String collectionId,
                                              final Script updateEntityScript,
                                              final String errorMessage) {
    final UpdateRequest.Builder request = new UpdateRequest.Builder<>()
      .index(COLLECTION_INDEX_NAME)
      .id(collectionId)
  ...
  public void addRoleToCollection(String collectionId, List<CollectionRoleRequestDto> rolesToAdd, String userId) {
    ...
    final Script addEntityScript = OpenSearchWriterUtil.createDefaultScriptWithSpecificDtoParams(
  ...
  public void updateRoleInCollection(final String collectionId,
    ...
    final Script addEntityScript = OpenSearchWriterUtil.createDefaultScriptWithPrimitiveParams(
  ...
  @Override
  public void removeRoleFromCollectionUnlessIsLastManager(final String collectionId,
                                                          final String roleEntryId,
                                                          final String userId) throws OptimizeConflictException {
    final Map<String, JsonData> params = constructParamsForRoleUpdateScript(roleEntryId, userId);
  ...
  private void removeRoleFromCollectionUnlessIsLastManager(final String collectionId,
                                                           final String roleEntryId,
                                                           final Map<String, JsonData> params) throws OptimizeConflictException {
    log.debug("Deleting the role [{}] in collection with id [{}] in OpenSearch.", roleEntryId, collectionId);
    final Script addEntityScript = OpenSearchWriterUtil.createDefaultScriptWithPrimitiveParams(

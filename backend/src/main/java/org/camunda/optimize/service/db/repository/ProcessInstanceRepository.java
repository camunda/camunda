...
public interface ProcessInstanceRepository {
  void bulkImportProcessInstances(final String importItemName, final List<ProcessInstanceDto> processInstanceDtos);
  ...
  void deleteVariablesOfInstancesThatEndedBefore(String index, OffsetDateTime endDate, String updateItem);

  void deleteEventsWithIdsInFromAllInstances(String index, List<String> eventIdsToDelete, String updateItem);
}

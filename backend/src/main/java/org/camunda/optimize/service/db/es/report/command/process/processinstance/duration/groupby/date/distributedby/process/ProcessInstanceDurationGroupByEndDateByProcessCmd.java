...
@Component
public class ProcessInstanceDurationGroupByEndDateByProcessCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceDurationGroupByEndDateByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

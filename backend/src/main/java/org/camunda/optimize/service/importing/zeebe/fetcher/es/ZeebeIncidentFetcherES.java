...
public class ZeebeIncidentFetcherES
  extends AbstractZeebeRecordFetcherES<ZeebeIncidentRecordDto> implements ZeebeIncidentFetcher {

  public ZeebeIncidentFetcherES(final int partitionId,

...
@Component
public class CountDecisionInstanceFrequencyGroupByOutputVariableCmd extends DecisionCmd<List<MapResultEntryDto>> {

  public CountDecisionInstanceFrequencyGroupByOutputVariableCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

...
@Component
public class CountProcessInstanceFrequencyGroupByVariableByEndDateCmd extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public CountProcessInstanceFrequencyGroupByVariableByEndDateCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

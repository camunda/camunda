...
public class SearchableIdentityCacheTest {
  ...
  public void searchUserById() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities(userIdentity.getId()).getResult();
  ...
  public void searchUserById_exactIdMatchBoostedOverMatchesOnOtherFields() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities(userIdentity1.getId()).getResult();
  ...
  public void searchUserByFirstAndLastName() {
    ...
    final List<IdentityRestDto> searchResult =
  ...
  public void searchUserByPartialNameWinsOverPartialId() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities("fro").getResult();
    assertThat(searchResult.size(), is(2));
    assertThat(searchResult, contains(userIdentity1, userIdentity2));
  }
  ...
  public void searchUserByPartialNameWinsOverPartialEmail() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities("Frod").getResult();
    assertThat(searchResult.size(), is(2));
    assertThat(searchResult, contains(userIdentity1, userIdentity2));
  }
  ...
  public void searchUserByFullNameWinsOverPartialEmail() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities("Frodo").getResult();
    assertThat(searchResult.size(), is(2));
    assertThat(searchResult, contains(userIdentity1, userIdentity2));
  }
  ...
  public void searchGroupById() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities(group.getId()).getResult();
  ...
  public void searchGroupById_exactIdMatchBoostedOverMatchesOnOtherFields() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities(group1.getId()).getResult();
    assertThat(searchResult.size(), is(2));
  ...
  public void load100kUsersAndSearch() {
    ...
    final List<IdentityRestDto> searchResult = cache.searchIdentities("Cla").getResult();
  ...
  private void insert100kUsers() {
    ...
    final List<IdentityRestDto> users = lines.stream().parallel()
      .map(rawUser -> {
  ...
  private void verifyCaseInsensitiveSearchResults(final String searchTerm, final int expectedResultCount) {
    final List<IdentityRestDto> searchResult = cache.searchIdentities(searchTerm).getResult();
    assertThat(searchResult.size(), is(expectedResultCount));
    final List<IdentityRestDto> searchResultUpperCase = cache.searchIdentities(searchTerm.toUpperCase()).getResult();
    assertThat(searchResultUpperCase.size(), is(expectedResultCount));
    final List<IdentityRestDto> searchResultLowerCase = cache.searchIdentities(searchTerm.toLowerCase()).getResult();

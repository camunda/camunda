...
public enum ProcessReportDataType {
  ...
  USER_TASK_FREQUENCY_GROUP_BY_FLOW_NODE_BY_ASSIGNEE,
  USER_TASK_FREQUENCY_GROUP_BY_FLOW_NODE_BY_CANDIDATE_GROUP,
  ...
  USER_TASK_DURATION_GROUP_BY_FLOW_NODE_BY_ASSIGNEE,
  USER_TASK_DURATION_GROUP_BY_FLOW_NODE_BY_CANDIDATE_GROUP,

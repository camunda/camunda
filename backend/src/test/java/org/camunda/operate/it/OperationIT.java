...
public class OperationIT extends OperateZeebeIntegrationTest {
  ...
  public void testBatchOperationsPersisted() throws Exception {
    ...
    //when
    final ListViewQueryDto allRunningQuery = ListViewQueryDto.allRunning();
  ...
  public void testNoOperationsPersistedForNoWorkflowInstances() throws Exception {
    ...
    //when
    final MvcResult mvcResult = postBatchOperationWithOKResponse(ListViewQueryDto.allRunning(), OperationType.CANCEL_WORKFLOW_INSTANCE);
  ...
  public void testFailOperationAsTooManyInstances() throws Exception {
    ...
    //when
    final MvcResult mvcResult = postBatchOperation(ListViewQueryDto.allRunning(), OperationType.RESOLVE_INCIDENT, HttpStatus.SC_BAD_REQUEST);

...
public @interface ConditionalOnAuthenticationMethod {
  ...
  class AuthenticationMethodCondition implements Condition {
    private static final String PROPERTY = "camunda.auth.method";
    private static final AuthenticationMethod DEFAULT_METHOD = AuthenticationMethod.OIDC;
    ...
    public boolean matches(final ConditionContext context, final AnnotatedTypeMetadata metadata) {
      ...
      return AuthenticationMethod.parse(env.getProperty(PROPERTY)).orElse(DEFAULT_METHOD)

 ...
 */
package io.camunda.auth.spring.controller;

import static io.camunda.auth.spring.handler.CamundaOidcLogoutSuccessHandler.POST_LOGOUT_REDIRECT_ATTRIBUTE;
import static io.camunda.auth.spring.utils.RequestValidationUtils.isAllowedRedirect;

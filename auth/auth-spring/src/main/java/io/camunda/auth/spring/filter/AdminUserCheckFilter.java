...
public class AdminUserCheckFilter extends OncePerRequestFilter {
  ...
  private final AdminUserCheckProvider adminUserCheckProvider;

  public AdminUserCheckFilter(final AdminUserCheckProvider adminUserCheckProvider) {
    this.adminUserCheckProvider = adminUserCheckProvider;
  }
  ...
  protected void doFilterInternal(
    ...
    try {
      if (!adminUserCheckProvider.hasAdminUser()) {

...
import io.camunda.auth.domain.config.AssertionConfiguration;
import io.camunda.auth.domain.config.AssertionConfiguration.KidCase;
import io.camunda.auth.domain.config.AssertionConfiguration.KidDigestAlgorithm;
import io.camunda.auth.domain.config.AssertionConfiguration.KidSource;

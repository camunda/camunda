...
import static io.camunda.auth.domain.config.AssertionConfiguration.KidDigestAlgorithm.*;
import static io.camunda.auth.domain.config.AssertionConfiguration.KidEncoding.*;
import static io.camunda.auth.domain.config.AssertionConfiguration.KidSource.*;
...
public class AssertionConfiguration {
  ...
  public static class Builder {
    ...
    public Builder kidSource(final KidSource kidSource) {
      this.kidSource = kidSource;
      return this;
    }

    public Builder kidDigestAlgorithm(final KidDigestAlgorithm kidDigestAlgorithm) {
      this.kidDigestAlgorithm = kidDigestAlgorithm;
      return this;
    }

    public Builder kidEncoding(final KidEncoding kidEncoding) {
      this.kidEncoding = kidEncoding;
      return this;
    }

    public Builder kidCase(final KidCase kidCase) {
      this.kidCase = kidCase;
      return this;
    }

    public AssertionConfiguration build() {
      final var config = new AssertionConfiguration();

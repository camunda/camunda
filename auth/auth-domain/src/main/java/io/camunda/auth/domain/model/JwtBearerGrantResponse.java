...
/**
 * Represents the response from an OAuth2 JWT Bearer grant as defined by RFC 7523.
 *
 * <p>Contains only the base response fields — JWT Bearer grants do not return additional
 ...
 */
public record JwtBearerGrantResponse(
  ...
  public static final class Builder {
    ...
    public JwtBearerGrantResponse build() {
      return new JwtBearerGrantResponse(accessToken, tokenType, expiresIn, scope, issuedAt);
    }
  }
}

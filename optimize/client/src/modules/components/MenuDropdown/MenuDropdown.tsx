...
export default forwardRef(function MenuDropdown(
  ...
  return (
    <div {...rest} aria-owns={open ? id : undefined} className={classnames(className, 'MenuDropdown')}>
      <ListBox isOpen={open} size={size} disabled={disabled} invalid={invalid} invalidText={invalidText} ref={ref}>
        <button
          type="button"
          ref={buttonRef}

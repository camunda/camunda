...
/**
 * Renders a coloured Week-over-Week delta pill badge.
 *
 * @param {number} currentValue - the value for the current period
 * @param {number|null} priorValue - the value for the prior period (badge hidden when null)
 * @param {'ms'|'%'|''} unit - the unit of the values
 * @param {'up'|'down'} deltaGoodDirection - which direction means "improvement"
 */

...
public class ZeebeProcessDataGenerator {
  ...
  private List<String> requiredIndexNames() {
    return List.of(
        ...
        zeebeIndexName(ZEEBE_AGENT_INSTANCE_INDEX_NAME));
  }
  ...
  private InstanceBatches createWriteBatches(final ZeebeBulkWriter writer) {
    ...
    final ZeebeBulkWriter.IndexBatch agentInstanceBatch =
        writer.newBatch(zeebeIndexName(ZEEBE_AGENT_INSTANCE_INDEX_NAME));
    return new InstanceBatches(
        processInstanceBatch, variableBatch, userTaskBatch, incidentBatch, agentInstanceBatch);
  }
  ...
  private InstanceOps generateInstance(
    ...
    return new InstanceOps(
        processInstanceOps, variableOps, userTasksOps, incidentOps, agentInstanceOps);
  }
  ...
  private void logProgress(final int completedCount, final InstanceBatches writeBatches) {
    ...
    LOG.info(
        "Progress: {}/{} instances ({} %) — pi={}, var={}, ut={}, inc={}, agent={} records so far",
        completedCount,
        ...
        writeBatches.agentInstance().totalCount());
  }

  private void logCompletion(final InstanceBatches writeBatches) {
    LOG.info(
        "Generation complete: {} instances — pi={}, var={}, ut={}, inc={}, agent={} records inserted",
        config.instanceCount,
        ...
        writeBatches.agentInstance().flushedCount());
  }
  ...
  private record InstanceOps(
      ...
      List<BulkOperation> agentInstance) {}
  ...
  private record InstanceBatches(
      ...
      ZeebeBulkWriter.IndexBatch agentInstance) {
    ...
    void addAll(final InstanceOps ops) {
      ...
      agentInstance.addAll(ops.agentInstance());
    }
    ...
    private Stream<ZeebeBulkWriter.IndexBatch> all() {
      return Stream.of(processInstance, variable, userTask, incident, agentInstance);
    }
  }
}

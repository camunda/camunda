...
@Slf4j
public class Upgrade8713To8714PlanFactory implements UpgradePlanFactory {

  @Override
  public UpgradePlan createUpgradePlan(final UpgradeExecutionDependencies dependencies) {
    return UpgradePlanBuilder.createUpgradePlan().fromVersion("8.7.13").toVersion("8.7.14").build();
  }
}

...
public class ExampleDmn12DataGenerator extends DecisionDataGenerator {

  private static final String DMN_DIAGRAM = "/diagrams/decision/Example-DMN-1.2.dmn";
  ...
  public ExampleDmn12DataGenerator(final SimpleEngineClient engineClient, final Integer nVersions) {

...
#   BASE_IMAGE - required; Docker base image name (e.g. docker.io/library/alpine:3.19.1)
# Arguments:
...
if [ -z "${BASE_IMAGE}" ]; then
  echo >&2 "No BASE_IMAGE was given; make sure to pass a valid base image name, e.g. docker.io/library/alpine:3.19.1"
  exit 1
fi

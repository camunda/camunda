...
public class ConfigurationValidatorTest {
  ...
  public void dummyMethod() {
    // this test is needed to enforce maven into recognizing the need for the junit
    // dependencies in the optimize-commons/pom.xml.
    // The reason why the dependency is not being detected as used by maven is because
    // it is used reflectively by the jupiter engine, instead of by direct access to it.
    final JUnitException exception = null;
  }
}

...
public class EngineConfiguration {
  ...
  public boolean isEventImportEnabled() {
    return eventImportEnabled;
  }

  public void setEventImportEnabled(final boolean eventImportEnabled) {
    this.eventImportEnabled = eventImportEnabled;
  }
  ...
  public int hashCode() {
    ...
    result = result * PRIME + (isEventImportEnabled() ? 79 : 97);
  ...
  public boolean equals(final Object o) {
    ...
    if (isEventImportEnabled() != other.isEventImportEnabled()) {
      return false;
    }

...
public class FlatProcessInstanceIndexES extends FlatProcessInstanceIndex<IndexSettings.Builder> {

  public FlatProcessInstanceIndexES(final String processInstanceIndexKey) {

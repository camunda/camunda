...
public abstract class ProcessInstanceIndex<TBuilder> extends AbstractInstanceIndex<TBuilder> {
  ...
  public static final String AGENT_INSTANCE_END_DATE_EPOCH_MS =
      AgentInstanceDto.Fields.endDateEpochMs;
  public static final String AGENT_INSTANCE_ELEMENT_INSTANCE_KEYS =
      AgentInstanceDto.Fields.elementInstanceKeys;
                ...
                p.nested(
                    k ->
                        k.properties(AGENT_INSTANCE_ID, pp -> pp.keyword(kk -> kk))
                            ...
                            .properties(AGENT_INSTANCE_END_DATE_EPOCH_MS, pp -> pp.long_(kk -> kk))
                            .properties(
                                AGENT_INSTANCE_ELEMENT_INSTANCE_KEYS, pp -> pp.keyword(kk -> kk))
                            .properties(

...
public class FlatProcessInstanceIndexOS extends FlatProcessInstanceIndex<IndexSettings.Builder> {

  public FlatProcessInstanceIndexOS(final String processInstanceIndexKey) {

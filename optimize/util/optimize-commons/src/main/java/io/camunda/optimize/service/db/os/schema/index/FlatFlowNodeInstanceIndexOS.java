...
public class FlatFlowNodeInstanceIndexOS extends FlatFlowNodeInstanceIndex<IndexSettings.Builder> {

  public FlatFlowNodeInstanceIndexOS(final String flowNodeInstanceIndexKey) {

...
/**
 * A flattened user task document that combines process instance context with user task-specific
 * fields, for storing in the FlatUserTaskIndex.
 */
public class FlatUserTaskDto implements OptimizeDto {

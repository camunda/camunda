...
public class ProcessInstanceDto implements OptimizeDto {
  ...
  protected ProcessInstanceDto(final String processDefinitionKey,
      final String processDefinitionVersion,
      final String processDefinitionId, final String processInstanceId, final String businessKey,
      ...
      final List<IncidentDto> incidents, final DataSourceDto dataSource, final String tenantId) {
  ...
  public int hashCode() {
    ...
    result = result * PRIME + ($processDefinitionVersion == null ? 43
        : $processDefinitionVersion.hashCode());
  ...
  public boolean equals(final Object o) {
    ...
    if (this$processDefinitionVersion == null ? other$processDefinitionVersion != null
    ...
    if (this$incidents == null ? other$incidents != null
  ...
  public String toString() {
    return "ProcessInstanceDto(processDefinitionKey=" + getProcessDefinitionKey()
        + ", processDefinitionVersion=" + getProcessDefinitionVersion()
        + ", processDefinitionId=" + getProcessDefinitionId() + ", processInstanceId="
        + getProcessInstanceId() + ", businessKey=" + getBusinessKey() + ", startDate="
        + getStartDate() + ", endDate=" + getEndDate() + ", duration="
        + getDuration() + ", state=" + getState() + ", flowNodeInstances="
        + getFlowNodeInstances() + ", variables=" + getVariables() + ", incidents="
        + getIncidents() + ", dataSource=" + getDataSource() + ", tenantId="
        + getTenantId() + ")";
  }
  ...
  public static abstract class ProcessInstanceDtoBuilder<C extends ProcessInstanceDto, B extends ProcessInstanceDtoBuilder<C, B>> {
    ...
    public String toString() {
      return "ProcessInstanceDto.ProcessInstanceDtoBuilder(processDefinitionKey="
          ...
          + processDefinitionVersion + ", processDefinitionId=" + processDefinitionId
          + ", processInstanceId=" + processInstanceId + ", businessKey=" + businessKey
          + ", startDate=" + startDate + ", endDate=" + endDate + ", duration="
          + duration + ", state=" + state + ", flowNodeInstances$value="
          + flowNodeInstances$value + ", variables$value=" + variables$value
          + ", incidents$value=" + incidents$value + ", dataSource=" + dataSource
          + ", tenantId=" + tenantId + ")";
    }
  }

  private static final class ProcessInstanceDtoBuilderImpl extends
      ProcessInstanceDtoBuilder<ProcessInstanceDto, ProcessInstanceDtoBuilderImpl> {

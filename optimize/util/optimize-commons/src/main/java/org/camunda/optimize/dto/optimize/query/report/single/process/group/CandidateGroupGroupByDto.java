...
public class CandidateGroupGroupByDto extends ProcessGroupByDto<FlowNodesGroupByValueDto> {

  public CandidateGroupGroupByDto() {
    this.type = ProcessGroupByType.CANDIDATE_GROUP;
  }
}

...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.PROC_INST_DUR_GROUP_BY_VARIABLE_WITH_PART;
...
// import static
// io.camunda.optimize.test.util.DurationAggregationUtil.getAggregationTypesAsListForProcessParts;
...
// import
// io.camunda.optimize.dto.optimize.query.report.single.process.filter.RunningInstancesOnlyFilterDto;
...
//     engineDatabaseExtension.changeFirstFlowNodeInstanceEndDate(END_LOOP,
// startDate.plusSeconds(2));
//     importAllEngineEntitiesFromScratch();
//
//     // when
//     ProcessReportDataDto reportData =
...
//     assertThat(MapResultUtil.getEntryForKey(resultDto.getFirstMeasureData(),
// "1").get().getValue())
//         .isEqualTo(1000.);
//     assertThat(
...
//     // buckets span across all variable values (buckets are in descending order, so the first
// bucket
//     // is based on the
...
// activityStartDate.plusSeconds(activityDurationsInSec.get(0)));
//     endDatesToUpdate.put(
//         processInstanceDto2.getId(),
// activityStartDate.plusSeconds(activityDurationsInSec.get(1)));
//     endDatesToUpdate.put(
//         processInstanceDto3.getId(),
// activityStartDate.plusSeconds(activityDurationsInSec.get(2)));
//

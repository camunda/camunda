 ...
 */
package io.camunda.optimize.service.db.es.report.process.single.processinstance.frequency.groupby.none.distributedby;
...
import static io.camunda.optimize.service.util.ProcessReportDataType.PROC_INST_FREQ_GROUP_BY_NONE_BY_PROCESS;
...
public class ProcessInstanceFrequencyByNoneByProcessReportEvaluationIT extends AbstractPlatformIT {
  ...
  public void reportEvaluationWithMultipleProcessDefinitionSourcesWithOverlappingVersionBuckets() {
    ...
    ReportDataDefinitionDto latestVersionDef =
        createReportDefinition(
            v1instance.getProcessDefinitionKey(), latestDefinition, ReportConstants.LATEST_VERSION);

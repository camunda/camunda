...
// package
// io.camunda.optimize.service.db.es.report.process.single.flownode.duration.groupby.variable.distributedby.flownode;
//
...
// import static io.camunda.optimize.util.BpmnModels.CALL_ACTIVITY;
// import static io.camunda.optimize.util.BpmnModels.MULTI_INSTANCE_END;
// import static io.camunda.optimize.util.BpmnModels.MULTI_INSTANCE_START;
// import static io.camunda.optimize.util.BpmnModels.PARALLEL_GATEWAY;
...
//
// public class FlowNodeDurationByVariableByFlowNodeReportEvaluationIT
...
//         .isEqualTo(DistributedByType.FLOW_NODE);
//
...
//     // when
//     final ProcessReportDataDto reportData =
//         createReport(processDefinitionKey, "1", "doubleVar", VariableType.DOUBLE);
...
//     changeActivityDuration(processInstanceDto, 10.);
//
//     IntStream.range(1, numberOfInstances)
//         .forEach(
//             i -> {
...
//             10.0
//                 * 4
//                 * numberOfInstances); // each instance went through 4 flownodes which each took
// 10.0
//   }
//
//   @Test
...
//         createReport(definitionKey, "1", "testVar", VariableType.STRING);
//     final ReportResultResponseDto<List<HyperMapResultEntryDto>> result =
//         reportClient.evaluateHyperMapReport(reportData).getResult();
//
//     // then
...
//     final ProcessInstanceEngineDto processInstanceDto =
//         deployAndStartSimpleUserTaskProcess(Collections.singletonMap("stringVar",
// "aStringValue"));
//     changeActivityDuration(processInstanceDto, 10.);
//     importAllEngineEntitiesFromScratch();
//
...
//             BpmnModels.getSingleServiceTaskProcess(key1, SERVICE_TASK_ID_1));
...
//     // when
//     final ProcessReportDataDto reportData =
//         createReport(key1, ALL_VERSIONS, variableName, VariableType.STRING);
...
//         reportClient.evaluateHyperMapReport(reportData).getResult();
//
//     // then the result includes all flownodes of the latest version with instance durations from
// all
//     // versions
//     // @formatter:off
//     HyperMapAsserter.asserter()
...
//     final ProcessInstanceEngineDto thirdProcess =
//         deployAndStartSimpleProcessWithVariables(variables);
...
//     return Stream.of(
//         Arguments.of(IN, new String[] {DEFAULT_USERNAME}, Map.of(USER_TASK_1, 2000.)),
//         Arguments.of(
//             IN,
//             new String[] {DEFAULT_USERNAME, SECOND_USER, null},
//             Map.of(USER_TASK_1, 2000., USER_TASK_2, 3000., USER_TASK_3, 4000.)),
//         Arguments.of(
//             NOT_IN, new String[] {SECOND_USER}, Map.of(USER_TASK_1, 2000., USER_TASK_3, 4000.)),
//         Arguments.of(
//             NOT_IN, new String[] {DEFAULT_USERNAME, SECOND_USER}, Map.of(USER_TASK_3, 4000.)));
//   }
//
//   @ParameterizedTest
...
//     return Stream.of(
//         Arguments.of(IN, new String[] {FIRST_CANDIDATE_GROUP_ID}, Map.of(USER_TASK_1, 2000.)),
//         Arguments.of(
//             IN,

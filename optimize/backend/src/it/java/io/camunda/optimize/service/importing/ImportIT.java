...
//             () -> {
//               final String regex =
//                   "If you are experiencing failures due to too many nested documents, try
// carefully increasing the configured nested object limit
// \\((es|opensearch)\\.settings\\.index\\.nested_documents_limit\\) or enabling the skipping of
// documents that have reached this limit during import
// \\(import\\.skipDataAfterNestedDocLimitReached\\)\\. See Optimize documentation for details\\.";
...
//     // given a definition that was deleted in engine before it could be imported, but instance
// data
//     // remains in engine
//     embeddedOptimizeExtension
//         .getConfigurationService()
...
//         processDefinitionKey, nestedDocLimit,
// embeddedOptimizeExtension.getConfigurationService());
//   }
//

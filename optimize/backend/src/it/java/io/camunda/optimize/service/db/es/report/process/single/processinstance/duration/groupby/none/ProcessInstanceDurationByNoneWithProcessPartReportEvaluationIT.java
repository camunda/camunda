...
// package
// io.camunda.optimize.service.db.es.report.process.single.processinstance.duration.groupby.none;
//
...
//
//   /**
//    * When migrating from Optimize 2.1 to 2.2 then all the activity instances that were imported
// in
...
//     // when
//     final ProcessReportDataDto reportData = createReport("FOOPROCDEF", "1", START_EVENT,
// END_EVENT);
//
//     final ReportResultResponseDto<Double> resultDto =
//         reportClient.evaluateNumberReport(reportData).getResult();

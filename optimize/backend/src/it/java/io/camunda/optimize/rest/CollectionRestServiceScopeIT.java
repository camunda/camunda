...
//     addDecisionDefinitionToElasticsearch(decisionScope2.getDefinitionKey(),
// "DECISION_KEY_FIRST");
...
//     // when
//     collectionClient.addScopeEntryToCollection(collectionId, entry);
//     List<CollectionScopeEntryResponseDto> scope =
// collectionClient.getCollectionScope(collectionId);
//
//     // then
//     assertThat(scope)
...
//         .hasSize(2)
//         .extracting(
//             CollectionScopeEntryResponseDto::getId,
// CollectionScopeEntryResponseDto::getTenantIds)
...
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildAddScopeEntriesToCollectionRequest("unknownId",
...
//
//     // when
//     collectionClient.addScopeEntriesToCollection(collectionId, Lists.newArrayList(entry1,
// entry2));
//     List<CollectionScopeEntryResponseDto> scope =
// collectionClient.getCollectionScope(collectionId);
//
...
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildBulkDeleteScopeEntriesFromCollectionRequest(Collections.emptyList(),
// collectionId)
...
//     String message =
//         String.format(
//             "There was an error while deleting reports associated to collection scope with id %s.
// The scope cannot be "
//                 + "deleted.",
//             scopeEntry1.getId());

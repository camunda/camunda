...
import io.camunda.optimize.service.db.es.report.process.single.ModelElementFrequencyByModelElementDateByModelElementReportEvaluationIT;
  ...
  public static Stream<Arguments> viewLevelAssigneeFilterScenarios() {
    return Stream.of(
        Arguments.of(
            ...
            1L,
            Arrays.asList(Tuple.tuple(USER_TASK_1, null), Tuple.tuple(USER_TASK_2, 1.))),
        Arguments.of(
            IN,

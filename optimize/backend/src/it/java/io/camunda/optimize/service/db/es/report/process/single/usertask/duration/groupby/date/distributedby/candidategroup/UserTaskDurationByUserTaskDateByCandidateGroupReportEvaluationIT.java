...
public abstract class UserTaskDurationByUserTaskDateByCandidateGroupReportEvaluationIT
  ...
  public void reportEvaluationForOneProcessInstance() {
    ...
    HyperMapAsserter.asserter()
        ...
        .distributedByContains(
            FIRST_CANDIDATE_GROUP_ID, expectedDuration, FIRST_CANDIDATE_GROUP_NAME)
        .doAssert(result);
    // @formatter:on
  }
  ...
  public void reportEvaluationForMultipleProcessDefinitions() {
    ...
    HyperMapAsserter.asserter()
        ...
        .distributedByContains(
            FIRST_CANDIDATE_GROUP_ID, expectedDuration, FIRST_CANDIDATE_GROUP_NAME)
        .distributedByContains(
            SECOND_CANDIDATE_GROUP_ID, expectedDuration, SECOND_CANDIDATE_GROUP_NAME)
        .doAssert(result);
    // @formatter:on
  }
  ...
  private void updateUserTaskDateAndDuration(

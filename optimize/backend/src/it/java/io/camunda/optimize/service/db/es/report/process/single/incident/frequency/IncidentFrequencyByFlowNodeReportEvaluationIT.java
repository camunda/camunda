...
// package io.camunda.optimize.service.db.es.report.process.single.incident.frequency;
//
// import static io.camunda.optimize.dto.optimize.ReportConstants.ALL_VERSIONS;
// import static
// io.camunda.optimize.dto.optimize.query.report.single.process.filter.FilterApplicationLevel.INSTANCE;
// import static
...
// import static
// io.camunda.optimize.service.db.es.report.process.single.incident.duration.IncidentDataDeployer.IncidentProcessType.TWO_PARALLEL_TASKS;
// import static
...
// import static
// io.camunda.optimize.service.db.es.report.process.single.incident.duration.IncidentDataDeployer.PROCESS_DEFINITION_KEY;
// import static
...
//       Runnable startAndReturnProcessInstanceWithTwoIncidents) {
//     // given
...
//         .measure(ViewProperty.FREQUENCY)
//         .groupedByContains(END_EVENT, null, END_EVENT_NAME)
//         .groupedByContains(SERVICE_TASK_ID_1, (double) selectedTenants.size(),
// SERVICE_TASK_NAME_1)
//         .groupedByContains(START_EVENT, null, START_EVENT_NAME)
//         .doAssert(resultDto);
//     // @formatter:on
...
//     List<ProcessFilterDto<?>> runningProcessInstanceFilter =

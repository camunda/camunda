...
// package
// io.camunda.optimize.service.db.es.report.process.single.usertask.frequency.groupby.candidategroup.distributedby.usertask;
//
...
// import static io.camunda.optimize.util.BpmnModels.USER_TASK_3;
// import static io.camunda.optimize.util.BpmnModels.USER_TASK_4;
...
//
// public class UserTaskFrequencyByCandidateGroupByUserTaskReportEvaluationIT
...
//     final ProcessInstanceEngineDto processInstanceDto2 =
//         engineIntegrationExtension.startProcessInstance(processDefinition.getId());
//     // finish task 1 of instance 2 with second candidate group and leave task 2 of instance 2
//     // unassigned
//
// engineIntegrationExtension.addCandidateGroupForAllRunningUserTasks(SECOND_CANDIDATE_GROUP_ID);
...
//     assertThat(actualResult.getFirstMeasureData().get(0))
//         .isEqualTo(flowNodeStatusTestValues.expectedFrequencyValues);
//   }
//
//   @Test
...
//     // then
//     assertThat(actualResult.getFirstMeasureData()).hasSize(1);
//     assertThat(actualResult.getFirstMeasureData().get(0)).isEqualTo(getExpectedResultsMap(1.,
// 1.));
//   }
//
//   @Test
...
//         getFourUserTaskDiagram("aProcess"));
//   }
//

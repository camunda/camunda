...
//         performBranchAnalysis(processDefinition.getKey(),
...
// deploySimpleGatewayProcessDefinitionWithLoop();
//     startSimpleGatewayProcessAndTakeTask1(processDefinition);
//     importAllEngineEntitiesFromScratch();
//
//     // when
...
//     BranchAnalysisResponseDto result = performBranchAnalysis(processDefinition1.getKey(),
// versions);
//
//     // then
//     assertThat(result).isNotNull();
...
//     engineIntegrationExtension.startProcessInstance(instanceEngineDto.getDefinitionId(),
// variables);
//     importAllEngineEntitiesFromScratch();
//
//     // when
...
//     // when
//     Response response =
//         analysisClient.getProcessDefinitionCorrelationRawResponse(new
...
//   }
//
//   private void startSimpleGatewayProcessAndTakeTask2(ProcessDefinitionEngineDto
// processDefinition) {
//     Map<String, Object> variables = new HashMap<>();

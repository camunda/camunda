...
//
//     // when
//     ProcessReportDataDto reportData = createReportData(procInstance1, VariableType.DATE,
// "dateVar");
...
//                   .isEqualTo(1000.);
//               assertThat(
//                       resultEntries.get(NUMBER_OF_DATA_POINTS_FOR_AUTOMATIC_INTERVAL_SELECTION -
// 1))
//                   .extracting(MapResultEntryDto::getValue)
//                   .isEqualTo(2000.);
//             });
...
//
//     // then
//     final ZonedDateTime startOfToday = truncateToStartOfUnit(OffsetDateTime.now(),
// ChronoUnit.DAYS);
//     // @formatter:off
//     HyperMapAsserter.asserter()

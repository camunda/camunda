...
// identityClient.searchForIdentity("frodo");
//
//     // then
...
//     // when
//     final IdentitySearchResultResponseDto searchResult =
// identityClient.searchForIdentity("hobbit");
//
//     // then
//     assertThat(searchResult)
...
//     embeddedOptimizeExtension
//         .getIdentityService()
//         .addIdentity(new UserDto("otherUser", "Frodo", "NotAHobbit",
// "not.a.hobbit@camunda.com"));
//
//     // when
//     final IdentitySearchResultResponseDto searchResult =
...
//         .isEqualTo(
//             new IdentitySearchResultResponseDto(Lists.newArrayList(userIdentity,
// groupIdentity)));
//   }
//
//   @Test
...
//     // then
//     assertThat(searchResult)
//         // user is first as name and email contains baggins, empty user is second because name ==
// id
//         // and is `testUser2`

...
// import static
// io.camunda.optimize.service.db.DatabaseConstants.EVENT_PROCESS_INSTANCE_INDEX_PREFIX;
...
// FlowNodeInstanceDto::getCanceled)
//                   .containsExactlyInAnyOrder(
//                       Tuple.tuple(BPMN_START_EVENT_ID, false), Tuple.tuple(USER_TASK_ID_ONE,
// true));
//             });
//   }
//
...
//     // Since we're not really creating a new index here, but just instantiating it in order to
// get
//     // the name, it's not

...
//                   // this could happen in a real world scenario if the progress does not get
// updated
...
//                   // no pending updates should be present as all adjacent updates could get
// merged
...
//                               MappedEventType.END, ImmutableSet.of(firstEventId))),
//                       new EventCorrelationStateDto(
//                           ImmutableMap.of(MappedEventType.START,
// ImmutableSet.of(secondEventId))),
//                       new EventCorrelationStateDto(
//                           ImmutableMap.of(
//                               MappedEventType.START, ImmutableSet.of(thirdEventId),

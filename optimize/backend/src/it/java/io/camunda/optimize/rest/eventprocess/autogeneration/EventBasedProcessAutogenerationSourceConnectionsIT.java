...
// // // import static
// io.camunda.optimize.service.util.EventDtoBuilderUtil.createCamundaEventTypeDto;
// // // import static
// io.camunda.optimize.service.util.EventModelBuilderUtil.generateConnectionGatewayIdForDefinitionKey;
// // // import static
// io.camunda.optimize.service.util.EventModelBuilderUtil.generateModelGatewayIdForSource;
// // // import static
...
// // //             firstModelInstance, EventScopeType.START_END);
...
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             secondModelInstance, EventScopeType.START_END);
...
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             firstModelInstance, EventScopeType.START_END);
// // //     final EventTypeDto firstStart1 =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, START_EVENT_ID_1, START_EVENT_ID_1);
// // //     final EventTypeDto firstStart2 =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, START_EVENT_ID_2, START_EVENT_ID_2);
// // //     final EventTypeDto firstEnd1 =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, END_EVENT_ID_1, END_EVENT_ID_1);
// // //     final EventTypeDto firstEnd2 =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, END_EVENT_ID_2, END_EVENT_ID_2);
// // //
// // //     BpmnModelInstance secondModelInstance = multipleStartMultipleEndModel(PROCESS_ID_2);
// // //     final CamundaEventSourceEntryDto secondCamundaSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             secondModelInstance, EventScopeType.START_END);
// // //     final EventTypeDto secondStart1 =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, START_EVENT_ID_1, START_EVENT_ID_1);
// // //     final EventTypeDto secondStart2 =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, START_EVENT_ID_2, START_EVENT_ID_2);
// // //     final EventTypeDto secondEnd1 =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_1, END_EVENT_ID_1);
// // //     final EventTypeDto secondEnd2 =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_2, END_EVENT_ID_2);
// // //
// // //     final List<EventSourceEntryDto<?>> sources =
// // //         Arrays.asList(firstCamundaSource, secondCamundaSource);
...
// // //             secondEnd2));
// // //
// // //     // 4 additional gateways exist in the source models, plus a single gateway to connect
// two source
// // //     // models
// // //     assertThat(generatedInstance.getModelElementsByType(FlowNode.class))
// // //         .hasSize(mappings.size() + 6);
// // //
// // //     // then the model elements are of the correct type and connected to expected nodes
// correctly
// // //     final String convergingId1 = generateModelGatewayIdForSource(firstCamundaSource,
// Converging);
// // //     final String divergingId1 = generateModelGatewayIdForSource(firstCamundaSource,
// Diverging);
// // //     final String convergingId2 = generateModelGatewayIdForSource(secondCamundaSource,
// Converging);
// // //     final String divergingId2 = generateModelGatewayIdForSource(secondCamundaSource,
// Diverging);
// // //     // The previous source is responsible for creating the converging connecting gateway so
// the ID
// // //     // uses its
// // //     // definition key
// // //     final String connectingId1 =
// // //         generateConnectionGatewayIdForDefinitionKey(
// // //             Converging, firstCamundaSource.getConfiguration().getProcessDefinitionKey());
// // //     // The next source is responsible for creating the diverging connecting gateway so the
// ID uses
// // //     // its definition key
// // //     final String connectingId2 =
// // //         generateConnectionGatewayIdForDefinitionKey(
// // //             Diverging, secondCamundaSource.getConfiguration().getProcessDefinitionKey());
// // //     assertNodeConnection(
// // //         idOf(firstStart1), START_EVENT, convergingId1, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(firstStart2), START_EVENT, convergingId1, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         convergingId1, EXCLUSIVE_GATEWAY, divergingId1, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         divergingId1, EXCLUSIVE_GATEWAY, idOf(firstEnd1), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         divergingId1, EXCLUSIVE_GATEWAY, idOf(firstEnd2), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(firstEnd1), INTERMEDIATE_EVENT, connectingId1, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(firstEnd2), INTERMEDIATE_EVENT, connectingId1, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         connectingId1, EXCLUSIVE_GATEWAY, connectingId2, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         connectingId2,
// // //         EXCLUSIVE_GATEWAY,
...
// // //         generatedInstance);
// // //     assertNodeConnection(
// // //         convergingId2, EXCLUSIVE_GATEWAY, divergingId2, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         divergingId2, EXCLUSIVE_GATEWAY, idOf(secondEnd1), END_EVENT, generatedInstance);
// // //     assertNodeConnection(
// // //         divergingId2, EXCLUSIVE_GATEWAY, idOf(secondEnd2), END_EVENT, generatedInstance);
...
// // //         generatedInstance.getModelElementsByType(Gateway.class);
...
// // //   @Test
// // //   public void
// // //       createFromTwoCamundaSources_camundaSourceHasNoEndEvents_canStillConnectToNextSource()
// {
// // //     BpmnModelInstance firstModelInstance = singleStartNoEndModel();
// // //     final CamundaEventSourceEntryDto noEndEventSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             firstModelInstance, EventScopeType.START_END);
// // //     final EventTypeDto firstStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, START_EVENT_ID_1, START_EVENT_ID_1);
...
// // //     BpmnModelInstance secondModelInstance =
// // //         singleStartSingleEndModel(PROCESS_ID_2, START_EVENT_ID_2, END_EVENT_ID_2);
// // //     final CamundaEventSourceEntryDto endEventSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             secondModelInstance, EventScopeType.START_END);
// // //     final EventTypeDto secondStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, START_EVENT_ID_2, START_EVENT_ID_2);
...
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_2, END_EVENT_ID_2);
// // //
// // //     final List<EventSourceEntryDto<?>> sources = Arrays.asList(noEndEventSource,
// endEventSource);
// // //     final EventProcessMappingCreateRequestDto createRequestDto =
// // //         buildAutogenerateCreateRequestDto(sources);
// // //
...
// // //     // then the mappings contain the correct events and are all in the model
// // //     assertCorrectMappingsAndContainsEvents(
// // //         mappings, generatedInstance, Arrays.asList(firstStart, secondStart, secondEnd));
// // //
// assertThat(generatedInstance.getModelElementsByType(FlowNode.class)).hasSize(mappings.size());
// // //
// // //     // then the model elements are of the correct type and connected to expected nodes
// correctly
// // //     assertNodeConnection(
// // //         idOf(firstStart), START_EVENT, idOf(secondStart), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(secondStart), INTERMEDIATE_EVENT, idOf(secondEnd), END_EVENT,
// generatedInstance);
...
// // //   public void
// // //
// createFromTwoCamundaSources_camundaSourceHasNoEndEvents_canStillExistAtEndOfGeneratedModel() {
// // //     BpmnModelInstance firstModelInstance =
// // //         singleStartSingleEndModel(PROCESS_ID_2, START_EVENT_ID_2, END_EVENT_ID_2);
// // //     final CamundaEventSourceEntryDto endEventSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
...
// // //         createCamundaEventTypeDto(PROCESS_ID_1, START_EVENT_ID_1, START_EVENT_ID_1);
// // //
// // //     final List<EventSourceEntryDto<?>> sources = Arrays.asList(endEventSource,
// noEndEventSource);
// // //     final EventProcessMappingCreateRequestDto createRequestDto =
// // //         buildAutogenerateCreateRequestDto(sources);
// // //
...
// // //     assertNodeConnection(idOf(secondStart), INTERMEDIATE_EVENT, null, null,
// generatedInstance);
// // //
// // //     // and the expected number of sequence flows exist
// // //     assertThat(generatedInstance.getModelElementsByType(SequenceFlow.class)).hasSize(2);
...
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_2, END_EVENT_ID_2);
// // //
// // //     // We supply the second source before the first, even though the instance started
// after, to make
// // //     // sure
...
// assertThat(generatedInstance.getModelElementsByType(FlowNode.class)).hasSize(mappings.size());
// // //
// // //     // then the model elements are sequenced by source in order of the start date of the
// instance of
// // //     // the correlated
// // //     // value
// // //     assertNodeConnection(
...
// // //   @Test
// // //   public void
// createFromTwoCamundaSources_bothSourcesWithInstancesWithNoCommonCorrelatingValue() {
// // //     BpmnModelInstance firstModelInstance =
// // //         singleStartSingleEndModel(PROCESS_ID_1, START_EVENT_ID_1, END_EVENT_ID_1);
// // //     final CamundaEventSourceEntryDto firstCamundaSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             firstModelInstance, EventScopeType.START_END, "businessKey1");
// // //     final EventTypeDto firstStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, START_EVENT_ID_1, START_EVENT_ID_1);
// // //     final EventTypeDto firstEnd =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, END_EVENT_ID_1, END_EVENT_ID_1);
...
// // //     final CamundaEventSourceEntryDto secondCamundaSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             secondModelInstance, EventScopeType.START_END, "businessKey2");
// // //     final EventTypeDto secondStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, START_EVENT_ID_2, START_EVENT_ID_2);
// // //     final EventTypeDto secondEnd =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_2, END_EVENT_ID_2);
...
// // //   public void
// // //
// createFromMultipleCamundaSources_correlationValueNotAlwaysPresent_useSecondaryPlacingBeforePlacedSource() {
// // //     // the first and second sources have instances that can be correlated together by
// business key
...
// // //         deployDefinitionWithInstance(secondModelInstance, Collections.emptyMap(),
// firstBusinessKey);
// // //     final CamundaEventSourceEntryDto secondCamundaSource =
...
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_2, END_EVENT_ID_2);
// // //
// // //     // the second and third sources have instances that can be correlated together by
// another
// // //     // business key
...
// // //     final CamundaEventSourceEntryDto thirdCamundaSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             thirdModelInstance, EventScopeType.START_END, secondBusinessKey);
// // //     final EventTypeDto thirdStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_3, START_EVENT_ID_3, START_EVENT_ID_3);
// // //     final EventTypeDto thirdEnd =
// // //         createCamundaEventTypeDto(PROCESS_ID_3, END_EVENT_ID_3, END_EVENT_ID_3);
// // //
// // //     engineIntegrationExtension.startProcessInstance(
// // //         secondInstanceEngineDto.getDefinitionId(), Collections.emptyMap(),
// secondBusinessKey);
...
// // //     final List<EventSourceEntryDto<?>> sources =
// // //         Arrays.asList(thirdCamundaSource, secondCamundaSource, firstCamundaSource);
// // //     final EventProcessMappingCreateRequestDto createRequestDto =
// // //         buildAutogenerateCreateRequestDto(sources);
// // //
// // //     // when
...
// // //   public void
// // //
// createFromMultipleCamundaSources_correlationValueNotAlwaysPresent_useSecondaryPlacingAfterPlacedSource() {
// // //     // the first and second sources have instances that can be correlated together by
// business key
// // //     final String firstBusinessKey = "businessKey1";
// // //     BpmnModelInstance firstModelInstance =
...
// // //         deployDefinitionWithInstance(firstModelInstance, Collections.emptyMap(),
// firstBusinessKey);
// // //     final CamundaEventSourceEntryDto firstCamundaSource =
// // //         createCamundaSourceEntry(
// // //             firstInstanceEngineDto.getProcessDefinitionKey(), EventScopeType.START_END);
// // //     final EventTypeDto firstStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, START_EVENT_ID_1, START_EVENT_ID_1);
// // //     final EventTypeDto firstEnd =
// // //         createCamundaEventTypeDto(PROCESS_ID_1, END_EVENT_ID_1, END_EVENT_ID_1);
...
// // //     final CamundaEventSourceEntryDto secondCamundaSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             secondModelInstance, EventScopeType.START_END, firstBusinessKey);
// // //     final EventTypeDto secondStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, START_EVENT_ID_2, START_EVENT_ID_2);
// // //     final EventTypeDto secondEnd =
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_2, END_EVENT_ID_2);
// // //
// // //     // the first and third sources have instances that can be correlated together by
// another
// // //     // business key
// // //     final String secondBusinessKey = "businessKey2";
// // //     engineIntegrationExtension.startProcessInstance(
// // //         firstInstanceEngineDto.getDefinitionId(), Collections.emptyMap(),
// secondBusinessKey);
// // //     importAllEngineEntitiesFromLastIndex();
// // //
// // //     BpmnModelInstance thirdModelInstance =
...
// // //         createCamundaEventTypeDto(PROCESS_ID_2, END_EVENT_ID_2, END_EVENT_ID_2);
// // //
// // //     // We supply the sources in a different order than we expect them to appear, to make
// sure the
// // //     // order determination
// // //     // is being applied
// // //     final List<EventSourceEntryDto<?>> sources =
// // //         Arrays.asList(
// // //             secondCamundaSource, firstCamundaSource,
...
// // //     // value
// // //     assertNodeConnection(
// // //         idOf(EVENT_A), START_EVENT, idOf(EVENT_B), INTERMEDIATE_EVENT, generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, idOf(firstStart), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(firstStart),
// // //         INTERMEDIATE_EVENT,
...
// // //     final List<EventSourceEntryDto<?>> sources =
// // //         Arrays.asList(
// // //             secondCamundaSource, createExternalEventAllGroupsSourceEntry(),
// firstCamundaSource);
// // //     final EventProcessMappingCreateRequestDto createRequestDto =
// // //         buildAutogenerateCreateRequestDto(sources);
// // //
...
// // //         generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(secondEnd), INTERMEDIATE_EVENT, idOf(EVENT_A), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_A), INTERMEDIATE_EVENT, idOf(EVENT_B), END_EVENT, generatedInstance);
...
// // //   public void
// // //
// createFromMultipleCamundaSources_correlationValueNotPresentInInstancesOfAllSources_defaultEndPlacing() {
// // //     BpmnModelInstance firstModelInstance =
// // //         singleStartSingleEndModel(PROCESS_ID_1, START_EVENT_ID_1, END_EVENT_ID_1);
// // //     final String businessKey = "businessKey1";
// // //     final CamundaEventSourceEntryDto firstCamundaSource =
...
// // //     BpmnModelInstance thirdModelInstance =
// // //         singleStartSingleEndModel(PROCESS_ID_3, START_EVENT_ID_3, END_EVENT_ID_3);
// // //     // This uses a different business key so can't be correlated by instance and should be
// placed at
// // //     // the end
// // //     final CamundaEventSourceEntryDto thirdCamundaSource =
// // //         deployDefinitionWithInstanceAndCreateEventSource(
// // //             thirdModelInstance, EventScopeType.START_END, "someOtherBusinessKey");
// // //     final EventTypeDto thirdStart =
// // //         createCamundaEventTypeDto(PROCESS_ID_3, START_EVENT_ID_3, START_EVENT_ID_3);
// // //     final EventTypeDto thirdEnd =
// // //         createCamundaEventTypeDto(PROCESS_ID_3, END_EVENT_ID_3, END_EVENT_ID_3);
...
// // //         generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(thirdStart), INTERMEDIATE_EVENT, idOf(thirdEnd), END_EVENT,
// generatedInstance);

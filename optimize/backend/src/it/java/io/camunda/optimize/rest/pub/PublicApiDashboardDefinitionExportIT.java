...
// // import io.camunda.optimize.service.entities.dashboard.AbstractDashboardDefinitionExportIT;
...
// //     setAccessToken();
// //     return publicApiClient.exportDashboardsAndReturnExportDtos(
// //         Collections.singletonList(dashboardId), ACCESS_TOKEN);
// //   }
// //
// //   @Override
// //   protected Response exportDashboardDefinitionAndReturnResponse(final String dashboardId) {
// //     setAccessToken();
// //     return publicApiClient.exportDashboardDefinitions(
// //         Collections.singletonList(dashboardId), ACCESS_TOKEN);
// //   }
// //
// //   @Test
...
// //         reportClient.getSingleProcessReportById(processReportId);
// //     final SingleProcessReportDefinitionExportDto expectedProcess =
// createExportDto(processReport1);
// //
...
// //         publicApiClient.exportDashboardsAndReturnExportDtos(
// //             List.of(dashboardId1, dashboardId2), ACCESS_TOKEN);
// //
...
// //     assertThat(exportedDtos)
// //         .filteredOn(dto ->
// ExportEntityType.SINGLE_PROCESS_REPORT.equals(dto.getExportEntityType()))
// //         .singleElement()
...
// //     final SingleProcessReportDefinitionRequestDto report2 =
...
// //
// //     final DashboardDefinitionRestDto dashboardDef1 =
// //         createDashboardDefinition(Collections.singletonList(reportId1));
// //     final String dashboardId1 = dashboardClient.createDashboard(dashboardDef1);
// //     dashboardDef1.setId(dashboardId1);
// //     final DashboardDefinitionExportDto expectedDashboard1 = createExportDto(dashboardDef1);
// //     final DashboardDefinitionRestDto dashboardDef2 =
// //         createDashboardDefinition(List.of(reportId1, reportId2));
// //     final String dashboardId2 = dashboardClient.createDashboard(dashboardDef2);
// //     dashboardDef2.setId(dashboardId2);
// //     final DashboardDefinitionExportDto expectedDashboard2 = createExportDto(dashboardDef2);
// //
...
// //             Collections.singletonList(createSimpleReport(ReportType.PROCESS)));
...
// //     final List<OptimizeEntityExportDto> exportedDtos =
// //         publicApiClient.exportDashboardsAndReturnExportDtos(
// //             List.of(dashboardId1, dashboardId1), ACCESS_TOKEN);
// //

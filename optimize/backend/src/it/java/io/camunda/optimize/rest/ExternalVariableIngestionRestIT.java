...
// ingestionClient.ingestVariablesAndReturnResponse(variablesToIngest);
//
//     // then
...
//     final List<ExternalProcessVariableDto> actualVariables =
// getAllStoredExternalProcessVariables();

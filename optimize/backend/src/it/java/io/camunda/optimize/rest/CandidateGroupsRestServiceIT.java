...
public class CandidateGroupsRestServiceIT extends AbstractPlatformIT {
  ...
  public void getCandidateGroupById() {
    ...
    final List<GroupDto> candidateGroups =
        candidateGroupClient.getCandidateGroupsByIdsWithoutAuthentication(
            ImmutableList.of(CANDIDATE_GROUP_ID_IMPOSTERS));
  ...
  public void getCandidateGroupsByIds() {
    ...
    assertThat(candidateGroups)
        ...
        .containsExactlyInAnyOrder(
            CANDIDATE_GROUP_NAME_IMPOSTERS, CANDIDATE_GROUP_NAME_CREW_MEMBERS);
  }
  ...
  public void searchForCandidateGroups_forDefinition_unauthorized() {
    ...
    final Response response =
        embeddedOptimizeExtension
            ...
            .buildSearchForCandidateGroupsRequest(
                AssigneeCandidateGroupDefinitionSearchRequestDto.builder().build())
            .execute();
  ...
  public void searchForCandidateGroups_forReports_unauthorized() {
    ...
    final Response response =
        embeddedOptimizeExtension
            ...
            .withoutAuthentication()
            .buildSearchForCandidateGroupsRequest(
                AssigneeCandidateGroupReportSearchRequestDto.builder().build())
            .execute();
  ...
  public void searchForCandidateGroupsNoSearchTerm_forDefinition() {
    ...
    final IdentitySearchResultResponseDto searchResponse =
        candidateGroupClient.searchForCandidateGroups(
  ...
  public void searchForCandidateGroupsNoSearchTerm_otherProcessCandidateGroupIsFiltered() {
    ...
    startSimpleUserTaskProcessWithCandidateGroupAndImport(
        definitionKey1, CANDIDATE_GROUP_ID_IMPOSTERS);
    final String definitionKey2 = "otherProcess";
    engineIntegrationExtension.createGroup(
        CANDIDATE_GROUP_ID_CREW_MEMBERS, CANDIDATE_GROUP_NAME_CREW_MEMBERS);
    startSimpleUserTaskProcessWithCandidateGroupAndImport(
        definitionKey2, CANDIDATE_GROUP_ID_CREW_MEMBERS);
    ...
    final IdentitySearchResultResponseDto searchResponse =
        candidateGroupClient.searchForCandidateGroups(
            AssigneeCandidateGroupDefinitionSearchRequestDto.builder()
                ...
                .build());
    final IdentitySearchResultResponseDto otherDefinitionSearchResponse =
        candidateGroupClient.searchForCandidateGroups(
            AssigneeCandidateGroupDefinitionSearchRequestDto.builder()
    ...
    assertThat(searchResponse.getResult())
        .singleElement()
        .isEqualTo(new GroupDto(CANDIDATE_GROUP_ID_IMPOSTERS, CANDIDATE_GROUP_NAME_IMPOSTERS));
    ...
    final IdentitySearchResultResponseDto searchResponse =
        candidateGroupClient.searchForCandidateGroups(
            AssigneeCandidateGroupReportSearchRequestDto.builder()
                ...
                .build());
    final IdentitySearchResultResponseDto otherReportSearchResponse =
        candidateGroupClient.searchForCandidateGroups(
            AssigneeCandidateGroupReportSearchRequestDto.builder()
  ...
  public void searchForCandidateGroupsNoSearchTerm_forDefinition_tenantAssigneeIsFiltered() {
    ...
    // when
    final IdentitySearchResultResponseDto noTenantSearchResponse =
        candidateGroupClient.searchForCandidateGroups(
            AssigneeCandidateGroupDefinitionSearchRequestDto.builder()
                .processDefinitionKey(processInstanceEngineDto.getProcessDefinitionKey())
                .build());
    final IdentitySearchResultResponseDto tenant1SearchResponse =
        candidateGroupClient.searchForCandidateGroups(
            AssigneeCandidateGroupDefinitionSearchRequestDto.builder()
                .processDefinitionKey(processInstanceEngineDto.getProcessDefinitionKey())
  ...
  public void searchForCandidateGroupsNoSearchTerm_forReports_tenantAssigneeIsFiltered() {
    ...
    final String reportId2 =
        reportClient.createAndStoreProcessReport(
            instance.getProcessDefinitionKey(), Collections.singletonList(tenant1));
  ...
  public void searchForCandidateGroupsWithSearchTerm_forReports_groupNotInEngine() {
    ...
    assertThat(searchResponse.getResult())
        .singleElement()
        .isEqualTo(new GroupDto(candidateGroupNotInEngine, candidateGroupNotInEngine));
  }
  ...
  public void searchForCandidateGroupsWithSearchTerm_otherProcessCandidateGroupIsFiltered() {
    ...
    engineIntegrationExtension.createGroup(
        CANDIDATE_GROUP_ID_CREW_MEMBERS, CANDIDATE_GROUP_NAME_CREW_MEMBERS);
    startSimpleUserTaskProcessWithCandidateGroupAndImport(
        "otherProcess", CANDIDATE_GROUP_ID_CREW_MEMBERS);
  ...
  private ProcessInstanceEngineDto startSimpleUserTaskProcessWithCandidateGroupAndImport(
      final String candidateGroup) {
    return startSimpleUserTaskProcessWithCandidateGroupAndImport("key", candidateGroup);
  }

  private ProcessInstanceEngineDto startSimpleUserTaskProcessWithCandidateGroupAndImport(
      final String definitionKey, final String candidateGroup) {
    return startSimpleUserTaskProcessWithCandidateGroupAndImport(
        definitionKey, candidateGroup, null);
  }

  private ProcessInstanceEngineDto startSimpleUserTaskProcessWithCandidateGroupAndImport(
      final String definitionKey, final String candidateGroup, final String tenantId) {
    final ProcessInstanceEngineDto processInstanceEngineDto =
        engineIntegrationExtension.deployAndStartProcess(
            BpmnModels.getUserTaskDiagramWithCandidateGroup(definitionKey, candidateGroup),
            tenantId);

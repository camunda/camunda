...
//
// import static
// io.camunda.optimize.service.db.DatabaseConstants.ZEEBE_PROCESS_DEFINITION_INDEX_NAME;
...
//     final Process secondVersion =
// deployProcessAndStartInstance(createStartEndProcess(processName));
//     waitUntilNumberOfDefinitionsExported(2);
//
//     // when
//     importAllZeebeEntitiesFromScratch();
...
// DefinitionOptimizeResponseDto::getVersion)
//         .containsExactlyInAnyOrder(
//             Tuple.tuple(

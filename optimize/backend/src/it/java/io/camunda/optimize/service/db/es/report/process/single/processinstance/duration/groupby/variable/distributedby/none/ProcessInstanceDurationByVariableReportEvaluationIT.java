...
import static io.camunda.optimize.service.util.ProcessReportDataType.PROC_INST_FREQ_GROUP_BY_VARIABLE;
...
public class ProcessInstanceDurationByVariableReportEvaluationIT
  ...
  public void groupByDateVariableWorksForAutomaticInterval() {
    ...
    // bucket span covers the values of all date variables (buckets are in descending order, so the
    // first bucket is

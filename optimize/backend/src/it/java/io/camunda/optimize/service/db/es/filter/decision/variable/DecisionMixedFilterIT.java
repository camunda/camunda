...
import static io.camunda.optimize.test.util.decision.DecisionFilterUtilHelper.createBooleanOutputVariableFilter;
import static io.camunda.optimize.test.util.decision.DecisionFilterUtilHelper.createFixedDateInputVariableFilter;
import static io.camunda.optimize.test.util.decision.DecisionFilterUtilHelper.createNumericInputVariableFilter;
...
public class DecisionMixedFilterIT extends AbstractDecisionDefinitionIT {
  ...
  public void createAndEvaluateReportWithAllFilterTypes() {
    ...
    final InputVariableFilterDto fixedDateInputVariableFilter =
        createFixedDateInputVariableFilter(INPUT_INVOICE_DATE_ID, dateTimeInputFilterStart, null);

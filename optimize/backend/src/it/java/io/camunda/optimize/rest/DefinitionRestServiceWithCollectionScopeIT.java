...
import io.camunda.optimize.dto.optimize.rest.definition.MultiDefinitionTenantsRequestDto.DefinitionDto;
...
public class DefinitionRestServiceWithCollectionScopeIT extends AbstractPlatformIT {
  ...
  private static final TenantResponseDto TENANT_NOT_DEFINED_RESPONSE_DTO =
      new TenantResponseDto(TENANT_NOT_DEFINED_ID, TENANT_NOT_DEFINED.getName());
  private static final TenantResponseDto TENANT_1_RESPONSE_DTO =
      new TenantResponseDto(TENANT_ID_1, TENANT_ID_1);
  private static final TenantResponseDto TENANT_2_RESPONSE_DTO =
      new TenantResponseDto(TENANT_ID_2, TENANT_ID_2);
  private static final TenantResponseDto TENANT_3_RESPONSE_DTO =
      new TenantResponseDto(TENANT_ID_3, TENANT_ID_3);
  ...
  public void getDefinitionKeysByType_multipleInScope(final DefinitionType type) {
    ...
    final List<DefinitionKeyResponseDto> definitionKeys =
        definitionClient.getDefinitionKeysByType(type, collectionId);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionKeysByType_sharedDefinitionOnlySpecificTenantInScope(
    ...
    // then the definition key is still returned although the definition only exists for the not
    // defined tenant
    assertThat(definitionKeys)
        .extracting(DefinitionKeyResponseDto::getKey)
  ...
  public void getDefinitionKeysByType_typesAreIsolated(final DefinitionType type) {
    ...
    final List<DefinitionKeyResponseDto> definitionKeys =
        definitionClient.getDefinitionKeysByType(otherDefinitionType, collectionId);
  ...
  public void getDefinitionVersionsByKeyAndType_multipleInScope(final DefinitionType type) {
    ...
    collectionClient.addScopeEntryToCollection(
        collectionId,
        new CollectionScopeEntryDto(otherDefinitionType, definitionKey1, scopeTenantIds));
    databaseIntegrationTestExtension.refreshAllOptimizeIndices();

    // when
    final List<DefinitionVersionResponseDto> versions =
        definitionClient.getDefinitionVersionsByTypeAndKey(type, definitionKey1, collectionId);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByKeyAndType_deletedDefinitionsExcludedFromResult(
      final DefinitionType type) {
    // given
    final String definitionKey1 = "definitionKey1";
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByKeyAndType_multiTenant_specificDefinitions(
      final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByKeyAndType_multiTenant_sharedDefinition(
      final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByKeyAndType_multiTenant_sharedAndSpecificDefinitions(
      final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
  ...
  public void getDefinitionVersionsByKeyAndType_keyNotInScope(final DefinitionType type) {
    ...
    final Response responseForWrongKey =
        embeddedOptimizeExtension
            .getRequestExecutor()
            .buildGetDefinitionVersionsByTypeAndKeyRequest(
                type.getId(), definitionKey1, collectionId)
            .execute();

    // then a 404 is returned
    assertThat(responseForWrongKey.getStatus())
        .isEqualTo(Response.Status.NOT_FOUND.getStatusCode());

    // when trying to get versions for a definition type that is not in the scope but key that is in
    // the scope
    final Response responseForWrongType =
        embeddedOptimizeExtension
            .getRequestExecutor()
            .buildGetDefinitionVersionsByTypeAndKeyRequest(
                otherDefinitionType.getId(), definitionKey2, collectionId)
            .execute();

    // then a 404 is returned
    assertThat(responseForWrongType.getStatus())
        .isEqualTo(Response.Status.NOT_FOUND.getStatusCode());
  }

  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionTenantsByTypeForMultipleKeyAndVersions_invalidCollectionId(
      final DefinitionType type) {
    // given
    final String definitionKey1 = "definitionKey1";
    createDefinition(type, definitionKey1, "1", null, "the name");
        ...
        embeddedOptimizeExtension
            ...
            .buildResolveDefinitionTenantsByTypeMultipleKeysAndVersionsRequest(
                ...
                new MultiDefinitionTenantsRequestDto(
                    List.of(new DefinitionDto(definitionKey1, List.of(ALL_VERSIONS))), "invalid"))
            .execute();
  ...
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_tenantSpecificDefinitions_specificVersions_fullScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
    ...
    collectionClient.addScopeEntryToCollection(
        collectionId,
        new CollectionScopeEntryDto(otherDefinitionType, definitionKey, scopeTenantIds));
    ...
    final List<DefinitionWithTenantsResponseDto> definitionTenantsForAllVersions =
        definitionClient.resolveDefinitionTenantsByTypeMultipleKeyAndVersions(
            type,
            new MultiDefinitionTenantsRequestDto(
                List.of(new DefinitionDto(definitionKey, List.of("1", "2"))), collectionId));
    ...
    final List<DefinitionWithTenantsResponseDto> definitionTenantsForVersion1 =
        definitionClient.resolveDefinitionTenantsByTypeMultipleKeyAndVersions(
            type,
            new MultiDefinitionTenantsRequestDto(
                List.of(new DefinitionDto(definitionKey, List.of("1"))), collectionId));
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_tenantSpecificDefinitions_specificVersions_reducedScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
    ...
    // when all versions are included
    // (this is an artificial case as usually no more versions are provided than within the scope,
    // still it ensures
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_tenantSpecificDefinitions_allVersion_reducedScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_tenantSpecificDefinitions_latestVersion_reducedScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
    ...
    final List<DefinitionWithTenantsResponseDto> definitionTenantsForLatestVersion =
        definitionClient.resolveDefinitionTenantsByTypeMultipleKeyAndVersions(
            type,
            new MultiDefinitionTenantsRequestDto(
                List.of(new DefinitionDto(definitionKey, List.of(LATEST_VERSION))), collectionId));
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_sharedDefinition_specificVersions_fullScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
    ...
    final List<String> scopeTenantIds =
        Lists.newArrayList(TENANT_NOT_DEFINED_ID, TENANT_ID_1, TENANT_ID_2, TENANT_ID_3);
    collectionClient.addScopeEntryToCollection(
        collectionId, new CollectionScopeEntryDto(type, definitionKey, scopeTenantIds));
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_sharedDefinition_specificVersions_reducedScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_sharedDefinition_specificVersions_notDefinedNotInScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_sharedAndTenantSpecificDefinitions_specificVersions_reducedScope(
          final DefinitionType type) {
    // given
    createTenant(TENANT_ID_1);
    createTenant(TENANT_ID_2);
    ...
    // only some tenants are in the scope
    final List<String> scopeTenantIds =
        Lists.newArrayList(TENANT_NOT_DEFINED_ID, TENANT_ID_1, TENANT_ID_2);
    collectionClient.addScopeEntryToCollection(
        collectionId, new CollectionScopeEntryDto(type, definitionKey, scopeTenantIds));
    ...
    assertThat(definitionTenantsForAllVersions)
        ...
        .containsExactly(
            Arrays.asList(
                TENANT_NOT_DEFINED_RESPONSE_DTO, TENANT_1_RESPONSE_DTO, TENANT_2_RESPONSE_DTO));
  }

  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionTenantsByTypeForMultipleKeyAndVersions_definitionNotInScope(
      final DefinitionType type) {
    // given
    final String definitionKey1 = "definitionKey1";
    createDefinition(type, definitionKey1, "1", null, "the name");
    ...
    final Response responseForWrongKey =
        embeddedOptimizeExtension
            ...
            .buildResolveDefinitionTenantsByTypeMultipleKeysAndVersionsRequest(
                type.getId(),
                new MultiDefinitionTenantsRequestDto(
                    List.of(new DefinitionDto(definitionKey1, List.of("1"))), collectionId))
            .execute();
    ...
    // when trying to get tenants for a definition type that is not in the scope but key that is in
    // the scope
    final Response responseForWrongType =
        embeddedOptimizeExtension
            .getRequestExecutor()
    ...
    // when trying to get tenants for a definition version that is not in the scope but key that is
    // in the scope
    final Response responseForWrongVersion =
        embeddedOptimizeExtension
            .getRequestExecutor()
            .buildResolveDefinitionTenantsByTypeMultipleKeysAndVersionsRequest(
                otherDefinitionType.getId(),
                new MultiDefinitionTenantsRequestDto(
                    List.of(new DefinitionDto(definitionKey1, List.of("99"))), collectionId))
            .execute();

    // then a 404 is returned
    assertThat(responseForWrongVersion.getStatus())
        .isEqualTo(Response.Status.NOT_FOUND.getStatusCode());
  }
  ...
  private void addProcessDefinitionToElasticsearch(
      final String key,
      final String version,
      final String tenantId,
      final String name,

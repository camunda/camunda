...
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildGetDefinitionVersionsByTypeAndKeyRequest(type.getId(), definitionKey1,
// "invalid")
//             .execute();
//
//     // then
...
//
//     // when trying to get versions for a definition type that is not in the scope but key that is
// in
//     // the scope
...
//                     List.of(new DefinitionDto(definitionKey1, List.of(ALL_VERSIONS))),
// "invalid"))
//             .execute();
//
//     // then
...
//
//     // when all versions are included
//     // (this is an artificial case as usually no more versions are provided than within the
// scope,
//     // still it ensures
...
//             type,
//             new MultiDefinitionTenantsRequestDto(
//                 List.of(new DefinitionDto(definitionKey, List.of(LATEST_VERSION))),
// collectionId));
//
...
//         .isEqualTo(Response.Status.NOT_FOUND.getStatusCode());
//
//     // when trying to get tenants for a definition type that is not in the scope but key that is
// in
//     // the scope
//     final Response responseForWrongType =
//         embeddedOptimizeExtension
...
//         .isEqualTo(Response.Status.NOT_FOUND.getStatusCode());
//
//     // when trying to get tenants for a definition version that is not in the scope but key that
// is
//     // in the scope

...
public class AuthenticationExtractorPluginIT extends AbstractPlatformIT {
  ...
  public void automaticallySignInWhenCustomHeaderIsSet() {
    // given
    String basePackage = "io.camunda.optimize.testplugin.security.authentication.util1";
  ...
  public void cookieHasCorrectExpiryDate() {
    // given
    final String basePackage = "io.camunda.optimize.testplugin.security.authentication.util1";
    addAuthenticationExtractorBasePackagesToConfiguration(basePackage);

...
// import static
// io.camunda.optimize.service.db.schema.index.IndexMappingCreatorBuilder.PROCESS_INSTANCE_INDEX;
// import static
...
// import
// io.camunda.optimize.dto.optimize.rest.report.AuthorizedCombinedReportEvaluationResponseDto;
// import
...
//     engineDatabaseExtension.changeFlowNodeStartDate(processInstanceDto1.getId(), USER_TASK_1,
// now);
//     engineDatabaseExtension.changeFlowNodeStartDate(processInstanceDto2.getId(), USER_TASK_1,
// now);
...
//         .hasSize(1)
//         .first()
//         .extracting(a -> OffsetDateTime.parse(a,
...
//     // for details see
// https://github.com/camunda/camunda-optimize/pull/2318#discussion_r451470038
...
//     engineDatabaseExtension.changeProcessInstanceStartDate(processInstanceDto2.getId(), now);
//     engineDatabaseExtension.changeProcessInstanceEndDate(processInstanceDto1.getId(), now);
//     engineDatabaseExtension.changeFlowNodeStartDate(processInstanceDto1.getId(), START_EVENT,
// now);
//     engineDatabaseExtension.changeFlowNodeStartDate(processInstanceDto2.getId(), START_EVENT,
// now);
...
//         truncateToStartOfUnit(now, ChronoUnit.YEARS,
// ZoneId.of("Europe/Berlin")).toOffsetDateTime();
//     final ProcessInstanceEngineDto processInstance = deployAndStartSimpleProcess();
...
//             // Thus, the instance will not be part of the result if the timezone of this request
// is
//             // respected.
//             .addSingleHeader(X_OPTIMIZE_CLIENT_TIMEZONE, "UTC")
//             // @formatter:off
...
//         getProcessInstanceIndexAliasName("aKey"), instanceDto.getProcessInstanceId(),
// instanceDto);
...
//   }
//
//   // Compares the first parameter to the second. So will be positive if the offset of z1 is
// greater
//   // than z2 after

...
// package
// io.camunda.optimize.service.db.es.report.process.single.usertask.frequency.groupby.assignee;
//
...
// resultData.stream().map(MapResultEntryDto::getLabel).toList();
...
// resultData.stream().map(MapResultEntryDto::getValue).toList();

...
// import
// io.camunda.optimize.dto.optimize.query.definition.AssigneeCandidateGroupDefinitionSearchRequestDto;
// import
...
//
// assigneesClient.getAssigneesByIdsWithoutAuthentication(ImmutableList.of(ASSIGNEE_ID_JOHN));
//
//     // then
...
//             UserDto::getLastName,
//             IdentityWithMetadataResponseDto::getName,
//             UserDto::getEmail)
//         .singleElement()
//         .isEqualTo(
//             Tuple.tuple(
...
//     // when
//     final List<UserDto> assignees =
//         assigneesClient.getAssigneesByIdsWithoutAuthentication(
//             ImmutableList.of(ASSIGNEE_ID_JOHN, ASSIGNEE_ID_JEAN));
//
//     // then
//     assertThat(assignees)
//         .hasSize(2)
...
//             .buildSearchForAssigneesRequest(
...
//         assigneesClient.searchForAssignees(
...
//     assertThat(searchResponse.getResult())
//         .hasSize(1)
//         .containsExactlyInAnyOrder(new UserDto(userIdNotInEngine));
//   }
//
//   @Test
...
//     assertThat(searchResponse.getResult())
//         .singleElement()
//         .isEqualTo(new UserDto(userIdNotInEngine));
//   }
//
//   @Test
...
//         instance.getProcessDefinitionKey(), ASSIGNEE_ID_JEAN, tenant1);
//
//     final String singleReport1 =
//         reportClient.createAndStoreProcessReport(instance.getProcessDefinitionKey());
//     final String singleReport2 =
//         reportClient.createAndStoreProcessReport(
//             instance.getProcessDefinitionKey(), Collections.singletonList(tenant1));
//     final String combinedReportId =
//         reportClient.createNewCombinedReport(singleReport1, singleReport2);
//
//     // when
//     final IdentitySearchResultResponseDto searchResponse =
//         assigneesClient.searchForAssignees(
...
//         createSimpleDmnModel("decisionKey"));
//
...
//   }
//
//   private ProcessInstanceEngineDto startSimpleUserTaskProcessWithAssigneeAndImport(
//       final String assignee) {
//     return startSimpleUserTaskProcessWithAssigneeAndImport("key", assignee);
//   }
//
//   private ProcessInstanceEngineDto startSimpleUserTaskProcessWithAssigneeAndImport(
//       final String definitionKey, final String assignee) {
//     return startSimpleUserTaskProcessWithAssigneeAndImport(definitionKey, assignee, null);
//   }
//
//   private ProcessInstanceEngineDto startSimpleUserTaskProcessWithAssigneeAndImport(
//       final String definitionKey, final String assignee, final String tenantId) {
//     final ProcessInstanceEngineDto processInstanceEngineDto =

...
// package
// io.camunda.optimize.service.db.es.report.process.single.usertask.duration.groupby.candidategroup.distributedby.usertask;
//
...
//         FIRST_CANDIDATE_GROUP_ID, groupByResults, FIRST_CANDIDATE_GROUP_NAME);
//   }
//
...
//     runningStateValues.processFilters =
...
//     completedStateValues.processFilters =
...
//     completedOrCanceledStateValues.processFilters =
//         ProcessFilterBuilder.filter().completedOrCanceledFlowNodesOnly().add().buildList();
...
//   }
//
//   protected abstract void assertEvaluateReportWithFlowNodeStatusFilters(
//       ReportResultResponseDto<List<HyperMapResultEntryDto>> result,
...
//   }
//
//   private void finishUserTaskOneWithFirstGroupAndLeaveOneUnassigned(
//       final ProcessInstanceEngineDto processInstanceDto) {

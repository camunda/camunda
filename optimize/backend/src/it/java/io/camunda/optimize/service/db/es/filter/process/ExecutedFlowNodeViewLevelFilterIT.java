...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_DUR_GROUP_BY_FLOW_NODE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_DUR_GROUP_BY_FLOW_NODE_START_DATE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_DUR_GROUP_BY_VARIABLE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_FLOW_NODE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_FLOW_NODE_DURATION;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_FLOW_NODE_START_DATE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_VARIABLE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.INCIDENT_FREQ_GROUP_BY_FLOW_NODE;
// import static
...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_DUR_GROUP_BY_USER_TASK;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_DUR_GROUP_BY_USER_TASK_START_DATE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_ASSIGNEE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_USER_TASK;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_USER_TASK_DURATION;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_USER_TASK_START_DATE;
// import static
...
//   private static final OffsetDateTime INSTANCE_1_DATE =
//       OffsetDateTime.parse("2021-01-01T01:00:00+01:00");
//   private static final OffsetDateTime INSTANCE_2_DATE =
//       OffsetDateTime.parse("2021-01-02T01:00:00+01:00");
...
//   }
//
//   // This stream does not include endDate reports as these scenarios are covered by the
// equivalent
//   // startDate report.
...
//             Arrays.asList(new Tuple(START_EVENT, 2.), new Tuple(USER_TASK_1, 2.))),
//         Arguments.of(
//             FLOW_NODE_DUR_GROUP_BY_FLOW_NODE,
//             Arrays.asList(new Tuple(START_EVENT, 20.), new Tuple(USER_TASK_1, 30.))),
//         Arguments.of(
//             USER_TASK_FREQ_GROUP_BY_USER_TASK,
//             Collections.singletonList(new Tuple(USER_TASK_1, 2.))),
//         Arguments.of(
//             USER_TASK_DUR_GROUP_BY_USER_TASK,
//             Collections.singletonList(new Tuple(USER_TASK_1, 30.))),
//         Arguments.of(
...
//             Arrays.asList(
//                 new Tuple(INSTANCE_1_DATE_STRING, 1.), new Tuple(INSTANCE_2_DATE_STRING, 1.))),
//         Arguments.of(
//             USER_TASK_DUR_GROUP_BY_USER_TASK_START_DATE,
//             Arrays.asList(
//                 new Tuple(INSTANCE_1_DATE_STRING, 20.), new Tuple(INSTANCE_2_DATE_STRING, 40.))),
//         Arguments.of(
//             FLOW_NODE_FREQ_GROUP_BY_FLOW_NODE_START_DATE,
//             Arrays.asList(
//                 new Tuple(INSTANCE_1_DATE_STRING, 2.), new Tuple(INSTANCE_2_DATE_STRING, 2.))),
//         Arguments.of(
//             FLOW_NODE_DUR_GROUP_BY_FLOW_NODE_START_DATE,
//             Arrays.asList(
//                 new Tuple(INSTANCE_1_DATE_STRING, 15.), new Tuple(INSTANCE_2_DATE_STRING, 35.))),
//         Arguments.of(
//             USER_TASK_FREQ_GROUP_BY_ASSIGNEE,
//             Arrays.asList(new Tuple(DEMO_USER, 1.), new Tuple(KERMIT_USER, 1.))),
//         Arguments.of(
//             USER_TASK_DUR_GROUP_BY_ASSIGNEE,
//             Arrays.asList(new Tuple(DEMO_USER, 20.), new Tuple(KERMIT_USER, 40.))),
//         Arguments.of(
//             FLOW_NODE_FREQ_GROUP_BY_VARIABLE,
//             Arrays.asList(new Tuple(VARIABLE_1_VALUE, 2.), new Tuple(VARIABLE_2_VALUE, 2.))),
//         Arguments.of(
//             FLOW_NODE_DUR_GROUP_BY_VARIABLE,
//             Arrays.asList(new Tuple(VARIABLE_1_VALUE, 15.), new Tuple(VARIABLE_2_VALUE, 35.))));
//   }
//
//   @ParameterizedTest
//   @MethodSource("flowNodeAndUserTaskMapReportTypeAndExpectedResults")
//   public void notInExecutedFlowNodeFilterWorks_groupByReports(
//       final ProcessReportDataType reportType, final List<Tuple> expectedResults) {
//     // given one instance with start, userTask1 and userTask2 and one instance with start and
//     // userTask1
//     setupInstanceData();
//
//     // when filtering out userTask2 (ie a filter that only affects flowNode data and not instance
//     // count because both
...
//
//     // then both instances are in the result as well as all flowNodes except the filtered out
//     // userTask2 bucket
//     assertThat(resultDto.getInstanceCount()).isEqualTo(2);
//     assertThat(resultDto.getInstanceCountWithoutFilters()).isEqualTo(2);
//     assertThat(
...
//     ProcessDefinitionEngineDto processDefinition =
//         engineIntegrationExtension.deployProcessAndGetProcessDefinition(
//             BpmnModels.getTwoExternalTaskProcess(DEF_KEY));
//
...
//     importAllEngineEntitiesFromScratch();
//
//     // when filtering out service task 2 (ie a filter that only affects flowNode data and not
...
//             INCIDENT_FREQ_GROUP_BY_FLOW_NODE, new String[] {SERVICE_TASK_ID_2});
//
...
//
//     // when filtering out start and service task 1 (ie a filter that also affects instance count
//     // because only
//     // instance2 has an incident which matches the filter)
//     resultDto =
//         evaluateReportWithNotInExecutedFlowNodeFilter(
//             INCIDENT_FREQ_GROUP_BY_FLOW_NODE, new String[] {START_EVENT, SERVICE_TASK_ID_1});
//
...
//   @ParameterizedTest
//   @MethodSource("flowNodeAndUserTaskMapReportTypeAndExpectedResults")
//   public void notInExecutedFlowNodeFilterWorks_viewLevelFilteringAlsoAffectsInstanceCount(
//       final ProcessReportDataType reportType) {
//     // given one instance with start, userTask1 and userTask2 and one instance with start and
//     // userTask1
//     setupInstanceData();
//
//     // when filtering out the start event and the userTask1 (a viewLevel filter that also affects
//     // instance count
//     // because instance1 does not have any flowNodes matching the filter)
//     ReportResultResponseDto<List<MapResultEntryDto>> resultDto =
//         evaluateReportWithNotInExecutedFlowNodeFilter(
//             reportType, new String[] {START_EVENT, USER_TASK_1});
//
//     // then the instance with only start and userTask1 is filtered out and only the end event
// bucket
//     // is in the result
//     assertThat(resultDto.getInstanceCount()).isEqualTo(1);
//     assertThat(resultDto.getInstanceCountWithoutFilters()).isEqualTo(2);
...
//   public void
//
// notInExecutedFlowNodeFilterWorks_viewLevelFilteringAlsoAffectsInstanceCount_nonFlowNodeReport() {
//     // given one instance with start, userTask1 and userTask2 and one instance with start and
//     // userTask1
//     setupInstanceData();
//
...
//     ReportResultResponseDto<List<MapResultEntryDto>> resultDto =
//         evaluateReportWithNotInExecutedFlowNodeFilter(
//             PROC_INST_FREQ_GROUP_BY_START_DATE, new String[] {START_EVENT, USER_TASK_1});
//
...
//   }
//
//   private ReportResultResponseDto<List<MapResultEntryDto>>
//       evaluateReportWithNotInExecutedFlowNodeFilter(
//           final ProcessReportDataType reportType, final String[] idsToFilter) {
//     final List<ProcessFilterDto<?>> flowNodeIdFilter =
//         createNotInExecutedFlowNodeFilter(idsToFilter);
//     final ProcessReportDataDto reportData =
//         TemplatedProcessReportDataBuilder.createReportData()
//             .setProcessDefinitionKey(DEF_KEY)
//             .setProcessDefinitionVersion(LATEST_VERSION)

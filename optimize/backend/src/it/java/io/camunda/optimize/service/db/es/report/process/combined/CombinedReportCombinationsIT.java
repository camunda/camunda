...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.INCIDENT_DUR_GROUP_BY_FLOW_NODE;
// import static
...
//             .map(
//                 report -> new
// CombinedReportItemDto(reportClient.createSingleProcessReport(report)))
...
//
//     return Stream.of(Arrays.asList(groupByDurationBucketSize,
// groupByDurationBucketSizeAnotherKey));
//   }
//
//   private static Stream<List<SingleProcessReportDefinitionRequestDto>>
//       createCombinableIncidentReports() {

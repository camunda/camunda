...
// //     assertThat((String)
// headers.getFirst(HttpHeaders.CACHE_CONTROL)).contains("max-age=21600");
...
// //
// //     // when
// //     Response response = executeDefinitionRequest(key, version, type, KERMIT_USER,
// KERMIT_USER);
// //
// //     // then
// //     final MultivaluedMap<String, Object> headers = response.getHeaders();
...
// //     switch (type) {
// //       case DECISION:
// //         DecisionDefinitionOptimizeDto decisionDefinitionDto = new
// DecisionDefinitionOptimizeDto();
...
// //             DECISION_DEFINITION_INDEX_NAME, decisionDefinitionDto.getId(),
...
// //           processDefinitionOptimizeDto.setDataSource(new
// EngineDataSourceDto(DEFAULT_ENGINE_ALIAS));

...
// package
// io.camunda.optimize.service.db.es.report.process.single.processinstance.duration.groupby.date.distributedby.variable;
//
...
// AbstractProcessInstanceDurationByInstanceDateByVarWithPartReportEvaluationIT
...
//     engineDatabaseExtension.changeProcessInstanceEndDate(processInstanceDto.getId(),
// referenceDate);
//
...
//     final ProcessReportDataDto reportData =
//         createReportData(
//             processInstanceDto, VariableType.STRING, "stringVar", START_EVENT,
// SERVICE_TASK_ID_1);
//     final ReportResultResponseDto<List<HyperMapResultEntryDto>> result =
//         reportClient.evaluateHyperMapReport(reportData).getResult();
//
...
//     return createReportData(processInstanceDto, variableType, variableName, START_EVENT,
// END_EVENT);
//   }
//
//   protected ProcessReportDataDto createReportData(

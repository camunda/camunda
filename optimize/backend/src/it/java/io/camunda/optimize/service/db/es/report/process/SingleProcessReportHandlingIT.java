...
import static io.camunda.optimize.service.util.ProcessReportDataType.PROC_INST_DUR_GROUP_BY_NONE_WITH_PART;
...
import io.camunda.optimize.dto.optimize.query.report.single.configuration.heatmap_target_value.HeatmapTargetValueEntryDto;
import io.camunda.optimize.dto.optimize.query.report.single.configuration.process_part.ProcessPartDto;
import io.camunda.optimize.dto.optimize.query.report.single.configuration.target_value.CountProgressDto;
import io.camunda.optimize.dto.optimize.query.report.single.configuration.target_value.DurationProgressDto;
...
public class SingleProcessReportHandlingIT extends AbstractPlatformIT {
  ...
  public void updateProcessReport() {
    ...
    final SingleReportTargetValueDto singleReportTargetValueDto = new SingleReportTargetValueDto();
  ...
  public void doNotUpdateNullFieldsInReport() {
    // given
    final String id = reportClient.createEmptySingleProcessReport();
    final SingleProcessReportDefinitionRequestDto report = constructSingleProcessReportWithFakePD();

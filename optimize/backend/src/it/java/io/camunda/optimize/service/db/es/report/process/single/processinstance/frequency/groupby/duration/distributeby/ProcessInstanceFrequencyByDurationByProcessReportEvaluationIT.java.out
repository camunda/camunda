...
// package
// io.camunda.optimize.service.db.es.report.process.single.processinstance.frequency.groupby.duration.distributeby;
//
// import static io.camunda.optimize.dto.optimize.ReportConstants.ALL_VERSIONS;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.PROC_INST_FREQ_GROUP_BY_DURATION_BY_PROCESS;
...
//                 createHyperMapResult(
//                     "3000.0", new MapResultEntryDto(processIdentifier, 1.0,
// processDisplayName))));
//   }
//
//   @Test
...
//     engineDatabaseExtension.changeProcessInstanceStartAndEndDate(secondInstance.getId(), now,
// now);
//     importAllEngineEntitiesFromScratch();

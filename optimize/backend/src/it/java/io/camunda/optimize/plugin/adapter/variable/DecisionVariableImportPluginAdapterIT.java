 ...
 */
package io.camunda.optimize.plugin.adapter.variable;
...
public class DecisionVariableImportPluginAdapterIT extends AbstractPlatformIT {
  ...
  public void adaptInputs() {
    addDMNInputImportPluginBasePackagesToConfiguration(
        "io.camunda.optimize.testplugin.adapter.variable.dmn1.DoubleNumericInputValues");
  ...
  public void skipInvalidAdaptedInputs() {
    addDMNInputImportPluginBasePackagesToConfiguration(
        "io.camunda.optimize.testplugin.adapter.variable.dmn2.ReturnInvalidInputs");
    final DecisionDefinitionEngineDto decision =
  ...
  public void pluginReturnsMoreInputVariables() {
    addDMNInputImportPluginBasePackagesToConfiguration(
        "io.camunda.optimize.testplugin.adapter.variable.dmn3.ReturnMoreInputVariables");
    final DecisionDefinitionEngineDto decision =
        engineIntegrationExtension.deployAndStartDecisionDefinition();
    importAllEngineEntitiesFromScratch();
  ...
  public void applySeveralInputAdapters() {
    addDMNInputImportPluginBasePackagesToConfiguration(
        "io.camunda.optimize.testplugin.adapter.variable.dmn1.DoubleNumericValues",
        "io.camunda.optimize.testplugin.adapter.variable.dmn5.SetAllStringInputsToFoo");
    final DecisionDefinitionEngineDto decision =
        deployAndStartDecisionDefinition(
            new HashMap<>() {
              {
  ...
  public void adaptOutputs() {
    addDMNOutputImportPluginBasePackagesToConfiguration(
        "io.camunda.optimize.testplugin.adapter.variable.dmn4.AddNewOutput");
    final DecisionDefinitionEngineDto decision =
        deployAndStartDecisionDefinition(
            new HashMap<>() {
              {

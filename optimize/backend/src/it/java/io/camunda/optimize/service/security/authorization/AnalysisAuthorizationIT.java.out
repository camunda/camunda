...
//     // when
//     Response response =
//         executeBranchAnalysisAsKermit(processDefinition1, Lists.newArrayList(tenantId1,
// tenantId2));
//
//     // then
//     assertThat(response.getStatus()).isEqualTo(Response.Status.FORBIDDEN.getStatusCode());
...
//   }
//
//   private void startSimpleGatewayProcessAndTakeTask1(ProcessDefinitionEngineDto
// processDefinition) {

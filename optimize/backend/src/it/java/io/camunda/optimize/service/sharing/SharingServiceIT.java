...
//     evaluationResult = evaluateDashboardReport(reportId, dashboardShareId,
...
//     final String dashboardShareId = addShareForDashboard(dashboardId);
//     final String reportId =
//         reportClient.createSingleReport(PRIVATE_COLLECTION_ID, PROCESS, "A_KEY",
// DEFAULT_TENANTS);
//
//     // when
...
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildEvaluateSharedDashboardReportRequest(dashboardShareId,
// reportIdToStayInDashboard)
//             .execute();
//     assertThat(response.getStatus()).isEqualTo(Response.Status.OK.getStatusCode());
//
//     // and then
...
//     final String dashboardId =
//         dashboardClient.createDashboard(collectionId,
...
//     return evaluateDashboardReport(rawDataReportId, dashboardShareId, paginationRequestDto,
// null);
//   }
//
//   private AuthorizedProcessReportEvaluationResponseDto<List<RawDataProcessInstanceDto>>

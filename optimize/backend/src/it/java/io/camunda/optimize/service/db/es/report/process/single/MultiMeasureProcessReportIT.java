...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_USER_TASK_BY_ASSIGNEE;
// import static
...
//             // using process instance frequency group by none as base for the setup but will
// modify
//             // view.properties
...
//     // given
//     final ProcessInstanceEngineDto processInstanceDto = deployAndStartSimpleServiceTaskProcess();
//     // modifying activity duration to make sure the result for count does never equal the
// duration
//     // average
...
//                 .collect(toList()))
//         .containsExactlyElementsOf(viewProperties);
//     // no result value assertion as this was considered too much effort and the main focus here
// is
//     // on the measures
//     // being present
//   }
...
//   public void
// mapResultSupportsMultipleViewPropertiesAlongWithMultipleAggregationsAndMultipleTimes(
//       final AggregationDto[] aggregationTypes, final UserTaskDurationTime[]
...
//         .extracting(MeasureResponseDto::getAggregationType)
//         .containsSequence(
//             // generate a sequence of the expected aggregationTypes, all distinct
// aggregationTypes
//             // are expected
...
//             // entry
//             // by the amount of aggregations used, as every aggregationType causes multiple
// measures
...
//             // if there is the duration view present we should see the userTask total time as
// this
//             // is a user task report
//             .map(
//                 viewProperty ->
//                     ViewProperty.DURATION.equals(viewProperty) ? UserTaskDurationTime.TOTAL :
// null)
//             .toList();
//
//     // then
...
//             .setProcessDefinitionKey(processInstanceDto.getProcessDefinitionKey())
//             .setProcessDefinitionVersion(processInstanceDto.getProcessDefinitionVersion())
//             // using usertask frequency group by usertask startDate as base for the setup but
// will
...
//             .setProcessDefinitionKey(processInstanceDto.getProcessDefinitionKey())
//             .setProcessDefinitionVersion(processInstanceDto.getProcessDefinitionVersion())
//             // using user task frequency group by user task distribute by assignee as base for
// the
...
//         Arguments.of(
//             Arrays.asList(ViewProperty.DURATION, ViewProperty.FREQUENCY,

...
// // //     assertNodeConnection(idOf(eventC), INTERMEDIATE_EVENT, idOf(eventD), END_EVENT,
// modelInstance);
...
// // //     ingestEventAndProcessTraces(
// // //         Arrays.asList(
// // //             illegalCharEvent, createCloudEventOfType(EVENT_A, traceId,
// now.plusSeconds(10))));
// // //     final List<EventSourceEntryDto<?>> externalSource =
// // //         Collections.singletonList(createExternalEventAllGroupsSourceEntry());
// // //     final EventProcessMappingCreateRequestDto createRequestDto =
...
// // //     assertNodeConnection(
// // //         expectedGatewayId, EXCLUSIVE_GATEWAY, idOf(EVENT_C), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_C), INTERMEDIATE_EVENT, idOf(EVENT_D), END_EVENT, modelInstance);
// // //     assertNodeConnection(idOf(EVENT_D), END_EVENT, null, null, modelInstance);
...
// modelInstance.getModelElementsByType(Gateway.class);
...
// assertThat(modelInstance.getModelElementsByType(FlowNode.class)).hasSize(mappings.size() + 1);
// // //
// // //     // then the model elements are of the correct type and connected to sequence flows
// correctly
// // //     final String expectedGatewayId = generateGatewayIdForNode(EVENT_B, Diverging);
// // //     assertNodeConnection(
// // //         idOf(EVENT_A), START_EVENT, idOf(EVENT_B), INTERMEDIATE_EVENT, modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, expectedGatewayId, EXCLUSIVE_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
...
// // //     assertNodeConnection(
// // //         divergingGatewayId, EXCLUSIVE_GATEWAY, idOf(EVENT_B), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         divergingGatewayId, EXCLUSIVE_GATEWAY, idOf(EVENT_C), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, convergingGatewayId, EXCLUSIVE_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_C), INTERMEDIATE_EVENT, convergingGatewayId, EXCLUSIVE_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
...
// // //     // then the model elements are of the correct type and connected to sequence flows
// correctly
// // //     assertNodeConnection(idOf(EVENT_A), START_EVENT, idOf(EVENT_B), END_EVENT,
// modelInstance);
// // //     assertNodeConnection(idOf(EVENT_B), END_EVENT, null, null, modelInstance);
// // //     assertNodeConnection(idOf(EVENT_C), START_EVENT, idOf(EVENT_D), END_EVENT,
// modelInstance);
// // //     assertNodeConnection(idOf(EVENT_D), END_EVENT, null, null, modelInstance);
// // //     // and the expected number of sequence flows exists
...
// // //     assertNodeConnection(
// // //         convergingGatewayId, EXCLUSIVE_GATEWAY, idOf(EVENT_B), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, idOf(EVENT_C), INTERMEDIATE_EVENT,
// modelInstance);
...
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_D), INTERMEDIATE_EVENT, divergingGatewayId, EXCLUSIVE_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
// // //         divergingGatewayId,
// // //         EXCLUSIVE_GATEWAY,
...
// // //
// // //     // and the gateways have the expected source and target events
// // //     final Collection<Gateway> gateways =
// modelInstance.getModelElementsByType(Gateway.class);
...
// // //     assertNodeConnection(
// // //         divergingGatewayId, PARALLEL_GATEWAY, idOf(EVENT_B), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         divergingGatewayId, PARALLEL_GATEWAY, idOf(EVENT_C), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, convergingGatewayId, PARALLEL_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_C), INTERMEDIATE_EVENT, convergingGatewayId, PARALLEL_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
...
// // //     assertNodeConnection(
// // //         divergingGatewayId, INCLUSIVE_GATEWAY, idOf(EVENT_B), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         divergingGatewayId, INCLUSIVE_GATEWAY, idOf(EVENT_C), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, convergingGatewayId, INCLUSIVE_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_C), INTERMEDIATE_EVENT, convergingGatewayId, INCLUSIVE_GATEWAY,
// modelInstance);
// // //     assertNodeConnection(
...
// // //     // If this trace was considered in the gateway selection, we would expect inclusive
// gateways as
// // //     // it has no EVENT_C
// // //     final String thirdTraceId = "thirdTraceTraceId";
// // //     ingestEventAndProcessTraces(
...
// // //     // then the model elements are of the correct type and connected to sequence flows
// correctly
// // //     // The gateways being Parallel shows that the third event trace isn't considered for
// gateway
// // //     // selection
// // //     final String divergingGatewayId = generateGatewayIdForNode(EVENT_A, Diverging);
// // //     final String convergingGatewayId = generateGatewayIdForNode(EVENT_D, Converging);
...
// modelInstance);
// // //     assertNodeConnection(
// // //         convergingGatewayId, PARALLEL_GATEWAY, idOf(EVENT_D), INTERMEDIATE_EVENT,
// modelInstance);
// // //     assertNodeConnection(

...
// // import static
// io.camunda.optimize.service.db.DatabaseConstants.EVENT_PROCESS_PUBLISH_STATE_INDEX_NAME;
// // import static
...
// //     assertGetMappingRequestStatusCode(eventProcessId1,
// Response.Status.NOT_FOUND.getStatusCode());
// //     assertGetMappingRequestStatusCode(eventProcessId2,
// Response.Status.NOT_FOUND.getStatusCode());
// //   }
// //
// //   @Test
// //   public void
// eventProcessMappingsSkippedOnBulkDelete_IfDatabaseFailsToDeleteReportsUsingMapping() {
// //     EventProcessMappingDto eventProcessMappingDto =
// //         createEventProcessMappingDtoWithSimpleMappingsAndExternalEventSource();
// //     String eventProcessDefinitionKey1 =
// //         eventProcessClient.createEventProcessMapping(eventProcessMappingDto);
...
// //         "There was an error while deleting resources associated to the event process mapping
// with id "
...
// //   @Test
// //   public void
// bulkDeleteEventProcessMappings_skipsDeletionWhenEventProcessMappingDoesNotExist() {
// //     // given
// //     EventProcessMappingDto eventProcessMappingDto =
// //         createEventProcessMappingDtoWithSimpleMappingsAndExternalEventSource();
// //     String eventProcessDefinitionKey1 =
...
// //     // when
// //     List<String> eventProcessIds =
// //         Arrays.asList(eventProcessDefinitionKey1, "doesNotExist1",
...
// //   @Test
// //   public void
// bulkDeleteEventProcessMappings_skipsDeletionIfDatabaseFailsToDeletePublishState() {
// //     // given
// //     EventProcessMappingDto eventProcessMappingDto =
// //         createEventProcessMappingDtoWithSimpleMappingsAndExternalEventSource();
// //     String eventProcessDefinitionKey1 =
...
// //     final ClientAndServer dbMockServer = useAndGetDbMockServer();
// //     final HttpRequest requestMatcher =
// //         request().withPath("/.*" + COLLECTION_INDEX_NAME +
// ".*/_update_by_query").withMethod(POST);
// //     dbMockServer
// //         .when(requestMatcher, Times.once())
// //         .error(HttpError.error().withDropConnection(true));
// //
...
// //
// //     collectionClient.addScopeEntryToCollection(
// //         collectionId, new CollectionScopeEntryDto(PROCESS,
...
// //                 collectionId, firstDeletingEventProcessDefinitionKey,
...
// //             collectionId,
// //             Arrays.asList(
// //                 reportWithEventProcessDefKey, reportIdWithDefaultDefKey,
// reportIdWithNoDefKey));
// //
// //     List<String> eventProcessIds =
// //         Arrays.asList(
...
// //         .hasSize(1)
// //         .extracting(CollectionDefinitionDto.Fields.data + "." +
// CollectionDataDto.Fields.scope)
// //         .contains(
...
// //   }
// //
// //   private void assertGetMappingRequestStatusCode(String eventProcessMappingKey, int
// statusCode) {
// //     eventProcessClient

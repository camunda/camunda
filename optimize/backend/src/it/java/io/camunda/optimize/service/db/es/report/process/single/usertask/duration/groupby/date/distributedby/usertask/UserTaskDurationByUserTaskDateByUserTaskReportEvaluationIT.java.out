...
// import
// io.camunda.optimize.service.db.es.report.process.single.ModelElementDurationByModelElementDateByModelElementReportEvaluationIT;
...
//             1000L,
//             1L,
//             Arrays.asList(Tuple.tuple(USER_TASK_1, 2000.), Tuple.tuple(USER_TASK_2, null))),
//         Arguments.of(
//             USER_TASK_2,
//             GREATER_THAN,
//             500L,
//             1L,
//             Arrays.asList(Tuple.tuple(USER_TASK_1, null), Tuple.tuple(USER_TASK_2, 1000.))),
//         Arguments.of(
//             USER_TASK_1,
//             GREATER_THAN_EQUALS,
//             2000L,
...
//     // We also have to change both durations as the instance level filtering applies to the
//     // activities and the
...
//   @SuppressWarnings(UNCHECKED_CAST)
//   public void
//       instanceLevelFilterByCandidateGroupOnlyCountsUserTasksForInstancesWithThatCandidateGroup(
//           final MembershipFilterOperator filterOperator,
//           final String[] filterValues,
//           final Long expectedInstanceCount,
//           final List<Tuple> expectedResult) {
...
//         Arrays.asList(firstDefinition.getVersionAsString(),

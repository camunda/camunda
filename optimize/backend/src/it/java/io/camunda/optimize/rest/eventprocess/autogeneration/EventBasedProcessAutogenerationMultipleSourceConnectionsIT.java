...
// // // import static
// io.camunda.optimize.service.db.DatabaseConstants.EXTERNAL_EVENTS_INDEX_SUFFIX;
// // // import static
...
// // // import static
// io.camunda.optimize.service.util.EventModelBuilderUtil.generateGatewayIdForNode;
// // // import static
...
// // // import static
// io.camunda.optimize.service.util.EventModelBuilderUtil.generateTaskIdForDefinitionKey;
// // // import static
...
// // //   @Test
// // //   public void
// createFromExternalAndCamundaSources_noExternalEndEvents_singleCamundaStartEvent() {
...
// // //         mappings, generatedInstance, Arrays.asList(EVENT_A, EVENT_B, camundaStart,
// camundaEnd));
// // //
...
// correctly
// // //     // We cannot assert on the actual connection between the models as we don't know which
// start
// // //     // event will be connected
// // //     // to the camunda start events
// // //     assertNodeConnection(
// // //         idOf(camundaStart), INTERMEDIATE_EVENT, idOf(camundaEnd), END_EVENT,
// generatedInstance);
...
// // //   @Test
// // //   public void
// createFromExternalAndCamundaSources_noExternalEndEvents_multipleCamundaStartEvent() {
// // //     final Instant now = Instant.now();
// // //     final String firstTraceId = "firstTracingId";
// // //     ingestEventAndProcessTraces(
// // //         Arrays.asList(
...
// // //     // We cannot assert on the actual connections between the models as we don't know which
// start
// // //     // event will be
...
// // //     // We cannot assert on the connecting gateway as we do not know what start event will
// be its
// // //     // source
...
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, idOf(EVENT_C), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_C), INTERMEDIATE_EVENT, idOf(EVENT_D), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_D),
// // //         INTERMEDIATE_EVENT,
...
// // //         generatedInstance,
// // //         Arrays.asList(EVENT_A, EVENT_B, EVENT_C, EVENT_D, camundaStart, camundaEnd));
// // //     // The extra flow nodes are the connecting gateway and the one to split the two end
// events from
// // //     // the external
// // //     // source model
// // //     assertThat(generatedInstance.getModelElementsByType(FlowNode.class))
...
// correctly
// // //     final String connectingId =
// // //         generateConnectionGatewayIdForDefinitionKey(Converging,
// EXTERNAL_EVENTS_INDEX_SUFFIX);
// // //     final String externalId = generateGatewayIdForNode(EVENT_B, Diverging);
// // //     assertNodeConnection(
// // //         idOf(EVENT_A), START_EVENT, idOf(EVENT_B), INTERMEDIATE_EVENT, generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, externalId, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         externalId, EXCLUSIVE_GATEWAY, idOf(EVENT_C), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         externalId, EXCLUSIVE_GATEWAY, idOf(EVENT_D), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_C), INTERMEDIATE_EVENT, connectingId, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_D), INTERMEDIATE_EVENT, connectingId, EXCLUSIVE_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         connectingId, EXCLUSIVE_GATEWAY, idOf(camundaStart), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(camundaStart), INTERMEDIATE_EVENT, idOf(camundaEnd), END_EVENT,
// generatedInstance);
...
// // //     final List<EventSourceEntryDto<?>> sources =
// // //         Arrays.asList(
// // //             createExternalEventAllGroupsSourceEntry(), camundaProcessSource,
// startEndSource);
// // //     final EventProcessMappingCreateRequestDto createRequestDto =
// // //         buildAutogenerateCreateRequestDto(sources);
// // //
...
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_D), INTERMEDIATE_EVENT, processNodeId, CALL_ACTIVITY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         processNodeId, CALL_ACTIVITY, idOf(camundaStart), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(camundaStart), INTERMEDIATE_EVENT, idOf(camundaEnd), END_EVENT,
// generatedInstance);
...
// // //     final List<EventSourceEntryDto<?>> sources =
// // //         Arrays.asList(
// // //             camundaProcessSource, startEndSource,
...
// correctly
// // //     assertNodeConnection(
// // //         idOf(processStart), START_EVENT, idOf(processEnd), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(processEnd),
// // //         INTERMEDIATE_EVENT,
...
// // //         generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(camundaEnd), INTERMEDIATE_EVENT, idOf(EVENT_A), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
...
// // //     final List<EventSourceEntryDto<?>> sources =
// // //         Arrays.asList(
// // //             startEndSource, createExternalEventAllGroupsSourceEntry(),
...
// correctly
// // //     assertNodeConnection(
// // //         idOf(camundaStart), START_EVENT, idOf(camundaEnd), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(camundaEnd), INTERMEDIATE_EVENT, idOf(EVENT_A), INTERMEDIATE_EVENT,
// generatedInstance);
...
// // //         generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(processStart), INTERMEDIATE_EVENT, idOf(processEnd), END_EVENT,
// generatedInstance);
...
// // //     final String convergingId2 = generateModelGatewayIdForSource(startEndSource,
// Converging);
...
// // //     assertNodeConnection(
// // //         divergingId1, PARALLEL_GATEWAY, idOf(EVENT_B), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         divergingId1, PARALLEL_GATEWAY, idOf(EVENT_C), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_B), INTERMEDIATE_EVENT, convergingId1, PARALLEL_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_C), INTERMEDIATE_EVENT, convergingId1, PARALLEL_GATEWAY,
// generatedInstance);
// // //     assertNodeConnection(
// // //         convergingId1, PARALLEL_GATEWAY, idOf(EVENT_D), INTERMEDIATE_EVENT,
// generatedInstance);
// // //     assertNodeConnection(
// // //         idOf(EVENT_D), INTERMEDIATE_EVENT, processNodeId, CALL_ACTIVITY,
// generatedInstance);

...
// import static
// io.camunda.optimize.dto.optimize.query.event.process.source.EventSourceType.CAMUNDA;
...
//
//     // when the second import cycle completes only the first and second event for each source
// have
//     // been processed
//     // as the import fetches all events with the exact firstEvent Timestamp + a maxPageSize
// amount
//     // of events after it
...
//
//     // when the third import cycle completes another event considered for publish progress has
// been
//     // ingested so the
...
//
//     // when the fourth import cycle completes the status is updated to Published as all events
// have
//     // been processed
//     executeImportCycle();
//     // then
...
//
//     // when the third import cycle completes the status is updated to Published as all events
// have
//     // been processed
//     executeImportCycle();
//     // then
...
//
//   @Disabled(
//       "Disabled without thorough investigation to get master passing again. EBP is not a critical
// feature")
//   @Test
//   public void
...
//
//     // these events should not be correlated or used for calculations as the group isn't selected
// as
//     // source
...
// groupToCorrelate),
//                 BPMN_END_EVENT_ID,
//                 buildExternalEventMapping(FINISHED_EVENT, MappedEventType.END,
// groupToCorrelate)),
...
//     publishEventProcessMappingAndRefreshIndices(eventProcessMappingId);
//
//     // when the first import cycle completes the status has not been updated yet, but there are
// two
//     // import sources -
...
//         getEventProcessPublishStateDtoFromDatabase(eventProcessMappingId)
//             .orElseThrow(() -> new OptimizeIntegrationTestException("Cannot get published
// state"));

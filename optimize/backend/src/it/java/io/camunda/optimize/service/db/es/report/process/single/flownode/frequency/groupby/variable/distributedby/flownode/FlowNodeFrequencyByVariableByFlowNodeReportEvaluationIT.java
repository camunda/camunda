 ...
 */
package io.camunda.optimize.service.db.es.report.process.single.flownode.frequency.groupby.variable.distributedby.flownode;
...
public class FlowNodeFrequencyByVariableByFlowNodeReportEvaluationIT
  ...
  public void allVersions_resultIncludesLatestNodesOnly_latestHasMoreNodes() {
    ...
    // then the result includes all flownodes of the latest version with instance counts from all
    // versions
    // @formatter:off
    HyperMapAsserter.asserter()
        .processInstanceCount(2L)
  ...
  public void allVersions_resultIncludesLatestNodesOnly_latestHasFewerNodes() {
    ...
    // then the result includes only the flownodes of the latest version with instance counts from
    // all versions
    // @formatter:off
    HyperMapAsserter.asserter()
        .processInstanceCount(2L)
  ...
  private static Stream<Arguments> viewLevelAssigneeFilterScenarios() {
    return Stream.of(
        Arguments.of(IN, new String[] {DEFAULT_USERNAME}, Map.of(USER_TASK_1, 1.)),
        Arguments.of(
            IN,
            new String[] {DEFAULT_USERNAME, SECOND_USER, null},
            Map.of(USER_TASK_1, 1., USER_TASK_2, 1., USER_TASK_3, 1.)),
        Arguments.of(NOT_IN, new String[] {SECOND_USER}, Map.of(USER_TASK_1, 1., USER_TASK_3, 1.)),
        Arguments.of(
            NOT_IN, new String[] {DEFAULT_USERNAME, SECOND_USER}, Map.of(USER_TASK_3, 1.)));
  }
  ...
  private static Stream<Arguments> viewLevelCandidateGroupFilterScenarios() {
    return Stream.of(
        Arguments.of(IN, new String[] {FIRST_CANDIDATE_GROUP_ID}, Map.of(USER_TASK_1, 1.)),
        Arguments.of(
            IN,

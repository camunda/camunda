...
//             Tuple.tuple(
//                 "objectVar.birthday", DATE.getId(),
// singletonList("1992-11-17T00:00:00.000+0100")),
...
//                 .collect(toSet()))
//         .singleElement() // all flattened variables have the same timestamp as the original
// object
//         // variable
//         .isNotNull();
//     assertThat(storedVariableUpdateInstances)
...
//             SimpleProcessVariableDto::getValue)
//         .containsExactlyInAnyOrder(
//             Tuple.tuple("objectVar", OBJECT.getId(),
// singletonList(objectVariableDto.getValue())),
//             Tuple.tuple(
...
//         getVariablesForProcessInstance(instanceDto);
//
//     // then the object variable is still imported correctly as the ignore_above setting is used
// for
//     // the

...
// //                 eventRequestDto(GROUP, null, 0, DatabaseConstants.MAX_RESPONSE_SIZE_LIMIT +
// 1))
// //             .execute();
// //
// //     // then
...
// //     final String searchTerm = "ketchup";
// //     EventSearchRequestDto requestDto =
// //         eventRequestDto(caseInsensitive ? searchTerm.toUpperCase() : searchTerm, GROUP, DESC,
// 0, 5);
// //
// //     // when
// //     final Page<DeletableEventDto> eventsPage =
...
// //       comparator =
// //           Comparator.comparing(DeletableEventDto::getSource,
// Comparator.nullsFirst(naturalOrder()));
...
// //         searchTerm, new SortRequestDto(sortBy, sortOrder), new PaginationRequestDto(limit,
// offset));
// //   }
// //
// //   private static EventSearchRequestDto eventRequestDto(
// //       final String sortBy, final SortOrder sortOrder, final Integer offset, final Integer
// limit) {

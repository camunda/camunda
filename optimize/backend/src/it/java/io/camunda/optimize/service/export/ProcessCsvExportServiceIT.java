...
// import
// io.camunda.optimize.dto.optimize.query.report.single.process.filter.CanceledInstancesOnlyFilterDto;
// import
...
//
//     final ProcessReportDataDto currentReport =
...
//         variablesClient.createListJsonObjectVariableDto(List.of("test1", "test2"));
...
//         processInstance.getId(), shiftedStartDate);
//     engineDatabaseExtension.changeProcessInstanceEndDate(processInstance.getId(),
// shiftedStartDate);
...
//     long expectedDuration = now.toInstant().toEpochMilli() -
...
//     ProcessInstanceEngineDto runningInstanceOneWeek =
//         engineIntegrationExtension.startProcessInstance(processDefinitionEngineDto.getId());
//     engineDatabaseExtension.changeProcessInstanceStartDate(
//         runningInstanceOneWeek.getId(), twoWeeksAgo);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         runningInstanceOneWeek.getId(), START_EVENT, 0L);
//     engineDatabaseExtension.changeFlowNodeStartDate(
//         runningInstanceOneWeek.getId(), USER_TASK_1, twoWeeksAgo);
//     importAllEngineEntitiesFromScratch();
//
//     ProcessReportDataDto currentReport =
//         TemplatedProcessReportDataBuilder.createReportData()
...
//     String reportId =
//         createAndStoreDefaultReportDefinitionWithSortByDuration(currentReport, sortingOrder);
...
//     long userTaskDuration = now.toInstant().toEpochMilli() -
// twoWeeksAgo.toInstant().toEpochMilli();
//     expectedString = expectedString.replace("${PI_ID_1}", runningInstanceOneWeek.getId());
//     expectedString = expectedString.replace("${PD_ID_1}",
// runningInstanceOneWeek.getDefinitionId());
...
//     expectedString =
//         expectedString.replace("${USER_TASK_DURATION_1}", String.valueOf(userTaskDuration));
//
//     // when
...
//     OffsetDateTime twoWeeksAgo = now.minusWeeks(2L);
//
//     long completedInstanceOneWeekDuration =
//         oneWeekAgo.toInstant().toEpochMilli() - twoWeeksAgo.toInstant().toEpochMilli();
//     long completedInstanceOneDayDuration =
//         twoDaysAgo.toInstant().toEpochMilli() - threeDaysAgo.toInstant().toEpochMilli();
//     long runningInstanceTwoDaysDuration =
//         now.toInstant().toEpochMilli() - twoDaysAgo.toInstant().toEpochMilli();
//     long runningInstanceTwoWeeksDuration =
//         now.toInstant().toEpochMilli() - twoWeeksAgo.toInstant().toEpochMilli();
//
//     ProcessDefinitionEngineDto processDefinitionEngineDto = deploySimpleOneUserTasksDefinition();
//     ProcessInstanceEngineDto completedInstanceOneWeek =
//         engineIntegrationExtension.startProcessInstance(processDefinitionEngineDto.getId());
...
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         completedInstanceOneWeek.getId(), START_EVENT, 1);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         completedInstanceOneWeek.getId(), USER_TASK_1, 99);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         completedInstanceOneWeek.getId(), END_EVENT, 1);
//
...
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         completedInstanceOneDay.getId(), START_EVENT, 1);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         completedInstanceOneDay.getId(), USER_TASK_1, 99);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         completedInstanceOneDay.getId(), END_EVENT, 1);
//
//     final ProcessInstanceEngineDto runningInstanceTwoDays =
//         engineIntegrationExtension.startProcessInstance(processDefinitionEngineDto.getId());
//     engineDatabaseExtension.changeProcessInstanceStartDate(
//         runningInstanceTwoDays.getId(), twoDaysAgo);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         runningInstanceTwoDays.getId(), START_EVENT, 0);
//     engineDatabaseExtension.changeFlowNodeStartDate(
//         runningInstanceTwoDays.getId(), USER_TASK_1, twoDaysAgo);
//
...
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         runningInstanceTwoWeeks.getId(), START_EVENT, 0);
//     engineDatabaseExtension.changeFlowNodeStartDate(
//         runningInstanceTwoWeeks.getId(), USER_TASK_1, twoWeeksAgo);
//     importAllEngineEntitiesFromScratch();
//
//     ProcessReportDataDto currentReport =
//         TemplatedProcessReportDataBuilder.createReportData()
...
//       expectedString =
//           replaceExpectedValuesForInstance(
//               expectedString,
//               4,
...
//       ProcessReportDataDto currentReport, String expectedCSV, char customDelimiter) {
//     // given
//     embeddedOptimizeExtension
//         .getConfigurationService()
//         .getCsvConfiguration()
//         .setExportCsvDelimiter(customDelimiter);
//     ProcessInstanceEngineDto processInstance = deployAndStartSimpleProcess();
//
//     importAllEngineEntitiesFromScratch();
//
...
//     final ProcessInstanceEngineDto processInstance =
//         deployAndStartSimpleProcessWithVariables(variables);
//     final OffsetDateTime shiftedStartDate =
// OffsetDateTime.parse("2018-02-26T14:20:00.000+01:00");
//     engineDatabaseExtension.changeProcessInstanceStartDate(
//         processInstance.getId(), shiftedStartDate);
//     engineDatabaseExtension.changeProcessInstanceEndDate(processInstance.getId(),
// shiftedStartDate);
...
//     final String stringExpected =
//         getExpectedContentAsString(
//             processInstance, "/csv/process/single/raw_process_data_object_variable.csv");
//
//     assertThat(actualContent).isEqualTo(stringExpected);
//   }
//
//   private String getExpectedContentAsString(
//       ProcessInstanceEngineDto processInstance, String expectedCSV) {
...
//   }
//
//   private String createAndStoreDefaultReportDefinitionWithSortByDuration(
//       ProcessReportDataDto reportData, ReportSortingDto order) {
//     SingleProcessReportDefinitionRequestDto singleProcessReportDefinitionDto =
//         new SingleProcessReportDefinitionRequestDto();
//     singleProcessReportDefinitionDto.setData(reportData);
//     singleProcessReportDefinitionDto.setId("something");
...
//     OffsetDateTime shiftedStartDate = OffsetDateTime.parse("2018-02-26T14:20:00.000+01:00");
//     engineDatabaseExtension.changeProcessInstanceStartDate(
//         processInstanceEngineDto.getId(), shiftedStartDate);
//     engineDatabaseExtension.changeProcessInstanceEndDate(
//         processInstanceEngineDto.getId(), shiftedStartDate);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         processInstanceEngineDto.getId(), START_EVENT, 0L);
//     engineDatabaseExtension.changeFlowNodeTotalDuration(
//         processInstanceEngineDto.getId(), END_EVENT, 0L);
...
//   }
//
//   private String replaceExpectedValuesForInstance(
//       String expectedString,
//       int rowNum,
...
//       Long duration) {
//     expectedString =
//         expectedString.replace("${PI_ID_" + rowNum + "}", "\"" + processInstance.getId() + "\"");
//     expectedString =
//         expectedString.replace(
//             "${PD_ID_" + rowNum + "}", "\"" + processInstance.getDefinitionId() + "\"");
//     expectedString =
//         expectedString.replace("${START_DATE_" + rowNum + "}", "\"" + startDate + "\"");
//     expectedString = expectedString.replace("${DURATION_" + rowNum + "}", "\"" + duration +
// "\"");
//     expectedString =
//         expectedString.replace(
//             "${END_DATE_" + rowNum + "}", endDate == null ? "" : "\"" + endDate + "\"");
//     return expectedString;
//   }
//
...
//     return Stream.of(Arguments.of(SortOrder.ASC), Arguments.of(SortOrder.DESC));
//   }
// }

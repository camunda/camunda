...
//     // given
//     final DecisionDefinitionOptimizeDto expectedDecisionDefinition =
// createDecisionDefinitionDto();
//
//     // when
...
//         createDecisionDefinitionDto("key", firstTenantId);
//     addDecisionDefinitionToElasticsearch(firstTenantDefinition);
//     DecisionDefinitionOptimizeDto secondTenantDefinition = createDecisionDefinitionDto("key",
// null);
//     addDecisionDefinitionToElasticsearch(secondTenantDefinition);
//
//     // when
...
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildGetDecisionDefinitionXmlRequest(expectedDefinitionDto.getKey(),
// "nonsenseVersion")
...
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildGetDecisionDefinitionXmlRequest("nonsenseKey",

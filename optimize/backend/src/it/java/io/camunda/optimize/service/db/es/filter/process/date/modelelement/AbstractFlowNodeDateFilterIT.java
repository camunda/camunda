...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_VARIABLE_BY_FLOW_NODE;
// import static
...
//
//   protected static final OffsetDateTime DATE_1 =
// OffsetDateTime.parse("2019-05-09T00:00:00+02:00");
//   protected static final OffsetDateTime DATE_2 =
// OffsetDateTime.parse("2021-06-07T00:00:00+02:00");
...
//   }
//
//   protected ReportResultResponseDto<List<MapResultEntryDto>>
// evaluateReportWithFlowNodeDateFilter(
...
//       final ProcessReportDataType reportType, final List<ProcessFilterDto<?>>
// flowNodeDateFilters) {
//     final ProcessReportDataDto reportData =
...
//         KERMIT_USER, KERMIT_USER, instance2.getId());
//
//     // end events are irrelevant and would bloat report results, we just need 2 userTasks and 1
// non
//     // userTask to test

...
//     final List<CollectionRoleResponseDto> expectedRoles =
//         collectionClient.getCollectionRoles(collectionId);
//
//     // when
...
//     final List<CollectionRoleResponseDto> actualRoles =
//         collectionClient.getCollectionRoles(collectionId);
...
//
//     // then
//     assertThat(roles).hasSize(1).isEqualTo(expectedRoles);
//   }
//
//   @Test
...
//             new IdentityDto(TEST_GROUP_ID, IdentityType.GROUP), RoleType.EDITOR));
//     collectionClient.addRolesToCollection(
//         collectionId,
//         new CollectionRoleRequestDto(
//             new IdentityDto(TEST_GROUP_B_ID, IdentityType.GROUP), RoleType.EDITOR));
//     collectionClient.addRolesToCollection(
//         collectionId,
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_KERMIT_ID, IdentityType.USER), RoleType.EDITOR));
//     collectionClient.addRolesToCollection(
//         collectionId,
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_MISS_PIGGY_ID, IdentityType.USER), RoleType.EDITOR));
//
//     // when
//     List<CollectionRoleResponseDto> roles = collectionClient.getCollectionRoles(collectionId);
//
...
//         anotherTestGroupDto.getId(), RESOURCE_TYPE_GROUP);
//     authorizationClient.grantSingleResourceAuthorizationForKermit(
//         demoUserDto.getId(), RESOURCE_TYPE_USER);
//
//     // when
//     List<CollectionRoleResponseDto> roles =
//         collectionClient.getCollectionRolesAsUser(collectionId, USER_KERMIT_ID, USER_KERMIT_ID);
//
//     // then
...
//         .isEqualTo(
//             expectedUserDtoWithData.getFirstName() + " " +
// expectedUserDtoWithData.getLastName());
...
//     assertThat(userDto.getName()).isEqualTo(DEFAULT_FIRSTNAME + " " + DEFAULT_LASTNAME);
...
//     authorizationClient.addKermitUserAndGrantAccessToOptimize();
//     authorizationClient.addUserAndGrantOptimizeAccess(USER_MISS_PIGGY_ID);
//     authorizationClient.createGroupAndAddUsers(TEST_GROUP_ID, USER_KERMIT_ID,
// USER_MISS_PIGGY_ID);
//
...
//
//     // then
//     final List<IdentityWithMetadataResponseDto> groupIdentities =
//         roles.stream()
...
//         collectionClient.getCollectionRoleIdDtos(collectionId).stream()
...
//     // when
//     final CollectionRoleRequestDto roleDto =
//         new CollectionRoleRequestDto(new IdentityDto(USER_KERMIT_ID, null), RoleType.EDITOR);
//     collectionClient.addRolesToCollection(collectionId, roleDto);
//     final CollectionRoleRequestDto expectedRoleDto =
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_KERMIT_ID, IdentityType.USER), RoleType.EDITOR);
//
//     // then
...
//     // when
//     final CollectionRoleRequestDto roleDto =
//         new CollectionRoleRequestDto(new IdentityDto(TEST_GROUP_ID, null), RoleType.EDITOR);
//     collectionClient.addRolesToCollection(collectionId, roleDto);
//     final CollectionRoleRequestDto expectedRoleDto =
//         new CollectionRoleRequestDto(
//             new IdentityDto(TEST_GROUP_ID, IdentityType.GROUP), RoleType.EDITOR);
...
//
//     // when
//     final CollectionRoleRequestDto kermitRoleDto =
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_KERMIT_ID, IdentityType.USER), RoleType.EDITOR);
//     final CollectionRoleRequestDto missPiggyRoleDto =
//         new CollectionRoleRequestDto(
...
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_KERMIT_ID, IdentityType.USER), RoleType.EDITOR);
//     final Response addRoleResponse =
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildAddRolesToCollectionRequest(collectionId, roleDto)
//             .execute();
...
//     final CollectionRoleRequestDto kermitRoleDto =
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_KERMIT_ID, IdentityType.USER), RoleType.MANAGER);
//     collectionClient.addRolesToCollection(collectionId, kermitRoleDto);
//
//     // when
//     final CollectionRoleRequestDto roleDto =
//         new CollectionRoleRequestDto(testUser, RoleType.EDITOR);
//     final Response addRoleResponse =
//         embeddedOptimizeExtension
//             .getRequestExecutor()
...
//             new IdentityDto(DEFAULT_USERNAME, IdentityType.USER), RoleType.EDITOR);
...
//
//     // when
//     final CollectionRoleRequestDto kermit =
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_KERMIT_ID, IdentityType.USER), RoleType.EDITOR);
//     final CollectionRoleRequestDto demo =
//         new CollectionRoleRequestDto(
//             // there is already an entry for the default user who created the collection
//             new IdentityDto(DEFAULT_USERNAME, IdentityType.USER), RoleType.EDITOR);
//     ConflictResponseDto conflictResponseDto =
...
//     final CollectionRoleRequestDto roleDto =
//         new CollectionRoleRequestDto(identityDto, RoleType.EDITOR);
//     collectionClient.addRolesToCollection(collectionId, roleDto);
//
//     final CollectionRoleUpdateRequestDto updatedRoleDto =
//         new CollectionRoleUpdateRequestDto(RoleType.VIEWER);
...
//             .map(IdResponseDto::getId)
//             .collect(Collectors.toList());
//     assertThat(roleIds).hasSize(2).contains(roleDto.getId());
//   }
//
//   @Test
...
//     final CollectionRoleUpdateRequestDto updatedRoleDto =
//         new CollectionRoleUpdateRequestDto(RoleType.VIEWER);
//     final Response updateRoleResponse =
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .withUserAuthentication(USER_KERMIT_ID, USER_KERMIT_ID)
...
//     // when
//     final CollectionRoleUpdateRequestDto updatedRoleDto =
//         new CollectionRoleUpdateRequestDto(RoleType.EDITOR);
//     ConflictResponseDto conflictResponseDto =
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildUpdateRoleToCollectionRequest(collectionId, roleEntryDto.getId(),
// updatedRoleDto)
//             .execute(ConflictResponseDto.class, Response.Status.CONFLICT.getStatusCode());
//
//     // then
...
//                 collectionId, notExistingRoleEntryId, updatedRoleDto)
//             .execute();
//
//     // then
...
//     // when
//     Response response =
//         createAndExecuteBuildDeleteCollectionRolesRequest(Collections.emptyList(), null);
//
//     // then
//     assertThat(response.getStatus()).isEqualTo(Response.Status.NOT_FOUND.getStatusCode());
//   }
...
//     // when
//     Response response =
//         createAndExecuteBuildDeleteCollectionRolesRequest(Collections.emptyList(),
// "doesntExist");
//
//     // then
//     assertThat(response.getStatus()).isEqualTo(Response.Status.NOT_FOUND.getStatusCode());
...
//     String collectionId = collectionClient.createNewCollection();
//
//     final CollectionRoleRequestDto roleDto1 =
//         new CollectionRoleRequestDto(
//             new IdentityDto(TEST_GROUP_ID, IdentityType.GROUP), RoleType.VIEWER);
//
//     final CollectionRoleRequestDto roleDto2 =
//         new CollectionRoleRequestDto(
//             new IdentityDto(USER_MISS_PIGGY_ID, IdentityType.USER), RoleType.VIEWER);
...
//         embeddedOptimizeExtension
//             .getRequestExecutor()
//             .buildDeleteCollectionRolesRequest(
//                 Arrays.asList(roleDto1.getId(), roleDto2.getId()), collectionId)
...
//     String collectionId = collectionClient.createNewCollection();
//
//     final CollectionRoleRequestDto groupViewerRole =
//         new CollectionRoleRequestDto(
//             new IdentityDto(TEST_GROUP_ID, IdentityType.GROUP), RoleType.VIEWER);
//
//     final CollectionRoleRequestDto userViewerRole =
//         new CollectionRoleRequestDto(
...
//     // when
//     Response response =
//         createAndExecuteBuildDeleteCollectionRolesRequest(
//             Arrays.asList(groupViewerRole.getId(), userViewerRole.getId()), collectionId);
//
//     // then
//     assertThat(response.getStatus()).isEqualTo(Response.Status.NO_CONTENT.getStatusCode());
//     final List<CollectionRoleResponseDto> actualRoles =
...
//     Response response =
//         createAndExecuteBuildDeleteCollectionRolesRequest(
//             Arrays.asList(demoManagerRole.getId(), groupViewerRole.getId()), collectionId);
//
//     // then
//     assertThat(response.getStatus()).isEqualTo(Response.Status.NO_CONTENT.getStatusCode());
//
...
//     Response response =
//         createAndExecuteBuildDeleteCollectionRolesRequest(
//             Arrays.asList(groupViewerRole.getId(), "doesNotExist", userViewerRole.getId()),
//             collectionId);
//
//     // then
//     assertThat(response.getStatus()).isEqualTo(Response.Status.NO_CONTENT.getStatusCode());
...
//         "Could not delete role with id doesNotExist. The role is already deleted.");
//   }
//
//   private void updateRoleOnCollection(
...
//   }
//
//   private void deleteRoleFromCollection(final String collectionId, final String roleEntryId) {
//     Response response =
//         embeddedOptimizeExtension
//             .getRequestExecutor()
...
//   }
//
//   private Response createAndExecuteBuildDeleteCollectionRolesRequest(
//       List<String> collectionRoles, String collectionId) {

...
// // import
// io.camunda.optimize.dto.optimize.query.event.process.source.ExternalEventSourceConfigDto;
// // import
...
// //     final EventProcessMappingDto eventProcessMapping =
// createWithEventSourceEntries(eventSources);
// //
// //     // when
// //     final String eventProcessMappingId =
// //         eventProcessClient.createEventProcessMapping(eventProcessMapping);
...
// //         .getConfiguration()
// //         .setEventScope(Arrays.asList(EventScopeType.START_END,
...
// //     Response response =
// //         eventProcessClient
// //             .createUpdateEventProcessMappingRequest(eventProcessMappingId,
// eventProcessMapping)
// //             .execute();
// //
// //     // then
...
// //     // given
// //     List<EventSourceEntryDto<?>> eventSourceEntryDtos = new ArrayList<>();
// //     final ExternalEventSourceEntryDto groupA =
// createExternalEventSourceEntryForGroup("aGroup");
// //     final ExternalEventSourceEntryDto groupB =
// createExternalEventSourceEntryForGroup("bGroup");
...
// //
// //     // then
// //     assertEventSourcesContainsExpectedEntries(updatedEventSources, Arrays.asList(groupA,
// groupB));
// //   }
// //
// //   @Test
...
// //         null, null, createTwoEventAndOneTaskActivitiesProcessDefinitionXml(),
// eventSourceEntries);
// //   }
// //
...
// //             .collect(
// //                 Collectors.toMap(EventSourceEntryDto::getSourceIdentifier,
// Function.identity()));
...
// //             assertThat((CamundaEventSourceConfigDto)
// actualEntryForIdentifier.getConfiguration())
...
// //             assertThat((ExternalEventSourceConfigDto)
// actualEntryForIdentifier.getConfiguration())
// //                 .usingRecursiveComparison()
// //                 .isEqualTo(expectedEntry.getConfiguration());
// //           }

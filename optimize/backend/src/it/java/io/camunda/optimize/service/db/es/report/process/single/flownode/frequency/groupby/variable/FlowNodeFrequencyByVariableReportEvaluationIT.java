...
// package
// io.camunda.optimize.service.db.es.report.process.single.flownode.frequency.groupby.variable;
//
...
//         reportClient.evaluateMapReport(reportData).getResult();
//
//     // then the instance withValue has passed through 4 flownodes and the 4 instances without the
//     // variable
...
//         reportClient.evaluateMapReport(reportData).getResult();
//
//     // then the result counts 2 flownodes from first definition plus 4 flownodes of the latest
//     // definition
//     assertThat(result.getFirstMeasureData()).isNotNull().hasSize(1);
//     assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), "aStringValue"))
//         .isPresent()
...
//     // given
//     final Map<String, Object> variables = Collections.singletonMap("stringVar", "aStringValue");
//     final ProcessInstanceEngineDto firstProcessInst =
//         deployAndStartSimpleProcessWithVariables(variables);
//     deployAndStartSimpleProcessWithVariables(variables);
//     final ProcessInstanceEngineDto latestProcessInst =
//         deployAndStartTwoServiceTaskProcessWithVariables(variables);
//
//     importAllEngineEntitiesFromScratch();
//
...
//             ImmutableList.of(
//                 firstProcessInst.getProcessDefinitionVersion(),
//                 latestProcessInst.getProcessDefinitionVersion()),
//             "stringVar",
//             VariableType.STRING);
//     final ReportResultResponseDto<List<MapResultEntryDto>> result =
//         reportClient.evaluateMapReport(reportData).getResult();
//
//     // then the result counts 2 flownodes of the first decfinition plus 4 flownodes of the latest
//     // definition
//     assertThat(result.getFirstMeasureData()).isNotNull().hasSize(1);
//     assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), "aStringValue"))
//         .isPresent()
...
//       final FilterApplicationLevel filterApplicationLevel, final Double expectedCount) {
//     // given
...
//     return Stream.of(
//         Arguments.of(IN, new String[] {DEFAULT_USERNAME}, 1.),
//         Arguments.of(IN, new String[] {DEFAULT_USERNAME, SECOND_USER, null}, 3.),
//         Arguments.of(NOT_IN, new String[] {SECOND_USER}, 2.),
//         Arguments.of(NOT_IN, new String[] {DEFAULT_USERNAME, SECOND_USER}, 1.));
//   }
//
//   @ParameterizedTest
...
//     return Stream.of(
//         Arguments.of(IN, new String[] {FIRST_CANDIDATE_GROUP_ID}, 1.),
//         Arguments.of(
//             IN, new String[] {FIRST_CANDIDATE_GROUP_ID, SECOND_CANDIDATE_GROUP_ID, null}, 3.),
//         Arguments.of(NOT_IN, new String[] {SECOND_CANDIDATE_GROUP_ID}, 2.),
//         Arguments.of(
//             NOT_IN, new String[] {FIRST_CANDIDATE_GROUP_ID, SECOND_CANDIDATE_GROUP_ID}, 1.));
//   }
//
//   @ParameterizedTest

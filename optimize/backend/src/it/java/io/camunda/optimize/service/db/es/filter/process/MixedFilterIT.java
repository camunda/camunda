...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.PROC_INST_FREQ_GROUP_BY_NONE;
...
// import
// io.camunda.optimize.dto.optimize.query.report.single.filter.data.operator.ComparisonOperator;
// import
...
//             .getHistoricProcessInstance(instanceEngineDto.getId())
//             .getStartTime();
//     OffsetDateTime end =
//         engineIntegrationExtension
//             .getHistoricProcessInstance(instanceEngineDto.getId())
...
//         instanceEngineDto.getId(), start.plusDays(2));
//     engineDatabaseExtension.changeProcessInstanceEndDate(
//         instanceEngineDto.getId(), end.plusDays(2));
...
//         createAndEvaluateReportWithFilter(processDefinition, filterList);
//
//     // then
//     assertThat(rawDataReportResultDto.getData()).hasSize(1);
//     assertThat(rawDataReportResultDto.getData().get(0).getProcessInstanceId())
...
//             .buildList();
//
//     ReportResultResponseDto<List<RawDataProcessInstanceDto>> rawDataReportResultDto =
//         createAndEvaluateReportWithFilter(processDefinition, filterList);
//
//     // then
//     assertThat(rawDataReportResultDto.getData()).hasSize(1);
...
//   public void testIncompatibleCombinationOfViewLevelFlowNodeStatusFilters(
...
//         evaluateReport(reportType, processDefinition, filterList);
//
//     // then
...
//
//   @Disabled(
//       "Disabled as there currently are no incompatible duration viewLevel filters. To be adjusted
// with OPT-5349"
//           + " and OPT-5350")
//   @ParameterizedTest
//   @MethodSource("reportTypesToEvaluate")
//   public void testIncompatibleCombinationOfViewLevelFlowNodeDurationFilters(
//       final ProcessReportDataType reportType) {
//     // given
...
//     engineDatabaseExtension.changeFirstFlowNodeInstanceStartDate(
//         SERVICE_TASK_ID_1, firstActivityStart);
//     engineDatabaseExtension.changeFirstFlowNodeInstanceEndDate(
//         SERVICE_TASK_ID_1, firstActivityStart.plusHours(1));
//     importAllEngineEntitiesFromScratch();
//
//     // when
//     List<ProcessFilterDto<?>> filterList =
...
//   @ParameterizedTest
//   @MethodSource("reportTypesToEvaluate")
//   public void testIncompatibleCombinationOfViewLevelAssigneeFilters(
//       final ProcessReportDataType reportType) {
//     // given
//     ProcessDefinitionEngineDto processDefinition =
//         engineIntegrationExtension.deployProcessAndGetProcessDefinition(
...
//   @ParameterizedTest
//   @MethodSource("reportTypesToEvaluate")
//   public void testIncompatibleCombinationOfViewLevelCandidateGroupFilters(
//       final ProcessReportDataType reportType) {
//     // given
...
//   @ParameterizedTest
//   @MethodSource("reportTypesToEvaluate")
//   public void testIncompatibleCombinationOfViewLevelIncidentFilters(
//       final ProcessReportDataType reportType) {
//     // given
...
//         .executeDeployment();
//     importAllEngineEntitiesFromScratch();
//     final ProcessDefinitionOptimizeDto def =
//         databaseIntegrationTestExtension.getAllProcessDefinitions().get(0);
//
//     // when
//     List<ProcessFilterDto<?>> filterList =
//         ProcessFilterBuilder.filter()
...
//             .buildList();
//     final ReportResultResponseDto<?> result =
//         evaluateReport(reportType, def.getKey(), def.getVersion(), filterList);
//
//     // then
//     assertReportWithIncompatibleFilters(reportType, result);
//   }
...
//   @ParameterizedTest
//   @MethodSource("reportTypesToEvaluate")
//   public void testIncompatibleCombinationOfViewLevelFlowNodeDateFilters(
//       final ProcessReportDataType reportType) {
//     // given
...
//             .add()
//             .buildList();
//     ReportResultResponseDto<?> result = evaluateReport(reportType, processDefinition,
// filterList);
//
//     // then
//     assertReportWithIncompatibleFilters(reportType, result);
...
//   @ParameterizedTest
//   @MethodSource("reportTypesToEvaluate")
//   public void testIncompatibleCombinationOfInstanceLevelFlowNodeDateFilters(
//       final ProcessReportDataType reportType) {
//     // given
//     final OffsetDateTime now = dateFreezer().freezeDateAndReturn();
//     ProcessDefinitionEngineDto processDefinition =
...
//     // given
//     ProcessReportDataDto reportData =
//         createReportWithDefinition(
//             engineIntegrationExtension.deployProcessAndGetProcessDefinition(
//                 getSingleUserTaskDiagram()));
//     reportData.setFilter(filters);
//     SingleProcessReportDefinitionRequestDto definition =
...
//   public void reportEvaluationWithValidApplicationLevelsForFilters(
...
//   @ParameterizedTest
//   @MethodSource("invalidFilters")
//   public void reportEvaluationWithInvalidApplicationLevelsForFilters(
//       List<ProcessFilterDto<?>> filters) {
//     // given
//     ProcessReportDataDto reportData =
//         createReportWithDefinition(
...
//   }
//
//   private ProcessReportDataDto createReportWithCompletedInstancesFilter(
//       ProcessDefinitionEngineDto processDefinition) {
//     ProcessReportDataDto processReportDataDto = createReportWithDefinition(processDefinition);
//     processReportDataDto.setFilter(
...
//                     !filter
//                         .get(0)
//                         .validApplicationLevels()
//                         .contains(FilterApplicationLevel.INSTANCE)),
//         buildFilters(FilterApplicationLevel.VIEW)
//             .filter(
//                 filter ->
//
// !filter.get(0).validApplicationLevels().contains(FilterApplicationLevel.VIEW)));
//   }
//
//   @SuppressWarnings(SuppressionConstants.UNUSED)
...
//   }
//
//   private static Stream<List<ProcessFilterDto<?>>> buildFilters(
//       final FilterApplicationLevel levelToApply) {
//     return Stream.of(
//         ProcessFilterBuilder.filter()
//             .executedFlowNodes()
//             .id("someId")
...
//         ProcessFilterBuilder.filter()
//             .fixedInstanceStartDate()
//             .start(LocalDateUtil.getCurrentDateTime().minusMinutes(60))
//             .end(LocalDateUtil.getCurrentDateTime())
//             .filterLevel(levelToApply)
//             .add()
//             .buildList(),
//         ProcessFilterBuilder.filter()
...
//             .name("name")
//             .operator(CONTAINS)
//             .values(Collections.singletonList("someString"))
//             .filterLevel(levelToApply)
//             .add()
//             .buildList(),
//         ProcessFilterBuilder.filter()
...
//   }
//
//   private ReportResultResponseDto<? extends Object> evaluateReport(
//       final ProcessReportDataType reportType,
//       final String definitionKey,
//       final String definitionVersion,
//       final List<ProcessFilterDto<?>> filter) {
//     final TemplatedProcessReportDataBuilder dataBuilder =
//         TemplatedProcessReportDataBuilder.createReportData()
...
//   }
//
//   private void assertReportWithIncompatibleFilters(
//       final ProcessReportDataType reportType, final ReportResultResponseDto<?> reportResult) {
...
//       case INCIDENT_FREQ_GROUP_BY_FLOW_NODE:
//       case RAW_DATA:
//         assertThat(((ReportResultResponseDto<List<?>>) reportResult).getFirstMeasureData())
//             .isEmpty();
//         break;
//       case PROC_INST_FREQ_GROUP_BY_NONE:
//         assertThat(((ReportResultResponseDto<Double>)
// reportResult).getFirstMeasureData()).isZero();
//         break;
//       case VARIABLE_AGGREGATION_GROUP_BY_NONE:
//         assertThat(((ReportResultResponseDto<Double>)
// reportResult).getFirstMeasureData()).isNull();
//         break;
//       default:
//         throw new OptimizeIntegrationTestException(
//             String.format("Cannot assert results of report of type %s in this test",
// reportType));
//     }
//   }
//
//   private ReportResultResponseDto<?> evaluateReport(
//       final ProcessReportDataType reportType,
//       final ProcessDefinitionEngineDto definitionEngineDto,
//       final List<ProcessFilterDto<?>> filter) {
//     return evaluateReport(
//         reportType, definitionEngineDto.getKey(), definitionEngineDto.getVersionAsString(),
// filter);
//   }
// }

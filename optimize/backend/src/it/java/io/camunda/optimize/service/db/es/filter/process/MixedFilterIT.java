...
import static io.camunda.optimize.service.util.ProcessReportDataType.INCIDENT_FREQ_GROUP_BY_FLOW_NODE;
...
import static io.camunda.optimize.service.util.ProcessReportDataType.VARIABLE_AGGREGATION_GROUP_BY_NONE;
...
public class MixedFilterIT extends AbstractFilterIT {
  ...
  @Disabled(
      "Disabled as there currently are no incompatible duration viewLevel filters. To be adjusted with OPT-5349"
          + " and OPT-5350")
  @ParameterizedTest
  @MethodSource("reportTypesToEvaluate")
  ...
  protected ReportResultResponseDto<List<RawDataProcessInstanceDto>>
    ...
    ProcessReportDataDto reportData = createReportWithCompletedInstancesFilter(processDefinition);
  ...
  private ReportResultResponseDto<?> evaluateReport(
    ...
    return evaluateReport(
        reportType, definitionEngineDto.getKey(), definitionEngineDto.getVersionAsString(), filter);
  }
}

...
// // import static
// io.camunda.optimize.service.util.EventDtoBuilderUtil.applyCamundaProcessInstanceEndEventSuffix;
// // import static
// io.camunda.optimize.service.util.EventDtoBuilderUtil.applyCamundaProcessInstanceStartEventSuffix;
// // import static
// io.camunda.optimize.service.util.EventDtoBuilderUtil.applyCamundaTaskEndEventSuffix;
// // import static
...
// // import
// io.camunda.optimize.dto.optimize.query.event.process.source.CamundaEventSourceConfigDto;
...
// //       LogCapturer.create().forLevel(Level.DEBUG).captureForType(EventCountService.class);
// //
// //   @BeforeAll
...
// //     // when
// //     Response response =
// //         createPostEventCountsRequestAllExternalEvents().withoutAuthentication().execute();
// //
...
// //         createPostEventCountsRequest(Collections.emptyList())
...
// //     // when
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestAllExternalEvents()
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
...
// //
// createPostEventCountsRequest(Collections.singletonList(externalEventSourceEntryForGroup))
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
...
// //
// //     // then all events are sorted using default group case-insensitive ordering
// //     assertThat(eventCountDtos).isNotNull().hasSize(6);
// //   }
// //
// //   @Test
...
// //                 definitionKey, EventScopeType.START_END, ImmutableList.of("1"))
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
// //     // then
...
// //             createStartEventCountDto(definitionKey, 1L), createEndEventCountDto(definitionKey,
// 0L));
// //   }
// //
// //   @Test
...
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestCamundaSourceOnly(
// //                 definitionKey, EventScopeType.PROCESS_INSTANCE, ImmutableList.of("1"))
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
// //     // then
...
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestCamundaSourceOnly(
// //                 definitionKey, EventScopeType.ALL, ImmutableList.of("1"))
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
// //     // then
...
// //                 definitionKey,
// //                 Arrays.asList(
// //                     EventScopeType.ALL, EventScopeType.PROCESS_INSTANCE,
...
// //
// //   @ParameterizedTest(
// //       name = "get all camunda events of the latest version if version selection is {0}")
// //   @MethodSource("multipleVersionCases")
// //   public void getEventCounts_camundaOnly_allEvents_multipleVersions_latestWins(
...
// //     // when
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestCamundaSourceOnly(definitionKey, EventScopeType.ALL,
// versions)
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
...
// //         DEFAULT_USERNAME, tenantId2, RESOURCE_TYPE_TENANT);
...
// //
// //     // when
// //     final EventCountRequestDto countRequestDto =
...
// //     final List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequest("etch", countRequestDto)
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
...
// //     // when
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestAllExternalEvents(searchTerm)
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
// //     // then matching event counts are return using default group case-insensitive ordering
...
// //     // when
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestAllExternalEvents(eventCountSorter)
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
...
// Response.Status.OK.getStatusCode());
// //
// //     // then the event counts are listed according to sort parameters according to label if
...
// //     // when
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestAllExternalEvents(eventCountSorter, null)
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
// //     // then all matching event counts are return using sort and ordering provided
...
// //     // when
// //     Response response =
// //         createPostEventCountsRequestAllExternalEvents(eventCountSorter, null).execute();
// //
...
// //     // when
// //     List<EventCountResponseDto> eventCountDtos =
// //         createPostEventCountsRequestAllExternalEvents(eventCountSorter, "etch")
// //             .executeAndReturnList(EventCountResponseDto.class,
// Response.Status.OK.getStatusCode());
// //
...
// //         String.format(
// //             "Cannot fetch event counts for sources with keys %s as sequence count indices do
// not exist",
...
// //     assertThat(eventCountDtos).isEmpty();
// //     logCapturer.assertContains(
// //         "Cannot fetch external event counts as sequence count index for external events does
// not exist");
// //   }
// //
...
// //   }
// //
// //   private OptimizeRequestExecutor createPostEventCountsRequestAllExternalEvents(String
// searchTerm) {
// //     return createPostEventCountsRequestAllExternalEvents(null, searchTerm);
// //   }
// //
// //   private OptimizeRequestExecutor createPostEventCountsRequestAllExternalEvents(
// //       EventCountSorter eventCountSorter) {
...
// //   }
// //
// //   private OptimizeRequestExecutor createPostEventCountsRequestCamundaSourceOnly(
// //       final String definitionKey, final EventScopeType eventScope, final List<String>
// versions) {
// //     return createPostEventCountsRequestCamundaSourceOnly(
// //         definitionKey, Collections.singletonList(eventScope), versions);
// //   }
// //
// //   private OptimizeRequestExecutor createPostEventCountsRequestCamundaSourceOnly(
...
// //         Arrays.asList(createCamundaEventSourceEntryDto(definitionKey, eventScope, versions));
...
// //         .getRequestExecutor()
// //         .buildPostEventCountRequest(
// //             EventCountRequestDto.builder().eventSources(eventSources).build());
// //   }
// //
// //   private OptimizeRequestExecutor createPostEventCountsRequest(
...
// //     return embeddedOptimizeExtension
// //         .getRequestExecutor()
// //         .buildPostEventCountRequest(eventCountSorter, searchTerm,
// eventCountSuggestionsRequestDto);
// //   }
// //
// //   private CamundaEventSourceEntryDto createCamundaEventSourceEntryDto(
// //       final String definitionKey,
// //       final List<EventScopeType> eventScope,
// //       final List<String> versions) {
...
// //   }
// //
// //   private EventCountResponseDto createProcessInstanceStartEventCountDto(
// //       final String definitionKey) {
// //     return EventCountResponseDto.builder()
// //         .source(EVENT_SOURCE_CAMUNDA)
// //         .group(definitionKey)
...
// //   }
// //
// //   private EventCountResponseDto createStartEventCountDto(
// //       final String definitionKey, final Long count) {
// //     return EventCountResponseDto.builder()
...
// //   }
// //
// //   private EventCountResponseDto createEndEventCountDto(
// //       final String definitionKey, final Long count) {
// //     return EventCountResponseDto.builder()
...
// //   }
// //
// //   private EventCountResponseDto createTaskEndEventCountDto(
// //       final String definitionKey, final String activityId, final Long count) {
// //     return EventCountResponseDto.builder()
...
// //   }
// //
// //   private EventCountResponseDto createTaskStartEventCountDto(
// //       final String definitionKey, final String activityId, final Long count) {
// //     return EventCountResponseDto.builder()
...
// //       final String definitionKey, final String tenantId) {
// //     // @formatter:off
// //     BpmnModelInstance processModel =
// //         Bpmn.createExecutableProcess(definitionKey)
...
// //   }
// //
// //   private ProcessInstanceEngineDto deployAndStartServiceTaskProcess(final String
// definitionKey) {

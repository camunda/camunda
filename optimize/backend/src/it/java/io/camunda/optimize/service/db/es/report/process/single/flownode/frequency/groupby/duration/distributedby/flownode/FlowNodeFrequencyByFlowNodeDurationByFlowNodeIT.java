...
// package
// io.camunda.optimize.service.db.es.report.process.single.flownode.frequency.groupby.duration.distributedby.flownode;
//
...
//             .dateFreezer(startTime.plus(completedActivityInstanceDurations + 1,
// ChronoUnit.MILLIS))
//             .freezeDateAndReturn();
...
//         Arguments.of(NOT_IN, new String[] {SECOND_USER}, Map.of(USER_TASK_1, 1., USER_TASK_3,
// 1.)),
//         Arguments.of(

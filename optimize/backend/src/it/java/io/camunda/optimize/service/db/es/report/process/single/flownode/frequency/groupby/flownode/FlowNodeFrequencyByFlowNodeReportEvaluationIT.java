...
// package
// io.camunda.optimize.service.db.es.report.process.single.flownode.frequency.groupby.flownode;
//
...
//         createReport(latestProcess.getProcessDefinitionKey(), ALL_VERSIONS);
...
//     assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), TEST_ACTIVITY))
//         .get()
...
//     // when
//     ProcessReportDataDto reportData =
//         createReport(engineDto.getProcessDefinitionKey(), ALL_VERSIONS);
...
//         .isPresent()
//         .get()
//         .satisfies(data -> assertThat(data.getValue()).isEqualTo(1));
...
//     // given
//     ProcessInstanceEngineDto instanceWithCanceledFlowNode =
// deployAndStartSimpleUserTaskProcess();
//     engineIntegrationExtension.cancelActivityInstance(
//         instanceWithCanceledFlowNode.getId(), USER_TASK_1);
//
...
//         evaluationResponse1 = reportClient.evaluateMapReport(reportData);
...
//     final AuthorizedProcessReportEvaluationResponseDto<List<MapResultEntryDto>>
//         evaluationResponse2 = reportClient.evaluateMapReport(reportData);
//
//     // then
//     final ProcessReportDataDto resultReportDataDto1 =
//         evaluationResponse1.getReportDefinition().getData();
//     assertThat(resultReportDataDto1.getProcessDefinitionKey())
//         .isEqualTo(instanceDto.getProcessDefinitionKey());
//     assertThat(resultReportDataDto1.getDefinitionVersions())
//         .contains(instanceDto.getProcessDefinitionVersion());
...
//     assertThat(MapResultUtil.getEntryForKey(result1.getFirstMeasureData(), TEST_ACTIVITY))
//         .get()
//         .extracting(MapResultEntryDto::getValue)
//         .isEqualTo(2.);
//
//     final ProcessReportDataDto resultReportDataDto2 =
//         evaluationResponse2.getReportDefinition().getData();
//     assertThat(resultReportDataDto2.getProcessDefinitionKey())
//         .isEqualTo(instanceDto2.getProcessDefinitionKey());
//     assertThat(resultReportDataDto2.getDefinitionVersions())
//         .contains(instanceDto2.getProcessDefinitionVersion());
...
//     assertThat(MapResultUtil.getEntryForKey(result2.getFirstMeasureData(), TEST_ACTIVITY))
//         .get()
//         .extracting(MapResultEntryDto::getValue)
//         .isEqualTo(1.);
//   }
...
//     // given
//     AbstractServiceTaskBuilder<?> serviceTaskBuilder =
...
//     for (int i = 1; i < 11; i++) {
//       serviceTaskBuilder =
//           serviceTaskBuilder.serviceTask(TEST_ACTIVITY + i).camundaExpression("${true}");
//     }
//     BpmnModelInstance processModel = serviceTaskBuilder.endEvent().done();
//
...
//     assertThat(MapResultUtil.getEntryForKey(result.getFirstMeasureData(), TEST_ACTIVITY + 0))
//         .get()
//         .extracting(MapResultEntryDto::getValue)
//         .isEqualTo(1.);
//   }
...
//
//     // when
//     ProcessReportDataDto reportData = createReport(testMIProcess, "1");
//     ReportResultResponseDto<List<MapResultEntryDto>> result =
//         reportClient.evaluateMapReport(reportData).getResult();
//
//     // then
...
//   public void viewLevelFiltersAlsoAppliedToInstances(
...
//     engineDatabaseExtension.changeFlowNodeTotalDuration(firstInstance.getId(), TEST_ACTIVITY,
// 5000);
...
//         secondInstance.getId(), TEST_ACTIVITY, 10000);
//
//     importAllEngineEntitiesFromScratch();
//
//     // when
...
//     return Stream.of(
//         Arguments.of(IN, new String[] {DEFAULT_USERNAME}, List.of(Tuple.tuple(USER_TASK_1, 1.))),
//         Arguments.of(
//             IN,
...
//     return Stream.of(
//         Arguments.of(
//             IN, new String[] {FIRST_CANDIDATE_GROUP_ID}, List.of(Tuple.tuple(USER_TASK_1, 1.))),
//         Arguments.of(
//             IN,
...
//   }
//
//   private ProcessReportDataDto createReport(String processDefinitionKey, String
// definitionVersion) {
//     return createReport(
//         processDefinitionKey, ImmutableList.of(definitionVersion),
// Collections.singletonList(null));
//   }
//
//   private ProcessReportDataDto createReport(
//       String processDefinitionKey, String definitionVersion, List<String> tenantIds) {
//     return createReport(processDefinitionKey, ImmutableList.of(definitionVersion), tenantIds);
//   }
//
//   private ProcessReportDataDto createReport(
//       String processDefinitionKey, List<String> definitionVersions) {
//     return createReport(processDefinitionKey, definitionVersions,
// Collections.singletonList(null));
//   }
//
//   private ProcessReportDataDto createReport(
//       String processDefinitionKey, List<String> definitionVersions, List<String> tenantIds) {

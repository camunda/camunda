...
// // //   protected static final Class<IntermediateCatchEvent> INTERMEDIATE_EVENT =
...
// // //   protected static final Class<ExclusiveGateway> EXCLUSIVE_GATEWAY =
// ExclusiveGateway.class;
// // //   protected static final Class<ParallelGateway> PARALLEL_GATEWAY = ParallelGateway.class;
// // //   protected static final Class<InclusiveGateway> INCLUSIVE_GATEWAY =
...
// // //
// // //   protected static BpmnModelInstance singleStartSingleEndModel(
// // //       final String processId, final String startEventId, final String endEventId) {
...
// // //   }
// // //
// // //   protected static BpmnModelInstance singleStartSingleEndUserTaskModel(
// // //       final String processId, final String startEventId, final String endEventId) {
// // //     return Bpmn.createExecutableProcess(processId)
// // //         .startEvent(startEventId)
...
// // //
// processBuilder.startEvent(START_EVENT_ID_1).exclusiveGateway(gateway).endEvent(END_EVENT_ID_1);
// // //
// processBuilder.startEvent(START_EVENT_ID_2).message(START_EVENT_ID_2).connectTo(gateway);
...
// // //     final ProcessBuilder processBuilder = Bpmn.createExecutableProcess(PROCESS_ID_1);
// // //     processBuilder.startEvent(START_EVENT_ID_1).done();
// // //     return processBuilder.done();
// // //   }
// // //
...
// // //     final ProcessBuilder processBuilder = Bpmn.createExecutableProcess(processId);
// // //     processBuilder.startEvent(START_EVENT_ID_1);
// // //     processBuilder.startEvent(START_EVENT_ID_2).message(IdGenerator.getNextId()).done();
// // //     return processBuilder.done();
// // //   }
// // //
// // //   protected void assertProcessMappingConfiguration(
...
// // //     assertThat(eventProcessMapping.getName())
// // //         .isEqualTo(EventProcessService.DEFAULT_AUTOGENERATED_PROCESS_NAME);
// // //     assertThat(eventProcessMapping.getState()).isEqualTo(processState);
// // //     assertThat(eventProcessMapping.getEventSources())
// // //         .extracting(
...
// // //                     source ->
// // //                         Tuple.tuple(
// // //                             source.getConfiguration().getEventScope(),
// source.getSourceType()))
// // //                 .collect(Collectors.toList()));
// // //   }
// // //
// // //   protected EventProcessMappingResponseDto autogenerateProcessAndGetMappingResponse(
// // //       final EventProcessMappingCreateRequestDto createRequestDto) {
// // //     final String processId =
// // //         eventProcessClient
// // //             .createCreateEventProcessMappingRequest(createRequestDto)
// // //             .execute(IdResponseDto.class, Response.Status.OK.getStatusCode())
// // //             .getId();
// // //     return eventProcessClient.getEventProcessMapping(processId);
// // //   }
// // //
// // //   protected EventProcessMappingCreateRequestDto buildAutogenerateCreateRequestDto(
...
// // //   }
// // //
// // //   protected CamundaEventSourceEntryDto deployDefinitionWithInstanceAndCreateEventSource(
// // //       final BpmnModelInstance modelInstance, final EventScopeType eventScopeType) {
...
// // //     return deployDefinitionWithInstanceAndCreateEventSource(
// // //         modelInstance, eventScopeType, variables, null);
// // //   }
// // //
// // //   protected CamundaEventSourceEntryDto deployDefinitionWithInstanceAndCreateEventSource(
// // //       final BpmnModelInstance modelInstance,
...
// // //         deployDefinitionWithInstance(modelInstance, variables, businessKey);
// // //     return createCamundaSourceEntry(
// // //         processInstanceEngineDto.getProcessDefinitionKey(), eventScopeType);
// // //   }
// // //
// // //   protected ProcessInstanceEngineDto deployDefinitionWithInstance(
// // //       final BpmnModelInstance modelInstance,
// // //       final Map<String, Object> variables,
// // //       final String businessKey) {
// // //     final ProcessInstanceEngineDto processInstanceEngineDto =
// // //         engineIntegrationExtension.deployAndStartProcessWithVariables(
// // //             modelInstance, variables, businessKey, null);
// // //     importEngineEntities();
// // //     return processInstanceEngineDto;
// // //   }
// // //
// // //   protected CamundaEventSourceEntryDto deployDefinitionAndCreateEventSource(
// // //       final BpmnModelInstance modelInstance, final EventScopeType eventScopeType) {
// // //     final ProcessDefinitionEngineDto processDefinitionEngineDto =
// // //         deployDefinition(modelInstance, null);
// // //     return createCamundaSourceEntry(processDefinitionEngineDto.getKey(), eventScopeType);
// // //   }
// // //
// // //   protected ProcessDefinitionEngineDto deployDefinition(
// // //       final BpmnModelInstance modelInstance, final String tenantId) {
// // //     final ProcessDefinitionEngineDto processDefinitionEngineDto =
...
// // //   }
// // //
// // //   protected CamundaEventSourceEntryDto createCamundaSourceEntry(
// // //       final String definitionKey, final EventScopeType eventScopeType) {
...
// // //   }
// // //
// // //   protected void assertNodeConnection(
...
// // //
// assertThat(expectedNodeType.isAssignableFrom(element.getElementType().getInstanceType()))
// // //         .isTrue();
// // //     final Collection<SequenceFlow> outgoingSequenceFlows =
// // //         expectedNodeType.cast(element).getOutgoing();
...
// // //     } else {
// // //       final Optional<FlowNode> connectedNode =
...
// // //       if (expectedConnectedNodeType != null) {
// // //         assertThat(
// // //                 expectedConnectedNodeType.isAssignableFrom(
// // //                     connectedNode.get().getElementType().getInstanceType()))
// // //             .isTrue();
// // //       }
// // //     }
// // //   }
// // //
// // //   protected void assertCorrectMappingsAndContainsEvents(
...
// // //             (id, mapping) ->
// // //
// assertThat(bpmnModelInstance.getModelElementById(id).getElementType()).isNotNull());
// // //   }
// // //
// // //   protected void assertGatewayWithSourcesAndTargets(
// // //       final List<String> expectedSourceNodeIds,
// // //       final List<String> expectedTargetNodeIds,
// // //       final Gateway gateway) {
// // //     final List<String> incomingNodeIds =
// // //         gateway.getIncoming().stream()
// // //             .map(SequenceFlow::getSource)
// // //             .map(FlowNode::getId)
// // //             .collect(Collectors.toList());
// // //     final List<String> outgoingNodeIds =
...
// // //   }
// // //
// // //   protected Gateway getGatewayWithId(final Collection<Gateway> gateways, final String
// gatewayId) {
// // //     return gateways.stream().filter(gateway ->
// gateway.getId().equals(gatewayId)).findFirst().get();
// // //   }
// // //
...
// // //   }
// // //
// // //   protected CloudEventRequestDto createCloudEventOfType(
// // //       final EventTypeDto eventType, final String traceId, final Instant now) {
...
// // //   }
// // //
// // //   protected void ingestEventAndProcessTraces(final List<CloudEventRequestDto>
// eventsToIngest) {
// // //     ingestionClient.ingestEventBatch(eventsToIngest);
// // //     processEventCountAndTraces();
// // //   }
// // //
// // //   protected List<EventTypeDto> getMappedEventTypeDtosFromMappings(
// // //       final Map<String, EventMappingDto> mappings) {
...
// // //   }
// // //
// // //   protected List<EventTypeDto> getEventCountsAsEventTypeDtos(
// // //       final List<EventSourceEntryDto<?>> camundaEventSourceEntryDtos) {
// // //     return embeddedOptimizeExtension
// // //         .getRequestExecutor()
// // //         .buildPostEventCountRequest(
// // //
// EventCountRequestDto.builder().eventSources(camundaEventSourceEntryDtos).build())
// // //         .executeAndReturnList(EventCountResponseDto.class,
...
// // //   }
// // //
// // //   protected String idOf(final EventTypeDto eventTypeDto) {

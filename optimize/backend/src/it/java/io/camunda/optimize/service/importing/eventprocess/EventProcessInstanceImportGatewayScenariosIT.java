...
//                               ? SECOND_EVENT_DATETIME
//                               : FIRST_EVENT_DATETIME),
//                       Tuple.tuple(USER_TASK_TYPE, USER_TASK_ID_ONE, SECOND_EVENT_DATETIME,
// null)));
//             });
//   }
//
...
//     OffsetDateTime thirdEventSecondOccurrenceTime =
// secondEventSecondOccurrenceTime.plusSeconds(1);
//     OffsetDateTime secondEventThirdOccurrenceTime =
// thirdEventSecondOccurrenceTime.plusSeconds(1);
//
//     ingestTestEvent(FIRST_EVENT_NAME, FIRST_EVENT_DATETIME);
//     ingestTestEvent(SECOND_EVENT_NAME, SECOND_EVENT_DATETIME);
//     ingestTestEvent(THIRD_EVENT_NAME, THIRD_EVENT_DATETIME);
...
//         .hasFieldOrPropertyWithValue(ProcessInstanceDto.Fields.state,

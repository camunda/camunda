...
//                 .flowNodeData(
//                     ImmutableList.of(
//                         new FlowNodeDataDto(BPMN_END_EVENT_ID, BPMN_END_EVENT_ID,
// END_EVENT_TYPE),
...
//         buildSimpleEventProcessMappingDto(STARTED_EVENT, FINISHED_EVENT);
//     final String eventProcessMappingId =
// createAndPublishEventProcess(simpleEventProcessMappingDto);
...
//     eventProcessClient.publishEventProcessMapping(eventProcessMappingId);
//
//     // two cycles needed as the definition gets published with the next cycle after publish
// finished
//     executeImportCycle();
//     executeImportCycle();
//   }

...
// package io.camunda.optimize.service.process.digest;
//
...
//                 + "targets.")
//         .containsIgnoringWhitespaces("There are currently no time KPIs defined for this
// process.")
//         .containsIgnoringWhitespaces(
...
//     assertThat(greenMail.waitForIncomingEmail(100, 1)).isTrue();
//     assertThat(readEmailHtmlContent(greenMail.getReceivedMessages()[0]))
//         .containsIgnoringWhitespaces("#/report/" + reportId +
// "?utm_medium=email&utm_source=digest")
//         .containsIgnoringWhitespaces("#/");
//   }
//
//   @Test
...
//       assertThat(readEmailHtmlContent(greenMail.getReceivedMessages()[0]))
//           .containsIgnoringWhitespaces(
//               customContextPath + "/#/report/" + reportId +
// "?utm_medium=email&utm_source=digest")
...
//     engineIntegrationExtension.deployAndStartProcess(getSimpleBpmnDiagram(DEF_KEY));
//     importAllEngineEntitiesFromScratch();
//     processOverviewClient.updateProcess(DEF_KEY, DEFAULT_USERNAME, new
// ProcessDigestRequestDto());
...
//             DEFAULT_USERNAME, DEF_KEY, new ProcessDigestDto(false, null),

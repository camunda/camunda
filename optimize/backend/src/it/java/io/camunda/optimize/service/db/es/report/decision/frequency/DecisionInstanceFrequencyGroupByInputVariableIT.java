...
// String.valueOf(decisionDefinitionDto1.getVersion());
//     startDecisionInstanceWithInputVars(
//         decisionDefinitionDto1.getId(), createInputsWithDate(100.0, dateGroupKey));
//     startDecisionInstanceWithInputVars(
//         decisionDefinitionDto1.getId(), createInputsWithDate(100.0, dateGroupKey));
//
//     // different version
...
//   @Test
//   public void
//       reportEvaluationMultiBucketGroupByNumberInputVariable_invalidBaseline_returnsEmptyResult()
// {
//     // given
//     DecisionDefinitionEngineDto decisionDefinitionDto1 =
//         engineIntegrationExtension.deployDecisionDefinition();
//     startDecisionInstanceWithInputVars(decisionDefinitionDto1.getId(), createInputs(10.0,
// "Misc"));
//     startDecisionInstanceWithInputVars(decisionDefinitionDto1.getId(), createInputs(20.0,
// "Misc"));
//
//     importAllEngineEntitiesFromScratch();
//
...
//     DecisionDefinitionEngineDto decisionDefinitionDto1 =
//         engineIntegrationExtension.deployDecisionDefinition();
//     startDecisionInstanceWithInputVars(decisionDefinitionDto1.getId(), createInputs(-1.0,
// "Misc"));
//     startDecisionInstanceWithInputVars(decisionDefinitionDto1.getId(), createInputs(-5.0,
// "Misc"));
//
//     importAllEngineEntitiesFromScratch();
//
...
//     final List<MapResultEntryDto> resultData = result.getFirstMeasureData();
//     assertThat(resultData.stream().mapToDouble(MapResultEntryDto::getValue).sum()).isEqualTo(6L);
//     final List<String> resultDataKeys =
...
//   @Test
//   public void
// reportEvaluationMultiBucketsSpecificVersionGroupByNumberInputVariableFilterByValue() {
//     // given
//     DecisionDefinitionEngineDto decisionDefinitionDto1 =
//         engineIntegrationExtension.deployDecisionDefinition();
//     final String decisionDefinitionVersion1 =
...
//             .setVariableType(VariableType.DOUBLE)
//             .setFilter(
//                 Lists.newArrayList(createNumericInputVariableFilter(INPUT_AMOUNT_ID, IN,
// "200.0")))
//             .build();
//
//     final ReportResultResponseDto<List<MapResultEntryDto>> result =
...
//   public void
//
// reportEvaluationSingleBucketAllVersionsGroupByNumberInputVariableOtherDefinitionsHaveNoSideEffect() {
//     // given
//     final String amountValue = "100.00";
//     final Double amountValueAsDouble = Double.valueOf(amountValue);
//     DecisionDefinitionEngineDto decisionDefinitionDto1 =
...
//         deployDefaultDecisionDefinitionWithDifferentKey("otherKey");
//     startDecisionInstanceWithInputVars(
...
//         deploySimpleInputDecisionDefinition(inputClauseId, camInputVariable,
...
//     final ReportResultResponseDto<List<MapResultEntryDto>> result =
//         evaluateDecisionInstanceFrequencyByInputVariable(
//                 definition, definition.getVersionAsString(), inputClauseId, null,
// VariableType.DATE)
//             .getResult();
//
//     // then
...
//     dateVariableValue =
//         dateVariableValue.minus(numberOfInstances - 1, chronoUnit); // reset to first variable
// value
//     for (int i = 0; i < numberOfInstances; i++) {
...
//     engineIntegrationExtension.startDecisionInstance(
//         decisionDefinitionDto.getId(), ImmutableMap.of(camInputVariable, "whateverElse"));
//     engineIntegrationExtension.startDecisionInstance(
...
//         .isEqualTo(1.);
//     assertThat(
//             MapResultUtil.getEntryForKey(result.getFirstMeasureData(), "whateverElse")
//                 .get()
//                 .getValue())
//         .isEqualTo(1.);
//     assertThat(
...
//     final DecisionDefinitionEngineDto decisionDefinitionDto =
//         deploySimpleInputDecisionDefinition(
//             inputVariableName, outputVariableName, DecisionTypeRef.DOUBLE);
//     engineIntegrationExtension.startDecisionInstance(
//         decisionDefinitionDto.getId(), ImmutableMap.of(outputVariableName, doubleVarValue));
//     engineIntegrationExtension.startDecisionInstance(
//         decisionDefinitionDto.getId(), Collections.singletonMap(outputVariableName, null));
//     engineIntegrationExtension.startDecisionInstance(
//         decisionDefinitionDto.getId(),
...
//   }
//
//   private DecisionDefinitionEngineDto deployDefaultDecisionDefinitionWithDifferentKey(
//       final String key) {

...
// package
// io.camunda.optimize.service.db.es.report.process.single.flownode.duration.groupby.flownode.distributedby.process;
//
...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_DUR_GROUP_BY_FLOW_NODE_BY_PROCESS;
...
//
// public class FlowNodeDurationByFlowNodeByProcessReportEvaluationIT extends AbstractPlatformIT {
//
...
//             Tuple.tuple(new AggregationDto(AVERAGE), createResultsForAllFlowNodes(3000.0,
// 1000.0)),
...
//             // on merging
//             Tuple.tuple(
//                 new AggregationDto(PERCENTILE, 50.), createResultsForAllFlowNodes(null, null)),
//             Tuple.tuple(
//                 new AggregationDto(PERCENTILE, 99.), createResultsForAllFlowNodes(null, null)));
//   }
//

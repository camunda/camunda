...
// package
// io.camunda.optimize.service.db.es.report.process.single.usertask.frequency.groupby.date.distributedby.candidategroup;
//
...
//     final List<HyperMapResultEntryDto> resultData = result.getFirstMeasureData();
//     String nowStrippedToMonthAsString =
//         localDateTimeToString(truncateToStartOfUnit(now, ChronoUnit.MONTHS));
...
//     // when
//     final ProcessReportDataDto reportData =
//         createReportData("nonExistingProcessDefinitionId", "1", AggregateByDateUnit.DAY);
//     final ReportResultResponseDto<List<HyperMapResultEntryDto>> actualResult =
//         reportClient.evaluateHyperMapReport(reportData).getResult();
//
//     // then
...
//         processDefinition.getKey(), processDefinition.getVersionAsString(), groupByDateUnit);
//   }
//

...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_FLOW_NODE_DURATION_BY_FLOW_NODE;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_FLOW_NODE_END_DATE;
// import static
...
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_USER_TASK_END_DATE;
// import static
...
// import
// io.camunda.optimize.dto.optimize.query.report.single.process.group.value.VariableGroupByValueDto;
...
//     ((VariableGroupByValueDto)
// groupByNumberVar1Data.getGroupBy().getValue()).setName("doubleVar");
...
//     ((VariableGroupByValueDto)
// groupByNumberVar2Data.getGroupBy().getValue()).setName("doubleVar");
...
//         Arrays.asList(instanceCountStartDateYearBarChart,
// instanceDurationBstartDateYearBarChart),
...
//         reportClient.evaluateCombinedReportByIdWithAdditionalFilters(combinedReportId,
// filterDto);
//
...
//             .add()
//             .buildList());
//     String singleReportIdA = createNewSingleMapReportWithFilter(engineDto,
// singleReportFilterDto);
//     String singleReportIdB = createNewSingleMapReportWithFilter(engineDto,
// singleReportFilterDto);
//     importAllEngineEntitiesFromScratch();
//
...
//   @Tag(OPENSEARCH_SINGLE_TEST_FAIL_OK)
//   public void
// combinedReportsCanBeEvaluatedWithAdditionalFilters_filterVariableExistsInOneReport() {
//     // given
...
//     ProcessInstanceEngineDto engineDto = deployAndStartSimpleUserTaskProcess();
//     engineIntegrationExtension.finishAllRunningUserTasks();
//     String userTaskTotalDurationReportId =
// createNewSingleUserTaskTotalDurationMapReport(engineDto);
...
//   @Tag(OPENSEARCH_SINGLE_TEST_FAIL_OK)
//   public void
// singleReportsAreRemovedFromCombinedReportOnReportUpdateWhenMultiUserTaskTimesAdded() {
//     // given
//     final ProcessInstanceEngineDto engineDto = deploySimpleServiceTaskProcessDefinition();
//     final ProcessReportDataDto userTaskDurationByTaskReportData =
//         TemplatedProcessReportDataBuilder.createReportData()
...
//   @Tag(OPENSEARCH_SINGLE_TEST_FAIL_OK)
//   public void
// canEvaluateUnsavedCombinedReportWithGroupedByProcessInstanceStartAndEndDateReports() {
//     // given
//     OffsetDateTime now = OffsetDateTime.now();
//     ProcessInstanceEngineDto engineDto = deployAndStartSimpleUserTaskProcess();
//     engineIntegrationExtension.finishAllRunningUserTasks(engineDto.getId());
...
//         resultMap = result.getData();
//     assertThat(resultMap).isNotNull();
//     assertThat(resultMap.keySet()).contains(groupedByEndDateReportId,
// groupedByStartDateReportId);
//
//     final ReportResultResponseDto<List<MapResultEntryDto>> result1 =
...
//   }
//
//   private String createNewSingleUserTaskTotalDurationMapReport(ProcessInstanceEngineDto
// engineDto) {
//     ProcessReportDataDto durationMapReportData =
//         TemplatedProcessReportDataBuilder.createReportData()
//             .setProcessDefinitionKey(engineDto.getProcessDefinitionKey())

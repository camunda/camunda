...
// import static
// io.camunda.optimize.dto.optimize.query.report.single.configuration.TableColumnDto.INPUT_PREFIX;
// import static
// io.camunda.optimize.dto.optimize.query.report.single.configuration.TableColumnDto.OUTPUT_PREFIX;
...
// import static io.camunda.optimize.util.DmnModels.OUTPUT_BEVERAGES;
// import static io.camunda.optimize.util.DmnModels.OUTPUT_CLASSIFICATION_ID;
...
// import
// io.camunda.optimize.service.db.es.report.command.modules.view.decision.DecisionViewRawData;
...
//         createOutputs(false, "day-to-day expense");
...
//         createReport(decisionDefinitionDto.getKey(), decisionDefinitionVersion);
...
//
//     final RawDataDecisionInstanceDto rawDataDecisionInstanceDto = result.getData().get(0);
//     assertThat(rawDataDecisionInstanceDto.getDecisionDefinitionKey())
//         .isEqualTo(decisionDefinitionDto.getKey());
//     assertThat(rawDataDecisionInstanceDto.getDecisionDefinitionId())
//         .isEqualTo(decisionDefinitionDto.getId());
...
//
//     final Map<String, InputVariableEntry> receivedInputVariables =
//         rawDataDecisionInstanceDto.getInputVariables();
//     assertInputVariablesMatchExcepted(inputs, receivedInputVariables);
//
//     final Map<String, OutputVariableEntry> receivedOutputVariables =
//         rawDataDecisionInstanceDto.getOutputVariables();
...
//     assertThat(resultDataDto.getDecisionDefinitionVersions())
//         .containsOnly(decisionDefinitionVersion);
//     assertThat(resultDataDto.getView())
//         .isNotNull()
//         .extracting(DecisionViewDto::getProperties)
//         .satisfies(
//             viewProperties -> assertThat(viewProperties).containsExactly(ViewProperty.RAW_DATA));
//   }
//
//   @Test
...
//     final DecisionDefinitionEngineDto decisionDefinitionDto =
//         engineIntegrationExtension.deployDecisionDefinition(
//             createDefaultDmnModel("aUniqueDefinitionKey"));
//     importAllEngineEntitiesFromScratch();
//
//     final DecisionReportDataDto reportData =
//         createReport(decisionDefinitionDto.getKey(), decisionDefinitionDto.getVersionAsString());
//
//     // when
//     final AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
//         evaluationResult = reportClient.evaluateDecisionRawReport(reportData, null);
//     final ReportResultResponseDto<List<RawDataDecisionInstanceDto>> result =
//         evaluationResult.getResult();
//
//     // then
...
//         deployAndStartMultiTenantDefinition(Arrays.asList(null, tenantId1, tenantId2));
//
//     importAllEngineEntitiesFromScratch();
//
//     // when
//     final DecisionReportDataDto reportData = createReport(decisionDefinitionKey, ALL_VERSIONS);
...
//         .getConfiguration()
//         .setSorting(
//             new ReportSortingDto(DecisionInstanceIndex.DECISION_INSTANCE_ID, SortOrder.ASC));
//     final AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
//         evaluationResult = evaluateRawReportWithDefaultPagination(reportData);
//
//     // then
...
//         .getConfiguration()
//         .setSorting(
//             new ReportSortingDto(DecisionInstanceIndex.EVALUATION_DATE_TIME, SortOrder.ASC));
//     final AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
//         evaluationResult = evaluateRawReportWithDefaultPagination(reportData);
//
//     // then
...
//     startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs(20.0,
// "Misc"));
...
// "Misc"));
//     startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs(400.0,
// "Misc"));
//     startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs(1000.0,
// "Misc"));
//
//     importAllEngineEntitiesFromScratch();
//
...
//         .getConfiguration()
//         .setSorting(
//             new ReportSortingDto(
//                 DecisionViewRawData.INPUT_VARIABLE_PREFIX + INPUT_AMOUNT_ID, SortOrder.ASC));
//     final AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
//         evaluationResult = evaluateRawReportWithDefaultPagination(reportData);
//
//     // then
...
//                 instance ->
//                     Double.parseDouble(
//                         (String) instance.getInputVariables().get(INPUT_AMOUNT_ID).getValue())));
//   }
//
//   @Test
...
//     startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs(10.0,
// "Misc"));
...
// "Misc"));
//     // results in audit true
//     startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs(3000.0,
// "Misc"));
//     // results in audit false
//     startDecisionInstanceWithInputVars(decisionDefinitionDto.getId(), createInputs(200.0,
// "Misc"));
...
//         .setSorting(
//             new ReportSortingDto(
//                 DecisionViewRawData.OUTPUT_VARIABLE_PREFIX + OUTPUT_AUDIT_ID, SortOrder.ASC));
//     final AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
//         evaluationResult = evaluateRawReportWithDefaultPagination(reportData);
//
//     // then
...
//                         (String)
//
// instance.getOutputVariables().get(OUTPUT_AUDIT_ID).getFirstValue())));
//   }
//
//   @Test
...
//     AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
...
//         .satisfies(
//             rawDataInstance -> {
//               assertThat(rawDataInstance.getInputVariables().entrySet())
//                   .singleElement()
//                   .satisfies(
//                       inputVar ->
//                           assertThat(inputVar.getValue().getValue())
//                               .isEqualTo(String.valueOf(doubleVarValue)));
//               assertThat(rawDataInstance.getOutputVariables().entrySet())
//                   .singleElement()
//                   .satisfies(
//                       outputVar ->
//                           assertThat(outputVar.getValue().getValues())
...
//                   .singleElement()
//                   .satisfies(inputVar ->
// assertThat(inputVar.getValue().getValue()).isEqualTo(""));
//               assertThat(rawDataInstance.getOutputVariables().entrySet())
//                   .singleElement()
//                   .satisfies(outputVar ->
// assertThat(outputVar.getValue().getValues()).isEmpty());
//             });
//   }
//
//   @Test
...
//         .getTableColumns()
//         .getExcludedColumns()
//         .add(INPUT_PREFIX + INPUT_AMOUNT_ID);
//     reportData
//         .getConfiguration()
//         .getTableColumns()
//         .getIncludedColumns()
//         .add(OUTPUT_PREFIX + OUTPUT_AUDIT_ID);
...
//         .getTableColumns()
//         .getExcludedColumns()
//         .add(nonExistentInputVariable);
//     reportData
//         .getConfiguration()
//         .getTableColumns()
//         .getIncludedColumns()
//         .add(nonExistentOutputVariable);
//     final AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
//         evaluationResult = evaluateRawReportWithDefaultPagination(reportData);
//
...
//         databaseIntegrationTestExtension.getAllDecisionInstances().stream()
...
//     // given
//     final DecisionReportDataDto reportData = createReport("definitionKey", ALL_VERSIONS);
//
//     // when
//     final PaginationRequestDto paginationDto = new PaginationRequestDto();
...
//     engineIntegrationExtension.startDecisionInstance(decisionDefinitionDto.getId());
//     importAllEngineEntitiesFromScratch();
//     final String expectedDecisionInstanceId =
//         databaseIntegrationTestExtension.getAllDecisionInstances().stream()
//             .sorted(Comparator.comparing(DecisionInstanceDto::getEvaluationDateTime).reversed())
//             .map(DecisionInstanceDto::getDecisionInstanceId)
//             .findFirst()
...
//         reportClient.createSingleDecisionReport(
//             createReport(decisionDefinitionDto.getKey(), ALL_VERSIONS));
//
//     // These are the expected instances using their default sort
//     final List<String> expectedInstanceIds =
...
//       evaluateSavedRawDataDecisionReport(
...
//
//   private AuthorizedDecisionReportEvaluationResponseDto<List<RawDataDecisionInstanceDto>>
//       evaluateRawReportWithDefaultPagination(final DecisionReportDataDto reportData) {
//     final PaginationRequestDto paginationDto = new PaginationRequestDto();
//     paginationDto.setOffset(0);
//     paginationDto.setLimit(20);
...
//   }
//
//   private void assertInputVariablesMatchExcepted(
//       final HashMap<String, InputVariableEntry> expectedVariables,
...
//   }
//
//   private void assertOutputVariablesMatchExcepted(
//       final HashMap<String, OutputVariableEntry> expectedVariables,
...
//                   variableEntry.getValues().stream().map(String::valueOf).toArray());
//         });
//   }
//
...
//   }
//
//   private void startDishDecisionInstance(
//       final DecisionDefinitionEngineDto decisionDefinitionEngineDto) {
//     engineIntegrationExtension.startDecisionInstance(
...
//         put(
//             OUTPUT_AUDIT_ID,
//             new OutputVariableEntry(OUTPUT_AUDIT_ID, "Audit", VariableType.BOOLEAN, auditValue));
//         put(
...
//   }
//
//   private DecisionReportDataDto createReport(
//       final String decisionDefinitionKey, final String decisionDefinitionVersion) {

 ...
 */
package io.camunda.optimize.service.db.es.report.process.single.flownode.duration.groupby.date.distributedby.flownode;
...
import io.camunda.optimize.service.db.es.report.process.single.ModelElementDurationByModelElementDateByModelElementReportEvaluationIT;
...
public abstract class FlowNodeDurationByFlowNodeDateByFlowNodeReportEvaluationIT
  ...
  private static Stream<Arguments> viewLevelAssigneeFilterScenarios() {
    return Stream.of(
        Arguments.of(IN, new String[] {SECOND_USER}, Map.of(USER_TASK_2, 3000.)),
        Arguments.of(
            IN,
        ...
        Arguments.of(NOT_IN, new String[] {DEFAULT_USERNAME, null}, Map.of(USER_TASK_2, 3000.)));
  }
  ...
  private static Stream<Arguments> viewLevelCandidateGroupFilterScenarios() {
    return Stream.of(
        Arguments.of(IN, new String[] {SECOND_CANDIDATE_GROUP_ID}, Map.of(USER_TASK_2, 3000.)),
        Arguments.of(
            IN,
  ...
  protected void changeDuration(
    ...
    engineDatabaseExtension.changeFlowNodeTotalDuration(
        processInstanceDto.getId(), modelElementId, durationInMs.longValue());

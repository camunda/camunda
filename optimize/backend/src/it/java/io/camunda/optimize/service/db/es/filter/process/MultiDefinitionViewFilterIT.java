...
//             // only catch the second user task flow node instances (thus also only catching 2 of
// 4
//             // process instances)
//             .executedFlowNodes()
//             .filterLevel(VIEW)
...
//     reportData.setFilter(
//         ProcessFilterBuilder.filter()
//             // exclude the start events of all process (catches 4/4 instances as all have other
// flow
//             // node instances)
//             .executedFlowNodes()
//             .filterLevel(VIEW)
...
//     reportData.setFilter(
//         ProcessFilterBuilder.filter()
//             // only catch the instances with specific assignee from each process (thus only 2 of
// 4
//             // process instances)
//             .assignee()
//             .filterLevel(VIEW)
...
//             .appliedTo(APPLIED_TO_ALL_DEFINITIONS)
//             .add()
//             // this will lead to no results from definition 2 as the all and the specific filter
// are
//             // mutually exclusive:

...
//
// public abstract class ModelElementFrequencyByModelElementDateReportEvaluationIT
...
//         processDefinition.getId(), referenceDate.minusDays(3), referenceDate.minusDays(1));
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), referenceDate.minusDays(2), referenceDate.minusDays(4));
//
//     importAllEngineEntitiesFromScratch();
//
//     // when
...
//         processDefinition.getId(), referenceDate.minusDays(3), referenceDate.minusDays(1));
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), referenceDate.minusDays(2), referenceDate.minusDays(2));
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), referenceDate.minusDays(3), referenceDate.minusDays(3));
//     importAllEngineEntitiesFromScratch();
//
//     // when
//     final ProcessReportDataDto reportData = createGroupedByDayReport(processDefinition);
//     reportData.getConfiguration().setSorting(new ReportSortingDto(SORT_BY_VALUE,
// SortOrder.DESC));
//     final ReportResultResponseDto<List<MapResultEntryDto>> result =
//         reportClient.evaluateMapReport(reportData).getResult();
//
...
//     final OffsetDateTime referenceDate = OffsetDateTime.now();
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), referenceDate.minusDays(1), referenceDate.minusDays(2));
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), referenceDate.minusDays(1), referenceDate.minusDays(2));
//     importAllEngineEntitiesFromScratch();
//
...
//     final String expectedStringDayBeforeYesterday =
//         localDateTimeToString(startOfToday.minusDays(2));
...
//     ProcessDefinitionEngineDto processDefinition = deployTwoModelElementDefinition();
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), referenceDate.minusDays(1), referenceDate.minusDays(3));
//     importAllEngineEntitiesFromScratch();
//
//     // when
//     final ProcessReportDataDto reportData = createGroupedByDayReport(processDefinition);
...
//     startAndCompleteInstanceWithDates(
//         processDefinition1.getId(), referenceDate.minusDays(1), referenceDate.minusDays(1));
//     ProcessDefinitionEngineDto processDefinition2 = deployTwoModelElementDefinition();
//     startAndCompleteInstanceWithDates(
//         processDefinition2.getId(), referenceDate.minusDays(1), referenceDate.minusDays(1));
//     importAllEngineEntitiesFromScratch();
//
//     // when
...
//     startInstancesWithDayRangeForDefinition(processDefinition1, now.plusDays(1),
// now.plusDays(4));
//     ProcessDefinitionEngineDto processDefinition2 = deploySimpleModelElementDefinition();
//     startInstancesWithDayRangeForDefinition(processDefinition2, now.plusDays(4),
// now.plusDays(6));
//     importAllEngineEntitiesFromScratch();
//
//     SingleProcessReportDefinitionRequestDto singleProcessReportDefinitionDto =
...
//         createReportData(processDefinition1, AggregateByDateUnit.AUTOMATIC);
//     singleProcessReportDefinitionDto.setData(reportData);
//     final String singleReportId1 =
//         reportClient.createSingleProcessReport(singleProcessReportDefinitionDto);
//     reportData = createReportData(processDefinition2, AggregateByDateUnit.AUTOMATIC);
//     singleProcessReportDefinitionDto.setData(reportData);
//     final String singleReportId2 =
//         reportClient.createSingleProcessReport(singleProcessReportDefinitionDto);
//
//     // when
...
// now.plusDays(6));
//     ProcessDefinitionEngineDto processDefinition2 = deploySimpleModelElementDefinition();
//     startInstancesWithDayRangeForDefinition(processDefinition2, now.plusDays(3),
// now.plusDays(5));
//     importAllEngineEntitiesFromScratch();
//
//     SingleProcessReportDefinitionRequestDto singleProcessReportDefinitionDto =
...
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), startOfToday.plusDays(2), startOfToday.plusDays(2));
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), startOfToday.plusDays(5), startOfToday.plusDays(5));
//
//     importAllEngineEntitiesFromScratch();
//
//     // when
...
//     startAndCompleteInstanceWithDates(processDefinition.getId(), startOfToday, startOfToday);
//     startAndCompleteInstanceWithDates(
//         processDefinition.getId(), startOfToday.minusDays(1), startOfToday.minusDays(1));
//
//     importAllEngineEntitiesFromScratch();
//
//     // when
...
//                   localDateTimeToString(startDate.plus((i), groupByUnitAsChrono));
...
//           .first()
//           .extracting(MapResultEntryDto::getKey)
//           .isEqualTo(localDateTimeToString(startRange));
...
//         .isGreaterThanOrEqualTo(localDateTimeToString(endTotal.minus(interval,
// ChronoUnit.MILLIS)))
//         .isLessThan(localDateTimeToString(endTotal));
//   }
//
//   protected void updateModelElementTime(
...
//         getSimpleBpmnDiagram(key), tenantId);
//   }
//
...
//   }
//
//   protected long getExecutedFlowNodeCount(
...
//
//   protected abstract void changeModelElementDate(
...
//
//   protected abstract ProcessInstanceEngineDto startAndCompleteInstanceWithDates(
...
//
//   protected abstract void startInstancesWithDayRangeForDefinition(

...
// import
// io.camunda.optimize.dto.optimize.query.report.single.configuration.custom_buckets.BucketUnit;
// import
// io.camunda.optimize.dto.optimize.query.report.single.configuration.custom_buckets.CustomBucketDto;
...
//
// public abstract class ModelElementFrequencyByModelElementDurationIT
...
//     startProcessInstanceCompleteTaskAndModifyDuration(definition.getId(),
...
//         .contains(definition.getVersionAsString());
...
//         createAndStoreDefaultReportDefinition(definition.getKey(),
...
//     final ProcessReportDataDto reportData =
//         createReport(definition.getKey(), definition.getVersionAsString());
//     final List<ProcessFilterDto<?>> filterYieldingNoResults =
...
//     startProcessInstanceCompleteTaskAndModifyDuration(definition1.getId(),
// durationInMilliseconds);
//     final ProcessDefinitionEngineDto definition2 =
//         engineIntegrationExtension.deployProcessAndGetProcessDefinition(
//             getSingleUserTaskDiagram(key2, USER_TASK_2));
//     startProcessInstanceCompleteTaskAndModifyDuration(definition2.getId(),
// durationInMilliseconds);
//
//     importAllEngineEntitiesFromScratch();
//
//     // when
//     final ProcessReportDataDto reportData =
//         createReport(definition1.getKey(), definition1.getVersionAsString());
...
//         deployAndStartMultiTenantSimpleUserTaskTaskProcess(
...
//     assertThat(resultDto.getFirstMeasureData())
//         // we expect buckets from 1000ms (finished instance) to 5000ms (running instance in
// relation
//         // to currentTime)
...
//         .contains(
//             Tuple.tuple(
//                 createDurationBucketKey((int) Duration.between(startTime,
...
//         minDurationInMillis + NUMBER_OF_DATA_POINTS_FOR_AUTOMATIC_INTERVAL_SELECTION - 1;
//     final ProcessDefinitionEngineDto definition = deploySimpleOneUserTasksDefinition();
...
//     assertThat(resultDto.getFirstMeasureData())
//         .isNotNull()
//         // if the data range fits into the default max bucket number of 80, we should see a
// bucket
//         // for each value
...
//         .contains(
//             Tuple.tuple(
//                 createDurationBucketKey(minDurationInMillis),
// getExpectedNumberOfModelElements()),
//             Tuple.tuple(
//                 createDurationBucketKey(maxDurationInMillis),
// getExpectedNumberOfModelElements()));
//   }
//
//   @Test
...
//     startProcessInstanceCompleteTaskAndModifyDuration(
//         definition.getId(), baseDuration.multipliedBy(2).toMillis());
//     startProcessInstanceCompleteTaskAndModifyDuration(
//         definition.getId(), baseDuration.multipliedBy(3).toMillis());
//     importAllEngineEntitiesFromScratch();
//
//     // when
//     final ProcessReportDataDto reportData =
...
//   }
//
//   protected String createAndStoreDefaultReportDefinition(

...
// //
// // import static
// io.camunda.optimize.dto.optimize.rest.pagination.PaginationScrollableRequestDto.QUERY_LIMIT_PARAM;
...
// // import
// io.camunda.optimize.dto.optimize.query.report.single.configuration.UserTaskDurationTime;
...
// //
// //     // when
// //     Response responsePage1 = publicApiClient.exportReport(reportId, getAccessToken(), limit,
// null);
...
// //     Response responsePage2 =
// //         publicApiClient.exportReport(reportId, getAccessToken(), null,
// data.getSearchRequestId());
// //     PaginatedDataExportDto dataPage2 = responsePage2.readEntity(PaginatedDataExportDto.class);
// //
// //     // then
// //     assertThat(data.getNumberOfRecordsInResponse()).isEqualTo(numberOfInstances);
...
// //
// //     // then
// //     assertThat(errorMessage).isEqualToIgnoringCase("Combined reports cannot be exported as
// Json");
// //   }
// //
// //   @Test
...
// //                     historicUserTaskInstanceDto.getStartTime().plus(millis,
// ChronoUnit.MILLIS));

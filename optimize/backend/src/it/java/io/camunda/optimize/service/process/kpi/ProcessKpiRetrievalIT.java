...
// import
// io.camunda.optimize.dto.optimize.query.report.single.process.filter.ExecutedFlowNodeFilterDto;
// import
...
//             createExpectedKpiResponse(reportId1, "1"), createExpectedKpiResponse(reportId2,
// "2"));
//   }
//
//   @Test
...
//             ProcessOverviewResponseDto::getProcessDefinitionKey,
//             ProcessOverviewResponseDto::getKpis)
//         .containsExactlyInAnyOrder(Tuple.tuple(PROCESS_DEFINITION_KEY,
...
//             ProcessOverviewResponseDto::getKpis)
//         .containsExactlyInAnyOrder(
//             Tuple.tuple(PROCESS_DEFINITION_KEY, List.of(createExpectedKpiResponse(reportId,
// "1"))));
//   }
//
//   @Test
...
//     // when
//     final List<ProcessOverviewResponseDto> processes =
// processOverviewClient.getProcessOverviews();
//
//     // then
//     assertThat(processes).hasSize(1);
...
//   }
//
//   private String createKpiReportWithMeasures(final String target, final ViewProperty
// viewProperty) {
...
//             .definitions(
//                 List.of(new
// ReportDataDefinitionDto(ProcessKpiRetrievalIT.PROCESS_DEFINITION_KEY)))
//             .build();
//     reportDataDto.getConfiguration().getTargetValue().setIsKpi(true);
//     reportDataDto.getConfiguration().getTargetValue().getCountProgress().setIsBelow(true);
//     reportDataDto.getConfiguration().getTargetValue().getCountProgress().setTarget(target);

...
//             .flowNodeInstances(createEventList(new String[] {GATEWAY_ACTIVITY, END_ACTIVITY,
// TASK}))
//             .build();
...
//
//     procInst.setFlowNodeInstances(createEventList(new String[] {GATEWAY_ACTIVITY,
// END_ACTIVITY}));
//     procInst.setProcessInstanceId(PROCESS_INSTANCE_ID_2);
//     databaseIntegrationTestExtension.addEntryToDatabase(
//         getProcessInstanceIndexAliasName(PROCESS_DEFINITION_KEY), PROCESS_INSTANCE_ID_2,
// procInst);
//   }
//

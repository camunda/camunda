...
public class EventBasedProcessAutogenerationCamundaSourceSingleAndMultipleStartIT
  ...
  public void createFromCamundaSource_startEndEvents_multipleStartSingleEndEvents() {
    ...
    assertNodeConnection(
        gatewayId, EXCLUSIVE_GATEWAY, idOf(expectedEndEvent), END_EVENT, generatedInstance);
    assertNodeConnection(idOf(expectedEndEvent), END_EVENT, null, null, generatedInstance);
  ...
  public void createFromCamundaSource_startEndEvents_singleStartMultipleEndEvents() {
    ...
    assertNodeConnection(
        idOf(expectedStartEvent), START_EVENT, gatewayId, EXCLUSIVE_GATEWAY, generatedInstance);
    assertNodeConnection(
        gatewayId, EXCLUSIVE_GATEWAY, idOf(expectedEndEvent1), END_EVENT, generatedInstance);
    assertNodeConnection(
        gatewayId, EXCLUSIVE_GATEWAY, idOf(expectedEndEvent2), END_EVENT, generatedInstance);

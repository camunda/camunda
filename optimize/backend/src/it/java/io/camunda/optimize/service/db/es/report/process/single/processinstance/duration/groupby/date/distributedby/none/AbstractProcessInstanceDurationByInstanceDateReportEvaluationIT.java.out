...
//       String processInstanceId, OffsetDateTime refDate, long daysToShift, Long durationInSec) {
...
//
//     engineDatabaseExtension.changeProcessInstanceStartDate(
//         processInstance1.getId(), now.minusSeconds(1));
...
//         engineIntegrationExtension.startProcessInstance(instance.getDefinitionId());
...
//     engineDatabaseExtension.changeProcessInstanceStartDate(
//         completedProcessInstance2.getId(), now.minusDays(1));
...
//     assertThat(resultMap.get(0).getValue())
//         .isEqualTo(calculateExpectedValueGivenDurationsDefaultAggr(1000.));
//   }
//
//   @Test

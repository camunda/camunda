...
// package
// io.camunda.optimize.service.db.es.report.process.single.usertask.frequency.groupby.usertask.distributedby.process;
//
// import static io.camunda.optimize.dto.optimize.ReportConstants.ALL_VERSIONS;
// import static
// io.camunda.optimize.service.util.ProcessReportDataType.USER_TASK_FREQ_GROUP_BY_USER_TASK_BY_PROCESS;
...
//                     USER_TASK_1, new MapResultEntryDto(processIdentifier, 1.0,
// processDisplayName)),
//                 createHyperMapResult(
//                     USER_TASK_2,

...
//             .buildGetDefinitionByTypeAndKeyRequest(DefinitionType.PROCESS.getId(),
// "doesntMatter")
//             .execute();
//
//     assertThat(response).isNotNull();
...
//
//     final DefinitionOptimizeResponseDto expectedDefinition =
//         createDefinitionAndAddToDatabase(definitionType, "key", "1", TENANT_2.getId(), "the
// name");
//
//     // when
//     final DefinitionResponseDto definition =
...
//         .isNotEmpty()
//         .extracting("id")
//         .containsExactly(SIMPLE_TENANT_NOT_DEFINED_DTO.getId(), TENANT_1.getId(),
// TENANT_2.getId());
//   }
//
//   @ParameterizedTest
...
//         createDefinitionAndAddToDatabase(PROCESS, "process3", "1", null, "a process
// Definition3");
//     final DefinitionOptimizeResponseDto decisionDefinition1 =
//         createDefinitionAndAddToDatabase(DECISION, "decision1", "1", null, "Decision
// Definition1");
//     final DefinitionOptimizeResponseDto decisionDefinition2 =
//         createDefinitionAndAddToDatabase(DECISION, "decision2", "1", null, "decision
// Definition2");
...
//                 Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
//                 DEFAULT_ENGINE_ALIAS),
//             // then we expect the decision definition #1 as the `1` name suffix is smaller than
// the
//             // `2` and first letter
//             // case is ignored
//             new DefinitionResponseDto(
...
//         createDefinitionAndAddToDatabase(definitionType, "definition1", "2", null, "updated
// name");
...
//                 decisionDefinition1_1.getName(),
//                 DefinitionType.DECISION,
//                 // for shared definition expected order is not defined first, then all tenants by
// id
...
//     createDefinitionAndAddToDatabase(DECISION, decisionKey1, "2", TENANT_1.getId(),
// decisionName1);
//     createDefinitionAndAddToDatabase(DECISION, decisionKey1, "2", TENANT_2.getId(),
// decisionName1);
//     // create tenant3 definition first, to ensure creation order does not affect result
...
//     createDefinitionAndAddToDatabase(DECISION, decisionKey2, "1", TENANT_3.getId(),
// decisionName2);
//     createDefinitionAndAddToDatabase(DECISION, decisionKey2, "1", TENANT_2.getId(),
// decisionName2);
...
//     // another definition with same key but different tenant to ensure this causes no duplicate
// key
//     // entries
...
//         createDefinitionAndAddToDatabase(definitionType, "deletedKey", "1", null, "deleted",
// true);
...
//     // and only the key with the instance imported with the importEnabled configuration is
// available
//     // when requesting
...
//     // given
//     final String definitionKey = "key";
//     final List<String> descendingVersions = Arrays.asList("200", "30", "21", "20", "19", "3",
// "2");
...
//
//     // then the available tenants for the latest version as well as the other version are
// returned
...
//     databaseIntegrationTestExtension.addEntryToDatabase(TENANT_INDEX_NAME, tenant.getId(),
// tenant);
//   }
//

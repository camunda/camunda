...
import io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardDoubleVariableFilterDataDto;
import io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardIdentityFilterDataDto;
import io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardIntegerVariableFilterDataDto;
import io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardLongVariableFilterDataDto;
import io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardShortVariableFilterDataDto;
  ...
  protected static Stream<List<DashboardFilterDto<?>>> validFilterCombinations() {
    return Stream.of(
        ...
        Arrays.asList(
            ...
            createDashboardVariableFilter(
                VariableType.STRING, "stringVar", IN, Arrays.asList("StringA", "StringB"), false),
            createDashboardVariableFilter(
                VariableType.STRING,
                "stringVar",
                CONTAINS,
    ...
    return Stream.of(
        ...
        Arrays.asList(
            ...
            createDashboardCandidateGroupFilter(
                Collections.emptyList(), MembershipFilterOperator.NOT_IN, true)),
        Arrays.asList(
            new DashboardInstanceStartDateFilterDto(), new DashboardInstanceStartDateFilterDto()),
        Arrays.asList(

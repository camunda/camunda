...
// import
// io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardDoubleVariableFilterDataDto;
// import
// io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardIdentityFilterDataDto;
// import
// io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardIntegerVariableFilterDataDto;
// import
// io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardLongVariableFilterDataDto;
// import
// io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardShortVariableFilterDataDto;
// import io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardStateFilterDataDto;
// import
// io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardStringVariableFilterDataDto;
// import
// io.camunda.optimize.dto.optimize.query.dashboard.filter.data.DashboardVariableFilterDataDto;
...
// import
// io.camunda.optimize.dto.optimize.query.report.single.filter.data.variable.data.DashboardVariableFilterSubDataDto;
// import
...
//
// public abstract class AbstractDashboardRestServiceIT extends AbstractPlatformIT {
//
...
//         Collections.singletonList(createDashboardVariableFilter(VariableType.BOOLEAN,
// "boolVar")),
...
//                 VariableType.LONG, "longVar", IN, Arrays.asList("1", "2"), false),
//             createDashboardVariableFilter(
//                 VariableType.DOUBLE, "doubleVar", IN, Arrays.asList("1", "2"), true)),
//         Arrays.asList(
//             createDashboardAssigneeFilter(
//                 Collections.emptyList(), MembershipFilterOperator.IN, false),
//             createDashboardCandidateGroupFilter(
//                 Collections.emptyList(), MembershipFilterOperator.NOT_IN, true)),
//         Arrays.asList(
//             createDashboardAssigneeFilter(
//                 Arrays.asList("Rose", "Martha"), MembershipFilterOperator.IN, false),
//             createDashboardAssigneeFilter(
//                 Arrays.asList("Donna", "Clara"), MembershipFilterOperator.NOT_IN, true)),
//         Arrays.asList(
//             createDashboardCandidateGroupFilter(
//                 Arrays.asList("Cybermen", "Daleks"), MembershipFilterOperator.IN, true),
//             createDashboardCandidateGroupFilter(
//                 Arrays.asList("Ood", "Judoon"), MembershipFilterOperator.NOT_IN, false)),
//         Arrays.asList(
//             createDashboardAssigneeFilter(
//                 Arrays.asList("Rose", "Martha"), MembershipFilterOperator.IN, true),
//             createDashboardCandidateGroupFilter(
//                 Arrays.asList("Ood", "Judoon"), MembershipFilterOperator.NOT_IN, true)),
//         Arrays.asList(
...
//                 VariableType.LONG, "longVar", IN, Arrays.asList("1", "2"), false),
//             createDashboardVariableFilter(
//                 VariableType.DOUBLE, "doubleVar", IN, Arrays.asList("1.0", "2.0"), false),
//             createDashboardVariableFilter(
//                 VariableType.STRING, "stringVar", IN, Arrays.asList("StringA", "StringB"),
// false),
//             createDashboardVariableFilter(
//                 VariableType.STRING,
//                 "stringVar",
...
//                 Arrays.asList("Rose", "Martha"), MembershipFilterOperator.IN, false),
//             createDashboardCandidateGroupFilter(
//                 Arrays.asList("Cybermen", "Daleks"), MembershipFilterOperator.IN, false),
//             createDashboardStartDateFilterWithDefaultValues(null),
//             createDashboardEndDateFilterWithDefaultValues(null),
//             createDashboardStateFilterWithDefaultValues(null)),
//         Arrays.asList(
...
//                 VariableType.LONG, "longVar", IN, Arrays.asList("1", "2"), true),
//             createDashboardVariableFilter(
//                 VariableType.DOUBLE, "doubleVar", IN, Arrays.asList("1.0", "2.0"), true),
//             createDashboardVariableFilter(
//                 VariableType.STRING, "stringVar", IN, Arrays.asList("StringA", "StringB"), true),
//             createDashboardVariableFilter(
//                 VariableType.STRING,
//                 "stringVar",
//                 CONTAINS,
...
//                     new RelativeDateFilterStartDto(2L, DateUnit.MINUTES))),
...
//             createDashboardStateFilterWithDefaultValues(
//                 Collections.singletonList("canceledInstancesOnly")),
...
//             createDashboardEndDateFilterWithDefaultValues(
//                 new RelativeDateFilterDataDto(
//                     new RelativeDateFilterStartDto(1L, DateUnit.MINUTES)))),
//         Collections.singletonList(
//             createDashboardEndDateFilterWithDefaultValues(
//                 new RollingDateFilterDataDto(new RollingDateFilterStartDto(2L,
// DateUnit.YEARS)))),
//         Collections.singletonList(
//             createDashboardStartDateFilterWithDefaultValues(
//                 new RelativeDateFilterDataDto(
//                     new RelativeDateFilterStartDto(3L, DateUnit.SECONDS)))),
//         Collections.singletonList(
//             createDashboardStartDateFilterWithDefaultValues(
//                 new RollingDateFilterDataDto(new RollingDateFilterStartDto(4L,
// DateUnit.DAYS)))));
//   }
//
...
//                 Collections.emptyList(), MembershipFilterOperator.IN, false),
//             createDashboardAssigneeFilter(
//                 Collections.emptyList(), MembershipFilterOperator.IN, true)),
//         Arrays.asList(
//             createDashboardCandidateGroupFilter(
//                 Collections.emptyList(), MembershipFilterOperator.NOT_IN, false),
//             createDashboardCandidateGroupFilter(
//                 Collections.emptyList(), MembershipFilterOperator.NOT_IN, true)),
//         Arrays.asList(
//             new DashboardInstanceStartDateFilterDto(), new
// DashboardInstanceStartDateFilterDto()),
//         Arrays.asList(
//             new DashboardInstanceEndDateFilterDto(), new DashboardInstanceEndDateFilterDto()),
//         Arrays.asList(new DashboardStateFilterDto(), new DashboardStateFilterDto()),
//         Collections.singletonList(
//             createDashboardVariableFilter(
//                 VariableType.DATE,
//                 "dateVar",
//                 IN,
//                 Collections.singletonList(OffsetDateTime.now().toString()),
//                 false)),
//         Collections.singletonList(
//             createDashboardVariableFilter(
//                 VariableType.DATE,
...
//         Collections.singletonList(
//             createDashboardVariableFilter(VariableType.LONG, "longVar", null)),
//         Collections.singletonList(
//             createDashboardVariableFilter(VariableType.DOUBLE, "doubleVar", null)),
//         Collections.singletonList(
//             createDashboardVariableFilter(VariableType.STRING, "stringVar", null)));
//   }
//
...
//         Bpmn.createExecutableProcess("someProcess").startEvent().endEvent().done();
...
//   }
//
//   protected static DashboardFilterDto<?> createDashboardVariableFilter(
...
//   }
//
//   private static DashboardFilterDto<?> createDashboardVariableFilter(
//       final VariableType type, final String variableName) {
//     return createDashboardVariableFilter(type, variableName, null);
//   }
//
//   private static DashboardFilterDto<?> createDashboardVariableFilter(
...
//   }
//
//   private static DashboardFilterDto<?> createDashboardDateVariableFilterWithDefaultValues(
//       final DateFilterDataDto<?> defaultValues) {
//     DashboardVariableFilterDto filterDto =
//         (DashboardVariableFilterDto)
//             createDashboardVariableFilter(VariableType.DATE, "dateVar", null);
...
//     DashboardVariableFilterDto filterDto =
//         (DashboardVariableFilterDto)
//             createDashboardVariableFilter(VariableType.BOOLEAN, "boolVar", null);
//     ((DashboardBooleanVariableFilterDataDto) filterDto.getData())
//         .setDefaultValues(Collections.singletonList(true));
//     return filterDto;
//   }
//
...
//                 false);
//     ((DashboardStringVariableFilterDataDto) filterDto.getData())
//         .setDefaultValues(Collections.singletonList("aStringValue"));
//     return filterDto;
//   }
//
...
//         (DashboardVariableFilterDto)
//             createDashboardVariableFilter(
//                 VariableType.INTEGER, "integerVar", NOT_IN, List.of("7", "8"), false);
//     ((DashboardIntegerVariableFilterDataDto) filterDto.getData())
//         .setDefaultValues(Collections.singletonList("8"));
//     return filterDto;
//   }
//
...
//         (DashboardVariableFilterDto)
//             createDashboardVariableFilter(
//                 VariableType.SHORT, "shortVar", IN, List.of("1", "2"), false);
//     ((DashboardShortVariableFilterDataDto) filterDto.getData())
//         .setDefaultValues(Collections.singletonList("1"));
//     return filterDto;
//   }
//
...
//         (DashboardVariableFilterDto)
//             createDashboardVariableFilter(
//                 VariableType.LONG, "longVar", IN, List.of("3", "4"), false);
//     ((DashboardLongVariableFilterDataDto) filterDto.getData())
//         .setDefaultValues(Collections.singletonList("4"));
//     return filterDto;
//   }
//
...
//         (DashboardVariableFilterDto)
//             createDashboardVariableFilter(
//                 VariableType.DOUBLE, "doubleVar", NOT_IN, List.of("5.0", "6.0"), false);
//     ((DashboardDoubleVariableFilterDataDto) filterDto.getData())
//         .setDefaultValues(Collections.singletonList("5.0"));
//     return filterDto;
//   }
//
...
//   }
//
//   private static DashboardFilterDto<?> createDashboardEndDateFilterWithDefaultValues(
//       final DateFilterDataDto<?> defaultValues) {
...
//   }
//
//   private static DashboardFilterDto<?> createDashboardStateFilterWithDefaultValues(
...
//   }
//
//   private static DashboardFilterDto<?> createDashboardAssigneeFilter(
...
//     assigneeFilter.setData(
//         new DashboardIdentityFilterDataDto(
//             filterOperator, assigneeNames, allowCustomValues, defaultValues));
//     return assigneeFilter;
//   }
//
//   private static DashboardFilterDto<?> createDashboardCandidateGroupFilter(
//       final List<String> candidateGroupNames,
//       final MembershipFilterOperator filterOperator,
//       final boolean allowCustomValues) {
//     return createDashboardCandidateGroupFilter(
//         candidateGroupNames, filterOperator, allowCustomValues, null);
//   }
//
//   private static DashboardFilterDto<?> createDashboardCandidateGroupFilter(
//       final List<String> candidateGroupNames,
...
//       final boolean allowCustomValues,
//       final List<String> defaultValues) {
//     final DashboardCandidateGroupFilterDto candidateGroupFilter =
//         new DashboardCandidateGroupFilterDto();
//     candidateGroupFilter.setData(
//         new DashboardIdentityFilterDataDto(
//             filterOperator, candidateGroupNames, allowCustomValues, defaultValues));

...
//
// import static
// io.camunda.optimize.service.util.configuration.WebhookConfiguration.Placeholder.ALERT_CURRENT_VALUE;
// import static
// io.camunda.optimize.service.util.configuration.WebhookConfiguration.Placeholder.ALERT_MESSAGE;
// import static
// io.camunda.optimize.service.util.configuration.WebhookConfiguration.Placeholder.ALERT_NAME;
// import static
// io.camunda.optimize.test.optimize.UiConfigurationClient.TEST_CUSTOM_CONTENT_TYPE_WEBHOOK_NAME;
// import static
// io.camunda.optimize.test.optimize.UiConfigurationClient.TEST_INVALID_PORT_WEBHOOK_NAME;
...
// import static
// io.camunda.optimize.test.optimize.UiConfigurationClient.TEST_WEBHOOK_WITH_PROXY_NAME;
...
//             collectionId, processInstance.getProcessDefinitionKey(),
...
//     embeddedOptimizeExtension
//         .getConfigurationService()
//         .setNotificationEmailPort(9999); // set to incorrect port so that email notifications
// fail
//
//     String alertId = setupWebhookAlert(TEST_WEBHOOK_NAME);
//
...
//     return createPayloadJson(simpleAlert, alertType, currentValue, expectedLink,
// expectedMessage);
//   }
//
//   private String createActiveAlertExpectedWebhookPayloadWithAllPlaceholders(
...
//         + " test alert\\nReport name: something\\nStatus: Given threshold [1s 500ms] was
// exceeded. Current"
...
// something\\nStatus: Given "
//         + "threshold [1s 500ms] is not exceeded anymore. Current value: 1s 500ms. Please check
// your"

...
// package
// io.camunda.optimize.service.db.es.report.process.single.flownode.frequency.groupby.variable.distributedby.flownode;
//
...
//         reportClient.evaluateHyperMapReport(reportData).getResult();
//
//     // then the result includes only the flownodes of the latest version with instance counts
// from
//     // all versions
//     // @formatter:off
//     HyperMapAsserter.asserter()

...
// //             .mappings(
// //                 ImmutableMap.of(
// //                     THIRD_TASK_ID, createEventMappingDto(null,
// nextMappedEventWithNullProperties)))
// //             .eventSources(createEventSourcesWithAllExternalEventsOnly())
// //             .build();
// //
// //     // when
...
// Response.Status.OK.getStatusCode());
// //
// //     // then only the event in sequence before closest neighbour is suggested, non-suggestions
// use
// //     // default ordering
// //     assertThat(eventCountDtos)
// //         .containsExactly(
...
// //             .xml(simpleDiagramXml)
// //             .mappings(
// //                 ImmutableMap.of(FIRST_TASK_ID, createEventMappingDto(previousMappedEvent,
// null)))
// //             .eventSources(createEventSourcesWithAllExternalEventsOnly())
// //             .build();
...
// Response.Status.OK.getStatusCode());
// //
// //     // then no suggestions are returned, result is using default group case-insensitive
// ordering
// //     assertThat(eventCountDtos)
// //         .containsExactly(
// //             createNullGroupCountDto(false),
...
// //       final EventCountSorter eventCountSorter,
// //       final EventCountRequestDto eventCountSuggestionsRequestDto) {
// //     return createPostEventCountsRequest(eventCountSorter, null,
// eventCountSuggestionsRequestDto);
// //   }
// //

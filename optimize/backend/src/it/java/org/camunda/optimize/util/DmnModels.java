...
public class DmnModels {
  ...
  public static DmnModelInstance createDefaultDmnModelNoInputAndOutputLabels(final String key) {
    return DmnModelGenerator.create()
        ...
        .addOutput(
            null, OUTPUT_CLASSIFICATION_ID, OUTPUT_VARIABLE_CLASSIFICATION, DecisionTypeRef.STRING)
  ...
  public static DmnModelInstance createInputEqualsOutput() {
    return DmnModelGenerator.create()
        ...
        .addInput(
            "Integer Input", INTEGER_INPUT_ID, INPUT_VARIABLE_INTEGER_INPUT, DecisionTypeRef.STRING)
        .addOutput(
            "String Output",
            STRING_OUTPUT_ID,

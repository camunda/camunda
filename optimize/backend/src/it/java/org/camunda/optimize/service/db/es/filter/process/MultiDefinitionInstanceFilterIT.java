  ...
  public void multipleDefinitionSpecificFiltersOnlyApplyToInstanceDataOfDefinitionSetInAppliedTo() {
    ...
    reportData.setFilter(
        ProcessFilterBuilder.filter()
            ...
            .add()
            // completedProcessInstanceDefinition1 has the variable with excluded value, thus should
            // not be returned
            .variable()
            .name(VAR_NAME)
            .type(STRING)
    ...
    assertThat(rawDataReportResultDto.getData())
        ...
        .containsExactlyInAnyOrder(
            runningProcessInstanceDefinition1.getId(), completedProcessInstanceDefinition2.getId());
  }

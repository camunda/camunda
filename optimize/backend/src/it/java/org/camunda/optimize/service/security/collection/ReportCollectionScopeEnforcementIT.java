...
public class ReportCollectionScopeEnforcementIT extends AbstractPlatformIT {
  ...
  public void enforceScope_oneTenantInScope(
    ...
    final String reportId =
        functionToEnforceScopeFor.apply(new ScopeScenario(collectionId, DEFINITION_KEY_1, tenants));
  ...
  private Stream<Arguments> scopeEnforcedForEndpointAndType() {
    return Stream.of(
        ...
        Arguments.of(
            copyAndMoveCombinedReportScenario(), PROCESS, "copy and move combined process report"),
  ...
  private Stream<Arguments> scopeEnforcedForEndpointAndTypeRequest() {
    return Stream.of(
        ...
        Arguments.of(
            copyAndMoveDecisionReportScenarioRequest(), DECISION, "copy and move decision report"));
  }

...
public class FlowNodeDurationFilterIT extends AbstractDurationFilterIT {
  ...
  public void testSingleCompletedViewLevelFlowNodeDurationFilter() {
    ...
    assertThat(MapResultUtil.getEntryForKey(greaterThanFilter.getFirstMeasureData(), USER_TASK_1))
        .isPresent()
        .get()
            ...
            .evaluateMapReport(
                createUserTaskReportWithFilters(
                    ...
                    ProcessFilterBuilder.filter()
                        .flowNodeDuration()
                        .flowNode(
                            USER_TASK_1, filterData(unit, (long) actualUserTaskDuration, LESS_THAN))
                        .filterLevel(FilterApplicationLevel.INSTANCE)
                        .add()
                        .buildList()))
            .getResult();

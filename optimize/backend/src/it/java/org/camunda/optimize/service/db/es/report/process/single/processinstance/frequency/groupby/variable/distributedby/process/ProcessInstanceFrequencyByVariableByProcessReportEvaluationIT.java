 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.processinstance.frequency.groupby.variable.distributedby.process;
...
public class ProcessInstanceFrequencyByVariableByProcessReportEvaluationIT
  ...
  private ProcessReportDataDto createReport(
    ...
    final ProcessReportDataDto report =
        TemplatedProcessReportDataBuilder.createReportData()
            ...
            .setReportDataType(ProcessReportDataType.PROC_INST_FREQ_GROUP_BY_VARIABLE_BY_PROCESS)
            .build();

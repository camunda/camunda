 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.flownode.duration.groupby.variable.distributedby.flownode;
...
public class FlowNodeDurationByVariableByFlowNodeReportEvaluationIT
  ...
  public void simpleReportEvaluation_dateVariable_automaticUnit() {
    ...
    assertThat(
        ...
        .isEqualTo(
            10.0
                * 4
                * numberOfInstances); // each instance went through 4 flownodes which each took 10.0
  }
  ...
  public void allVersions_resultIncludesLatestNodesOnly_latestHasMoreNodes() {
    ...
    // then the result includes all flownodes of the latest version with instance durations from all
    // versions
    // @formatter:off
    HyperMapAsserter.asserter()

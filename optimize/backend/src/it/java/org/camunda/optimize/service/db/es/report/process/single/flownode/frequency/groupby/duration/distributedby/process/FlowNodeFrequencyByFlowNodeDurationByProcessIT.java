 ...
 */
package org.camunda.optimize.service.db.es.report.process.single.flownode.frequency.groupby.duration.distributedby.process;

import static org.assertj.core.api.Assertions.assertThat;
import static org.camunda.optimize.dto.optimize.ReportConstants.ALL_VERSIONS;
import static org.camunda.optimize.service.util.ProcessReportDataType.FLOW_NODE_FREQ_GROUP_BY_FLOW_NODE_DURATION_BY_PROCESS;
...
public class FlowNodeFrequencyByFlowNodeDurationByProcessIT extends AbstractPlatformIT {
        ...
        .containsExactly(
            Collections.singletonList(
                createHyperMapResult(
                    1000.0, new MapResultEntryDto(processIdentifier, 3.0, processDisplayName))));
  }
  ...
  private HyperMapResultEntryDto createHyperMapResult(
      final Double durationKey, final MapResultEntryDto... results) {
    return new HyperMapResultEntryDto(
        String.valueOf(durationKey), Arrays.asList(results), String.valueOf(durationKey));
  }

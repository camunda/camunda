...
public class ExternalEventTraceStateImportIT extends AbstractEventTraceStateImportIT {
  ...
  public void processSingleBatchOfEventsNewUniqueTraceIds() throws IOException {
    // given
    CloudEventRequestDto eventDtoTraceOne =
        createCloudEventDtoWithProperties(
            "traceOne", "eventIdOne", "backend", "ketchup", "signup-event", 100L);
    CloudEventRequestDto eventDtoTraceTwo =
        createCloudEventDtoWithProperties(
            "traceTwo", "eventIdTwo", "backend", "mayonnaise", "register-event", 200L);
    CloudEventRequestDto eventDtoTraceThree =
        createCloudEventDtoWithProperties(
            "traceThree", "eventIdThree", null, "mayonnaise", "onboard-event", 300L);
    ingestionClient.ingestEventBatch(
        Arrays.asList(eventDtoTraceOne, eventDtoTraceTwo, eventDtoTraceThree));
    ...
    assertThat(getAllStoredExternalEventSequenceCounts())
        .containsExactlyInAnyOrder(
    ...
    assertThat(getLastProcessedEntityTimestampFromElasticsearch())
        .isEqualTo(findMostRecentEventTimestamp());
  }
  ...
  public void processSingleBatchOfEventsWithRepeatedSequencesAcrossTraces() throws IOException {
    ...
    assertThat(getAllStoredExternalEventSequenceCounts())
        .containsExactlyInAnyOrder(
            createSequenceFromSourceAndTargetEvents(
                eventDtoTraceOneEventOne, eventDtoTraceOneEventTwo, 2),
            createSequenceFromSourceAndTargetEvents(eventDtoTraceOneEventTwo, null, 2),
            createSequenceFromSourceAndTargetEvents(
                eventDtoTraceThreeEventOne, eventDtoTraceThreeEventTwo, 1),
  ...
  public void processMultipleBatchesOfEventsWithMultipleTracesNoTimestampModifications()
    ...
    String traceIdTwo = "traceIdTwo";
    String traceIdThree = "traceIdThree";
    CloudEventRequestDto eventOneTraceOne =
        createCloudEventDtoWithProperties(
            traceIdOne, "eventIdOne", null, "ketchup", "signup-event", 100L);
    CloudEventRequestDto eventOneTraceTwo =
        createCloudEventDtoWithProperties(
            traceIdTwo, "eventIdTwo", null, "ketchup", "signup-event", 200L);
    CloudEventRequestDto eventOneTraceThree =
        createCloudEventDtoWithProperties(
            traceIdThree, "eventIdThree", null, "ketchup", "signup-event", 300L);
    ingestionClient.ingestEventBatch(
        Arrays.asList(eventOneTraceOne, eventOneTraceTwo, eventOneTraceThree));
    ...
    assertThat(getAllStoredExternalEventTraceStates())
        .containsExactlyInAnyOrder(
            new EventTraceStateDto(
                traceIdOne, Collections.singletonList(mapToTracedEventDto(eventOneTraceOne))),
            new EventTraceStateDto(
                traceIdTwo, Collections.singletonList(mapToTracedEventDto(eventOneTraceTwo))),
            new EventTraceStateDto(
                traceIdThree, Collections.singletonList(mapToTracedEventDto(eventOneTraceThree))));
    assertThat(getAllStoredExternalEventSequenceCounts())
        .containsExactlyInAnyOrder(
    ...
    CloudEventRequestDto eventTwoTraceOne =
        createCloudEventDtoWithProperties(
            traceIdOne, "eventIdFour", "backend", "ketchup", "register-event", 400L);
    CloudEventRequestDto eventTwoTraceTwo =
        createCloudEventDtoWithProperties(
            traceIdTwo, "eventIdFive", "backend", "ketchup", "register-event", 500L);
    CloudEventRequestDto eventThreeTraceOne =
        createCloudEventDtoWithProperties(
            traceIdOne, "eventIdSix", "backend", "ketchup", "onboard-event", 600L);
    ingestionClient.ingestEventBatch(
        Arrays.asList(eventTwoTraceOne, eventTwoTraceTwo, eventThreeTraceOne));
    processEventCountAndTraces();
    ...
    assertThat(getAllStoredExternalEventTraceStates())
        .containsExactlyInAnyOrder(
            ...
            new EventTraceStateDto(
                traceIdTwo,
                Arrays.asList(
                    mapToTracedEventDto(eventOneTraceTwo), mapToTracedEventDto(eventTwoTraceTwo))),
            new EventTraceStateDto(
                traceIdThree, Collections.singletonList(mapToTracedEventDto(eventOneTraceThree))));
    assertThat(getAllStoredExternalEventSequenceCounts())
        .containsExactlyInAnyOrder(
  ...
  @Test
  public void
      processMultipleBatchesOfEventsWithEventTimestampModificationRequiringAdjustmentsForTraceEvent()
          throws IOException {
    // given
    ...
    CloudEventRequestDto eventDtoThreeModified =
        createCloudEventDtoWithProperties(
            traceId,
            eventDtoThree.getId(),
  ...
  public void processMultipleBatchesOfEventsWithSingleTraceDuplicateEventsAcrossBatches()
    ...
    CloudEventRequestDto eventOne =
        createCloudEventDtoWithProperties(
            traceId, "eventIdOne", null, "ketchup", "signup-event", 100L);
    CloudEventRequestDto eventTwo =
        createCloudEventDtoWithProperties(
            traceId, "eventIdTwo", "backend", "ketchup", "register-event", 200L);
    CloudEventRequestDto eventThree =
        createCloudEventDtoWithProperties(
            traceId, "eventIdThree", "backend", "ketchup", "onboarded-event", 300L);
    ...
    CloudEventRequestDto eventTwoRepeated =
        createCloudEventDtoWithProperties(
            traceId,
            eventTwo.getId(),
            eventTwo.getGroup().orElse(null),
            eventTwo.getSource(),
            eventTwo.getType(),
            200L);
  ...
  @Test
  public void
      processMultipleBatchesOfEventsWithSingleTraceAndMultipleOccurringEventsWithDifferentIds()
          throws IOException {
    // given
    String traceId = "traceIdOne";
    CloudEventRequestDto eventTaskA =
        createCloudEventDtoWithProperties(
            traceId, "eventIdOne", null, "ketchup", "signup-event", 100L);
    CloudEventRequestDto eventTaskB =
        createCloudEventDtoWithProperties(
            traceId, "eventIdTwo", "backend", "ketchup", "register-event", 200L);
    CloudEventRequestDto eventTaskC =
        createCloudEventDtoWithProperties(
            traceId, "eventIdThree", "backend", "ketchup", "onboarded-event", 300L);
    ...
    // when second batch adds the second occurrence of an event with a new event ID, reflecting a
    // loop in the
    // BPMN model
    CloudEventRequestDto eventTaskD =
        createCloudEventDtoWithProperties(
            traceId, "eventIdFour", "backend", "ketchup", "complained-event", 400L);
    CloudEventRequestDto eventTaskBSecondOccurrence =
        createCloudEventDtoWithProperties(
            traceId,
            "eventIdFive",
            eventTaskB.getGroup().orElse(null),
            eventTaskB.getSource(),
            eventTaskB.getType(),
            500L);
    ...
    // then trace state and sequence counts remain correct after processing and loop is correctly
    // traced
    assertThat(getAllStoredExternalEventTraceStates())
        .containsExactlyInAnyOrder(
            new EventTraceStateDto(
    ...
    // when third batch adds further occurrences of events with new IDs, reflecting further loops
    // and events beyond
    // the loop in the BPMN model
    CloudEventRequestDto eventTaskCSecondOccurrence =
        createCloudEventDtoWithProperties(
            traceId,
            "eventIdSix",
            eventTaskC.getGroup().orElse(null),
            eventTaskC.getSource(),
            eventTaskC.getType(),
            600L);
    CloudEventRequestDto eventTaskDSecondOccurrence =
        createCloudEventDtoWithProperties(
            traceId,
            "eventIdSeven",
            eventTaskD.getGroup().orElse(null),
            eventTaskD.getSource(),
            eventTaskD.getType(),
            700L);
    CloudEventRequestDto eventTaskBThirdOccurrence =
        createCloudEventDtoWithProperties(
            traceId,
            "eventIdEight",
            eventTaskB.getGroup().orElse(null),
            ...
            eventTaskB.getType(),
            800L);
    CloudEventRequestDto eventTaskE =
        createCloudEventDtoWithProperties(
    ...
    // then trace state and sequence counts remain correct after processing and loop is correct
    // traced
    assertThat(getAllStoredExternalEventTraceStates())
        .containsExactlyInAnyOrder(
            new EventTraceStateDto(
  ...
  @Test
  public void
      processMultipleBatchOfEventsAcrossMultipleTraces_sameTimestampEventsGetOrderedCorrectly()
          throws IOException {
    // given
    String traceIdOne = "traceIdOne";
    String traceIdTwo = "traceIdTwo";
    ...
    CloudEventRequestDto eventDtoTraceOneEventThree =
        createCloudEventDtoWithProperties(
            traceIdOne, "eventIdThree", "backend", "ketchup", "third-event", 300L);
    ingestionClient.ingestEventBatch(
        Arrays.asList(
            eventDtoTraceOneEventOne, eventDtoTraceOneEventTwo, eventDtoTraceOneEventThree));
    ...
    CloudEventRequestDto eventDtoTraceTwoEventThree =
        createCloudEventDtoWithProperties(
            traceIdTwo, "eventIdSix", "backend", "ketchup", "third-event", 200L);
    ingestionClient.ingestEventBatch(
        Arrays.asList(
            eventDtoTraceTwoEventThree, eventDtoTraceTwoEventOne, eventDtoTraceTwoEventTwo));
    processEventCountAndTraces();

    // then trace state and sequence counts are correct and identical timestamp order is resolved
    // correctly
    assertThat(getAllStoredExternalEventTraceStates())
        .containsExactlyInAnyOrder(
            new EventTraceStateDto(
  ...
  private CloudEventRequestDto createCloudEventDtoWithProperties(
      String traceId,
      String eventId,
      String group,
      String source,
  ...
  private EventDto mapToEventDto(final CloudEventRequestDto cloudEventDto) {
    return EventDto.builder()
        ...
        .timestamp(
            cloudEventDto.getTime().map(Instant::toEpochMilli).orElse(Instant.now().toEpochMilli()))
  ...
  private EventSequenceCountDto createSequenceFromSourceAndTargetEvents(
      CloudEventRequestDto sourceEventDto, CloudEventRequestDto targetEventDto, long count) {
    EventTypeDto sourceEvent =
        Optional.ofNullable(sourceEventDto)
            .map(
                source ->
    ...
    EventTypeDto targetEvent =
        Optional.ofNullable(targetEventDto)
            .map(
                target ->
                    EventTypeDto.builder()

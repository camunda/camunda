...
public abstract class ModelElementDurationByModelElementDateByModelElementReportEvaluationIT
  ...
  protected abstract ProcessReportDataDto createReportData(
      final String processDefinitionKey,
      final List<String> versions,
      final AggregateByDateUnit groupByDateUnit);

  protected void assertLastValueEquals(
  ...
  protected void assertFirstValueEquals(
      final List<HyperMapResultEntryDto> resultData, final Double expected) {
    assertThat(resultData)
        .first()
        .extracting(HyperMapResultEntryDto::getValue)
  ...
  protected void updateModelElementTimes(

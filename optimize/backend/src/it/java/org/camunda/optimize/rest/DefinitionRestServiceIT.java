...
public class DefinitionRestServiceIT extends AbstractPlatformIT {
  ...
  private static final TenantDto SIMPLE_TENANT_NOT_DEFINED_DTO =
      TenantDto.builder().id(TENANT_NOT_DEFINED.getId()).name(TENANT_NOT_DEFINED.getName()).build();
  private static final String VERSION_TAG = "aVersionTag";
  private static final TenantResponseDto TENANT_NOT_DEFINED_RESPONSE_DTO =
      new TenantResponseDto(TENANT_NOT_DEFINED.getId(), TENANT_NOT_DEFINED.getName());
  private static final TenantDto TENANT_1 =
      TenantDto.builder().id("tenant1").name("Tenant 1").engine(DEFAULT_ENGINE_ALIAS).build();
  private static final TenantResponseDto TENANT_1_RESPONSE_DTO =
      new TenantResponseDto(TENANT_1.getId(), TENANT_1.getName());
  private static final TenantDto TENANT_2 =
      TenantDto.builder().id("tenant2").name("Tenant 2").engine(DEFAULT_ENGINE_ALIAS).build();
  private static final TenantResponseDto TENANT_2_RESPONSE_DTO =
      new TenantResponseDto(TENANT_2.getId(), TENANT_2.getName());
  private static final TenantDto TENANT_3 =
      TenantDto.builder().id("tenant3").name("Tenant 3").engine(DEFAULT_ENGINE_ALIAS).build();
  private static final TenantResponseDto TENANT_3_RESPONSE_DTO =
  ...
  public void getDefinitionByTypeAndKey(final DefinitionType definitionType) {
    ...
    final DefinitionOptimizeResponseDto expectedDefinition =
        createDefinitionAndAddToDatabase(definitionType, "key", "1", null, "the name");

    // when
    final DefinitionResponseDto definition =
        definitionClient.getDefinitionByTypeAndKey(definitionType, expectedDefinition);
  ...
  public void getDefinitionByTypeAndKeyGetsLatestName(final DefinitionType definitionType) {
    // given
    final DefinitionOptimizeResponseDto definitionV1 =
        createDefinitionAndAddToDatabase(definitionType, "key", "1", null, "the name");
    final DefinitionOptimizeResponseDto definitionV2 =
        createDefinitionAndAddToDatabase(definitionType, "key", "2", null, "new name");

    // when
    final DefinitionResponseDto definition =
        definitionClient.getDefinitionByTypeAndKey(definitionType, definitionV1);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionByTypeAndKeyReturnsNonDeletedDefinition(
      final DefinitionType definitionType) {
    // given
    final DefinitionOptimizeResponseDto nonDeletedDefinition =
        createDefinitionAndAddToDatabase(definitionType, "key", "1", null, "not deleted", false);
    createDefinitionAndAddToDatabase(definitionType, "key", "1", null, "deleted", true);

    // when
    final DefinitionResponseDto definition =
        definitionClient.getDefinitionByTypeAndKey(definitionType, nonDeletedDefinition);
  ...
  public void getEventDefinitionByTypeAndKey() {
    // given
    final DefinitionOptimizeResponseDto expectedDefinition =
        createEventBasedDefinition("key", "the name");

    // when
    final DefinitionResponseDto definition =
        definitionClient.getDefinitionByTypeAndKey(PROCESS, expectedDefinition);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionByTypeAndKey_multiTenant_specificTenantDefinitions(
      final DefinitionType definitionType) {
    // given
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionByTypeAndKey_multiTenant_sharedDefinition(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionByTypeAndKey_multiTenant_sharedAndSpecificDefinition(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
  ...
  public void getDefinitions() {
    ...
    final DefinitionOptimizeResponseDto processDefinition1 =
        createDefinitionAndAddToDatabase(PROCESS, "process1", "1", null, "Process Definition1");
    final DefinitionOptimizeResponseDto processDefinition2 =
        createDefinitionAndAddToDatabase(PROCESS, "process2", "1", null, "process Definition2");
    final DefinitionOptimizeResponseDto processDefinition3 =
        createDefinitionAndAddToDatabase(PROCESS, "process3", "1", null, "a process Definition3");
    final DefinitionOptimizeResponseDto decisionDefinition1 =
        createDefinitionAndAddToDatabase(DECISION, "decision1", "1", null, "Decision Definition1");
    final DefinitionOptimizeResponseDto decisionDefinition2 =
        createDefinitionAndAddToDatabase(DECISION, "decision2", "1", null, "decision Definition2");
    final DefinitionOptimizeResponseDto decisionDefinition3 =
    ...
    final DefinitionOptimizeResponseDto eventProcessDefinition1 =
        createEventBasedDefinition("eventProcess1", "Event process Definition1");
    final DefinitionOptimizeResponseDto eventProcessDefinition2 =
        createEventBasedDefinition("eventProcess2", "event process Definition2");
    final DefinitionOptimizeResponseDto eventProcessDefinition3 =
        createEventBasedDefinition("eventProcess3", "an event process Definition3");
    // deleted definitions will not be included in the result
    createDefinitionAndAddToDatabase(PROCESS, "process1", "1", null, "Process Definition1", true);
    createDefinitionAndAddToDatabase(
    ...
    assertThat(definitions)
        ...
        .containsExactly(
            ...
            new DefinitionResponseDto(
                decisionDefinition3.getKey(),
                decisionDefinition3.getName(),
                DefinitionType.DECISION,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                processDefinition3.getKey(),
                processDefinition3.getName(),
                DefinitionType.PROCESS,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                eventProcessDefinition3.getKey(),
                eventProcessDefinition3.getName(),
                DefinitionType.PROCESS,
                true,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            // then we expect the decision definition #1 as the `1` name suffix is smaller than the
            // `2` and first letter
            // case is ignored
            new DefinitionResponseDto(
                decisionDefinition1.getKey(),
                decisionDefinition1.getName(),
                DefinitionType.DECISION,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                decisionDefinition2.getKey(),
                decisionDefinition2.getName(),
                DefinitionType.DECISION,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            // then the event definitions as they start with "E"
            new DefinitionResponseDto(
                eventProcessDefinition1.getKey(),
                eventProcessDefinition1.getName(),
                DefinitionType.PROCESS,
                true,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                eventProcessDefinition2.getKey(),
                eventProcessDefinition2.getName(),
                DefinitionType.PROCESS,
                true,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            ...
            new DefinitionResponseDto(
                ...
                processDefinition1.getName(),
                DefinitionType.PROCESS,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                processDefinition2.getKey(),
                processDefinition2.getName(),
                DefinitionType.PROCESS,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS));
  }
  ...
  public void getDefinitions_nameUpdatedBetweenVersions(final DefinitionType definitionType) {
    // given
    createDefinitionAndAddToDatabase(definitionType, "definition1", "1", null, "original name");
    final DefinitionOptimizeResponseDto definition1v2 =
        createDefinitionAndAddToDatabase(definitionType, "definition1", "2", null, "updated name");
    final DefinitionOptimizeResponseDto definition2 =
        createDefinitionAndAddToDatabase(definitionType, "definition2", "1", null, "process2");
    ...
    assertThat(definitions)
        ...
        .containsExactly(
            new DefinitionResponseDto(
                ...
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                definition1v2.getKey(),
                definition1v2.getName(),
                definitionType,
                Lists.newArrayList(SIMPLE_TENANT_NOT_DEFINED_DTO),
                DEFAULT_ENGINE_ALIAS));
  }
  ...
  public void getDefinitions_multiTenant_specificTenantDefinitions() {
    ...
    final DefinitionOptimizeResponseDto processDefinition1_1 =
        createDefinitionAndAddToDatabase(
            PROCESS, "process1", "1", TENANT_1.getId(), "Process Definition1");
    final DefinitionOptimizeResponseDto processDefinition1_2 =
        createDefinitionAndAddToDatabase(
            PROCESS, "process1", "1", TENANT_2.getId(), "Process Definition1");
    final DefinitionOptimizeResponseDto processDefinition2_3 =
        createDefinitionAndAddToDatabase(
            PROCESS, "process2", "1", TENANT_3.getId(), "Process Definition2");
    final DefinitionOptimizeResponseDto processDefinition2_2 =
        createDefinitionAndAddToDatabase(
            PROCESS, "process2", "1", TENANT_2.getId(), "Process Definition2");

    final DefinitionOptimizeResponseDto decisionDefinition1_1 =
        createDefinitionAndAddToDatabase(
            DECISION, "decision1", "2", TENANT_1.getId(), "Decision Definition1");
    final DefinitionOptimizeResponseDto decisionDefinition1_2 =
        createDefinitionAndAddToDatabase(
    ...
    final DefinitionOptimizeResponseDto decisionDefinition2_3 =
        createDefinitionAndAddToDatabase(
            DECISION, "decision2", "1", TENANT_3.getId(), "Decision Definition2");
    final DefinitionOptimizeResponseDto decisionDefinition2_2 =
        createDefinitionAndAddToDatabase(
    ...
    assertThat(definitions)
        ...
        .containsExactly(
            new DefinitionResponseDto(
                decisionDefinition1_1.getKey(),
                decisionDefinition1_1.getName(),
                DefinitionType.DECISION,
                // expected order is by id
                Lists.newArrayList(TENANT_1, TENANT_2),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                decisionDefinition2_2.getKey(),
                decisionDefinition2_2.getName(),
                DefinitionType.DECISION,
                // expected order is by id
                Lists.newArrayList(TENANT_2, TENANT_3),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                processDefinition1_1.getKey(),
                processDefinition1_1.getName(),
                DefinitionType.PROCESS,
                // expected order is by id
                Lists.newArrayList(TENANT_1, TENANT_2),
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                processDefinition2_2.getKey(),
                processDefinition2_2.getName(),
                DefinitionType.PROCESS,
                // expected order is by id
                Lists.newArrayList(TENANT_2, TENANT_3),
                DEFAULT_ENGINE_ALIAS));
  ...
  public void getDefinitions_multiTenant_sharedDefinitions() {
    ...
    final DefinitionOptimizeResponseDto decisionDefinition1_1 =
        createDefinitionAndAddToDatabase(DECISION, "decision1", "1", null, "Decision Definition1");
    final DefinitionOptimizeResponseDto eventProcessDefinition1_1 =
        createEventBasedDefinition("eventProcess1", "Event Process Definition1");
    ...
    assertThat(definitions)
        ...
        .containsExactly(
            new DefinitionResponseDto(
                ...
                DEFAULT_ENGINE_ALIAS),
            new DefinitionResponseDto(
                eventProcessDefinition1_1.getKey(),
                eventProcessDefinition1_1.getName(),
                DefinitionType.PROCESS,
                true,
  ...
  public void getDefinitions_multiTenant_sharedAndSpecificDefinitions() {
    ...
    final SimpleDefinitionDto processDefinition1 =
        new SimpleDefinitionDto(
    ...
    final SimpleDefinitionDto processDefinition2 =
        new SimpleDefinitionDto(
    ...
    final SimpleDefinitionDto decisionDefinition1 =
        new SimpleDefinitionDto(
    ...
    final SimpleDefinitionDto decisionDefinition2 =
        new SimpleDefinitionDto(
            decisionKey2, decisionName2, DefinitionType.DECISION, false, DEFAULT_ENGINE_ALIAS);

    final DefinitionOptimizeResponseDto eventProcess1 =
        createEventBasedDefinition("eventProcessKey1", "Event Process Definition1");
    final SimpleDefinitionDto eventProcessDefinition1 =
        new SimpleDefinitionDto(
            eventProcess1.getKey(),
            eventProcess1.getName(),
            DefinitionType.PROCESS,
            true,
            DEFAULT_ENGINE_ALIAS);
    final DefinitionOptimizeResponseDto eventProcess2 =
        createEventBasedDefinition("eventProcessKey2", "Event Process Definition2");
    final SimpleDefinitionDto eventProcessDefinition2 =
        new SimpleDefinitionDto(
            eventProcess2.getKey(),
            eventProcess2.getName(),
            DefinitionType.PROCESS,
            true,
            DEFAULT_ENGINE_ALIAS);
  ...
  public void getDefinitionKeysByType(final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    final DefinitionOptimizeResponseDto definition1 =
        createDefinitionAndAddToDatabase(definitionType, "1", "1", null, "D1");
    ...
    final DefinitionOptimizeResponseDto definition2_tenant1 =
        createDefinitionAndAddToDatabase(definitionType, "2", "1", TENANT_1.getId(), "d2");
    // another definition with same key but different tenant to ensure this causes no duplicate key
    // entries
    final DefinitionOptimizeResponseDto definition2_tenant2 =
        createDefinitionAndAddToDatabase(definitionType, "2", "1", TENANT_2.getId(), "d2");
    final DefinitionOptimizeResponseDto definition3 =
        createDefinitionAndAddToDatabase(definitionType, "3", "1", null, "a");
    // another definition that is deleted, which should not be returned
    final DefinitionOptimizeResponseDto deleted =
        createDefinitionAndAddToDatabase(definitionType, "deletedKey", "1", null, "deleted", true);
    // also create a definition of another type, should not be returned
    final DefinitionType otherDefinitionType =
        Arrays.stream(DefinitionType.values())
    ...
    final List<DefinitionKeyResponseDto> definitions =
        definitionClient.getDefinitionKeysByType(definitionType);
    ...
    assertThat(definitions)
        ...
        .containsSequence(
            ...
            new DefinitionKeyResponseDto(
                definition2_tenant1.getKey(), definition2_tenant1.getName()));
  }
  ...
  public void getProcessDefinitionKeys_camundaImportedEventProcessesOnly() {
    ...
    final ProcessInstanceEngineDto secondInstance =
        deployDefinitionAndStartInstance("anotherProcess");
    importAllEngineEntitiesFromLastIndex();
    embeddedOptimizeExtension.processEvents();

    // then both keys are available when fetching all keys
    final List<DefinitionKeyResponseDto> allDefinitionKeys =
        definitionClient.getDefinitionKeysByType(PROCESS);
    assertThat(allDefinitionKeys)
        .hasSize(2)
        .extracting(DefinitionKeyResponseDto::getKey)
        .containsExactlyInAnyOrder(
            firstInstance.getProcessDefinitionKey(), secondInstance.getProcessDefinitionKey());
    // and only the key with the instance imported with the importEnabled configuration is available
    // when requesting
  ...
  public void getDefinitionVersionsByTypeAndKey(final DefinitionType definitionType) {
    ...
    final List<DefinitionVersionResponseDto> versions =
        definitionClient.getDefinitionVersionsByTypeAndKey(definitionType, definitionKey);
  ...
  public void getDefinitionVersionsIsSortedNumerically(final DefinitionType definitionType) {
    ...
    randomOrderVersions.forEach(
        version ->
            createDefinitionAndAddToDatabase(
                definitionType, definitionKey, version, null, "the name"));
  ...
  public void getDefinitionVersionsByTypeAndKey_eventBasedProcess() {
    ...
    // when
    final List<DefinitionVersionResponseDto> versions =
        definitionClient.getDefinitionVersionsByTypeAndKey(
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByTypeAndKey_multiTenant_specificDefinition(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
    ...
    final String definitionKey = "key";
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey, "1", TENANT_1.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey, "1", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey, "2", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey, "3", TENANT_3.getId(), "the name");
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByTypeAndKey_multiTenant_sharedDefinition(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByTypeAndKey_multiTenant_sharedAndSpecificDefinitions(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
    ...
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey, "2", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey, "3", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey, "4", TENANT_3.getId(), "the name");
  ...
  @ParameterizedTest
  @EnumSource(DefinitionType.class)
  public void getDefinitionVersionsByTypeAndKeyExcludesDeletedDefinitions(
      final DefinitionType definitionType) {
    // given
    final String definitionKey = "key";
    createDefinitionAndAddToDatabase(definitionType, definitionKey, "1", null, "the name");
  ...
  @EnumSource(DefinitionType.class)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_tenantSpecificDefinitions_specificVersions(
          final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
    ...
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "1", TENANT_1.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "2", TENANT_2.getId(), "the name");
    ...
    final DefinitionType otherDefinitionType =
        Arrays.stream(DefinitionType.values())
            ...
            .orElseThrow(OptimizeIntegrationTestException::new);
    createDefinitionAndAddToDatabase(
        otherDefinitionType, definitionKey1, "1", TENANT_3.getId(), "other");
    createDefinitionAndAddToDatabase(
        otherDefinitionType, definitionKey1, "2", TENANT_3.getId(), "other");
    // and a second definition of same type we want to get as well
    final String definitionKey2 = "key2";
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey2, "1", TENANT_3.getId(), "the name");
    ...
    final List<DefinitionWithTenantsResponseDto> definitionsWithTenants =
        definitionClient.resolveDefinitionTenantsByTypeMultipleKeyAndVersions(
            ...
            createMultiDefinitionTenantsRequestDto(
                new DefinitionDto(definitionKey1, List.of("1", "2")),
  ...
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_tenantSpecificDefinitions_allVersions(
          final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
    ...
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "1", TENANT_1.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "1", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "2", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "3", TENANT_3.getId(), "the name");
    // and a second definition of same type we want to get as well
    final String definitionKey2 = "key2";
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey2, "1", TENANT_1.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey2, "1", TENANT_3.getId(), "the name");
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_tenantSpecificDefinitions_latestVersion(
          final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
  ...
  @EnumSource(DefinitionType.class)
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void getDefinitionTenantsByTypeForMultipleKeyAndVersions_sharedDefinition(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
  ...
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void
      getDefinitionTenantsByTypeForMultipleKeyAndVersions_sharedAndTenantSpecificDefinitions(
          final DefinitionType definitionType) {
    // given
    // a tenant starting with letter `a` to verify special ordering of notDefined tenant
    final TenantDto aTenant =
        TenantDto.builder().id("atenant").name("A Tenant").engine(DEFAULT_ENGINE_ALIAS).build();
    final TenantResponseDto aTenantResponseDto =
    ...
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "1", TENANT_1.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "1", aTenant.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "2", aTenant.getId(), "the name");
    createDefinitionAndAddToDatabase(definitionType, definitionKey1, "2", null, "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "3", TENANT_2.getId(), "the name");
    // and a second definition of same type we want to get as well
    final String definitionKey2 = "key2";
    createDefinitionAndAddToDatabase(definitionType, definitionKey2, "1", null, "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey2, "1", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey2, "2", aTenant.getId(), "the name");
  ...
  @EnumSource(DefinitionType.class)
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void getDefinitionTenantsByTypeForMultipleKeyAndVersions_emptyVersionList(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    final String definitionKey1 = "key";
  ...
  @EnumSource(DefinitionType.class)
  @SuppressWarnings(SuppressionConstants.UNCHECKED_CAST)
  public void getDefinitionTenantsByTypeForMultipleKeyAndVersions_excludesDeletedDefinitions(
      final DefinitionType definitionType) {
    // given
    createTenant(TENANT_1);
    createTenant(TENANT_2);
    ...
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "2", TENANT_2.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey1, "2", TENANT_3.getId(), "deleted", true);
    // and a second definition of same type we want to get as well
    final String definitionKey2 = "key2";
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey2, "1", TENANT_1.getId(), "the name");
    createDefinitionAndAddToDatabase(
        definitionType, definitionKey2, "1", TENANT_2.getId(), "deleted", true);
  ...
  public void getDefinitionsGroupedByTenant_multiTenant_specificTenantDefinitions() {
    ...
    createDefinitionAndAddToDatabase(
        PROCESS, processKey1, "1", TENANT_3.getId(), processName1, true);
  ...
  public void getDefinitionsGroupedByTenant_multiTenant_sharedDefinitions() {
    ...
    final DefinitionOptimizeResponseDto eventBasedDefinition1 =
        createEventBasedDefinition("eventProcess1", "Event Process Definition1");
    final SimpleDefinitionDto eventProcessDefinition1 =
        new SimpleDefinitionDto(
    ...
    assertThat(tenantsWithDefinitions)
        ...
        .containsExactly(
            ...
            new TenantWithDefinitionsResponseDto(
                SIMPLE_TENANT_NOT_DEFINED_DTO.getId(),
                SIMPLE_TENANT_NOT_DEFINED_DTO.getName(),
                // definitions ordered by name
                Lists.newArrayList(
                    decisionDefinition1, eventProcessDefinition1, processDefinition1)),
            new TenantWithDefinitionsResponseDto(
                TENANT_1.getId(),
                TENANT_1.getName(),
                // definitions ordered by name
  ...
  public void getDefinitionsGroupedByTenant_multiTenant_sharedAndSpecificDefinitions() {
    ...
    final SimpleDefinitionDto eventProcessDefinition1 =
        new SimpleDefinitionDto(
            ...
            true,
            DEFAULT_ENGINE_ALIAS);
    final DefinitionOptimizeResponseDto eventBasedDefinition2 =
        createEventBasedDefinition("eventProcess2", "An event Process Definition2");
    final SimpleDefinitionDto eventProcessDefinition2 =
        new SimpleDefinitionDto(
  ...
  public void getDefinitions_allEntriesAreRetrievedIfMoreThanBucketLimit() {
    ...
    final int definitionCount = bucketLimit * 2;

    embeddedOptimizeExtension
        .getConfigurationService()
        .getElasticSearchConfiguration()
        .setAggregationBucketLimit(bucketLimit);
    final Map<String, Object> definitionMap = new HashMap<>();
    IntStream.range(0, definitionCount)
        .mapToObj(String::valueOf)
        .forEach(
            i -> {
              final DefinitionOptimizeResponseDto def =
                  createProcessDefinition("key" + i, "1", null, "Definition " + i);
  ...
  public void getDefinitionsGroupedByTenant_allEntriesAreRetrievedIfMoreThanBucketLimit() {
    ...
    // when
    final List<TenantWithDefinitionsResponseDto> definitions =
        definitionClient.getDefinitionsGroupedByTenant();
  ...
  private DefinitionOptimizeResponseDto createEventBasedDefinition(
  ...
  private DefinitionOptimizeResponseDto createDefinitionAndAddToDatabase(
      final DefinitionType definitionType,
      final String key,
  ...
  private DecisionDefinitionOptimizeDto addDecisionDefinitionToDatabase(
      final String key,
      final String version,
      final String tenantId,
      final String name,
  ...
  private ProcessDefinitionOptimizeDto addProcessDefinitionToElasticsearch(
      final String key,
      final String version,
      final String tenantId,
      final String name,
    ...
    final ProcessDefinitionOptimizeDto expectedDto =
        createProcessDefinition(key, version, tenantId, name);
  ...
  private void addProcessDefinitionsToElasticsearch(final Map<String, Object> definitions) {
    databaseIntegrationTestExtension.addEntriesToDatabase(
        PROCESS_DEFINITION_INDEX_NAME, definitions);
  }
  ...
  private ProcessInstanceEngineDto deployDefinitionAndStartInstance(final String processId) {
    return engineIntegrationExtension.deployAndStartProcess(
        Bpmn.createExecutableProcess(processId).name(processId).startEvent().endEvent().done());
  }
  ...
  private MultiDefinitionTenantsRequestDto createMultiDefinitionTenantsRequestDto(
      final DefinitionDto... definitionDtos) {
    final MultiDefinitionTenantsRequestDto multiDefinitionTenantsRequestDto =

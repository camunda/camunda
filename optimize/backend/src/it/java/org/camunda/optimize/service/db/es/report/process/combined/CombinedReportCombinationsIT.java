...
public class CombinedReportCombinationsIT extends AbstractPlatformIT {
  ...
  public void combineCombinableSingleReports(
    ...
    List<CombinedReportItemDto> reportIds =
        singleReports.stream()
            .map(
                report -> new CombinedReportItemDto(reportClient.createSingleProcessReport(report)))
    ...
    assertThat(result.getReportDefinition().getData().getReports())
        .containsExactlyInAnyOrderElementsOf(reportIds);
  }

  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
      getCombinableSingleReports() {
    return Stream.of(
  ...
  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
      createDifferentProcessDefinitionReports() {
    // different procDefs
    final SingleProcessReportDefinitionRequestDto procDefKeyReport =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto procDefKeyReportData =
    ...
    final SingleProcessReportDefinitionRequestDto procDefAnotherKeyReport =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto procDefAnotherKeyReportData =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(PROC_INST_FREQ_GROUP_BY_START_DATE)
  ...
  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
    ...
    final SingleProcessReportDefinitionRequestDto byStartDate =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto procDefKeyReportData =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(PROC_INST_FREQ_GROUP_BY_START_DATE)
    ...
    final SingleProcessReportDefinitionRequestDto byEndDate =
        new SingleProcessReportDefinitionRequestDto();
  ...
  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
    ...
    final SingleProcessReportDefinitionRequestDto userTaskDuration =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto userTaskDurationData =
        TemplatedProcessReportDataBuilder.createReportData()
    ...
    final SingleProcessReportDefinitionRequestDto flowNodeDuration =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto flowNodeDurationData =
        TemplatedProcessReportDataBuilder.createReportData()
  ...
  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
    ...
    final SingleProcessReportDefinitionRequestDto groupByNumberVar1 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto groupByNumberVar1Data =
        TemplatedProcessReportDataBuilder.createReportData()
    ...
    final SingleProcessReportDefinitionRequestDto groupByNumberVar2 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto groupByNumberVar2Data =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(PROC_INST_FREQ_GROUP_BY_VARIABLE)
            .setVariableType(VariableType.DOUBLE)
            .setProcessDefinitionKey("key")
  ...
  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
      createByInstanceDurationReports() {
    // groupByDuration
    final SingleProcessReportDefinitionRequestDto groupByDuration =
        new SingleProcessReportDefinitionRequestDto();
    ...
    final SingleProcessReportDefinitionRequestDto groupByDurationAnotherKey =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto groupByDurationDataAnotherKey =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(PROC_INST_FREQ_GROUP_BY_DURATION)
            .setProcessDefinitionKey("anotherKey")
            .setProcessDefinitionVersion("1")
  ...
  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
    ...
    final SingleProcessReportDefinitionRequestDto groupByDurationBucketSize =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto groupByDurationDataBucketSize =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(PROC_INST_FREQ_GROUP_BY_DURATION)
            .setProcessDefinitionKey("key")
            .setProcessDefinitionVersion("1")
    ...
    final SingleProcessReportDefinitionRequestDto groupByDurationBucketSizeAnotherKey =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto groupByDurationDataBucketSizeAnotherKey =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(PROC_INST_FREQ_GROUP_BY_DURATION)
            .setProcessDefinitionKey("anotherKey")
            .setProcessDefinitionVersion("1")
            .setVisualization(ProcessVisualization.BAR)
            .build();
    groupByDurationDataBucketSizeAnotherKey
        .getConfiguration()
        .setCustomBucket(
            CustomBucketDto.builder()
                .active(true)
  ...
  private static Stream<List<SingleProcessReportDefinitionRequestDto>>
    ...
    final SingleProcessReportDefinitionRequestDto incidentFrequency1 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentFrequencyData1 =
        TemplatedProcessReportDataBuilder.createReportData()
    ...
    final SingleProcessReportDefinitionRequestDto incidentFrequency2 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentFrequencyData2 =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(INCIDENT_FREQ_GROUP_BY_NONE)
            .setProcessDefinitionKey("key")
            .setProcessDefinitionVersion("1")
    ...
    final SingleProcessReportDefinitionRequestDto incidentDuration1 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentDurationData1 =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(INCIDENT_FREQ_GROUP_BY_NONE)
            .setProcessDefinitionKey("key")
            .setProcessDefinitionVersion("1")
    ...
    final SingleProcessReportDefinitionRequestDto incidentDuration2 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentDurationData2 =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(INCIDENT_FREQ_GROUP_BY_NONE)
            .setProcessDefinitionKey("key")
            .setProcessDefinitionVersion("1")
    ...
    final SingleProcessReportDefinitionRequestDto incidentFrequencyGroupedByFlowNode1 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentFrequencyGroupedByFlowNodeData1 =
        TemplatedProcessReportDataBuilder.createReportData()
    ...
    final SingleProcessReportDefinitionRequestDto incidentFrequencyGroupedByFlowNode2 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentFrequencyGroupedByFlowNodeData2 =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(INCIDENT_FREQ_GROUP_BY_FLOW_NODE)
            .setProcessDefinitionKey("key")
            .setProcessDefinitionVersion("1")
    ...
    final SingleProcessReportDefinitionRequestDto incidentDurationGroupedByFlowNode1 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentDurationGroupedByFlowNodeData1 =
        TemplatedProcessReportDataBuilder.createReportData()
    ...
    final SingleProcessReportDefinitionRequestDto incidentDurationGroupedByFlowNode2 =
        new SingleProcessReportDefinitionRequestDto();
    final ProcessReportDataDto incidentDurationGroupedByFlowNodeData2 =
        TemplatedProcessReportDataBuilder.createReportData()
            .setReportDataType(INCIDENT_DUR_GROUP_BY_FLOW_NODE)
            .setProcessDefinitionKey("key")
            .setProcessDefinitionVersion("1")

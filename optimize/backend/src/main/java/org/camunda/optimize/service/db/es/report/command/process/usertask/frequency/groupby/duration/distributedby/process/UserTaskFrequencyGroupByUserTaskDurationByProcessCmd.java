 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.frequency.groupby.duration.distributedby.process;
...
import org.camunda.optimize.service.db.es.report.command.modules.group_by.process.usertask.ProcessGroupByUserTaskDuration;
...
@Component
public class UserTaskFrequencyGroupByUserTaskDurationByProcessCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskFrequencyGroupByUserTaskDurationByProcessCmd(

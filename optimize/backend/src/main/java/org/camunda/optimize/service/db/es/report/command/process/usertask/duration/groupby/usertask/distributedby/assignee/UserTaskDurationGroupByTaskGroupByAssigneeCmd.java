 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.usertask.distributedby.assignee;
...
@Component
public class UserTaskDurationGroupByTaskGroupByAssigneeCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskDurationGroupByTaskGroupByAssigneeCmd(

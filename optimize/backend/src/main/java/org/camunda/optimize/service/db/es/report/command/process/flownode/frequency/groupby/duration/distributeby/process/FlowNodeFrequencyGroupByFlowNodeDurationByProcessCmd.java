 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.flownode.frequency.groupby.duration.distributeby.process;
...
@Component
public class FlowNodeFrequencyGroupByFlowNodeDurationByProcessCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeFrequencyGroupByFlowNodeDurationByProcessCmd(

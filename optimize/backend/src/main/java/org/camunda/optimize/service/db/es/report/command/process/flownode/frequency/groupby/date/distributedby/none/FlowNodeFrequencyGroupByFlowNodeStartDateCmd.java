...
@Component
public class FlowNodeFrequencyGroupByFlowNodeStartDateCmd
    extends ProcessCmd<List<MapResultEntryDto>> {

  public FlowNodeFrequencyGroupByFlowNodeStartDateCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

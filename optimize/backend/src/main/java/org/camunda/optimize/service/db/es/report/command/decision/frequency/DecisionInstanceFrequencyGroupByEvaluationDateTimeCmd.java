...
import org.camunda.optimize.service.db.es.report.command.modules.group_by.decision.DecisionGroupByEvaluationDateTime;
import org.camunda.optimize.service.db.es.report.command.modules.view.decision.DecisionViewInstanceFrequency;
import org.springframework.stereotype.Component;

@Component
public class DecisionInstanceFrequencyGroupByEvaluationDateTimeCmd
    extends DecisionCmd<List<MapResultEntryDto>> {

  public DecisionInstanceFrequencyGroupByEvaluationDateTimeCmd(

 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.frequency.groupby.date.distributedby.usertask;
...
@Component
public class UserTaskFrequencyGroupByUserTaskEndDateByTaskCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskFrequencyGroupByUserTaskEndDateByTaskCmd(

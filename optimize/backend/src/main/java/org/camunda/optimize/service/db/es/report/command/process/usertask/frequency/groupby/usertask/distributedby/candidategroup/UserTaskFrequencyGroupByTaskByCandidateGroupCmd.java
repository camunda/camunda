 ...
 */
package org.camunda.optimize.service.db.es.report.command.process.usertask.frequency.groupby.usertask.distributedby.candidategroup;
...
@Component
public class UserTaskFrequencyGroupByTaskByCandidateGroupCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskFrequencyGroupByTaskByCandidateGroupCmd(

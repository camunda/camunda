 ...
 */
package io.camunda.optimize.service.db.es.report.command.process.flownode.frequency.groupby.date.distributedby.process;
...
@Component
public class FlowNodeFrequencyGroupByFlowNodeStartDateByProcessCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeFrequencyGroupByFlowNodeStartDateByProcessCmd(

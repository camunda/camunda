...
public class MappingRepositoryES implements MappingRepository {
  ...
  private static final Logger log = org.slf4j.LoggerFactory.getLogger(MappingRepositoryES.class);
  private final OptimizeElasticsearchClient esClient;
  private final ObjectMapper objectMapper;

  public MappingRepositoryES(
  ...
  public void deleteEventProcessMappings(final List<String> eventProcessMappingIds) {
    ...
    try {
      ...
      final String reason = "Could not delete event process mappings due to an unexpected error.";
      log.error(reason, e);

...
public class PublicApiRestService {
  ...
  public static final String COLLECTION_SCOPE_SUB_PATH =
      COLLECTION_SUB_PATH + "/collection/{id}/scope";
  ...
  public IdResponseDto createCollection(
      @NotNull @RequestBody
          final PartialCollectionDefinitionRequestDto
    ...
    if (!identityService.doesIdentityExist(
      ...
      throw new OptimizeUserOrGroupIdNotFoundException("No Optimize user exists for the given ownerId.");
    }
  ...
  public void addScopeEntriesToCollection(
      ...
      @NotNull @RequestBody final List<CollectionScopeEntryDto> scopeEntries) {

      ...
      case PROC_INST_PER_GROUP_BY_NONE:
        reportData =
            new ProcessReportDataBuilderHelper()
                ...
                .build();
        break;
      case PROC_INST_AUTOMATION_RATE_GROUP_BY_NONE:
        reportData =
            new ProcessReportDataBuilderHelper()
                .viewEntity(ProcessViewEntity.PROCESS_INSTANCE)
                ...
                .build();
        break;
      case PROC_INST_AUTOMATION_RATE_GROUP_BY_PROCESS_DEFINITION_KEY:
        reportData =
            new ProcessReportDataBuilderHelper()
                .viewEntity(ProcessViewEntity.PROCESS_INSTANCE)
                .viewProperty(ViewProperty.AUTOMATION_RATE)
                .groupByType(ProcessGroupByType.PROCESS_DEFINITION_KEY)
                .distributedByType(DistributedByType.NONE)
                .definitions(definitions)
                .build();
        break;

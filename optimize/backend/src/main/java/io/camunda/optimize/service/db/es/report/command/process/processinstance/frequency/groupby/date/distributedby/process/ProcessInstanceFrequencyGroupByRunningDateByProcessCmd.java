 ...
 */
package io.camunda.optimize.service.db.es.report.command.process.processinstance.frequency.groupby.date.distributedby.process;
...
import io.camunda.optimize.service.db.es.report.command.modules.group_by.process.date.ProcessGroupByProcessInstanceRunningDate;
...
@Component
public class ProcessInstanceFrequencyGroupByRunningDateByProcessCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public ProcessInstanceFrequencyGroupByRunningDateByProcessCmd(

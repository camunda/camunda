...
public class AutogenerationProcessModelService {
  ...
  public AutogenerationProcessModelService(
      ...
      final CamundaEventModelBuilderService camundaEventModelBuilderService,
  ...
  public AutogenerationProcessModelDto generateModelFromEventSources(
    ...
    final List<String> externalSampleTraceIds = new ArrayList<>(
        sampleTraceListsByTracingId.keySet());

...
@Component
public class ProcessInstanceFrequencyGroupByStartDateCmd
    extends ProcessCmd<List<MapResultEntryDto>> {

  public ProcessInstanceFrequencyGroupByStartDateCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

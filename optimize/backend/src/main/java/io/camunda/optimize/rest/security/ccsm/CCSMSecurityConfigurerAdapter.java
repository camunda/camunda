          ...
          .authorizeHttpRequests(
              requests ->
                  requests
                      ...
                      .requestMatchers(
                          PathPatternRequestMatcher.withDefaults().matcher(createApiPath(READYZ_PATH)))
                      .permitAll()
                      ...
                      .requestMatchers(
                          ...
                          PathPatternRequestMatcher.withDefaults().matcher(EXTERNAL_SUB_PATH + "/index*"),
                          PathPatternRequestMatcher.withDefaults().matcher(
                              EXTERNAL_SUB_PATH + STATIC_RESOURCE_PATH + "/**"),
                          PathPatternRequestMatcher.withDefaults().matcher(EXTERNAL_SUB_PATH + "/*.js"),
                          PathPatternRequestMatcher.withDefaults().matcher(EXTERNAL_SUB_PATH + "/*.ico"))
                      .permitAll()
                      // public share related resources (API)
                      .requestMatchers(
                          PathPatternRequestMatcher.withDefaults().matcher(
                              createApiPath(EXTERNAL_SUB_PATH + DEEP_SUB_PATH_ANY)),
                          PathPatternRequestMatcher.withDefaults().matcher(EXTERNAL_SUB_PATH + "/api/**"))
                      .permitAll()
                      // common public api resources
                      .requestMatchers(
                          PathPatternRequestMatcher.withDefaults().matcher(
                              createApiPath(UI_CONFIGURATION_PATH)),
                          PathPatternRequestMatcher.withDefaults().matcher(createApiPath(LOCALIZATION_PATH)))
                      .permitAll()
                      .requestMatchers(
                          PathPatternRequestMatcher.withDefaults().matcher(ACTUATOR_ENDPOINT + "/**"))
                      .permitAll()
                      .anyRequest()
                      .authenticated())
          .addFilterBefore(
          ...
          .exceptionHandling(
              exceptionHandling ->
                  exceptionHandling
                      ...
                      .defaultAuthenticationEntryPointFor(
                          this::redirectToIdentity, PathPatternRequestMatcher.withDefaults().matcher("/**")))
          .build();

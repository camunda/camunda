...
public class EngineAuthenticationProvider {
  ...
  private static final Logger log =
      org.slf4j.LoggerFactory.getLogger(EngineAuthenticationProvider.class);

  private final ConfigurationService configurationService;

  public EngineAuthenticationProvider(final ConfigurationService configurationService) {
  ...
  public AuthenticationResultDto performAuthenticationCheck(
    ...
    try {
      ...
      if (responseIsSuccessful(response)) {
        final AuthenticationResultDto authResult =
            response.readEntity(AuthenticationResultDto.class);

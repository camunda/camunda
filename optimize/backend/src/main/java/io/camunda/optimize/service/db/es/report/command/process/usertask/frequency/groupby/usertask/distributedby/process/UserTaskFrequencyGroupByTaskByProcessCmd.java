 ...
 */
package io.camunda.optimize.service.db.es.report.command.process.usertask.frequency.groupby.usertask.distributedby.process;
...
@Component
public class UserTaskFrequencyGroupByTaskByProcessCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public UserTaskFrequencyGroupByTaskByProcessCmd(final ReportCmdExecutionPlanBuilder builder) {
    super(builder);
  }

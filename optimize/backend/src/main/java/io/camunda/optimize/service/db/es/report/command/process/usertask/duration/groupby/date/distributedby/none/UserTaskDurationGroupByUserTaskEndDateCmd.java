 ...
 */
package io.camunda.optimize.service.db.es.report.command.process.usertask.duration.groupby.date.distributedby.none;
...
@Component
public class UserTaskDurationGroupByUserTaskEndDateCmd extends ProcessCmd<List<MapResultEntryDto>> {

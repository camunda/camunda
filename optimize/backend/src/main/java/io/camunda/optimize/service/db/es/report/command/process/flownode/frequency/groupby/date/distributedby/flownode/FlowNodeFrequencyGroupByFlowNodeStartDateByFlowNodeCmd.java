 ...
 */
package io.camunda.optimize.service.db.es.report.command.process.flownode.frequency.groupby.date.distributedby.flownode;
...
@Component
public class FlowNodeFrequencyGroupByFlowNodeStartDateByFlowNodeCmd
    extends ProcessCmd<List<HyperMapResultEntryDto>> {

  public FlowNodeFrequencyGroupByFlowNodeStartDateByFlowNodeCmd(

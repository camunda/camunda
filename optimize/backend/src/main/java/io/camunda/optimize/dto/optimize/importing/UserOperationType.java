...
import static io.camunda.optimize.service.util.importing.EngineConstants.ACTIVATE_PROCESS_DEFINITION_OPERATION;
import static io.camunda.optimize.service.util.importing.EngineConstants.ACTIVATE_PROCESS_INSTANCE_OPERATION;
import static io.camunda.optimize.service.util.importing.EngineConstants.ACTIVATE_VIA_BATCH_OPERATION_TYPE;
import static io.camunda.optimize.service.util.importing.EngineConstants.INCL_INSTANCES_IN_DEFINITION_SUSPENSION_FIELD;
import static io.camunda.optimize.service.util.importing.EngineConstants.PROCESS_INSTANCE_ENTITY_TYPE;
import static io.camunda.optimize.service.util.importing.EngineConstants.SUSPEND_PROCESS_DEFINITION_OPERATION;
import static io.camunda.optimize.service.util.importing.EngineConstants.SUSPEND_PROCESS_INSTANCE_OPERATION;
import static io.camunda.optimize.service.util.importing.EngineConstants.SUSPEND_VIA_BATCH_OPERATION_TYPE;

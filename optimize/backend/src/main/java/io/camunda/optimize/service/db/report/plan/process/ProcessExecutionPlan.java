...
public enum ProcessExecutionPlan implements ExecutionPlan {
  ...
  PROCESS_AGENT_MODEL_CALLS_GROUP_BY_START_DATE(
      PROCESS_VIEW_AGENT_MODEL_CALLS,
      PROCESS_GROUP_BY_PROCESS_INSTANCE_START_DATE,
      PROCESS_DISTRIBUTED_BY_NONE,
      MAP),
  PROCESS_AGENT_MODEL_CALLS_GROUP_BY_NONE(
      PROCESS_VIEW_AGENT_MODEL_CALLS, PROCESS_GROUP_BY_NONE, PROCESS_DISTRIBUTED_BY_NONE, NUMBER),
  ...
  PROCESS_AGENT_AVG_TOKENS_PER_CALL_GROUP_BY_PROCESS_DEFINITION_KEY(
      PROCESS_VIEW_AGENT_AVG_TOKENS_PER_CALL,
      PROCESS_GROUP_BY_PROCESS_DEFINITION_KEY,
      PROCESS_DISTRIBUTED_BY_NONE,
      MAP),

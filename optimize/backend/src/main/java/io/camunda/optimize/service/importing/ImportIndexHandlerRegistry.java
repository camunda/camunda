...
public class ImportIndexHandlerRegistry {
  ...
  public ZeebeDecisionInstanceImportIndexHandler getZeebeDecisionInstanceImportIndexHandler(
      final Integer partitionId) {
    return getZeebeImportIndexHandler(partitionId, ZeebeDecisionInstanceImportIndexHandler.class);
  }

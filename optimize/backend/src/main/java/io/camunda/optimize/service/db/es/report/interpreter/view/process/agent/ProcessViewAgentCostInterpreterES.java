...
public class ProcessViewAgentCostInterpreterES extends AbstractProcessViewAgentMetricInterpreterES {

  @Override
  public Set<ProcessView> getSupportedViews() {
    return Set.of(PROCESS_VIEW_AGENT_COST);
  }

  @Override
  protected String getAggregationFieldName() {
    return ProcessInstanceIndex.AGENT_TOTAL_COST;
  }
}

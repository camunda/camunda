...
public class OpenIncidentQueryFilterOS implements QueryFilterOS<OpenIncidentFilterDataDto> {

  @Override
  public List<Query> filterQueries(
      final List<OpenIncidentFilterDataDto> withOpenIncident, final FilterContext filterContext) {
    return !CollectionUtils.isEmpty(withOpenIncident)
        ? List.of(nested(INCIDENTS, createOpenIncidentTermQuery(), ChildScoreMode.None))
        : List.of();
  }
}

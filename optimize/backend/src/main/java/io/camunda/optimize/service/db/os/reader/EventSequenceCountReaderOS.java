...
public class EventSequenceCountReaderOS implements EventSequenceCountReader {
  ...
  private Aggregation createAggregationBuilder() {
    ...
    final List<Map<String, CompositeAggregationSource>> eventAndSourceAndGroupTerms = new ArrayList<>();
  ...
  private Query buildEventTypeBoolQueryForProperty(final EventTypeDto eventTypeDto,

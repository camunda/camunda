...
public abstract class TimestampBasedExternalDataImportMediator<
        T extends TimestampBasedExternalDataImportIndexHandler<?>, DTO>
    extends BackoffImportMediator<T, DTO> {

  protected int countOfImportedEntitiesWithLastEntityTimestamp = 0;

  protected TimestampBasedExternalDataImportMediator(

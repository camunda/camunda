...
import static io.camunda.optimize.service.db.os.report.interpreter.view.process.ProcessViewAutomationRateInterpreterOS.AUTOMATED_TASKS_AGGREGATION;
import static io.camunda.optimize.service.db.os.report.interpreter.view.process.ProcessViewAutomationRateInterpreterOS.AUTOMATION_NESTED_AGGREGATION;
import static io.camunda.optimize.service.db.os.report.interpreter.view.process.ProcessViewAutomationRateInterpreterOS.HUMAN_TASKS_AGGREGATION;
...
class ProcessViewAutomationRateInterpreterOSTest {

  private final ProcessViewAutomationRateInterpreterOS interpreter =
      new ProcessViewAutomationRateInterpreterOS();
  ...
  void shouldEmitNestedAggregationOnFlowNodeInstances() {
    // when
    final Map<String, Aggregation> aggs = interpreter.createAggregations(context());
    ...
    final Aggregation nested = aggs.get(AUTOMATION_NESTED_AGGREGATION);
  ...
  void shouldFilterAutomatedTasksByAllFourAutomatedTypes() {
    ...
    final Aggregation nested =
        interpreter.createAggregations(context()).get(AUTOMATION_NESTED_AGGREGATION);

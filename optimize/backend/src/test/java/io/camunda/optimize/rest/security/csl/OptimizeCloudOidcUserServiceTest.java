...
class OptimizeCloudOidcUserServiceTest {
  ...
  @Test
  void shouldGrantAccessForConfiguredOrgWithAllowedRole() {
  ...
  @Test
  void shouldDenyWhenConfiguredOrgHasNoAllowedRole() {
  ...
  @Test
  void shouldDenyWhenUserIsNotMemberOfConfiguredOrg() {
  ...
  @Test
  void shouldDenyWhenOrganizationsClaimMissing() {
  ...
  @Test
  void shouldDenyWhenOrganizationsClaimIsNotACollection() {
    withOrgs("not-a-list");

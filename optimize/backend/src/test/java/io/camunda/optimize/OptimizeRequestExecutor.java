...
public class OptimizeRequestExecutor {
  ...
  public OptimizeRequestExecutor withUserAuthentication(final String username,
  ...
  public <T> Page<T> executeAndGetPage(final Class<T> classToExtractFromResponse,
    ...
    try (final Response response = execute()) {
      ...
      final JavaType listOfT = factory.constructCollectionType(List.class,
          classToExtractFromResponse);
  ...
  public <T> List<T> executeAndReturnList(final Class<T> classToExtractFromResponse,
      final int responseCode) {
    try (final Response response = execute()) {
      assertStatusCode(response, responseCode);
  ...
  public OptimizeRequestExecutor buildUpdateAlertRequest(final String id,
      final AlertCreationRequestDto alert) {
    body = getBody(alert);
    path = ALERT + "/" + id;
    method = PUT;
    return this;
  ...
  public OptimizeRequestExecutor buildGetProcessDefinitionXmlRequest(final String key,
  ...
  public OptimizeRequestExecutor buildProcessVariableNamesForReportsRequest(
    ...
    final GetVariableNamesForReportsRequestDto requestDto = new GetVariableNamesForReportsRequestDto();
  ...
  public OptimizeRequestExecutor buildCsvExportRequest(final String reportId,
  ...
  public OptimizeRequestExecutor buildValidateAndStoreLicenseRequest(final String license) {
    path = "license/validate-and-store";
    method = POST;
    body = Entity.entity(license, MediaType.TEXT_PLAIN);
    return this;
  }
  ...
  public OptimizeRequestExecutor buildGetDecisionDefinitionXmlRequest(final String key,
      final Object version) {
          ...
          .init(
              ...
              new TrustManager[] {
                new X509TrustManager() {
                  @Override public void checkClientTrusted(final X509Certificate[] arg0, final String arg1) {}

                  @Override public void checkServerTrusted(final X509Certificate[] arg0, final String arg1) {}
